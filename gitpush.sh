...
echo 'add a remote pseudo for the cim-test repository'

git remote add origin https://complexmathguy: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@github.com/complexmathguy/cim-test
