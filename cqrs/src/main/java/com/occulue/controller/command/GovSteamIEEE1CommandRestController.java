...
public class GovSteamIEEE1CommandRestController extends BaseSpringRestController {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovSteamIEEE1Command command ) {
		try {
	...
	public void unAssignPmax( @RequestBody(required=true)  UnAssignPmaxFromGovSteamIEEE1Command command ) {
		try {
	...
	public void unAssignPmin( @RequestBody(required=true)  UnAssignPminFromGovSteamIEEE1Command command ) {
		try {
