...
public class ActivePowerPerFrequencyCommandRestController extends BaseSpringRestController {
	...
	public void assignValue( @RequestBody AssignValueToActivePowerPerFrequencyCommand command ) {
		try {
			ActivePowerPerFrequencyBusinessDelegate.getActivePowerPerFrequencyInstance().assignValue( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignValue( @RequestBody(required=true)  UnAssignValueFromActivePowerPerFrequencyCommand command ) {
		try {
			ActivePowerPerFrequencyBusinessDelegate.getActivePowerPerFrequencyInstance().unAssignValue( command );   
		}
		catch( Exception exc ) {
