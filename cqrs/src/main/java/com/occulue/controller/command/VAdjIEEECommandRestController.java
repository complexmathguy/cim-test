...
public class VAdjIEEECommandRestController extends BaseSpringRestController {
	...
	public void unAssignAdjslew( @RequestBody(required=true)  UnAssignAdjslewFromVAdjIEEECommand command ) {
		try {
	...
	public void unAssignTaoff( @RequestBody(required=true)  UnAssignTaoffFromVAdjIEEECommand command ) {
		try {
	...
	public void unAssignVadjf( @RequestBody(required=true)  UnAssignVadjfFromVAdjIEEECommand command ) {
		try {
	...
	public void unAssignVadjmax( @RequestBody(required=true)  UnAssignVadjmaxFromVAdjIEEECommand command ) {
		try {
	...
	public void unAssignVadjmin( @RequestBody(required=true)  UnAssignVadjminFromVAdjIEEECommand command ) {
		try {
