...
public class Quality61850CommandRestController extends BaseSpringRestController {
	...
	public void unAssignBadReference( @RequestBody(required=true)  UnAssignBadReferenceFromQuality61850Command command ) {
		try {
	...
	public void assignEstimatorReplaced( @RequestBody AssignEstimatorReplacedToQuality61850Command command ) {
		try {
	...
	public void unAssignEstimatorReplaced( @RequestBody(required=true)  UnAssignEstimatorReplacedFromQuality61850Command command ) {
		try {
	...
	public void unAssignFailure( @RequestBody(required=true)  UnAssignFailureFromQuality61850Command command ) {
		try {
	...
	public void unAssignOldData( @RequestBody(required=true)  UnAssignOldDataFromQuality61850Command command ) {
		try {
	...
	public void assignOperatorBlocked( @RequestBody AssignOperatorBlockedToQuality61850Command command ) {
		try {
	...
	public void unAssignOperatorBlocked( @RequestBody(required=true)  UnAssignOperatorBlockedFromQuality61850Command command ) {
		try {
	...
	public void unAssignOscillatory( @RequestBody(required=true)  UnAssignOscillatoryFromQuality61850Command command ) {
		try {
	...
	public void unAssignOutOfRange( @RequestBody(required=true)  UnAssignOutOfRangeFromQuality61850Command command ) {
		try {
	...
	public void unAssignOverFlow( @RequestBody(required=true)  UnAssignOverFlowFromQuality61850Command command ) {
		try {
	...
	public void unAssignSuspect( @RequestBody(required=true)  UnAssignSuspectFromQuality61850Command command ) {
		try {
	...
	public void unAssignTest( @RequestBody(required=true)  UnAssignTestFromQuality61850Command command ) {
		try {
