...
public class BasicIntervalScheduleCommandRestController extends BaseSpringRestController {
	...
	public void assignStartTime( @RequestBody AssignStartTimeToBasicIntervalScheduleCommand command ) {
		try {
			BasicIntervalScheduleBusinessDelegate.getBasicIntervalScheduleInstance().assignStartTime( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignStartTime( @RequestBody(required=true)  UnAssignStartTimeFromBasicIntervalScheduleCommand command ) {
		try {
			BasicIntervalScheduleBusinessDelegate.getBasicIntervalScheduleInstance().unAssignStartTime( command );   
		}
		catch( Exception exc ) {
