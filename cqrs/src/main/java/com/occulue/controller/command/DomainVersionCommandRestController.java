...
public class DomainVersionCommandRestController extends BaseSpringRestController {
	...
	public void unAssignBaseUML( @RequestBody(required=true)  UnAssignBaseUMLFromDomainVersionCommand command ) {
		try {
	...
	public void unAssignDate( @RequestBody(required=true)  UnAssignDateFromDomainVersionCommand command ) {
		try {
	...
	public void unAssignEntsoeUML( @RequestBody(required=true)  UnAssignEntsoeUMLFromDomainVersionCommand command ) {
		try {
	...
	public void unAssignVersion( @RequestBody(required=true)  UnAssignVersionFromDomainVersionCommand command ) {
		try {
