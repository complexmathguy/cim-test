...
public class DiscExcContIEEEDEC2ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignTd1( @RequestBody(required=true)  UnAssignTd1FromDiscExcContIEEEDEC2ACommand command ) {
		try {
	...
	public void unAssignTd2( @RequestBody(required=true)  UnAssignTd2FromDiscExcContIEEEDEC2ACommand command ) {
		try {
	...
	public void unAssignVdmax( @RequestBody(required=true)  UnAssignVdmaxFromDiscExcContIEEEDEC2ACommand command ) {
		try {
	...
	public void unAssignVdmin( @RequestBody(required=true)  UnAssignVdminFromDiscExcContIEEEDEC2ACommand command ) {
		try {
	...
	public void unAssignVk( @RequestBody(required=true)  UnAssignVkFromDiscExcContIEEEDEC2ACommand command ) {
		try {
