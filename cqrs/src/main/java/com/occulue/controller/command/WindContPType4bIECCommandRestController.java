...
public class WindContPType4bIECCommandRestController extends BaseSpringRestController {
	...
	public void unAssignDpmax( @RequestBody(required=true)  UnAssignDpmaxFromWindContPType4bIECCommand command ) {
		try {
	...
	public void unAssignTpaero( @RequestBody(required=true)  UnAssignTpaeroFromWindContPType4bIECCommand command ) {
		try {
	...
	public void unAssignTpord( @RequestBody(required=true)  UnAssignTpordFromWindContPType4bIECCommand command ) {
		try {
	...
	public void unAssignTufilt( @RequestBody(required=true)  UnAssignTufiltFromWindContPType4bIECCommand command ) {
		try {
