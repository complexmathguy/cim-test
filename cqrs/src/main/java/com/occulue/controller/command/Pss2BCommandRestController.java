...
public class Pss2BCommandRestController extends BaseSpringRestController {
	...
	public void unAssignVsi1max( @RequestBody(required=true)  UnAssignVsi1maxFromPss2BCommand command ) {
		try {
	...
	public void unAssignVsi1min( @RequestBody(required=true)  UnAssignVsi1minFromPss2BCommand command ) {
		try {
	...
	public void unAssignVsi2max( @RequestBody(required=true)  UnAssignVsi2maxFromPss2BCommand command ) {
		try {
	...
	public void unAssignVsi2min( @RequestBody(required=true)  UnAssignVsi2minFromPss2BCommand command ) {
		try {
