...
public class PFVArType1IEEEVArControllerCommandRestController extends BaseSpringRestController {
	...
	public void assignTvarc( @RequestBody AssignTvarcToPFVArType1IEEEVArControllerCommand command ) {
		try {
			PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance().assignTvarc( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTvarc( @RequestBody(required=true)  UnAssignTvarcFromPFVArType1IEEEVArControllerCommand command ) {
		try {
			PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance().unAssignTvarc( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVvar( @RequestBody AssignVvarToPFVArType1IEEEVArControllerCommand command ) {
		try {
			PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance().assignVvar( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVvar( @RequestBody(required=true)  UnAssignVvarFromPFVArType1IEEEVArControllerCommand command ) {
		try {
			PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance().unAssignVvar( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVvarcbw( @RequestBody AssignVvarcbwToPFVArType1IEEEVArControllerCommand command ) {
		try {
			PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance().assignVvarcbw( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVvarcbw( @RequestBody(required=true)  UnAssignVvarcbwFromPFVArType1IEEEVArControllerCommand command ) {
		try {
			PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance().unAssignVvarcbw( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVvarref( @RequestBody AssignVvarrefToPFVArType1IEEEVArControllerCommand command ) {
		try {
			PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance().assignVvarref( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVvarref( @RequestBody(required=true)  UnAssignVvarrefFromPFVArType1IEEEVArControllerCommand command ) {
		try {
			PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance().unAssignVvarref( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVvtmax( @RequestBody AssignVvtmaxToPFVArType1IEEEVArControllerCommand command ) {
		try {
			PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance().assignVvtmax( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVvtmax( @RequestBody(required=true)  UnAssignVvtmaxFromPFVArType1IEEEVArControllerCommand command ) {
		try {
			PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance().unAssignVvtmax( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVvtmin( @RequestBody AssignVvtminToPFVArType1IEEEVArControllerCommand command ) {
		try {
			PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance().assignVvtmin( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVvtmin( @RequestBody(required=true)  UnAssignVvtminFromPFVArType1IEEEVArControllerCommand command ) {
		try {
			PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance().unAssignVvtmin( command );   
		}
		catch( Exception exc ) {
