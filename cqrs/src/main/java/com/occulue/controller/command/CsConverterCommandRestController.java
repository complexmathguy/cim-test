...
public class CsConverterCommandRestController extends BaseSpringRestController {
	...
	public void unAssignMaxAlpha( @RequestBody(required=true)  UnAssignMaxAlphaFromCsConverterCommand command ) {
		try {
	...
	public void unAssignMaxGamma( @RequestBody(required=true)  UnAssignMaxGammaFromCsConverterCommand command ) {
		try {
	...
	public void unAssignMaxIdc( @RequestBody(required=true)  UnAssignMaxIdcFromCsConverterCommand command ) {
		try {
	...
	public void unAssignMinAlpha( @RequestBody(required=true)  UnAssignMinAlphaFromCsConverterCommand command ) {
		try {
	...
	public void unAssignMinGamma( @RequestBody(required=true)  UnAssignMinGammaFromCsConverterCommand command ) {
		try {
	...
	public void unAssignMinIdc( @RequestBody(required=true)  UnAssignMinIdcFromCsConverterCommand command ) {
		try {
	...
	public void unAssignRatedIdc( @RequestBody(required=true)  UnAssignRatedIdcFromCsConverterCommand command ) {
		try {
