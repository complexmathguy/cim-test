...
public class ExcELIN1CommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfmax( @RequestBody(required=true)  UnAssignEfmaxFromExcELIN1Command command ) {
		try {
	...
	public void unAssignEfmin( @RequestBody(required=true)  UnAssignEfminFromExcELIN1Command command ) {
		try {
