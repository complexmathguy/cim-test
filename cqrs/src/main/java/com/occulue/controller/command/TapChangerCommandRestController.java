...
public class TapChangerCommandRestController extends BaseSpringRestController {
	...
	public void unAssignHighStep( @RequestBody(required=true)  UnAssignHighStepFromTapChangerCommand command ) {
		try {
	...
	public void unAssignLowStep( @RequestBody(required=true)  UnAssignLowStepFromTapChangerCommand command ) {
		try {
	...
	public void unAssignLtcFlag( @RequestBody(required=true)  UnAssignLtcFlagFromTapChangerCommand command ) {
		try {
	...
	public void unAssignNeutralStep( @RequestBody(required=true)  UnAssignNeutralStepFromTapChangerCommand command ) {
		try {
	...
	public void unAssignNeutralU( @RequestBody(required=true)  UnAssignNeutralUFromTapChangerCommand command ) {
		try {
	...
	public void unAssignNormalStep( @RequestBody(required=true)  UnAssignNormalStepFromTapChangerCommand command ) {
		try {
