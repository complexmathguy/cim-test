...
public class GovCT1CommandRestController extends BaseSpringRestController {
	...
	public void unAssignKiload( @RequestBody(required=true)  UnAssignKiloadFromGovCT1Command command ) {
		try {
	...
	public void unAssignKpload( @RequestBody(required=true)  UnAssignKploadFromGovCT1Command command ) {
		try {
	...
	public void unAssignMaxerr( @RequestBody(required=true)  UnAssignMaxerrFromGovCT1Command command ) {
		try {
	...
	public void unAssignMinerr( @RequestBody(required=true)  UnAssignMinerrFromGovCT1Command command ) {
		try {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovCT1Command command ) {
		try {
	...
	public void unAssignRclose( @RequestBody(required=true)  UnAssignRcloseFromGovCT1Command command ) {
		try {
	...
	public void unAssignTfload( @RequestBody(required=true)  UnAssignTfloadFromGovCT1Command command ) {
		try {
	...
	public void unAssignTpelec( @RequestBody(required=true)  UnAssignTpelecFromGovCT1Command command ) {
		try {
