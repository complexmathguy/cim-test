...
public class SetPointCommandRestController extends BaseSpringRestController {
	...
	public void unAssignNormalValue( @RequestBody(required=true)  UnAssignNormalValueFromSetPointCommand command ) {
		try {
	...
	public void unAssignValue( @RequestBody(required=true)  UnAssignValueFromSetPointCommand command ) {
		try {
