...
public class WindContPType4aIECCommandRestController extends BaseSpringRestController {
	...
	public void unAssignDpmax( @RequestBody(required=true)  UnAssignDpmaxFromWindContPType4aIECCommand command ) {
		try {
	...
	public void unAssignTpord( @RequestBody(required=true)  UnAssignTpordFromWindContPType4aIECCommand command ) {
		try {
	...
	public void unAssignTufilt( @RequestBody(required=true)  UnAssignTufiltFromWindContPType4aIECCommand command ) {
		try {
