...
public class WindContPType3IECCommandRestController extends BaseSpringRestController {
	...
	public void unAssignDpmax( @RequestBody(required=true)  UnAssignDpmaxFromWindContPType3IECCommand command ) {
		try {
	...
	public void assignDtrisemaxlvrt( @RequestBody AssignDtrisemaxlvrtToWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignDtrisemaxlvrt( @RequestBody(required=true)  UnAssignDtrisemaxlvrtFromWindContPType3IECCommand command ) {
		try {
			WindContPType3IECBusinessDelegate.getWindContPType3IECInstance().unAssignDtrisemaxlvrt( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignKdtd( @RequestBody(required=true)  UnAssignKdtdFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignKip( @RequestBody(required=true)  UnAssignKipFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignKpp( @RequestBody(required=true)  UnAssignKppFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignMplvrt( @RequestBody(required=true)  UnAssignMplvrtFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignOmegaoffset( @RequestBody(required=true)  UnAssignOmegaoffsetFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignPdtdmax( @RequestBody(required=true)  UnAssignPdtdmaxFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignRramp( @RequestBody(required=true)  UnAssignRrampFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignTdvs( @RequestBody(required=true)  UnAssignTdvsFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignTemin( @RequestBody(required=true)  UnAssignTeminFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignTomegafilt( @RequestBody(required=true)  UnAssignTomegafiltFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignTpfilt( @RequestBody(required=true)  UnAssignTpfiltFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignTpord( @RequestBody(required=true)  UnAssignTpordFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignTufilt( @RequestBody(required=true)  UnAssignTufiltFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignTuscale( @RequestBody(required=true)  UnAssignTuscaleFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignTwref( @RequestBody(required=true)  UnAssignTwrefFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignUdvs( @RequestBody(required=true)  UnAssignUdvsFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignUpdip( @RequestBody(required=true)  UnAssignUpdipFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignWdtd( @RequestBody(required=true)  UnAssignWdtdFromWindContPType3IECCommand command ) {
		try {
	...
	public void unAssignZeta( @RequestBody(required=true)  UnAssignZetaFromWindContPType3IECCommand command ) {
		try {
