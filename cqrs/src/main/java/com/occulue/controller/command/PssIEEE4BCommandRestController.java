...
public class PssIEEE4BCommandRestController extends BaseSpringRestController {
	...
	public void unAssignOmeganh1( @RequestBody(required=true)  UnAssignOmeganh1FromPssIEEE4BCommand command ) {
		try {
	...
	public void unAssignOmeganh2( @RequestBody(required=true)  UnAssignOmeganh2FromPssIEEE4BCommand command ) {
		try {
	...
	public void unAssignOmeganl1( @RequestBody(required=true)  UnAssignOmeganl1FromPssIEEE4BCommand command ) {
		try {
	...
	public void unAssignOmeganl2( @RequestBody(required=true)  UnAssignOmeganl2FromPssIEEE4BCommand command ) {
		try {
	...
	public void unAssignVhmax( @RequestBody(required=true)  UnAssignVhmaxFromPssIEEE4BCommand command ) {
		try {
	...
	public void unAssignVhmin( @RequestBody(required=true)  UnAssignVhminFromPssIEEE4BCommand command ) {
		try {
	...
	public void unAssignVimax( @RequestBody(required=true)  UnAssignVimaxFromPssIEEE4BCommand command ) {
		try {
	...
	public void unAssignVimin( @RequestBody(required=true)  UnAssignViminFromPssIEEE4BCommand command ) {
		try {
	...
	public void unAssignVlmax( @RequestBody(required=true)  UnAssignVlmaxFromPssIEEE4BCommand command ) {
		try {
	...
	public void unAssignVlmin( @RequestBody(required=true)  UnAssignVlminFromPssIEEE4BCommand command ) {
		try {
	...
	public void unAssignVstmax( @RequestBody(required=true)  UnAssignVstmaxFromPssIEEE4BCommand command ) {
		try {
	...
	public void unAssignVstmin( @RequestBody(required=true)  UnAssignVstminFromPssIEEE4BCommand command ) {
		try {
