...
public class GovHydroRCommandRestController extends BaseSpringRestController {
	...
	public void unAssignDturb( @RequestBody(required=true)  UnAssignDturbFromGovHydroRCommand command ) {
		try {
	...
	public void unAssignInputSignal( @RequestBody(required=true)  UnAssignInputSignalFromGovHydroRCommand command ) {
		try {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovHydroRCommand command ) {
		try {
	...
	public void unAssignVelcl( @RequestBody(required=true)  UnAssignVelclFromGovHydroRCommand command ) {
		try {
	...
	public void unAssignVelop( @RequestBody(required=true)  UnAssignVelopFromGovHydroRCommand command ) {
		try {
