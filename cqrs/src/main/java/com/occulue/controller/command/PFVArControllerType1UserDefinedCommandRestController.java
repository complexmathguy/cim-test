...
public class PFVArControllerType1UserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToPFVArControllerType1UserDefinedCommand command ) {
		try {
			PFVArControllerType1UserDefinedBusinessDelegate.getPFVArControllerType1UserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromPFVArControllerType1UserDefinedCommand command ) {
		try {
			PFVArControllerType1UserDefinedBusinessDelegate.getPFVArControllerType1UserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
