...
public class ExternalNetworkInjectionCommandRestController extends BaseSpringRestController {
	...
	public void assignGovernorSCD( @RequestBody AssignGovernorSCDToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignGovernorSCD( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignGovernorSCD( @RequestBody(required=true)  UnAssignGovernorSCDFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignGovernorSCD( command );   
		}
		catch( Exception exc ) {
	...
	public void assignIkSecond( @RequestBody AssignIkSecondToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignIkSecond( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignIkSecond( @RequestBody(required=true)  UnAssignIkSecondFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignIkSecond( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMaxInitialSymShCCurrent( @RequestBody AssignMaxInitialSymShCCurrentToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignMaxInitialSymShCCurrent( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMaxInitialSymShCCurrent( @RequestBody(required=true)  UnAssignMaxInitialSymShCCurrentFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignMaxInitialSymShCCurrent( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMaxP( @RequestBody AssignMaxPToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignMaxP( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMaxP( @RequestBody(required=true)  UnAssignMaxPFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignMaxP( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMaxQ( @RequestBody AssignMaxQToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignMaxQ( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMaxQ( @RequestBody(required=true)  UnAssignMaxQFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignMaxQ( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMaxR0ToX0Ratio( @RequestBody AssignMaxR0ToX0RatioToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignMaxR0ToX0Ratio( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMaxR0ToX0Ratio( @RequestBody(required=true)  UnAssignMaxR0ToX0RatioFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignMaxR0ToX0Ratio( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMaxR1ToX1Ratio( @RequestBody AssignMaxR1ToX1RatioToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignMaxR1ToX1Ratio( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMaxR1ToX1Ratio( @RequestBody(required=true)  UnAssignMaxR1ToX1RatioFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignMaxR1ToX1Ratio( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMaxZ0ToZ1Ratio( @RequestBody AssignMaxZ0ToZ1RatioToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignMaxZ0ToZ1Ratio( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMaxZ0ToZ1Ratio( @RequestBody(required=true)  UnAssignMaxZ0ToZ1RatioFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignMaxZ0ToZ1Ratio( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMinInitialSymShCCurrent( @RequestBody AssignMinInitialSymShCCurrentToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignMinInitialSymShCCurrent( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMinInitialSymShCCurrent( @RequestBody(required=true)  UnAssignMinInitialSymShCCurrentFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignMinInitialSymShCCurrent( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMinP( @RequestBody AssignMinPToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignMinP( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMinP( @RequestBody(required=true)  UnAssignMinPFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignMinP( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMinQ( @RequestBody AssignMinQToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignMinQ( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMinQ( @RequestBody(required=true)  UnAssignMinQFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignMinQ( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMinR0ToX0Ratio( @RequestBody AssignMinR0ToX0RatioToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignMinR0ToX0Ratio( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMinR0ToX0Ratio( @RequestBody(required=true)  UnAssignMinR0ToX0RatioFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignMinR0ToX0Ratio( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMinR1ToX1Ratio( @RequestBody AssignMinR1ToX1RatioToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignMinR1ToX1Ratio( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMinR1ToX1Ratio( @RequestBody(required=true)  UnAssignMinR1ToX1RatioFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignMinR1ToX1Ratio( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMinZ0ToZ1Ratio( @RequestBody AssignMinZ0ToZ1RatioToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignMinZ0ToZ1Ratio( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMinZ0ToZ1Ratio( @RequestBody(required=true)  UnAssignMinZ0ToZ1RatioFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignMinZ0ToZ1Ratio( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVoltageFactor( @RequestBody AssignVoltageFactorToExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().assignVoltageFactor( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVoltageFactor( @RequestBody(required=true)  UnAssignVoltageFactorFromExternalNetworkInjectionCommand command ) {
		try {
			ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance().unAssignVoltageFactor( command );   
		}
		catch( Exception exc ) {
