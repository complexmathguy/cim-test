...
public class ExcIEEEAC6ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignSeve1( @RequestBody(required=true)  UnAssignSeve1FromExcIEEEAC6ACommand command ) {
		try {
	...
	public void unAssignSeve2( @RequestBody(required=true)  UnAssignSeve2FromExcIEEEAC6ACommand command ) {
		try {
	...
	public void unAssignVamax( @RequestBody(required=true)  UnAssignVamaxFromExcIEEEAC6ACommand command ) {
		try {
	...
	public void unAssignVamin( @RequestBody(required=true)  UnAssignVaminFromExcIEEEAC6ACommand command ) {
		try {
	...
	public void unAssignVfelim( @RequestBody(required=true)  UnAssignVfelimFromExcIEEEAC6ACommand command ) {
		try {
	...
	public void unAssignVhmax( @RequestBody(required=true)  UnAssignVhmaxFromExcIEEEAC6ACommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEAC6ACommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEAC6ACommand command ) {
		try {
