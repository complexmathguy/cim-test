...
public class WindMechIECCommandRestController extends BaseSpringRestController {
	...
	public void unAssignCdrt( @RequestBody(required=true)  UnAssignCdrtFromWindMechIECCommand command ) {
		try {
	...
	public void unAssignHgen( @RequestBody(required=true)  UnAssignHgenFromWindMechIECCommand command ) {
		try {
	...
	public void unAssignHwtr( @RequestBody(required=true)  UnAssignHwtrFromWindMechIECCommand command ) {
		try {
	...
	public void unAssignKdrt( @RequestBody(required=true)  UnAssignKdrtFromWindMechIECCommand command ) {
		try {
