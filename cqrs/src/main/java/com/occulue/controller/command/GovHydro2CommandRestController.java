...
public class GovHydro2CommandRestController extends BaseSpringRestController {
	...
	public void unAssignAturb( @RequestBody(required=true)  UnAssignAturbFromGovHydro2Command command ) {
		try {
	...
	public void unAssignBturb( @RequestBody(required=true)  UnAssignBturbFromGovHydro2Command command ) {
		try {
	...
	public void unAssignKturb( @RequestBody(required=true)  UnAssignKturbFromGovHydro2Command command ) {
		try {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovHydro2Command command ) {
		try {
	...
	public void unAssignRperm( @RequestBody(required=true)  UnAssignRpermFromGovHydro2Command command ) {
		try {
	...
	public void unAssignRtemp( @RequestBody(required=true)  UnAssignRtempFromGovHydro2Command command ) {
		try {
