...
public class WindGenTurbineType3aIECCommandRestController extends BaseSpringRestController {
	...
	public void assignKpc( @RequestBody AssignKpcToWindGenTurbineType3aIECCommand command ) {
		try {
			WindGenTurbineType3aIECBusinessDelegate.getWindGenTurbineType3aIECInstance().assignKpc( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKpc( @RequestBody(required=true)  UnAssignKpcFromWindGenTurbineType3aIECCommand command ) {
		try {
			WindGenTurbineType3aIECBusinessDelegate.getWindGenTurbineType3aIECInstance().unAssignKpc( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTic( @RequestBody AssignTicToWindGenTurbineType3aIECCommand command ) {
		try {
			WindGenTurbineType3aIECBusinessDelegate.getWindGenTurbineType3aIECInstance().assignTic( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTic( @RequestBody(required=true)  UnAssignTicFromWindGenTurbineType3aIECCommand command ) {
		try {
			WindGenTurbineType3aIECBusinessDelegate.getWindGenTurbineType3aIECInstance().unAssignTic( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXs( @RequestBody AssignXsToWindGenTurbineType3aIECCommand command ) {
		try {
			WindGenTurbineType3aIECBusinessDelegate.getWindGenTurbineType3aIECInstance().assignXs( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXs( @RequestBody(required=true)  UnAssignXsFromWindGenTurbineType3aIECCommand command ) {
		try {
			WindGenTurbineType3aIECBusinessDelegate.getWindGenTurbineType3aIECInstance().unAssignXs( command );   
		}
		catch( Exception exc ) {
