...
public class ExcIEEEAC4ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignVimax( @RequestBody(required=true)  UnAssignVimaxFromExcIEEEAC4ACommand command ) {
		try {
	...
	public void unAssignVimin( @RequestBody(required=true)  UnAssignViminFromExcIEEEAC4ACommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEAC4ACommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEAC4ACommand command ) {
		try {
