...
public class ExcIEEEST5BCommandRestController extends BaseSpringRestController {
	...
	public void unAssignTob1( @RequestBody(required=true)  UnAssignTob1FromExcIEEEST5BCommand command ) {
		try {
	...
	public void unAssignTob2( @RequestBody(required=true)  UnAssignTob2FromExcIEEEST5BCommand command ) {
		try {
	...
	public void unAssignToc1( @RequestBody(required=true)  UnAssignToc1FromExcIEEEST5BCommand command ) {
		try {
	...
	public void unAssignToc2( @RequestBody(required=true)  UnAssignToc2FromExcIEEEST5BCommand command ) {
		try {
	...
	public void unAssignTub1( @RequestBody(required=true)  UnAssignTub1FromExcIEEEST5BCommand command ) {
		try {
	...
	public void unAssignTub2( @RequestBody(required=true)  UnAssignTub2FromExcIEEEST5BCommand command ) {
		try {
	...
	public void unAssignTuc1( @RequestBody(required=true)  UnAssignTuc1FromExcIEEEST5BCommand command ) {
		try {
	...
	public void unAssignTuc2( @RequestBody(required=true)  UnAssignTuc2FromExcIEEEST5BCommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEST5BCommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEST5BCommand command ) {
		try {
