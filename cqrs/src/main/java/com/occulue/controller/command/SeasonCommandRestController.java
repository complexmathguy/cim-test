...
public class SeasonCommandRestController extends BaseSpringRestController {
	...
	public void unAssignEndDate( @RequestBody(required=true)  UnAssignEndDateFromSeasonCommand command ) {
		try {
	...
	public void unAssignStartDate( @RequestBody(required=true)  UnAssignStartDateFromSeasonCommand command ) {
		try {
