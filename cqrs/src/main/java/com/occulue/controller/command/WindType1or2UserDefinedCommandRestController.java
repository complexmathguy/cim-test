...
public class WindType1or2UserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToWindType1or2UserDefinedCommand command ) {
		try {
			WindType1or2UserDefinedBusinessDelegate.getWindType1or2UserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromWindType1or2UserDefinedCommand command ) {
		try {
			WindType1or2UserDefinedBusinessDelegate.getWindType1or2UserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
