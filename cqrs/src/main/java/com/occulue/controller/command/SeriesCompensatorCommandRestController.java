...
public class SeriesCompensatorCommandRestController extends BaseSpringRestController {
	...
	public void unAssignR( @RequestBody(required=true)  UnAssignRFromSeriesCompensatorCommand command ) {
		try {
	...
	public void unAssignR0( @RequestBody(required=true)  UnAssignR0FromSeriesCompensatorCommand command ) {
		try {
	...
	public void assignVaristorPresent( @RequestBody AssignVaristorPresentToSeriesCompensatorCommand command ) {
		try {
			SeriesCompensatorBusinessDelegate.getSeriesCompensatorInstance().assignVaristorPresent( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVaristorPresent( @RequestBody(required=true)  UnAssignVaristorPresentFromSeriesCompensatorCommand command ) {
		try {
			SeriesCompensatorBusinessDelegate.getSeriesCompensatorInstance().unAssignVaristorPresent( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVaristorRatedCurrent( @RequestBody AssignVaristorRatedCurrentToSeriesCompensatorCommand command ) {
		try {
			SeriesCompensatorBusinessDelegate.getSeriesCompensatorInstance().assignVaristorRatedCurrent( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVaristorRatedCurrent( @RequestBody(required=true)  UnAssignVaristorRatedCurrentFromSeriesCompensatorCommand command ) {
		try {
			SeriesCompensatorBusinessDelegate.getSeriesCompensatorInstance().unAssignVaristorRatedCurrent( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVaristorVoltageThreshold( @RequestBody AssignVaristorVoltageThresholdToSeriesCompensatorCommand command ) {
		try {
			SeriesCompensatorBusinessDelegate.getSeriesCompensatorInstance().assignVaristorVoltageThreshold( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVaristorVoltageThreshold( @RequestBody(required=true)  UnAssignVaristorVoltageThresholdFromSeriesCompensatorCommand command ) {
		try {
			SeriesCompensatorBusinessDelegate.getSeriesCompensatorInstance().unAssignVaristorVoltageThreshold( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignX( @RequestBody(required=true)  UnAssignXFromSeriesCompensatorCommand command ) {
		try {
	...
	public void unAssignX0( @RequestBody(required=true)  UnAssignX0FromSeriesCompensatorCommand command ) {
		try {
