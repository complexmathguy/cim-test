...
public class PowerTransformerEndCommandRestController extends BaseSpringRestController {
	...
	public void unAssignB( @RequestBody(required=true)  UnAssignBFromPowerTransformerEndCommand command ) {
		try {
	...
	public void unAssignB0( @RequestBody(required=true)  UnAssignB0FromPowerTransformerEndCommand command ) {
		try {
	...
	public void unAssignG( @RequestBody(required=true)  UnAssignGFromPowerTransformerEndCommand command ) {
		try {
	...
	public void unAssignG0( @RequestBody(required=true)  UnAssignG0FromPowerTransformerEndCommand command ) {
		try {
	...
	public void assignPhaseAngleClock( @RequestBody AssignPhaseAngleClockToPowerTransformerEndCommand command ) {
		try {
			PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance().assignPhaseAngleClock( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPhaseAngleClock( @RequestBody(required=true)  UnAssignPhaseAngleClockFromPowerTransformerEndCommand command ) {
		try {
			PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance().unAssignPhaseAngleClock( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignR( @RequestBody(required=true)  UnAssignRFromPowerTransformerEndCommand command ) {
		try {
	...
	public void unAssignR0( @RequestBody(required=true)  UnAssignR0FromPowerTransformerEndCommand command ) {
		try {
	...
	public void unAssignRatedS( @RequestBody(required=true)  UnAssignRatedSFromPowerTransformerEndCommand command ) {
		try {
	...
	public void unAssignRatedU( @RequestBody(required=true)  UnAssignRatedUFromPowerTransformerEndCommand command ) {
		try {
	...
	public void unAssignX( @RequestBody(required=true)  UnAssignXFromPowerTransformerEndCommand command ) {
		try {
	...
	public void unAssignX0( @RequestBody(required=true)  UnAssignX0FromPowerTransformerEndCommand command ) {
		try {
