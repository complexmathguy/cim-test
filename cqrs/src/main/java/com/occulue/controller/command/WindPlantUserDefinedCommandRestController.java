...
public class WindPlantUserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToWindPlantUserDefinedCommand command ) {
		try {
			WindPlantUserDefinedBusinessDelegate.getWindPlantUserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromWindPlantUserDefinedCommand command ) {
		try {
			WindPlantUserDefinedBusinessDelegate.getWindPlantUserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
