...
public class VoltageLimitCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save Value on VoltageLimit
     * @param		command AssignValueToVoltageLimitCommand
     */     
	@PutMapping("/assignValue")
	public void assignValue( @RequestBody AssignValueToVoltageLimitCommand command ) {
		try {
			VoltageLimitBusinessDelegate.getVoltageLimitInstance().assignValue( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignValue( @RequestBody(required=true)  UnAssignValueFromVoltageLimitCommand command ) {
		try {
			VoltageLimitBusinessDelegate.getVoltageLimitInstance().unAssignValue( command );   
		}
		catch( Exception exc ) {
