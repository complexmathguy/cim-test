...
public class PssPTIST3CommandRestController extends BaseSpringRestController {
	...
	public void unAssignAthres( @RequestBody(required=true)  UnAssignAthresFromPssPTIST3Command command ) {
		try {
	...
	public void unAssignLthres( @RequestBody(required=true)  UnAssignLthresFromPssPTIST3Command command ) {
		try {
