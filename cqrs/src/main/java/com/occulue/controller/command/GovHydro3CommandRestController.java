...
public class GovHydro3CommandRestController extends BaseSpringRestController {
	...
	public void unAssignDturb( @RequestBody(required=true)  UnAssignDturbFromGovHydro3Command command ) {
		try {
	...
	public void unAssignGovernorControl( @RequestBody(required=true)  UnAssignGovernorControlFromGovHydro3Command command ) {
		try {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovHydro3Command command ) {
		try {
	...
	public void unAssignRelec( @RequestBody(required=true)  UnAssignRelecFromGovHydro3Command command ) {
		try {
	...
	public void unAssignRgate( @RequestBody(required=true)  UnAssignRgateFromGovHydro3Command command ) {
		try {
	...
	public void unAssignVelcl( @RequestBody(required=true)  UnAssignVelclFromGovHydro3Command command ) {
		try {
	...
	public void unAssignVelop( @RequestBody(required=true)  UnAssignVelopFromGovHydro3Command command ) {
		try {
