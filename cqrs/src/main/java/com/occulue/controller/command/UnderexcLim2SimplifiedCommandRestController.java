...
public class UnderexcLim2SimplifiedCommandRestController extends BaseSpringRestController {
	...
	public void unAssignKui( @RequestBody(required=true)  UnAssignKuiFromUnderexcLim2SimplifiedCommand command ) {
		try {
			UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance().unAssignKui( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignP0( @RequestBody(required=true)  UnAssignP0FromUnderexcLim2SimplifiedCommand command ) {
		try {
			UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance().unAssignP0( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignP1( @RequestBody(required=true)  UnAssignP1FromUnderexcLim2SimplifiedCommand command ) {
		try {
			UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance().unAssignP1( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignQ0( @RequestBody(required=true)  UnAssignQ0FromUnderexcLim2SimplifiedCommand command ) {
		try {
			UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance().unAssignQ0( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignQ1( @RequestBody(required=true)  UnAssignQ1FromUnderexcLim2SimplifiedCommand command ) {
		try {
			UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance().unAssignQ1( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVuimax( @RequestBody AssignVuimaxToUnderexcLim2SimplifiedCommand command ) {
		try {
			UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance().assignVuimax( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVuimax( @RequestBody(required=true)  UnAssignVuimaxFromUnderexcLim2SimplifiedCommand command ) {
		try {
			UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance().unAssignVuimax( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVuimin( @RequestBody AssignVuiminToUnderexcLim2SimplifiedCommand command ) {
		try {
			UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance().assignVuimin( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVuimin( @RequestBody(required=true)  UnAssignVuiminFromUnderexcLim2SimplifiedCommand command ) {
		try {
			UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance().unAssignVuimin( command );   
		}
		catch( Exception exc ) {
