...
public class PhaseTapChangerLinearCommandRestController extends BaseSpringRestController {
	...
	public void assignStepPhaseShiftIncrement( @RequestBody AssignStepPhaseShiftIncrementToPhaseTapChangerLinearCommand command ) {
		try {
			PhaseTapChangerLinearBusinessDelegate.getPhaseTapChangerLinearInstance().assignStepPhaseShiftIncrement( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignStepPhaseShiftIncrement( @RequestBody(required=true)  UnAssignStepPhaseShiftIncrementFromPhaseTapChangerLinearCommand command ) {
		try {
			PhaseTapChangerLinearBusinessDelegate.getPhaseTapChangerLinearInstance().unAssignStepPhaseShiftIncrement( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignXMax( @RequestBody(required=true)  UnAssignXMaxFromPhaseTapChangerLinearCommand command ) {
		try {
			PhaseTapChangerLinearBusinessDelegate.getPhaseTapChangerLinearInstance().unAssignXMax( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignXMin( @RequestBody(required=true)  UnAssignXMinFromPhaseTapChangerLinearCommand command ) {
		try {
			PhaseTapChangerLinearBusinessDelegate.getPhaseTapChangerLinearInstance().unAssignXMin( command );   
		}
		catch( Exception exc ) {
