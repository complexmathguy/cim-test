...
public class BoundaryExtensionsCommandRestController extends BaseSpringRestController {
	...
	public void assignBoundaryPoint( @RequestBody AssignBoundaryPointToBoundaryExtensionsCommand command ) {
		try {
			BoundaryExtensionsBusinessDelegate.getBoundaryExtensionsInstance().assignBoundaryPoint( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBoundaryPoint( @RequestBody(required=true)  UnAssignBoundaryPointFromBoundaryExtensionsCommand command ) {
		try {
			BoundaryExtensionsBusinessDelegate.getBoundaryExtensionsInstance().unAssignBoundaryPoint( command );   
		}
		catch( Exception exc ) {
	...
	public void assignFromEndIsoCode( @RequestBody AssignFromEndIsoCodeToBoundaryExtensionsCommand command ) {
		try {
			BoundaryExtensionsBusinessDelegate.getBoundaryExtensionsInstance().assignFromEndIsoCode( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignFromEndIsoCode( @RequestBody(required=true)  UnAssignFromEndIsoCodeFromBoundaryExtensionsCommand command ) {
		try {
			BoundaryExtensionsBusinessDelegate.getBoundaryExtensionsInstance().unAssignFromEndIsoCode( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignFromEndName( @RequestBody(required=true)  UnAssignFromEndNameFromBoundaryExtensionsCommand command ) {
		try {
			BoundaryExtensionsBusinessDelegate.getBoundaryExtensionsInstance().unAssignFromEndName( command );   
		}
		catch( Exception exc ) {
	...
	public void assignFromEndNameTso( @RequestBody AssignFromEndNameTsoToBoundaryExtensionsCommand command ) {
		try {
			BoundaryExtensionsBusinessDelegate.getBoundaryExtensionsInstance().assignFromEndNameTso( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignFromEndNameTso( @RequestBody(required=true)  UnAssignFromEndNameTsoFromBoundaryExtensionsCommand command ) {
		try {
			BoundaryExtensionsBusinessDelegate.getBoundaryExtensionsInstance().unAssignFromEndNameTso( command );   
		}
		catch( Exception exc ) {
	...
	public void assignToEndIsoCode( @RequestBody AssignToEndIsoCodeToBoundaryExtensionsCommand command ) {
		try {
			BoundaryExtensionsBusinessDelegate.getBoundaryExtensionsInstance().assignToEndIsoCode( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignToEndIsoCode( @RequestBody(required=true)  UnAssignToEndIsoCodeFromBoundaryExtensionsCommand command ) {
		try {
			BoundaryExtensionsBusinessDelegate.getBoundaryExtensionsInstance().unAssignToEndIsoCode( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignToEndName( @RequestBody(required=true)  UnAssignToEndNameFromBoundaryExtensionsCommand command ) {
		try {
	...
	public void assignToEndNameTso( @RequestBody AssignToEndNameTsoToBoundaryExtensionsCommand command ) {
		try {
			BoundaryExtensionsBusinessDelegate.getBoundaryExtensionsInstance().assignToEndNameTso( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignToEndNameTso( @RequestBody(required=true)  UnAssignToEndNameTsoFromBoundaryExtensionsCommand command ) {
		try {
			BoundaryExtensionsBusinessDelegate.getBoundaryExtensionsInstance().unAssignToEndNameTso( command );   
		}
		catch( Exception exc ) {
