...
public class PFVArType2Common1CommandRestController extends BaseSpringRestController {
	...
	public void unAssignJ( @RequestBody(required=true)  UnAssignJFromPFVArType2Common1Command command ) {
		try {
	...
	public void unAssignKi( @RequestBody(required=true)  UnAssignKiFromPFVArType2Common1Command command ) {
		try {
	...
	public void unAssignKp( @RequestBody(required=true)  UnAssignKpFromPFVArType2Common1Command command ) {
		try {
	...
	public void unAssignMax( @RequestBody(required=true)  UnAssignMaxFromPFVArType2Common1Command command ) {
		try {
	...
	public void unAssignRef( @RequestBody(required=true)  UnAssignRefFromPFVArType2Common1Command command ) {
		try {
