...
public class ExcitationSystemUserDefinedCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save Proprietary on ExcitationSystemUserDefined
     * @param		command AssignProprietaryToExcitationSystemUserDefinedCommand
     */     
	@PutMapping("/assignProprietary")
	public void assignProprietary( @RequestBody AssignProprietaryToExcitationSystemUserDefinedCommand command ) {
		try {
			ExcitationSystemUserDefinedBusinessDelegate.getExcitationSystemUserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromExcitationSystemUserDefinedCommand command ) {
		try {
			ExcitationSystemUserDefinedBusinessDelegate.getExcitationSystemUserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
