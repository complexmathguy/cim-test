...
public class ExcIEEEDC4BCommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfd1( @RequestBody(required=true)  UnAssignEfd1FromExcIEEEDC4BCommand command ) {
		try {
	...
	public void unAssignEfd2( @RequestBody(required=true)  UnAssignEfd2FromExcIEEEDC4BCommand command ) {
		try {
	...
	public void unAssignOelin( @RequestBody(required=true)  UnAssignOelinFromExcIEEEDC4BCommand command ) {
		try {
	...
	public void unAssignSeefd1( @RequestBody(required=true)  UnAssignSeefd1FromExcIEEEDC4BCommand command ) {
		try {
	...
	public void unAssignSeefd2( @RequestBody(required=true)  UnAssignSeefd2FromExcIEEEDC4BCommand command ) {
		try {
	...
	public void unAssignUelin( @RequestBody(required=true)  UnAssignUelinFromExcIEEEDC4BCommand command ) {
		try {
	...
	public void unAssignVemin( @RequestBody(required=true)  UnAssignVeminFromExcIEEEDC4BCommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEDC4BCommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEDC4BCommand command ) {
		try {
