...
public class ACDCConverterCommandRestController extends BaseSpringRestController {
	...
	public void unAssignBaseS( @RequestBody(required=true)  UnAssignBaseSFromACDCConverterCommand command ) {
		try {
	...
	public void unAssignIdleLoss( @RequestBody(required=true)  UnAssignIdleLossFromACDCConverterCommand command ) {
		try {
	...
	public void unAssignMaxUdc( @RequestBody(required=true)  UnAssignMaxUdcFromACDCConverterCommand command ) {
		try {
	...
	public void unAssignMinUdc( @RequestBody(required=true)  UnAssignMinUdcFromACDCConverterCommand command ) {
		try {
	...
	public void assignNumberOfValves( @RequestBody AssignNumberOfValvesToACDCConverterCommand command ) {
		try {
	...
	public void unAssignNumberOfValves( @RequestBody(required=true)  UnAssignNumberOfValvesFromACDCConverterCommand command ) {
		try {
	...
	public void unAssignRatedUdc( @RequestBody(required=true)  UnAssignRatedUdcFromACDCConverterCommand command ) {
		try {
	...
	public void unAssignResistiveLoss( @RequestBody(required=true)  UnAssignResistiveLossFromACDCConverterCommand command ) {
		try {
	...
	public void unAssignSwitchingLoss( @RequestBody(required=true)  UnAssignSwitchingLossFromACDCConverterCommand command ) {
		try {
	...
	public void unAssignValveU0( @RequestBody(required=true)  UnAssignValveU0FromACDCConverterCommand command ) {
		try {
