...
public class PowerTransformerCommandRestController extends BaseSpringRestController {
	...
	public void assignBeforeShCircuitHighestOperatingCurrent( @RequestBody AssignBeforeShCircuitHighestOperatingCurrentToPowerTransformerCommand command ) {
		try {
			PowerTransformerBusinessDelegate.getPowerTransformerInstance().assignBeforeShCircuitHighestOperatingCurrent( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBeforeShCircuitHighestOperatingCurrent( @RequestBody(required=true)  UnAssignBeforeShCircuitHighestOperatingCurrentFromPowerTransformerCommand command ) {
		try {
			PowerTransformerBusinessDelegate.getPowerTransformerInstance().unAssignBeforeShCircuitHighestOperatingCurrent( command );   
		}
		catch( Exception exc ) {
	...
	public void assignBeforeShCircuitHighestOperatingVoltage( @RequestBody AssignBeforeShCircuitHighestOperatingVoltageToPowerTransformerCommand command ) {
		try {
			PowerTransformerBusinessDelegate.getPowerTransformerInstance().assignBeforeShCircuitHighestOperatingVoltage( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBeforeShCircuitHighestOperatingVoltage( @RequestBody(required=true)  UnAssignBeforeShCircuitHighestOperatingVoltageFromPowerTransformerCommand command ) {
		try {
			PowerTransformerBusinessDelegate.getPowerTransformerInstance().unAssignBeforeShCircuitHighestOperatingVoltage( command );   
		}
		catch( Exception exc ) {
	...
	public void assignBeforeShortCircuitAnglePf( @RequestBody AssignBeforeShortCircuitAnglePfToPowerTransformerCommand command ) {
		try {
			PowerTransformerBusinessDelegate.getPowerTransformerInstance().assignBeforeShortCircuitAnglePf( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBeforeShortCircuitAnglePf( @RequestBody(required=true)  UnAssignBeforeShortCircuitAnglePfFromPowerTransformerCommand command ) {
		try {
			PowerTransformerBusinessDelegate.getPowerTransformerInstance().unAssignBeforeShortCircuitAnglePf( command );   
		}
		catch( Exception exc ) {
	...
	public void assignHighSideMinOperatingU( @RequestBody AssignHighSideMinOperatingUToPowerTransformerCommand command ) {
		try {
			PowerTransformerBusinessDelegate.getPowerTransformerInstance().assignHighSideMinOperatingU( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignHighSideMinOperatingU( @RequestBody(required=true)  UnAssignHighSideMinOperatingUFromPowerTransformerCommand command ) {
		try {
			PowerTransformerBusinessDelegate.getPowerTransformerInstance().unAssignHighSideMinOperatingU( command );   
		}
		catch( Exception exc ) {
	...
	public void assignPartOfGeneratorUnitFlag( @RequestBody AssignPartOfGeneratorUnitFlagToPowerTransformerCommand command ) {
		try {
			PowerTransformerBusinessDelegate.getPowerTransformerInstance().assignPartOfGeneratorUnitFlag( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPartOfGeneratorUnitFlag( @RequestBody(required=true)  UnAssignPartOfGeneratorUnitFlagFromPowerTransformerCommand command ) {
		try {
			PowerTransformerBusinessDelegate.getPowerTransformerInstance().unAssignPartOfGeneratorUnitFlag( command );   
		}
		catch( Exception exc ) {
	...
	public void assignOperationalValuesConsidered( @RequestBody AssignOperationalValuesConsideredToPowerTransformerCommand command ) {
		try {
			PowerTransformerBusinessDelegate.getPowerTransformerInstance().assignOperationalValuesConsidered( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignOperationalValuesConsidered( @RequestBody(required=true)  UnAssignOperationalValuesConsideredFromPowerTransformerCommand command ) {
		try {
			PowerTransformerBusinessDelegate.getPowerTransformerInstance().unAssignOperationalValuesConsidered( command );   
		}
		catch( Exception exc ) {
