...
public class TopologicalNodeCommandRestController extends BaseSpringRestController {
	...
	public void assignBoundaryPoint( @RequestBody AssignBoundaryPointToTopologicalNodeCommand command ) {
		try {
	...
	public void unAssignBoundaryPoint( @RequestBody(required=true)  UnAssignBoundaryPointFromTopologicalNodeCommand command ) {
		try {
	...
	public void assignFromEndIsoCode( @RequestBody AssignFromEndIsoCodeToTopologicalNodeCommand command ) {
		try {
	...
	public void unAssignFromEndIsoCode( @RequestBody(required=true)  UnAssignFromEndIsoCodeFromTopologicalNodeCommand command ) {
		try {
	...
	public void unAssignFromEndName( @RequestBody(required=true)  UnAssignFromEndNameFromTopologicalNodeCommand command ) {
		try {
	...
	public void assignFromEndNameTso( @RequestBody AssignFromEndNameTsoToTopologicalNodeCommand command ) {
		try {
	...
	public void unAssignFromEndNameTso( @RequestBody(required=true)  UnAssignFromEndNameTsoFromTopologicalNodeCommand command ) {
		try {
	...
	public void unAssignToEndIsoCode( @RequestBody(required=true)  UnAssignToEndIsoCodeFromTopologicalNodeCommand command ) {
		try {
	...
	public void unAssignToEndName( @RequestBody(required=true)  UnAssignToEndNameFromTopologicalNodeCommand command ) {
		try {
	...
	public void unAssignToEndNameTso( @RequestBody(required=true)  UnAssignToEndNameTsoFromTopologicalNodeCommand command ) {
		try {
