...
public class VCompIEEEType1CommandRestController extends BaseSpringRestController {
	...
	public void unAssignRc( @RequestBody(required=true)  UnAssignRcFromVCompIEEEType1Command command ) {
		try {
	...
	public void unAssignTr( @RequestBody(required=true)  UnAssignTrFromVCompIEEEType1Command command ) {
		try {
	...
	public void unAssignXc( @RequestBody(required=true)  UnAssignXcFromVCompIEEEType1Command command ) {
		try {
