...
public class AsynchronousMachineTimeConstantReactanceCommandRestController extends BaseSpringRestController {
	...
	public void assignTpo( @RequestBody AssignTpoToAsynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			AsynchronousMachineTimeConstantReactanceBusinessDelegate.getAsynchronousMachineTimeConstantReactanceInstance().assignTpo( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTpo( @RequestBody(required=true)  UnAssignTpoFromAsynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			AsynchronousMachineTimeConstantReactanceBusinessDelegate.getAsynchronousMachineTimeConstantReactanceInstance().unAssignTpo( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTppo( @RequestBody AssignTppoToAsynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			AsynchronousMachineTimeConstantReactanceBusinessDelegate.getAsynchronousMachineTimeConstantReactanceInstance().assignTppo( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTppo( @RequestBody(required=true)  UnAssignTppoFromAsynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			AsynchronousMachineTimeConstantReactanceBusinessDelegate.getAsynchronousMachineTimeConstantReactanceInstance().unAssignTppo( command );   
		}
		catch( Exception exc ) {
     ...
     */     
	@PutMapping("/assignXp")
	public void assignXp( @RequestBody AssignXpToAsynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			AsynchronousMachineTimeConstantReactanceBusinessDelegate.getAsynchronousMachineTimeConstantReactanceInstance().assignXp( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXp( @RequestBody(required=true)  UnAssignXpFromAsynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			AsynchronousMachineTimeConstantReactanceBusinessDelegate.getAsynchronousMachineTimeConstantReactanceInstance().unAssignXp( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXpp( @RequestBody AssignXppToAsynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			AsynchronousMachineTimeConstantReactanceBusinessDelegate.getAsynchronousMachineTimeConstantReactanceInstance().assignXpp( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXpp( @RequestBody(required=true)  UnAssignXppFromAsynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			AsynchronousMachineTimeConstantReactanceBusinessDelegate.getAsynchronousMachineTimeConstantReactanceInstance().unAssignXpp( command );   
		}
		catch( Exception exc ) {
     ...
     */     
	@PutMapping("/assignXs")
	public void assignXs( @RequestBody AssignXsToAsynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			AsynchronousMachineTimeConstantReactanceBusinessDelegate.getAsynchronousMachineTimeConstantReactanceInstance().assignXs( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXs( @RequestBody(required=true)  UnAssignXsFromAsynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			AsynchronousMachineTimeConstantReactanceBusinessDelegate.getAsynchronousMachineTimeConstantReactanceInstance().unAssignXs( command );   
		}
		catch( Exception exc ) {
