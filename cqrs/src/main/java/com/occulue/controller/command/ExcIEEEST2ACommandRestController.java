...
public class ExcIEEEST2ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfdmax( @RequestBody(required=true)  UnAssignEfdmaxFromExcIEEEST2ACommand command ) {
		try {
	...
	public void unAssignUelin( @RequestBody(required=true)  UnAssignUelinFromExcIEEEST2ACommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEST2ACommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEST2ACommand command ) {
		try {
