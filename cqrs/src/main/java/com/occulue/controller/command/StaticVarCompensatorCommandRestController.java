...
public class StaticVarCompensatorCommandRestController extends BaseSpringRestController {
	...
	public void assignCapacitiveRating( @RequestBody AssignCapacitiveRatingToStaticVarCompensatorCommand command ) {
		try {
			StaticVarCompensatorBusinessDelegate.getStaticVarCompensatorInstance().assignCapacitiveRating( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignCapacitiveRating( @RequestBody(required=true)  UnAssignCapacitiveRatingFromStaticVarCompensatorCommand command ) {
		try {
			StaticVarCompensatorBusinessDelegate.getStaticVarCompensatorInstance().unAssignCapacitiveRating( command );   
		}
		catch( Exception exc ) {
	...
	public void assignInductiveRating( @RequestBody AssignInductiveRatingToStaticVarCompensatorCommand command ) {
		try {
			StaticVarCompensatorBusinessDelegate.getStaticVarCompensatorInstance().assignInductiveRating( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignInductiveRating( @RequestBody(required=true)  UnAssignInductiveRatingFromStaticVarCompensatorCommand command ) {
		try {
			StaticVarCompensatorBusinessDelegate.getStaticVarCompensatorInstance().unAssignInductiveRating( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignSlope( @RequestBody(required=true)  UnAssignSlopeFromStaticVarCompensatorCommand command ) {
		try {
	...
	public void assignVoltageSetPoint( @RequestBody AssignVoltageSetPointToStaticVarCompensatorCommand command ) {
		try {
			StaticVarCompensatorBusinessDelegate.getStaticVarCompensatorInstance().assignVoltageSetPoint( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVoltageSetPoint( @RequestBody(required=true)  UnAssignVoltageSetPointFromStaticVarCompensatorCommand command ) {
		try {
			StaticVarCompensatorBusinessDelegate.getStaticVarCompensatorInstance().unAssignVoltageSetPoint( command );   
		}
		catch( Exception exc ) {
