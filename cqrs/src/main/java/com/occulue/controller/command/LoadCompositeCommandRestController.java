...
public class LoadCompositeCommandRestController extends BaseSpringRestController {
	...
	public void unAssignEpfd( @RequestBody(required=true)  UnAssignEpfdFromLoadCompositeCommand command ) {
		try {
	...
	public void unAssignEpfs( @RequestBody(required=true)  UnAssignEpfsFromLoadCompositeCommand command ) {
		try {
	...
	public void unAssignEpvd( @RequestBody(required=true)  UnAssignEpvdFromLoadCompositeCommand command ) {
		try {
	...
	public void unAssignEpvs( @RequestBody(required=true)  UnAssignEpvsFromLoadCompositeCommand command ) {
		try {
	...
	public void unAssignEqfd( @RequestBody(required=true)  UnAssignEqfdFromLoadCompositeCommand command ) {
		try {
	...
	public void unAssignEqfs( @RequestBody(required=true)  UnAssignEqfsFromLoadCompositeCommand command ) {
		try {
	...
	public void unAssignEqvd( @RequestBody(required=true)  UnAssignEqvdFromLoadCompositeCommand command ) {
		try {
	...
	public void unAssignEqvs( @RequestBody(required=true)  UnAssignEqvsFromLoadCompositeCommand command ) {
		try {
	...
	public void unAssignLfrac( @RequestBody(required=true)  UnAssignLfracFromLoadCompositeCommand command ) {
		try {
	...
	public void unAssignPfrac( @RequestBody(required=true)  UnAssignPfracFromLoadCompositeCommand command ) {
		try {
