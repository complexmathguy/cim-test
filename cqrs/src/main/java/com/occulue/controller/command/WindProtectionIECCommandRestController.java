...
public class WindProtectionIECCommandRestController extends BaseSpringRestController {
	...
	public void unAssignFover( @RequestBody(required=true)  UnAssignFoverFromWindProtectionIECCommand command ) {
		try {
	...
	public void unAssignFunder( @RequestBody(required=true)  UnAssignFunderFromWindProtectionIECCommand command ) {
		try {
	...
	public void unAssignTfover( @RequestBody(required=true)  UnAssignTfoverFromWindProtectionIECCommand command ) {
		try {
	...
	public void unAssignTfunder( @RequestBody(required=true)  UnAssignTfunderFromWindProtectionIECCommand command ) {
		try {
	...
	public void unAssignTuover( @RequestBody(required=true)  UnAssignTuoverFromWindProtectionIECCommand command ) {
		try {
	...
	public void unAssignTuunder( @RequestBody(required=true)  UnAssignTuunderFromWindProtectionIECCommand command ) {
		try {
	...
	public void unAssignUover( @RequestBody(required=true)  UnAssignUoverFromWindProtectionIECCommand command ) {
		try {
	...
	public void unAssignUunder( @RequestBody(required=true)  UnAssignUunderFromWindProtectionIECCommand command ) {
		try {
