...
public class ExcIEEEDC3ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfd1( @RequestBody(required=true)  UnAssignEfd1FromExcIEEEDC3ACommand command ) {
		try {
	...
	public void unAssignEfd2( @RequestBody(required=true)  UnAssignEfd2FromExcIEEEDC3ACommand command ) {
		try {
	...
	public void unAssignExclim( @RequestBody(required=true)  UnAssignExclimFromExcIEEEDC3ACommand command ) {
		try {
	...
	public void unAssignSeefd1( @RequestBody(required=true)  UnAssignSeefd1FromExcIEEEDC3ACommand command ) {
		try {
	...
	public void unAssignSeefd2( @RequestBody(required=true)  UnAssignSeefd2FromExcIEEEDC3ACommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEDC3ACommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEDC3ACommand command ) {
		try {
