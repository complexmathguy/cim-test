...
public class SynchronousMachineCommandRestController extends BaseSpringRestController {
	...
	public void unAssignEarthing( @RequestBody(required=true)  UnAssignEarthingFromSynchronousMachineCommand command ) {
		try {
	...
	public void assignEarthingStarPointR( @RequestBody AssignEarthingStarPointRToSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().assignEarthingStarPointR( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEarthingStarPointR( @RequestBody(required=true)  UnAssignEarthingStarPointRFromSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().unAssignEarthingStarPointR( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEarthingStarPointX( @RequestBody AssignEarthingStarPointXToSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().assignEarthingStarPointX( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEarthingStarPointX( @RequestBody(required=true)  UnAssignEarthingStarPointXFromSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().unAssignEarthingStarPointX( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignIkk( @RequestBody(required=true)  UnAssignIkkFromSynchronousMachineCommand command ) {
		try {
	...
	public void unAssignMaxQ( @RequestBody(required=true)  UnAssignMaxQFromSynchronousMachineCommand command ) {
		try {
	...
	public void unAssignMinQ( @RequestBody(required=true)  UnAssignMinQFromSynchronousMachineCommand command ) {
		try {
	...
	public void unAssignMu( @RequestBody(required=true)  UnAssignMuFromSynchronousMachineCommand command ) {
		try {
	...
	public void unAssignQPercent( @RequestBody(required=true)  UnAssignQPercentFromSynchronousMachineCommand command ) {
		try {
	...
	public void unAssignR( @RequestBody(required=true)  UnAssignRFromSynchronousMachineCommand command ) {
		try {
	...
	public void unAssignR0( @RequestBody(required=true)  UnAssignR0FromSynchronousMachineCommand command ) {
		try {
	...
	public void unAssignR2( @RequestBody(required=true)  UnAssignR2FromSynchronousMachineCommand command ) {
		try {
	...
	public void assignSatDirectSubtransX( @RequestBody AssignSatDirectSubtransXToSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().assignSatDirectSubtransX( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignSatDirectSubtransX( @RequestBody(required=true)  UnAssignSatDirectSubtransXFromSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().unAssignSatDirectSubtransX( command );   
		}
		catch( Exception exc ) {
	...
	public void assignSatDirectSyncX( @RequestBody AssignSatDirectSyncXToSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().assignSatDirectSyncX( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignSatDirectSyncX( @RequestBody(required=true)  UnAssignSatDirectSyncXFromSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().unAssignSatDirectSyncX( command );   
		}
		catch( Exception exc ) {
	...
	public void assignSatDirectTransX( @RequestBody AssignSatDirectTransXToSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().assignSatDirectTransX( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignSatDirectTransX( @RequestBody(required=true)  UnAssignSatDirectTransXFromSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().unAssignSatDirectTransX( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVoltageRegulationRange( @RequestBody AssignVoltageRegulationRangeToSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().assignVoltageRegulationRange( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVoltageRegulationRange( @RequestBody(required=true)  UnAssignVoltageRegulationRangeFromSynchronousMachineCommand command ) {
		try {
			SynchronousMachineBusinessDelegate.getSynchronousMachineInstance().unAssignVoltageRegulationRange( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignX0( @RequestBody(required=true)  UnAssignX0FromSynchronousMachineCommand command ) {
		try {
	...
	public void unAssignX2( @RequestBody(required=true)  UnAssignX2FromSynchronousMachineCommand command ) {
		try {
