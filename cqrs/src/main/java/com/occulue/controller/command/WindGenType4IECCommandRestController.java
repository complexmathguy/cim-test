...
public class WindGenType4IECCommandRestController extends BaseSpringRestController {
	...
	public void unAssignDipmax( @RequestBody(required=true)  UnAssignDipmaxFromWindGenType4IECCommand command ) {
		try {
	...
	public void unAssignDiqmax( @RequestBody(required=true)  UnAssignDiqmaxFromWindGenType4IECCommand command ) {
		try {
	...
	public void unAssignDiqmin( @RequestBody(required=true)  UnAssignDiqminFromWindGenType4IECCommand command ) {
		try {
	...
	public void unAssignTg( @RequestBody(required=true)  UnAssignTgFromWindGenType4IECCommand command ) {
		try {
