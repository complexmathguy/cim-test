...
public class DiagramCommandRestController extends BaseSpringRestController {
	...
	public void unAssignX1InitialView( @RequestBody(required=true)  UnAssignX1InitialViewFromDiagramCommand command ) {
		try {
	...
	public void unAssignX2InitialView( @RequestBody(required=true)  UnAssignX2InitialViewFromDiagramCommand command ) {
		try {
	...
	public void unAssignY1InitialView( @RequestBody(required=true)  UnAssignY1InitialViewFromDiagramCommand command ) {
		try {
	...
	public void unAssignY2InitialView( @RequestBody(required=true)  UnAssignY2InitialViewFromDiagramCommand command ) {
		try {
