...
public class DCSeriesDeviceCommandRestController extends BaseSpringRestController {
	...
	public void unAssignInductance( @RequestBody(required=true)  UnAssignInductanceFromDCSeriesDeviceCommand command ) {
		try {
	...
	public void unAssignRatedUdc( @RequestBody(required=true)  UnAssignRatedUdcFromDCSeriesDeviceCommand command ) {
		try {
	...
	public void unAssignResistance( @RequestBody(required=true)  UnAssignResistanceFromDCSeriesDeviceCommand command ) {
		try {
