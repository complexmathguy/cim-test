...
public class IdentifiedObjectCommandRestController extends BaseSpringRestController {
	...
	public void unAssignDescription( @RequestBody(required=true)  UnAssignDescriptionFromIdentifiedObjectCommand command ) {
		try {
	...
	public void assignEnergyIdentCodeEic( @RequestBody AssignEnergyIdentCodeEicToIdentifiedObjectCommand command ) {
		try {
			IdentifiedObjectBusinessDelegate.getIdentifiedObjectInstance().assignEnergyIdentCodeEic( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEnergyIdentCodeEic( @RequestBody(required=true)  UnAssignEnergyIdentCodeEicFromIdentifiedObjectCommand command ) {
		try {
			IdentifiedObjectBusinessDelegate.getIdentifiedObjectInstance().unAssignEnergyIdentCodeEic( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignMRID( @RequestBody(required=true)  UnAssignMRIDFromIdentifiedObjectCommand command ) {
		try {
	...
	public void unAssignName( @RequestBody(required=true)  UnAssignNameFromIdentifiedObjectCommand command ) {
		try {
	...
	public void unAssignShortName( @RequestBody(required=true)  UnAssignShortNameFromIdentifiedObjectCommand command ) {
		try {
