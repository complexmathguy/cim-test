...
public class PetersenCoilCommandRestController extends BaseSpringRestController {
	...
	public void unAssignNominalU( @RequestBody(required=true)  UnAssignNominalUFromPetersenCoilCommand command ) {
		try {
	...
	public void unAssignOffsetCurrent( @RequestBody(required=true)  UnAssignOffsetCurrentFromPetersenCoilCommand command ) {
		try {
	...
	public void assignPositionCurrent( @RequestBody AssignPositionCurrentToPetersenCoilCommand command ) {
		try {
	...
	public void unAssignPositionCurrent( @RequestBody(required=true)  UnAssignPositionCurrentFromPetersenCoilCommand command ) {
		try {
	...
	public void unAssignXGroundMax( @RequestBody(required=true)  UnAssignXGroundMaxFromPetersenCoilCommand command ) {
		try {
	...
	public void unAssignXGroundMin( @RequestBody(required=true)  UnAssignXGroundMinFromPetersenCoilCommand command ) {
		try {
	...
	public void unAssignXGroundNominal( @RequestBody(required=true)  UnAssignXGroundNominalFromPetersenCoilCommand command ) {
		try {
