...
public class GovHydroPIDCommandRestController extends BaseSpringRestController {
	...
	public void unAssignAturb( @RequestBody(required=true)  UnAssignAturbFromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignBturb( @RequestBody(required=true)  UnAssignBturbFromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignInputSignal( @RequestBody(required=true)  UnAssignInputSignalFromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignPgv1( @RequestBody(required=true)  UnAssignPgv1FromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignPgv2( @RequestBody(required=true)  UnAssignPgv2FromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignPgv3( @RequestBody(required=true)  UnAssignPgv3FromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignPgv4( @RequestBody(required=true)  UnAssignPgv4FromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignPgv5( @RequestBody(required=true)  UnAssignPgv5FromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignPgv6( @RequestBody(required=true)  UnAssignPgv6FromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignPmax( @RequestBody(required=true)  UnAssignPmaxFromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignPmin( @RequestBody(required=true)  UnAssignPminFromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignTturb( @RequestBody(required=true)  UnAssignTturbFromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignVelcl( @RequestBody(required=true)  UnAssignVelclFromGovHydroPIDCommand command ) {
		try {
	...
	public void unAssignVelop( @RequestBody(required=true)  UnAssignVelopFromGovHydroPIDCommand command ) {
		try {
