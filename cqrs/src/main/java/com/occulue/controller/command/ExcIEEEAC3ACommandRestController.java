...
public class ExcIEEEAC3ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfdn( @RequestBody(required=true)  UnAssignEfdnFromExcIEEEAC3ACommand command ) {
		try {
	...
	public void unAssignSeve1( @RequestBody(required=true)  UnAssignSeve1FromExcIEEEAC3ACommand command ) {
		try {
	...
	public void unAssignSeve2( @RequestBody(required=true)  UnAssignSeve2FromExcIEEEAC3ACommand command ) {
		try {
	...
	public void unAssignVamax( @RequestBody(required=true)  UnAssignVamaxFromExcIEEEAC3ACommand command ) {
		try {
	...
	public void unAssignVamin( @RequestBody(required=true)  UnAssignVaminFromExcIEEEAC3ACommand command ) {
		try {
	...
	public void unAssignVemin( @RequestBody(required=true)  UnAssignVeminFromExcIEEEAC3ACommand command ) {
		try {
	...
	public void unAssignVfemax( @RequestBody(required=true)  UnAssignVfemaxFromExcIEEEAC3ACommand command ) {
		try {
