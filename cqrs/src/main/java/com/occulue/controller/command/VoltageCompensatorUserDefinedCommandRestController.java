...
public class VoltageCompensatorUserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToVoltageCompensatorUserDefinedCommand command ) {
		try {
			VoltageCompensatorUserDefinedBusinessDelegate.getVoltageCompensatorUserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromVoltageCompensatorUserDefinedCommand command ) {
		try {
			VoltageCompensatorUserDefinedBusinessDelegate.getVoltageCompensatorUserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
