...
public class ExcSEXSCommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfdmax( @RequestBody(required=true)  UnAssignEfdmaxFromExcSEXSCommand command ) {
		try {
	...
	public void unAssignEfdmin( @RequestBody(required=true)  UnAssignEfdminFromExcSEXSCommand command ) {
		try {
