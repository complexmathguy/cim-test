...
public class PFVArType1IEEEPFControllerCommandRestController extends BaseSpringRestController {
	...
	public void assignOvex( @RequestBody AssignOvexToPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().assignOvex( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignOvex( @RequestBody(required=true)  UnAssignOvexFromPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().unAssignOvex( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTpfc( @RequestBody AssignTpfcToPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().assignTpfc( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTpfc( @RequestBody(required=true)  UnAssignTpfcFromPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().unAssignTpfc( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVitmin( @RequestBody AssignVitminToPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().assignVitmin( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVitmin( @RequestBody(required=true)  UnAssignVitminFromPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().unAssignVitmin( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVpf( @RequestBody AssignVpfToPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().assignVpf( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVpf( @RequestBody(required=true)  UnAssignVpfFromPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().unAssignVpf( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVpfcbw( @RequestBody AssignVpfcbwToPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().assignVpfcbw( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVpfcbw( @RequestBody(required=true)  UnAssignVpfcbwFromPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().unAssignVpfcbw( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVpfref( @RequestBody AssignVpfrefToPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().assignVpfref( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVpfref( @RequestBody(required=true)  UnAssignVpfrefFromPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().unAssignVpfref( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVvtmax( @RequestBody AssignVvtmaxToPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().assignVvtmax( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVvtmax( @RequestBody(required=true)  UnAssignVvtmaxFromPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().unAssignVvtmax( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVvtmin( @RequestBody AssignVvtminToPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().assignVvtmin( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVvtmin( @RequestBody(required=true)  UnAssignVvtminFromPFVArType1IEEEPFControllerCommand command ) {
		try {
			PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance().unAssignVvtmin( command );   
		}
		catch( Exception exc ) {
