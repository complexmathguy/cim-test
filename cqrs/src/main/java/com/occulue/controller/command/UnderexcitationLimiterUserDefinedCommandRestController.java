...
public class UnderexcitationLimiterUserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToUnderexcitationLimiterUserDefinedCommand command ) {
		try {
			UnderexcitationLimiterUserDefinedBusinessDelegate.getUnderexcitationLimiterUserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromUnderexcitationLimiterUserDefinedCommand command ) {
		try {
			UnderexcitationLimiterUserDefinedBusinessDelegate.getUnderexcitationLimiterUserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
