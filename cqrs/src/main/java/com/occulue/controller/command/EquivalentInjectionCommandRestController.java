...
public class EquivalentInjectionCommandRestController extends BaseSpringRestController {
	...
	public void unAssignMaxP( @RequestBody(required=true)  UnAssignMaxPFromEquivalentInjectionCommand command ) {
		try {
	...
	public void unAssignMaxQ( @RequestBody(required=true)  UnAssignMaxQFromEquivalentInjectionCommand command ) {
		try {
	...
	public void unAssignMinP( @RequestBody(required=true)  UnAssignMinPFromEquivalentInjectionCommand command ) {
		try {
	...
	public void unAssignMinQ( @RequestBody(required=true)  UnAssignMinQFromEquivalentInjectionCommand command ) {
		try {
	...
	public void unAssignR( @RequestBody(required=true)  UnAssignRFromEquivalentInjectionCommand command ) {
		try {
	...
	public void unAssignR0( @RequestBody(required=true)  UnAssignR0FromEquivalentInjectionCommand command ) {
		try {
	...
	public void unAssignR2( @RequestBody(required=true)  UnAssignR2FromEquivalentInjectionCommand command ) {
		try {
	...
	public void assignRegulationCapability( @RequestBody AssignRegulationCapabilityToEquivalentInjectionCommand command ) {
		try {
			EquivalentInjectionBusinessDelegate.getEquivalentInjectionInstance().assignRegulationCapability( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignRegulationCapability( @RequestBody(required=true)  UnAssignRegulationCapabilityFromEquivalentInjectionCommand command ) {
		try {
			EquivalentInjectionBusinessDelegate.getEquivalentInjectionInstance().unAssignRegulationCapability( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignX( @RequestBody(required=true)  UnAssignXFromEquivalentInjectionCommand command ) {
		try {
	...
	public void unAssignX0( @RequestBody(required=true)  UnAssignX0FromEquivalentInjectionCommand command ) {
		try {
	...
	public void unAssignX2( @RequestBody(required=true)  UnAssignX2FromEquivalentInjectionCommand command ) {
		try {
