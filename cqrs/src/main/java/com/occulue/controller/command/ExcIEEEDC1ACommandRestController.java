...
public class ExcIEEEDC1ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfd1( @RequestBody(required=true)  UnAssignEfd1FromExcIEEEDC1ACommand command ) {
		try {
	...
	public void unAssignEfd2( @RequestBody(required=true)  UnAssignEfd2FromExcIEEEDC1ACommand command ) {
		try {
	...
	public void unAssignExclim( @RequestBody(required=true)  UnAssignExclimFromExcIEEEDC1ACommand command ) {
		try {
	...
	public void unAssignSeefd1( @RequestBody(required=true)  UnAssignSeefd1FromExcIEEEDC1ACommand command ) {
		try {
	...
	public void unAssignSeefd2( @RequestBody(required=true)  UnAssignSeefd2FromExcIEEEDC1ACommand command ) {
		try {
	...
	public void unAssignUelin( @RequestBody(required=true)  UnAssignUelinFromExcIEEEDC1ACommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEDC1ACommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEDC1ACommand command ) {
		try {
