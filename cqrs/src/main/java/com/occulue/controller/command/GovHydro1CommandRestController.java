...
public class GovHydro1CommandRestController extends BaseSpringRestController {
	...
	public void unAssignDturb( @RequestBody(required=true)  UnAssignDturbFromGovHydro1Command command ) {
		try {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovHydro1Command command ) {
		try {
	...
	public void unAssignRperm( @RequestBody(required=true)  UnAssignRpermFromGovHydro1Command command ) {
		try {
	...
	public void unAssignRtemp( @RequestBody(required=true)  UnAssignRtempFromGovHydro1Command command ) {
		try {
