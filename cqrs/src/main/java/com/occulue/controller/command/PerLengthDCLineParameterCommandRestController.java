...
public class PerLengthDCLineParameterCommandRestController extends BaseSpringRestController {
	...
	public void assignCapacitance( @RequestBody AssignCapacitanceToPerLengthDCLineParameterCommand command ) {
		try {
			PerLengthDCLineParameterBusinessDelegate.getPerLengthDCLineParameterInstance().assignCapacitance( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignCapacitance( @RequestBody(required=true)  UnAssignCapacitanceFromPerLengthDCLineParameterCommand command ) {
		try {
			PerLengthDCLineParameterBusinessDelegate.getPerLengthDCLineParameterInstance().unAssignCapacitance( command );   
		}
		catch( Exception exc ) {
	...
	public void assignInductance( @RequestBody AssignInductanceToPerLengthDCLineParameterCommand command ) {
		try {
			PerLengthDCLineParameterBusinessDelegate.getPerLengthDCLineParameterInstance().assignInductance( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignInductance( @RequestBody(required=true)  UnAssignInductanceFromPerLengthDCLineParameterCommand command ) {
		try {
			PerLengthDCLineParameterBusinessDelegate.getPerLengthDCLineParameterInstance().unAssignInductance( command );   
		}
		catch( Exception exc ) {
	...
	public void assignResistance( @RequestBody AssignResistanceToPerLengthDCLineParameterCommand command ) {
		try {
			PerLengthDCLineParameterBusinessDelegate.getPerLengthDCLineParameterInstance().assignResistance( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignResistance( @RequestBody(required=true)  UnAssignResistanceFromPerLengthDCLineParameterCommand command ) {
		try {
			PerLengthDCLineParameterBusinessDelegate.getPerLengthDCLineParameterInstance().unAssignResistance( command );   
		}
		catch( Exception exc ) {
