...
public class ExcDC2ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignExclim( @RequestBody(required=true)  UnAssignExclimFromExcDC2ACommand command ) {
		try {
	...
	public void unAssignSeefd1( @RequestBody(required=true)  UnAssignSeefd1FromExcDC2ACommand command ) {
		try {
	...
	public void unAssignSeefd2( @RequestBody(required=true)  UnAssignSeefd2FromExcDC2ACommand command ) {
		try {
