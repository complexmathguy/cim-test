...
public class TurbineGovernorUserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToTurbineGovernorUserDefinedCommand command ) {
		try {
			TurbineGovernorUserDefinedBusinessDelegate.getTurbineGovernorUserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromTurbineGovernorUserDefinedCommand command ) {
		try {
			TurbineGovernorUserDefinedBusinessDelegate.getTurbineGovernorUserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
