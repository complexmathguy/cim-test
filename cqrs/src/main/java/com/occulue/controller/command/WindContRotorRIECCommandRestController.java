...
public class WindContRotorRIECCommandRestController extends BaseSpringRestController {
	...
	public void unAssignKirr( @RequestBody(required=true)  UnAssignKirrFromWindContRotorRIECCommand command ) {
		try {
	...
	public void unAssignKomegafilt( @RequestBody(required=true)  UnAssignKomegafiltFromWindContRotorRIECCommand command ) {
		try {
	...
	public void unAssignKpfilt( @RequestBody(required=true)  UnAssignKpfiltFromWindContRotorRIECCommand command ) {
		try {
	...
	public void unAssignKprr( @RequestBody(required=true)  UnAssignKprrFromWindContRotorRIECCommand command ) {
		try {
	...
	public void unAssignRmax( @RequestBody(required=true)  UnAssignRmaxFromWindContRotorRIECCommand command ) {
		try {
	...
	public void unAssignRmin( @RequestBody(required=true)  UnAssignRminFromWindContRotorRIECCommand command ) {
		try {
	...
	public void unAssignTomegafilt( @RequestBody(required=true)  UnAssignTomegafiltFromWindContRotorRIECCommand command ) {
		try {
	...
	public void unAssignTpfilt( @RequestBody(required=true)  UnAssignTpfiltFromWindContRotorRIECCommand command ) {
		try {
