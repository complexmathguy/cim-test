...
public class ExcOEX3TCommandRestController extends BaseSpringRestController {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcOEX3TCommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcOEX3TCommand command ) {
		try {
