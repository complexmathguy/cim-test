...
public class RotatingMachineDynamicsCommandRestController extends BaseSpringRestController {
	...
	public void assignDamping( @RequestBody AssignDampingToRotatingMachineDynamicsCommand command ) {
		try {
			RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance().assignDamping( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDamping( @RequestBody(required=true)  UnAssignDampingFromRotatingMachineDynamicsCommand command ) {
		try {
			RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance().unAssignDamping( command );   
		}
		catch( Exception exc ) {
	...
	public void assignInertia( @RequestBody AssignInertiaToRotatingMachineDynamicsCommand command ) {
		try {
			RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance().assignInertia( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignInertia( @RequestBody(required=true)  UnAssignInertiaFromRotatingMachineDynamicsCommand command ) {
		try {
			RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance().unAssignInertia( command );   
		}
		catch( Exception exc ) {
	...
	public void assignSaturationFactor( @RequestBody AssignSaturationFactorToRotatingMachineDynamicsCommand command ) {
		try {
			RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance().assignSaturationFactor( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignSaturationFactor( @RequestBody(required=true)  UnAssignSaturationFactorFromRotatingMachineDynamicsCommand command ) {
		try {
			RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance().unAssignSaturationFactor( command );   
		}
		catch( Exception exc ) {
	...
	public void assignSaturationFactor120( @RequestBody AssignSaturationFactor120ToRotatingMachineDynamicsCommand command ) {
		try {
			RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance().assignSaturationFactor120( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignSaturationFactor120( @RequestBody(required=true)  UnAssignSaturationFactor120FromRotatingMachineDynamicsCommand command ) {
		try {
			RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance().unAssignSaturationFactor120( command );   
		}
		catch( Exception exc ) {
	...
	public void assignStatorLeakageReactance( @RequestBody AssignStatorLeakageReactanceToRotatingMachineDynamicsCommand command ) {
		try {
			RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance().assignStatorLeakageReactance( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignStatorLeakageReactance( @RequestBody(required=true)  UnAssignStatorLeakageReactanceFromRotatingMachineDynamicsCommand command ) {
		try {
			RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance().unAssignStatorLeakageReactance( command );   
		}
		catch( Exception exc ) {
	...
	public void assignStatorResistance( @RequestBody AssignStatorResistanceToRotatingMachineDynamicsCommand command ) {
		try {
			RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance().assignStatorResistance( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignStatorResistance( @RequestBody(required=true)  UnAssignStatorResistanceFromRotatingMachineDynamicsCommand command ) {
		try {
			RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance().unAssignStatorResistance( command );   
		}
		catch( Exception exc ) {
