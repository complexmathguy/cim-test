...
public class SvShuntCompensatorSectionsCommandRestController extends BaseSpringRestController {
	...
	public void assignSections( @RequestBody AssignSectionsToSvShuntCompensatorSectionsCommand command ) {
		try {
			SvShuntCompensatorSectionsBusinessDelegate.getSvShuntCompensatorSectionsInstance().assignSections( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignSections( @RequestBody(required=true)  UnAssignSectionsFromSvShuntCompensatorSectionsCommand command ) {
		try {
			SvShuntCompensatorSectionsBusinessDelegate.getSvShuntCompensatorSectionsInstance().unAssignSections( command );   
		}
		catch( Exception exc ) {
