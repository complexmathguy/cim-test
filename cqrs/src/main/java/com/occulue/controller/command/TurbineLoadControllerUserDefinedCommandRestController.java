...
public class TurbineLoadControllerUserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToTurbineLoadControllerUserDefinedCommand command ) {
		try {
			TurbineLoadControllerUserDefinedBusinessDelegate.getTurbineLoadControllerUserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromTurbineLoadControllerUserDefinedCommand command ) {
		try {
			TurbineLoadControllerUserDefinedBusinessDelegate.getTurbineLoadControllerUserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
