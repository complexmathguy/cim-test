...
public class ExtensionVersionCommandRestController extends BaseSpringRestController {
	...
	public void unAssignDate( @RequestBody(required=true)  UnAssignDateFromExtensionVersionCommand command ) {
		try {
	...
	public void unAssignNamespaceURI( @RequestBody(required=true)  UnAssignNamespaceURIFromExtensionVersionCommand command ) {
		try {
