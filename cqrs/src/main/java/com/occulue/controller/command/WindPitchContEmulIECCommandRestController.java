...
public class WindPitchContEmulIECCommandRestController extends BaseSpringRestController {
	...
	public void unAssignKdroop( @RequestBody(required=true)  UnAssignKdroopFromWindPitchContEmulIECCommand command ) {
		try {
			WindPitchContEmulIECBusinessDelegate.getWindPitchContEmulIECInstance().unAssignKdroop( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignKipce( @RequestBody(required=true)  UnAssignKipceFromWindPitchContEmulIECCommand command ) {
		try {
	...
	public void assignKomegaaero( @RequestBody AssignKomegaaeroToWindPitchContEmulIECCommand command ) {
		try {
			WindPitchContEmulIECBusinessDelegate.getWindPitchContEmulIECInstance().assignKomegaaero( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKomegaaero( @RequestBody(required=true)  UnAssignKomegaaeroFromWindPitchContEmulIECCommand command ) {
		try {
			WindPitchContEmulIECBusinessDelegate.getWindPitchContEmulIECInstance().unAssignKomegaaero( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignKppce( @RequestBody(required=true)  UnAssignKppceFromWindPitchContEmulIECCommand command ) {
		try {
	...
	public void assignOmegaref( @RequestBody AssignOmegarefToWindPitchContEmulIECCommand command ) {
		try {
			WindPitchContEmulIECBusinessDelegate.getWindPitchContEmulIECInstance().assignOmegaref( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignOmegaref( @RequestBody(required=true)  UnAssignOmegarefFromWindPitchContEmulIECCommand command ) {
		try {
			WindPitchContEmulIECBusinessDelegate.getWindPitchContEmulIECInstance().unAssignOmegaref( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignPimax( @RequestBody(required=true)  UnAssignPimaxFromWindPitchContEmulIECCommand command ) {
		try {
	...
	public void unAssignPimin( @RequestBody(required=true)  UnAssignPiminFromWindPitchContEmulIECCommand command ) {
		try {
	...
	public void unAssignT1( @RequestBody(required=true)  UnAssignT1FromWindPitchContEmulIECCommand command ) {
		try {
	...
	public void unAssignT2( @RequestBody(required=true)  UnAssignT2FromWindPitchContEmulIECCommand command ) {
		try {
	...
	public void unAssignTpe( @RequestBody(required=true)  UnAssignTpeFromWindPitchContEmulIECCommand command ) {
		try {
