...
public class PhaseTapChangerAsymmetricalCommandRestController extends BaseSpringRestController {
	...
	public void assignWindingConnectionAngle( @RequestBody AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalCommand command ) {
		try {
			PhaseTapChangerAsymmetricalBusinessDelegate.getPhaseTapChangerAsymmetricalInstance().assignWindingConnectionAngle( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignWindingConnectionAngle( @RequestBody(required=true)  UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalCommand command ) {
		try {
			PhaseTapChangerAsymmetricalBusinessDelegate.getPhaseTapChangerAsymmetricalInstance().unAssignWindingConnectionAngle( command );   
		}
		catch( Exception exc ) {
