...
public class OverexcLimX2CommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfd1( @RequestBody(required=true)  UnAssignEfd1FromOverexcLimX2Command command ) {
		try {
	...
	public void unAssignEfd2( @RequestBody(required=true)  UnAssignEfd2FromOverexcLimX2Command command ) {
		try {
	...
	public void unAssignEfd3( @RequestBody(required=true)  UnAssignEfd3FromOverexcLimX2Command command ) {
		try {
	...
	public void unAssignEfddes( @RequestBody(required=true)  UnAssignEfddesFromOverexcLimX2Command command ) {
		try {
	...
	public void unAssignEfdrated( @RequestBody(required=true)  UnAssignEfdratedFromOverexcLimX2Command command ) {
		try {
	...
	public void unAssignKmx( @RequestBody(required=true)  UnAssignKmxFromOverexcLimX2Command command ) {
		try {
	...
	public void unAssignVlow( @RequestBody(required=true)  UnAssignVlowFromOverexcLimX2Command command ) {
		try {
