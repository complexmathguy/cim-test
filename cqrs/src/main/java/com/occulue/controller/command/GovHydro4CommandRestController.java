...
public class GovHydro4CommandRestController extends BaseSpringRestController {
	...
	public void unAssignDturb( @RequestBody(required=true)  UnAssignDturbFromGovHydro4Command command ) {
		try {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovHydro4Command command ) {
		try {
	...
	public void unAssignRperm( @RequestBody(required=true)  UnAssignRpermFromGovHydro4Command command ) {
		try {
	...
	public void unAssignRtemp( @RequestBody(required=true)  UnAssignRtempFromGovHydro4Command command ) {
		try {
	...
	public void unAssignTblade( @RequestBody(required=true)  UnAssignTbladeFromGovHydro4Command command ) {
		try {
