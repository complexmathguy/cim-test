...
public class TurbLCFB1CommandRestController extends BaseSpringRestController {
	...
	public void unAssignIrmax( @RequestBody(required=true)  UnAssignIrmaxFromTurbLCFB1Command command ) {
		try {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromTurbLCFB1Command command ) {
		try {
	...
	public void unAssignPmwset( @RequestBody(required=true)  UnAssignPmwsetFromTurbLCFB1Command command ) {
		try {
	...
	public void assignSpeedReferenceGovernor( @RequestBody AssignSpeedReferenceGovernorToTurbLCFB1Command command ) {
		try {
	...
	public void unAssignSpeedReferenceGovernor( @RequestBody(required=true)  UnAssignSpeedReferenceGovernorFromTurbLCFB1Command command ) {
		try {
	...
	public void unAssignTpelec( @RequestBody(required=true)  UnAssignTpelecFromTurbLCFB1Command command ) {
		try {
