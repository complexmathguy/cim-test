...
public class ENTSOEIdentifiedObjectCommandRestController extends BaseSpringRestController {
	...
	public void assignEnergyIdentCodeEic( @RequestBody AssignEnergyIdentCodeEicToENTSOEIdentifiedObjectCommand command ) {
		try {
			ENTSOEIdentifiedObjectBusinessDelegate.getENTSOEIdentifiedObjectInstance().assignEnergyIdentCodeEic( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEnergyIdentCodeEic( @RequestBody(required=true)  UnAssignEnergyIdentCodeEicFromENTSOEIdentifiedObjectCommand command ) {
		try {
			ENTSOEIdentifiedObjectBusinessDelegate.getENTSOEIdentifiedObjectInstance().unAssignEnergyIdentCodeEic( command );   
		}
		catch( Exception exc ) {
	...
	public void assignShortName( @RequestBody AssignShortNameToENTSOEIdentifiedObjectCommand command ) {
		try {
			ENTSOEIdentifiedObjectBusinessDelegate.getENTSOEIdentifiedObjectInstance().assignShortName( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignShortName( @RequestBody(required=true)  UnAssignShortNameFromENTSOEIdentifiedObjectCommand command ) {
		try {
			ENTSOEIdentifiedObjectBusinessDelegate.getENTSOEIdentifiedObjectInstance().unAssignShortName( command );   
		}
		catch( Exception exc ) {
