...
public class TopologyVersionCommandRestController extends BaseSpringRestController {
	...
	public void unAssignBaseUML( @RequestBody(required=true)  UnAssignBaseUMLFromTopologyVersionCommand command ) {
		try {
	...
	public void unAssignBaseURI( @RequestBody(required=true)  UnAssignBaseURIFromTopologyVersionCommand command ) {
		try {
	...
	public void unAssignDate( @RequestBody(required=true)  UnAssignDateFromTopologyVersionCommand command ) {
		try {
	...
	public void assignDifferenceModelURI( @RequestBody AssignDifferenceModelURIToTopologyVersionCommand command ) {
		try {
			TopologyVersionBusinessDelegate.getTopologyVersionInstance().assignDifferenceModelURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDifferenceModelURI( @RequestBody(required=true)  UnAssignDifferenceModelURIFromTopologyVersionCommand command ) {
		try {
			TopologyVersionBusinessDelegate.getTopologyVersionInstance().unAssignDifferenceModelURI( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignEntsoeUML( @RequestBody(required=true)  UnAssignEntsoeUMLFromTopologyVersionCommand command ) {
		try {
	...
	public void unAssignEntsoeURI( @RequestBody(required=true)  UnAssignEntsoeURIFromTopologyVersionCommand command ) {
		try {
	...
	public void assignModelDescriptionURI( @RequestBody AssignModelDescriptionURIToTopologyVersionCommand command ) {
		try {
			TopologyVersionBusinessDelegate.getTopologyVersionInstance().assignModelDescriptionURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignModelDescriptionURI( @RequestBody(required=true)  UnAssignModelDescriptionURIFromTopologyVersionCommand command ) {
		try {
			TopologyVersionBusinessDelegate.getTopologyVersionInstance().unAssignModelDescriptionURI( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignNamespaceRDF( @RequestBody(required=true)  UnAssignNamespaceRDFFromTopologyVersionCommand command ) {
		try {
	...
	public void unAssignNamespaceUML( @RequestBody(required=true)  UnAssignNamespaceUMLFromTopologyVersionCommand command ) {
		try {
	...
	public void unAssignShortName( @RequestBody(required=true)  UnAssignShortNameFromTopologyVersionCommand command ) {
		try {
