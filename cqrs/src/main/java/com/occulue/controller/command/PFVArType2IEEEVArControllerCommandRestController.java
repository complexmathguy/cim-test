...
public class PFVArType2IEEEVArControllerCommandRestController extends BaseSpringRestController {
	...
	public void assignExlon( @RequestBody AssignExlonToPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().assignExlon( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignExlon( @RequestBody(required=true)  UnAssignExlonFromPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().unAssignExlon( command );   
		}
		catch( Exception exc ) {
	...
	public void assignKi( @RequestBody AssignKiToPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().assignKi( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKi( @RequestBody(required=true)  UnAssignKiFromPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().unAssignKi( command );   
		}
		catch( Exception exc ) {
	...
	public void assignKp( @RequestBody AssignKpToPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().assignKp( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKp( @RequestBody(required=true)  UnAssignKpFromPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().unAssignKp( command );   
		}
		catch( Exception exc ) {
	...
	public void assignQref( @RequestBody AssignQrefToPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().assignQref( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignQref( @RequestBody(required=true)  UnAssignQrefFromPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().unAssignQref( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVclmt( @RequestBody AssignVclmtToPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().assignVclmt( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVclmt( @RequestBody(required=true)  UnAssignVclmtFromPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().unAssignVclmt( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVref( @RequestBody AssignVrefToPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().assignVref( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVref( @RequestBody(required=true)  UnAssignVrefFromPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().unAssignVref( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVs( @RequestBody AssignVsToPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().assignVs( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVs( @RequestBody(required=true)  UnAssignVsFromPFVArType2IEEEVArControllerCommand command ) {
		try {
			PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance().unAssignVs( command );   
		}
		catch( Exception exc ) {
