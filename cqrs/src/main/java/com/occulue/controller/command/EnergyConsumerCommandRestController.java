...
public class EnergyConsumerCommandRestController extends BaseSpringRestController {
	...
	public void unAssignPfixed( @RequestBody(required=true)  UnAssignPfixedFromEnergyConsumerCommand command ) {
		try {
	...
	public void unAssignPfixedPct( @RequestBody(required=true)  UnAssignPfixedPctFromEnergyConsumerCommand command ) {
		try {
	...
	public void unAssignQfixed( @RequestBody(required=true)  UnAssignQfixedFromEnergyConsumerCommand command ) {
		try {
	...
	public void unAssignQfixedPct( @RequestBody(required=true)  UnAssignQfixedPctFromEnergyConsumerCommand command ) {
		try {
