...
public class LoadResponseCharacteristicCommandRestController extends BaseSpringRestController {
	...
	public void assignExponentModel( @RequestBody AssignExponentModelToLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().assignExponentModel( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignExponentModel( @RequestBody(required=true)  UnAssignExponentModelFromLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().unAssignExponentModel( command );   
		}
		catch( Exception exc ) {
	...
	public void assignPConstantCurrent( @RequestBody AssignPConstantCurrentToLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().assignPConstantCurrent( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPConstantCurrent( @RequestBody(required=true)  UnAssignPConstantCurrentFromLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().unAssignPConstantCurrent( command );   
		}
		catch( Exception exc ) {
	...
	public void assignPConstantImpedance( @RequestBody AssignPConstantImpedanceToLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().assignPConstantImpedance( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPConstantImpedance( @RequestBody(required=true)  UnAssignPConstantImpedanceFromLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().unAssignPConstantImpedance( command );   
		}
		catch( Exception exc ) {
	...
	public void assignPConstantPower( @RequestBody AssignPConstantPowerToLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().assignPConstantPower( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPConstantPower( @RequestBody(required=true)  UnAssignPConstantPowerFromLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().unAssignPConstantPower( command );   
		}
		catch( Exception exc ) {
	...
	public void assignPFrequencyExponent( @RequestBody AssignPFrequencyExponentToLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().assignPFrequencyExponent( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPFrequencyExponent( @RequestBody(required=true)  UnAssignPFrequencyExponentFromLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().unAssignPFrequencyExponent( command );   
		}
		catch( Exception exc ) {
	...
	public void assignPVoltageExponent( @RequestBody AssignPVoltageExponentToLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().assignPVoltageExponent( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPVoltageExponent( @RequestBody(required=true)  UnAssignPVoltageExponentFromLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().unAssignPVoltageExponent( command );   
		}
		catch( Exception exc ) {
	...
	public void assignQConstantCurrent( @RequestBody AssignQConstantCurrentToLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().assignQConstantCurrent( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignQConstantCurrent( @RequestBody(required=true)  UnAssignQConstantCurrentFromLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().unAssignQConstantCurrent( command );   
		}
		catch( Exception exc ) {
	...
	public void assignQConstantImpedance( @RequestBody AssignQConstantImpedanceToLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().assignQConstantImpedance( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignQConstantImpedance( @RequestBody(required=true)  UnAssignQConstantImpedanceFromLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().unAssignQConstantImpedance( command );   
		}
		catch( Exception exc ) {
	...
	public void assignQConstantPower( @RequestBody AssignQConstantPowerToLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().assignQConstantPower( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignQConstantPower( @RequestBody(required=true)  UnAssignQConstantPowerFromLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().unAssignQConstantPower( command );   
		}
		catch( Exception exc ) {
	...
	public void assignQFrequencyExponent( @RequestBody AssignQFrequencyExponentToLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().assignQFrequencyExponent( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignQFrequencyExponent( @RequestBody(required=true)  UnAssignQFrequencyExponentFromLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().unAssignQFrequencyExponent( command );   
		}
		catch( Exception exc ) {
	...
	public void assignQVoltageExponent( @RequestBody AssignQVoltageExponentToLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().assignQVoltageExponent( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignQVoltageExponent( @RequestBody(required=true)  UnAssignQVoltageExponentFromLoadResponseCharacteristicCommand command ) {
		try {
			LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance().unAssignQVoltageExponent( command );   
		}
		catch( Exception exc ) {
