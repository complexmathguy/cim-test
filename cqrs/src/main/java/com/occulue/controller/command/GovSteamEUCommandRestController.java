...
public class GovSteamEUCommandRestController extends BaseSpringRestController {
	...
	public void unAssignHhpmax( @RequestBody(required=true)  UnAssignHhpmaxFromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignKfcor( @RequestBody(required=true)  UnAssignKfcorFromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignKwcor( @RequestBody(required=true)  UnAssignKwcorFromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignPmax( @RequestBody(required=true)  UnAssignPmaxFromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignPrhmax( @RequestBody(required=true)  UnAssignPrhmaxFromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignSimx( @RequestBody(required=true)  UnAssignSimxFromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignTvhp( @RequestBody(required=true)  UnAssignTvhpFromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignTvip( @RequestBody(required=true)  UnAssignTvipFromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignWfmax( @RequestBody(required=true)  UnAssignWfmaxFromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignWfmin( @RequestBody(required=true)  UnAssignWfminFromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignWmax1( @RequestBody(required=true)  UnAssignWmax1FromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignWmax2( @RequestBody(required=true)  UnAssignWmax2FromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignWwmax( @RequestBody(required=true)  UnAssignWwmaxFromGovSteamEUCommand command ) {
		try {
	...
	public void unAssignWwmin( @RequestBody(required=true)  UnAssignWwminFromGovSteamEUCommand command ) {
		try {
