...
public class StateVariablesVersionCommandRestController extends BaseSpringRestController {
	...
	public void assignBaseUML( @RequestBody AssignBaseUMLToStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().assignBaseUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBaseUML( @RequestBody(required=true)  UnAssignBaseUMLFromStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().unAssignBaseUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignBaseURI( @RequestBody AssignBaseURIToStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().assignBaseURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBaseURI( @RequestBody(required=true)  UnAssignBaseURIFromStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().unAssignBaseURI( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignDate( @RequestBody(required=true)  UnAssignDateFromStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().unAssignDate( command );   
		}
		catch( Exception exc ) {
	...
	public void assignDifferenceModelURI( @RequestBody AssignDifferenceModelURIToStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().assignDifferenceModelURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDifferenceModelURI( @RequestBody(required=true)  UnAssignDifferenceModelURIFromStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().unAssignDifferenceModelURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeUML( @RequestBody AssignEntsoeUMLToStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().assignEntsoeUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeUML( @RequestBody(required=true)  UnAssignEntsoeUMLFromStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().unAssignEntsoeUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeURI( @RequestBody AssignEntsoeURIToStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().assignEntsoeURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeURI( @RequestBody(required=true)  UnAssignEntsoeURIFromStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().unAssignEntsoeURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignModelDescriptionURI( @RequestBody AssignModelDescriptionURIToStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().assignModelDescriptionURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignModelDescriptionURI( @RequestBody(required=true)  UnAssignModelDescriptionURIFromStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().unAssignModelDescriptionURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNamespaceRDF( @RequestBody AssignNamespaceRDFToStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().assignNamespaceRDF( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNamespaceRDF( @RequestBody(required=true)  UnAssignNamespaceRDFFromStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().unAssignNamespaceRDF( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNamespaceUML( @RequestBody AssignNamespaceUMLToStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().assignNamespaceUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNamespaceUML( @RequestBody(required=true)  UnAssignNamespaceUMLFromStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().unAssignNamespaceUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignShortName( @RequestBody AssignShortNameToStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().assignShortName( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignShortName( @RequestBody(required=true)  UnAssignShortNameFromStateVariablesVersionCommand command ) {
		try {
			StateVariablesVersionBusinessDelegate.getStateVariablesVersionInstance().unAssignShortName( command );   
		}
		catch( Exception exc ) {
