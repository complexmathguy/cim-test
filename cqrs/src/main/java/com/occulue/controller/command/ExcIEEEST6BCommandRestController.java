...
public class ExcIEEEST6BCommandRestController extends BaseSpringRestController {
	...
	public void unAssignVamax( @RequestBody(required=true)  UnAssignVamaxFromExcIEEEST6BCommand command ) {
		try {
	...
	public void unAssignVamin( @RequestBody(required=true)  UnAssignVaminFromExcIEEEST6BCommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEST6BCommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEST6BCommand command ) {
		try {
