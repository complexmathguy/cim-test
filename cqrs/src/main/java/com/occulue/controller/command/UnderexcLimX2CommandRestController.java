...
public class UnderexcLimX2CommandRestController extends BaseSpringRestController {
	...
	public void unAssignKf2( @RequestBody(required=true)  UnAssignKf2FromUnderexcLimX2Command command ) {
		try {
	...
	public void unAssignMelmax( @RequestBody(required=true)  UnAssignMelmaxFromUnderexcLimX2Command command ) {
		try {
	...
	public void unAssignTf2( @RequestBody(required=true)  UnAssignTf2FromUnderexcLimX2Command command ) {
		try {
