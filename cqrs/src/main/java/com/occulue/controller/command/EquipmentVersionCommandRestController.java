...
public class EquipmentVersionCommandRestController extends BaseSpringRestController {
	...
	public void unAssignBaseUML( @RequestBody(required=true)  UnAssignBaseUMLFromEquipmentVersionCommand command ) {
		try {
	...
	public void unAssignBaseURIcore( @RequestBody(required=true)  UnAssignBaseURIcoreFromEquipmentVersionCommand command ) {
		try {
	...
	public void assignBaseURIoperation( @RequestBody AssignBaseURIoperationToEquipmentVersionCommand command ) {
		try {
			EquipmentVersionBusinessDelegate.getEquipmentVersionInstance().assignBaseURIoperation( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBaseURIoperation( @RequestBody(required=true)  UnAssignBaseURIoperationFromEquipmentVersionCommand command ) {
		try {
			EquipmentVersionBusinessDelegate.getEquipmentVersionInstance().unAssignBaseURIoperation( command );   
		}
		catch( Exception exc ) {
	...
	public void assignBaseURIshortCircuit( @RequestBody AssignBaseURIshortCircuitToEquipmentVersionCommand command ) {
		try {
			EquipmentVersionBusinessDelegate.getEquipmentVersionInstance().assignBaseURIshortCircuit( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBaseURIshortCircuit( @RequestBody(required=true)  UnAssignBaseURIshortCircuitFromEquipmentVersionCommand command ) {
		try {
			EquipmentVersionBusinessDelegate.getEquipmentVersionInstance().unAssignBaseURIshortCircuit( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignDate( @RequestBody(required=true)  UnAssignDateFromEquipmentVersionCommand command ) {
		try {
	...
	public void assignDifferenceModelURI( @RequestBody AssignDifferenceModelURIToEquipmentVersionCommand command ) {
		try {
			EquipmentVersionBusinessDelegate.getEquipmentVersionInstance().assignDifferenceModelURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDifferenceModelURI( @RequestBody(required=true)  UnAssignDifferenceModelURIFromEquipmentVersionCommand command ) {
		try {
			EquipmentVersionBusinessDelegate.getEquipmentVersionInstance().unAssignDifferenceModelURI( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignEntsoeUML( @RequestBody(required=true)  UnAssignEntsoeUMLFromEquipmentVersionCommand command ) {
		try {
	...
	public void assignEntsoeURIcore( @RequestBody AssignEntsoeURIcoreToEquipmentVersionCommand command ) {
		try {
	...
	public void unAssignEntsoeURIcore( @RequestBody(required=true)  UnAssignEntsoeURIcoreFromEquipmentVersionCommand command ) {
		try {
	...
	public void assignEntsoeURIoperation( @RequestBody AssignEntsoeURIoperationToEquipmentVersionCommand command ) {
		try {
			EquipmentVersionBusinessDelegate.getEquipmentVersionInstance().assignEntsoeURIoperation( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeURIoperation( @RequestBody(required=true)  UnAssignEntsoeURIoperationFromEquipmentVersionCommand command ) {
		try {
			EquipmentVersionBusinessDelegate.getEquipmentVersionInstance().unAssignEntsoeURIoperation( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeURIshortCircuit( @RequestBody AssignEntsoeURIshortCircuitToEquipmentVersionCommand command ) {
		try {
			EquipmentVersionBusinessDelegate.getEquipmentVersionInstance().assignEntsoeURIshortCircuit( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeURIshortCircuit( @RequestBody(required=true)  UnAssignEntsoeURIshortCircuitFromEquipmentVersionCommand command ) {
		try {
			EquipmentVersionBusinessDelegate.getEquipmentVersionInstance().unAssignEntsoeURIshortCircuit( command );   
		}
		catch( Exception exc ) {
	...
	public void assignModelDescriptionURI( @RequestBody AssignModelDescriptionURIToEquipmentVersionCommand command ) {
		try {
			EquipmentVersionBusinessDelegate.getEquipmentVersionInstance().assignModelDescriptionURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignModelDescriptionURI( @RequestBody(required=true)  UnAssignModelDescriptionURIFromEquipmentVersionCommand command ) {
		try {
			EquipmentVersionBusinessDelegate.getEquipmentVersionInstance().unAssignModelDescriptionURI( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignNamespaceRDF( @RequestBody(required=true)  UnAssignNamespaceRDFFromEquipmentVersionCommand command ) {
		try {
	...
	public void unAssignNamespaceUML( @RequestBody(required=true)  UnAssignNamespaceUMLFromEquipmentVersionCommand command ) {
		try {
	...
	public void unAssignShortName( @RequestBody(required=true)  UnAssignShortNameFromEquipmentVersionCommand command ) {
		try {
