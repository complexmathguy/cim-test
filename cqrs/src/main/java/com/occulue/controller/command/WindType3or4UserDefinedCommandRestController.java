...
public class WindType3or4UserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToWindType3or4UserDefinedCommand command ) {
		try {
			WindType3or4UserDefinedBusinessDelegate.getWindType3or4UserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromWindType3or4UserDefinedCommand command ) {
		try {
			WindType3or4UserDefinedBusinessDelegate.getWindType3or4UserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
