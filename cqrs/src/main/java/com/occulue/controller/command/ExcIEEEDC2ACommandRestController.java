...
public class ExcIEEEDC2ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfd1( @RequestBody(required=true)  UnAssignEfd1FromExcIEEEDC2ACommand command ) {
		try {
	...
	public void unAssignEfd2( @RequestBody(required=true)  UnAssignEfd2FromExcIEEEDC2ACommand command ) {
		try {
	...
	public void unAssignExclim( @RequestBody(required=true)  UnAssignExclimFromExcIEEEDC2ACommand command ) {
		try {
	...
	public void unAssignSeefd1( @RequestBody(required=true)  UnAssignSeefd1FromExcIEEEDC2ACommand command ) {
		try {
	...
	public void unAssignSeefd2( @RequestBody(required=true)  UnAssignSeefd2FromExcIEEEDC2ACommand command ) {
		try {
	...
	public void unAssignUelin( @RequestBody(required=true)  UnAssignUelinFromExcIEEEDC2ACommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEDC2ACommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEDC2ACommand command ) {
		try {
