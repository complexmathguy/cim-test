...
public class MonthDayIntervalCommandRestController extends BaseSpringRestController {
	...
	public void unAssignEnd( @RequestBody(required=true)  UnAssignEndFromMonthDayIntervalCommand command ) {
		try {
	...
	public void unAssignStart( @RequestBody(required=true)  UnAssignStartFromMonthDayIntervalCommand command ) {
		try {
