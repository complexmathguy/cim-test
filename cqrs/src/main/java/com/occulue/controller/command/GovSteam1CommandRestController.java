...
public class GovSteam1CommandRestController extends BaseSpringRestController {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovSteam1Command command ) {
		try {
	...
	public void unAssignValve( @RequestBody(required=true)  UnAssignValveFromGovSteam1Command command ) {
		try {
