...
public class GovGAST1CommandRestController extends BaseSpringRestController {
	...
	public void unAssignFidle( @RequestBody(required=true)  UnAssignFidleFromGovGAST1Command command ) {
		try {
	...
	public void unAssignLoadinc( @RequestBody(required=true)  UnAssignLoadincFromGovGAST1Command command ) {
		try {
	...
	public void unAssignLtrate( @RequestBody(required=true)  UnAssignLtrateFromGovGAST1Command command ) {
		try {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovGAST1Command command ) {
		try {
