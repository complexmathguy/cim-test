...
public class ExcIEEEST3ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignThetap( @RequestBody(required=true)  UnAssignThetapFromExcIEEEST3ACommand command ) {
		try {
	...
	public void unAssignVbmax( @RequestBody(required=true)  UnAssignVbmaxFromExcIEEEST3ACommand command ) {
		try {
	...
	public void unAssignVgmax( @RequestBody(required=true)  UnAssignVgmaxFromExcIEEEST3ACommand command ) {
		try {
	...
	public void unAssignVimax( @RequestBody(required=true)  UnAssignVimaxFromExcIEEEST3ACommand command ) {
		try {
	...
	public void unAssignVimin( @RequestBody(required=true)  UnAssignViminFromExcIEEEST3ACommand command ) {
		try {
	...
	public void unAssignVmmax( @RequestBody(required=true)  UnAssignVmmaxFromExcIEEEST3ACommand command ) {
		try {
	...
	public void unAssignVmmin( @RequestBody(required=true)  UnAssignVmminFromExcIEEEST3ACommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEST3ACommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEST3ACommand command ) {
		try {
