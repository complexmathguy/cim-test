...
public class OverexcLimIEEECommandRestController extends BaseSpringRestController {
	...
	public void unAssignHyst( @RequestBody(required=true)  UnAssignHystFromOverexcLimIEEECommand command ) {
		try {
	...
	public void unAssignIfdlim( @RequestBody(required=true)  UnAssignIfdlimFromOverexcLimIEEECommand command ) {
		try {
	...
	public void unAssignIfdmax( @RequestBody(required=true)  UnAssignIfdmaxFromOverexcLimIEEECommand command ) {
		try {
	...
	public void unAssignItfpu( @RequestBody(required=true)  UnAssignItfpuFromOverexcLimIEEECommand command ) {
		try {
	...
	public void unAssignKcd( @RequestBody(required=true)  UnAssignKcdFromOverexcLimIEEECommand command ) {
		try {
	...
	public void unAssignKramp( @RequestBody(required=true)  UnAssignKrampFromOverexcLimIEEECommand command ) {
		try {
