...
public class DiscExcContIEEEDEC3ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignTdr( @RequestBody(required=true)  UnAssignTdrFromDiscExcContIEEEDEC3ACommand command ) {
		try {
	...
	public void unAssignVtmin( @RequestBody(required=true)  UnAssignVtminFromDiscExcContIEEEDEC3ACommand command ) {
		try {
