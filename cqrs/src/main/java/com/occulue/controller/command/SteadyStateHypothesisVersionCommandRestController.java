...
public class SteadyStateHypothesisVersionCommandRestController extends BaseSpringRestController {
	...
	public void assignBaseUML( @RequestBody AssignBaseUMLToSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().assignBaseUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBaseUML( @RequestBody(required=true)  UnAssignBaseUMLFromSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().unAssignBaseUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignBaseURI( @RequestBody AssignBaseURIToSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().assignBaseURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBaseURI( @RequestBody(required=true)  UnAssignBaseURIFromSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().unAssignBaseURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignDate( @RequestBody AssignDateToSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().assignDate( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDate( @RequestBody(required=true)  UnAssignDateFromSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().unAssignDate( command );   
		}
		catch( Exception exc ) {
	...
	public void assignDifferenceModelURI( @RequestBody AssignDifferenceModelURIToSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().assignDifferenceModelURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDifferenceModelURI( @RequestBody(required=true)  UnAssignDifferenceModelURIFromSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().unAssignDifferenceModelURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeUML( @RequestBody AssignEntsoeUMLToSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().assignEntsoeUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeUML( @RequestBody(required=true)  UnAssignEntsoeUMLFromSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().unAssignEntsoeUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeURI( @RequestBody AssignEntsoeURIToSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().assignEntsoeURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeURI( @RequestBody(required=true)  UnAssignEntsoeURIFromSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().unAssignEntsoeURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignModelDescriptionURI( @RequestBody AssignModelDescriptionURIToSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().assignModelDescriptionURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignModelDescriptionURI( @RequestBody(required=true)  UnAssignModelDescriptionURIFromSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().unAssignModelDescriptionURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNamespaceRDF( @RequestBody AssignNamespaceRDFToSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().assignNamespaceRDF( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNamespaceRDF( @RequestBody(required=true)  UnAssignNamespaceRDFFromSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().unAssignNamespaceRDF( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNamespaceUML( @RequestBody AssignNamespaceUMLToSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().assignNamespaceUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNamespaceUML( @RequestBody(required=true)  UnAssignNamespaceUMLFromSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().unAssignNamespaceUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignShortName( @RequestBody AssignShortNameToSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().assignShortName( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignShortName( @RequestBody(required=true)  UnAssignShortNameFromSteadyStateHypothesisVersionCommand command ) {
		try {
			SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance().unAssignShortName( command );   
		}
		catch( Exception exc ) {
