...
public class GovGASTWDCommandRestController extends BaseSpringRestController {
	...
	public void unAssignKdroop( @RequestBody(required=true)  UnAssignKdroopFromGovGASTWDCommand command ) {
		try {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovGASTWDCommand command ) {
		try {
	...
	public void unAssignTrate( @RequestBody(required=true)  UnAssignTrateFromGovGASTWDCommand command ) {
		try {
