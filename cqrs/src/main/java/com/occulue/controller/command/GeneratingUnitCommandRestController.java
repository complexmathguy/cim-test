...
public class GeneratingUnitCommandRestController extends BaseSpringRestController {
	...
	public void unAssignGovernorSCD( @RequestBody(required=true)  UnAssignGovernorSCDFromGeneratingUnitCommand command ) {
		try {
	...
	public void unAssignInitialP( @RequestBody(required=true)  UnAssignInitialPFromGeneratingUnitCommand command ) {
		try {
	...
	public void unAssignLongPF( @RequestBody(required=true)  UnAssignLongPFFromGeneratingUnitCommand command ) {
		try {
	...
	public void assignMaximumAllowableSpinningReserve( @RequestBody AssignMaximumAllowableSpinningReserveToGeneratingUnitCommand command ) {
		try {
			GeneratingUnitBusinessDelegate.getGeneratingUnitInstance().assignMaximumAllowableSpinningReserve( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMaximumAllowableSpinningReserve( @RequestBody(required=true)  UnAssignMaximumAllowableSpinningReserveFromGeneratingUnitCommand command ) {
		try {
			GeneratingUnitBusinessDelegate.getGeneratingUnitInstance().unAssignMaximumAllowableSpinningReserve( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignMaxOperatingP( @RequestBody(required=true)  UnAssignMaxOperatingPFromGeneratingUnitCommand command ) {
		try {
	...
	public void unAssignMinOperatingP( @RequestBody(required=true)  UnAssignMinOperatingPFromGeneratingUnitCommand command ) {
		try {
	...
	public void unAssignNominalP( @RequestBody(required=true)  UnAssignNominalPFromGeneratingUnitCommand command ) {
		try {
	...
	public void assignRatedGrossMaxP( @RequestBody AssignRatedGrossMaxPToGeneratingUnitCommand command ) {
		try {
	...
	public void unAssignRatedGrossMaxP( @RequestBody(required=true)  UnAssignRatedGrossMaxPFromGeneratingUnitCommand command ) {
		try {
	...
	public void assignRatedGrossMinP( @RequestBody AssignRatedGrossMinPToGeneratingUnitCommand command ) {
		try {
	...
	public void unAssignRatedGrossMinP( @RequestBody(required=true)  UnAssignRatedGrossMinPFromGeneratingUnitCommand command ) {
		try {
	...
	public void unAssignRatedNetMaxP( @RequestBody(required=true)  UnAssignRatedNetMaxPFromGeneratingUnitCommand command ) {
		try {
	...
	public void unAssignShortPF( @RequestBody(required=true)  UnAssignShortPFFromGeneratingUnitCommand command ) {
		try {
	...
	public void unAssignStartupCost( @RequestBody(required=true)  UnAssignStartupCostFromGeneratingUnitCommand command ) {
		try {
	...
	public void assignTotalEfficiency( @RequestBody AssignTotalEfficiencyToGeneratingUnitCommand command ) {
		try {
	...
	public void unAssignTotalEfficiency( @RequestBody(required=true)  UnAssignTotalEfficiencyFromGeneratingUnitCommand command ) {
		try {
	...
	public void unAssignVariableCost( @RequestBody(required=true)  UnAssignVariableCostFromGeneratingUnitCommand command ) {
		try {
