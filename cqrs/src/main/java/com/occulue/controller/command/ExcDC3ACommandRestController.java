...
public class ExcDC3ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignEdfmax( @RequestBody(required=true)  UnAssignEdfmaxFromExcDC3ACommand command ) {
		try {
	...
	public void unAssignEfdlim( @RequestBody(required=true)  UnAssignEfdlimFromExcDC3ACommand command ) {
		try {
	...
	public void unAssignEfdmin( @RequestBody(required=true)  UnAssignEfdminFromExcDC3ACommand command ) {
		try {
	...
	public void unAssignExclim( @RequestBody(required=true)  UnAssignExclimFromExcDC3ACommand command ) {
		try {
	...
	public void unAssignSeefd1( @RequestBody(required=true)  UnAssignSeefd1FromExcDC3ACommand command ) {
		try {
	...
	public void unAssignSeefd2( @RequestBody(required=true)  UnAssignSeefd2FromExcDC3ACommand command ) {
		try {
