...
public class ExcIEEEST1ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignPssin( @RequestBody(required=true)  UnAssignPssinFromExcIEEEST1ACommand command ) {
		try {
	...
	public void unAssignVamax( @RequestBody(required=true)  UnAssignVamaxFromExcIEEEST1ACommand command ) {
		try {
	...
	public void unAssignVamin( @RequestBody(required=true)  UnAssignVaminFromExcIEEEST1ACommand command ) {
		try {
	...
	public void unAssignVimax( @RequestBody(required=true)  UnAssignVimaxFromExcIEEEST1ACommand command ) {
		try {
	...
	public void unAssignVimin( @RequestBody(required=true)  UnAssignViminFromExcIEEEST1ACommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEST1ACommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEST1ACommand command ) {
		try {
