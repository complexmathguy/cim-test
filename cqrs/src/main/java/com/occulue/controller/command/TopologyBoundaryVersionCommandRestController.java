...
public class TopologyBoundaryVersionCommandRestController extends BaseSpringRestController {
	...
	public void assignBaseUML( @RequestBody AssignBaseUMLToTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().assignBaseUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBaseUML( @RequestBody(required=true)  UnAssignBaseUMLFromTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().unAssignBaseUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignBaseURI( @RequestBody AssignBaseURIToTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().assignBaseURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBaseURI( @RequestBody(required=true)  UnAssignBaseURIFromTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().unAssignBaseURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignDate( @RequestBody AssignDateToTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().assignDate( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDate( @RequestBody(required=true)  UnAssignDateFromTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().unAssignDate( command );   
		}
		catch( Exception exc ) {
	...
	public void assignDifferenceModelURI( @RequestBody AssignDifferenceModelURIToTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().assignDifferenceModelURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDifferenceModelURI( @RequestBody(required=true)  UnAssignDifferenceModelURIFromTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().unAssignDifferenceModelURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeUML( @RequestBody AssignEntsoeUMLToTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().assignEntsoeUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeUML( @RequestBody(required=true)  UnAssignEntsoeUMLFromTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().unAssignEntsoeUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeURI( @RequestBody AssignEntsoeURIToTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().assignEntsoeURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeURI( @RequestBody(required=true)  UnAssignEntsoeURIFromTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().unAssignEntsoeURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignModelDescriptionURI( @RequestBody AssignModelDescriptionURIToTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().assignModelDescriptionURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignModelDescriptionURI( @RequestBody(required=true)  UnAssignModelDescriptionURIFromTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().unAssignModelDescriptionURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNamespaceRDF( @RequestBody AssignNamespaceRDFToTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().assignNamespaceRDF( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNamespaceRDF( @RequestBody(required=true)  UnAssignNamespaceRDFFromTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().unAssignNamespaceRDF( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNamespaceUML( @RequestBody AssignNamespaceUMLToTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().assignNamespaceUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNamespaceUML( @RequestBody(required=true)  UnAssignNamespaceUMLFromTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().unAssignNamespaceUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignShortName( @RequestBody AssignShortNameToTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().assignShortName( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignShortName( @RequestBody(required=true)  UnAssignShortNameFromTopologyBoundaryVersionCommand command ) {
		try {
			TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance().unAssignShortName( command );   
		}
		catch( Exception exc ) {
