...
public class AsynchronousMachineCommandRestController extends BaseSpringRestController {
	...
	public void assignConverterFedDrive( @RequestBody AssignConverterFedDriveToAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().assignConverterFedDrive( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignConverterFedDrive( @RequestBody(required=true)  UnAssignConverterFedDriveFromAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().unAssignConverterFedDrive( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEfficiency( @RequestBody AssignEfficiencyToAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().assignEfficiency( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEfficiency( @RequestBody(required=true)  UnAssignEfficiencyFromAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().unAssignEfficiency( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignIaIrRatio( @RequestBody(required=true)  UnAssignIaIrRatioFromAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().unAssignIaIrRatio( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNominalFrequency( @RequestBody AssignNominalFrequencyToAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().assignNominalFrequency( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNominalFrequency( @RequestBody(required=true)  UnAssignNominalFrequencyFromAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().unAssignNominalFrequency( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNominalSpeed( @RequestBody AssignNominalSpeedToAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().assignNominalSpeed( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNominalSpeed( @RequestBody(required=true)  UnAssignNominalSpeedFromAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().unAssignNominalSpeed( command );   
		}
		catch( Exception exc ) {
	...
	public void assignPolePairNumber( @RequestBody AssignPolePairNumberToAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().assignPolePairNumber( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPolePairNumber( @RequestBody(required=true)  UnAssignPolePairNumberFromAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().unAssignPolePairNumber( command );   
		}
		catch( Exception exc ) {
	...
	public void assignRatedMechanicalPower( @RequestBody AssignRatedMechanicalPowerToAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().assignRatedMechanicalPower( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignRatedMechanicalPower( @RequestBody(required=true)  UnAssignRatedMechanicalPowerFromAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().unAssignRatedMechanicalPower( command );   
		}
		catch( Exception exc ) {
	...
	public void assignReversible( @RequestBody AssignReversibleToAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().assignReversible( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignReversible( @RequestBody(required=true)  UnAssignReversibleFromAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().unAssignReversible( command );   
		}
		catch( Exception exc ) {
	...
	public void assignRxLockedRotorRatio( @RequestBody AssignRxLockedRotorRatioToAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().assignRxLockedRotorRatio( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignRxLockedRotorRatio( @RequestBody(required=true)  UnAssignRxLockedRotorRatioFromAsynchronousMachineCommand command ) {
		try {
			AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance().unAssignRxLockedRotorRatio( command );   
		}
		catch( Exception exc ) {
