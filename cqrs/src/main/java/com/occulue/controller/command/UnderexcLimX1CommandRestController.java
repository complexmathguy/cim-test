...
public class UnderexcLimX1CommandRestController extends BaseSpringRestController {
	...
	public void unAssignKf2( @RequestBody(required=true)  UnAssignKf2FromUnderexcLimX1Command command ) {
		try {
	...
	public void unAssignMelmax( @RequestBody(required=true)  UnAssignMelmaxFromUnderexcLimX1Command command ) {
		try {
	...
	public void unAssignTf2( @RequestBody(required=true)  UnAssignTf2FromUnderexcLimX1Command command ) {
		try {
