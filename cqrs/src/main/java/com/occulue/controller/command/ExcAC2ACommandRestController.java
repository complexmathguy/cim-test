...
public class ExcAC2ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignHvgate( @RequestBody(required=true)  UnAssignHvgateFromExcAC2ACommand command ) {
		try {
	...
	public void unAssignLvgate( @RequestBody(required=true)  UnAssignLvgateFromExcAC2ACommand command ) {
		try {
	...
	public void unAssignVfemax( @RequestBody(required=true)  UnAssignVfemaxFromExcAC2ACommand command ) {
		try {
