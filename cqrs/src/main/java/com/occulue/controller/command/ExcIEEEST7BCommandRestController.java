...
public class ExcIEEEST7BCommandRestController extends BaseSpringRestController {
	...
	public void unAssignVmax( @RequestBody(required=true)  UnAssignVmaxFromExcIEEEST7BCommand command ) {
		try {
	...
	public void unAssignVmin( @RequestBody(required=true)  UnAssignVminFromExcIEEEST7BCommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEST7BCommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEST7BCommand command ) {
		try {
