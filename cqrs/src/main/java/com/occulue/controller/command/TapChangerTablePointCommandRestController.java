...
public class TapChangerTablePointCommandRestController extends BaseSpringRestController {
	...
	public void unAssignB( @RequestBody(required=true)  UnAssignBFromTapChangerTablePointCommand command ) {
		try {
	...
	public void unAssignG( @RequestBody(required=true)  UnAssignGFromTapChangerTablePointCommand command ) {
		try {
	...
	public void unAssignR( @RequestBody(required=true)  UnAssignRFromTapChangerTablePointCommand command ) {
		try {
	...
	public void unAssignRatio( @RequestBody(required=true)  UnAssignRatioFromTapChangerTablePointCommand command ) {
		try {
	...
	public void unAssignStep( @RequestBody(required=true)  UnAssignStepFromTapChangerTablePointCommand command ) {
		try {
	...
	public void unAssignX( @RequestBody(required=true)  UnAssignXFromTapChangerTablePointCommand command ) {
		try {
