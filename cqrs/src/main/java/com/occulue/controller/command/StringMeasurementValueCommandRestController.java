...
public class StringMeasurementValueCommandRestController extends BaseSpringRestController {
	...
	public void assignValue( @RequestBody AssignValueToStringMeasurementValueCommand command ) {
		try {
			StringMeasurementValueBusinessDelegate.getStringMeasurementValueInstance().assignValue( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignValue( @RequestBody(required=true)  UnAssignValueFromStringMeasurementValueCommand command ) {
		try {
			StringMeasurementValueBusinessDelegate.getStringMeasurementValueInstance().unAssignValue( command );   
		}
		catch( Exception exc ) {
