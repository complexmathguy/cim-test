...
public class GovHydroIEEE0CommandRestController extends BaseSpringRestController {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovHydroIEEE0Command command ) {
		try {
	...
	public void unAssignPmax( @RequestBody(required=true)  UnAssignPmaxFromGovHydroIEEE0Command command ) {
		try {
	...
	public void unAssignPmin( @RequestBody(required=true)  UnAssignPminFromGovHydroIEEE0Command command ) {
		try {
