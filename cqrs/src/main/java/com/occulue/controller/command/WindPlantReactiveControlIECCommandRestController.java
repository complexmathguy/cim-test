...
public class WindPlantReactiveControlIECCommandRestController extends BaseSpringRestController {
	...
	public void assignKiwpx( @RequestBody AssignKiwpxToWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().assignKiwpx( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKiwpx( @RequestBody(required=true)  UnAssignKiwpxFromWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().unAssignKiwpx( command );   
		}
		catch( Exception exc ) {
	...
	public void assignKpwpx( @RequestBody AssignKpwpxToWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().assignKpwpx( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKpwpx( @RequestBody(required=true)  UnAssignKpwpxFromWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().unAssignKpwpx( command );   
		}
		catch( Exception exc ) {
	...
	public void assignKwpqu( @RequestBody AssignKwpquToWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().assignKwpqu( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKwpqu( @RequestBody(required=true)  UnAssignKwpquFromWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().unAssignKwpqu( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMwppf( @RequestBody AssignMwppfToWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().assignMwppf( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMwppf( @RequestBody(required=true)  UnAssignMwppfFromWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().unAssignMwppf( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMwpu( @RequestBody AssignMwpuToWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().assignMwpu( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMwpu( @RequestBody(required=true)  UnAssignMwpuFromWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().unAssignMwpu( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTwppfilt( @RequestBody AssignTwppfiltToWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().assignTwppfilt( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTwppfilt( @RequestBody(required=true)  UnAssignTwppfiltFromWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().unAssignTwppfilt( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTwpqfilt( @RequestBody AssignTwpqfiltToWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().assignTwpqfilt( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTwpqfilt( @RequestBody(required=true)  UnAssignTwpqfiltFromWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().unAssignTwpqfilt( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTwpufilt( @RequestBody AssignTwpufiltToWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().assignTwpufilt( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTwpufilt( @RequestBody(required=true)  UnAssignTwpufiltFromWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().unAssignTwpufilt( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTxft( @RequestBody AssignTxftToWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().assignTxft( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTxft( @RequestBody(required=true)  UnAssignTxftFromWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().unAssignTxft( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTxfv( @RequestBody AssignTxfvToWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().assignTxfv( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTxfv( @RequestBody(required=true)  UnAssignTxfvFromWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().unAssignTxfv( command );   
		}
		catch( Exception exc ) {
	...
	public void assignUwpqdip( @RequestBody AssignUwpqdipToWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().assignUwpqdip( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignUwpqdip( @RequestBody(required=true)  UnAssignUwpqdipFromWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().unAssignUwpqdip( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXrefmax( @RequestBody AssignXrefmaxToWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().assignXrefmax( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXrefmax( @RequestBody(required=true)  UnAssignXrefmaxFromWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().unAssignXrefmax( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXrefmin( @RequestBody AssignXrefminToWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().assignXrefmin( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXrefmin( @RequestBody(required=true)  UnAssignXrefminFromWindPlantReactiveControlIECCommand command ) {
		try {
			WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance().unAssignXrefmin( command );   
		}
		catch( Exception exc ) {
