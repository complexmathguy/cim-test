...
public class ExcIEEEST4BCommandRestController extends BaseSpringRestController {
	...
	public void unAssignThetap( @RequestBody(required=true)  UnAssignThetapFromExcIEEEST4BCommand command ) {
		try {
	...
	public void unAssignVbmax( @RequestBody(required=true)  UnAssignVbmaxFromExcIEEEST4BCommand command ) {
		try {
	...
	public void unAssignVmmax( @RequestBody(required=true)  UnAssignVmmaxFromExcIEEEST4BCommand command ) {
		try {
	...
	public void unAssignVmmin( @RequestBody(required=true)  UnAssignVmminFromExcIEEEST4BCommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEST4BCommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEST4BCommand command ) {
		try {
