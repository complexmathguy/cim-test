...
public class PssIEEE3BCommandRestController extends BaseSpringRestController {
	...
	public void unAssignVstmax( @RequestBody(required=true)  UnAssignVstmaxFromPssIEEE3BCommand command ) {
		try {
	...
	public void unAssignVstmin( @RequestBody(required=true)  UnAssignVstminFromPssIEEE3BCommand command ) {
		try {
