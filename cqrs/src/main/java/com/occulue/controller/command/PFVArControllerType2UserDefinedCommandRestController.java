...
public class PFVArControllerType2UserDefinedCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save Proprietary on PFVArControllerType2UserDefined
     * @param		command AssignProprietaryToPFVArControllerType2UserDefinedCommand
     */     
	@PutMapping("/assignProprietary")
	public void assignProprietary( @RequestBody AssignProprietaryToPFVArControllerType2UserDefinedCommand command ) {
		try {
			PFVArControllerType2UserDefinedBusinessDelegate.getPFVArControllerType2UserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromPFVArControllerType2UserDefinedCommand command ) {
		try {
			PFVArControllerType2UserDefinedBusinessDelegate.getPFVArControllerType2UserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
