...
public class SvInjectionCommandRestController extends BaseSpringRestController {
	...
	public void unAssignPInjection( @RequestBody(required=true)  UnAssignPInjectionFromSvInjectionCommand command ) {
		try {
	...
	public void unAssignQInjection( @RequestBody(required=true)  UnAssignQInjectionFromSvInjectionCommand command ) {
		try {
