...
public class OverexcitationLimiterUserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToOverexcitationLimiterUserDefinedCommand command ) {
		try {
			OverexcitationLimiterUserDefinedBusinessDelegate.getOverexcitationLimiterUserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromOverexcitationLimiterUserDefinedCommand command ) {
		try {
			OverexcitationLimiterUserDefinedBusinessDelegate.getOverexcitationLimiterUserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
