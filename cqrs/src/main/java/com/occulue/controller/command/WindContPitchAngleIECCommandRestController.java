...
public class WindContPitchAngleIECCommandRestController extends BaseSpringRestController {
	...
	public void assignDthetamax( @RequestBody AssignDthetamaxToWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().assignDthetamax( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDthetamax( @RequestBody(required=true)  UnAssignDthetamaxFromWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().unAssignDthetamax( command );   
		}
		catch( Exception exc ) {
	...
	public void assignDthetamin( @RequestBody AssignDthetaminToWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().assignDthetamin( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDthetamin( @RequestBody(required=true)  UnAssignDthetaminFromWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().unAssignDthetamin( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignKic( @RequestBody(required=true)  UnAssignKicFromWindContPitchAngleIECCommand command ) {
		try {
	...
	public void assignKiomega( @RequestBody AssignKiomegaToWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().assignKiomega( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKiomega( @RequestBody(required=true)  UnAssignKiomegaFromWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().unAssignKiomega( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignKpc( @RequestBody(required=true)  UnAssignKpcFromWindContPitchAngleIECCommand command ) {
		try {
	...
	public void assignKpomega( @RequestBody AssignKpomegaToWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().assignKpomega( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKpomega( @RequestBody(required=true)  UnAssignKpomegaFromWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().unAssignKpomega( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignKpx( @RequestBody(required=true)  UnAssignKpxFromWindContPitchAngleIECCommand command ) {
		try {
	...
	public void assignThetamax( @RequestBody AssignThetamaxToWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().assignThetamax( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignThetamax( @RequestBody(required=true)  UnAssignThetamaxFromWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().unAssignThetamax( command );   
		}
		catch( Exception exc ) {
	...
	public void assignThetamin( @RequestBody AssignThetaminToWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().assignThetamin( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignThetamin( @RequestBody(required=true)  UnAssignThetaminFromWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().unAssignThetamin( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTtheta( @RequestBody AssignTthetaToWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().assignTtheta( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTtheta( @RequestBody(required=true)  UnAssignTthetaFromWindContPitchAngleIECCommand command ) {
		try {
			WindContPitchAngleIECBusinessDelegate.getWindContPitchAngleIECInstance().unAssignTtheta( command );   
		}
		catch( Exception exc ) {
