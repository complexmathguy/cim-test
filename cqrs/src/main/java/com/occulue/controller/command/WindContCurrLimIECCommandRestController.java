...
public class WindContCurrLimIECCommandRestController extends BaseSpringRestController {
	...
	public void unAssignImax( @RequestBody(required=true)  UnAssignImaxFromWindContCurrLimIECCommand command ) {
		try {
	...
	public void unAssignImaxdip( @RequestBody(required=true)  UnAssignImaxdipFromWindContCurrLimIECCommand command ) {
		try {
	...
	public void unAssignMdfslim( @RequestBody(required=true)  UnAssignMdfslimFromWindContCurrLimIECCommand command ) {
		try {
	...
	public void unAssignMqpri( @RequestBody(required=true)  UnAssignMqpriFromWindContCurrLimIECCommand command ) {
		try {
	...
	public void unAssignTufilt( @RequestBody(required=true)  UnAssignTufiltFromWindContCurrLimIECCommand command ) {
		try {
