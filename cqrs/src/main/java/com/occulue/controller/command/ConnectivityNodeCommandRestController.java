...
public class ConnectivityNodeCommandRestController extends BaseSpringRestController {
	...
	public void assignBoundaryPoint( @RequestBody AssignBoundaryPointToConnectivityNodeCommand command ) {
		try {
	...
	public void unAssignBoundaryPoint( @RequestBody(required=true)  UnAssignBoundaryPointFromConnectivityNodeCommand command ) {
		try {
	...
	public void assignFromEndIsoCode( @RequestBody AssignFromEndIsoCodeToConnectivityNodeCommand command ) {
		try {
	...
	public void unAssignFromEndIsoCode( @RequestBody(required=true)  UnAssignFromEndIsoCodeFromConnectivityNodeCommand command ) {
		try {
			ConnectivityNodeBusinessDelegate.getConnectivityNodeInstance().unAssignFromEndIsoCode( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignFromEndName( @RequestBody(required=true)  UnAssignFromEndNameFromConnectivityNodeCommand command ) {
		try {
	...
	public void assignFromEndNameTso( @RequestBody AssignFromEndNameTsoToConnectivityNodeCommand command ) {
		try {
	...
	public void unAssignFromEndNameTso( @RequestBody(required=true)  UnAssignFromEndNameTsoFromConnectivityNodeCommand command ) {
		try {
			ConnectivityNodeBusinessDelegate.getConnectivityNodeInstance().unAssignFromEndNameTso( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignToEndIsoCode( @RequestBody(required=true)  UnAssignToEndIsoCodeFromConnectivityNodeCommand command ) {
		try {
	...
	public void unAssignToEndName( @RequestBody(required=true)  UnAssignToEndNameFromConnectivityNodeCommand command ) {
		try {
	...
	public void unAssignToEndNameTso( @RequestBody(required=true)  UnAssignToEndNameTsoFromConnectivityNodeCommand command ) {
		try {
