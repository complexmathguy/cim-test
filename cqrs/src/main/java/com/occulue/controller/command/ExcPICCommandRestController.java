...
public class ExcPICCommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfdmax( @RequestBody(required=true)  UnAssignEfdmaxFromExcPICCommand command ) {
		try {
	...
	public void unAssignEfdmin( @RequestBody(required=true)  UnAssignEfdminFromExcPICCommand command ) {
		try {
