...
public class PositionPointCommandRestController extends BaseSpringRestController {
	...
	public void assignSequenceNumber( @RequestBody AssignSequenceNumberToPositionPointCommand command ) {
		try {
	...
	public void unAssignSequenceNumber( @RequestBody(required=true)  UnAssignSequenceNumberFromPositionPointCommand command ) {
		try {
	...
	public void unAssignXPosition( @RequestBody(required=true)  UnAssignXPositionFromPositionPointCommand command ) {
		try {
	...
	public void unAssignYPosition( @RequestBody(required=true)  UnAssignYPositionFromPositionPointCommand command ) {
		try {
	...
	public void unAssignZPosition( @RequestBody(required=true)  UnAssignZPositionFromPositionPointCommand command ) {
		try {
