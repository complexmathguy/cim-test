...
public class OverexcLimX1CommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfd1( @RequestBody(required=true)  UnAssignEfd1FromOverexcLimX1Command command ) {
		try {
	...
	public void unAssignEfd2( @RequestBody(required=true)  UnAssignEfd2FromOverexcLimX1Command command ) {
		try {
	...
	public void unAssignEfd3( @RequestBody(required=true)  UnAssignEfd3FromOverexcLimX1Command command ) {
		try {
	...
	public void unAssignEfddes( @RequestBody(required=true)  UnAssignEfddesFromOverexcLimX1Command command ) {
		try {
	...
	public void unAssignEfdrated( @RequestBody(required=true)  UnAssignEfdratedFromOverexcLimX1Command command ) {
		try {
	...
	public void unAssignKmx( @RequestBody(required=true)  UnAssignKmxFromOverexcLimX1Command command ) {
		try {
	...
	public void unAssignVlow( @RequestBody(required=true)  UnAssignVlowFromOverexcLimX1Command command ) {
		try {
