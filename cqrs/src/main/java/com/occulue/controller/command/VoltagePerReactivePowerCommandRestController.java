...
public class VoltagePerReactivePowerCommandRestController extends BaseSpringRestController {
	...
	public void assignValue( @RequestBody AssignValueToVoltagePerReactivePowerCommand command ) {
		try {
			VoltagePerReactivePowerBusinessDelegate.getVoltagePerReactivePowerInstance().assignValue( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignValue( @RequestBody(required=true)  UnAssignValueFromVoltagePerReactivePowerCommand command ) {
		try {
			VoltagePerReactivePowerBusinessDelegate.getVoltagePerReactivePowerInstance().unAssignValue( command );   
		}
		catch( Exception exc ) {
