...
public class DynamicsFunctionBlockCommandRestController extends BaseSpringRestController {
	...
	public void assignEnabled( @RequestBody AssignEnabledToDynamicsFunctionBlockCommand command ) {
		try {
			DynamicsFunctionBlockBusinessDelegate.getDynamicsFunctionBlockInstance().assignEnabled( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEnabled( @RequestBody(required=true)  UnAssignEnabledFromDynamicsFunctionBlockCommand command ) {
		try {
			DynamicsFunctionBlockBusinessDelegate.getDynamicsFunctionBlockInstance().unAssignEnabled( command );   
		}
		catch( Exception exc ) {
