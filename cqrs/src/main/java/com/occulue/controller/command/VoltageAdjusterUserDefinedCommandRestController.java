...
public class VoltageAdjusterUserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToVoltageAdjusterUserDefinedCommand command ) {
		try {
			VoltageAdjusterUserDefinedBusinessDelegate.getVoltageAdjusterUserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromVoltageAdjusterUserDefinedCommand command ) {
		try {
			VoltageAdjusterUserDefinedBusinessDelegate.getVoltageAdjusterUserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
