...
public class ExcST3ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfdmax( @RequestBody(required=true)  UnAssignEfdmaxFromExcST3ACommand command ) {
		try {
	...
	public void unAssignThetap( @RequestBody(required=true)  UnAssignThetapFromExcST3ACommand command ) {
		try {
