...
public class ExcAC5ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignSeefd1( @RequestBody(required=true)  UnAssignSeefd1FromExcAC5ACommand command ) {
		try {
	...
	public void unAssignSeefd2( @RequestBody(required=true)  UnAssignSeefd2FromExcAC5ACommand command ) {
		try {
