...
public class PFVArType2IEEEPFControllerCommandRestController extends BaseSpringRestController {
	...
	public void assignExlon( @RequestBody AssignExlonToPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().assignExlon( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignExlon( @RequestBody(required=true)  UnAssignExlonFromPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().unAssignExlon( command );   
		}
		catch( Exception exc ) {
	...
	public void assignKi( @RequestBody AssignKiToPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().assignKi( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKi( @RequestBody(required=true)  UnAssignKiFromPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().unAssignKi( command );   
		}
		catch( Exception exc ) {
	...
	public void assignKp( @RequestBody AssignKpToPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().assignKp( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKp( @RequestBody(required=true)  UnAssignKpFromPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().unAssignKp( command );   
		}
		catch( Exception exc ) {
	...
	public void assignPfref( @RequestBody AssignPfrefToPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().assignPfref( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPfref( @RequestBody(required=true)  UnAssignPfrefFromPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().unAssignPfref( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVclmt( @RequestBody AssignVclmtToPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().assignVclmt( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVclmt( @RequestBody(required=true)  UnAssignVclmtFromPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().unAssignVclmt( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVref( @RequestBody AssignVrefToPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().assignVref( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVref( @RequestBody(required=true)  UnAssignVrefFromPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().unAssignVref( command );   
		}
		catch( Exception exc ) {
	...
	public void assignVs( @RequestBody AssignVsToPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().assignVs( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVs( @RequestBody(required=true)  UnAssignVsFromPFVArType2IEEEPFControllerCommand command ) {
		try {
			PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance().unAssignVs( command );   
		}
		catch( Exception exc ) {
