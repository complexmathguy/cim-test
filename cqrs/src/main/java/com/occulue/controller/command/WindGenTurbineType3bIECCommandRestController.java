...
public class WindGenTurbineType3bIECCommandRestController extends BaseSpringRestController {
	...
	public void assignFducw( @RequestBody AssignFducwToWindGenTurbineType3bIECCommand command ) {
		try {
			WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance().assignFducw( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignFducw( @RequestBody(required=true)  UnAssignFducwFromWindGenTurbineType3bIECCommand command ) {
		try {
			WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance().unAssignFducw( command );   
		}
		catch( Exception exc ) {
	...
	public void assignMwtcwp( @RequestBody AssignMwtcwpToWindGenTurbineType3bIECCommand command ) {
		try {
			WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance().assignMwtcwp( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignMwtcwp( @RequestBody(required=true)  UnAssignMwtcwpFromWindGenTurbineType3bIECCommand command ) {
		try {
			WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance().unAssignMwtcwp( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTg( @RequestBody AssignTgToWindGenTurbineType3bIECCommand command ) {
		try {
			WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance().assignTg( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTg( @RequestBody(required=true)  UnAssignTgFromWindGenTurbineType3bIECCommand command ) {
		try {
			WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance().unAssignTg( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTwo( @RequestBody AssignTwoToWindGenTurbineType3bIECCommand command ) {
		try {
			WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance().assignTwo( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTwo( @RequestBody(required=true)  UnAssignTwoFromWindGenTurbineType3bIECCommand command ) {
		try {
			WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance().unAssignTwo( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXs( @RequestBody AssignXsToWindGenTurbineType3bIECCommand command ) {
		try {
			WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance().assignXs( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXs( @RequestBody(required=true)  UnAssignXsFromWindGenTurbineType3bIECCommand command ) {
		try {
			WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance().unAssignXs( command );   
		}
		catch( Exception exc ) {
