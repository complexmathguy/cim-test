...
public class GovHydroPID2CommandRestController extends BaseSpringRestController {
	...
	public void unAssignAtw( @RequestBody(required=true)  UnAssignAtwFromGovHydroPID2Command command ) {
		try {
	...
	public void unAssignFeedbackSignal( @RequestBody(required=true)  UnAssignFeedbackSignalFromGovHydroPID2Command command ) {
		try {
	...
	public void unAssignGmax( @RequestBody(required=true)  UnAssignGmaxFromGovHydroPID2Command command ) {
		try {
	...
	public void unAssignGmin( @RequestBody(required=true)  UnAssignGminFromGovHydroPID2Command command ) {
		try {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovHydroPID2Command command ) {
		try {
	...
	public void unAssignRperm( @RequestBody(required=true)  UnAssignRpermFromGovHydroPID2Command command ) {
		try {
	...
	public void unAssignTreg( @RequestBody(required=true)  UnAssignTregFromGovHydroPID2Command command ) {
		try {
	...
	public void unAssignVelmax( @RequestBody(required=true)  UnAssignVelmaxFromGovHydroPID2Command command ) {
		try {
	...
	public void unAssignVelmin( @RequestBody(required=true)  UnAssignVelminFromGovHydroPID2Command command ) {
		try {
