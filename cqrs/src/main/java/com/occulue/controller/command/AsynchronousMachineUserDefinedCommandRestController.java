...
public class AsynchronousMachineUserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToAsynchronousMachineUserDefinedCommand command ) {
		try {
			AsynchronousMachineUserDefinedBusinessDelegate.getAsynchronousMachineUserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromAsynchronousMachineUserDefinedCommand command ) {
		try {
			AsynchronousMachineUserDefinedBusinessDelegate.getAsynchronousMachineUserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
