...
public class DiscExcContIEEEDEC1ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignEsc( @RequestBody(required=true)  UnAssignEscFromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignKan( @RequestBody(required=true)  UnAssignKanFromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignKetl( @RequestBody(required=true)  UnAssignKetlFromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignTan( @RequestBody(required=true)  UnAssignTanFromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignTd( @RequestBody(required=true)  UnAssignTdFromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignTl1( @RequestBody(required=true)  UnAssignTl1FromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignTl2( @RequestBody(required=true)  UnAssignTl2FromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignTw5( @RequestBody(required=true)  UnAssignTw5FromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignValue( @RequestBody(required=true)  UnAssignValueFromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignVanmax( @RequestBody(required=true)  UnAssignVanmaxFromDiscExcContIEEEDEC1ACommand command ) {
		try {
			DiscExcContIEEEDEC1ABusinessDelegate.getDiscExcContIEEEDEC1AInstance().unAssignVanmax( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignVomax( @RequestBody(required=true)  UnAssignVomaxFromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignVomin( @RequestBody(required=true)  UnAssignVominFromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignVsmax( @RequestBody(required=true)  UnAssignVsmaxFromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignVsmin( @RequestBody(required=true)  UnAssignVsminFromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignVtc( @RequestBody(required=true)  UnAssignVtcFromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignVtlmt( @RequestBody(required=true)  UnAssignVtlmtFromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignVtm( @RequestBody(required=true)  UnAssignVtmFromDiscExcContIEEEDEC1ACommand command ) {
		try {
	...
	public void unAssignVtn( @RequestBody(required=true)  UnAssignVtnFromDiscExcContIEEEDEC1ACommand command ) {
		try {
