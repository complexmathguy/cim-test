...
public class AnalogCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save PositiveFlowIn on Analog
     * @param		command AssignPositiveFlowInToAnalogCommand
     */     
	@PutMapping("/assignPositiveFlowIn")
	public void assignPositiveFlowIn( @RequestBody AssignPositiveFlowInToAnalogCommand command ) {
		try {
			AnalogBusinessDelegate.getAnalogInstance().assignPositiveFlowIn( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPositiveFlowIn( @RequestBody(required=true)  UnAssignPositiveFlowInFromAnalogCommand command ) {
		try {
			AnalogBusinessDelegate.getAnalogInstance().unAssignPositiveFlowIn( command );   
		}
		catch( Exception exc ) {
