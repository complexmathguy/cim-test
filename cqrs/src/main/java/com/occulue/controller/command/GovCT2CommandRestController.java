...
public class GovCT2CommandRestController extends BaseSpringRestController {
	...
	public void unAssignFlim10( @RequestBody(required=true)  UnAssignFlim10FromGovCT2Command command ) {
		try {
	...
	public void unAssignKiload( @RequestBody(required=true)  UnAssignKiloadFromGovCT2Command command ) {
		try {
	...
	public void unAssignKpload( @RequestBody(required=true)  UnAssignKploadFromGovCT2Command command ) {
		try {
	...
	public void unAssignMaxerr( @RequestBody(required=true)  UnAssignMaxerrFromGovCT2Command command ) {
		try {
	...
	public void unAssignMinerr( @RequestBody(required=true)  UnAssignMinerrFromGovCT2Command command ) {
		try {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovCT2Command command ) {
		try {
	...
	public void unAssignPlim10( @RequestBody(required=true)  UnAssignPlim10FromGovCT2Command command ) {
		try {
	...
	public void unAssignRclose( @RequestBody(required=true)  UnAssignRcloseFromGovCT2Command command ) {
		try {
	...
	public void unAssignTfload( @RequestBody(required=true)  UnAssignTfloadFromGovCT2Command command ) {
		try {
	...
	public void unAssignTpelec( @RequestBody(required=true)  UnAssignTpelecFromGovCT2Command command ) {
		try {
