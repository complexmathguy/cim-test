...
public class LinearShuntCompensatorCommandRestController extends BaseSpringRestController {
	...
	public void assignB0PerSection( @RequestBody AssignB0PerSectionToLinearShuntCompensatorCommand command ) {
		try {
			LinearShuntCompensatorBusinessDelegate.getLinearShuntCompensatorInstance().assignB0PerSection( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignB0PerSection( @RequestBody(required=true)  UnAssignB0PerSectionFromLinearShuntCompensatorCommand command ) {
		try {
			LinearShuntCompensatorBusinessDelegate.getLinearShuntCompensatorInstance().unAssignB0PerSection( command );   
		}
		catch( Exception exc ) {
	...
	public void assignBPerSection( @RequestBody AssignBPerSectionToLinearShuntCompensatorCommand command ) {
		try {
			LinearShuntCompensatorBusinessDelegate.getLinearShuntCompensatorInstance().assignBPerSection( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBPerSection( @RequestBody(required=true)  UnAssignBPerSectionFromLinearShuntCompensatorCommand command ) {
		try {
			LinearShuntCompensatorBusinessDelegate.getLinearShuntCompensatorInstance().unAssignBPerSection( command );   
		}
		catch( Exception exc ) {
	...
	public void assignG0PerSection( @RequestBody AssignG0PerSectionToLinearShuntCompensatorCommand command ) {
		try {
			LinearShuntCompensatorBusinessDelegate.getLinearShuntCompensatorInstance().assignG0PerSection( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignG0PerSection( @RequestBody(required=true)  UnAssignG0PerSectionFromLinearShuntCompensatorCommand command ) {
		try {
			LinearShuntCompensatorBusinessDelegate.getLinearShuntCompensatorInstance().unAssignG0PerSection( command );   
		}
		catch( Exception exc ) {
	...
	public void assignGPerSection( @RequestBody AssignGPerSectionToLinearShuntCompensatorCommand command ) {
		try {
			LinearShuntCompensatorBusinessDelegate.getLinearShuntCompensatorInstance().assignGPerSection( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignGPerSection( @RequestBody(required=true)  UnAssignGPerSectionFromLinearShuntCompensatorCommand command ) {
		try {
			LinearShuntCompensatorBusinessDelegate.getLinearShuntCompensatorInstance().unAssignGPerSection( command );   
		}
		catch( Exception exc ) {
