...
public class ACLineSegmentCommandRestController extends BaseSpringRestController {
	...
	public void unAssignB0ch( @RequestBody(required=true)  UnAssignB0chFromACLineSegmentCommand command ) {
		try {
	...
	public void unAssignBch( @RequestBody(required=true)  UnAssignBchFromACLineSegmentCommand command ) {
		try {
	...
	public void unAssignG0ch( @RequestBody(required=true)  UnAssignG0chFromACLineSegmentCommand command ) {
		try {
	...
	public void unAssignGch( @RequestBody(required=true)  UnAssignGchFromACLineSegmentCommand command ) {
		try {
	...
	public void assignShortCircuitEndTemperature( @RequestBody AssignShortCircuitEndTemperatureToACLineSegmentCommand command ) {
		try {
			ACLineSegmentBusinessDelegate.getACLineSegmentInstance().assignShortCircuitEndTemperature( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignShortCircuitEndTemperature( @RequestBody(required=true)  UnAssignShortCircuitEndTemperatureFromACLineSegmentCommand command ) {
		try {
			ACLineSegmentBusinessDelegate.getACLineSegmentInstance().unAssignShortCircuitEndTemperature( command );   
		}
		catch( Exception exc ) {
