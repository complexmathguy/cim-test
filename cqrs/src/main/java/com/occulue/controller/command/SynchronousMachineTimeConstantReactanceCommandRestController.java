...
public class SynchronousMachineTimeConstantReactanceCommandRestController extends BaseSpringRestController {
     ...
     */     
	@PutMapping("/assignKs")
	public void assignKs( @RequestBody AssignKsToSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().assignKs( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKs( @RequestBody(required=true)  UnAssignKsFromSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().unAssignKs( command );   
		}
		catch( Exception exc ) {
     ...
     */     
	@PutMapping("/assignTc")
	public void assignTc( @RequestBody AssignTcToSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().assignTc( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTc( @RequestBody(required=true)  UnAssignTcFromSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().unAssignTc( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTpdo( @RequestBody AssignTpdoToSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().assignTpdo( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTpdo( @RequestBody(required=true)  UnAssignTpdoFromSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().unAssignTpdo( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTppdo( @RequestBody AssignTppdoToSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().assignTppdo( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTppdo( @RequestBody(required=true)  UnAssignTppdoFromSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().unAssignTppdo( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTppqo( @RequestBody AssignTppqoToSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().assignTppqo( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTppqo( @RequestBody(required=true)  UnAssignTppqoFromSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().unAssignTppqo( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTpqo( @RequestBody AssignTpqoToSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().assignTpqo( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTpqo( @RequestBody(required=true)  UnAssignTpqoFromSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().unAssignTpqo( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXDirectSubtrans( @RequestBody AssignXDirectSubtransToSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().assignXDirectSubtrans( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXDirectSubtrans( @RequestBody(required=true)  UnAssignXDirectSubtransFromSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().unAssignXDirectSubtrans( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXDirectSync( @RequestBody AssignXDirectSyncToSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().assignXDirectSync( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXDirectSync( @RequestBody(required=true)  UnAssignXDirectSyncFromSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().unAssignXDirectSync( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXDirectTrans( @RequestBody AssignXDirectTransToSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().assignXDirectTrans( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXDirectTrans( @RequestBody(required=true)  UnAssignXDirectTransFromSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().unAssignXDirectTrans( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXQuadSubtrans( @RequestBody AssignXQuadSubtransToSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().assignXQuadSubtrans( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXQuadSubtrans( @RequestBody(required=true)  UnAssignXQuadSubtransFromSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().unAssignXQuadSubtrans( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXQuadSync( @RequestBody AssignXQuadSyncToSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().assignXQuadSync( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXQuadSync( @RequestBody(required=true)  UnAssignXQuadSyncFromSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().unAssignXQuadSync( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXQuadTrans( @RequestBody AssignXQuadTransToSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().assignXQuadTrans( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXQuadTrans( @RequestBody(required=true)  UnAssignXQuadTransFromSynchronousMachineTimeConstantReactanceCommand command ) {
		try {
			SynchronousMachineTimeConstantReactanceBusinessDelegate.getSynchronousMachineTimeConstantReactanceInstance().unAssignXQuadTrans( command );   
		}
		catch( Exception exc ) {
