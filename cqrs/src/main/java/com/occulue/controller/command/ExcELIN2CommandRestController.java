...
public class ExcELIN2CommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfdbas( @RequestBody(required=true)  UnAssignEfdbasFromExcELIN2Command command ) {
		try {
	...
	public void unAssignIefmax( @RequestBody(required=true)  UnAssignIefmaxFromExcELIN2Command command ) {
		try {
	...
	public void unAssignIefmax2( @RequestBody(required=true)  UnAssignIefmax2FromExcELIN2Command command ) {
		try {
	...
	public void unAssignIefmin( @RequestBody(required=true)  UnAssignIefminFromExcELIN2Command command ) {
		try {
	...
	public void unAssignPid1max( @RequestBody(required=true)  UnAssignPid1maxFromExcELIN2Command command ) {
		try {
	...
	public void unAssignSeve1( @RequestBody(required=true)  UnAssignSeve1FromExcELIN2Command command ) {
		try {
	...
	public void unAssignSeve2( @RequestBody(required=true)  UnAssignSeve2FromExcELIN2Command command ) {
		try {
	...
	public void unAssignUpmax( @RequestBody(required=true)  UnAssignUpmaxFromExcELIN2Command command ) {
		try {
	...
	public void unAssignUpmin( @RequestBody(required=true)  UnAssignUpminFromExcELIN2Command command ) {
		try {
