...
public class GovSteamCCCommandRestController extends BaseSpringRestController {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovSteamCCCommand command ) {
		try {
	...
	public void unAssignPmaxhp( @RequestBody(required=true)  UnAssignPmaxhpFromGovSteamCCCommand command ) {
		try {
	...
	public void unAssignPmaxlp( @RequestBody(required=true)  UnAssignPmaxlpFromGovSteamCCCommand command ) {
		try {
	...
	public void unAssignT1hp( @RequestBody(required=true)  UnAssignT1hpFromGovSteamCCCommand command ) {
		try {
	...
	public void unAssignT1lp( @RequestBody(required=true)  UnAssignT1lpFromGovSteamCCCommand command ) {
		try {
	...
	public void unAssignT3hp( @RequestBody(required=true)  UnAssignT3hpFromGovSteamCCCommand command ) {
		try {
	...
	public void unAssignT3lp( @RequestBody(required=true)  UnAssignT3lpFromGovSteamCCCommand command ) {
		try {
	...
	public void unAssignT4hp( @RequestBody(required=true)  UnAssignT4hpFromGovSteamCCCommand command ) {
		try {
	...
	public void unAssignT4lp( @RequestBody(required=true)  UnAssignT4lpFromGovSteamCCCommand command ) {
		try {
	...
	public void unAssignT5hp( @RequestBody(required=true)  UnAssignT5hpFromGovSteamCCCommand command ) {
		try {
	...
	public void unAssignT5lp( @RequestBody(required=true)  UnAssignT5lpFromGovSteamCCCommand command ) {
		try {
