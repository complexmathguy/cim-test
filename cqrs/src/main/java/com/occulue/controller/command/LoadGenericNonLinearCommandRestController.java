...
public class LoadGenericNonLinearCommandRestController extends BaseSpringRestController {
	...
	public void unAssignBs( @RequestBody(required=true)  UnAssignBsFromLoadGenericNonLinearCommand command ) {
		try {
	...
	public void unAssignBt( @RequestBody(required=true)  UnAssignBtFromLoadGenericNonLinearCommand command ) {
		try {
	...
	public void unAssignLs( @RequestBody(required=true)  UnAssignLsFromLoadGenericNonLinearCommand command ) {
		try {
	...
	public void unAssignLt( @RequestBody(required=true)  UnAssignLtFromLoadGenericNonLinearCommand command ) {
		try {
	...
	public void unAssignPt( @RequestBody(required=true)  UnAssignPtFromLoadGenericNonLinearCommand command ) {
		try {
	...
	public void unAssignQt( @RequestBody(required=true)  UnAssignQtFromLoadGenericNonLinearCommand command ) {
		try {
	...
	public void unAssignTp( @RequestBody(required=true)  UnAssignTpFromLoadGenericNonLinearCommand command ) {
		try {
	...
	public void unAssignTq( @RequestBody(required=true)  UnAssignTqFromLoadGenericNonLinearCommand command ) {
		try {
