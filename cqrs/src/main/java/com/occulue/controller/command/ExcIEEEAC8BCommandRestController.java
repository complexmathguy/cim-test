...
public class ExcIEEEAC8BCommandRestController extends BaseSpringRestController {
	...
	public void unAssignSeve1( @RequestBody(required=true)  UnAssignSeve1FromExcIEEEAC8BCommand command ) {
		try {
	...
	public void unAssignSeve2( @RequestBody(required=true)  UnAssignSeve2FromExcIEEEAC8BCommand command ) {
		try {
	...
	public void unAssignVemin( @RequestBody(required=true)  UnAssignVeminFromExcIEEEAC8BCommand command ) {
		try {
	...
	public void unAssignVfemax( @RequestBody(required=true)  UnAssignVfemaxFromExcIEEEAC8BCommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEAC8BCommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEAC8BCommand command ) {
		try {
