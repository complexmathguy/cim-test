...
public class GovGAST2CommandRestController extends BaseSpringRestController {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovGAST2Command command ) {
		try {
	...
	public void unAssignTrate( @RequestBody(required=true)  UnAssignTrateFromGovGAST2Command command ) {
		try {
