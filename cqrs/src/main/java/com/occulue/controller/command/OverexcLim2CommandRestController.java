...
public class OverexcLim2CommandRestController extends BaseSpringRestController {
	...
	public void unAssignIfdlim( @RequestBody(required=true)  UnAssignIfdlimFromOverexcLim2Command command ) {
		try {
	...
	public void unAssignVoimax( @RequestBody(required=true)  UnAssignVoimaxFromOverexcLim2Command command ) {
		try {
	...
	public void unAssignVoimin( @RequestBody(required=true)  UnAssignVoiminFromOverexcLim2Command command ) {
		try {
