...
public class DCShuntCommandRestController extends BaseSpringRestController {
	...
	public void unAssignCapacitance( @RequestBody(required=true)  UnAssignCapacitanceFromDCShuntCommand command ) {
		try {
	...
	public void unAssignRatedUdc( @RequestBody(required=true)  UnAssignRatedUdcFromDCShuntCommand command ) {
		try {
	...
	public void unAssignResistance( @RequestBody(required=true)  UnAssignResistanceFromDCShuntCommand command ) {
		try {
