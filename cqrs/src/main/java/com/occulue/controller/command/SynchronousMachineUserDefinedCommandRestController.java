...
public class SynchronousMachineUserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToSynchronousMachineUserDefinedCommand command ) {
		try {
			SynchronousMachineUserDefinedBusinessDelegate.getSynchronousMachineUserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromSynchronousMachineUserDefinedCommand command ) {
		try {
			SynchronousMachineUserDefinedBusinessDelegate.getSynchronousMachineUserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
