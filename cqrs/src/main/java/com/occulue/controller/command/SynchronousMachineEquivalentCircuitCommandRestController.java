...
public class SynchronousMachineEquivalentCircuitCommandRestController extends BaseSpringRestController {
	...
	public void assignR1d( @RequestBody AssignR1dToSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().assignR1d( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignR1d( @RequestBody(required=true)  UnAssignR1dFromSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().unAssignR1d( command );   
		}
		catch( Exception exc ) {
	...
	public void assignR1q( @RequestBody AssignR1qToSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().assignR1q( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignR1q( @RequestBody(required=true)  UnAssignR1qFromSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().unAssignR1q( command );   
		}
		catch( Exception exc ) {
	...
	public void assignR2q( @RequestBody AssignR2qToSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().assignR2q( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignR2q( @RequestBody(required=true)  UnAssignR2qFromSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().unAssignR2q( command );   
		}
		catch( Exception exc ) {
	...
	public void assignRfd( @RequestBody AssignRfdToSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().assignRfd( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignRfd( @RequestBody(required=true)  UnAssignRfdFromSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().unAssignRfd( command );   
		}
		catch( Exception exc ) {
	...
	public void assignX1d( @RequestBody AssignX1dToSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().assignX1d( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignX1d( @RequestBody(required=true)  UnAssignX1dFromSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().unAssignX1d( command );   
		}
		catch( Exception exc ) {
	...
	public void assignX1q( @RequestBody AssignX1qToSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().assignX1q( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignX1q( @RequestBody(required=true)  UnAssignX1qFromSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().unAssignX1q( command );   
		}
		catch( Exception exc ) {
	...
	public void assignX2q( @RequestBody AssignX2qToSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().assignX2q( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignX2q( @RequestBody(required=true)  UnAssignX2qFromSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().unAssignX2q( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXad( @RequestBody AssignXadToSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().assignXad( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXad( @RequestBody(required=true)  UnAssignXadFromSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().unAssignXad( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXaq( @RequestBody AssignXaqToSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().assignXaq( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXaq( @RequestBody(required=true)  UnAssignXaqFromSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().unAssignXaq( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXf1d( @RequestBody AssignXf1dToSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().assignXf1d( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXf1d( @RequestBody(required=true)  UnAssignXf1dFromSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().unAssignXf1d( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXfd( @RequestBody AssignXfdToSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().assignXfd( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXfd( @RequestBody(required=true)  UnAssignXfdFromSynchronousMachineEquivalentCircuitCommand command ) {
		try {
			SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().unAssignXfd( command );   
		}
		catch( Exception exc ) {
