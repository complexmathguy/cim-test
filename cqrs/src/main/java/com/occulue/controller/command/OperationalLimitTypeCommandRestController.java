...
public class OperationalLimitTypeCommandRestController extends BaseSpringRestController {
	...
	public void assignAcceptableDuration( @RequestBody AssignAcceptableDurationToOperationalLimitTypeCommand command ) {
		try {
			OperationalLimitTypeBusinessDelegate.getOperationalLimitTypeInstance().assignAcceptableDuration( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignAcceptableDuration( @RequestBody(required=true)  UnAssignAcceptableDurationFromOperationalLimitTypeCommand command ) {
		try {
			OperationalLimitTypeBusinessDelegate.getOperationalLimitTypeInstance().unAssignAcceptableDuration( command );   
		}
		catch( Exception exc ) {
