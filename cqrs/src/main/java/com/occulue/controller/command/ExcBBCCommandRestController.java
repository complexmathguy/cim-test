...
public class ExcBBCCommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfdmax( @RequestBody(required=true)  UnAssignEfdmaxFromExcBBCCommand command ) {
		try {
	...
	public void unAssignEfdmin( @RequestBody(required=true)  UnAssignEfdminFromExcBBCCommand command ) {
		try {
	...
	public void unAssignSwitchIt( @RequestBody(required=true)  UnAssignSwitchItFromExcBBCCommand command ) {
		try {
