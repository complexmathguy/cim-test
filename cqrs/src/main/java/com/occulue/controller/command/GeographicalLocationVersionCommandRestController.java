...
public class GeographicalLocationVersionCommandRestController extends BaseSpringRestController {
	...
	public void assignBaseUML( @RequestBody AssignBaseUMLToGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().assignBaseUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBaseUML( @RequestBody(required=true)  UnAssignBaseUMLFromGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().unAssignBaseUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignBaseURI( @RequestBody AssignBaseURIToGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().assignBaseURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBaseURI( @RequestBody(required=true)  UnAssignBaseURIFromGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().unAssignBaseURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignDate( @RequestBody AssignDateToGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().assignDate( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDate( @RequestBody(required=true)  UnAssignDateFromGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().unAssignDate( command );   
		}
		catch( Exception exc ) {
	...
	public void assignDifferenceModelURI( @RequestBody AssignDifferenceModelURIToGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().assignDifferenceModelURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDifferenceModelURI( @RequestBody(required=true)  UnAssignDifferenceModelURIFromGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().unAssignDifferenceModelURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeUML( @RequestBody AssignEntsoeUMLToGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().assignEntsoeUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeUML( @RequestBody(required=true)  UnAssignEntsoeUMLFromGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().unAssignEntsoeUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeURI( @RequestBody AssignEntsoeURIToGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().assignEntsoeURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeURI( @RequestBody(required=true)  UnAssignEntsoeURIFromGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().unAssignEntsoeURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignModelDescriptionURI( @RequestBody AssignModelDescriptionURIToGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().assignModelDescriptionURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignModelDescriptionURI( @RequestBody(required=true)  UnAssignModelDescriptionURIFromGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().unAssignModelDescriptionURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNamespaceRDF( @RequestBody AssignNamespaceRDFToGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().assignNamespaceRDF( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNamespaceRDF( @RequestBody(required=true)  UnAssignNamespaceRDFFromGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().unAssignNamespaceRDF( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNamespaceUML( @RequestBody AssignNamespaceUMLToGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().assignNamespaceUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNamespaceUML( @RequestBody(required=true)  UnAssignNamespaceUMLFromGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().unAssignNamespaceUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignShortName( @RequestBody AssignShortNameToGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().assignShortName( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignShortName( @RequestBody(required=true)  UnAssignShortNameFromGeographicalLocationVersionCommand command ) {
		try {
			GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance().unAssignShortName( command );   
		}
		catch( Exception exc ) {
