...
public class ExcIEEEAC7BCommandRestController extends BaseSpringRestController {
	...
	public void unAssignSeve1( @RequestBody(required=true)  UnAssignSeve1FromExcIEEEAC7BCommand command ) {
		try {
	...
	public void unAssignSeve2( @RequestBody(required=true)  UnAssignSeve2FromExcIEEEAC7BCommand command ) {
		try {
	...
	public void unAssignVamax( @RequestBody(required=true)  UnAssignVamaxFromExcIEEEAC7BCommand command ) {
		try {
	...
	public void unAssignVamin( @RequestBody(required=true)  UnAssignVaminFromExcIEEEAC7BCommand command ) {
		try {
	...
	public void unAssignVemin( @RequestBody(required=true)  UnAssignVeminFromExcIEEEAC7BCommand command ) {
		try {
	...
	public void unAssignVfemax( @RequestBody(required=true)  UnAssignVfemaxFromExcIEEEAC7BCommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEAC7BCommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEAC7BCommand command ) {
		try {
