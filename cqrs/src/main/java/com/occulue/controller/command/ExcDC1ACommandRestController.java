...
public class ExcDC1ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignEdfmax( @RequestBody(required=true)  UnAssignEdfmaxFromExcDC1ACommand command ) {
		try {
	...
	public void unAssignEfdmin( @RequestBody(required=true)  UnAssignEfdminFromExcDC1ACommand command ) {
		try {
	...
	public void unAssignExclim( @RequestBody(required=true)  UnAssignExclimFromExcDC1ACommand command ) {
		try {
	...
	public void unAssignSeefd1( @RequestBody(required=true)  UnAssignSeefd1FromExcDC1ACommand command ) {
		try {
	...
	public void unAssignSeefd2( @RequestBody(required=true)  UnAssignSeefd2FromExcDC1ACommand command ) {
		try {
