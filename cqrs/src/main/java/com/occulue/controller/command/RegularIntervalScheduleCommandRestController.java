...
public class RegularIntervalScheduleCommandRestController extends BaseSpringRestController {
	...
	public void assignEndTime( @RequestBody AssignEndTimeToRegularIntervalScheduleCommand command ) {
		try {
			RegularIntervalScheduleBusinessDelegate.getRegularIntervalScheduleInstance().assignEndTime( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEndTime( @RequestBody(required=true)  UnAssignEndTimeFromRegularIntervalScheduleCommand command ) {
		try {
			RegularIntervalScheduleBusinessDelegate.getRegularIntervalScheduleInstance().unAssignEndTime( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTimeStep( @RequestBody AssignTimeStepToRegularIntervalScheduleCommand command ) {
		try {
			RegularIntervalScheduleBusinessDelegate.getRegularIntervalScheduleInstance().assignTimeStep( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTimeStep( @RequestBody(required=true)  UnAssignTimeStepFromRegularIntervalScheduleCommand command ) {
		try {
			RegularIntervalScheduleBusinessDelegate.getRegularIntervalScheduleInstance().unAssignTimeStep( command );   
		}
		catch( Exception exc ) {
