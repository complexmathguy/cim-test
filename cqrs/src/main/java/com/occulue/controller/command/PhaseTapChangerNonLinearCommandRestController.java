...
public class PhaseTapChangerNonLinearCommandRestController extends BaseSpringRestController {
	...
	public void assignVoltageStepIncrement( @RequestBody AssignVoltageStepIncrementToPhaseTapChangerNonLinearCommand command ) {
		try {
			PhaseTapChangerNonLinearBusinessDelegate.getPhaseTapChangerNonLinearInstance().assignVoltageStepIncrement( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVoltageStepIncrement( @RequestBody(required=true)  UnAssignVoltageStepIncrementFromPhaseTapChangerNonLinearCommand command ) {
		try {
			PhaseTapChangerNonLinearBusinessDelegate.getPhaseTapChangerNonLinearInstance().unAssignVoltageStepIncrement( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXMax( @RequestBody AssignXMaxToPhaseTapChangerNonLinearCommand command ) {
		try {
			PhaseTapChangerNonLinearBusinessDelegate.getPhaseTapChangerNonLinearInstance().assignXMax( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXMax( @RequestBody(required=true)  UnAssignXMaxFromPhaseTapChangerNonLinearCommand command ) {
		try {
			PhaseTapChangerNonLinearBusinessDelegate.getPhaseTapChangerNonLinearInstance().unAssignXMax( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXMin( @RequestBody AssignXMinToPhaseTapChangerNonLinearCommand command ) {
		try {
			PhaseTapChangerNonLinearBusinessDelegate.getPhaseTapChangerNonLinearInstance().assignXMin( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXMin( @RequestBody(required=true)  UnAssignXMinFromPhaseTapChangerNonLinearCommand command ) {
		try {
			PhaseTapChangerNonLinearBusinessDelegate.getPhaseTapChangerNonLinearInstance().unAssignXMin( command );   
		}
		catch( Exception exc ) {
