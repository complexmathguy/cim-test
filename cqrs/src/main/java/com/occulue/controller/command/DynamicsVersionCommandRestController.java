...
public class DynamicsVersionCommandRestController extends BaseSpringRestController {
	...
	public void unAssignBaseUML( @RequestBody(required=true)  UnAssignBaseUMLFromDynamicsVersionCommand command ) {
		try {
	...
	public void unAssignBaseURI( @RequestBody(required=true)  UnAssignBaseURIFromDynamicsVersionCommand command ) {
		try {
	...
	public void unAssignDate( @RequestBody(required=true)  UnAssignDateFromDynamicsVersionCommand command ) {
		try {
	...
	public void assignDifferenceModelURI( @RequestBody AssignDifferenceModelURIToDynamicsVersionCommand command ) {
		try {
			DynamicsVersionBusinessDelegate.getDynamicsVersionInstance().assignDifferenceModelURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDifferenceModelURI( @RequestBody(required=true)  UnAssignDifferenceModelURIFromDynamicsVersionCommand command ) {
		try {
			DynamicsVersionBusinessDelegate.getDynamicsVersionInstance().unAssignDifferenceModelURI( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignEntsoeUML( @RequestBody(required=true)  UnAssignEntsoeUMLFromDynamicsVersionCommand command ) {
		try {
	...
	public void unAssignEntsoeURI( @RequestBody(required=true)  UnAssignEntsoeURIFromDynamicsVersionCommand command ) {
		try {
	...
	public void assignModelDescriptionURI( @RequestBody AssignModelDescriptionURIToDynamicsVersionCommand command ) {
		try {
			DynamicsVersionBusinessDelegate.getDynamicsVersionInstance().assignModelDescriptionURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignModelDescriptionURI( @RequestBody(required=true)  UnAssignModelDescriptionURIFromDynamicsVersionCommand command ) {
		try {
			DynamicsVersionBusinessDelegate.getDynamicsVersionInstance().unAssignModelDescriptionURI( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignNamespaceRDF( @RequestBody(required=true)  UnAssignNamespaceRDFFromDynamicsVersionCommand command ) {
		try {
	...
	public void unAssignNamespaceUML( @RequestBody(required=true)  UnAssignNamespaceUMLFromDynamicsVersionCommand command ) {
		try {
	...
	public void unAssignShortName( @RequestBody(required=true)  UnAssignShortNameFromDynamicsVersionCommand command ) {
		try {
