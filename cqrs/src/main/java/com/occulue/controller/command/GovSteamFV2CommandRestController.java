...
public class GovSteamFV2CommandRestController extends BaseSpringRestController {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovSteamFV2Command command ) {
		try {
	...
	public void unAssignVmax( @RequestBody(required=true)  UnAssignVmaxFromGovSteamFV2Command command ) {
		try {
	...
	public void unAssignVmin( @RequestBody(required=true)  UnAssignVminFromGovSteamFV2Command command ) {
		try {
