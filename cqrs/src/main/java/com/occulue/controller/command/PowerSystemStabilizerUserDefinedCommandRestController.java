...
public class PowerSystemStabilizerUserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToPowerSystemStabilizerUserDefinedCommand command ) {
		try {
			PowerSystemStabilizerUserDefinedBusinessDelegate.getPowerSystemStabilizerUserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromPowerSystemStabilizerUserDefinedCommand command ) {
		try {
			PowerSystemStabilizerUserDefinedBusinessDelegate.getPowerSystemStabilizerUserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
