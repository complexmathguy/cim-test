...
public class SynchronousMachineDetailedCommandRestController extends BaseSpringRestController {
	...
	public void assignEfdBaseRatio( @RequestBody AssignEfdBaseRatioToSynchronousMachineDetailedCommand command ) {
		try {
			SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance().assignEfdBaseRatio( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEfdBaseRatio( @RequestBody(required=true)  UnAssignEfdBaseRatioFromSynchronousMachineDetailedCommand command ) {
		try {
			SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance().unAssignEfdBaseRatio( command );   
		}
		catch( Exception exc ) {
	...
	public void assignIfdBaseValue( @RequestBody AssignIfdBaseValueToSynchronousMachineDetailedCommand command ) {
		try {
			SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance().assignIfdBaseValue( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignIfdBaseValue( @RequestBody(required=true)  UnAssignIfdBaseValueFromSynchronousMachineDetailedCommand command ) {
		try {
			SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance().unAssignIfdBaseValue( command );   
		}
		catch( Exception exc ) {
	...
	public void assignSaturationFactor120QAxis( @RequestBody AssignSaturationFactor120QAxisToSynchronousMachineDetailedCommand command ) {
		try {
			SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance().assignSaturationFactor120QAxis( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignSaturationFactor120QAxis( @RequestBody(required=true)  UnAssignSaturationFactor120QAxisFromSynchronousMachineDetailedCommand command ) {
		try {
			SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance().unAssignSaturationFactor120QAxis( command );   
		}
		catch( Exception exc ) {
	...
	public void assignSaturationFactorQAxis( @RequestBody AssignSaturationFactorQAxisToSynchronousMachineDetailedCommand command ) {
		try {
			SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance().assignSaturationFactorQAxis( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignSaturationFactorQAxis( @RequestBody(required=true)  UnAssignSaturationFactorQAxisFromSynchronousMachineDetailedCommand command ) {
		try {
			SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance().unAssignSaturationFactorQAxis( command );   
		}
		catch( Exception exc ) {
