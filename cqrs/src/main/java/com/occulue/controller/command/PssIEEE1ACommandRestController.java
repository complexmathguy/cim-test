...
public class PssIEEE1ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromPssIEEE1ACommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromPssIEEE1ACommand command ) {
		try {
