...
public class ExcIEEEAC5ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignEfd1( @RequestBody(required=true)  UnAssignEfd1FromExcIEEEAC5ACommand command ) {
		try {
	...
	public void unAssignEfd2( @RequestBody(required=true)  UnAssignEfd2FromExcIEEEAC5ACommand command ) {
		try {
	...
	public void unAssignSeefd1( @RequestBody(required=true)  UnAssignSeefd1FromExcIEEEAC5ACommand command ) {
		try {
	...
	public void unAssignSeefd2( @RequestBody(required=true)  UnAssignSeefd2FromExcIEEEAC5ACommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEAC5ACommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEAC5ACommand command ) {
		try {
