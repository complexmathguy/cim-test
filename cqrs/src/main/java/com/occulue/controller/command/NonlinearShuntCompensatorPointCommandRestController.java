...
public class NonlinearShuntCompensatorPointCommandRestController extends BaseSpringRestController {
	...
	public void assignB( @RequestBody AssignBToNonlinearShuntCompensatorPointCommand command ) {
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().assignB( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignB( @RequestBody(required=true)  UnAssignBFromNonlinearShuntCompensatorPointCommand command ) {
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().unAssignB( command );   
		}
		catch( Exception exc ) {
	...
	public void assignB0( @RequestBody AssignB0ToNonlinearShuntCompensatorPointCommand command ) {
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().assignB0( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignB0( @RequestBody(required=true)  UnAssignB0FromNonlinearShuntCompensatorPointCommand command ) {
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().unAssignB0( command );   
		}
		catch( Exception exc ) {
	...
	public void assignG( @RequestBody AssignGToNonlinearShuntCompensatorPointCommand command ) {
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().assignG( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignG( @RequestBody(required=true)  UnAssignGFromNonlinearShuntCompensatorPointCommand command ) {
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().unAssignG( command );   
		}
		catch( Exception exc ) {
	...
	public void assignG0( @RequestBody AssignG0ToNonlinearShuntCompensatorPointCommand command ) {
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().assignG0( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignG0( @RequestBody(required=true)  UnAssignG0FromNonlinearShuntCompensatorPointCommand command ) {
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().unAssignG0( command );   
		}
		catch( Exception exc ) {
	...
	public void assignSectionNumber( @RequestBody AssignSectionNumberToNonlinearShuntCompensatorPointCommand command ) {
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().assignSectionNumber( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignSectionNumber( @RequestBody(required=true)  UnAssignSectionNumberFromNonlinearShuntCompensatorPointCommand command ) {
		try {
			NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().unAssignSectionNumber( command );   
		}
		catch( Exception exc ) {
