...
public class ShuntCompensatorCommandRestController extends BaseSpringRestController {
	...
	public void unAssignAVRDelay( @RequestBody(required=true)  UnAssignAVRDelayFromShuntCompensatorCommand command ) {
		try {
	...
	public void unAssignGrounded( @RequestBody(required=true)  UnAssignGroundedFromShuntCompensatorCommand command ) {
		try {
	...
	public void assignMaximumSections( @RequestBody AssignMaximumSectionsToShuntCompensatorCommand command ) {
		try {
	...
	public void unAssignMaximumSections( @RequestBody(required=true)  UnAssignMaximumSectionsFromShuntCompensatorCommand command ) {
		try {
			ShuntCompensatorBusinessDelegate.getShuntCompensatorInstance().unAssignMaximumSections( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignNomU( @RequestBody(required=true)  UnAssignNomUFromShuntCompensatorCommand command ) {
		try {
	...
	public void assignNormalSections( @RequestBody AssignNormalSectionsToShuntCompensatorCommand command ) {
		try {
	...
	public void unAssignNormalSections( @RequestBody(required=true)  UnAssignNormalSectionsFromShuntCompensatorCommand command ) {
		try {
			ShuntCompensatorBusinessDelegate.getShuntCompensatorInstance().unAssignNormalSections( command );   
		}
		catch( Exception exc ) {
	...
	public void assignSwitchOnCount( @RequestBody AssignSwitchOnCountToShuntCompensatorCommand command ) {
		try {
	...
	public void unAssignSwitchOnCount( @RequestBody(required=true)  UnAssignSwitchOnCountFromShuntCompensatorCommand command ) {
		try {
	...
	public void unAssignSwitchOnDate( @RequestBody(required=true)  UnAssignSwitchOnDateFromShuntCompensatorCommand command ) {
		try {
	...
	public void assignVoltageSensitivity( @RequestBody AssignVoltageSensitivityToShuntCompensatorCommand command ) {
		try {
			ShuntCompensatorBusinessDelegate.getShuntCompensatorInstance().assignVoltageSensitivity( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignVoltageSensitivity( @RequestBody(required=true)  UnAssignVoltageSensitivityFromShuntCompensatorCommand command ) {
		try {
			ShuntCompensatorBusinessDelegate.getShuntCompensatorInstance().unAssignVoltageSensitivity( command );   
		}
		catch( Exception exc ) {
