...
public class AsynchronousMachineEquivalentCircuitCommandRestController extends BaseSpringRestController {
	...
	public void assignRr1( @RequestBody AssignRr1ToAsynchronousMachineEquivalentCircuitCommand command ) {
		try {
			AsynchronousMachineEquivalentCircuitBusinessDelegate.getAsynchronousMachineEquivalentCircuitInstance().assignRr1( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignRr1( @RequestBody(required=true)  UnAssignRr1FromAsynchronousMachineEquivalentCircuitCommand command ) {
		try {
			AsynchronousMachineEquivalentCircuitBusinessDelegate.getAsynchronousMachineEquivalentCircuitInstance().unAssignRr1( command );   
		}
		catch( Exception exc ) {
	...
	public void assignRr2( @RequestBody AssignRr2ToAsynchronousMachineEquivalentCircuitCommand command ) {
		try {
			AsynchronousMachineEquivalentCircuitBusinessDelegate.getAsynchronousMachineEquivalentCircuitInstance().assignRr2( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignRr2( @RequestBody(required=true)  UnAssignRr2FromAsynchronousMachineEquivalentCircuitCommand command ) {
		try {
			AsynchronousMachineEquivalentCircuitBusinessDelegate.getAsynchronousMachineEquivalentCircuitInstance().unAssignRr2( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXlr1( @RequestBody AssignXlr1ToAsynchronousMachineEquivalentCircuitCommand command ) {
		try {
			AsynchronousMachineEquivalentCircuitBusinessDelegate.getAsynchronousMachineEquivalentCircuitInstance().assignXlr1( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXlr1( @RequestBody(required=true)  UnAssignXlr1FromAsynchronousMachineEquivalentCircuitCommand command ) {
		try {
			AsynchronousMachineEquivalentCircuitBusinessDelegate.getAsynchronousMachineEquivalentCircuitInstance().unAssignXlr1( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXlr2( @RequestBody AssignXlr2ToAsynchronousMachineEquivalentCircuitCommand command ) {
		try {
			AsynchronousMachineEquivalentCircuitBusinessDelegate.getAsynchronousMachineEquivalentCircuitInstance().assignXlr2( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXlr2( @RequestBody(required=true)  UnAssignXlr2FromAsynchronousMachineEquivalentCircuitCommand command ) {
		try {
			AsynchronousMachineEquivalentCircuitBusinessDelegate.getAsynchronousMachineEquivalentCircuitInstance().unAssignXlr2( command );   
		}
		catch( Exception exc ) {
	...
	public void assignXm( @RequestBody AssignXmToAsynchronousMachineEquivalentCircuitCommand command ) {
		try {
			AsynchronousMachineEquivalentCircuitBusinessDelegate.getAsynchronousMachineEquivalentCircuitInstance().assignXm( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignXm( @RequestBody(required=true)  UnAssignXmFromAsynchronousMachineEquivalentCircuitCommand command ) {
		try {
			AsynchronousMachineEquivalentCircuitBusinessDelegate.getAsynchronousMachineEquivalentCircuitInstance().unAssignXm( command );   
		}
		catch( Exception exc ) {
