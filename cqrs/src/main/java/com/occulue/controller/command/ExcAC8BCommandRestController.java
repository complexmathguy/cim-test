...
public class ExcAC8BCommandRestController extends BaseSpringRestController {
	...
	public void unAssignPidlim( @RequestBody(required=true)  UnAssignPidlimFromExcAC8BCommand command ) {
		try {
	...
	public void unAssignVfemax( @RequestBody(required=true)  UnAssignVfemaxFromExcAC8BCommand command ) {
		try {
	...
	public void unAssignVpidmax( @RequestBody(required=true)  UnAssignVpidmaxFromExcAC8BCommand command ) {
		try {
	...
	public void unAssignVpidmin( @RequestBody(required=true)  UnAssignVpidminFromExcAC8BCommand command ) {
		try {
	...
	public void unAssignVtmult( @RequestBody(required=true)  UnAssignVtmultFromExcAC8BCommand command ) {
		try {
