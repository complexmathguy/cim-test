...
public class WindPlantFreqPcontrolIECCommandRestController extends BaseSpringRestController {
	...
	public void assignDprefmax( @RequestBody AssignDprefmaxToWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().assignDprefmax( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDprefmax( @RequestBody(required=true)  UnAssignDprefmaxFromWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().unAssignDprefmax( command );   
		}
		catch( Exception exc ) {
	...
	public void assignDprefmin( @RequestBody AssignDprefminToWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().assignDprefmin( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDprefmin( @RequestBody(required=true)  UnAssignDprefminFromWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().unAssignDprefmin( command );   
		}
		catch( Exception exc ) {
	...
	public void assignKiwpp( @RequestBody AssignKiwppToWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().assignKiwpp( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKiwpp( @RequestBody(required=true)  UnAssignKiwppFromWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().unAssignKiwpp( command );   
		}
		catch( Exception exc ) {
	...
	public void assignKpwpp( @RequestBody AssignKpwppToWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().assignKpwpp( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignKpwpp( @RequestBody(required=true)  UnAssignKpwppFromWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().unAssignKpwpp( command );   
		}
		catch( Exception exc ) {
	...
	public void assignPrefmax( @RequestBody AssignPrefmaxToWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().assignPrefmax( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPrefmax( @RequestBody(required=true)  UnAssignPrefmaxFromWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().unAssignPrefmax( command );   
		}
		catch( Exception exc ) {
	...
	public void assignPrefmin( @RequestBody AssignPrefminToWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().assignPrefmin( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignPrefmin( @RequestBody(required=true)  UnAssignPrefminFromWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().unAssignPrefmin( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTpft( @RequestBody AssignTpftToWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().assignTpft( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTpft( @RequestBody(required=true)  UnAssignTpftFromWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().unAssignTpft( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTpfv( @RequestBody AssignTpfvToWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().assignTpfv( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTpfv( @RequestBody(required=true)  UnAssignTpfvFromWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().unAssignTpfv( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTwpffilt( @RequestBody AssignTwpffiltToWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().assignTwpffilt( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTwpffilt( @RequestBody(required=true)  UnAssignTwpffiltFromWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().unAssignTwpffilt( command );   
		}
		catch( Exception exc ) {
	...
	public void assignTwppfilt( @RequestBody AssignTwppfiltToWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().assignTwppfilt( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignTwppfilt( @RequestBody(required=true)  UnAssignTwppfiltFromWindPlantFreqPcontrolIECCommand command ) {
		try {
			WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance().unAssignTwppfilt( command );   
		}
		catch( Exception exc ) {
