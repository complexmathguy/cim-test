...
public class DiagramLayoutVersionCommandRestController extends BaseSpringRestController {
	...
	public void unAssignBaseUML( @RequestBody(required=true)  UnAssignBaseUMLFromDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().unAssignBaseUML( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignBaseURI( @RequestBody(required=true)  UnAssignBaseURIFromDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().unAssignBaseURI( command );   
		}
		catch( Exception exc ) {
	...
	public void unAssignDate( @RequestBody(required=true)  UnAssignDateFromDiagramLayoutVersionCommand command ) {
		try {
	...
	public void assignDifferenceModelURI( @RequestBody AssignDifferenceModelURIToDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().assignDifferenceModelURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDifferenceModelURI( @RequestBody(required=true)  UnAssignDifferenceModelURIFromDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().unAssignDifferenceModelURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeUML( @RequestBody AssignEntsoeUMLToDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().assignEntsoeUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeUML( @RequestBody(required=true)  UnAssignEntsoeUMLFromDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().unAssignEntsoeUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeURI( @RequestBody AssignEntsoeURIToDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().assignEntsoeURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeURI( @RequestBody(required=true)  UnAssignEntsoeURIFromDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().unAssignEntsoeURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignModelDescriptionURI( @RequestBody AssignModelDescriptionURIToDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().assignModelDescriptionURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignModelDescriptionURI( @RequestBody(required=true)  UnAssignModelDescriptionURIFromDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().unAssignModelDescriptionURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNamespaceRDF( @RequestBody AssignNamespaceRDFToDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().assignNamespaceRDF( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNamespaceRDF( @RequestBody(required=true)  UnAssignNamespaceRDFFromDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().unAssignNamespaceRDF( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNamespaceUML( @RequestBody AssignNamespaceUMLToDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().assignNamespaceUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNamespaceUML( @RequestBody(required=true)  UnAssignNamespaceUMLFromDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().unAssignNamespaceUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignShortName( @RequestBody AssignShortNameToDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().assignShortName( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignShortName( @RequestBody(required=true)  UnAssignShortNameFromDiagramLayoutVersionCommand command ) {
		try {
			DiagramLayoutVersionBusinessDelegate.getDiagramLayoutVersionInstance().unAssignShortName( command );   
		}
		catch( Exception exc ) {
