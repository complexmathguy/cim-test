...
public class DiscontinuousExcitationControlUserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToDiscontinuousExcitationControlUserDefinedCommand command ) {
		try {
			DiscontinuousExcitationControlUserDefinedBusinessDelegate.getDiscontinuousExcitationControlUserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromDiscontinuousExcitationControlUserDefinedCommand command ) {
		try {
			DiscontinuousExcitationControlUserDefinedBusinessDelegate.getDiscontinuousExcitationControlUserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
