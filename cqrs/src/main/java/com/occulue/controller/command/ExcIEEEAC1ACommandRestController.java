...
public class ExcIEEEAC1ACommandRestController extends BaseSpringRestController {
	...
	public void unAssignSeve1( @RequestBody(required=true)  UnAssignSeve1FromExcIEEEAC1ACommand command ) {
		try {
	...
	public void unAssignSeve2( @RequestBody(required=true)  UnAssignSeve2FromExcIEEEAC1ACommand command ) {
		try {
	...
	public void unAssignVamax( @RequestBody(required=true)  UnAssignVamaxFromExcIEEEAC1ACommand command ) {
		try {
	...
	public void unAssignVamin( @RequestBody(required=true)  UnAssignVaminFromExcIEEEAC1ACommand command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcIEEEAC1ACommand command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcIEEEAC1ACommand command ) {
		try {
