...
public class GovSteamFV3CommandRestController extends BaseSpringRestController {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovSteamFV3Command command ) {
		try {
	...
	public void unAssignPmax( @RequestBody(required=true)  UnAssignPmaxFromGovSteamFV3Command command ) {
		try {
	...
	public void unAssignPmin( @RequestBody(required=true)  UnAssignPminFromGovSteamFV3Command command ) {
		try {
	...
	public void unAssignPrmax( @RequestBody(required=true)  UnAssignPrmaxFromGovSteamFV3Command command ) {
		try {
