...
public class PhaseTapChangerTablePointCommandRestController extends BaseSpringRestController {
	...
	public void assignAngle( @RequestBody AssignAngleToPhaseTapChangerTablePointCommand command ) {
		try {
			PhaseTapChangerTablePointBusinessDelegate.getPhaseTapChangerTablePointInstance().assignAngle( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignAngle( @RequestBody(required=true)  UnAssignAngleFromPhaseTapChangerTablePointCommand command ) {
		try {
			PhaseTapChangerTablePointBusinessDelegate.getPhaseTapChangerTablePointInstance().unAssignAngle( command );   
		}
		catch( Exception exc ) {
