...
public class EquipmentBoundaryVersionCommandRestController extends BaseSpringRestController {
	...
	public void assignBaseUML( @RequestBody AssignBaseUMLToEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().assignBaseUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBaseUML( @RequestBody(required=true)  UnAssignBaseUMLFromEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().unAssignBaseUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignBaseURI( @RequestBody AssignBaseURIToEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().assignBaseURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignBaseURI( @RequestBody(required=true)  UnAssignBaseURIFromEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().unAssignBaseURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignDate( @RequestBody AssignDateToEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().assignDate( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDate( @RequestBody(required=true)  UnAssignDateFromEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().unAssignDate( command );   
		}
		catch( Exception exc ) {
	...
	public void assignDifferenceModelURI( @RequestBody AssignDifferenceModelURIToEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().assignDifferenceModelURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignDifferenceModelURI( @RequestBody(required=true)  UnAssignDifferenceModelURIFromEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().unAssignDifferenceModelURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeUML( @RequestBody AssignEntsoeUMLToEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().assignEntsoeUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeUML( @RequestBody(required=true)  UnAssignEntsoeUMLFromEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().unAssignEntsoeUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeURIcore( @RequestBody AssignEntsoeURIcoreToEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().assignEntsoeURIcore( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeURIcore( @RequestBody(required=true)  UnAssignEntsoeURIcoreFromEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().unAssignEntsoeURIcore( command );   
		}
		catch( Exception exc ) {
	...
	public void assignEntsoeURIoperation( @RequestBody AssignEntsoeURIoperationToEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().assignEntsoeURIoperation( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignEntsoeURIoperation( @RequestBody(required=true)  UnAssignEntsoeURIoperationFromEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().unAssignEntsoeURIoperation( command );   
		}
		catch( Exception exc ) {
	...
	public void assignModelDescriptionURI( @RequestBody AssignModelDescriptionURIToEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().assignModelDescriptionURI( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignModelDescriptionURI( @RequestBody(required=true)  UnAssignModelDescriptionURIFromEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().unAssignModelDescriptionURI( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNamespaceRDF( @RequestBody AssignNamespaceRDFToEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().assignNamespaceRDF( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNamespaceRDF( @RequestBody(required=true)  UnAssignNamespaceRDFFromEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().unAssignNamespaceRDF( command );   
		}
		catch( Exception exc ) {
	...
	public void assignNamespaceUML( @RequestBody AssignNamespaceUMLToEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().assignNamespaceUML( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignNamespaceUML( @RequestBody(required=true)  UnAssignNamespaceUMLFromEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().unAssignNamespaceUML( command );   
		}
		catch( Exception exc ) {
	...
	public void assignShortName( @RequestBody AssignShortNameToEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().assignShortName( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignShortName( @RequestBody(required=true)  UnAssignShortNameFromEquipmentBoundaryVersionCommand command ) {
		try {
			EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance().unAssignShortName( command );   
		}
		catch( Exception exc ) {
