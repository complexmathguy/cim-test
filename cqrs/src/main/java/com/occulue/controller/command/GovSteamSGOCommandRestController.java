...
public class GovSteamSGOCommandRestController extends BaseSpringRestController {
	...
	public void unAssignMwbase( @RequestBody(required=true)  UnAssignMwbaseFromGovSteamSGOCommand command ) {
		try {
	...
	public void unAssignPmax( @RequestBody(required=true)  UnAssignPmaxFromGovSteamSGOCommand command ) {
		try {
	...
	public void unAssignPmin( @RequestBody(required=true)  UnAssignPminFromGovSteamSGOCommand command ) {
		try {
