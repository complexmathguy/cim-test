...
public class WindAeroLinearIECCommandRestController extends BaseSpringRestController {
	...
	public void unAssignDpomega( @RequestBody(required=true)  UnAssignDpomegaFromWindAeroLinearIECCommand command ) {
		try {
	...
	public void unAssignDptheta( @RequestBody(required=true)  UnAssignDpthetaFromWindAeroLinearIECCommand command ) {
		try {
	...
	public void unAssignOmegazero( @RequestBody(required=true)  UnAssignOmegazeroFromWindAeroLinearIECCommand command ) {
		try {
	...
	public void unAssignPavail( @RequestBody(required=true)  UnAssignPavailFromWindAeroLinearIECCommand command ) {
		try {
	...
	public void unAssignThetazero( @RequestBody(required=true)  UnAssignThetazeroFromWindAeroLinearIECCommand command ) {
		try {
