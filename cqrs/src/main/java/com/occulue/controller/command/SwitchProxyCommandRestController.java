...
public class SwitchProxyCommandRestController extends BaseSpringRestController {
	...
	public void unAssignNormalOpen( @RequestBody(required=true)  UnAssignNormalOpenFromSwitchProxyCommand command ) {
		try {
	...
	public void unAssignRatedCurrent( @RequestBody(required=true)  UnAssignRatedCurrentFromSwitchProxyCommand command ) {
		try {
	...
	public void unAssignRetained( @RequestBody(required=true)  UnAssignRetainedFromSwitchProxyCommand command ) {
		try {
