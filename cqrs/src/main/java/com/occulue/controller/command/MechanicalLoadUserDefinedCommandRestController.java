...
public class MechanicalLoadUserDefinedCommandRestController extends BaseSpringRestController {
	...
	public void assignProprietary( @RequestBody AssignProprietaryToMechanicalLoadUserDefinedCommand command ) {
		try {
			MechanicalLoadUserDefinedBusinessDelegate.getMechanicalLoadUserDefinedInstance().assignProprietary( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignProprietary( @RequestBody(required=true)  UnAssignProprietaryFromMechanicalLoadUserDefinedCommand command ) {
		try {
			MechanicalLoadUserDefinedBusinessDelegate.getMechanicalLoadUserDefinedInstance().unAssignProprietary( command );   
		}
		catch( Exception exc ) {
