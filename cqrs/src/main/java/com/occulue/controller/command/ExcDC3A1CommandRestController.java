...
public class ExcDC3A1CommandRestController extends BaseSpringRestController {
	...
	public void unAssignExclim( @RequestBody(required=true)  UnAssignExclimFromExcDC3A1Command command ) {
		try {
	...
	public void unAssignVb1max( @RequestBody(required=true)  UnAssignVb1maxFromExcDC3A1Command command ) {
		try {
	...
	public void unAssignVblim( @RequestBody(required=true)  UnAssignVblimFromExcDC3A1Command command ) {
		try {
	...
	public void unAssignVbmax( @RequestBody(required=true)  UnAssignVbmaxFromExcDC3A1Command command ) {
		try {
	...
	public void unAssignVrmax( @RequestBody(required=true)  UnAssignVrmaxFromExcDC3A1Command command ) {
		try {
	...
	public void unAssignVrmin( @RequestBody(required=true)  UnAssignVrminFromExcDC3A1Command command ) {
		try {
