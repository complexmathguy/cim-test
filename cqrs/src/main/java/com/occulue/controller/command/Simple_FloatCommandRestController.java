...
public class Simple_FloatCommandRestController extends BaseSpringRestController {
    ...
    /**
     * save Value on Simple_Float
     * @param		command AssignValueToSimple_FloatCommand
     */     
	@PutMapping("/assignValue")
	public void assignValue( @RequestBody AssignValueToSimple_FloatCommand command ) {
		try {
			Simple_FloatBusinessDelegate.getSimple_FloatInstance().assignValue( command );   
		}
        catch( Throwable exc ) {
	...
	public void unAssignValue( @RequestBody(required=true)  UnAssignValueFromSimple_FloatCommand command ) {
		try {
			Simple_FloatBusinessDelegate.getSimple_FloatInstance().unAssignValue( command );   
		}
		catch( Exception exc ) {
