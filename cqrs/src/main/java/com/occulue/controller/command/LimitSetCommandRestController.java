...
public class LimitSetCommandRestController extends BaseSpringRestController {
	...
	public void assignPercentageLimitsFlag( @RequestBody AssignPercentageLimitsFlagToLimitSetCommand command ) {
		try {
	...
	public void unAssignPercentageLimitsFlag( @RequestBody(required=true)  UnAssignPercentageLimitsFlagFromLimitSetCommand command ) {
		try {
