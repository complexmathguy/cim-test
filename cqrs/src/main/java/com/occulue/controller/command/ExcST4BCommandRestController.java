...
public class ExcST4BCommandRestController extends BaseSpringRestController {
	...
	public void unAssignLvgate( @RequestBody(required=true)  UnAssignLvgateFromExcST4BCommand command ) {
		try {
	...
	public void unAssignThetap( @RequestBody(required=true)  UnAssignThetapFromExcST4BCommand command ) {
		try {
