...
public class PssIEEE2BCommandRestController extends BaseSpringRestController {
	...
	public void unAssignVsi1max( @RequestBody(required=true)  UnAssignVsi1maxFromPssIEEE2BCommand command ) {
		try {
	...
	public void unAssignVsi1min( @RequestBody(required=true)  UnAssignVsi1minFromPssIEEE2BCommand command ) {
		try {
	...
	public void unAssignVsi2max( @RequestBody(required=true)  UnAssignVsi2maxFromPssIEEE2BCommand command ) {
		try {
	...
	public void unAssignVsi2min( @RequestBody(required=true)  UnAssignVsi2minFromPssIEEE2BCommand command ) {
		try {
	...
	public void unAssignVstmax( @RequestBody(required=true)  UnAssignVstmaxFromPssIEEE2BCommand command ) {
		try {
	...
	public void unAssignVstmin( @RequestBody(required=true)  UnAssignVstminFromPssIEEE2BCommand command ) {
		try {
