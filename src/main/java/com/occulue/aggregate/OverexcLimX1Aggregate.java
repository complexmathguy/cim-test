...
public class OverexcLimX1Aggregate {  
    ...
    public void handle(UpdateOverexcLimX1Command command) throws Exception {
    	...
    	UpdateOverexcLimX1Event event = new UpdateOverexcLimX1Event(command.getOverexcLimX1Id(), command.Efd1(), command.Efd2(), command.Efd3(), command.Efddes(), command.Efdrated(), command.Kmx(), command.T1(), command.T2(), command.T3(), command.Vlow());        
    ...
    public void handle(AssignEfddesToOverexcLimX1Command command) throws Exception {
        ...
        apply(new AssignEfddesToOverexcLimX1Event(command.getOverexcLimX1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignEfdratedToOverexcLimX1Command command) throws Exception {
        ...
        apply(new AssignEfdratedToOverexcLimX1Event(command.getOverexcLimX1Id(), command.getAssignment()));
    }
