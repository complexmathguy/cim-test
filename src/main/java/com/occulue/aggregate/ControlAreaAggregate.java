...
public class ControlAreaAggregate {  
    ...
    public ControlAreaAggregate(CreateControlAreaCommand command) throws Exception {
    	...
    	CreateControlAreaEvent event = new CreateControlAreaEvent(command.getControlAreaId(), command.Type());
    ...
    public void handle(UpdateControlAreaCommand command) throws Exception {
    	...
    	UpdateControlAreaEvent event = new UpdateControlAreaEvent(command.getControlAreaId(), command.Type());        
