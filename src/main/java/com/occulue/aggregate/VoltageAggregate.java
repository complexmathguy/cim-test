...
public class VoltageAggregate {  
    ...
    public VoltageAggregate(CreateVoltageCommand command) throws Exception {
    	...
    	CreateVoltageEvent event = new CreateVoltageEvent(command.getVoltageId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateVoltageCommand command) throws Exception {
    	...
    	UpdateVoltageEvent event = new UpdateVoltageEvent(command.getVoltageId(), command.Multiplier(), command.Unit(), command.Value());        
