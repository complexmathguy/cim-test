...
public class CurveAggregate {  
    ...
    public CurveAggregate(CreateCurveCommand command) throws Exception {
    	...
    	CreateCurveEvent event = new CreateCurveEvent(command.getCurveId(), command.CurveStyle(), command.XUnit(), command.Y1Unit(), command.Y2Unit());
    ...
    public void handle(UpdateCurveCommand command) throws Exception {
    	...
    	UpdateCurveEvent event = new UpdateCurveEvent(command.getCurveId(), command.CurveStyle(), command.XUnit(), command.Y1Unit(), command.Y2Unit());        
