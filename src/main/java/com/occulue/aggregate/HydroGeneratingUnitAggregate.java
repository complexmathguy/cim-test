...
public class HydroGeneratingUnitAggregate {  
    ...
    public HydroGeneratingUnitAggregate(CreateHydroGeneratingUnitCommand command) throws Exception {
    	...
    	CreateHydroGeneratingUnitEvent event = new CreateHydroGeneratingUnitEvent(command.getHydroGeneratingUnitId(), command.EnergyConversionCapability());
    ...
    public void handle(UpdateHydroGeneratingUnitCommand command) throws Exception {
    	...
    	UpdateHydroGeneratingUnitEvent event = new UpdateHydroGeneratingUnitEvent(command.getHydroGeneratingUnitId(), command.EnergyConversionCapability());        
