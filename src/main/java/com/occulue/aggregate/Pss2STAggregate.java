...
public class Pss2STAggregate {  
    ...
    public Pss2STAggregate(CreatePss2STCommand command) throws Exception {
    	...
    	CreatePss2STEvent event = new CreatePss2STEvent(command.getPss2STId(), command.InputSignal1Type(), command.InputSignal2Type());
    ...
    public void handle(UpdatePss2STCommand command) throws Exception {
    	...
    	UpdatePss2STEvent event = new UpdatePss2STEvent(command.getPss2STId(), command.InputSignal1Type(), command.InputSignal2Type(), command.K1(), command.K2(), command.Lsmax(), command.Lsmin(), command.T1(), command.T10(), command.T2(), command.T3(), command.T4(), command.T5(), command.T6(), command.T7(), command.T8(), command.T9(), command.Vcl(), command.Vcu());        
    ...
    public void handle(AssignLsmaxToPss2STCommand command) throws Exception {
    	...
    	if (  lsmax != null && lsmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Lsmax already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignLsmaxFromPss2STCommand command) throws Exception {
    	...
    	if (  lsmax == null )
    		throw new ProcessingException( "Lsmax already has nothing assigned." );  
    ...
    public void handle(AssignLsminToPss2STCommand command) throws Exception {
    	...
    	if (  lsmin != null && lsmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Lsmin already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignLsminFromPss2STCommand command) throws Exception {
    	...
    	if (  lsmin == null )
    		throw new ProcessingException( "Lsmin already has nothing assigned." );  
