...
public class ExcAC1AAggregate {  
    ...
    public void handle(UpdateExcAC1ACommand command) throws Exception {
    	...
    	UpdateExcAC1AEvent event = new UpdateExcAC1AEvent(command.getExcAC1AId(), command.Hvlvgates(), command.Ka(), command.Kc(), command.Kd(), command.Ke(), command.Kf(), command.Kf1(), command.Kf2(), command.Ks(), command.Seve1(), command.Seve2(), command.Ta(), command.Tb(), command.Tc(), command.Te(), command.Tf(), command.Vamax(), command.Vamin(), command.Ve1(), command.Ve2(), command.Vrmax(), command.Vrmin());        
    ...
    public void handle(AssignHvlvgatesToExcAC1ACommand command) throws Exception {
    	...
    	if (  hvlvgates != null && hvlvgates.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Hvlvgates already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(UnAssignHvlvgatesFromExcAC1ACommand command) throws Exception {
    	...
    	if (  hvlvgates == null )
    		throw new ProcessingException( "Hvlvgates already has nothing assigned." );  
