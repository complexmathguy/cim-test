...
public class ActivePowerLimitAggregate {  
    ...
    public ActivePowerLimitAggregate(CreateActivePowerLimitCommand command) throws Exception {
    	...
    	CreateActivePowerLimitEvent event = new CreateActivePowerLimitEvent(command.getActivePowerLimitId());
    ...
    public void handle(UpdateActivePowerLimitCommand command) throws Exception {
    	...
    	UpdateActivePowerLimitEvent event = new UpdateActivePowerLimitEvent(command.getActivePowerLimitId(), command.Value());        
    ...
    public void handle(AssignValueToActivePowerLimitCommand command) throws Exception {
    	...
    	if (  value != null && value.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "Value already assigned with id " + command.getAssignment().getActivePowerId() );  
    		
        apply(new AssignValueToActivePowerLimitEvent(command.getActivePowerLimitId(), command.getAssignment()));
    }
