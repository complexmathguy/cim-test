...
public class PFVArType2IEEEPFControllerAggregate {  
    ...
    public PFVArType2IEEEPFControllerAggregate(CreatePFVArType2IEEEPFControllerCommand command) throws Exception {
    	...
    	CreatePFVArType2IEEEPFControllerEvent event = new CreatePFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId());
    ...
    public void handle(UpdatePFVArType2IEEEPFControllerCommand command) throws Exception {
    	...
    	UpdatePFVArType2IEEEPFControllerEvent event = new UpdatePFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId(), command.Exlon(), command.Ki(), command.Kp(), command.Pfref(), command.Vclmt(), command.Vref(), command.Vs());        
    ...
    public void handle(AssignExlonToPFVArType2IEEEPFControllerCommand command) throws Exception {
        ...
        apply(new AssignExlonToPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignExlonFromPFVArType2IEEEPFControllerCommand command) throws Exception {
    	...
    	apply(new UnAssignExlonFromPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId()));
    }
    @CommandHandler
    public void handle(AssignKiToPFVArType2IEEEPFControllerCommand command) throws Exception {
        ...
        apply(new AssignKiToPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKiFromPFVArType2IEEEPFControllerCommand command) throws Exception {
    	...
    	apply(new UnAssignKiFromPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId()));
    }
    @CommandHandler
    public void handle(AssignKpToPFVArType2IEEEPFControllerCommand command) throws Exception {
        ...
        apply(new AssignKpToPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKpFromPFVArType2IEEEPFControllerCommand command) throws Exception {
    	...
    	apply(new UnAssignKpFromPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId()));
    }
    @CommandHandler
    public void handle(AssignPfrefToPFVArType2IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  pfref != null && pfref.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Pfref already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignPfrefToPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignPfrefFromPFVArType2IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  pfref == null )
    		throw new ProcessingException( "Pfref already has nothing assigned." );  

    	apply(new UnAssignPfrefFromPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId()));
    }
    @CommandHandler
    public void handle(AssignVclmtToPFVArType2IEEEPFControllerCommand command) throws Exception {
        ...
        apply(new AssignVclmtToPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVclmtFromPFVArType2IEEEPFControllerCommand command) throws Exception {
    	...
    	apply(new UnAssignVclmtFromPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId()));
    }
    @CommandHandler
    public void handle(AssignVrefToPFVArType2IEEEPFControllerCommand command) throws Exception {
        ...
        apply(new AssignVrefToPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVrefFromPFVArType2IEEEPFControllerCommand command) throws Exception {
    	...
    	apply(new UnAssignVrefFromPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId()));
    }
    @CommandHandler
    public void handle(AssignVsToPFVArType2IEEEPFControllerCommand command) throws Exception {
        ...
        apply(new AssignVsToPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVsFromPFVArType2IEEEPFControllerCommand command) throws Exception {
    	...
    	apply(new UnAssignVsFromPFVArType2IEEEPFControllerEvent(command.getPFVArType2IEEEPFControllerId()));
    }
