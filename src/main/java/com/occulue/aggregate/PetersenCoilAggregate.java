...
public class PetersenCoilAggregate {  
    ...
    public PetersenCoilAggregate(CreatePetersenCoilCommand command) throws Exception {
    	...
    	CreatePetersenCoilEvent event = new CreatePetersenCoilEvent(command.getPetersenCoilId(), command.Mode());
    ...
    public void handle(UpdatePetersenCoilCommand command) throws Exception {
    	...
    	UpdatePetersenCoilEvent event = new UpdatePetersenCoilEvent(command.getPetersenCoilId(), command.Mode(), command.NominalU(), command.OffsetCurrent(), command.PositionCurrent(), command.XGroundMax(), command.XGroundMin(), command.XGroundNominal());        
    ...
    public void handle(AssignNominalUToPetersenCoilCommand command) throws Exception {
    	...
    	if (  nominalU != null && nominalU.getVoltageId() == command.getAssignment().getVoltageId() )
    		throw new ProcessingException( "NominalU already assigned with id " + command.getAssignment().getVoltageId() );  
    		
        apply(new AssignNominalUToPetersenCoilEvent(command.getPetersenCoilId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignNominalUFromPetersenCoilCommand command) throws Exception {
    	...
    	if (  nominalU == null )
    		throw new ProcessingException( "NominalU already has nothing assigned." );  
    ...
    public void handle(AssignOffsetCurrentToPetersenCoilCommand command) throws Exception {
    	...
    	if (  offsetCurrent != null && offsetCurrent.getCurrentFlowId() == command.getAssignment().getCurrentFlowId() )
    		throw new ProcessingException( "OffsetCurrent already assigned with id " + command.getAssignment().getCurrentFlowId() );  
    		
        apply(new AssignOffsetCurrentToPetersenCoilEvent(command.getPetersenCoilId(), command.getAssignment()));
    }
    ...
    public void handle(AssignPositionCurrentToPetersenCoilCommand command) throws Exception {
    	...
    	if (  positionCurrent != null && positionCurrent.getCurrentFlowId() == command.getAssignment().getCurrentFlowId() )
    		throw new ProcessingException( "PositionCurrent already assigned with id " + command.getAssignment().getCurrentFlowId() );  
    		
        apply(new AssignPositionCurrentToPetersenCoilEvent(command.getPetersenCoilId(), command.getAssignment()));
    }
    ...
    public void handle(AssignXGroundMaxToPetersenCoilCommand command) throws Exception {
    	...
    	if (  xGroundMax != null && xGroundMax.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "XGroundMax already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignXGroundMaxToPetersenCoilEvent(command.getPetersenCoilId(), command.getAssignment()));
    }
    ...
    public void handle(AssignXGroundMinToPetersenCoilCommand command) throws Exception {
    	...
    	if (  xGroundMin != null && xGroundMin.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "XGroundMin already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignXGroundMinToPetersenCoilEvent(command.getPetersenCoilId(), command.getAssignment()));
    }
    ...
    public void handle(AssignXGroundNominalToPetersenCoilCommand command) throws Exception {
    	...
    	if (  xGroundNominal != null && xGroundNominal.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "XGroundNominal already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignXGroundNominalToPetersenCoilEvent(command.getPetersenCoilId(), command.getAssignment()));
    }
