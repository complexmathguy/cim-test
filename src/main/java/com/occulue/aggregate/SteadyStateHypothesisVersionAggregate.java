...
public class SteadyStateHypothesisVersionAggregate {  
    ...
    public SteadyStateHypothesisVersionAggregate(CreateSteadyStateHypothesisVersionCommand command) throws Exception {
    	...
    	CreateSteadyStateHypothesisVersionEvent event = new CreateSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId());
    ...
    public void handle(UpdateSteadyStateHypothesisVersionCommand command) throws Exception {
    	...
    	UpdateSteadyStateHypothesisVersionEvent event = new UpdateSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId(), command.BaseUML(), command.BaseURI(), command.Date(), command.DifferenceModelURI(), command.EntsoeUML(), command.EntsoeURI(), command.ModelDescriptionURI(), command.NamespaceRDF(), command.NamespaceUML(), command.ShortName());        
    ...
    public void handle(AssignBaseUMLToSteadyStateHypothesisVersionCommand command) throws Exception {
    	...
    	if (  baseUML != null && baseUML.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "BaseUML already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignBaseUMLToSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignBaseUMLFromSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignBaseUMLFromSteadyStateHypothesisVersionCommand" );

    	if (  baseUML == null )
    		throw new ProcessingException( "BaseUML already has nothing assigned." );  

    	apply(new UnAssignBaseUMLFromSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId()));
    }
    @CommandHandler
    public void handle(AssignBaseURIToSteadyStateHypothesisVersionCommand command) throws Exception {
    	...
    	if (  baseURI != null && baseURI.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "BaseURI already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignBaseURIToSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignBaseURIFromSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignBaseURIFromSteadyStateHypothesisVersionCommand" );

    	if (  baseURI == null )
    		throw new ProcessingException( "BaseURI already has nothing assigned." );  

    	apply(new UnAssignBaseURIFromSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId()));
    }
    @CommandHandler
    public void handle(AssignDateToSteadyStateHypothesisVersionCommand command) throws Exception {
    	...
    	if (  date != null && date.getDateProxyId() == command.getAssignment().getDateProxyId() )
    		throw new ProcessingException( "Date already assigned with id " + command.getAssignment().getDateProxyId() );  
    		
        apply(new AssignDateToSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDateFromSteadyStateHypothesisVersionCommand command) throws Exception {
    	...
    	if (  date == null )
    		throw new ProcessingException( "Date already has nothing assigned." );  

    	apply(new UnAssignDateFromSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId()));
    }
    @CommandHandler
    public void handle(AssignDifferenceModelURIToSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignDifferenceModelURIToSteadyStateHypothesisVersionCommand" );
    	
    	if (  differenceModelURI != null && differenceModelURI.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "DifferenceModelURI already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignDifferenceModelURIToSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignDifferenceModelURIFromSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignDifferenceModelURIFromSteadyStateHypothesisVersionCommand" );

    	if (  differenceModelURI == null )
    		throw new ProcessingException( "DifferenceModelURI already has nothing assigned." );  

    	apply(new UnAssignDifferenceModelURIFromSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId()));
    }
    @CommandHandler
    public void handle(AssignEntsoeUMLToSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignEntsoeUMLToSteadyStateHypothesisVersionCommand" );
    	
    	if (  entsoeUML != null && entsoeUML.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "EntsoeUML already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignEntsoeUMLToSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEntsoeUMLFromSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignEntsoeUMLFromSteadyStateHypothesisVersionCommand" );

    	if (  entsoeUML == null )
    		throw new ProcessingException( "EntsoeUML already has nothing assigned." );  

    	apply(new UnAssignEntsoeUMLFromSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId()));
    }
    @CommandHandler
    public void handle(AssignEntsoeURIToSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignEntsoeURIToSteadyStateHypothesisVersionCommand" );
    	
    	if (  entsoeURI != null && entsoeURI.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "EntsoeURI already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignEntsoeURIToSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEntsoeURIFromSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignEntsoeURIFromSteadyStateHypothesisVersionCommand" );

    	if (  entsoeURI == null )
    		throw new ProcessingException( "EntsoeURI already has nothing assigned." );  

    	apply(new UnAssignEntsoeURIFromSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId()));
    }
    @CommandHandler
    public void handle(AssignModelDescriptionURIToSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignModelDescriptionURIToSteadyStateHypothesisVersionCommand" );
    	
    	if (  modelDescriptionURI != null && modelDescriptionURI.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "ModelDescriptionURI already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignModelDescriptionURIToSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignModelDescriptionURIFromSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignModelDescriptionURIFromSteadyStateHypothesisVersionCommand" );

    	if (  modelDescriptionURI == null )
    		throw new ProcessingException( "ModelDescriptionURI already has nothing assigned." );  

    	apply(new UnAssignModelDescriptionURIFromSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId()));
    }
    @CommandHandler
    public void handle(AssignNamespaceRDFToSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignNamespaceRDFToSteadyStateHypothesisVersionCommand" );
    	
    	if (  namespaceRDF != null && namespaceRDF.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "NamespaceRDF already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignNamespaceRDFToSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignNamespaceRDFFromSteadyStateHypothesisVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignNamespaceRDFFromSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId()));
    }
    @CommandHandler
    public void handle(AssignNamespaceUMLToSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignNamespaceUMLToSteadyStateHypothesisVersionCommand" );
    	
    	if (  namespaceUML != null && namespaceUML.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "NamespaceUML already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignNamespaceUMLToSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignNamespaceUMLFromSteadyStateHypothesisVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignNamespaceUMLFromSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId()));
    }
    @CommandHandler
    public void handle(AssignShortNameToSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignShortNameToSteadyStateHypothesisVersionCommand" );
    	
    	if (  shortName != null && shortName.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "ShortName already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignShortNameToSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignShortNameFromSteadyStateHypothesisVersionCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignShortNameFromSteadyStateHypothesisVersionCommand" );

    	if (  shortName == null )
    		throw new ProcessingException( "ShortName already has nothing assigned." );  

    	apply(new UnAssignShortNameFromSteadyStateHypothesisVersionEvent(command.getSteadyStateHypothesisVersionId()));
    }
