...
public class ProprietaryParameterDynamicsAggregate {  
    ...
    public void handle(UpdateProprietaryParameterDynamicsCommand command) throws Exception {
    	...
    	UpdateProprietaryParameterDynamicsEvent event = new UpdateProprietaryParameterDynamicsEvent(command.getProprietaryParameterDynamicsId(), command.BooleanParameterValue(), command.FloatParameterValue(), command.IntegerParameterValue(), command.ParameterNumber());        
