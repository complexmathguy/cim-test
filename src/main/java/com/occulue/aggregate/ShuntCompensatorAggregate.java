...
public class ShuntCompensatorAggregate {  
    ...
    public ShuntCompensatorAggregate(CreateShuntCompensatorCommand command) throws Exception {
    	...
    	CreateShuntCompensatorEvent event = new CreateShuntCompensatorEvent(command.getShuntCompensatorId());
    ...
    public void handle(UpdateShuntCompensatorCommand command) throws Exception {
    	...
    	UpdateShuntCompensatorEvent event = new UpdateShuntCompensatorEvent(command.getShuntCompensatorId(), command.AVRDelay(), command.Grounded(), command.MaximumSections(), command.NomU(), command.NormalSections(), command.SwitchOnCount(), command.SwitchOnDate(), command.VoltageSensitivity());        
    ...
    public void handle(AssignAVRDelayToShuntCompensatorCommand command) throws Exception {
    	...
    	if (  aVRDelay != null && aVRDelay.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "AVRDelay already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignAVRDelayToShuntCompensatorEvent(command.getShuntCompensatorId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignAVRDelayFromShuntCompensatorCommand command) throws Exception {
    	...
    	if (  aVRDelay == null )
    		throw new ProcessingException( "AVRDelay already has nothing assigned." );  
    ...
    public void handle(AssignGroundedToShuntCompensatorCommand command) throws Exception {
        ...
        apply(new AssignGroundedToShuntCompensatorEvent(command.getShuntCompensatorId(), command.getAssignment()));
    }
    ...
    public void handle(AssignMaximumSectionsToShuntCompensatorCommand command) throws Exception {
    	...
    	if (  maximumSections != null && maximumSections.getIntegerProxyId() == command.getAssignment().getIntegerProxyId() )
    		throw new ProcessingException( "MaximumSections already assigned with id " + command.getAssignment().getIntegerProxyId() );  
    		
        apply(new AssignMaximumSectionsToShuntCompensatorEvent(command.getShuntCompensatorId(), command.getAssignment()));
    }
    ...
    public void handle(AssignNomUToShuntCompensatorCommand command) throws Exception {
    	...
    	if (  nomU != null && nomU.getVoltageId() == command.getAssignment().getVoltageId() )
    		throw new ProcessingException( "NomU already assigned with id " + command.getAssignment().getVoltageId() );  
    		
        apply(new AssignNomUToShuntCompensatorEvent(command.getShuntCompensatorId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignNomUFromShuntCompensatorCommand command) throws Exception {
    	...
    	if (  nomU == null )
    		throw new ProcessingException( "NomU already has nothing assigned." );  
    ...
    public void handle(AssignNormalSectionsToShuntCompensatorCommand command) throws Exception {
    	...
    	if (  normalSections != null && normalSections.getIntegerProxyId() == command.getAssignment().getIntegerProxyId() )
    		throw new ProcessingException( "NormalSections already assigned with id " + command.getAssignment().getIntegerProxyId() );  
    		
        apply(new AssignNormalSectionsToShuntCompensatorEvent(command.getShuntCompensatorId(), command.getAssignment()));
    }
    ...
    public void handle(AssignSwitchOnCountToShuntCompensatorCommand command) throws Exception {
    	...
    	if (  switchOnCount != null && switchOnCount.getIntegerProxyId() == command.getAssignment().getIntegerProxyId() )
    		throw new ProcessingException( "SwitchOnCount already assigned with id " + command.getAssignment().getIntegerProxyId() );  
    		
        apply(new AssignSwitchOnCountToShuntCompensatorEvent(command.getShuntCompensatorId(), command.getAssignment()));
    }
    ...
    public void handle(AssignSwitchOnDateToShuntCompensatorCommand command) throws Exception {
    	...
    	if (  switchOnDate != null && switchOnDate.getDateTimeId() == command.getAssignment().getDateTimeId() )
    		throw new ProcessingException( "SwitchOnDate already assigned with id " + command.getAssignment().getDateTimeId() );  
    		
        apply(new AssignSwitchOnDateToShuntCompensatorEvent(command.getShuntCompensatorId(), command.getAssignment()));
    }
    ...
    public void handle(AssignVoltageSensitivityToShuntCompensatorCommand command) throws Exception {
    	...
    	if (  voltageSensitivity != null && voltageSensitivity.getVoltagePerReactivePowerId() == command.getAssignment().getVoltagePerReactivePowerId() )
    		throw new ProcessingException( "VoltageSensitivity already assigned with id " + command.getAssignment().getVoltagePerReactivePowerId() );  
    		
        apply(new AssignVoltageSensitivityToShuntCompensatorEvent(command.getShuntCompensatorId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignVoltageSensitivityFromShuntCompensatorCommand command) throws Exception {
