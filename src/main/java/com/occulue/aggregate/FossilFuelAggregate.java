...
public class FossilFuelAggregate {  
    ...
    public FossilFuelAggregate(CreateFossilFuelCommand command) throws Exception {
    	...
    	CreateFossilFuelEvent event = new CreateFossilFuelEvent(command.getFossilFuelId(), command.FossilFuelType());
    ...
    public void handle(UpdateFossilFuelCommand command) throws Exception {
    	...
    	UpdateFossilFuelEvent event = new UpdateFossilFuelEvent(command.getFossilFuelId(), command.FossilFuelType());        
