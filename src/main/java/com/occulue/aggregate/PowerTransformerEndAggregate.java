...
public class PowerTransformerEndAggregate {  
    ...
    public PowerTransformerEndAggregate(CreatePowerTransformerEndCommand command) throws Exception {
    	...
    	CreatePowerTransformerEndEvent event = new CreatePowerTransformerEndEvent(command.getPowerTransformerEndId(), command.ConnectionKind());
    ...
    public void handle(UpdatePowerTransformerEndCommand command) throws Exception {
    	...
    	UpdatePowerTransformerEndEvent event = new UpdatePowerTransformerEndEvent(command.getPowerTransformerEndId(), command.B(), command.B0(), command.ConnectionKind(), command.G(), command.G0(), command.PhaseAngleClock(), command.R(), command.R0(), command.RatedS(), command.RatedU(), command.X(), command.X0());        
    ...
    public void handle(AssignBToPowerTransformerEndCommand command) throws Exception {
        ...
        apply(new AssignBToPowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getAssignment()));
    }
    ...
    public void handle(AssignB0ToPowerTransformerEndCommand command) throws Exception {
        ...
        apply(new AssignB0ToPowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getAssignment()));
    }
    ...
    public void handle(AssignGToPowerTransformerEndCommand command) throws Exception {
        ...
        apply(new AssignGToPowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getAssignment()));
    }
    ...
    public void handle(AssignG0ToPowerTransformerEndCommand command) throws Exception {
        ...
        apply(new AssignG0ToPowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getAssignment()));
    }
    ...
    public void handle(AssignPhaseAngleClockToPowerTransformerEndCommand command) throws Exception {
    	...
    	if (  phaseAngleClock != null && phaseAngleClock.getIntegerProxyId() == command.getAssignment().getIntegerProxyId() )
    		throw new ProcessingException( "PhaseAngleClock already assigned with id " + command.getAssignment().getIntegerProxyId() );  
    		
        apply(new AssignPhaseAngleClockToPowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignPhaseAngleClockFromPowerTransformerEndCommand command) throws Exception {
    	...
    	apply(new UnAssignPhaseAngleClockFromPowerTransformerEndEvent(command.getPowerTransformerEndId()));
    }
    @CommandHandler
    public void handle(AssignRToPowerTransformerEndCommand command) throws Exception {
        ...
        apply(new AssignRToPowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getAssignment()));
    }
    ...
    public void handle(AssignR0ToPowerTransformerEndCommand command) throws Exception {
        ...
        apply(new AssignR0ToPowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRatedSToPowerTransformerEndCommand command) throws Exception {
        ...
        apply(new AssignRatedSToPowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRatedUToPowerTransformerEndCommand command) throws Exception {
        ...
        apply(new AssignRatedUToPowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getAssignment()));
    }
    ...
    public void handle(AssignXToPowerTransformerEndCommand command) throws Exception {
        ...
        apply(new AssignXToPowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getAssignment()));
    }
    ...
    public void handle(AssignX0ToPowerTransformerEndCommand command) throws Exception {
        ...
        apply(new AssignX0ToPowerTransformerEndEvent(command.getPowerTransformerEndId(), command.getAssignment()));
    }
