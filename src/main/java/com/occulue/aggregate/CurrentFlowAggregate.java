...
public class CurrentFlowAggregate {  
    ...
    public CurrentFlowAggregate(CreateCurrentFlowCommand command) throws Exception {
    	...
    	CreateCurrentFlowEvent event = new CreateCurrentFlowEvent(command.getCurrentFlowId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateCurrentFlowCommand command) throws Exception {
    	...
    	UpdateCurrentFlowEvent event = new UpdateCurrentFlowEvent(command.getCurrentFlowId(), command.Multiplier(), command.Unit(), command.Value());        
