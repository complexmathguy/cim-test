...
public class ExcIEEEDC2AAggregate {  
    ...
    public void handle(UpdateExcIEEEDC2ACommand command) throws Exception {
    	...
    	UpdateExcIEEEDC2AEvent event = new UpdateExcIEEEDC2AEvent(command.getExcIEEEDC2AId(), command.Efd1(), command.Efd2(), command.Exclim(), command.Ka(), command.Ke(), command.Kf(), command.Seefd1(), command.Seefd2(), command.Ta(), command.Tb(), command.Tc(), command.Te(), command.Tf(), command.Uelin(), command.Vrmax(), command.Vrmin());        
    ...
    public void handle(AssignExclimToExcIEEEDC2ACommand command) throws Exception {
    	...
    	if (  exclim != null && exclim.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Exclim already assigned with id " + command.getAssignment().getPUId() );  
