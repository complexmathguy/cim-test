...
public class CapacitancePerLengthAggregate {  
    ...
    public CapacitancePerLengthAggregate(CreateCapacitancePerLengthCommand command) throws Exception {
    	...
    	CreateCapacitancePerLengthEvent event = new CreateCapacitancePerLengthEvent(command.getCapacitancePerLengthId(), command.DenominatorMultiplier(), command.DenominatorUnit(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateCapacitancePerLengthCommand command) throws Exception {
    	...
    	UpdateCapacitancePerLengthEvent event = new UpdateCapacitancePerLengthEvent(command.getCapacitancePerLengthId(), command.DenominatorMultiplier(), command.DenominatorUnit(), command.Multiplier(), command.Unit(), command.Value());        
    ...
    public void handle(AssignValueToCapacitancePerLengthCommand command) throws Exception {
        ...
        apply(new AssignValueToCapacitancePerLengthEvent(command.getCapacitancePerLengthId(), command.getAssignment()));
    }
