...
public class ExcST3AAggregate {  
    ...
    public void handle(UpdateExcST3ACommand command) throws Exception {
    	...
    	UpdateExcST3AEvent event = new UpdateExcST3AEvent(command.getExcST3AId(), command.Efdmax(), command.Kc(), command.Kg(), command.Ki(), command.Kj(), command.Km(), command.Kp(), command.Ks(), command.Ks1(), command.Tb(), command.Tc(), command.Thetap(), command.Tm(), command.Vbmax(), command.Vgmax(), command.Vimax(), command.Vimin(), command.Vrmax(), command.Vrmin(), command.Xl());        
    ...
    public void handle(AssignKjToExcST3ACommand command) throws Exception {
    	...
    	if (  kj != null && kj.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kj already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignKjFromExcST3ACommand command) throws Exception {
    	...
    	if (  kj == null )
    		throw new ProcessingException( "Kj already has nothing assigned." );  
