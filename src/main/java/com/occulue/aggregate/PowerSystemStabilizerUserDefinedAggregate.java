...
public class PowerSystemStabilizerUserDefinedAggregate {  
    ...
    public PowerSystemStabilizerUserDefinedAggregate(CreatePowerSystemStabilizerUserDefinedCommand command) throws Exception {
    	...
    	CreatePowerSystemStabilizerUserDefinedEvent event = new CreatePowerSystemStabilizerUserDefinedEvent(command.getPowerSystemStabilizerUserDefinedId());
    ...
    public void handle(UpdatePowerSystemStabilizerUserDefinedCommand command) throws Exception {
    	...
    	UpdatePowerSystemStabilizerUserDefinedEvent event = new UpdatePowerSystemStabilizerUserDefinedEvent(command.getPowerSystemStabilizerUserDefinedId(), command.Proprietary());        
    ...
    @CommandHandler
    public void handle(AssignProprietaryToPowerSystemStabilizerUserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToPowerSystemStabilizerUserDefinedEvent(command.getPowerSystemStabilizerUserDefinedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignProprietaryFromPowerSystemStabilizerUserDefinedCommand command) throws Exception {
    	...
    	apply(new UnAssignProprietaryFromPowerSystemStabilizerUserDefinedEvent(command.getPowerSystemStabilizerUserDefinedId()));
    }
