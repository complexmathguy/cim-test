...
public class WindProtectionIECAggregate {  
    ...
    public WindProtectionIECAggregate(CreateWindProtectionIECCommand command) throws Exception {
    	...
    	CreateWindProtectionIECEvent event = new CreateWindProtectionIECEvent(command.getWindProtectionIECId());
    ...
    public void handle(UpdateWindProtectionIECCommand command) throws Exception {
    	...
    	UpdateWindProtectionIECEvent event = new UpdateWindProtectionIECEvent(command.getWindProtectionIECId(), command.Fover(), command.Funder(), command.Tfover(), command.Tfunder(), command.Tuover(), command.Tuunder(), command.Uover(), command.Uunder());        
    ...
    public void handle(AssignFoverToWindProtectionIECCommand command) throws Exception {
    	...
    	if (  fover != null && fover.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Fover already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignFoverToWindProtectionIECEvent(command.getWindProtectionIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignFoverFromWindProtectionIECCommand command) throws Exception {
    	...
    	if (  fover == null )
    		throw new ProcessingException( "Fover already has nothing assigned." );  
    ...
    public void handle(AssignFunderToWindProtectionIECCommand command) throws Exception {
    	...
    	if (  funder != null && funder.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Funder already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignFunderToWindProtectionIECEvent(command.getWindProtectionIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignFunderFromWindProtectionIECCommand command) throws Exception {
    	...
    	if (  funder == null )
    		throw new ProcessingException( "Funder already has nothing assigned." );  
    ...
    public void handle(AssignTfoverToWindProtectionIECCommand command) throws Exception {
    	...
    	if (  tfover != null && tfover.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tfover already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTfoverToWindProtectionIECEvent(command.getWindProtectionIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTfoverFromWindProtectionIECCommand command) throws Exception {
    	...
    	if (  tfover == null )
    		throw new ProcessingException( "Tfover already has nothing assigned." );  
    ...
    public void handle(AssignTfunderToWindProtectionIECCommand command) throws Exception {
    	...
    	if (  tfunder != null && tfunder.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tfunder already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTfunderToWindProtectionIECEvent(command.getWindProtectionIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTfunderFromWindProtectionIECCommand command) throws Exception {
    	...
    	if (  tfunder == null )
    		throw new ProcessingException( "Tfunder already has nothing assigned." );  
    ...
    public void handle(AssignTuoverToWindProtectionIECCommand command) throws Exception {
    	...
    	if (  tuover != null && tuover.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tuover already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTuoverToWindProtectionIECEvent(command.getWindProtectionIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTuoverFromWindProtectionIECCommand command) throws Exception {
    	...
    	if (  tuover == null )
    		throw new ProcessingException( "Tuover already has nothing assigned." );  
    ...
    public void handle(AssignTuunderToWindProtectionIECCommand command) throws Exception {
    	...
    	if (  tuunder != null && tuunder.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tuunder already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTuunderToWindProtectionIECEvent(command.getWindProtectionIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTuunderFromWindProtectionIECCommand command) throws Exception {
    	...
    	if (  tuunder == null )
    		throw new ProcessingException( "Tuunder already has nothing assigned." );  
    ...
    public void handle(AssignUoverToWindProtectionIECCommand command) throws Exception {
    	...
    	if (  uover != null && uover.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Uover already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignUoverToWindProtectionIECEvent(command.getWindProtectionIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignUoverFromWindProtectionIECCommand command) throws Exception {
    	...
    	if (  uover == null )
    		throw new ProcessingException( "Uover already has nothing assigned." );  
    ...
    public void handle(AssignUunderToWindProtectionIECCommand command) throws Exception {
    	...
    	if (  uunder != null && uunder.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Uunder already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignUunderToWindProtectionIECEvent(command.getWindProtectionIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignUunderFromWindProtectionIECCommand command) throws Exception {
    	...
    	if (  uunder == null )
    		throw new ProcessingException( "Uunder already has nothing assigned." );  
