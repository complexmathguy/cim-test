...
public class TapChangerAggregate {  
    ...
    public void handle(UpdateTapChangerCommand command) throws Exception {
    	...
    	UpdateTapChangerEvent event = new UpdateTapChangerEvent(command.getTapChangerId(), command.HighStep(), command.LowStep(), command.LtcFlag(), command.NeutralStep(), command.NeutralU(), command.NormalStep());        
    ...
    public void handle(AssignHighStepToTapChangerCommand command) throws Exception {
    	...
    	if (  highStep != null && highStep.getIntegerProxyId() == command.getAssignment().getIntegerProxyId() )
    		throw new ProcessingException( "HighStep already assigned with id " + command.getAssignment().getIntegerProxyId() );  
    ...
    public void handle(UnAssignHighStepFromTapChangerCommand command) throws Exception {
    	...
    	if (  highStep == null )
    		throw new ProcessingException( "HighStep already has nothing assigned." );  
    ...
    public void handle(AssignLowStepToTapChangerCommand command) throws Exception {
    	...
    	if (  lowStep != null && lowStep.getIntegerProxyId() == command.getAssignment().getIntegerProxyId() )
    		throw new ProcessingException( "LowStep already assigned with id " + command.getAssignment().getIntegerProxyId() );  
    ...
    public void handle(UnAssignLowStepFromTapChangerCommand command) throws Exception {
    	...
    	if (  lowStep == null )
    		throw new ProcessingException( "LowStep already has nothing assigned." );  
    ...
    public void handle(AssignLtcFlagToTapChangerCommand command) throws Exception {
    	...
    	if (  ltcFlag != null && ltcFlag.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "LtcFlag already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(UnAssignLtcFlagFromTapChangerCommand command) throws Exception {
    	...
    	if (  ltcFlag == null )
    		throw new ProcessingException( "LtcFlag already has nothing assigned." );  
    ...
    public void handle(AssignNeutralStepToTapChangerCommand command) throws Exception {
    	...
    	if (  neutralStep != null && neutralStep.getIntegerProxyId() == command.getAssignment().getIntegerProxyId() )
    		throw new ProcessingException( "NeutralStep already assigned with id " + command.getAssignment().getIntegerProxyId() );  
    		
        apply(new AssignNeutralStepToTapChangerEvent(command.getTapChangerId(), command.getAssignment()));
    }
    ...
    public void handle(AssignNeutralUToTapChangerCommand command) throws Exception {
    	...
    	if (  neutralU != null && neutralU.getVoltageId() == command.getAssignment().getVoltageId() )
    		throw new ProcessingException( "NeutralU already assigned with id " + command.getAssignment().getVoltageId() );  
    ...
    public void handle(UnAssignNeutralUFromTapChangerCommand command) throws Exception {
    	...
    	if (  neutralU == null )
    		throw new ProcessingException( "NeutralU already has nothing assigned." );  
    ...
    public void handle(AssignNormalStepToTapChangerCommand command) throws Exception {
    	...
    	if (  normalStep != null && normalStep.getIntegerProxyId() == command.getAssignment().getIntegerProxyId() )
    		throw new ProcessingException( "NormalStep already assigned with id " + command.getAssignment().getIntegerProxyId() );  
    		
        apply(new AssignNormalStepToTapChangerEvent(command.getTapChangerId(), command.getAssignment()));
    }
