...
public class OverexcLimX2Aggregate {  
    ...
    public void handle(UpdateOverexcLimX2Command command) throws Exception {
    	...
    	UpdateOverexcLimX2Event event = new UpdateOverexcLimX2Event(command.getOverexcLimX2Id(), command.Efd1(), command.Efd2(), command.Efd3(), command.Efddes(), command.Efdrated(), command.Kmx(), command.M(), command.T1(), command.T2(), command.T3(), command.Vlow());        
    ...
    public void handle(AssignEfd3ToOverexcLimX2Command command) throws Exception {
    	...
    	if (  efd3 != null && efd3.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Efd3 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignEfd3FromOverexcLimX2Command command) throws Exception {
    	...
    	if (  efd3 == null )
    		throw new ProcessingException( "Efd3 already has nothing assigned." );  
    ...
    public void handle(AssignEfddesToOverexcLimX2Command command) throws Exception {
    	...
    	if (  efddes != null && efddes.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Efddes already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignEfddesToOverexcLimX2Event(command.getOverexcLimX2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEfddesFromOverexcLimX2Command command) throws Exception {
    	...
    	if (  efddes == null )
    		throw new ProcessingException( "Efddes already has nothing assigned." );  
    ...
    public void handle(AssignEfdratedToOverexcLimX2Command command) throws Exception {
    	...
    	if (  efdrated != null && efdrated.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Efdrated already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignEfdratedToOverexcLimX2Event(command.getOverexcLimX2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEfdratedFromOverexcLimX2Command command) throws Exception {
    	...
    	if (  efdrated == null )
    		throw new ProcessingException( "Efdrated already has nothing assigned." );  
    ...
    public void handle(AssignKmxToOverexcLimX2Command command) throws Exception {
    	...
    	if (  kmx != null && kmx.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kmx already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignKmxFromOverexcLimX2Command command) throws Exception {
    	...
    	if (  kmx == null )
    		throw new ProcessingException( "Kmx already has nothing assigned." );  
    ...
    public void handle(AssignMToOverexcLimX2Command command) throws Exception {
    	...
    	if (  m != null && m.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "M already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(AssignVlowToOverexcLimX2Command command) throws Exception {
    	...
    	if (  vlow != null && vlow.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vlow already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignVlowFromOverexcLimX2Command command) throws Exception {
    	...
    	if (  vlow == null )
    		throw new ProcessingException( "Vlow already has nothing assigned." );  
