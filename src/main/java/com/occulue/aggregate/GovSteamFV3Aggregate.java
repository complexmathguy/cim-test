...
public class GovSteamFV3Aggregate {  
    ...
    public void handle(UpdateGovSteamFV3Command command) throws Exception {
    	...
    	UpdateGovSteamFV3Event event = new UpdateGovSteamFV3Event(command.getGovSteamFV3Id(), command.K(), command.K1(), command.K2(), command.K3(), command.Mwbase(), command.Pmax(), command.Pmin(), command.Prmax(), command.T1(), command.T2(), command.T3(), command.T4(), command.T5(), command.T6(), command.Ta(), command.Tb(), command.Tc(), command.Uc(), command.Uo());        
    ...
    public void handle(AssignPrmaxToGovSteamFV3Command command) throws Exception {
    	...
    	if (  prmax != null && prmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Prmax already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignPrmaxFromGovSteamFV3Command command) throws Exception {
    	...
    	if (  prmax == null )
    		throw new ProcessingException( "Prmax already has nothing assigned." );  
