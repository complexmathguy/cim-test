...
public class GovHydroDDAggregate {  
    ...
    public void handle(UpdateGovHydroDDCommand command) throws Exception {
    	...
    	UpdateGovHydroDDEvent event = new UpdateGovHydroDDEvent(command.getGovHydroDDId(), command.Aturb(), command.Bturb(), command.Db1(), command.Db2(), command.Eps(), command.Gmax(), command.Gmin(), command.Gv1(), command.Gv2(), command.Gv3(), command.Gv4(), command.Gv5(), command.Gv6(), command.InputSignal(), command.K1(), command.K2(), command.Kg(), command.Ki(), command.Mwbase(), command.Pgv1(), command.Pgv2(), command.Pgv3(), command.Pgv4(), command.Pgv5(), command.Pgv6(), command.Pmax(), command.Pmin(), command.R(), command.Td(), command.Tf(), command.Tp(), command.Tt(), command.Tturb(), command.Velcl(), command.Velop());        
    ...
    public void handle(AssignAturbToGovHydroDDCommand command) throws Exception {
    	...
    	if (  aturb != null && aturb.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Aturb already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignAturbFromGovHydroDDCommand command) throws Exception {
    	...
    	if (  aturb == null )
    		throw new ProcessingException( "Aturb already has nothing assigned." );  
    ...
    public void handle(AssignBturbToGovHydroDDCommand command) throws Exception {
    	...
    	if (  bturb != null && bturb.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Bturb already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignBturbFromGovHydroDDCommand command) throws Exception {
    	...
    	if (  bturb == null )
    		throw new ProcessingException( "Bturb already has nothing assigned." );  
    ...
    public void handle(AssignInputSignalToGovHydroDDCommand command) throws Exception {
        ...
        apply(new AssignInputSignalToGovHydroDDEvent(command.getGovHydroDDId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTturbToGovHydroDDCommand command) throws Exception {
    	...
    	if (  tturb != null && tturb.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tturb already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(UnAssignTturbFromGovHydroDDCommand command) throws Exception {
    	...
    	if (  tturb == null )
    		throw new ProcessingException( "Tturb already has nothing assigned." );  
