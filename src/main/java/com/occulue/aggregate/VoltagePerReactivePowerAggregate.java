...
public class VoltagePerReactivePowerAggregate {  
    ...
    public VoltagePerReactivePowerAggregate(CreateVoltagePerReactivePowerCommand command) throws Exception {
    	...
    	CreateVoltagePerReactivePowerEvent event = new CreateVoltagePerReactivePowerEvent(command.getVoltagePerReactivePowerId(), command.DenominatorMultiplier(), command.DenominatorUnit(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateVoltagePerReactivePowerCommand command) throws Exception {
    	...
    	UpdateVoltagePerReactivePowerEvent event = new UpdateVoltagePerReactivePowerEvent(command.getVoltagePerReactivePowerId(), command.DenominatorMultiplier(), command.DenominatorUnit(), command.Multiplier(), command.Unit(), command.Value());        
    ...
    public void handle(AssignValueToVoltagePerReactivePowerCommand command) throws Exception {
        ...
        apply(new AssignValueToVoltagePerReactivePowerEvent(command.getVoltagePerReactivePowerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignValueFromVoltagePerReactivePowerCommand command) throws Exception {
    	...
    	apply(new UnAssignValueFromVoltagePerReactivePowerEvent(command.getVoltagePerReactivePowerId()));
    }
