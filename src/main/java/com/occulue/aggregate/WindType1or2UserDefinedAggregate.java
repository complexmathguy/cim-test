...
public class WindType1or2UserDefinedAggregate {  
    ...
    public WindType1or2UserDefinedAggregate(CreateWindType1or2UserDefinedCommand command) throws Exception {
    	...
    	CreateWindType1or2UserDefinedEvent event = new CreateWindType1or2UserDefinedEvent(command.getWindType1or2UserDefinedId());
    ...
    public void handle(UpdateWindType1or2UserDefinedCommand command) throws Exception {
    	...
    	UpdateWindType1or2UserDefinedEvent event = new UpdateWindType1or2UserDefinedEvent(command.getWindType1or2UserDefinedId(), command.Proprietary());        
    ...
    public void handle(AssignProprietaryToWindType1or2UserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToWindType1or2UserDefinedEvent(command.getWindType1or2UserDefinedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignProprietaryFromWindType1or2UserDefinedCommand command) throws Exception {
    	...
    	apply(new UnAssignProprietaryFromWindType1or2UserDefinedEvent(command.getWindType1or2UserDefinedId()));
    }
