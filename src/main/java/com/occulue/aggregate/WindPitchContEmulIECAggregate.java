...
public class WindPitchContEmulIECAggregate {  
    ...
    public WindPitchContEmulIECAggregate(CreateWindPitchContEmulIECCommand command) throws Exception {
    	...
    	CreateWindPitchContEmulIECEvent event = new CreateWindPitchContEmulIECEvent(command.getWindPitchContEmulIECId());
    ...
    public void handle(UpdateWindPitchContEmulIECCommand command) throws Exception {
    	...
    	UpdateWindPitchContEmulIECEvent event = new UpdateWindPitchContEmulIECEvent(command.getWindPitchContEmulIECId(), command.Kdroop(), command.Kipce(), command.Komegaaero(), command.Kppce(), command.Omegaref(), command.Pimax(), command.Pimin(), command.T1(), command.T2(), command.Tpe());        
    ...
    public void handle(AssignKdroopToWindPitchContEmulIECCommand command) throws Exception {
    	...
    	if (  kdroop != null && kdroop.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Kdroop already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignKdroopToWindPitchContEmulIECEvent(command.getWindPitchContEmulIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignKipceToWindPitchContEmulIECCommand command) throws Exception {
    	...
    	if (  kipce != null && kipce.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Kipce already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignKipceToWindPitchContEmulIECEvent(command.getWindPitchContEmulIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKipceFromWindPitchContEmulIECCommand command) throws Exception {
    	...
    	if (  kipce == null )
    		throw new ProcessingException( "Kipce already has nothing assigned." );  
    ...
    public void handle(AssignKomegaaeroToWindPitchContEmulIECCommand command) throws Exception {
    	...
    	if (  komegaaero != null && komegaaero.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Komegaaero already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKomegaaeroToWindPitchContEmulIECEvent(command.getWindPitchContEmulIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignKppceToWindPitchContEmulIECCommand command) throws Exception {
    	...
    	if (  kppce != null && kppce.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Kppce already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignKppceToWindPitchContEmulIECEvent(command.getWindPitchContEmulIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKppceFromWindPitchContEmulIECCommand command) throws Exception {
    	...
    	if (  kppce == null )
    		throw new ProcessingException( "Kppce already has nothing assigned." );  
    ...
    public void handle(AssignOmegarefToWindPitchContEmulIECCommand command) throws Exception {
    	...
    	if (  omegaref != null && omegaref.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Omegaref already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignOmegarefToWindPitchContEmulIECEvent(command.getWindPitchContEmulIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignOmegarefFromWindPitchContEmulIECCommand command) throws Exception {
    	...
    	if (  omegaref == null )
    		throw new ProcessingException( "Omegaref already has nothing assigned." );  
    ...
    public void handle(AssignPimaxToWindPitchContEmulIECCommand command) throws Exception {
    	...
    	if (  pimax != null && pimax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Pimax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignPimaxToWindPitchContEmulIECEvent(command.getWindPitchContEmulIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignPimaxFromWindPitchContEmulIECCommand command) throws Exception {
    	...
    	if (  pimax == null )
    		throw new ProcessingException( "Pimax already has nothing assigned." );  
    ...
    public void handle(AssignPiminToWindPitchContEmulIECCommand command) throws Exception {
    	...
    	if (  pimin != null && pimin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Pimin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignPiminToWindPitchContEmulIECEvent(command.getWindPitchContEmulIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignPiminFromWindPitchContEmulIECCommand command) throws Exception {
    	...
    	if (  pimin == null )
    		throw new ProcessingException( "Pimin already has nothing assigned." );  
    ...
    public void handle(AssignT1ToWindPitchContEmulIECCommand command) throws Exception {
        ...
        apply(new AssignT1ToWindPitchContEmulIECEvent(command.getWindPitchContEmulIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignT2ToWindPitchContEmulIECCommand command) throws Exception {
        ...
        apply(new AssignT2ToWindPitchContEmulIECEvent(command.getWindPitchContEmulIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTpeToWindPitchContEmulIECCommand command) throws Exception {
        ...
        apply(new AssignTpeToWindPitchContEmulIECEvent(command.getWindPitchContEmulIECId(), command.getAssignment()));
    }
