...
public class ExcST1AAggregate {  
    ...
    public void handle(UpdateExcST1ACommand command) throws Exception {
    	...
    	UpdateExcST1AEvent event = new UpdateExcST1AEvent(command.getExcST1AId(), command.Ilr(), command.Ka(), command.Kc(), command.Kf(), command.Klr(), command.Ta(), command.Tb(), command.Tb1(), command.Tc(), command.Tc1(), command.Tf(), command.Vamax(), command.Vamin(), command.Vimax(), command.Vimin(), command.Vrmax(), command.Vrmin(), command.Xe());        
    ...
    public void handle(AssignXeToExcST1ACommand command) throws Exception {
    	...
    	if (  xe != null && xe.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Xe already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignXeFromExcST1ACommand command) throws Exception {
    	...
    	if (  xe == null )
    		throw new ProcessingException( "Xe already has nothing assigned." );  
