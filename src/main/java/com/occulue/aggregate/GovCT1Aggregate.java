...
public class GovCT1Aggregate {  
    ...
    public GovCT1Aggregate(CreateGovCT1Command command) throws Exception {
    	...
    	CreateGovCT1Event event = new CreateGovCT1Event(command.getGovCT1Id(), command.Rselect());
