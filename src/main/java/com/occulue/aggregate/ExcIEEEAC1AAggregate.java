...
public class ExcIEEEAC1AAggregate {  
    ...
    public void handle(UpdateExcIEEEAC1ACommand command) throws Exception {
    	...
    	UpdateExcIEEEAC1AEvent event = new UpdateExcIEEEAC1AEvent(command.getExcIEEEAC1AId(), command.Ka(), command.Kc(), command.Kd(), command.Ke(), command.Kf(), command.Seve1(), command.Seve2(), command.Ta(), command.Tb(), command.Tc(), command.Te(), command.Tf(), command.Vamax(), command.Vamin(), command.Ve1(), command.Ve2(), command.Vrmax(), command.Vrmin());        
