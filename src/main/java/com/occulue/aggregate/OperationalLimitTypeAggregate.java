...
public class OperationalLimitTypeAggregate {  
    ...
    public OperationalLimitTypeAggregate(CreateOperationalLimitTypeCommand command) throws Exception {
    	...
    	CreateOperationalLimitTypeEvent event = new CreateOperationalLimitTypeEvent(command.getOperationalLimitTypeId(), command.Direction(), command.LimitType());
    ...
    public void handle(UpdateOperationalLimitTypeCommand command) throws Exception {
    	...
    	UpdateOperationalLimitTypeEvent event = new UpdateOperationalLimitTypeEvent(command.getOperationalLimitTypeId(), command.AcceptableDuration(), command.Direction(), command.LimitType());        
    ...
    @CommandHandler
    public void handle(AssignAcceptableDurationToOperationalLimitTypeCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignAcceptableDurationToOperationalLimitTypeCommand" );
    	
    	if (  acceptableDuration != null && acceptableDuration.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "AcceptableDuration already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignAcceptableDurationToOperationalLimitTypeEvent(command.getOperationalLimitTypeId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignAcceptableDurationFromOperationalLimitTypeCommand command) throws Exception {
    	...
    	apply(new UnAssignAcceptableDurationFromOperationalLimitTypeEvent(command.getOperationalLimitTypeId()));
    }
