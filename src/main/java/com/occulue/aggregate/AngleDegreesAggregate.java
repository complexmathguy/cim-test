...
public class AngleDegreesAggregate {  
    ...
    public AngleDegreesAggregate(CreateAngleDegreesCommand command) throws Exception {
    	...
    	CreateAngleDegreesEvent event = new CreateAngleDegreesEvent(command.getAngleDegreesId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateAngleDegreesCommand command) throws Exception {
    	...
    	UpdateAngleDegreesEvent event = new UpdateAngleDegreesEvent(command.getAngleDegreesId(), command.Multiplier(), command.Unit(), command.Value());        
