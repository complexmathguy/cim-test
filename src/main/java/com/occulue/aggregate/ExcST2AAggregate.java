...
public class ExcST2AAggregate {  
    ...
    public void handle(UpdateExcST2ACommand command) throws Exception {
    	...
    	UpdateExcST2AEvent event = new UpdateExcST2AEvent(command.getExcST2AId(), command.Efdmax(), command.Ka(), command.Kc(), command.Ke(), command.Kf(), command.Ki(), command.Kp(), command.Ta(), command.Tb(), command.Tc(), command.Te(), command.Tf(), command.Uelin(), command.Vrmax(), command.Vrmin());        
