...
public class ExcSCRXAggregate {  
    ...
    public void handle(UpdateExcSCRXCommand command) throws Exception {
    	...
    	UpdateExcSCRXEvent event = new UpdateExcSCRXEvent(command.getExcSCRXId(), command.Cswitch(), command.Emax(), command.Emin(), command.K(), command.Rcrfd(), command.Tatb(), command.Tb(), command.Te());        
    ...
    public void handle(AssignCswitchToExcSCRXCommand command) throws Exception {
    	...
    	if (  cswitch != null && cswitch.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Cswitch already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(UnAssignCswitchFromExcSCRXCommand command) throws Exception {
    	...
    	if (  cswitch == null )
    		throw new ProcessingException( "Cswitch already has nothing assigned." );  
    ...
    public void handle(AssignRcrfdToExcSCRXCommand command) throws Exception {
    	...
    	if (  rcrfd != null && rcrfd.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Rcrfd already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    ...
    public void handle(UnAssignRcrfdFromExcSCRXCommand command) throws Exception {
    	...
    	if (  rcrfd == null )
    		throw new ProcessingException( "Rcrfd already has nothing assigned." );  
