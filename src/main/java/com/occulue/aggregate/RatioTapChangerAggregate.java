...
public class RatioTapChangerAggregate {  
    ...
    public RatioTapChangerAggregate(CreateRatioTapChangerCommand command) throws Exception {
    	...
    	CreateRatioTapChangerEvent event = new CreateRatioTapChangerEvent(command.getRatioTapChangerId(), command.TculControlMode());
    ...
    public void handle(UpdateRatioTapChangerCommand command) throws Exception {
    	...
    	UpdateRatioTapChangerEvent event = new UpdateRatioTapChangerEvent(command.getRatioTapChangerId(), command.StepVoltageIncrement(), command.TculControlMode());        
