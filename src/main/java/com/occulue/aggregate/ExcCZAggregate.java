...
public class ExcCZAggregate {  
    ...
    public void handle(UpdateExcCZCommand command) throws Exception {
    	...
    	UpdateExcCZEvent event = new UpdateExcCZEvent(command.getExcCZId(), command.Efdmax(), command.Efdmin(), command.Ka(), command.Ke(), command.Kp(), command.Ta(), command.Tc(), command.Te(), command.Vrmax(), command.Vrmin());        
