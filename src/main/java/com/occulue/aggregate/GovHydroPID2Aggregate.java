...
public class GovHydroPID2Aggregate {  
    ...
    public void handle(UpdateGovHydroPID2Command command) throws Exception {
    	...
    	UpdateGovHydroPID2Event event = new UpdateGovHydroPID2Event(command.getGovHydroPID2Id(), command.Atw(), command.D(), command.FeedbackSignal(), command.G0(), command.G1(), command.G2(), command.Gmax(), command.Gmin(), command.Kd(), command.Ki(), command.Kp(), command.Mwbase(), command.P1(), command.P2(), command.P3(), command.Rperm(), command.Ta(), command.Tb(), command.Treg(), command.Tw(), command.Velmax(), command.Velmin());        
    ...
    public void handle(AssignAtwToGovHydroPID2Command command) throws Exception {
    	...
    	if (  atw != null && atw.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Atw already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignAtwFromGovHydroPID2Command command) throws Exception {
    	...
    	if (  atw == null )
    		throw new ProcessingException( "Atw already has nothing assigned." );  
    ...
    public void handle(AssignFeedbackSignalToGovHydroPID2Command command) throws Exception {
        ...
        apply(new AssignFeedbackSignalToGovHydroPID2Event(command.getGovHydroPID2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignG0ToGovHydroPID2Command command) throws Exception {
    	...
    	if (  g0 != null && g0.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "G0 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(AssignG1ToGovHydroPID2Command command) throws Exception {
    	...
    	if (  g1 != null && g1.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "G1 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignG1FromGovHydroPID2Command command) throws Exception {
    	...
    	if (  g1 == null )
    		throw new ProcessingException( "G1 already has nothing assigned." );  
    ...
    public void handle(AssignG2ToGovHydroPID2Command command) throws Exception {
    	...
    	if (  g2 != null && g2.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "G2 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignG2FromGovHydroPID2Command command) throws Exception {
    	...
    	if (  g2 == null )
    		throw new ProcessingException( "G2 already has nothing assigned." );  
    ...
    public void handle(AssignKiToGovHydroPID2Command command) throws Exception {
    	...
    	if (  ki != null && ki.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Ki already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    ...
    public void handle(AssignMwbaseToGovHydroPID2Command command) throws Exception {
        ...
        apply(new AssignMwbaseToGovHydroPID2Event(command.getGovHydroPID2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignVelmaxToGovHydroPID2Command command) throws Exception {
    	...
    	if (  velmax != null && velmax.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Velmax already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignVelmaxToGovHydroPID2Event(command.getGovHydroPID2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignVelminToGovHydroPID2Command command) throws Exception {
    	...
    	if (  velmin != null && velmin.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Velmin already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignVelminToGovHydroPID2Event(command.getGovHydroPID2Id(), command.getAssignment()));
    }
