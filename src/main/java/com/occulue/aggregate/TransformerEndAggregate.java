...
public class TransformerEndAggregate {  
    ...
    public void handle(UpdateTransformerEndCommand command) throws Exception {
    	...
    	UpdateTransformerEndEvent event = new UpdateTransformerEndEvent(command.getTransformerEndId(), command.EndNumber(), command.Grounded(), command.Rground(), command.Xground());        
