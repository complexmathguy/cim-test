...
public class ExcAVR3Aggregate {  
    ...
    public void handle(UpdateExcAVR3Command command) throws Exception {
    	...
    	UpdateExcAVR3Event event = new UpdateExcAVR3Event(command.getExcAVR3Id(), command.E1(), command.E2(), command.Ka(), command.Se1(), command.Se2(), command.T1(), command.T2(), command.T3(), command.T4(), command.Te(), command.Vrmn(), command.Vrmx());        
