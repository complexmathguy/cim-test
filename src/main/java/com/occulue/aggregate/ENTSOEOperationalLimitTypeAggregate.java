...
public class ENTSOEOperationalLimitTypeAggregate {  
    ...
    public ENTSOEOperationalLimitTypeAggregate(CreateENTSOEOperationalLimitTypeCommand command) throws Exception {
    	...
    	CreateENTSOEOperationalLimitTypeEvent event = new CreateENTSOEOperationalLimitTypeEvent(command.getENTSOEOperationalLimitTypeId(), command.LimitType());
    ...
    public void handle(UpdateENTSOEOperationalLimitTypeCommand command) throws Exception {
    	...
    	UpdateENTSOEOperationalLimitTypeEvent event = new UpdateENTSOEOperationalLimitTypeEvent(command.getENTSOEOperationalLimitTypeId(), command.LimitType());        
