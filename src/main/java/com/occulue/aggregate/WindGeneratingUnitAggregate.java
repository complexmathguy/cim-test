...
public class WindGeneratingUnitAggregate {  
    ...
    public WindGeneratingUnitAggregate(CreateWindGeneratingUnitCommand command) throws Exception {
    	...
    	CreateWindGeneratingUnitEvent event = new CreateWindGeneratingUnitEvent(command.getWindGeneratingUnitId(), command.WindGenUnitType());
    ...
    public void handle(UpdateWindGeneratingUnitCommand command) throws Exception {
    	...
    	UpdateWindGeneratingUnitEvent event = new UpdateWindGeneratingUnitEvent(command.getWindGeneratingUnitId(), command.WindGenUnitType());        
