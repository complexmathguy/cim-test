...
public class ExcDC2AAggregate {  
    ...
    public void handle(UpdateExcDC2ACommand command) throws Exception {
    	...
    	UpdateExcDC2AEvent event = new UpdateExcDC2AEvent(command.getExcDC2AId(), command.Efd1(), command.Efd2(), command.Exclim(), command.Ka(), command.Ke(), command.Kf(), command.Ks(), command.Seefd1(), command.Seefd2(), command.Ta(), command.Tb(), command.Tc(), command.Te(), command.Tf(), command.Tf1(), command.Vrmax(), command.Vrmin(), command.Vtlim());        
    ...
    public void handle(AssignExclimToExcDC2ACommand command) throws Exception {
    	...
    	if (  exclim != null && exclim.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Exclim already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(UnAssignExclimFromExcDC2ACommand command) throws Exception {
    	...
    	if (  exclim == null )
    		throw new ProcessingException( "Exclim already has nothing assigned." );  
    ...
    public void handle(AssignVtlimToExcDC2ACommand command) throws Exception {
    	...
    	if (  vtlim != null && vtlim.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Vtlim already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(UnAssignVtlimFromExcDC2ACommand command) throws Exception {
    	...
    	if (  vtlim == null )
    		throw new ProcessingException( "Vtlim already has nothing assigned." );  
