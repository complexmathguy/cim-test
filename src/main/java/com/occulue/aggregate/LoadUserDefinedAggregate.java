...
public class LoadUserDefinedAggregate {  
    ...
    public LoadUserDefinedAggregate(CreateLoadUserDefinedCommand command) throws Exception {
    	...
    	CreateLoadUserDefinedEvent event = new CreateLoadUserDefinedEvent(command.getLoadUserDefinedId());
    ...
    public void handle(UpdateLoadUserDefinedCommand command) throws Exception {
    	...
    	UpdateLoadUserDefinedEvent event = new UpdateLoadUserDefinedEvent(command.getLoadUserDefinedId(), command.Proprietary());        
    ...
    public void handle(AssignProprietaryToLoadUserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToLoadUserDefinedEvent(command.getLoadUserDefinedId(), command.getAssignment()));
    }
