...
public class AsynchronousMachineEquivalentCircuitAggregate {  
    ...
    public AsynchronousMachineEquivalentCircuitAggregate(CreateAsynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	CreateAsynchronousMachineEquivalentCircuitEvent event = new CreateAsynchronousMachineEquivalentCircuitEvent(command.getAsynchronousMachineEquivalentCircuitId());
    ...
    public void handle(UpdateAsynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	UpdateAsynchronousMachineEquivalentCircuitEvent event = new UpdateAsynchronousMachineEquivalentCircuitEvent(command.getAsynchronousMachineEquivalentCircuitId(), command.Rr1(), command.Rr2(), command.Xlr1(), command.Xlr2(), command.Xm());        
    ...
    @CommandHandler
    public void handle(AssignRr1ToAsynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  rr1 != null && rr1.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Rr1 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignRr1ToAsynchronousMachineEquivalentCircuitEvent(command.getAsynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignRr1FromAsynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignRr1FromAsynchronousMachineEquivalentCircuitCommand" );

    	if (  rr1 == null )
    		throw new ProcessingException( "Rr1 already has nothing assigned." );  

    	apply(new UnAssignRr1FromAsynchronousMachineEquivalentCircuitEvent(command.getAsynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignRr2ToAsynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  rr2 != null && rr2.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Rr2 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignRr2ToAsynchronousMachineEquivalentCircuitEvent(command.getAsynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignRr2FromAsynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignRr2FromAsynchronousMachineEquivalentCircuitCommand" );

    	if (  rr2 == null )
    		throw new ProcessingException( "Rr2 already has nothing assigned." );  

    	apply(new UnAssignRr2FromAsynchronousMachineEquivalentCircuitEvent(command.getAsynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignXlr1ToAsynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  xlr1 != null && xlr1.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Xlr1 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignXlr1ToAsynchronousMachineEquivalentCircuitEvent(command.getAsynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignXlr1FromAsynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignXlr1FromAsynchronousMachineEquivalentCircuitCommand" );

    	if (  xlr1 == null )
    		throw new ProcessingException( "Xlr1 already has nothing assigned." );  

    	apply(new UnAssignXlr1FromAsynchronousMachineEquivalentCircuitEvent(command.getAsynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignXlr2ToAsynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  xlr2 != null && xlr2.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Xlr2 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignXlr2ToAsynchronousMachineEquivalentCircuitEvent(command.getAsynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignXlr2FromAsynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignXlr2FromAsynchronousMachineEquivalentCircuitCommand" );

    	if (  xlr2 == null )
    		throw new ProcessingException( "Xlr2 already has nothing assigned." );  

    	apply(new UnAssignXlr2FromAsynchronousMachineEquivalentCircuitEvent(command.getAsynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignXmToAsynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  xm != null && xm.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Xm already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignXmToAsynchronousMachineEquivalentCircuitEvent(command.getAsynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignXmFromAsynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignXmFromAsynchronousMachineEquivalentCircuitCommand" );

    	if (  xm == null )
    		throw new ProcessingException( "Xm already has nothing assigned." );  

    	apply(new UnAssignXmFromAsynchronousMachineEquivalentCircuitEvent(command.getAsynchronousMachineEquivalentCircuitId()));
    }
