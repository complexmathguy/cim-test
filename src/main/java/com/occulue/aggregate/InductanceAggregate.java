...
public class InductanceAggregate {  
    ...
    public InductanceAggregate(CreateInductanceCommand command) throws Exception {
    	...
    	CreateInductanceEvent event = new CreateInductanceEvent(command.getInductanceId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateInductanceCommand command) throws Exception {
    	...
    	UpdateInductanceEvent event = new UpdateInductanceEvent(command.getInductanceId(), command.Multiplier(), command.Unit(), command.Value());        
