...
public class NonlinearShuntCompensatorPointAggregate {  
    ...
    public void handle(UpdateNonlinearShuntCompensatorPointCommand command) throws Exception {
    	...
    	UpdateNonlinearShuntCompensatorPointEvent event = new UpdateNonlinearShuntCompensatorPointEvent(command.getNonlinearShuntCompensatorPointId(), command.B(), command.B0(), command.G(), command.G0(), command.SectionNumber());        
