...
public class UnderexcLimX2Aggregate {  
    ...
    public void handle(UpdateUnderexcLimX2Command command) throws Exception {
    	...
    	UpdateUnderexcLimX2Event event = new UpdateUnderexcLimX2Event(command.getUnderexcLimX2Id(), command.Kf2(), command.Km(), command.Melmax(), command.Qo(), command.R(), command.Tf2(), command.Tm());        
    ...
    public void handle(AssignMelmaxToUnderexcLimX2Command command) throws Exception {
    	...
    	if (  melmax != null && melmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Melmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignMelmaxToUnderexcLimX2Event(command.getUnderexcLimX2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMelmaxFromUnderexcLimX2Command command) throws Exception {
    	...
    	if (  melmax == null )
    		throw new ProcessingException( "Melmax already has nothing assigned." );  
    ...
    public void handle(AssignQoToUnderexcLimX2Command command) throws Exception {
    	...
    	if (  qo != null && qo.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Qo already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignQoFromUnderexcLimX2Command command) throws Exception {
    	...
    	if (  qo == null )
    		throw new ProcessingException( "Qo already has nothing assigned." );  
