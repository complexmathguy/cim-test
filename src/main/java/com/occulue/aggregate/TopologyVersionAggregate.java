...
public class TopologyVersionAggregate {  
    ...
    public TopologyVersionAggregate(CreateTopologyVersionCommand command) throws Exception {
    	...
    	CreateTopologyVersionEvent event = new CreateTopologyVersionEvent(command.getTopologyVersionId());
    ...
    public void handle(UpdateTopologyVersionCommand command) throws Exception {
    	...
    	UpdateTopologyVersionEvent event = new UpdateTopologyVersionEvent(command.getTopologyVersionId(), command.BaseUML(), command.BaseURI(), command.Date(), command.DifferenceModelURI(), command.EntsoeUML(), command.EntsoeURI(), command.ModelDescriptionURI(), command.NamespaceRDF(), command.NamespaceUML(), command.ShortName());        
    ...
    public void handle(AssignBaseUMLToTopologyVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseUMLToTopologyVersionEvent(command.getTopologyVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignBaseURIToTopologyVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseURIToTopologyVersionEvent(command.getTopologyVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignDateToTopologyVersionCommand command) throws Exception {
        ...
        apply(new AssignDateToTopologyVersionEvent(command.getTopologyVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignDifferenceModelURIToTopologyVersionCommand command) throws Exception {
        ...
        apply(new AssignDifferenceModelURIToTopologyVersionEvent(command.getTopologyVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignDifferenceModelURIFromTopologyVersionCommand command) throws Exception {
    ...
    public void handle(AssignEntsoeUMLToTopologyVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeUMLToTopologyVersionEvent(command.getTopologyVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignEntsoeURIToTopologyVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeURIToTopologyVersionEvent(command.getTopologyVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignModelDescriptionURIToTopologyVersionCommand command) throws Exception {
        ...
        apply(new AssignModelDescriptionURIToTopologyVersionEvent(command.getTopologyVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignModelDescriptionURIFromTopologyVersionCommand command) throws Exception {
    ...
    public void handle(AssignNamespaceRDFToTopologyVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceRDFToTopologyVersionEvent(command.getTopologyVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignNamespaceUMLToTopologyVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceUMLToTopologyVersionEvent(command.getTopologyVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignShortNameToTopologyVersionCommand command) throws Exception {
        ...
        apply(new AssignShortNameToTopologyVersionEvent(command.getTopologyVersionId(), command.getAssignment()));
    }
