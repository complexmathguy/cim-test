...
public class ExcIEEEDC1AAggregate {  
    ...
    public void handle(UpdateExcIEEEDC1ACommand command) throws Exception {
    	...
    	UpdateExcIEEEDC1AEvent event = new UpdateExcIEEEDC1AEvent(command.getExcIEEEDC1AId(), command.Efd1(), command.Efd2(), command.Exclim(), command.Ka(), command.Ke(), command.Kf(), command.Seefd1(), command.Seefd2(), command.Ta(), command.Tb(), command.Tc(), command.Te(), command.Tf(), command.Uelin(), command.Vrmax(), command.Vrmin());        
