...
public class PerCentAggregate {  
    ...
    public PerCentAggregate(CreatePerCentCommand command) throws Exception {
    	...
    	CreatePerCentEvent event = new CreatePerCentEvent(command.getPerCentId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdatePerCentCommand command) throws Exception {
    	...
    	UpdatePerCentEvent event = new UpdatePerCentEvent(command.getPerCentId(), command.Multiplier(), command.Unit(), command.Value());        
