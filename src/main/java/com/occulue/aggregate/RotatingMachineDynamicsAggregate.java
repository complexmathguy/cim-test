...
public class RotatingMachineDynamicsAggregate {  
    ...
    public RotatingMachineDynamicsAggregate(CreateRotatingMachineDynamicsCommand command) throws Exception {
    	...
    	CreateRotatingMachineDynamicsEvent event = new CreateRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId());
    ...
    public void handle(UpdateRotatingMachineDynamicsCommand command) throws Exception {
    	...
    	UpdateRotatingMachineDynamicsEvent event = new UpdateRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId(), command.Damping(), command.Inertia(), command.SaturationFactor(), command.SaturationFactor120(), command.StatorLeakageReactance(), command.StatorResistance());        
    ...
    public void handle(AssignDampingToRotatingMachineDynamicsCommand command) throws Exception {
    	...
    	if (  damping != null && damping.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Damping already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignDampingToRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDampingFromRotatingMachineDynamicsCommand command) throws Exception {
    	...
    	if (  damping == null )
    		throw new ProcessingException( "Damping already has nothing assigned." );  

    	apply(new UnAssignDampingFromRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId()));
    }
    @CommandHandler
    public void handle(AssignInertiaToRotatingMachineDynamicsCommand command) throws Exception {
    	...
    	if (  inertia != null && inertia.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Inertia already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignInertiaToRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignInertiaFromRotatingMachineDynamicsCommand command) throws Exception {
    	...
    	if (  inertia == null )
    		throw new ProcessingException( "Inertia already has nothing assigned." );  

    	apply(new UnAssignInertiaFromRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId()));
    }
    @CommandHandler
    public void handle(AssignSaturationFactorToRotatingMachineDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignSaturationFactorToRotatingMachineDynamicsCommand" );
    	
    	if (  saturationFactor != null && saturationFactor.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "SaturationFactor already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignSaturationFactorToRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignSaturationFactorFromRotatingMachineDynamicsCommand command) throws Exception {
    	...
    	apply(new UnAssignSaturationFactorFromRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId()));
    }
    @CommandHandler
    public void handle(AssignSaturationFactor120ToRotatingMachineDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignSaturationFactor120ToRotatingMachineDynamicsCommand" );
    	
    	if (  saturationFactor120 != null && saturationFactor120.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "SaturationFactor120 already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignSaturationFactor120ToRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignSaturationFactor120FromRotatingMachineDynamicsCommand command) throws Exception {
    	...
    	apply(new UnAssignSaturationFactor120FromRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId()));
    }
    @CommandHandler
    public void handle(AssignStatorLeakageReactanceToRotatingMachineDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignStatorLeakageReactanceToRotatingMachineDynamicsCommand" );
    	
    	if (  statorLeakageReactance != null && statorLeakageReactance.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "StatorLeakageReactance already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignStatorLeakageReactanceToRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignStatorLeakageReactanceFromRotatingMachineDynamicsCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignStatorLeakageReactanceFromRotatingMachineDynamicsCommand" );

    	if (  statorLeakageReactance == null )
    		throw new ProcessingException( "StatorLeakageReactance already has nothing assigned." );  

    	apply(new UnAssignStatorLeakageReactanceFromRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId()));
    }
    @CommandHandler
    public void handle(AssignStatorResistanceToRotatingMachineDynamicsCommand command) throws Exception {
    	...
    	if (  statorResistance != null && statorResistance.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "StatorResistance already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignStatorResistanceToRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignStatorResistanceFromRotatingMachineDynamicsCommand command) throws Exception {
    	...
    	apply(new UnAssignStatorResistanceFromRotatingMachineDynamicsEvent(command.getRotatingMachineDynamicsId()));
    }
