...
public class ExcIEEEST2AAggregate {  
    ...
    public void handle(UpdateExcIEEEST2ACommand command) throws Exception {
    	...
    	UpdateExcIEEEST2AEvent event = new UpdateExcIEEEST2AEvent(command.getExcIEEEST2AId(), command.Efdmax(), command.Ka(), command.Kc(), command.Ke(), command.Kf(), command.Ki(), command.Kp(), command.Ta(), command.Te(), command.Tf(), command.Uelin(), command.Vrmax(), command.Vrmin());        
