...
public class WindPlantFreqPcontrolIECAggregate {  
    ...
    public WindPlantFreqPcontrolIECAggregate(CreateWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	CreateWindPlantFreqPcontrolIECEvent event = new CreateWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId());
    ...
    public void handle(UpdateWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	UpdateWindPlantFreqPcontrolIECEvent event = new UpdateWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId(), command.Dprefmax(), command.Dprefmin(), command.Kiwpp(), command.Kpwpp(), command.Prefmax(), command.Prefmin(), command.Tpft(), command.Tpfv(), command.Twpffilt(), command.Twppfilt());        
    ...
    public void handle(AssignDprefmaxToWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  dprefmax != null && dprefmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Dprefmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignDprefmaxToWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDprefmaxFromWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  dprefmax == null )
    		throw new ProcessingException( "Dprefmax already has nothing assigned." );  

    	apply(new UnAssignDprefmaxFromWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId()));
    }
    @CommandHandler
    public void handle(AssignDprefminToWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  dprefmin != null && dprefmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Dprefmin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignDprefminToWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDprefminFromWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  dprefmin == null )
    		throw new ProcessingException( "Dprefmin already has nothing assigned." );  

    	apply(new UnAssignDprefminFromWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId()));
    }
    @CommandHandler
    public void handle(AssignKiwppToWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  kiwpp != null && kiwpp.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Kiwpp already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignKiwppToWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKiwppFromWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  kiwpp == null )
    		throw new ProcessingException( "Kiwpp already has nothing assigned." );  

    	apply(new UnAssignKiwppFromWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId()));
    }
    @CommandHandler
    public void handle(AssignKpwppToWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  kpwpp != null && kpwpp.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Kpwpp already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignKpwppToWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKpwppFromWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  kpwpp == null )
    		throw new ProcessingException( "Kpwpp already has nothing assigned." );  

    	apply(new UnAssignKpwppFromWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId()));
    }
    @CommandHandler
    public void handle(AssignPrefmaxToWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  prefmax != null && prefmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Prefmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignPrefmaxToWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignPrefmaxFromWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  prefmax == null )
    		throw new ProcessingException( "Prefmax already has nothing assigned." );  

    	apply(new UnAssignPrefmaxFromWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId()));
    }
    @CommandHandler
    public void handle(AssignPrefminToWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  prefmin != null && prefmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Prefmin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignPrefminToWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignPrefminFromWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  prefmin == null )
    		throw new ProcessingException( "Prefmin already has nothing assigned." );  

    	apply(new UnAssignPrefminFromWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId()));
    }
    @CommandHandler
    public void handle(AssignTpftToWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  tpft != null && tpft.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tpft already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTpftToWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTpftFromWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  tpft == null )
    		throw new ProcessingException( "Tpft already has nothing assigned." );  

    	apply(new UnAssignTpftFromWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId()));
    }
    @CommandHandler
    public void handle(AssignTpfvToWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  tpfv != null && tpfv.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tpfv already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTpfvToWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTpfvFromWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  tpfv == null )
    		throw new ProcessingException( "Tpfv already has nothing assigned." );  

    	apply(new UnAssignTpfvFromWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId()));
    }
    @CommandHandler
    public void handle(AssignTwpffiltToWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  twpffilt != null && twpffilt.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Twpffilt already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTwpffiltToWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTwpffiltFromWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	if (  twpffilt == null )
    		throw new ProcessingException( "Twpffilt already has nothing assigned." );  

    	apply(new UnAssignTwpffiltFromWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId()));
    }
    @CommandHandler
    public void handle(AssignTwppfiltToWindPlantFreqPcontrolIECCommand command) throws Exception {
        ...
        apply(new AssignTwppfiltToWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTwppfiltFromWindPlantFreqPcontrolIECCommand command) throws Exception {
    	...
    	apply(new UnAssignTwppfiltFromWindPlantFreqPcontrolIECEvent(command.getWindPlantFreqPcontrolIECId()));
    }
