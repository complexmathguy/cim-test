...
public class SynchronousMachineAggregate {  
    ...
    public SynchronousMachineAggregate(CreateSynchronousMachineCommand command) throws Exception {
    	...
    	CreateSynchronousMachineEvent event = new CreateSynchronousMachineEvent(command.getSynchronousMachineId(), command.ShortCircuitRotorType(), command.Type());
    ...
    public void handle(UpdateSynchronousMachineCommand command) throws Exception {
    	...
    	UpdateSynchronousMachineEvent event = new UpdateSynchronousMachineEvent(command.getSynchronousMachineId(), command.Earthing(), command.EarthingStarPointR(), command.EarthingStarPointX(), command.Ikk(), command.MaxQ(), command.MinQ(), command.Mu(), command.QPercent(), command.R(), command.R0(), command.R2(), command.SatDirectSubtransX(), command.SatDirectSyncX(), command.SatDirectTransX(), command.ShortCircuitRotorType(), command.Type(), command.VoltageRegulationRange(), command.X0(), command.X2());        
    ...
    public void handle(AssignEarthingToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  earthing != null && earthing.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Earthing already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignEarthingToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEarthingFromSynchronousMachineCommand command) throws Exception {
    	...
    	if (  earthing == null )
    		throw new ProcessingException( "Earthing already has nothing assigned." );  
    ...
    public void handle(AssignEarthingStarPointRToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  earthingStarPointR != null && earthingStarPointR.getResistanceId() == command.getAssignment().getResistanceId() )
    		throw new ProcessingException( "EarthingStarPointR already assigned with id " + command.getAssignment().getResistanceId() );  
    		
        apply(new AssignEarthingStarPointRToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEarthingStarPointRFromSynchronousMachineCommand command) throws Exception {
    	...
    	apply(new UnAssignEarthingStarPointRFromSynchronousMachineEvent(command.getSynchronousMachineId()));
    }
    @CommandHandler
    public void handle(AssignEarthingStarPointXToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  earthingStarPointX != null && earthingStarPointX.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "EarthingStarPointX already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignEarthingStarPointXToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEarthingStarPointXFromSynchronousMachineCommand command) throws Exception {
    	...
    	apply(new UnAssignEarthingStarPointXFromSynchronousMachineEvent(command.getSynchronousMachineId()));
    }
    @CommandHandler
    public void handle(AssignIkkToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  ikk != null && ikk.getCurrentFlowId() == command.getAssignment().getCurrentFlowId() )
    		throw new ProcessingException( "Ikk already assigned with id " + command.getAssignment().getCurrentFlowId() );  
    		
        apply(new AssignIkkToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignIkkFromSynchronousMachineCommand command) throws Exception {
    	...
    	if (  ikk == null )
    		throw new ProcessingException( "Ikk already has nothing assigned." );  
    ...
    public void handle(AssignMaxQToSynchronousMachineCommand command) throws Exception {
        ...
        apply(new AssignMaxQToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(AssignMinQToSynchronousMachineCommand command) throws Exception {
        ...
        apply(new AssignMinQToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(AssignMuToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  mu != null && mu.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Mu already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignMuToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMuFromSynchronousMachineCommand command) throws Exception {
    	...
    	if (  mu == null )
    		throw new ProcessingException( "Mu already has nothing assigned." );  
    ...
    public void handle(AssignQPercentToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  qPercent != null && qPercent.getPerCentId() == command.getAssignment().getPerCentId() )
    		throw new ProcessingException( "QPercent already assigned with id " + command.getAssignment().getPerCentId() );  
    		
        apply(new AssignQPercentToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQPercentFromSynchronousMachineCommand command) throws Exception {
    	...
    	if (  qPercent == null )
    		throw new ProcessingException( "QPercent already has nothing assigned." );  
    ...
    public void handle(AssignRToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  r != null && r.getResistanceId() == command.getAssignment().getResistanceId() )
    		throw new ProcessingException( "R already assigned with id " + command.getAssignment().getResistanceId() );  
    		
        apply(new AssignRToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(AssignR0ToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  r0 != null && r0.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "R0 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignR0ToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(AssignR2ToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  r2 != null && r2.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "R2 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignR2ToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignR2FromSynchronousMachineCommand command) throws Exception {
    	...
    	if (  r2 == null )
    		throw new ProcessingException( "R2 already has nothing assigned." );  
    ...
    public void handle(AssignSatDirectSubtransXToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  satDirectSubtransX != null && satDirectSubtransX.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "SatDirectSubtransX already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignSatDirectSubtransXToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignSatDirectSubtransXFromSynchronousMachineCommand command) throws Exception {
    	...
    	apply(new UnAssignSatDirectSubtransXFromSynchronousMachineEvent(command.getSynchronousMachineId()));
    }
    @CommandHandler
    public void handle(AssignSatDirectSyncXToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  satDirectSyncX != null && satDirectSyncX.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "SatDirectSyncX already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignSatDirectSyncXToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(AssignSatDirectTransXToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  satDirectTransX != null && satDirectTransX.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "SatDirectTransX already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignSatDirectTransXToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignSatDirectTransXFromSynchronousMachineCommand command) throws Exception {
    	...
    	apply(new UnAssignSatDirectTransXFromSynchronousMachineEvent(command.getSynchronousMachineId()));
    }
    @CommandHandler
    public void handle(AssignVoltageRegulationRangeToSynchronousMachineCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignVoltageRegulationRangeToSynchronousMachineCommand" );
    	
    	if (  voltageRegulationRange != null && voltageRegulationRange.getPerCentId() == command.getAssignment().getPerCentId() )
    		throw new ProcessingException( "VoltageRegulationRange already assigned with id " + command.getAssignment().getPerCentId() );  
    		
        apply(new AssignVoltageRegulationRangeToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignVoltageRegulationRangeFromSynchronousMachineCommand command) throws Exception {
    	...
    	apply(new UnAssignVoltageRegulationRangeFromSynchronousMachineEvent(command.getSynchronousMachineId()));
    }
    @CommandHandler
    public void handle(AssignX0ToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  x0 != null && x0.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "X0 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignX0ToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(AssignX2ToSynchronousMachineCommand command) throws Exception {
    	...
    	if (  x2 != null && x2.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "X2 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignX2ToSynchronousMachineEvent(command.getSynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignX2FromSynchronousMachineCommand command) throws Exception {
    	...
    	if (  x2 == null )
    		throw new ProcessingException( "X2 already has nothing assigned." );  
