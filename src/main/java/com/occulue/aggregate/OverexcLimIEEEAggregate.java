...
public class OverexcLimIEEEAggregate {  
    ...
    public void handle(UpdateOverexcLimIEEECommand command) throws Exception {
    	...
    	UpdateOverexcLimIEEEEvent event = new UpdateOverexcLimIEEEEvent(command.getOverexcLimIEEEId(), command.Hyst(), command.Ifdlim(), command.Ifdmax(), command.Itfpu(), command.Kcd(), command.Kramp());        
    ...
    public void handle(AssignHystToOverexcLimIEEECommand command) throws Exception {
    	...
    	if (  hyst != null && hyst.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Hyst already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignHystToOverexcLimIEEEEvent(command.getOverexcLimIEEEId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignHystFromOverexcLimIEEECommand command) throws Exception {
    	...
    	if (  hyst == null )
    		throw new ProcessingException( "Hyst already has nothing assigned." );  
    ...
    public void handle(AssignIfdlimToOverexcLimIEEECommand command) throws Exception {
    	...
    	if (  ifdlim != null && ifdlim.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Ifdlim already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignIfdlimToOverexcLimIEEEEvent(command.getOverexcLimIEEEId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignIfdlimFromOverexcLimIEEECommand command) throws Exception {
    	...
    	if (  ifdlim == null )
    		throw new ProcessingException( "Ifdlim already has nothing assigned." );  
    ...
    public void handle(AssignIfdmaxToOverexcLimIEEECommand command) throws Exception {
    	...
    	if (  ifdmax != null && ifdmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Ifdmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignIfdmaxToOverexcLimIEEEEvent(command.getOverexcLimIEEEId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignIfdmaxFromOverexcLimIEEECommand command) throws Exception {
    	...
    	if (  ifdmax == null )
    		throw new ProcessingException( "Ifdmax already has nothing assigned." );  
    ...
    public void handle(AssignItfpuToOverexcLimIEEECommand command) throws Exception {
    	...
    	if (  itfpu != null && itfpu.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Itfpu already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignItfpuToOverexcLimIEEEEvent(command.getOverexcLimIEEEId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignItfpuFromOverexcLimIEEECommand command) throws Exception {
    	...
    	if (  itfpu == null )
    		throw new ProcessingException( "Itfpu already has nothing assigned." );  
    ...
    public void handle(AssignKcdToOverexcLimIEEECommand command) throws Exception {
    	...
    	if (  kcd != null && kcd.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kcd already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKcdToOverexcLimIEEEEvent(command.getOverexcLimIEEEId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKcdFromOverexcLimIEEECommand command) throws Exception {
    	...
    	if (  kcd == null )
    		throw new ProcessingException( "Kcd already has nothing assigned." );  
    ...
    public void handle(AssignKrampToOverexcLimIEEECommand command) throws Exception {
    	...
    	if (  kramp != null && kramp.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Kramp already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignKrampToOverexcLimIEEEEvent(command.getOverexcLimIEEEId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKrampFromOverexcLimIEEECommand command) throws Exception {
    	...
    	if (  kramp == null )
    		throw new ProcessingException( "Kramp already has nothing assigned." );  
