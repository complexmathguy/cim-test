...
public class ReactivePowerAggregate {  
    ...
    public ReactivePowerAggregate(CreateReactivePowerCommand command) throws Exception {
    	...
    	CreateReactivePowerEvent event = new CreateReactivePowerEvent(command.getReactivePowerId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateReactivePowerCommand command) throws Exception {
    	...
    	UpdateReactivePowerEvent event = new UpdateReactivePowerEvent(command.getReactivePowerId(), command.Multiplier(), command.Unit(), command.Value());        
    ...
    public void handle(AssignValueToReactivePowerCommand command) throws Exception {
        ...
        apply(new AssignValueToReactivePowerEvent(command.getReactivePowerId(), command.getAssignment()));
    }
