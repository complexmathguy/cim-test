...
public class DiscExcContIEEEDEC2AAggregate {  
    ...
    public DiscExcContIEEEDEC2AAggregate(CreateDiscExcContIEEEDEC2ACommand command) throws Exception {
    	...
    	CreateDiscExcContIEEEDEC2AEvent event = new CreateDiscExcContIEEEDEC2AEvent(command.getDiscExcContIEEEDEC2AId());
    ...
    public void handle(UpdateDiscExcContIEEEDEC2ACommand command) throws Exception {
    	...
    	UpdateDiscExcContIEEEDEC2AEvent event = new UpdateDiscExcContIEEEDEC2AEvent(command.getDiscExcContIEEEDEC2AId(), command.Td1(), command.Td2(), command.Vdmax(), command.Vdmin(), command.Vk());        
    ...
    public void handle(AssignTd1ToDiscExcContIEEEDEC2ACommand command) throws Exception {
    	...
    	if (  td1 != null && td1.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Td1 already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTd1ToDiscExcContIEEEDEC2AEvent(command.getDiscExcContIEEEDEC2AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTd1FromDiscExcContIEEEDEC2ACommand command) throws Exception {
    	...
    	if (  td1 == null )
    		throw new ProcessingException( "Td1 already has nothing assigned." );  
    ...
    public void handle(AssignTd2ToDiscExcContIEEEDEC2ACommand command) throws Exception {
    	...
    	if (  td2 != null && td2.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Td2 already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTd2ToDiscExcContIEEEDEC2AEvent(command.getDiscExcContIEEEDEC2AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTd2FromDiscExcContIEEEDEC2ACommand command) throws Exception {
    	...
    	if (  td2 == null )
    		throw new ProcessingException( "Td2 already has nothing assigned." );  
    ...
    public void handle(AssignVdmaxToDiscExcContIEEEDEC2ACommand command) throws Exception {
    	...
    	if (  vdmax != null && vdmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vdmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVdmaxToDiscExcContIEEEDEC2AEvent(command.getDiscExcContIEEEDEC2AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVdmaxFromDiscExcContIEEEDEC2ACommand command) throws Exception {
    	...
    	if (  vdmax == null )
    		throw new ProcessingException( "Vdmax already has nothing assigned." );  
    ...
    public void handle(AssignVdminToDiscExcContIEEEDEC2ACommand command) throws Exception {
    	...
    	if (  vdmin != null && vdmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vdmin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVdminToDiscExcContIEEEDEC2AEvent(command.getDiscExcContIEEEDEC2AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVdminFromDiscExcContIEEEDEC2ACommand command) throws Exception {
    	...
    	if (  vdmin == null )
    		throw new ProcessingException( "Vdmin already has nothing assigned." );  
    ...
    public void handle(AssignVkToDiscExcContIEEEDEC2ACommand command) throws Exception {
    	...
    	if (  vk != null && vk.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vk already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVkToDiscExcContIEEEDEC2AEvent(command.getDiscExcContIEEEDEC2AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVkFromDiscExcContIEEEDEC2ACommand command) throws Exception {
    	...
    	if (  vk == null )
    		throw new ProcessingException( "Vk already has nothing assigned." );  
