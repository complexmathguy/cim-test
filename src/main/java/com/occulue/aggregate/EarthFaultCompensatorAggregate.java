...
public class EarthFaultCompensatorAggregate {  
    ...
    public EarthFaultCompensatorAggregate(CreateEarthFaultCompensatorCommand command) throws Exception {
    	...
    	CreateEarthFaultCompensatorEvent event = new CreateEarthFaultCompensatorEvent(command.getEarthFaultCompensatorId());
    ...
    public void handle(UpdateEarthFaultCompensatorCommand command) throws Exception {
    	...
    	UpdateEarthFaultCompensatorEvent event = new UpdateEarthFaultCompensatorEvent(command.getEarthFaultCompensatorId(), command.R());        
    ...
    public void handle(AssignRToEarthFaultCompensatorCommand command) throws Exception {
        ...
        apply(new AssignRToEarthFaultCompensatorEvent(command.getEarthFaultCompensatorId(), command.getAssignment()));
    }
