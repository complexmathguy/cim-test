...
public class EquivalentInjectionAggregate {  
    ...
    public EquivalentInjectionAggregate(CreateEquivalentInjectionCommand command) throws Exception {
    	...
    	CreateEquivalentInjectionEvent event = new CreateEquivalentInjectionEvent(command.getEquivalentInjectionId());
    ...
    public void handle(UpdateEquivalentInjectionCommand command) throws Exception {
    	...
    	UpdateEquivalentInjectionEvent event = new UpdateEquivalentInjectionEvent(command.getEquivalentInjectionId(), command.MaxP(), command.MaxQ(), command.MinP(), command.MinQ(), command.R(), command.R0(), command.R2(), command.RegulationCapability(), command.X(), command.X0(), command.X2());        
    ...
    public void handle(AssignMaxPToEquivalentInjectionCommand command) throws Exception {
        ...
        apply(new AssignMaxPToEquivalentInjectionEvent(command.getEquivalentInjectionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignMaxQToEquivalentInjectionCommand command) throws Exception {
        ...
        apply(new AssignMaxQToEquivalentInjectionEvent(command.getEquivalentInjectionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignMinPToEquivalentInjectionCommand command) throws Exception {
        ...
        apply(new AssignMinPToEquivalentInjectionEvent(command.getEquivalentInjectionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignMinQToEquivalentInjectionCommand command) throws Exception {
        ...
        apply(new AssignMinQToEquivalentInjectionEvent(command.getEquivalentInjectionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRToEquivalentInjectionCommand command) throws Exception {
        ...
        apply(new AssignRToEquivalentInjectionEvent(command.getEquivalentInjectionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignR0ToEquivalentInjectionCommand command) throws Exception {
        ...
        apply(new AssignR0ToEquivalentInjectionEvent(command.getEquivalentInjectionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignR2ToEquivalentInjectionCommand command) throws Exception {
    	...
    	if (  r2 != null && r2.getResistanceId() == command.getAssignment().getResistanceId() )
    		throw new ProcessingException( "R2 already assigned with id " + command.getAssignment().getResistanceId() );  
    		
        apply(new AssignR2ToEquivalentInjectionEvent(command.getEquivalentInjectionId(), command.getAssignment()));
    }
    ...
    @CommandHandler
    public void handle(AssignRegulationCapabilityToEquivalentInjectionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignRegulationCapabilityToEquivalentInjectionCommand" );
    	
    	if (  regulationCapability != null && regulationCapability.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "RegulationCapability already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignRegulationCapabilityToEquivalentInjectionEvent(command.getEquivalentInjectionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignRegulationCapabilityFromEquivalentInjectionCommand command) throws Exception {
    	...
    	apply(new UnAssignRegulationCapabilityFromEquivalentInjectionEvent(command.getEquivalentInjectionId()));
    }
    @CommandHandler
    public void handle(AssignXToEquivalentInjectionCommand command) throws Exception {
        ...
        apply(new AssignXToEquivalentInjectionEvent(command.getEquivalentInjectionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignX0ToEquivalentInjectionCommand command) throws Exception {
        ...
        apply(new AssignX0ToEquivalentInjectionEvent(command.getEquivalentInjectionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignX2ToEquivalentInjectionCommand command) throws Exception {
    	...
    	if (  x2 != null && x2.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "X2 already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignX2ToEquivalentInjectionEvent(command.getEquivalentInjectionId(), command.getAssignment()));
    }
