...
public class MonthDayIntervalAggregate {  
    ...
    public MonthDayIntervalAggregate(CreateMonthDayIntervalCommand command) throws Exception {
    	...
    	CreateMonthDayIntervalEvent event = new CreateMonthDayIntervalEvent(command.getMonthDayIntervalId());
    ...
    public void handle(UpdateMonthDayIntervalCommand command) throws Exception {
    	...
    	UpdateMonthDayIntervalEvent event = new UpdateMonthDayIntervalEvent(command.getMonthDayIntervalId(), command.End(), command.Start());        
    ...
    public void handle(AssignEndToMonthDayIntervalCommand command) throws Exception {
    	...
    	if (  end != null && end.getMonthDayId() == command.getAssignment().getMonthDayId() )
    		throw new ProcessingException( "End already assigned with id " + command.getAssignment().getMonthDayId() );  
    		
        apply(new AssignEndToMonthDayIntervalEvent(command.getMonthDayIntervalId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEndFromMonthDayIntervalCommand command) throws Exception {
    	...
    	if (  end == null )
    		throw new ProcessingException( "End already has nothing assigned." );  
    ...
    public void handle(AssignStartToMonthDayIntervalCommand command) throws Exception {
    	...
    	if (  start != null && start.getMonthDayId() == command.getAssignment().getMonthDayId() )
    		throw new ProcessingException( "Start already assigned with id " + command.getAssignment().getMonthDayId() );  
    		
        apply(new AssignStartToMonthDayIntervalEvent(command.getMonthDayIntervalId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignStartFromMonthDayIntervalCommand command) throws Exception {
    	...
    	if (  start == null )
    		throw new ProcessingException( "Start already has nothing assigned." );  
