...
public class GovGASTAggregate {  
    ...
    public void handle(UpdateGovGASTCommand command) throws Exception {
    	...
    	UpdateGovGASTEvent event = new UpdateGovGASTEvent(command.getGovGASTId(), command.At(), command.Dturb(), command.Kt(), command.Mwbase(), command.R(), command.T1(), command.T2(), command.T3(), command.Vmax(), command.Vmin());        
