...
public class AsynchronousMachineUserDefinedAggregate {  
    ...
    public AsynchronousMachineUserDefinedAggregate(CreateAsynchronousMachineUserDefinedCommand command) throws Exception {
    	...
    	CreateAsynchronousMachineUserDefinedEvent event = new CreateAsynchronousMachineUserDefinedEvent(command.getAsynchronousMachineUserDefinedId());
    ...
    public void handle(UpdateAsynchronousMachineUserDefinedCommand command) throws Exception {
    	...
    	UpdateAsynchronousMachineUserDefinedEvent event = new UpdateAsynchronousMachineUserDefinedEvent(command.getAsynchronousMachineUserDefinedId(), command.Proprietary());        
    ...
    @CommandHandler
    public void handle(AssignProprietaryToAsynchronousMachineUserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToAsynchronousMachineUserDefinedEvent(command.getAsynchronousMachineUserDefinedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignProprietaryFromAsynchronousMachineUserDefinedCommand command) throws Exception {
    	...
    	apply(new UnAssignProprietaryFromAsynchronousMachineUserDefinedEvent(command.getAsynchronousMachineUserDefinedId()));
    }
