...
public class ExcAVR7Aggregate {  
    ...
    public void handle(UpdateExcAVR7Command command) throws Exception {
    	...
    	UpdateExcAVR7Event event = new UpdateExcAVR7Event(command.getExcAVR7Id(), command.A1(), command.A2(), command.A3(), command.A4(), command.A5(), command.A6(), command.K1(), command.K3(), command.K5(), command.T1(), command.T2(), command.T3(), command.T4(), command.T5(), command.T6(), command.Vmax1(), command.Vmax3(), command.Vmax5(), command.Vmin1(), command.Vmin3(), command.Vmin5());        
    ...
    public void handle(AssignVmax1ToExcAVR7Command command) throws Exception {
    	...
    	if (  vmax1 != null && vmax1.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vmax1 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignVmax1FromExcAVR7Command command) throws Exception {
    	...
    	if (  vmax1 == null )
    		throw new ProcessingException( "Vmax1 already has nothing assigned." );  
    ...
    public void handle(AssignVmax3ToExcAVR7Command command) throws Exception {
    	...
    	if (  vmax3 != null && vmax3.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vmax3 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignVmax3FromExcAVR7Command command) throws Exception {
    	...
    	if (  vmax3 == null )
    		throw new ProcessingException( "Vmax3 already has nothing assigned." );  
    ...
    public void handle(AssignVmax5ToExcAVR7Command command) throws Exception {
    	...
    	if (  vmax5 != null && vmax5.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vmax5 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignVmax5FromExcAVR7Command command) throws Exception {
    	...
    	if (  vmax5 == null )
    		throw new ProcessingException( "Vmax5 already has nothing assigned." );  
    ...
    public void handle(AssignVmin1ToExcAVR7Command command) throws Exception {
    	...
    	if (  vmin1 != null && vmin1.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vmin1 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignVmin1FromExcAVR7Command command) throws Exception {
    	...
    	if (  vmin1 == null )
    		throw new ProcessingException( "Vmin1 already has nothing assigned." );  
    ...
    public void handle(AssignVmin3ToExcAVR7Command command) throws Exception {
    	...
    	if (  vmin3 != null && vmin3.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vmin3 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignVmin3FromExcAVR7Command command) throws Exception {
    	...
    	if (  vmin3 == null )
    		throw new ProcessingException( "Vmin3 already has nothing assigned." );  
    ...
    public void handle(AssignVmin5ToExcAVR7Command command) throws Exception {
    	...
    	if (  vmin5 != null && vmin5.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vmin5 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignVmin5FromExcAVR7Command command) throws Exception {
    	...
    	if (  vmin5 == null )
    		throw new ProcessingException( "Vmin5 already has nothing assigned." );  
