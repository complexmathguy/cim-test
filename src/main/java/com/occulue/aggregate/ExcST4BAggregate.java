...
public class ExcST4BAggregate {  
    ...
    public void handle(UpdateExcST4BCommand command) throws Exception {
    	...
    	UpdateExcST4BEvent event = new UpdateExcST4BEvent(command.getExcST4BId(), command.Kc(), command.Kg(), command.Ki(), command.Kim(), command.Kir(), command.Kp(), command.Kpm(), command.Kpr(), command.Lvgate(), command.Ta(), command.Thetap(), command.Uel(), command.Vbmax(), command.Vgmax(), command.Vmmax(), command.Vmmin(), command.Vrmax(), command.Vrmin(), command.Xl());        
    ...
    public void handle(AssignKimToExcST4BCommand command) throws Exception {
    	...
    	if (  kim != null && kim.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kim already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignKimFromExcST4BCommand command) throws Exception {
    	...
    	if (  kim == null )
    		throw new ProcessingException( "Kim already has nothing assigned." );  
    ...
    public void handle(AssignKpmToExcST4BCommand command) throws Exception {
    	...
    	if (  kpm != null && kpm.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kpm already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignKpmFromExcST4BCommand command) throws Exception {
    	...
    	if (  kpm == null )
    		throw new ProcessingException( "Kpm already has nothing assigned." );  
    ...
    public void handle(AssignUelToExcST4BCommand command) throws Exception {
    	...
    	if (  uel != null && uel.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Uel already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(UnAssignUelFromExcST4BCommand command) throws Exception {
    	...
    	if (  uel == null )
    		throw new ProcessingException( "Uel already has nothing assigned." );  
