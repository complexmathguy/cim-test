...
public class EquipmentVersionAggregate {  
    ...
    public EquipmentVersionAggregate(CreateEquipmentVersionCommand command) throws Exception {
    	...
    	CreateEquipmentVersionEvent event = new CreateEquipmentVersionEvent(command.getEquipmentVersionId());
    ...
    public void handle(UpdateEquipmentVersionCommand command) throws Exception {
    	...
    	UpdateEquipmentVersionEvent event = new UpdateEquipmentVersionEvent(command.getEquipmentVersionId(), command.BaseUML(), command.BaseURIcore(), command.BaseURIoperation(), command.BaseURIshortCircuit(), command.Date(), command.DifferenceModelURI(), command.EntsoeUML(), command.EntsoeURIcore(), command.EntsoeURIoperation(), command.EntsoeURIshortCircuit(), command.ModelDescriptionURI(), command.NamespaceRDF(), command.NamespaceUML(), command.ShortName());        
    ...
    public void handle(AssignBaseUMLToEquipmentVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseUMLToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignBaseURIcoreToEquipmentVersionCommand command) throws Exception {
    	...
    	if (  baseURIcore != null && baseURIcore.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "BaseURIcore already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignBaseURIcoreToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignBaseURIoperationToEquipmentVersionCommand command) throws Exception {
    	...
    	if (  baseURIoperation != null && baseURIoperation.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "BaseURIoperation already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignBaseURIoperationToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignBaseURIshortCircuitToEquipmentVersionCommand command) throws Exception {
    	...
    	if (  baseURIshortCircuit != null && baseURIshortCircuit.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "BaseURIshortCircuit already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignBaseURIshortCircuitToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignBaseURIshortCircuitFromEquipmentVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignBaseURIshortCircuitFromEquipmentVersionEvent(command.getEquipmentVersionId()));
    }
    @CommandHandler
    public void handle(AssignDateToEquipmentVersionCommand command) throws Exception {
        ...
        apply(new AssignDateToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignDifferenceModelURIToEquipmentVersionCommand command) throws Exception {
        ...
        apply(new AssignDifferenceModelURIToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignDifferenceModelURIFromEquipmentVersionCommand command) throws Exception {
    ...
    public void handle(AssignEntsoeUMLToEquipmentVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeUMLToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignEntsoeURIcoreToEquipmentVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeURIcoreToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignEntsoeURIoperationToEquipmentVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeURIoperationToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEntsoeURIoperationFromEquipmentVersionCommand command) throws Exception {
    ...
    @CommandHandler
    public void handle(AssignEntsoeURIshortCircuitToEquipmentVersionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignEntsoeURIshortCircuitToEquipmentVersionCommand" );
    	
    	if (  entsoeURIshortCircuit != null && entsoeURIshortCircuit.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "EntsoeURIshortCircuit already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignEntsoeURIshortCircuitToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEntsoeURIshortCircuitFromEquipmentVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignEntsoeURIshortCircuitFromEquipmentVersionEvent(command.getEquipmentVersionId()));
    }
    @CommandHandler
    public void handle(AssignModelDescriptionURIToEquipmentVersionCommand command) throws Exception {
        ...
        apply(new AssignModelDescriptionURIToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignModelDescriptionURIFromEquipmentVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignModelDescriptionURIFromEquipmentVersionEvent(command.getEquipmentVersionId()));
    }
    @CommandHandler
    public void handle(AssignNamespaceRDFToEquipmentVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceRDFToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignNamespaceUMLToEquipmentVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceUMLToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignShortNameToEquipmentVersionCommand command) throws Exception {
        ...
        apply(new AssignShortNameToEquipmentVersionEvent(command.getEquipmentVersionId(), command.getAssignment()));
    }
