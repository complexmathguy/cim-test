...
public class PFVArControllerType1UserDefinedAggregate {  
    ...
    public PFVArControllerType1UserDefinedAggregate(CreatePFVArControllerType1UserDefinedCommand command) throws Exception {
    	...
    	CreatePFVArControllerType1UserDefinedEvent event = new CreatePFVArControllerType1UserDefinedEvent(command.getPFVArControllerType1UserDefinedId());
    ...
    public void handle(UpdatePFVArControllerType1UserDefinedCommand command) throws Exception {
    	...
    	UpdatePFVArControllerType1UserDefinedEvent event = new UpdatePFVArControllerType1UserDefinedEvent(command.getPFVArControllerType1UserDefinedId(), command.Proprietary());        
    ...
    @CommandHandler
    public void handle(AssignProprietaryToPFVArControllerType1UserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToPFVArControllerType1UserDefinedEvent(command.getPFVArControllerType1UserDefinedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignProprietaryFromPFVArControllerType1UserDefinedCommand command) throws Exception {
    	...
    	apply(new UnAssignProprietaryFromPFVArControllerType1UserDefinedEvent(command.getPFVArControllerType1UserDefinedId()));
    }
