...
public class VCompIEEEType1Aggregate {  
    ...
    public void handle(UpdateVCompIEEEType1Command command) throws Exception {
    	...
    	UpdateVCompIEEEType1Event event = new UpdateVCompIEEEType1Event(command.getVCompIEEEType1Id(), command.Rc(), command.Tr(), command.Xc());        
    ...
    public void handle(AssignRcToVCompIEEEType1Command command) throws Exception {
    	...
    	if (  rc != null && rc.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Rc already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignRcToVCompIEEEType1Event(command.getVCompIEEEType1Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignRcFromVCompIEEEType1Command command) throws Exception {
    	...
    	if (  rc == null )
    		throw new ProcessingException( "Rc already has nothing assigned." );  
    ...
    public void handle(AssignTrToVCompIEEEType1Command command) throws Exception {
        ...
        apply(new AssignTrToVCompIEEEType1Event(command.getVCompIEEEType1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignXcToVCompIEEEType1Command command) throws Exception {
        ...
        apply(new AssignXcToVCompIEEEType1Event(command.getVCompIEEEType1Id(), command.getAssignment()));
    }
