...
public class TopologyBoundaryVersionAggregate {  
    ...
    public TopologyBoundaryVersionAggregate(CreateTopologyBoundaryVersionCommand command) throws Exception {
    	...
    	CreateTopologyBoundaryVersionEvent event = new CreateTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId());
    ...
    public void handle(UpdateTopologyBoundaryVersionCommand command) throws Exception {
    	...
    	UpdateTopologyBoundaryVersionEvent event = new UpdateTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId(), command.BaseUML(), command.BaseURI(), command.Date(), command.DifferenceModelURI(), command.EntsoeUML(), command.EntsoeURI(), command.ModelDescriptionURI(), command.NamespaceRDF(), command.NamespaceUML(), command.ShortName());        
    ...
    public void handle(AssignBaseUMLToTopologyBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseUMLToTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignBaseUMLFromTopologyBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignBaseUMLFromTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignBaseURIToTopologyBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseURIToTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignBaseURIFromTopologyBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignBaseURIFromTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignDateToTopologyBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignDateToTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId(), command.getAssignment()));
    }
    ...
    @CommandHandler
    public void handle(AssignDifferenceModelURIToTopologyBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignDifferenceModelURIToTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignDifferenceModelURIFromTopologyBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignDifferenceModelURIFromTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignEntsoeUMLToTopologyBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeUMLToTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEntsoeUMLFromTopologyBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignEntsoeUMLFromTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignEntsoeURIToTopologyBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeURIToTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEntsoeURIFromTopologyBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignEntsoeURIFromTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignModelDescriptionURIToTopologyBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignModelDescriptionURIToTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignModelDescriptionURIFromTopologyBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignModelDescriptionURIFromTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignNamespaceRDFToTopologyBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceRDFToTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignNamespaceRDFFromTopologyBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignNamespaceRDFFromTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignNamespaceUMLToTopologyBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceUMLToTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignNamespaceUMLFromTopologyBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignNamespaceUMLFromTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignShortNameToTopologyBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignShortNameToTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignShortNameFromTopologyBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignShortNameFromTopologyBoundaryVersionEvent(command.getTopologyBoundaryVersionId()));
    }
