...
public class GovSteam0Aggregate {  
    ...
    public void handle(UpdateGovSteam0Command command) throws Exception {
    	...
    	UpdateGovSteam0Event event = new UpdateGovSteam0Event(command.getGovSteam0Id(), command.Dt(), command.Mwbase(), command.R(), command.T1(), command.T2(), command.T3(), command.Vmax(), command.Vmin());        
