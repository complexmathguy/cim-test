...
public class PositionPointAggregate {  
    ...
    public void handle(UpdatePositionPointCommand command) throws Exception {
    	...
    	UpdatePositionPointEvent event = new UpdatePositionPointEvent(command.getPositionPointId(), command.SequenceNumber(), command.XPosition(), command.YPosition(), command.ZPosition());        
    ...
    public void handle(AssignSequenceNumberToPositionPointCommand command) throws Exception {
        ...
        apply(new AssignSequenceNumberToPositionPointEvent(command.getPositionPointId(), command.getAssignment()));
    }
    ...
    public void handle(AssignXPositionToPositionPointCommand command) throws Exception {
    	...
    	if (  xPosition != null && xPosition.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "XPosition already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignXPositionToPositionPointEvent(command.getPositionPointId(), command.getAssignment()));
    }
    ...
    public void handle(AssignYPositionToPositionPointCommand command) throws Exception {
    	...
    	if (  yPosition != null && yPosition.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "YPosition already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignYPositionToPositionPointEvent(command.getPositionPointId(), command.getAssignment()));
    }
    ...
    public void handle(AssignZPositionToPositionPointCommand command) throws Exception {
    	...
    	if (  zPosition != null && zPosition.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "ZPosition already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignZPositionToPositionPointEvent(command.getPositionPointId(), command.getAssignment()));
    }
