...
public class LoadCompositeAggregate {  
    ...
    public void handle(UpdateLoadCompositeCommand command) throws Exception {
    	...
    	UpdateLoadCompositeEvent event = new UpdateLoadCompositeEvent(command.getLoadCompositeId(), command.Epfd(), command.Epfs(), command.Epvd(), command.Epvs(), command.Eqfd(), command.Eqfs(), command.Eqvd(), command.Eqvs(), command.H(), command.Lfrac(), command.Pfrac());        
    ...
    public void handle(AssignEpfdToLoadCompositeCommand command) throws Exception {
    	...
    	if (  epfd != null && epfd.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Epfd already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignEpfdToLoadCompositeEvent(command.getLoadCompositeId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEpfdFromLoadCompositeCommand command) throws Exception {
    	...
    	if (  epfd == null )
    		throw new ProcessingException( "Epfd already has nothing assigned." );  
    ...
    public void handle(AssignEpfsToLoadCompositeCommand command) throws Exception {
    	...
    	if (  epfs != null && epfs.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Epfs already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignEpfsToLoadCompositeEvent(command.getLoadCompositeId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEpfsFromLoadCompositeCommand command) throws Exception {
    	...
    	if (  epfs == null )
    		throw new ProcessingException( "Epfs already has nothing assigned." );  
    ...
    public void handle(AssignEpvdToLoadCompositeCommand command) throws Exception {
    	...
    	if (  epvd != null && epvd.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Epvd already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignEpvdToLoadCompositeEvent(command.getLoadCompositeId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEpvdFromLoadCompositeCommand command) throws Exception {
    	...
    	if (  epvd == null )
    		throw new ProcessingException( "Epvd already has nothing assigned." );  
    ...
    public void handle(AssignEpvsToLoadCompositeCommand command) throws Exception {
    	...
    	if (  epvs != null && epvs.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Epvs already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignEpvsToLoadCompositeEvent(command.getLoadCompositeId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEpvsFromLoadCompositeCommand command) throws Exception {
    	...
    	if (  epvs == null )
    		throw new ProcessingException( "Epvs already has nothing assigned." );  
    ...
    public void handle(AssignEqfdToLoadCompositeCommand command) throws Exception {
    	...
    	if (  eqfd != null && eqfd.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Eqfd already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignEqfdToLoadCompositeEvent(command.getLoadCompositeId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEqfdFromLoadCompositeCommand command) throws Exception {
    	...
    	if (  eqfd == null )
    		throw new ProcessingException( "Eqfd already has nothing assigned." );  
    ...
    public void handle(AssignEqfsToLoadCompositeCommand command) throws Exception {
    	...
    	if (  eqfs != null && eqfs.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Eqfs already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignEqfsToLoadCompositeEvent(command.getLoadCompositeId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEqfsFromLoadCompositeCommand command) throws Exception {
    	...
    	if (  eqfs == null )
    		throw new ProcessingException( "Eqfs already has nothing assigned." );  
    ...
    public void handle(AssignEqvdToLoadCompositeCommand command) throws Exception {
    	...
    	if (  eqvd != null && eqvd.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Eqvd already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignEqvdToLoadCompositeEvent(command.getLoadCompositeId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEqvdFromLoadCompositeCommand command) throws Exception {
    	...
    	if (  eqvd == null )
    		throw new ProcessingException( "Eqvd already has nothing assigned." );  
    ...
    public void handle(AssignEqvsToLoadCompositeCommand command) throws Exception {
    	...
    	if (  eqvs != null && eqvs.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Eqvs already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignEqvsToLoadCompositeEvent(command.getLoadCompositeId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEqvsFromLoadCompositeCommand command) throws Exception {
    	...
    	if (  eqvs == null )
    		throw new ProcessingException( "Eqvs already has nothing assigned." );  
    ...
    public void handle(AssignHToLoadCompositeCommand command) throws Exception {
    	...
    	if (  h != null && h.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "H already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(UnAssignHFromLoadCompositeCommand command) throws Exception {
    	...
    	if (  h == null )
    		throw new ProcessingException( "H already has nothing assigned." );  
    ...
    public void handle(AssignLfracToLoadCompositeCommand command) throws Exception {
    	...
    	if (  lfrac != null && lfrac.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Lfrac already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignLfracToLoadCompositeEvent(command.getLoadCompositeId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignLfracFromLoadCompositeCommand command) throws Exception {
    	...
    	if (  lfrac == null )
    		throw new ProcessingException( "Lfrac already has nothing assigned." );  
    ...
    public void handle(AssignPfracToLoadCompositeCommand command) throws Exception {
    	...
    	if (  pfrac != null && pfrac.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Pfrac already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignPfracToLoadCompositeEvent(command.getLoadCompositeId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignPfracFromLoadCompositeCommand command) throws Exception {
    	...
    	if (  pfrac == null )
    		throw new ProcessingException( "Pfrac already has nothing assigned." );  
