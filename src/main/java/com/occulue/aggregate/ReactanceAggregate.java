...
public class ReactanceAggregate {  
    ...
    public ReactanceAggregate(CreateReactanceCommand command) throws Exception {
    	...
    	CreateReactanceEvent event = new CreateReactanceEvent(command.getReactanceId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateReactanceCommand command) throws Exception {
    	...
    	UpdateReactanceEvent event = new UpdateReactanceEvent(command.getReactanceId(), command.Multiplier(), command.Unit(), command.Value());        
