...
public class UnderexcLimIEEE1Aggregate {  
    ...
    public UnderexcLimIEEE1Aggregate(CreateUnderexcLimIEEE1Command command) throws Exception {
    	...
    	CreateUnderexcLimIEEE1Event event = new CreateUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id());
    ...
    public void handle(UpdateUnderexcLimIEEE1Command command) throws Exception {
    	...
    	UpdateUnderexcLimIEEE1Event event = new UpdateUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.Kuc(), command.Kuf(), command.Kui(), command.Kul(), command.Kur(), command.Tu1(), command.Tu2(), command.Tu3(), command.Tu4(), command.Vucmax(), command.Vuimax(), command.Vuimin(), command.Vulmax(), command.Vulmin(), command.Vurmax());        
    ...
    public void handle(AssignKucToUnderexcLimIEEE1Command command) throws Exception {
    	...
    	if (  kuc != null && kuc.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kuc already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKucToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKucFromUnderexcLimIEEE1Command command) throws Exception {
    	...
    	if (  kuc == null )
    		throw new ProcessingException( "Kuc already has nothing assigned." );  
    ...
    public void handle(AssignKufToUnderexcLimIEEE1Command command) throws Exception {
        ...
        apply(new AssignKufToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignKuiToUnderexcLimIEEE1Command command) throws Exception {
        ...
        apply(new AssignKuiToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignKulToUnderexcLimIEEE1Command command) throws Exception {
        ...
        apply(new AssignKulToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignKurToUnderexcLimIEEE1Command command) throws Exception {
    	...
    	if (  kur != null && kur.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kur already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKurToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKurFromUnderexcLimIEEE1Command command) throws Exception {
    	...
    	if (  kur == null )
    		throw new ProcessingException( "Kur already has nothing assigned." );  
    ...
    public void handle(AssignTu1ToUnderexcLimIEEE1Command command) throws Exception {
        ...
        apply(new AssignTu1ToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignTu2ToUnderexcLimIEEE1Command command) throws Exception {
        ...
        apply(new AssignTu2ToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignTu3ToUnderexcLimIEEE1Command command) throws Exception {
        ...
        apply(new AssignTu3ToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignTu4ToUnderexcLimIEEE1Command command) throws Exception {
        ...
        apply(new AssignTu4ToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignVucmaxToUnderexcLimIEEE1Command command) throws Exception {
    	...
    	if (  vucmax != null && vucmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vucmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVucmaxToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVucmaxFromUnderexcLimIEEE1Command command) throws Exception {
    	...
    	if (  vucmax == null )
    		throw new ProcessingException( "Vucmax already has nothing assigned." );  
    ...
    public void handle(AssignVuimaxToUnderexcLimIEEE1Command command) throws Exception {
        ...
        apply(new AssignVuimaxToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignVuiminToUnderexcLimIEEE1Command command) throws Exception {
        ...
        apply(new AssignVuiminToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignVulmaxToUnderexcLimIEEE1Command command) throws Exception {
        ...
        apply(new AssignVulmaxToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignVulminToUnderexcLimIEEE1Command command) throws Exception {
        ...
        apply(new AssignVulminToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignVurmaxToUnderexcLimIEEE1Command command) throws Exception {
    	...
    	if (  vurmax != null && vurmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vurmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVurmaxToUnderexcLimIEEE1Event(command.getUnderexcLimIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVurmaxFromUnderexcLimIEEE1Command command) throws Exception {
    	...
    	if (  vurmax == null )
    		throw new ProcessingException( "Vurmax already has nothing assigned." );  
