...
public class GeographicalLocationVersionAggregate {  
    ...
    public GeographicalLocationVersionAggregate(CreateGeographicalLocationVersionCommand command) throws Exception {
    	...
    	CreateGeographicalLocationVersionEvent event = new CreateGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId());
    ...
    public void handle(AssignBaseUMLToGeographicalLocationVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseUMLToGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignBaseUMLFromGeographicalLocationVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignBaseUMLFromGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId()));
    }
    @CommandHandler
    public void handle(AssignBaseURIToGeographicalLocationVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseURIToGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignBaseURIFromGeographicalLocationVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignBaseURIFromGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId()));
    }
    @CommandHandler
    public void handle(AssignDateToGeographicalLocationVersionCommand command) throws Exception {
        ...
        apply(new AssignDateToGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDateFromGeographicalLocationVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignDateFromGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId()));
    }
    @CommandHandler
    public void handle(AssignDifferenceModelURIToGeographicalLocationVersionCommand command) throws Exception {
        ...
        apply(new AssignDifferenceModelURIToGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignDifferenceModelURIFromGeographicalLocationVersionCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignDifferenceModelURIFromGeographicalLocationVersionCommand" );

    	if (  differenceModelURI == null )
    		throw new ProcessingException( "DifferenceModelURI already has nothing assigned." );  

    	apply(new UnAssignDifferenceModelURIFromGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId()));
    }
    @CommandHandler
    public void handle(AssignEntsoeUMLToGeographicalLocationVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeUMLToGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEntsoeUMLFromGeographicalLocationVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignEntsoeUMLFromGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId()));
    }
    @CommandHandler
    public void handle(AssignEntsoeURIToGeographicalLocationVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeURIToGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEntsoeURIFromGeographicalLocationVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignEntsoeURIFromGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId()));
    }
    @CommandHandler
    public void handle(AssignModelDescriptionURIToGeographicalLocationVersionCommand command) throws Exception {
        ...
        apply(new AssignModelDescriptionURIToGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignModelDescriptionURIFromGeographicalLocationVersionCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignModelDescriptionURIFromGeographicalLocationVersionCommand" );

    	if (  modelDescriptionURI == null )
    		throw new ProcessingException( "ModelDescriptionURI already has nothing assigned." );  

    	apply(new UnAssignModelDescriptionURIFromGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId()));
    }
    @CommandHandler
    public void handle(AssignNamespaceRDFToGeographicalLocationVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceRDFToGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignNamespaceRDFFromGeographicalLocationVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignNamespaceRDFFromGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId()));
    }
    @CommandHandler
    public void handle(AssignNamespaceUMLToGeographicalLocationVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceUMLToGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignNamespaceUMLFromGeographicalLocationVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignNamespaceUMLFromGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId()));
    }
    @CommandHandler
    public void handle(AssignShortNameToGeographicalLocationVersionCommand command) throws Exception {
        ...
        apply(new AssignShortNameToGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignShortNameFromGeographicalLocationVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignShortNameFromGeographicalLocationVersionEvent(command.getGeographicalLocationVersionId()));
    }
