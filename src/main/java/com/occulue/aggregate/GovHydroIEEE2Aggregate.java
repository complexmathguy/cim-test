...
public class GovHydroIEEE2Aggregate {  
    ...
    public void handle(UpdateGovHydroIEEE2Command command) throws Exception {
    	...
    	UpdateGovHydroIEEE2Event event = new UpdateGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.Aturb(), command.Bturb(), command.Gv1(), command.Gv2(), command.Gv3(), command.Gv4(), command.Gv5(), command.Gv6(), command.Kturb(), command.Mwbase(), command.Pgv1(), command.Pgv2(), command.Pgv3(), command.Pgv4(), command.Pgv5(), command.Pgv6(), command.Pmax(), command.Pmin(), command.Rperm(), command.Rtemp(), command.Tg(), command.Tp(), command.Tr(), command.Tw(), command.Uc(), command.Uo());        
    ...
    public void handle(AssignAturbToGovHydroIEEE2Command command) throws Exception {
        ...
        apply(new AssignAturbToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignBturbToGovHydroIEEE2Command command) throws Exception {
        ...
        apply(new AssignBturbToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignKturbToGovHydroIEEE2Command command) throws Exception {
        ...
        apply(new AssignKturbToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignMwbaseToGovHydroIEEE2Command command) throws Exception {
        ...
        apply(new AssignMwbaseToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignPgv1ToGovHydroIEEE2Command command) throws Exception {
        ...
        apply(new AssignPgv1ToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignPgv2ToGovHydroIEEE2Command command) throws Exception {
        ...
        apply(new AssignPgv2ToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignPgv3ToGovHydroIEEE2Command command) throws Exception {
        ...
        apply(new AssignPgv3ToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignPgv4ToGovHydroIEEE2Command command) throws Exception {
        ...
        apply(new AssignPgv4ToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignPgv5ToGovHydroIEEE2Command command) throws Exception {
        ...
        apply(new AssignPgv5ToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignPgv6ToGovHydroIEEE2Command command) throws Exception {
        ...
        apply(new AssignPgv6ToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignPmaxToGovHydroIEEE2Command command) throws Exception {
        ...
        apply(new AssignPmaxToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignPminToGovHydroIEEE2Command command) throws Exception {
        ...
        apply(new AssignPminToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignRpermToGovHydroIEEE2Command command) throws Exception {
    	...
    	if (  rperm != null && rperm.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Rperm already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignRpermToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignRtempToGovHydroIEEE2Command command) throws Exception {
    	...
    	if (  rtemp != null && rtemp.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Rtemp already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignRtempToGovHydroIEEE2Event(command.getGovHydroIEEE2Id(), command.getAssignment()));
    }
