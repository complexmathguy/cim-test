...
public class WindAeroLinearIECAggregate {  
    ...
    public WindAeroLinearIECAggregate(CreateWindAeroLinearIECCommand command) throws Exception {
    	...
    	CreateWindAeroLinearIECEvent event = new CreateWindAeroLinearIECEvent(command.getWindAeroLinearIECId());
    ...
    public void handle(UpdateWindAeroLinearIECCommand command) throws Exception {
    	...
    	UpdateWindAeroLinearIECEvent event = new UpdateWindAeroLinearIECEvent(command.getWindAeroLinearIECId(), command.Dpomega(), command.Dptheta(), command.Omegazero(), command.Pavail(), command.Thetazero());        
    ...
    public void handle(AssignDpomegaToWindAeroLinearIECCommand command) throws Exception {
    	...
    	if (  dpomega != null && dpomega.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Dpomega already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignDpomegaToWindAeroLinearIECEvent(command.getWindAeroLinearIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDpomegaFromWindAeroLinearIECCommand command) throws Exception {
    	...
    	if (  dpomega == null )
    		throw new ProcessingException( "Dpomega already has nothing assigned." );  
    ...
    public void handle(AssignDpthetaToWindAeroLinearIECCommand command) throws Exception {
    	...
    	if (  dptheta != null && dptheta.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Dptheta already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignDpthetaToWindAeroLinearIECEvent(command.getWindAeroLinearIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDpthetaFromWindAeroLinearIECCommand command) throws Exception {
    	...
    	if (  dptheta == null )
    		throw new ProcessingException( "Dptheta already has nothing assigned." );  
    ...
    public void handle(AssignOmegazeroToWindAeroLinearIECCommand command) throws Exception {
    	...
    	if (  omegazero != null && omegazero.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Omegazero already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignOmegazeroToWindAeroLinearIECEvent(command.getWindAeroLinearIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignOmegazeroFromWindAeroLinearIECCommand command) throws Exception {
    	...
    	if (  omegazero == null )
    		throw new ProcessingException( "Omegazero already has nothing assigned." );  
    ...
    public void handle(AssignPavailToWindAeroLinearIECCommand command) throws Exception {
    	...
    	if (  pavail != null && pavail.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Pavail already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignPavailToWindAeroLinearIECEvent(command.getWindAeroLinearIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignPavailFromWindAeroLinearIECCommand command) throws Exception {
    	...
    	if (  pavail == null )
    		throw new ProcessingException( "Pavail already has nothing assigned." );  
    ...
    public void handle(AssignThetazeroToWindAeroLinearIECCommand command) throws Exception {
    	...
    	if (  thetazero != null && thetazero.getAngleDegreesId() == command.getAssignment().getAngleDegreesId() )
    		throw new ProcessingException( "Thetazero already assigned with id " + command.getAssignment().getAngleDegreesId() );  
    		
        apply(new AssignThetazeroToWindAeroLinearIECEvent(command.getWindAeroLinearIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignThetazeroFromWindAeroLinearIECCommand command) throws Exception {
    	...
    	if (  thetazero == null )
    		throw new ProcessingException( "Thetazero already has nothing assigned." );  
