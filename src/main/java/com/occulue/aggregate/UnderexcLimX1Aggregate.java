...
public class UnderexcLimX1Aggregate {  
    ...
    public void handle(UpdateUnderexcLimX1Command command) throws Exception {
    	...
    	UpdateUnderexcLimX1Event event = new UpdateUnderexcLimX1Event(command.getUnderexcLimX1Id(), command.K(), command.Kf2(), command.Km(), command.Melmax(), command.Tf2(), command.Tm());        
    ...
    public void handle(AssignMelmaxToUnderexcLimX1Command command) throws Exception {
        ...
        apply(new AssignMelmaxToUnderexcLimX1Event(command.getUnderexcLimX1Id(), command.getAssignment()));
    }
