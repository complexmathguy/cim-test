...
public class UnderexcLim2SimplifiedAggregate {  
    ...
    public UnderexcLim2SimplifiedAggregate(CreateUnderexcLim2SimplifiedCommand command) throws Exception {
    	...
    	CreateUnderexcLim2SimplifiedEvent event = new CreateUnderexcLim2SimplifiedEvent(command.getUnderexcLim2SimplifiedId());
    ...
    public void handle(UpdateUnderexcLim2SimplifiedCommand command) throws Exception {
    	...
    	UpdateUnderexcLim2SimplifiedEvent event = new UpdateUnderexcLim2SimplifiedEvent(command.getUnderexcLim2SimplifiedId(), command.Kui(), command.P0(), command.P1(), command.Q0(), command.Q1(), command.Vuimax(), command.Vuimin());        
    ...
    public void handle(AssignKuiToUnderexcLim2SimplifiedCommand command) throws Exception {
        ...
        apply(new AssignKuiToUnderexcLim2SimplifiedEvent(command.getUnderexcLim2SimplifiedId(), command.getAssignment()));
    }
    ...
    public void handle(AssignP0ToUnderexcLim2SimplifiedCommand command) throws Exception {
        ...
        apply(new AssignP0ToUnderexcLim2SimplifiedEvent(command.getUnderexcLim2SimplifiedId(), command.getAssignment()));
    }
    ...
    public void handle(AssignP1ToUnderexcLim2SimplifiedCommand command) throws Exception {
        ...
        apply(new AssignP1ToUnderexcLim2SimplifiedEvent(command.getUnderexcLim2SimplifiedId(), command.getAssignment()));
    }
    ...
    public void handle(AssignQ0ToUnderexcLim2SimplifiedCommand command) throws Exception {
        ...
        apply(new AssignQ0ToUnderexcLim2SimplifiedEvent(command.getUnderexcLim2SimplifiedId(), command.getAssignment()));
    }
    ...
    public void handle(AssignQ1ToUnderexcLim2SimplifiedCommand command) throws Exception {
        ...
        apply(new AssignQ1ToUnderexcLim2SimplifiedEvent(command.getUnderexcLim2SimplifiedId(), command.getAssignment()));
    }
    ...
    public void handle(AssignVuimaxToUnderexcLim2SimplifiedCommand command) throws Exception {
        ...
        apply(new AssignVuimaxToUnderexcLim2SimplifiedEvent(command.getUnderexcLim2SimplifiedId(), command.getAssignment()));
    }
    ...
    public void handle(AssignVuiminToUnderexcLim2SimplifiedCommand command) throws Exception {
        ...
        apply(new AssignVuiminToUnderexcLim2SimplifiedEvent(command.getUnderexcLim2SimplifiedId(), command.getAssignment()));
    }
