...
public class ExcIEEEAC6AAggregate {  
    ...
    public void handle(UpdateExcIEEEAC6ACommand command) throws Exception {
    	...
    	UpdateExcIEEEAC6AEvent event = new UpdateExcIEEEAC6AEvent(command.getExcIEEEAC6AId(), command.Ka(), command.Kc(), command.Kd(), command.Ke(), command.Kh(), command.Seve1(), command.Seve2(), command.Ta(), command.Tb(), command.Tc(), command.Te(), command.Th(), command.Tj(), command.Tk(), command.Vamax(), command.Vamin(), command.Ve1(), command.Ve2(), command.Vfelim(), command.Vhmax(), command.Vrmax(), command.Vrmin());        
