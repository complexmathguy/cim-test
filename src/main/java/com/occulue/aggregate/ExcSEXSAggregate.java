...
public class ExcSEXSAggregate {  
    ...
    public void handle(UpdateExcSEXSCommand command) throws Exception {
    	...
    	UpdateExcSEXSEvent event = new UpdateExcSEXSEvent(command.getExcSEXSId(), command.Efdmax(), command.Efdmin(), command.Emax(), command.Emin(), command.K(), command.Kc(), command.Tatb(), command.Tb(), command.Tc(), command.Te());        
    ...
    public void handle(AssignTatbToExcSEXSCommand command) throws Exception {
    	...
    	if (  tatb != null && tatb.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Tatb already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    ...
    public void handle(UnAssignTatbFromExcSEXSCommand command) throws Exception {
    	...
    	if (  tatb == null )
    		throw new ProcessingException( "Tatb already has nothing assigned." );  
