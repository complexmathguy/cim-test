...
public class Pss1AAggregate {  
    ...
    public Pss1AAggregate(CreatePss1ACommand command) throws Exception {
    	...
    	CreatePss1AEvent event = new CreatePss1AEvent(command.getPss1AId(), command.InputSignalType());
    ...
    public void handle(UpdatePss1ACommand command) throws Exception {
    	...
    	UpdatePss1AEvent event = new UpdatePss1AEvent(command.getPss1AId(), command.A1(), command.A2(), command.A3(), command.A4(), command.A5(), command.A6(), command.A7(), command.A8(), command.InputSignalType(), command.Kd(), command.Ks(), command.T1(), command.T2(), command.T3(), command.T4(), command.T5(), command.T6(), command.Tdelay(), command.Vcl(), command.Vcu(), command.Vrmax(), command.Vrmin());        
    ...
    public void handle(AssignA6ToPss1ACommand command) throws Exception {
    	...
    	if (  a6 != null && a6.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "A6 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignA6FromPss1ACommand command) throws Exception {
    	...
    	if (  a6 == null )
    		throw new ProcessingException( "A6 already has nothing assigned." );  
    ...
    public void handle(AssignA7ToPss1ACommand command) throws Exception {
    	...
    	if (  a7 != null && a7.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "A7 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignA7FromPss1ACommand command) throws Exception {
    	...
    	if (  a7 == null )
    		throw new ProcessingException( "A7 already has nothing assigned." );  
    ...
    public void handle(AssignA8ToPss1ACommand command) throws Exception {
    	...
    	if (  a8 != null && a8.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "A8 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignA8FromPss1ACommand command) throws Exception {
    	...
    	if (  a8 == null )
    		throw new ProcessingException( "A8 already has nothing assigned." );  
    ...
    public void handle(AssignKdToPss1ACommand command) throws Exception {
    	...
    	if (  kd != null && kd.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Kd already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(AssignTdelayToPss1ACommand command) throws Exception {
    	...
    	if (  tdelay != null && tdelay.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tdelay already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(UnAssignTdelayFromPss1ACommand command) throws Exception {
    	...
    	if (  tdelay == null )
    		throw new ProcessingException( "Tdelay already has nothing assigned." );  
    ...
    public void handle(AssignVclToPss1ACommand command) throws Exception {
    	...
    	if (  vcl != null && vcl.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vcl already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignVclFromPss1ACommand command) throws Exception {
    	...
    	if (  vcl == null )
    		throw new ProcessingException( "Vcl already has nothing assigned." );  
    ...
    public void handle(AssignVcuToPss1ACommand command) throws Exception {
    	...
    	if (  vcu != null && vcu.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vcu already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignVcuFromPss1ACommand command) throws Exception {
    	...
    	if (  vcu == null )
    		throw new ProcessingException( "Vcu already has nothing assigned." );  
