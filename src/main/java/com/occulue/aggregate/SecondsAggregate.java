...
public class SecondsAggregate {  
    ...
    public SecondsAggregate(CreateSecondsCommand command) throws Exception {
    	...
    	CreateSecondsEvent event = new CreateSecondsEvent(command.getSecondsId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateSecondsCommand command) throws Exception {
    	...
    	UpdateSecondsEvent event = new UpdateSecondsEvent(command.getSecondsId(), command.Multiplier(), command.Unit(), command.Value());        
