...
public class GovHydroIEEE0Aggregate {  
    ...
    public void handle(UpdateGovHydroIEEE0Command command) throws Exception {
    	...
    	UpdateGovHydroIEEE0Event event = new UpdateGovHydroIEEE0Event(command.getGovHydroIEEE0Id(), command.K(), command.Mwbase(), command.Pmax(), command.Pmin(), command.T1(), command.T2(), command.T3(), command.T4());        
    ...
    public void handle(AssignMwbaseToGovHydroIEEE0Command command) throws Exception {
        ...
        apply(new AssignMwbaseToGovHydroIEEE0Event(command.getGovHydroIEEE0Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignPmaxToGovHydroIEEE0Command command) throws Exception {
        ...
        apply(new AssignPmaxToGovHydroIEEE0Event(command.getGovHydroIEEE0Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignPminToGovHydroIEEE0Command command) throws Exception {
        ...
        apply(new AssignPminToGovHydroIEEE0Event(command.getGovHydroIEEE0Id(), command.getAssignment()));
    }
