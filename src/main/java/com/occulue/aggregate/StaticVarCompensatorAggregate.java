...
public class StaticVarCompensatorAggregate {  
    ...
    public StaticVarCompensatorAggregate(CreateStaticVarCompensatorCommand command) throws Exception {
    	...
    	CreateStaticVarCompensatorEvent event = new CreateStaticVarCompensatorEvent(command.getStaticVarCompensatorId(), command.SVCControlMode());
    ...
    public void handle(UpdateStaticVarCompensatorCommand command) throws Exception {
    	...
    	UpdateStaticVarCompensatorEvent event = new UpdateStaticVarCompensatorEvent(command.getStaticVarCompensatorId(), command.CapacitiveRating(), command.InductiveRating(), command.Slope(), command.SVCControlMode(), command.VoltageSetPoint());        
    ...
    public void handle(AssignCapacitiveRatingToStaticVarCompensatorCommand command) throws Exception {
    	...
    	if (  capacitiveRating != null && capacitiveRating.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "CapacitiveRating already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignCapacitiveRatingToStaticVarCompensatorEvent(command.getStaticVarCompensatorId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignCapacitiveRatingFromStaticVarCompensatorCommand command) throws Exception {
    	...
    	apply(new UnAssignCapacitiveRatingFromStaticVarCompensatorEvent(command.getStaticVarCompensatorId()));
    }
    @CommandHandler
    public void handle(AssignInductiveRatingToStaticVarCompensatorCommand command) throws Exception {
    	...
    	if (  inductiveRating != null && inductiveRating.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "InductiveRating already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignInductiveRatingToStaticVarCompensatorEvent(command.getStaticVarCompensatorId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignInductiveRatingFromStaticVarCompensatorCommand command) throws Exception {
    	...
    	apply(new UnAssignInductiveRatingFromStaticVarCompensatorEvent(command.getStaticVarCompensatorId()));
    }
    @CommandHandler
    public void handle(AssignSlopeToStaticVarCompensatorCommand command) throws Exception {
    	...
    	if (  slope != null && slope.getVoltagePerReactivePowerId() == command.getAssignment().getVoltagePerReactivePowerId() )
    		throw new ProcessingException( "Slope already assigned with id " + command.getAssignment().getVoltagePerReactivePowerId() );  
    		
        apply(new AssignSlopeToStaticVarCompensatorEvent(command.getStaticVarCompensatorId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignSlopeFromStaticVarCompensatorCommand command) throws Exception {
    	...
    	if (  slope == null )
    		throw new ProcessingException( "Slope already has nothing assigned." );  
    ...
    public void handle(AssignVoltageSetPointToStaticVarCompensatorCommand command) throws Exception {
    	...
    	if (  voltageSetPoint != null && voltageSetPoint.getVoltageId() == command.getAssignment().getVoltageId() )
    		throw new ProcessingException( "VoltageSetPoint already assigned with id " + command.getAssignment().getVoltageId() );  
    		
        apply(new AssignVoltageSetPointToStaticVarCompensatorEvent(command.getStaticVarCompensatorId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignVoltageSetPointFromStaticVarCompensatorCommand command) throws Exception {
    	...
    	apply(new UnAssignVoltageSetPointFromStaticVarCompensatorEvent(command.getStaticVarCompensatorId()));
    }
