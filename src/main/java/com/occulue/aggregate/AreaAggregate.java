...
public class AreaAggregate {  
    ...
    public AreaAggregate(CreateAreaCommand command) throws Exception {
    	...
    	CreateAreaEvent event = new CreateAreaEvent(command.getAreaId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateAreaCommand command) throws Exception {
    	...
    	UpdateAreaEvent event = new UpdateAreaEvent(command.getAreaId(), command.Multiplier(), command.Unit(), command.Value());        
