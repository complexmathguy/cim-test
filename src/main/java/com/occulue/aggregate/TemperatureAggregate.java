...
public class TemperatureAggregate {  
    ...
    public TemperatureAggregate(CreateTemperatureCommand command) throws Exception {
    	...
    	CreateTemperatureEvent event = new CreateTemperatureEvent(command.getTemperatureId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateTemperatureCommand command) throws Exception {
    	...
    	UpdateTemperatureEvent event = new UpdateTemperatureEvent(command.getTemperatureId(), command.Multiplier(), command.Unit(), command.Value());        
