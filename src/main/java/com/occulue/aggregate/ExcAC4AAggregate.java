...
public class ExcAC4AAggregate {  
    ...
    public void handle(UpdateExcAC4ACommand command) throws Exception {
    	...
    	UpdateExcAC4AEvent event = new UpdateExcAC4AEvent(command.getExcAC4AId(), command.Ka(), command.Kc(), command.Ta(), command.Tb(), command.Tc(), command.Vimax(), command.Vimin(), command.Vrmax(), command.Vrmin());        
