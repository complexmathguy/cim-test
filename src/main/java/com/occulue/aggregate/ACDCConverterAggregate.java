...
public class ACDCConverterAggregate {  
    ...
    public void handle(UpdateACDCConverterCommand command) throws Exception {
    	...
    	UpdateACDCConverterEvent event = new UpdateACDCConverterEvent(command.getACDCConverterId(), command.BaseS(), command.IdleLoss(), command.MaxUdc(), command.MinUdc(), command.NumberOfValves(), command.RatedUdc(), command.ResistiveLoss(), command.SwitchingLoss(), command.ValveU0());        
    ...
    public void handle(AssignBaseSToACDCConverterCommand command) throws Exception {
    	...
    	if (  baseS != null && baseS.getApparentPowerId() == command.getAssignment().getApparentPowerId() )
    		throw new ProcessingException( "BaseS already assigned with id " + command.getAssignment().getApparentPowerId() );  
    		
        apply(new AssignBaseSToACDCConverterEvent(command.getACDCConverterId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignBaseSFromACDCConverterCommand command) throws Exception {
    	...
    	if (  baseS == null )
    		throw new ProcessingException( "BaseS already has nothing assigned." );  
    ...
    public void handle(AssignIdleLossToACDCConverterCommand command) throws Exception {
    	...
    	if (  idleLoss != null && idleLoss.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "IdleLoss already assigned with id " + command.getAssignment().getActivePowerId() );  
    		
        apply(new AssignIdleLossToACDCConverterEvent(command.getACDCConverterId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignIdleLossFromACDCConverterCommand command) throws Exception {
    	...
    	if (  idleLoss == null )
    		throw new ProcessingException( "IdleLoss already has nothing assigned." );  
    ...
    public void handle(AssignMaxUdcToACDCConverterCommand command) throws Exception {
    	...
    	if (  maxUdc != null && maxUdc.getVoltageId() == command.getAssignment().getVoltageId() )
    		throw new ProcessingException( "MaxUdc already assigned with id " + command.getAssignment().getVoltageId() );  
    		
        apply(new AssignMaxUdcToACDCConverterEvent(command.getACDCConverterId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMaxUdcFromACDCConverterCommand command) throws Exception {
    	...
    	if (  maxUdc == null )
    		throw new ProcessingException( "MaxUdc already has nothing assigned." );  
    ...
    public void handle(AssignMinUdcToACDCConverterCommand command) throws Exception {
    	...
    	if (  minUdc != null && minUdc.getVoltageId() == command.getAssignment().getVoltageId() )
    		throw new ProcessingException( "MinUdc already assigned with id " + command.getAssignment().getVoltageId() );  
    		
        apply(new AssignMinUdcToACDCConverterEvent(command.getACDCConverterId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMinUdcFromACDCConverterCommand command) throws Exception {
    	...
    	if (  minUdc == null )
    		throw new ProcessingException( "MinUdc already has nothing assigned." );  
    ...
    public void handle(AssignNumberOfValvesToACDCConverterCommand command) throws Exception {
    	...
    	if (  numberOfValves != null && numberOfValves.getIntegerProxyId() == command.getAssignment().getIntegerProxyId() )
    		throw new ProcessingException( "NumberOfValves already assigned with id " + command.getAssignment().getIntegerProxyId() );  
    		
        apply(new AssignNumberOfValvesToACDCConverterEvent(command.getACDCConverterId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRatedUdcToACDCConverterCommand command) throws Exception {
    	...
    	if (  ratedUdc != null && ratedUdc.getVoltageId() == command.getAssignment().getVoltageId() )
    		throw new ProcessingException( "RatedUdc already assigned with id " + command.getAssignment().getVoltageId() );  
    		
        apply(new AssignRatedUdcToACDCConverterEvent(command.getACDCConverterId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignRatedUdcFromACDCConverterCommand command) throws Exception {
    	...
    	if (  ratedUdc == null )
    		throw new ProcessingException( "RatedUdc already has nothing assigned." );  
    ...
    public void handle(AssignResistiveLossToACDCConverterCommand command) throws Exception {
    	...
    	if (  resistiveLoss != null && resistiveLoss.getResistanceId() == command.getAssignment().getResistanceId() )
    		throw new ProcessingException( "ResistiveLoss already assigned with id " + command.getAssignment().getResistanceId() );  
    		
        apply(new AssignResistiveLossToACDCConverterEvent(command.getACDCConverterId(), command.getAssignment()));
    }
    ...
    public void handle(AssignSwitchingLossToACDCConverterCommand command) throws Exception {
    	...
    	if (  switchingLoss != null && switchingLoss.getActivePowerPerCurrentFlowId() == command.getAssignment().getActivePowerPerCurrentFlowId() )
    		throw new ProcessingException( "SwitchingLoss already assigned with id " + command.getAssignment().getActivePowerPerCurrentFlowId() );  
    		
        apply(new AssignSwitchingLossToACDCConverterEvent(command.getACDCConverterId(), command.getAssignment()));
    }
    ...
    public void handle(AssignValveU0ToACDCConverterCommand command) throws Exception {
    	...
    	if (  valveU0 != null && valveU0.getVoltageId() == command.getAssignment().getVoltageId() )
    		throw new ProcessingException( "ValveU0 already assigned with id " + command.getAssignment().getVoltageId() );  
    		
        apply(new AssignValveU0ToACDCConverterEvent(command.getACDCConverterId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignValveU0FromACDCConverterCommand command) throws Exception {
    	...
    	if (  valveU0 == null )
    		throw new ProcessingException( "ValveU0 already has nothing assigned." );  
