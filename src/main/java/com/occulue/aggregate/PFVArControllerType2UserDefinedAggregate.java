...
public class PFVArControllerType2UserDefinedAggregate {  
    ...
    public PFVArControllerType2UserDefinedAggregate(CreatePFVArControllerType2UserDefinedCommand command) throws Exception {
    	...
    	CreatePFVArControllerType2UserDefinedEvent event = new CreatePFVArControllerType2UserDefinedEvent(command.getPFVArControllerType2UserDefinedId());
    ...
    public void handle(UpdatePFVArControllerType2UserDefinedCommand command) throws Exception {
    	...
    	UpdatePFVArControllerType2UserDefinedEvent event = new UpdatePFVArControllerType2UserDefinedEvent(command.getPFVArControllerType2UserDefinedId(), command.Proprietary());        
    ...
    @CommandHandler
    public void handle(AssignProprietaryToPFVArControllerType2UserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToPFVArControllerType2UserDefinedEvent(command.getPFVArControllerType2UserDefinedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignProprietaryFromPFVArControllerType2UserDefinedCommand command) throws Exception {
    	...
    	apply(new UnAssignProprietaryFromPFVArControllerType2UserDefinedEvent(command.getPFVArControllerType2UserDefinedId()));
    }
