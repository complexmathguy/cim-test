...
public class VoltageCompensatorUserDefinedAggregate {  
    ...
    public VoltageCompensatorUserDefinedAggregate(CreateVoltageCompensatorUserDefinedCommand command) throws Exception {
    	...
    	CreateVoltageCompensatorUserDefinedEvent event = new CreateVoltageCompensatorUserDefinedEvent(command.getVoltageCompensatorUserDefinedId());
    ...
    public void handle(UpdateVoltageCompensatorUserDefinedCommand command) throws Exception {
    	...
    	UpdateVoltageCompensatorUserDefinedEvent event = new UpdateVoltageCompensatorUserDefinedEvent(command.getVoltageCompensatorUserDefinedId(), command.Proprietary());        
    ...
    @CommandHandler
    public void handle(AssignProprietaryToVoltageCompensatorUserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToVoltageCompensatorUserDefinedEvent(command.getVoltageCompensatorUserDefinedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignProprietaryFromVoltageCompensatorUserDefinedCommand command) throws Exception {
    	...
    	apply(new UnAssignProprietaryFromVoltageCompensatorUserDefinedEvent(command.getVoltageCompensatorUserDefinedId()));
    }
