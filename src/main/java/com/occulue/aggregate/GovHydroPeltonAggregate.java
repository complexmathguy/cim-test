...
public class GovHydroPeltonAggregate {  
    ...
    public void handle(UpdateGovHydroPeltonCommand command) throws Exception {
    	...
    	UpdateGovHydroPeltonEvent event = new UpdateGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.Av0(), command.Av1(), command.Bp(), command.Db1(), command.Db2(), command.H1(), command.H2(), command.Hn(), command.Kc(), command.Kg(), command.Qc0(), command.Qn(), command.SimplifiedPelton(), command.StaticCompensating(), command.Ta(), command.Ts(), command.Tv(), command.Twnc(), command.Twng(), command.Tx(), command.Va(), command.Valvmax(), command.Valvmin(), command.Vav(), command.Vc(), command.Vcv(), command.WaterTunnelSurgeChamberSimulation(), command.Zsfc());        
    ...
    public void handle(AssignAv0ToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  av0 != null && av0.getAreaId() == command.getAssignment().getAreaId() )
    		throw new ProcessingException( "Av0 already assigned with id " + command.getAssignment().getAreaId() );  
    		
        apply(new AssignAv0ToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignAv0FromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  av0 == null )
    		throw new ProcessingException( "Av0 already has nothing assigned." );  
    ...
    public void handle(AssignAv1ToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  av1 != null && av1.getAreaId() == command.getAssignment().getAreaId() )
    		throw new ProcessingException( "Av1 already assigned with id " + command.getAssignment().getAreaId() );  
    		
        apply(new AssignAv1ToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignAv1FromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  av1 == null )
    		throw new ProcessingException( "Av1 already has nothing assigned." );  
    ...
    public void handle(AssignBpToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  bp != null && bp.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Bp already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignBpToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignBpFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  bp == null )
    		throw new ProcessingException( "Bp already has nothing assigned." );  
    ...
    public void handle(AssignDb1ToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  db1 != null && db1.getFrequencyId() == command.getAssignment().getFrequencyId() )
    		throw new ProcessingException( "Db1 already assigned with id " + command.getAssignment().getFrequencyId() );  
    		
        apply(new AssignDb1ToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDb1FromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  db1 == null )
    		throw new ProcessingException( "Db1 already has nothing assigned." );  
    ...
    public void handle(AssignDb2ToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  db2 != null && db2.getFrequencyId() == command.getAssignment().getFrequencyId() )
    		throw new ProcessingException( "Db2 already assigned with id " + command.getAssignment().getFrequencyId() );  
    		
        apply(new AssignDb2ToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDb2FromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  db2 == null )
    		throw new ProcessingException( "Db2 already has nothing assigned." );  
    ...
    public void handle(AssignH1ToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  h1 != null && h1.getLengthId() == command.getAssignment().getLengthId() )
    		throw new ProcessingException( "H1 already assigned with id " + command.getAssignment().getLengthId() );  
    		
        apply(new AssignH1ToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignH1FromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  h1 == null )
    		throw new ProcessingException( "H1 already has nothing assigned." );  
    ...
    public void handle(AssignH2ToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  h2 != null && h2.getLengthId() == command.getAssignment().getLengthId() )
    		throw new ProcessingException( "H2 already assigned with id " + command.getAssignment().getLengthId() );  
    		
        apply(new AssignH2ToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignH2FromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  h2 == null )
    		throw new ProcessingException( "H2 already has nothing assigned." );  
    ...
    public void handle(AssignHnToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  hn != null && hn.getLengthId() == command.getAssignment().getLengthId() )
    		throw new ProcessingException( "Hn already assigned with id " + command.getAssignment().getLengthId() );  
    		
        apply(new AssignHnToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignHnFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  hn == null )
    		throw new ProcessingException( "Hn already has nothing assigned." );  
    ...
    public void handle(AssignKcToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  kc != null && kc.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kc already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKcToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKcFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  kc == null )
    		throw new ProcessingException( "Kc already has nothing assigned." );  
    ...
    public void handle(AssignKgToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  kg != null && kg.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kg already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKgToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKgFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  kg == null )
    		throw new ProcessingException( "Kg already has nothing assigned." );  
    ...
    public void handle(AssignQc0ToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  qc0 != null && qc0.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Qc0 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignQc0ToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQc0FromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  qc0 == null )
    		throw new ProcessingException( "Qc0 already has nothing assigned." );  
    ...
    public void handle(AssignQnToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  qn != null && qn.getVolumeFlowRateId() == command.getAssignment().getVolumeFlowRateId() )
    		throw new ProcessingException( "Qn already assigned with id " + command.getAssignment().getVolumeFlowRateId() );  
    		
        apply(new AssignQnToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQnFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  qn == null )
    		throw new ProcessingException( "Qn already has nothing assigned." );  
    ...
    public void handle(AssignSimplifiedPeltonToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  simplifiedPelton != null && simplifiedPelton.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "SimplifiedPelton already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignSimplifiedPeltonToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(AssignStaticCompensatingToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  staticCompensating != null && staticCompensating.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "StaticCompensating already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignStaticCompensatingToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTaToGovHydroPeltonCommand command) throws Exception {
        ...
        apply(new AssignTaToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTsToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  ts != null && ts.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Ts already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTsToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTsFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  ts == null )
    		throw new ProcessingException( "Ts already has nothing assigned." );  
    ...
    public void handle(AssignTvToGovHydroPeltonCommand command) throws Exception {
        ...
        apply(new AssignTvToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTwncToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  twnc != null && twnc.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Twnc already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTwncToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTwncFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  twnc == null )
    		throw new ProcessingException( "Twnc already has nothing assigned." );  
    ...
    public void handle(AssignTwngToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  twng != null && twng.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Twng already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTwngToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTwngFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  twng == null )
    		throw new ProcessingException( "Twng already has nothing assigned." );  
    ...
    public void handle(AssignTxToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  tx != null && tx.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tx already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTxToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTxFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  tx == null )
    		throw new ProcessingException( "Tx already has nothing assigned." );  
    ...
    public void handle(AssignVaToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  va != null && va.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Va already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignVaToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVaFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  va == null )
    		throw new ProcessingException( "Va already has nothing assigned." );  
    ...
    public void handle(AssignValvmaxToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  valvmax != null && valvmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Valvmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignValvmaxToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignValvmaxFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  valvmax == null )
    		throw new ProcessingException( "Valvmax already has nothing assigned." );  
    ...
    public void handle(AssignValvminToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  valvmin != null && valvmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Valvmin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignValvminToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignValvminFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  valvmin == null )
    		throw new ProcessingException( "Valvmin already has nothing assigned." );  
    ...
    public void handle(AssignVavToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  vav != null && vav.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vav already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVavToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVavFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  vav == null )
    		throw new ProcessingException( "Vav already has nothing assigned." );  
    ...
    public void handle(AssignVcToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  vc != null && vc.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Vc already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignVcToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVcFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  vc == null )
    		throw new ProcessingException( "Vc already has nothing assigned." );  
    ...
    public void handle(AssignVcvToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  vcv != null && vcv.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vcv already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVcvToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVcvFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  vcv == null )
    		throw new ProcessingException( "Vcv already has nothing assigned." );  

    	apply(new UnAssignVcvFromGovHydroPeltonEvent(command.getGovHydroPeltonId()));
    }
    @CommandHandler
    public void handle(AssignWaterTunnelSurgeChamberSimulationToGovHydroPeltonCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignWaterTunnelSurgeChamberSimulationToGovHydroPeltonCommand" );
    	
    	if (  waterTunnelSurgeChamberSimulation != null && waterTunnelSurgeChamberSimulation.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "WaterTunnelSurgeChamberSimulation already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignWaterTunnelSurgeChamberSimulationToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroPeltonCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroPeltonCommand" );

    	if (  waterTunnelSurgeChamberSimulation == null )
    		throw new ProcessingException( "WaterTunnelSurgeChamberSimulation already has nothing assigned." );  

    	apply(new UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroPeltonEvent(command.getGovHydroPeltonId()));
    }
    @CommandHandler
    public void handle(AssignZsfcToGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  zsfc != null && zsfc.getLengthId() == command.getAssignment().getLengthId() )
    		throw new ProcessingException( "Zsfc already assigned with id " + command.getAssignment().getLengthId() );  
    		
        apply(new AssignZsfcToGovHydroPeltonEvent(command.getGovHydroPeltonId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignZsfcFromGovHydroPeltonCommand command) throws Exception {
    	...
    	if (  zsfc == null )
    		throw new ProcessingException( "Zsfc already has nothing assigned." );  
