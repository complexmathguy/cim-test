...
public class AsynchronousMachineAggregate {  
    ...
    public AsynchronousMachineAggregate(CreateAsynchronousMachineCommand command) throws Exception {
    	...
    	CreateAsynchronousMachineEvent event = new CreateAsynchronousMachineEvent(command.getAsynchronousMachineId());
    ...
    public void handle(UpdateAsynchronousMachineCommand command) throws Exception {
    	...
    	UpdateAsynchronousMachineEvent event = new UpdateAsynchronousMachineEvent(command.getAsynchronousMachineId(), command.ConverterFedDrive(), command.Efficiency(), command.IaIrRatio(), command.NominalFrequency(), command.NominalSpeed(), command.PolePairNumber(), command.RatedMechanicalPower(), command.Reversible(), command.RxLockedRotorRatio());        
    ...
    public void handle(AssignConverterFedDriveToAsynchronousMachineCommand command) throws Exception {
    	...
    	if (  converterFedDrive != null && converterFedDrive.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "ConverterFedDrive already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignConverterFedDriveToAsynchronousMachineEvent(command.getAsynchronousMachineId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignConverterFedDriveFromAsynchronousMachineCommand command) throws Exception {
    	...
    	apply(new UnAssignConverterFedDriveFromAsynchronousMachineEvent(command.getAsynchronousMachineId()));
    }
    @CommandHandler
    public void handle(AssignEfficiencyToAsynchronousMachineCommand command) throws Exception {
    	...
    	if (  efficiency != null && efficiency.getPerCentId() == command.getAssignment().getPerCentId() )
    		throw new ProcessingException( "Efficiency already assigned with id " + command.getAssignment().getPerCentId() );  
    		
        apply(new AssignEfficiencyToAsynchronousMachineEvent(command.getAsynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(AssignIaIrRatioToAsynchronousMachineCommand command) throws Exception {
    	...
    	if (  iaIrRatio != null && iaIrRatio.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "IaIrRatio already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignIaIrRatioToAsynchronousMachineEvent(command.getAsynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignIaIrRatioFromAsynchronousMachineCommand command) throws Exception {
    	...
    	if (  iaIrRatio == null )
    		throw new ProcessingException( "IaIrRatio already has nothing assigned." );  
    ...
    public void handle(AssignNominalFrequencyToAsynchronousMachineCommand command) throws Exception {
    	...
    	if (  nominalFrequency != null && nominalFrequency.getFrequencyId() == command.getAssignment().getFrequencyId() )
    		throw new ProcessingException( "NominalFrequency already assigned with id " + command.getAssignment().getFrequencyId() );  
    		
        apply(new AssignNominalFrequencyToAsynchronousMachineEvent(command.getAsynchronousMachineId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignNominalFrequencyFromAsynchronousMachineCommand command) throws Exception {
    	...
    	apply(new UnAssignNominalFrequencyFromAsynchronousMachineEvent(command.getAsynchronousMachineId()));
    }
    @CommandHandler
    public void handle(AssignNominalSpeedToAsynchronousMachineCommand command) throws Exception {
    	...
    	if (  nominalSpeed != null && nominalSpeed.getRotationSpeedId() == command.getAssignment().getRotationSpeedId() )
    		throw new ProcessingException( "NominalSpeed already assigned with id " + command.getAssignment().getRotationSpeedId() );  
    		
        apply(new AssignNominalSpeedToAsynchronousMachineEvent(command.getAsynchronousMachineId(), command.getAssignment()));
    }
    ...
    public void handle(AssignPolePairNumberToAsynchronousMachineCommand command) throws Exception {
    	...
    	if (  polePairNumber != null && polePairNumber.getIntegerProxyId() == command.getAssignment().getIntegerProxyId() )
    		throw new ProcessingException( "PolePairNumber already assigned with id " + command.getAssignment().getIntegerProxyId() );  
    		
        apply(new AssignPolePairNumberToAsynchronousMachineEvent(command.getAsynchronousMachineId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignPolePairNumberFromAsynchronousMachineCommand command) throws Exception {
    	...
    	apply(new UnAssignPolePairNumberFromAsynchronousMachineEvent(command.getAsynchronousMachineId()));
    }
    @CommandHandler
    public void handle(AssignRatedMechanicalPowerToAsynchronousMachineCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignRatedMechanicalPowerToAsynchronousMachineCommand" );
    	
    	if (  ratedMechanicalPower != null && ratedMechanicalPower.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "RatedMechanicalPower already assigned with id " + command.getAssignment().getActivePowerId() );  
    		
        apply(new AssignRatedMechanicalPowerToAsynchronousMachineEvent(command.getAsynchronousMachineId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignRatedMechanicalPowerFromAsynchronousMachineCommand command) throws Exception {
    	...
    	apply(new UnAssignRatedMechanicalPowerFromAsynchronousMachineEvent(command.getAsynchronousMachineId()));
    }
    @CommandHandler
    public void handle(AssignReversibleToAsynchronousMachineCommand command) throws Exception {
    	...
    	if (  reversible != null && reversible.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Reversible already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignReversibleToAsynchronousMachineEvent(command.getAsynchronousMachineId(), command.getAssignment()));
    }
    ...
    @CommandHandler
    public void handle(AssignRxLockedRotorRatioToAsynchronousMachineCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignRxLockedRotorRatioToAsynchronousMachineCommand" );
    	
    	if (  rxLockedRotorRatio != null && rxLockedRotorRatio.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "RxLockedRotorRatio already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignRxLockedRotorRatioToAsynchronousMachineEvent(command.getAsynchronousMachineId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignRxLockedRotorRatioFromAsynchronousMachineCommand command) throws Exception {
    	...
    	apply(new UnAssignRxLockedRotorRatioFromAsynchronousMachineEvent(command.getAsynchronousMachineId()));
    }
