...
public class ExcOEX3TAggregate {  
    ...
    public void handle(UpdateExcOEX3TCommand command) throws Exception {
    	...
    	UpdateExcOEX3TEvent event = new UpdateExcOEX3TEvent(command.getExcOEX3TId(), command.E1(), command.E2(), command.Ka(), command.Kc(), command.Kd(), command.Ke(), command.Kf(), command.See1(), command.See2(), command.T1(), command.T2(), command.T3(), command.T4(), command.T5(), command.T6(), command.Te(), command.Tf(), command.Vrmax(), command.Vrmin());        
    ...
    public void handle(AssignSee1ToExcOEX3TCommand command) throws Exception {
    	...
    	if (  see1 != null && see1.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "See1 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignSee1FromExcOEX3TCommand command) throws Exception {
    	...
    	if (  see1 == null )
    		throw new ProcessingException( "See1 already has nothing assigned." );  
    ...
    public void handle(AssignSee2ToExcOEX3TCommand command) throws Exception {
    	...
    	if (  see2 != null && see2.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "See2 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignSee2FromExcOEX3TCommand command) throws Exception {
    	...
    	if (  see2 == null )
    		throw new ProcessingException( "See2 already has nothing assigned." );  
