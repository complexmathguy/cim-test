...
public class GovHydro3Aggregate {  
    ...
    public void handle(UpdateGovHydro3Command command) throws Exception {
    	...
    	UpdateGovHydro3Event event = new UpdateGovHydro3Event(command.getGovHydro3Id(), command.At(), command.Db1(), command.Db2(), command.Dturb(), command.Eps(), command.GovernorControl(), command.Gv1(), command.Gv2(), command.Gv3(), command.Gv4(), command.Gv5(), command.Gv6(), command.H0(), command.K1(), command.K2(), command.Kg(), command.Ki(), command.Mwbase(), command.Pgv1(), command.Pgv2(), command.Pgv3(), command.Pgv4(), command.Pgv5(), command.Pgv6(), command.Pmax(), command.Pmin(), command.Qnl(), command.Relec(), command.Rgate(), command.Td(), command.Tf(), command.Tp(), command.Tt(), command.Tw(), command.Velcl(), command.Velop());        
    ...
    public void handle(AssignGovernorControlToGovHydro3Command command) throws Exception {
    	...
    	if (  governorControl != null && governorControl.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "GovernorControl already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignGovernorControlToGovHydro3Event(command.getGovHydro3Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignK1ToGovHydro3Command command) throws Exception {
    	...
    	if (  k1 != null && k1.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "K1 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(AssignK2ToGovHydro3Command command) throws Exception {
    	...
    	if (  k2 != null && k2.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "K2 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(AssignRelecToGovHydro3Command command) throws Exception {
    	...
    	if (  relec != null && relec.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Relec already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignRelecFromGovHydro3Command command) throws Exception {
    	...
    	if (  relec == null )
    		throw new ProcessingException( "Relec already has nothing assigned." );  
    ...
    public void handle(AssignRgateToGovHydro3Command command) throws Exception {
    	...
    	if (  rgate != null && rgate.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Rgate already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignRgateFromGovHydro3Command command) throws Exception {
    	...
    	if (  rgate == null )
    		throw new ProcessingException( "Rgate already has nothing assigned." );  
    ...
    public void handle(AssignTfToGovHydro3Command command) throws Exception {
    	...
    	if (  tf != null && tf.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tf already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(UnAssignTfFromGovHydro3Command command) throws Exception {
    	...
    	if (  tf == null )
    		throw new ProcessingException( "Tf already has nothing assigned." );  
