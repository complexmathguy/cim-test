...
public class IdentifiedObjectAggregate {  
    ...
    public IdentifiedObjectAggregate(CreateIdentifiedObjectCommand command) throws Exception {
    	...
    	CreateIdentifiedObjectEvent event = new CreateIdentifiedObjectEvent(command.getIdentifiedObjectId());
    ...
    public void handle(UpdateIdentifiedObjectCommand command) throws Exception {
    	...
    	UpdateIdentifiedObjectEvent event = new UpdateIdentifiedObjectEvent(command.getIdentifiedObjectId(), command.Description(), command.EnergyIdentCodeEic(), command.MRID(), command.Name(), command.ShortName());        
    ...
    public void handle(AssignDescriptionToIdentifiedObjectCommand command) throws Exception {
    	...
    	if (  description != null && description.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "Description already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignDescriptionToIdentifiedObjectEvent(command.getIdentifiedObjectId(), command.getAssignment()));
    }
    ...
    public void handle(AssignEnergyIdentCodeEicToIdentifiedObjectCommand command) throws Exception {
    	...
    	if (  energyIdentCodeEic != null && energyIdentCodeEic.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "EnergyIdentCodeEic already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignEnergyIdentCodeEicToIdentifiedObjectEvent(command.getIdentifiedObjectId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEnergyIdentCodeEicFromIdentifiedObjectCommand command) throws Exception {
    ...
    public void handle(AssignMRIDToIdentifiedObjectCommand command) throws Exception {
    	...
    	if (  mRID != null && mRID.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "MRID already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignMRIDToIdentifiedObjectEvent(command.getIdentifiedObjectId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMRIDFromIdentifiedObjectCommand command) throws Exception {
    	...
    	if (  mRID == null )
    		throw new ProcessingException( "MRID already has nothing assigned." );  
    ...
    public void handle(AssignNameToIdentifiedObjectCommand command) throws Exception {
    	...
    	if (  name != null && name.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "Name already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignNameToIdentifiedObjectEvent(command.getIdentifiedObjectId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignNameFromIdentifiedObjectCommand command) throws Exception {
    	...
    	if (  name == null )
    		throw new ProcessingException( "Name already has nothing assigned." );  
    ...
    public void handle(AssignShortNameToIdentifiedObjectCommand command) throws Exception {
        ...
        apply(new AssignShortNameToIdentifiedObjectEvent(command.getIdentifiedObjectId(), command.getAssignment()));
    }
