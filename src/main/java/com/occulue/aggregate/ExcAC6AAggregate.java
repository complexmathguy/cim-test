...
public class ExcAC6AAggregate {  
    ...
    public void handle(UpdateExcAC6ACommand command) throws Exception {
    	...
    	UpdateExcAC6AEvent event = new UpdateExcAC6AEvent(command.getExcAC6AId(), command.Ka(), command.Kc(), command.Kd(), command.Ke(), command.Kh(), command.Ks(), command.Seve1(), command.Seve2(), command.Ta(), command.Tb(), command.Tc(), command.Te(), command.Th(), command.Tj(), command.Tk(), command.Vamax(), command.Vamin(), command.Ve1(), command.Ve2(), command.Vfelim(), command.Vhmax(), command.Vrmax(), command.Vrmin());        
    ...
    public void handle(AssignThToExcAC6ACommand command) throws Exception {
    	...
    	if (  th != null && th.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Th already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(UnAssignThFromExcAC6ACommand command) throws Exception {
    	...
    	if (  th == null )
    		throw new ProcessingException( "Th already has nothing assigned." );  
    ...
    public void handle(AssignTjToExcAC6ACommand command) throws Exception {
    	...
    	if (  tj != null && tj.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tj already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(UnAssignTjFromExcAC6ACommand command) throws Exception {
    	...
    	if (  tj == null )
    		throw new ProcessingException( "Tj already has nothing assigned." );  
    ...
    public void handle(AssignTkToExcAC6ACommand command) throws Exception {
    	...
    	if (  tk != null && tk.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tk already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(UnAssignTkFromExcAC6ACommand command) throws Exception {
    	...
    	if (  tk == null )
    		throw new ProcessingException( "Tk already has nothing assigned." );  
    ...
    public void handle(AssignVfelimToExcAC6ACommand command) throws Exception {
    	...
    	if (  vfelim != null && vfelim.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vfelim already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignVfelimFromExcAC6ACommand command) throws Exception {
    	...
    	if (  vfelim == null )
    		throw new ProcessingException( "Vfelim already has nothing assigned." );  
