...
public class EquivalentShuntAggregate {  
    ...
    public EquivalentShuntAggregate(CreateEquivalentShuntCommand command) throws Exception {
    	...
    	CreateEquivalentShuntEvent event = new CreateEquivalentShuntEvent(command.getEquivalentShuntId());
    ...
    public void handle(UpdateEquivalentShuntCommand command) throws Exception {
    	...
    	UpdateEquivalentShuntEvent event = new UpdateEquivalentShuntEvent(command.getEquivalentShuntId(), command.B(), command.G());        
    ...
    public void handle(AssignBToEquivalentShuntCommand command) throws Exception {
        ...
        apply(new AssignBToEquivalentShuntEvent(command.getEquivalentShuntId(), command.getAssignment()));
    }
    ...
    public void handle(AssignGToEquivalentShuntCommand command) throws Exception {
        ...
        apply(new AssignGToEquivalentShuntEvent(command.getEquivalentShuntId(), command.getAssignment()));
    }
