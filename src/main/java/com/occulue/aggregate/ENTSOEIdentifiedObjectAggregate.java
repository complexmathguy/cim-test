...
public class ENTSOEIdentifiedObjectAggregate {  
    ...
    public ENTSOEIdentifiedObjectAggregate(CreateENTSOEIdentifiedObjectCommand command) throws Exception {
    	...
    	CreateENTSOEIdentifiedObjectEvent event = new CreateENTSOEIdentifiedObjectEvent(command.getENTSOEIdentifiedObjectId());
    ...
    public void handle(UpdateENTSOEIdentifiedObjectCommand command) throws Exception {
    	...
    	UpdateENTSOEIdentifiedObjectEvent event = new UpdateENTSOEIdentifiedObjectEvent(command.getENTSOEIdentifiedObjectId(), command.EnergyIdentCodeEic(), command.ShortName());        
    ...
    @CommandHandler
    public void handle(AssignEnergyIdentCodeEicToENTSOEIdentifiedObjectCommand command) throws Exception {
        ...
        apply(new AssignEnergyIdentCodeEicToENTSOEIdentifiedObjectEvent(command.getENTSOEIdentifiedObjectId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEnergyIdentCodeEicFromENTSOEIdentifiedObjectCommand command) throws Exception {
    	...
    	apply(new UnAssignEnergyIdentCodeEicFromENTSOEIdentifiedObjectEvent(command.getENTSOEIdentifiedObjectId()));
    }
    @CommandHandler
    public void handle(AssignShortNameToENTSOEIdentifiedObjectCommand command) throws Exception {
        ...
        apply(new AssignShortNameToENTSOEIdentifiedObjectEvent(command.getENTSOEIdentifiedObjectId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignShortNameFromENTSOEIdentifiedObjectCommand command) throws Exception {
    	...
    	apply(new UnAssignShortNameFromENTSOEIdentifiedObjectEvent(command.getENTSOEIdentifiedObjectId()));
    }
