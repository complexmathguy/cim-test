...
public class SynchronousMachineEquivalentCircuitAggregate {  
    ...
    public SynchronousMachineEquivalentCircuitAggregate(CreateSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	CreateSynchronousMachineEquivalentCircuitEvent event = new CreateSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId());
    ...
    public void handle(UpdateSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	UpdateSynchronousMachineEquivalentCircuitEvent event = new UpdateSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId(), command.R1d(), command.R1q(), command.R2q(), command.Rfd(), command.X1d(), command.X1q(), command.X2q(), command.Xad(), command.Xaq(), command.Xf1d(), command.Xfd());        
    ...
    @CommandHandler
    public void handle(AssignR1dToSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  r1d != null && r1d.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "R1d already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignR1dToSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignR1dFromSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignR1dFromSynchronousMachineEquivalentCircuitCommand" );

    	if (  r1d == null )
    		throw new ProcessingException( "R1d already has nothing assigned." );  

    	apply(new UnAssignR1dFromSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignR1qToSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  r1q != null && r1q.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "R1q already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignR1qToSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignR1qFromSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignR1qFromSynchronousMachineEquivalentCircuitCommand" );

    	if (  r1q == null )
    		throw new ProcessingException( "R1q already has nothing assigned." );  

    	apply(new UnAssignR1qFromSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignR2qToSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  r2q != null && r2q.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "R2q already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignR2qToSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignR2qFromSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignR2qFromSynchronousMachineEquivalentCircuitCommand" );

    	if (  r2q == null )
    		throw new ProcessingException( "R2q already has nothing assigned." );  

    	apply(new UnAssignR2qFromSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignRfdToSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  rfd != null && rfd.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Rfd already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignRfdToSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignRfdFromSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignRfdFromSynchronousMachineEquivalentCircuitCommand" );

    	if (  rfd == null )
    		throw new ProcessingException( "Rfd already has nothing assigned." );  

    	apply(new UnAssignRfdFromSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignX1dToSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  x1d != null && x1d.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "X1d already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignX1dToSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignX1dFromSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignX1dFromSynchronousMachineEquivalentCircuitCommand" );

    	if (  x1d == null )
    		throw new ProcessingException( "X1d already has nothing assigned." );  

    	apply(new UnAssignX1dFromSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignX1qToSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  x1q != null && x1q.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "X1q already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignX1qToSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignX1qFromSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignX1qFromSynchronousMachineEquivalentCircuitCommand" );

    	if (  x1q == null )
    		throw new ProcessingException( "X1q already has nothing assigned." );  

    	apply(new UnAssignX1qFromSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignX2qToSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  x2q != null && x2q.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "X2q already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignX2qToSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignX2qFromSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignX2qFromSynchronousMachineEquivalentCircuitCommand" );

    	if (  x2q == null )
    		throw new ProcessingException( "X2q already has nothing assigned." );  

    	apply(new UnAssignX2qFromSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignXadToSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  xad != null && xad.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Xad already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignXadToSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignXadFromSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignXadFromSynchronousMachineEquivalentCircuitCommand" );

    	if (  xad == null )
    		throw new ProcessingException( "Xad already has nothing assigned." );  

    	apply(new UnAssignXadFromSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignXaqToSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  xaq != null && xaq.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Xaq already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignXaqToSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignXaqFromSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignXaqFromSynchronousMachineEquivalentCircuitCommand" );

    	if (  xaq == null )
    		throw new ProcessingException( "Xaq already has nothing assigned." );  

    	apply(new UnAssignXaqFromSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignXf1dToSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  xf1d != null && xf1d.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Xf1d already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignXf1dToSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignXf1dFromSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignXf1dFromSynchronousMachineEquivalentCircuitCommand" );

    	if (  xf1d == null )
    		throw new ProcessingException( "Xf1d already has nothing assigned." );  

    	apply(new UnAssignXf1dFromSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId()));
    }
    @CommandHandler
    public void handle(AssignXfdToSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	...
    	if (  xfd != null && xfd.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Xfd already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignXfdToSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignXfdFromSynchronousMachineEquivalentCircuitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignXfdFromSynchronousMachineEquivalentCircuitCommand" );

    	if (  xfd == null )
    		throw new ProcessingException( "Xfd already has nothing assigned." );  

    	apply(new UnAssignXfdFromSynchronousMachineEquivalentCircuitEvent(command.getSynchronousMachineEquivalentCircuitId()));
    }
