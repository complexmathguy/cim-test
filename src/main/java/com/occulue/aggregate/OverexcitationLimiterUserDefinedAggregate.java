...
public class OverexcitationLimiterUserDefinedAggregate {  
    ...
    public OverexcitationLimiterUserDefinedAggregate(CreateOverexcitationLimiterUserDefinedCommand command) throws Exception {
    	...
    	CreateOverexcitationLimiterUserDefinedEvent event = new CreateOverexcitationLimiterUserDefinedEvent(command.getOverexcitationLimiterUserDefinedId());
    ...
    public void handle(UpdateOverexcitationLimiterUserDefinedCommand command) throws Exception {
    	...
    	UpdateOverexcitationLimiterUserDefinedEvent event = new UpdateOverexcitationLimiterUserDefinedEvent(command.getOverexcitationLimiterUserDefinedId(), command.Proprietary());        
    ...
    @CommandHandler
    public void handle(AssignProprietaryToOverexcitationLimiterUserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToOverexcitationLimiterUserDefinedEvent(command.getOverexcitationLimiterUserDefinedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignProprietaryFromOverexcitationLimiterUserDefinedCommand command) throws Exception {
    	...
    	apply(new UnAssignProprietaryFromOverexcitationLimiterUserDefinedEvent(command.getOverexcitationLimiterUserDefinedId()));
    }
