...
public class GovHydroFrancisAggregate {  
    ...
    public GovHydroFrancisAggregate(CreateGovHydroFrancisCommand command) throws Exception {
    	...
    	CreateGovHydroFrancisEvent event = new CreateGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.GovernorControl());
    ...
    public void handle(UpdateGovHydroFrancisCommand command) throws Exception {
    	...
    	UpdateGovHydroFrancisEvent event = new UpdateGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.Am(), command.Av0(), command.Av1(), command.Bp(), command.Db1(), command.Etamax(), command.GovernorControl(), command.H1(), command.H2(), command.Hn(), command.Kc(), command.Kg(), command.Kt(), command.Qc0(), command.Qn(), command.Ta(), command.Td(), command.Ts(), command.Twnc(), command.Twng(), command.Tx(), command.Va(), command.Valvmax(), command.Valvmin(), command.Vc(), command.WaterTunnelSurgeChamberSimulation(), command.Zsfc());        
    ...
    public void handle(AssignAmToGovHydroFrancisCommand command) throws Exception {
    	...
    	if (  am != null && am.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Am already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignAmToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignAmFromGovHydroFrancisCommand command) throws Exception {
    	...
    	if (  am == null )
    		throw new ProcessingException( "Am already has nothing assigned." );  
    ...
    public void handle(AssignAv0ToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignAv0ToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignAv1ToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignAv1ToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignBpToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignBpToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignDb1ToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignDb1ToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignEtamaxToGovHydroFrancisCommand command) throws Exception {
    	...
    	if (  etamax != null && etamax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Etamax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignEtamaxToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEtamaxFromGovHydroFrancisCommand command) throws Exception {
    	...
    	if (  etamax == null )
    		throw new ProcessingException( "Etamax already has nothing assigned." );  
    ...
    public void handle(AssignH1ToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignH1ToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignH2ToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignH2ToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignHnToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignHnToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignKcToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignKcToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignKgToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignKgToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignKtToGovHydroFrancisCommand command) throws Exception {
    	...
    	if (  kt != null && kt.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kt already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKtToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKtFromGovHydroFrancisCommand command) throws Exception {
    	...
    	if (  kt == null )
    		throw new ProcessingException( "Kt already has nothing assigned." );  
    ...
    public void handle(AssignQc0ToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignQc0ToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignQnToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignQnToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTaToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignTaToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTdToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignTdToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTsToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignTsToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTwncToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignTwncToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTwngToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignTwngToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTxToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignTxToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignVaToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignVaToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignValvmaxToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignValvmaxToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignValvminToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignValvminToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    public void handle(AssignVcToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignVcToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
    ...
    @CommandHandler
    public void handle(AssignWaterTunnelSurgeChamberSimulationToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignWaterTunnelSurgeChamberSimulationToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroFrancisCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroFrancisCommand" );
    	...
    	apply(new UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroFrancisEvent(command.getGovHydroFrancisId()));
    }
    @CommandHandler
    public void handle(AssignZsfcToGovHydroFrancisCommand command) throws Exception {
        ...
        apply(new AssignZsfcToGovHydroFrancisEvent(command.getGovHydroFrancisId(), command.getAssignment()));
    }
