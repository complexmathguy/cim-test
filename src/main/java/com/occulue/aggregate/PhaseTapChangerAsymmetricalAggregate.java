...
public class PhaseTapChangerAsymmetricalAggregate {  
    ...
    public PhaseTapChangerAsymmetricalAggregate(CreatePhaseTapChangerAsymmetricalCommand command) throws Exception {
    	...
    	CreatePhaseTapChangerAsymmetricalEvent event = new CreatePhaseTapChangerAsymmetricalEvent(command.getPhaseTapChangerAsymmetricalId());
    ...
    public void handle(UpdatePhaseTapChangerAsymmetricalCommand command) throws Exception {
    	...
    	UpdatePhaseTapChangerAsymmetricalEvent event = new UpdatePhaseTapChangerAsymmetricalEvent(command.getPhaseTapChangerAsymmetricalId(), command.WindingConnectionAngle());        
    ...
    @CommandHandler
    public void handle(AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalCommand" );
    	
    	if (  windingConnectionAngle != null && windingConnectionAngle.getAngleDegreesId() == command.getAssignment().getAngleDegreesId() )
    		throw new ProcessingException( "WindingConnectionAngle already assigned with id " + command.getAssignment().getAngleDegreesId() );  
    		
        apply(new AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalEvent(command.getPhaseTapChangerAsymmetricalId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalCommand" );

    	if (  windingConnectionAngle == null )
    		throw new ProcessingException( "WindingConnectionAngle already has nothing assigned." );  

    	apply(new UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalEvent(command.getPhaseTapChangerAsymmetricalId()));
    }
	...
	void on(UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalEvent" );
