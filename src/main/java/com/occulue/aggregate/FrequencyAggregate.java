...
public class FrequencyAggregate {  
    ...
    public FrequencyAggregate(CreateFrequencyCommand command) throws Exception {
    	...
    	CreateFrequencyEvent event = new CreateFrequencyEvent(command.getFrequencyId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateFrequencyCommand command) throws Exception {
    	...
    	UpdateFrequencyEvent event = new UpdateFrequencyEvent(command.getFrequencyId(), command.Multiplier(), command.Unit(), command.Value());        
