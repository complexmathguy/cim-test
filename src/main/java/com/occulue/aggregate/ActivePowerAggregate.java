...
public class ActivePowerAggregate {  
    ...
    public ActivePowerAggregate(CreateActivePowerCommand command) throws Exception {
    	...
    	CreateActivePowerEvent event = new CreateActivePowerEvent(command.getActivePowerId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateActivePowerCommand command) throws Exception {
    	...
    	UpdateActivePowerEvent event = new UpdateActivePowerEvent(command.getActivePowerId(), command.Multiplier(), command.Unit(), command.Value());        
