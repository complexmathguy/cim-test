...
public class LoadGenericNonLinearAggregate {  
    ...
    public LoadGenericNonLinearAggregate(CreateLoadGenericNonLinearCommand command) throws Exception {
    	...
    	CreateLoadGenericNonLinearEvent event = new CreateLoadGenericNonLinearEvent(command.getLoadGenericNonLinearId(), command.GenericNonLinearLoadModelType());
    ...
    public void handle(UpdateLoadGenericNonLinearCommand command) throws Exception {
    	...
    	UpdateLoadGenericNonLinearEvent event = new UpdateLoadGenericNonLinearEvent(command.getLoadGenericNonLinearId(), command.Bs(), command.Bt(), command.GenericNonLinearLoadModelType(), command.Ls(), command.Lt(), command.Pt(), command.Qt(), command.Tp(), command.Tq());        
    ...
    public void handle(AssignBsToLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  bs != null && bs.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Bs already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignBsToLoadGenericNonLinearEvent(command.getLoadGenericNonLinearId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignBsFromLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  bs == null )
    		throw new ProcessingException( "Bs already has nothing assigned." );  
    ...
    public void handle(AssignBtToLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  bt != null && bt.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Bt already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignBtToLoadGenericNonLinearEvent(command.getLoadGenericNonLinearId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignBtFromLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  bt == null )
    		throw new ProcessingException( "Bt already has nothing assigned." );  
    ...
    public void handle(AssignLsToLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  ls != null && ls.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Ls already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignLsToLoadGenericNonLinearEvent(command.getLoadGenericNonLinearId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignLsFromLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  ls == null )
    		throw new ProcessingException( "Ls already has nothing assigned." );  
    ...
    public void handle(AssignLtToLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  lt != null && lt.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Lt already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignLtToLoadGenericNonLinearEvent(command.getLoadGenericNonLinearId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignLtFromLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  lt == null )
    		throw new ProcessingException( "Lt already has nothing assigned." );  
    ...
    public void handle(AssignPtToLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  pt != null && pt.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Pt already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignPtToLoadGenericNonLinearEvent(command.getLoadGenericNonLinearId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignPtFromLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  pt == null )
    		throw new ProcessingException( "Pt already has nothing assigned." );  
    ...
    public void handle(AssignQtToLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  qt != null && qt.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Qt already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignQtToLoadGenericNonLinearEvent(command.getLoadGenericNonLinearId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQtFromLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  qt == null )
    		throw new ProcessingException( "Qt already has nothing assigned." );  
    ...
    public void handle(AssignTpToLoadGenericNonLinearCommand command) throws Exception {
        ...
        apply(new AssignTpToLoadGenericNonLinearEvent(command.getLoadGenericNonLinearId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTqToLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  tq != null && tq.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tq already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTqToLoadGenericNonLinearEvent(command.getLoadGenericNonLinearId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTqFromLoadGenericNonLinearCommand command) throws Exception {
    	...
    	if (  tq == null )
    		throw new ProcessingException( "Tq already has nothing assigned." );  
