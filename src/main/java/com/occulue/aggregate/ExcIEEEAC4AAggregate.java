...
public class ExcIEEEAC4AAggregate {  
    ...
    public void handle(UpdateExcIEEEAC4ACommand command) throws Exception {
    	...
    	UpdateExcIEEEAC4AEvent event = new UpdateExcIEEEAC4AEvent(command.getExcIEEEAC4AId(), command.Ka(), command.Kc(), command.Ta(), command.Tb(), command.Tc(), command.Vimax(), command.Vimin(), command.Vrmax(), command.Vrmin());        
