...
public class RemoteInputSignalAggregate {  
    ...
    public RemoteInputSignalAggregate(CreateRemoteInputSignalCommand command) throws Exception {
    	...
    	CreateRemoteInputSignalEvent event = new CreateRemoteInputSignalEvent(command.getRemoteInputSignalId(), command.RemoteSignalType());
    ...
    public void handle(UpdateRemoteInputSignalCommand command) throws Exception {
    	...
    	UpdateRemoteInputSignalEvent event = new UpdateRemoteInputSignalEvent(command.getRemoteInputSignalId(), command.RemoteSignalType());        
