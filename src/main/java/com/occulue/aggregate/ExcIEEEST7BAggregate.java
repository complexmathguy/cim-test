...
public class ExcIEEEST7BAggregate {  
    ...
    public ExcIEEEST7BAggregate(CreateExcIEEEST7BCommand command) throws Exception {
    	...
    	CreateExcIEEEST7BEvent event = new CreateExcIEEEST7BEvent(command.getExcIEEEST7BId(), command.Oelin(), command.Uelin());
    ...
    public void handle(UpdateExcIEEEST7BCommand command) throws Exception {
    	...
    	UpdateExcIEEEST7BEvent event = new UpdateExcIEEEST7BEvent(command.getExcIEEEST7BId(), command.Kh(), command.Kia(), command.Kl(), command.Kpa(), command.Oelin(), command.Tb(), command.Tc(), command.Tf(), command.Tg(), command.Tia(), command.Uelin(), command.Vmax(), command.Vmin(), command.Vrmax(), command.Vrmin());        
