...
public class PFVArType1IEEEVArControllerAggregate {  
    ...
    public PFVArType1IEEEVArControllerAggregate(CreatePFVArType1IEEEVArControllerCommand command) throws Exception {
    	...
    	CreatePFVArType1IEEEVArControllerEvent event = new CreatePFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId());
    ...
    public void handle(UpdatePFVArType1IEEEVArControllerCommand command) throws Exception {
    	...
    	UpdatePFVArType1IEEEVArControllerEvent event = new UpdatePFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId(), command.Tvarc(), command.Vvar(), command.Vvarcbw(), command.Vvarref(), command.Vvtmax(), command.Vvtmin());        
    ...
    public void handle(AssignTvarcToPFVArType1IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  tvarc != null && tvarc.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tvarc already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTvarcToPFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTvarcFromPFVArType1IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  tvarc == null )
    		throw new ProcessingException( "Tvarc already has nothing assigned." );  

    	apply(new UnAssignTvarcFromPFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId()));
    }
    @CommandHandler
    public void handle(AssignVvarToPFVArType1IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  vvar != null && vvar.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vvar already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVvarToPFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVvarFromPFVArType1IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  vvar == null )
    		throw new ProcessingException( "Vvar already has nothing assigned." );  

    	apply(new UnAssignVvarFromPFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId()));
    }
    @CommandHandler
    public void handle(AssignVvarcbwToPFVArType1IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  vvarcbw != null && vvarcbw.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Vvarcbw already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignVvarcbwToPFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignVvarcbwFromPFVArType1IEEEVArControllerCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignVvarcbwFromPFVArType1IEEEVArControllerCommand" );

    	if (  vvarcbw == null )
    		throw new ProcessingException( "Vvarcbw already has nothing assigned." );  

    	apply(new UnAssignVvarcbwFromPFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId()));
    }
    @CommandHandler
    public void handle(AssignVvarrefToPFVArType1IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  vvarref != null && vvarref.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vvarref already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVvarrefToPFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignVvarrefFromPFVArType1IEEEVArControllerCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignVvarrefFromPFVArType1IEEEVArControllerCommand" );

    	if (  vvarref == null )
    		throw new ProcessingException( "Vvarref already has nothing assigned." );  

    	apply(new UnAssignVvarrefFromPFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId()));
    }
    @CommandHandler
    public void handle(AssignVvtmaxToPFVArType1IEEEVArControllerCommand command) throws Exception {
        ...
        apply(new AssignVvtmaxToPFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignVvtmaxFromPFVArType1IEEEVArControllerCommand command) throws Exception {
    	...
    	apply(new UnAssignVvtmaxFromPFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId()));
    }
    @CommandHandler
    public void handle(AssignVvtminToPFVArType1IEEEVArControllerCommand command) throws Exception {
        ...
        apply(new AssignVvtminToPFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignVvtminFromPFVArType1IEEEVArControllerCommand command) throws Exception {
    	...
    	apply(new UnAssignVvtminFromPFVArType1IEEEVArControllerEvent(command.getPFVArType1IEEEVArControllerId()));
    }
