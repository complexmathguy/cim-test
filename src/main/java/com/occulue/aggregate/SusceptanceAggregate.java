...
public class SusceptanceAggregate {  
    ...
    public SusceptanceAggregate(CreateSusceptanceCommand command) throws Exception {
    	...
    	CreateSusceptanceEvent event = new CreateSusceptanceEvent(command.getSusceptanceId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateSusceptanceCommand command) throws Exception {
    	...
    	UpdateSusceptanceEvent event = new UpdateSusceptanceEvent(command.getSusceptanceId(), command.Multiplier(), command.Unit(), command.Value());        
