...
public class DiscExcContIEEEDEC1AAggregate {  
    ...
    public DiscExcContIEEEDEC1AAggregate(CreateDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	CreateDiscExcContIEEEDEC1AEvent event = new CreateDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId());
    ...
    public void handle(UpdateDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	UpdateDiscExcContIEEEDEC1AEvent event = new UpdateDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.Esc(), command.Kan(), command.Ketl(), command.Tan(), command.Td(), command.Tl1(), command.Tl2(), command.Tw5(), command.Value(), command.Vanmax(), command.Vomax(), command.Vomin(), command.Vsmax(), command.Vsmin(), command.Vtc(), command.Vtlmt(), command.Vtm(), command.Vtn());        
    ...
    public void handle(AssignEscToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  esc != null && esc.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Esc already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignEscToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEscFromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  esc == null )
    		throw new ProcessingException( "Esc already has nothing assigned." );  
    ...
    public void handle(AssignKanToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  kan != null && kan.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kan already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKanToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKanFromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  kan == null )
    		throw new ProcessingException( "Kan already has nothing assigned." );  
    ...
    public void handle(AssignKetlToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  ketl != null && ketl.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Ketl already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKetlToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKetlFromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  ketl == null )
    		throw new ProcessingException( "Ketl already has nothing assigned." );  
    ...
    public void handle(AssignTanToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  tan != null && tan.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tan already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTanToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTanFromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  tan == null )
    		throw new ProcessingException( "Tan already has nothing assigned." );  
    ...
    public void handle(AssignTdToDiscExcContIEEEDEC1ACommand command) throws Exception {
        ...
        apply(new AssignTdToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTl1ToDiscExcContIEEEDEC1ACommand command) throws Exception {
        ...
        apply(new AssignTl1ToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTl2ToDiscExcContIEEEDEC1ACommand command) throws Exception {
        ...
        apply(new AssignTl2ToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTw5ToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  tw5 != null && tw5.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tw5 already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTw5ToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTw5FromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  tw5 == null )
    		throw new ProcessingException( "Tw5 already has nothing assigned." );  
    ...
    public void handle(AssignValueToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  value != null && value.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Value already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignValueToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(AssignVanmaxToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vanmax != null && vanmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vanmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVanmaxToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVanmaxFromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vanmax == null )
    		throw new ProcessingException( "Vanmax already has nothing assigned." );  
    ...
    public void handle(AssignVomaxToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vomax != null && vomax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vomax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVomaxToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVomaxFromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vomax == null )
    		throw new ProcessingException( "Vomax already has nothing assigned." );  
    ...
    public void handle(AssignVominToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vomin != null && vomin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vomin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVominToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVominFromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vomin == null )
    		throw new ProcessingException( "Vomin already has nothing assigned." );  
    ...
    public void handle(AssignVsmaxToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vsmax != null && vsmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vsmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVsmaxToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVsmaxFromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vsmax == null )
    		throw new ProcessingException( "Vsmax already has nothing assigned." );  
    ...
    public void handle(AssignVsminToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vsmin != null && vsmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vsmin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVsminToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVsminFromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vsmin == null )
    		throw new ProcessingException( "Vsmin already has nothing assigned." );  
    ...
    public void handle(AssignVtcToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vtc != null && vtc.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vtc already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVtcToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVtcFromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vtc == null )
    		throw new ProcessingException( "Vtc already has nothing assigned." );  
    ...
    public void handle(AssignVtlmtToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vtlmt != null && vtlmt.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vtlmt already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVtlmtToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVtlmtFromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vtlmt == null )
    		throw new ProcessingException( "Vtlmt already has nothing assigned." );  
    ...
    public void handle(AssignVtmToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vtm != null && vtm.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vtm already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVtmToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVtmFromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vtm == null )
    		throw new ProcessingException( "Vtm already has nothing assigned." );  
    ...
    public void handle(AssignVtnToDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vtn != null && vtn.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vtn already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVtnToDiscExcContIEEEDEC1AEvent(command.getDiscExcContIEEEDEC1AId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVtnFromDiscExcContIEEEDEC1ACommand command) throws Exception {
    	...
    	if (  vtn == null )
    		throw new ProcessingException( "Vtn already has nothing assigned." );  
