...
public class TapChangerTablePointAggregate {  
    ...
    public TapChangerTablePointAggregate(CreateTapChangerTablePointCommand command) throws Exception {
    	...
    	CreateTapChangerTablePointEvent event = new CreateTapChangerTablePointEvent(command.getTapChangerTablePointId());
    ...
    public void handle(UpdateTapChangerTablePointCommand command) throws Exception {
    	...
    	UpdateTapChangerTablePointEvent event = new UpdateTapChangerTablePointEvent(command.getTapChangerTablePointId(), command.B(), command.G(), command.R(), command.Ratio(), command.Step(), command.X());        
    ...
    public void handle(AssignBToTapChangerTablePointCommand command) throws Exception {
    	...
    	if (  b != null && b.getPerCentId() == command.getAssignment().getPerCentId() )
    		throw new ProcessingException( "B already assigned with id " + command.getAssignment().getPerCentId() );  
    		
        apply(new AssignBToTapChangerTablePointEvent(command.getTapChangerTablePointId(), command.getAssignment()));
    }
    ...
    public void handle(AssignGToTapChangerTablePointCommand command) throws Exception {
    	...
    	if (  g != null && g.getPerCentId() == command.getAssignment().getPerCentId() )
    		throw new ProcessingException( "G already assigned with id " + command.getAssignment().getPerCentId() );  
    		
        apply(new AssignGToTapChangerTablePointEvent(command.getTapChangerTablePointId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRToTapChangerTablePointCommand command) throws Exception {
    	...
    	if (  r != null && r.getPerCentId() == command.getAssignment().getPerCentId() )
    		throw new ProcessingException( "R already assigned with id " + command.getAssignment().getPerCentId() );  
    		
        apply(new AssignRToTapChangerTablePointEvent(command.getTapChangerTablePointId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRatioToTapChangerTablePointCommand command) throws Exception {
    	...
    	if (  ratio != null && ratio.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Ratio already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignRatioToTapChangerTablePointEvent(command.getTapChangerTablePointId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignRatioFromTapChangerTablePointCommand command) throws Exception {
    	...
    	if (  ratio == null )
    		throw new ProcessingException( "Ratio already has nothing assigned." );  
    ...
    public void handle(AssignStepToTapChangerTablePointCommand command) throws Exception {
    	...
    	if (  step != null && step.getIntegerProxyId() == command.getAssignment().getIntegerProxyId() )
    		throw new ProcessingException( "Step already assigned with id " + command.getAssignment().getIntegerProxyId() );  
    		
        apply(new AssignStepToTapChangerTablePointEvent(command.getTapChangerTablePointId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignStepFromTapChangerTablePointCommand command) throws Exception {
    	...
    	if (  step == null )
    		throw new ProcessingException( "Step already has nothing assigned." );  
    ...
    public void handle(AssignXToTapChangerTablePointCommand command) throws Exception {
    	...
    	if (  x != null && x.getPerCentId() == command.getAssignment().getPerCentId() )
    		throw new ProcessingException( "X already assigned with id " + command.getAssignment().getPerCentId() );  
    		
        apply(new AssignXToTapChangerTablePointEvent(command.getTapChangerTablePointId(), command.getAssignment()));
    }
