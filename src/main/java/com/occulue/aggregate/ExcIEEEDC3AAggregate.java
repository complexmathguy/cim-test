...
public class ExcIEEEDC3AAggregate {  
    ...
    public void handle(UpdateExcIEEEDC3ACommand command) throws Exception {
    	...
    	UpdateExcIEEEDC3AEvent event = new UpdateExcIEEEDC3AEvent(command.getExcIEEEDC3AId(), command.Efd1(), command.Efd2(), command.Exclim(), command.Ke(), command.Kv(), command.Seefd1(), command.Seefd2(), command.Te(), command.Trh(), command.Vrmax(), command.Vrmin());        
