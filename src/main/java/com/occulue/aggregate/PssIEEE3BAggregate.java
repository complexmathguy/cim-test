...
public class PssIEEE3BAggregate {  
    ...
    public PssIEEE3BAggregate(CreatePssIEEE3BCommand command) throws Exception {
    	...
    	CreatePssIEEE3BEvent event = new CreatePssIEEE3BEvent(command.getPssIEEE3BId(), command.InputSignal1Type(), command.InputSignal2Type());
    ...
    public void handle(UpdatePssIEEE3BCommand command) throws Exception {
    	...
    	UpdatePssIEEE3BEvent event = new UpdatePssIEEE3BEvent(command.getPssIEEE3BId(), command.A1(), command.A2(), command.A3(), command.A4(), command.A5(), command.A6(), command.A7(), command.A8(), command.InputSignal1Type(), command.InputSignal2Type(), command.Ks1(), command.Ks2(), command.T1(), command.T2(), command.Tw1(), command.Tw2(), command.Tw3(), command.Vstmax(), command.Vstmin());        
