...
public class WindContPType3IECAggregate {  
    ...
    public void handle(UpdateWindContPType3IECCommand command) throws Exception {
    	...
    	UpdateWindContPType3IECEvent event = new UpdateWindContPType3IECEvent(command.getWindContPType3IECId(), command.Dpmax(), command.Dtrisemaxlvrt(), command.Kdtd(), command.Kip(), command.Kpp(), command.Mplvrt(), command.Omegaoffset(), command.Pdtdmax(), command.Rramp(), command.Tdvs(), command.Temin(), command.Tomegafilt(), command.Tpfilt(), command.Tpord(), command.Tufilt(), command.Tuscale(), command.Twref(), command.Udvs(), command.Updip(), command.Wdtd(), command.Zeta());        
    ...
    public void handle(AssignDpmaxToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  dpmax != null && dpmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Dpmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignDpmaxToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDpmaxFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  dpmax == null )
    		throw new ProcessingException( "Dpmax already has nothing assigned." );  
    ...
    public void handle(AssignDtrisemaxlvrtToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  dtrisemaxlvrt != null && dtrisemaxlvrt.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Dtrisemaxlvrt already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignDtrisemaxlvrtToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignKdtdToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  kdtd != null && kdtd.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kdtd already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKdtdToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKdtdFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  kdtd == null )
    		throw new ProcessingException( "Kdtd already has nothing assigned." );  
    ...
    public void handle(AssignKipToWindContPType3IECCommand command) throws Exception {
        ...
        apply(new AssignKipToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignKppToWindContPType3IECCommand command) throws Exception {
        ...
        apply(new AssignKppToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignMplvrtToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  mplvrt != null && mplvrt.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Mplvrt already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignMplvrtToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMplvrtFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  mplvrt == null )
    		throw new ProcessingException( "Mplvrt already has nothing assigned." );  
    ...
    public void handle(AssignOmegaoffsetToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  omegaoffset != null && omegaoffset.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Omegaoffset already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignOmegaoffsetToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignPdtdmaxToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  pdtdmax != null && pdtdmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Pdtdmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignPdtdmaxToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignPdtdmaxFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  pdtdmax == null )
    		throw new ProcessingException( "Pdtdmax already has nothing assigned." );  
    ...
    public void handle(AssignRrampToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  rramp != null && rramp.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Rramp already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignRrampToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignRrampFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  rramp == null )
    		throw new ProcessingException( "Rramp already has nothing assigned." );  
    ...
    public void handle(AssignTdvsToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  tdvs != null && tdvs.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tdvs already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTdvsToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTdvsFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  tdvs == null )
    		throw new ProcessingException( "Tdvs already has nothing assigned." );  
    ...
    public void handle(AssignTeminToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  temin != null && temin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Temin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignTeminToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTeminFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  temin == null )
    		throw new ProcessingException( "Temin already has nothing assigned." );  
    ...
    public void handle(AssignTomegafiltToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  tomegafilt != null && tomegafilt.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tomegafilt already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTomegafiltToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTpfiltToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  tpfilt != null && tpfilt.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tpfilt already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTpfiltToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTpfiltFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  tpfilt == null )
    		throw new ProcessingException( "Tpfilt already has nothing assigned." );  
    ...
    public void handle(AssignTpordToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  tpord != null && tpord.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Tpord already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignTpordToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTpordFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  tpord == null )
    		throw new ProcessingException( "Tpord already has nothing assigned." );  
    ...
    public void handle(AssignTufiltToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  tufilt != null && tufilt.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tufilt already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTufiltToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTufiltFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  tufilt == null )
    		throw new ProcessingException( "Tufilt already has nothing assigned." );  
    ...
    public void handle(AssignTuscaleToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  tuscale != null && tuscale.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Tuscale already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignTuscaleToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTuscaleFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  tuscale == null )
    		throw new ProcessingException( "Tuscale already has nothing assigned." );  
    ...
    public void handle(AssignTwrefToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  twref != null && twref.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Twref already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTwrefToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTwrefFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  twref == null )
    		throw new ProcessingException( "Twref already has nothing assigned." );  
    ...
    public void handle(AssignUdvsToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  udvs != null && udvs.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Udvs already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignUdvsToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignUdvsFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  udvs == null )
    		throw new ProcessingException( "Udvs already has nothing assigned." );  
    ...
    public void handle(AssignUpdipToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  updip != null && updip.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Updip already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignUpdipToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignUpdipFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  updip == null )
    		throw new ProcessingException( "Updip already has nothing assigned." );  
    ...
    public void handle(AssignWdtdToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  wdtd != null && wdtd.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Wdtd already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignWdtdToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignWdtdFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  wdtd == null )
    		throw new ProcessingException( "Wdtd already has nothing assigned." );  
    ...
    public void handle(AssignZetaToWindContPType3IECCommand command) throws Exception {
    	...
    	if (  zeta != null && zeta.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Zeta already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignZetaToWindContPType3IECEvent(command.getWindContPType3IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignZetaFromWindContPType3IECCommand command) throws Exception {
    	...
    	if (  zeta == null )
    		throw new ProcessingException( "Zeta already has nothing assigned." );  
