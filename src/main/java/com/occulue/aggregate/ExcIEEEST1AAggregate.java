...
public class ExcIEEEST1AAggregate {  
    ...
    public ExcIEEEST1AAggregate(CreateExcIEEEST1ACommand command) throws Exception {
    	...
    	CreateExcIEEEST1AEvent event = new CreateExcIEEEST1AEvent(command.getExcIEEEST1AId(), command.Uelin());
    ...
    public void handle(UpdateExcIEEEST1ACommand command) throws Exception {
    	...
    	UpdateExcIEEEST1AEvent event = new UpdateExcIEEEST1AEvent(command.getExcIEEEST1AId(), command.Ilr(), command.Ka(), command.Kc(), command.Kf(), command.Klr(), command.Pssin(), command.Ta(), command.Tb(), command.Tb1(), command.Tc(), command.Tc1(), command.Tf(), command.Uelin(), command.Vamax(), command.Vamin(), command.Vimax(), command.Vimin(), command.Vrmax(), command.Vrmin());        
    ...
    public void handle(AssignPssinToExcIEEEST1ACommand command) throws Exception {
    	...
    	if (  pssin != null && pssin.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Pssin already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(UnAssignPssinFromExcIEEEST1ACommand command) throws Exception {
    	...
    	if (  pssin == null )
    		throw new ProcessingException( "Pssin already has nothing assigned." );  
