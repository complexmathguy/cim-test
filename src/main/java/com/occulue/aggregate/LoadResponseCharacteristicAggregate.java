...
public class LoadResponseCharacteristicAggregate {  
    ...
    public LoadResponseCharacteristicAggregate(CreateLoadResponseCharacteristicCommand command) throws Exception {
    	...
    	CreateLoadResponseCharacteristicEvent event = new CreateLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId());
    ...
    public void handle(UpdateLoadResponseCharacteristicCommand command) throws Exception {
    	...
    	UpdateLoadResponseCharacteristicEvent event = new UpdateLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId(), command.ExponentModel(), command.PConstantCurrent(), command.PConstantImpedance(), command.PConstantPower(), command.PFrequencyExponent(), command.PVoltageExponent(), command.QConstantCurrent(), command.QConstantImpedance(), command.QConstantPower(), command.QFrequencyExponent(), command.QVoltageExponent());        
    ...
    @CommandHandler
    public void handle(AssignExponentModelToLoadResponseCharacteristicCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignExponentModelToLoadResponseCharacteristicCommand" );
    	
    	if (  exponentModel != null && exponentModel.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "ExponentModel already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignExponentModelToLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignExponentModelFromLoadResponseCharacteristicCommand command) throws Exception {
    	...
    	apply(new UnAssignExponentModelFromLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId()));
    }
    @CommandHandler
    public void handle(AssignPConstantCurrentToLoadResponseCharacteristicCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignPConstantCurrentToLoadResponseCharacteristicCommand" );
    	
    	if (  pConstantCurrent != null && pConstantCurrent.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "PConstantCurrent already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignPConstantCurrentToLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignPConstantCurrentFromLoadResponseCharacteristicCommand command) throws Exception {
    	...
    	apply(new UnAssignPConstantCurrentFromLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId()));
    }
    @CommandHandler
    public void handle(AssignPConstantImpedanceToLoadResponseCharacteristicCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignPConstantImpedanceToLoadResponseCharacteristicCommand" );
    	
    	if (  pConstantImpedance != null && pConstantImpedance.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "PConstantImpedance already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignPConstantImpedanceToLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignPConstantImpedanceFromLoadResponseCharacteristicCommand command) throws Exception {
    	...
    	apply(new UnAssignPConstantImpedanceFromLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId()));
    }
    @CommandHandler
    public void handle(AssignPConstantPowerToLoadResponseCharacteristicCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignPConstantPowerToLoadResponseCharacteristicCommand" );
    	
    	if (  pConstantPower != null && pConstantPower.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "PConstantPower already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignPConstantPowerToLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignPConstantPowerFromLoadResponseCharacteristicCommand command) throws Exception {
    	...
    	apply(new UnAssignPConstantPowerFromLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId()));
    }
    @CommandHandler
    public void handle(AssignPFrequencyExponentToLoadResponseCharacteristicCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignPFrequencyExponentToLoadResponseCharacteristicCommand" );
    	
    	if (  pFrequencyExponent != null && pFrequencyExponent.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "PFrequencyExponent already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignPFrequencyExponentToLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignPFrequencyExponentFromLoadResponseCharacteristicCommand command) throws Exception {
    	...
    	apply(new UnAssignPFrequencyExponentFromLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId()));
    }
    @CommandHandler
    public void handle(AssignPVoltageExponentToLoadResponseCharacteristicCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignPVoltageExponentToLoadResponseCharacteristicCommand" );
    	
    	if (  pVoltageExponent != null && pVoltageExponent.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "PVoltageExponent already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignPVoltageExponentToLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignPVoltageExponentFromLoadResponseCharacteristicCommand command) throws Exception {
    	...
    	apply(new UnAssignPVoltageExponentFromLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId()));
    }
    @CommandHandler
    public void handle(AssignQConstantCurrentToLoadResponseCharacteristicCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignQConstantCurrentToLoadResponseCharacteristicCommand" );
    	
    	if (  qConstantCurrent != null && qConstantCurrent.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "QConstantCurrent already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignQConstantCurrentToLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignQConstantCurrentFromLoadResponseCharacteristicCommand command) throws Exception {
    	...
    	apply(new UnAssignQConstantCurrentFromLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId()));
    }
    @CommandHandler
    public void handle(AssignQConstantImpedanceToLoadResponseCharacteristicCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignQConstantImpedanceToLoadResponseCharacteristicCommand" );
    	
    	if (  qConstantImpedance != null && qConstantImpedance.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "QConstantImpedance already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignQConstantImpedanceToLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignQConstantImpedanceFromLoadResponseCharacteristicCommand command) throws Exception {
    	...
    	apply(new UnAssignQConstantImpedanceFromLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId()));
    }
    @CommandHandler
    public void handle(AssignQConstantPowerToLoadResponseCharacteristicCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignQConstantPowerToLoadResponseCharacteristicCommand" );
    	
    	if (  qConstantPower != null && qConstantPower.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "QConstantPower already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignQConstantPowerToLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignQConstantPowerFromLoadResponseCharacteristicCommand command) throws Exception {
    	...
    	apply(new UnAssignQConstantPowerFromLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId()));
    }
    @CommandHandler
    public void handle(AssignQFrequencyExponentToLoadResponseCharacteristicCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignQFrequencyExponentToLoadResponseCharacteristicCommand" );
    	
    	if (  qFrequencyExponent != null && qFrequencyExponent.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "QFrequencyExponent already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignQFrequencyExponentToLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignQFrequencyExponentFromLoadResponseCharacteristicCommand command) throws Exception {
    	...
    	apply(new UnAssignQFrequencyExponentFromLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId()));
    }
    @CommandHandler
    public void handle(AssignQVoltageExponentToLoadResponseCharacteristicCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignQVoltageExponentToLoadResponseCharacteristicCommand" );
    	
    	if (  qVoltageExponent != null && qVoltageExponent.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "QVoltageExponent already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignQVoltageExponentToLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignQVoltageExponentFromLoadResponseCharacteristicCommand command) throws Exception {
    	...
    	apply(new UnAssignQVoltageExponentFromLoadResponseCharacteristicEvent(command.getLoadResponseCharacteristicId()));
    }
