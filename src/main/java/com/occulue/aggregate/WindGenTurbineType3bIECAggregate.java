...
public class WindGenTurbineType3bIECAggregate {  
    ...
    public WindGenTurbineType3bIECAggregate(CreateWindGenTurbineType3bIECCommand command) throws Exception {
    	...
    	CreateWindGenTurbineType3bIECEvent event = new CreateWindGenTurbineType3bIECEvent(command.getWindGenTurbineType3bIECId());
    ...
    public void handle(UpdateWindGenTurbineType3bIECCommand command) throws Exception {
    	...
    	UpdateWindGenTurbineType3bIECEvent event = new UpdateWindGenTurbineType3bIECEvent(command.getWindGenTurbineType3bIECId(), command.Fducw(), command.Mwtcwp(), command.Tg(), command.Two(), command.Xs());        
    ...
    public void handle(AssignFducwToWindGenTurbineType3bIECCommand command) throws Exception {
    	...
    	if (  fducw != null && fducw.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Fducw already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignFducwToWindGenTurbineType3bIECEvent(command.getWindGenTurbineType3bIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignFducwFromWindGenTurbineType3bIECCommand command) throws Exception {
    	...
    	if (  fducw == null )
    		throw new ProcessingException( "Fducw already has nothing assigned." );  

    	apply(new UnAssignFducwFromWindGenTurbineType3bIECEvent(command.getWindGenTurbineType3bIECId()));
    }
    @CommandHandler
    public void handle(AssignMwtcwpToWindGenTurbineType3bIECCommand command) throws Exception {
    	...
    	if (  mwtcwp != null && mwtcwp.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Mwtcwp already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignMwtcwpToWindGenTurbineType3bIECEvent(command.getWindGenTurbineType3bIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMwtcwpFromWindGenTurbineType3bIECCommand command) throws Exception {
    	...
    	if (  mwtcwp == null )
    		throw new ProcessingException( "Mwtcwp already has nothing assigned." );  

    	apply(new UnAssignMwtcwpFromWindGenTurbineType3bIECEvent(command.getWindGenTurbineType3bIECId()));
    }
    @CommandHandler
    public void handle(AssignTgToWindGenTurbineType3bIECCommand command) throws Exception {
        ...
        apply(new AssignTgToWindGenTurbineType3bIECEvent(command.getWindGenTurbineType3bIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTwoToWindGenTurbineType3bIECCommand command) throws Exception {
    	...
    	if (  two != null && two.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Two already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTwoToWindGenTurbineType3bIECEvent(command.getWindGenTurbineType3bIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTwoFromWindGenTurbineType3bIECCommand command) throws Exception {
    	...
    	if (  two == null )
    		throw new ProcessingException( "Two already has nothing assigned." );  
    ...
    public void handle(AssignXsToWindGenTurbineType3bIECCommand command) throws Exception {
        ...
        apply(new AssignXsToWindGenTurbineType3bIECEvent(command.getWindGenTurbineType3bIECId(), command.getAssignment()));
    }
