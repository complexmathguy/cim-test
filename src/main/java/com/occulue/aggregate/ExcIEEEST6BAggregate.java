...
public class ExcIEEEST6BAggregate {  
    ...
    public ExcIEEEST6BAggregate(CreateExcIEEEST6BCommand command) throws Exception {
    	...
    	CreateExcIEEEST6BEvent event = new CreateExcIEEEST6BEvent(command.getExcIEEEST6BId(), command.Oelin());
    ...
    public void handle(UpdateExcIEEEST6BCommand command) throws Exception {
    	...
    	UpdateExcIEEEST6BEvent event = new UpdateExcIEEEST6BEvent(command.getExcIEEEST6BId(), command.Ilr(), command.Kci(), command.Kff(), command.Kg(), command.Kia(), command.Klr(), command.Km(), command.Kpa(), command.Oelin(), command.Tg(), command.Vamax(), command.Vamin(), command.Vrmax(), command.Vrmin());        
    ...
    public void handle(AssignKciToExcIEEEST6BCommand command) throws Exception {
    	...
    	if (  kci != null && kci.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kci already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignKciFromExcIEEEST6BCommand command) throws Exception {
    	...
    	if (  kci == null )
    		throw new ProcessingException( "Kci already has nothing assigned." );  
