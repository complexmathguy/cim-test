...
public class ActivePowerPerCurrentFlowAggregate {  
    ...
    public ActivePowerPerCurrentFlowAggregate(CreateActivePowerPerCurrentFlowCommand command) throws Exception {
    	...
    	CreateActivePowerPerCurrentFlowEvent event = new CreateActivePowerPerCurrentFlowEvent(command.getActivePowerPerCurrentFlowId());
    ...
    public void handle(UpdateActivePowerPerCurrentFlowCommand command) throws Exception {
    	...
    	UpdateActivePowerPerCurrentFlowEvent event = new UpdateActivePowerPerCurrentFlowEvent(command.getActivePowerPerCurrentFlowId());        
