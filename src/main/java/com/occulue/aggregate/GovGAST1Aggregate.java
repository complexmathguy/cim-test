...
public class GovGAST1Aggregate {  
    ...
    public void handle(UpdateGovGAST1Command command) throws Exception {
    	...
    	UpdateGovGAST1Event event = new UpdateGovGAST1Event(command.getGovGAST1Id(), command.A(), command.B(), command.Db1(), command.Db2(), command.Eps(), command.Fidle(), command.Gv1(), command.Gv2(), command.Gv3(), command.Gv4(), command.Gv5(), command.Gv6(), command.Ka(), command.Kt(), command.Lmax(), command.Loadinc(), command.Ltrate(), command.Mwbase(), command.Pgv1(), command.Pgv2(), command.Pgv3(), command.Pgv4(), command.Pgv5(), command.Pgv6(), command.R(), command.Rmax(), command.T1(), command.T2(), command.T3(), command.T4(), command.T5(), command.Tltr(), command.Vmax(), command.Vmin());        
    ...
    public void handle(AssignAToGovGAST1Command command) throws Exception {
    	...
    	if (  a != null && a.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "A already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    ...
    public void handle(UnAssignAFromGovGAST1Command command) throws Exception {
    	...
    	if (  a == null )
    		throw new ProcessingException( "A already has nothing assigned." );  
    ...
    public void handle(AssignBToGovGAST1Command command) throws Exception {
    	...
    	if (  b != null && b.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "B already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    ...
    public void handle(AssignFidleToGovGAST1Command command) throws Exception {
    	...
    	if (  fidle != null && fidle.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Fidle already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignFidleFromGovGAST1Command command) throws Exception {
    	...
    	if (  fidle == null )
    		throw new ProcessingException( "Fidle already has nothing assigned." );  
    ...
    public void handle(AssignLmaxToGovGAST1Command command) throws Exception {
    	...
    	if (  lmax != null && lmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Lmax already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignLmaxFromGovGAST1Command command) throws Exception {
    	...
    	if (  lmax == null )
    		throw new ProcessingException( "Lmax already has nothing assigned." );  
    ...
    public void handle(AssignLoadincToGovGAST1Command command) throws Exception {
    	...
    	if (  loadinc != null && loadinc.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Loadinc already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignLoadincFromGovGAST1Command command) throws Exception {
    	...
    	if (  loadinc == null )
    		throw new ProcessingException( "Loadinc already has nothing assigned." );  
    ...
    public void handle(AssignLtrateToGovGAST1Command command) throws Exception {
    	...
    	if (  ltrate != null && ltrate.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Ltrate already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    ...
    public void handle(UnAssignLtrateFromGovGAST1Command command) throws Exception {
    	...
    	if (  ltrate == null )
    		throw new ProcessingException( "Ltrate already has nothing assigned." );  
    ...
    public void handle(AssignRmaxToGovGAST1Command command) throws Exception {
    	...
    	if (  rmax != null && rmax.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Rmax already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    ...
    public void handle(UnAssignRmaxFromGovGAST1Command command) throws Exception {
    	...
    	if (  rmax == null )
    		throw new ProcessingException( "Rmax already has nothing assigned." );  
    ...
    public void handle(AssignTltrToGovGAST1Command command) throws Exception {
    	...
    	if (  tltr != null && tltr.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tltr already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(UnAssignTltrFromGovGAST1Command command) throws Exception {
    	...
    	if (  tltr == null )
    		throw new ProcessingException( "Tltr already has nothing assigned." );  
