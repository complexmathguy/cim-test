...
public class SynchronousMachineDetailedAggregate {  
    ...
    public SynchronousMachineDetailedAggregate(CreateSynchronousMachineDetailedCommand command) throws Exception {
    	...
    	CreateSynchronousMachineDetailedEvent event = new CreateSynchronousMachineDetailedEvent(command.getSynchronousMachineDetailedId(), command.IfdBaseType());
    ...
    public void handle(UpdateSynchronousMachineDetailedCommand command) throws Exception {
    	...
    	UpdateSynchronousMachineDetailedEvent event = new UpdateSynchronousMachineDetailedEvent(command.getSynchronousMachineDetailedId(), command.EfdBaseRatio(), command.IfdBaseType(), command.IfdBaseValue(), command.SaturationFactor120QAxis(), command.SaturationFactorQAxis());        
    ...
    @CommandHandler
    public void handle(AssignEfdBaseRatioToSynchronousMachineDetailedCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignEfdBaseRatioToSynchronousMachineDetailedCommand" );
    	
    	if (  efdBaseRatio != null && efdBaseRatio.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "EfdBaseRatio already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignEfdBaseRatioToSynchronousMachineDetailedEvent(command.getSynchronousMachineDetailedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEfdBaseRatioFromSynchronousMachineDetailedCommand command) throws Exception {
    	...
    	apply(new UnAssignEfdBaseRatioFromSynchronousMachineDetailedEvent(command.getSynchronousMachineDetailedId()));
    }
    @CommandHandler
    public void handle(AssignIfdBaseValueToSynchronousMachineDetailedCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignIfdBaseValueToSynchronousMachineDetailedCommand" );
    	
    	if (  ifdBaseValue != null && ifdBaseValue.getCurrentFlowId() == command.getAssignment().getCurrentFlowId() )
    		throw new ProcessingException( "IfdBaseValue already assigned with id " + command.getAssignment().getCurrentFlowId() );  
    		
        apply(new AssignIfdBaseValueToSynchronousMachineDetailedEvent(command.getSynchronousMachineDetailedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignIfdBaseValueFromSynchronousMachineDetailedCommand command) throws Exception {
    	...
    	apply(new UnAssignIfdBaseValueFromSynchronousMachineDetailedEvent(command.getSynchronousMachineDetailedId()));
    }
    @CommandHandler
    public void handle(AssignSaturationFactor120QAxisToSynchronousMachineDetailedCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignSaturationFactor120QAxisToSynchronousMachineDetailedCommand" );
    	
    	if (  saturationFactor120QAxis != null && saturationFactor120QAxis.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "SaturationFactor120QAxis already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignSaturationFactor120QAxisToSynchronousMachineDetailedEvent(command.getSynchronousMachineDetailedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignSaturationFactor120QAxisFromSynchronousMachineDetailedCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignSaturationFactor120QAxisFromSynchronousMachineDetailedCommand" );

    	if (  saturationFactor120QAxis == null )
    		throw new ProcessingException( "SaturationFactor120QAxis already has nothing assigned." );  

    	apply(new UnAssignSaturationFactor120QAxisFromSynchronousMachineDetailedEvent(command.getSynchronousMachineDetailedId()));
    }
    @CommandHandler
    public void handle(AssignSaturationFactorQAxisToSynchronousMachineDetailedCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignSaturationFactorQAxisToSynchronousMachineDetailedCommand" );
    	
    	if (  saturationFactorQAxis != null && saturationFactorQAxis.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "SaturationFactorQAxis already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignSaturationFactorQAxisToSynchronousMachineDetailedEvent(command.getSynchronousMachineDetailedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignSaturationFactorQAxisFromSynchronousMachineDetailedCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignSaturationFactorQAxisFromSynchronousMachineDetailedCommand" );

    	if (  saturationFactorQAxis == null )
    		throw new ProcessingException( "SaturationFactorQAxis already has nothing assigned." );  

    	apply(new UnAssignSaturationFactorQAxisFromSynchronousMachineDetailedEvent(command.getSynchronousMachineDetailedId()));
    }
	...
	void on(UnAssignSaturationFactor120QAxisFromSynchronousMachineDetailedEvent event ) {	
		LOGGER.info( "Event sourcing UnAssignSaturationFactor120QAxisFromSynchronousMachineDetailedEvent" );
