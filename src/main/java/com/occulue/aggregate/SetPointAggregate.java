...
public class SetPointAggregate {  
    ...
    public void handle(UpdateSetPointCommand command) throws Exception {
    	...
    	UpdateSetPointEvent event = new UpdateSetPointEvent(command.getSetPointId(), command.NormalValue(), command.Value());        
    ...
    public void handle(AssignNormalValueToSetPointCommand command) throws Exception {
    	...
    	if (  normalValue != null && normalValue.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "NormalValue already assigned with id " + command.getAssignment().getSimple_FloatId() );  
