...
public class GovSteamSGOAggregate {  
    ...
    public void handle(UpdateGovSteamSGOCommand command) throws Exception {
    	...
    	UpdateGovSteamSGOEvent event = new UpdateGovSteamSGOEvent(command.getGovSteamSGOId(), command.K1(), command.K2(), command.K3(), command.Mwbase(), command.Pmax(), command.Pmin(), command.T1(), command.T2(), command.T3(), command.T4(), command.T5(), command.T6());        
    ...
    public void handle(AssignPminToGovSteamSGOCommand command) throws Exception {
    	...
    	if (  pmin != null && pmin.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Pmin already assigned with id " + command.getAssignment().getSecondsId() );  
