...
public class SynchronousMachineUserDefinedAggregate {  
    ...
    public SynchronousMachineUserDefinedAggregate(CreateSynchronousMachineUserDefinedCommand command) throws Exception {
    	...
    	CreateSynchronousMachineUserDefinedEvent event = new CreateSynchronousMachineUserDefinedEvent(command.getSynchronousMachineUserDefinedId());
    ...
    public void handle(UpdateSynchronousMachineUserDefinedCommand command) throws Exception {
    	...
    	UpdateSynchronousMachineUserDefinedEvent event = new UpdateSynchronousMachineUserDefinedEvent(command.getSynchronousMachineUserDefinedId(), command.Proprietary());        
    ...
    @CommandHandler
    public void handle(AssignProprietaryToSynchronousMachineUserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToSynchronousMachineUserDefinedEvent(command.getSynchronousMachineUserDefinedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignProprietaryFromSynchronousMachineUserDefinedCommand command) throws Exception {
    	...
    	apply(new UnAssignProprietaryFromSynchronousMachineUserDefinedEvent(command.getSynchronousMachineUserDefinedId()));
    }
