...
public class DynamicsFunctionBlockAggregate {  
    ...
    public DynamicsFunctionBlockAggregate(CreateDynamicsFunctionBlockCommand command) throws Exception {
    	...
    	CreateDynamicsFunctionBlockEvent event = new CreateDynamicsFunctionBlockEvent(command.getDynamicsFunctionBlockId());
    ...
    public void handle(UpdateDynamicsFunctionBlockCommand command) throws Exception {
    	...
    	UpdateDynamicsFunctionBlockEvent event = new UpdateDynamicsFunctionBlockEvent(command.getDynamicsFunctionBlockId(), command.Enabled());        
    ...
    public void handle(AssignEnabledToDynamicsFunctionBlockCommand command) throws Exception {
    	...
    	if (  enabled != null && enabled.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Enabled already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignEnabledToDynamicsFunctionBlockEvent(command.getDynamicsFunctionBlockId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEnabledFromDynamicsFunctionBlockCommand command) throws Exception {
    	...
    	if (  enabled == null )
    		throw new ProcessingException( "Enabled already has nothing assigned." );  
