...
public class PssWECCAggregate {  
    ...
    public PssWECCAggregate(CreatePssWECCCommand command) throws Exception {
    	...
    	CreatePssWECCEvent event = new CreatePssWECCEvent(command.getPssWECCId(), command.InputSignal1Type(), command.InputSignal2Type());
    ...
    public void handle(UpdatePssWECCCommand command) throws Exception {
    	...
    	UpdatePssWECCEvent event = new UpdatePssWECCEvent(command.getPssWECCId(), command.InputSignal1Type(), command.InputSignal2Type(), command.K1(), command.K2(), command.T1(), command.T10(), command.T2(), command.T3(), command.T4(), command.T5(), command.T6(), command.T7(), command.T8(), command.T9(), command.Vcl(), command.Vcu(), command.Vsmax(), command.Vsmin());        
