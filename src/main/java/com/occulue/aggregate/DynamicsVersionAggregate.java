...
public class DynamicsVersionAggregate {  
    ...
    public void handle(UpdateDynamicsVersionCommand command) throws Exception {
    	...
    	UpdateDynamicsVersionEvent event = new UpdateDynamicsVersionEvent(command.getDynamicsVersionId(), command.BaseUML(), command.BaseURI(), command.Date(), command.DifferenceModelURI(), command.EntsoeUML(), command.EntsoeURI(), command.ModelDescriptionURI(), command.NamespaceRDF(), command.NamespaceUML(), command.ShortName());        
    ...
    public void handle(AssignBaseUMLToDynamicsVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseUMLToDynamicsVersionEvent(command.getDynamicsVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignBaseURIToDynamicsVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseURIToDynamicsVersionEvent(command.getDynamicsVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignDateToDynamicsVersionCommand command) throws Exception {
        ...
        apply(new AssignDateToDynamicsVersionEvent(command.getDynamicsVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignDifferenceModelURIToDynamicsVersionCommand command) throws Exception {
        ...
        apply(new AssignDifferenceModelURIToDynamicsVersionEvent(command.getDynamicsVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignDifferenceModelURIFromDynamicsVersionCommand command) throws Exception {
    ...
    public void handle(AssignEntsoeUMLToDynamicsVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeUMLToDynamicsVersionEvent(command.getDynamicsVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignEntsoeURIToDynamicsVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeURIToDynamicsVersionEvent(command.getDynamicsVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignModelDescriptionURIToDynamicsVersionCommand command) throws Exception {
        ...
        apply(new AssignModelDescriptionURIToDynamicsVersionEvent(command.getDynamicsVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignModelDescriptionURIFromDynamicsVersionCommand command) throws Exception {
    ...
    public void handle(AssignNamespaceRDFToDynamicsVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceRDFToDynamicsVersionEvent(command.getDynamicsVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignNamespaceUMLToDynamicsVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceUMLToDynamicsVersionEvent(command.getDynamicsVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignShortNameToDynamicsVersionCommand command) throws Exception {
        ...
        apply(new AssignShortNameToDynamicsVersionEvent(command.getDynamicsVersionId(), command.getAssignment()));
    }
