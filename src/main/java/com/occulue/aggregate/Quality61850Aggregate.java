...
public class Quality61850Aggregate {  
    ...
    public Quality61850Aggregate(CreateQuality61850Command command) throws Exception {
    	...
    	CreateQuality61850Event event = new CreateQuality61850Event(command.getQuality61850Id(), command.Source(), command.Validity());
    ...
    public void handle(UpdateQuality61850Command command) throws Exception {
    	...
    	UpdateQuality61850Event event = new UpdateQuality61850Event(command.getQuality61850Id(), command.BadReference(), command.EstimatorReplaced(), command.Failure(), command.OldData(), command.OperatorBlocked(), command.Oscillatory(), command.OutOfRange(), command.OverFlow(), command.Source(), command.Suspect(), command.Test(), command.Validity());        
    ...
    public void handle(AssignBadReferenceToQuality61850Command command) throws Exception {
    	...
    	if (  badReference != null && badReference.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "BadReference already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignBadReferenceToQuality61850Event(command.getQuality61850Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignEstimatorReplacedToQuality61850Command command) throws Exception {
    	...
    	if (  estimatorReplaced != null && estimatorReplaced.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "EstimatorReplaced already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignEstimatorReplacedToQuality61850Event(command.getQuality61850Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignFailureToQuality61850Command command) throws Exception {
    	...
    	if (  failure != null && failure.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Failure already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignFailureToQuality61850Event(command.getQuality61850Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignFailureFromQuality61850Command command) throws Exception {
    	...
    	if (  failure == null )
    		throw new ProcessingException( "Failure already has nothing assigned." );  
    ...
    public void handle(AssignOldDataToQuality61850Command command) throws Exception {
    	...
    	if (  oldData != null && oldData.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "OldData already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignOldDataToQuality61850Event(command.getQuality61850Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignOldDataFromQuality61850Command command) throws Exception {
    	...
    	if (  oldData == null )
    		throw new ProcessingException( "OldData already has nothing assigned." );  
    ...
    public void handle(AssignOperatorBlockedToQuality61850Command command) throws Exception {
    	...
    	if (  operatorBlocked != null && operatorBlocked.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "OperatorBlocked already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignOperatorBlockedToQuality61850Event(command.getQuality61850Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignOscillatoryToQuality61850Command command) throws Exception {
    	...
    	if (  oscillatory != null && oscillatory.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Oscillatory already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignOscillatoryToQuality61850Event(command.getQuality61850Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignOutOfRangeToQuality61850Command command) throws Exception {
    	...
    	if (  outOfRange != null && outOfRange.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "OutOfRange already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignOutOfRangeToQuality61850Event(command.getQuality61850Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignOverFlowToQuality61850Command command) throws Exception {
    	...
    	if (  overFlow != null && overFlow.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "OverFlow already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignOverFlowToQuality61850Event(command.getQuality61850Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignOverFlowFromQuality61850Command command) throws Exception {
    	...
    	if (  overFlow == null )
    		throw new ProcessingException( "OverFlow already has nothing assigned." );  
    ...
    public void handle(AssignSuspectToQuality61850Command command) throws Exception {
    	...
    	if (  suspect != null && suspect.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Suspect already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignSuspectToQuality61850Event(command.getQuality61850Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignSuspectFromQuality61850Command command) throws Exception {
    	...
    	if (  suspect == null )
    		throw new ProcessingException( "Suspect already has nothing assigned." );  
    ...
    public void handle(AssignTestToQuality61850Command command) throws Exception {
    	...
    	if (  test != null && test.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Test already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(UnAssignTestFromQuality61850Command command) throws Exception {
    	...
    	if (  test == null )
    		throw new ProcessingException( "Test already has nothing assigned." );  
