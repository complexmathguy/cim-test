...
public class TurbineGovernorUserDefinedAggregate {  
    ...
    public TurbineGovernorUserDefinedAggregate(CreateTurbineGovernorUserDefinedCommand command) throws Exception {
    	...
    	CreateTurbineGovernorUserDefinedEvent event = new CreateTurbineGovernorUserDefinedEvent(command.getTurbineGovernorUserDefinedId());
    ...
    public void handle(UpdateTurbineGovernorUserDefinedCommand command) throws Exception {
    	...
    	UpdateTurbineGovernorUserDefinedEvent event = new UpdateTurbineGovernorUserDefinedEvent(command.getTurbineGovernorUserDefinedId(), command.Proprietary());        
    ...
    @CommandHandler
    public void handle(AssignProprietaryToTurbineGovernorUserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToTurbineGovernorUserDefinedEvent(command.getTurbineGovernorUserDefinedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignProprietaryFromTurbineGovernorUserDefinedCommand command) throws Exception {
    	...
    	apply(new UnAssignProprietaryFromTurbineGovernorUserDefinedEvent(command.getTurbineGovernorUserDefinedId()));
    }
