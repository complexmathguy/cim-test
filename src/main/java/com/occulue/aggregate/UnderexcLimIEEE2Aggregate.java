...
public class UnderexcLimIEEE2Aggregate {  
    ...
    public UnderexcLimIEEE2Aggregate(CreateUnderexcLimIEEE2Command command) throws Exception {
    	...
    	CreateUnderexcLimIEEE2Event event = new CreateUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id());
    ...
    public void handle(UpdateUnderexcLimIEEE2Command command) throws Exception {
    	...
    	UpdateUnderexcLimIEEE2Event event = new UpdateUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.K1(), command.K2(), command.Kfb(), command.Kuf(), command.Kui(), command.Kul(), command.P0(), command.P1(), command.P10(), command.P2(), command.P3(), command.P4(), command.P5(), command.P6(), command.P7(), command.P8(), command.P9(), command.Q0(), command.Q1(), command.Q10(), command.Q2(), command.Q3(), command.Q4(), command.Q5(), command.Q6(), command.Q7(), command.Q8(), command.Q9(), command.Tu1(), command.Tu2(), command.Tu3(), command.Tu4(), command.Tul(), command.Tup(), command.Tuq(), command.Tuv(), command.Vuimax(), command.Vuimin(), command.Vulmax(), command.Vulmin());        
    ...
    public void handle(AssignK1ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  k1 != null && k1.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "K1 already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignK1ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignK1FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  k1 == null )
    		throw new ProcessingException( "K1 already has nothing assigned." );  
    ...
    public void handle(AssignK2ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  k2 != null && k2.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "K2 already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignK2ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignK2FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  k2 == null )
    		throw new ProcessingException( "K2 already has nothing assigned." );  
    ...
    public void handle(AssignKfbToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  kfb != null && kfb.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kfb already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKfbToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKfbFromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  kfb == null )
    		throw new ProcessingException( "Kfb already has nothing assigned." );  
    ...
    public void handle(AssignKufToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  kuf != null && kuf.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kuf already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKufToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKufFromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  kuf == null )
    		throw new ProcessingException( "Kuf already has nothing assigned." );  
    ...
    public void handle(AssignKuiToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  kui != null && kui.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kui already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKuiToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKuiFromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  kui == null )
    		throw new ProcessingException( "Kui already has nothing assigned." );  
    ...
    public void handle(AssignKulToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  kul != null && kul.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kul already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKulToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKulFromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  kul == null )
    		throw new ProcessingException( "Kul already has nothing assigned." );  
    ...
    public void handle(AssignP0ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p0 != null && p0.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "P0 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignP0ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignP0FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p0 == null )
    		throw new ProcessingException( "P0 already has nothing assigned." );  
    ...
    public void handle(AssignP1ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p1 != null && p1.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "P1 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignP1ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignP1FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p1 == null )
    		throw new ProcessingException( "P1 already has nothing assigned." );  
    ...
    public void handle(AssignP10ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p10 != null && p10.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "P10 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignP10ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignP10FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p10 == null )
    		throw new ProcessingException( "P10 already has nothing assigned." );  
    ...
    public void handle(AssignP2ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p2 != null && p2.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "P2 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignP2ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignP2FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p2 == null )
    		throw new ProcessingException( "P2 already has nothing assigned." );  
    ...
    public void handle(AssignP3ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p3 != null && p3.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "P3 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignP3ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignP3FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p3 == null )
    		throw new ProcessingException( "P3 already has nothing assigned." );  
    ...
    public void handle(AssignP4ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p4 != null && p4.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "P4 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignP4ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignP4FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p4 == null )
    		throw new ProcessingException( "P4 already has nothing assigned." );  
    ...
    public void handle(AssignP5ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p5 != null && p5.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "P5 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignP5ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignP5FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p5 == null )
    		throw new ProcessingException( "P5 already has nothing assigned." );  
    ...
    public void handle(AssignP6ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p6 != null && p6.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "P6 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignP6ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignP6FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p6 == null )
    		throw new ProcessingException( "P6 already has nothing assigned." );  
    ...
    public void handle(AssignP7ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p7 != null && p7.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "P7 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignP7ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignP7FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p7 == null )
    		throw new ProcessingException( "P7 already has nothing assigned." );  
    ...
    public void handle(AssignP8ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p8 != null && p8.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "P8 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignP8ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignP8FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p8 == null )
    		throw new ProcessingException( "P8 already has nothing assigned." );  
    ...
    public void handle(AssignP9ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p9 != null && p9.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "P9 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignP9ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignP9FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  p9 == null )
    		throw new ProcessingException( "P9 already has nothing assigned." );  
    ...
    public void handle(AssignQ0ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q0 != null && q0.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Q0 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignQ0ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQ0FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q0 == null )
    		throw new ProcessingException( "Q0 already has nothing assigned." );  
    ...
    public void handle(AssignQ1ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q1 != null && q1.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Q1 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignQ1ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQ1FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q1 == null )
    		throw new ProcessingException( "Q1 already has nothing assigned." );  
    ...
    public void handle(AssignQ10ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q10 != null && q10.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Q10 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignQ10ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQ10FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q10 == null )
    		throw new ProcessingException( "Q10 already has nothing assigned." );  
    ...
    public void handle(AssignQ2ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q2 != null && q2.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Q2 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignQ2ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQ2FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q2 == null )
    		throw new ProcessingException( "Q2 already has nothing assigned." );  
    ...
    public void handle(AssignQ3ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q3 != null && q3.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Q3 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignQ3ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQ3FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q3 == null )
    		throw new ProcessingException( "Q3 already has nothing assigned." );  
    ...
    public void handle(AssignQ4ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q4 != null && q4.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Q4 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignQ4ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQ4FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q4 == null )
    		throw new ProcessingException( "Q4 already has nothing assigned." );  
    ...
    public void handle(AssignQ5ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q5 != null && q5.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Q5 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignQ5ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQ5FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q5 == null )
    		throw new ProcessingException( "Q5 already has nothing assigned." );  
    ...
    public void handle(AssignQ6ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q6 != null && q6.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Q6 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignQ6ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQ6FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q6 == null )
    		throw new ProcessingException( "Q6 already has nothing assigned." );  
    ...
    public void handle(AssignQ7ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q7 != null && q7.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Q7 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignQ7ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQ7FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q7 == null )
    		throw new ProcessingException( "Q7 already has nothing assigned." );  
    ...
    public void handle(AssignQ8ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q8 != null && q8.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Q8 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignQ8ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQ8FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q8 == null )
    		throw new ProcessingException( "Q8 already has nothing assigned." );  
    ...
    public void handle(AssignQ9ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q9 != null && q9.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Q9 already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignQ9ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQ9FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  q9 == null )
    		throw new ProcessingException( "Q9 already has nothing assigned." );  
    ...
    public void handle(AssignTu1ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tu1 != null && tu1.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tu1 already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTu1ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTu1FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tu1 == null )
    		throw new ProcessingException( "Tu1 already has nothing assigned." );  
    ...
    public void handle(AssignTu2ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tu2 != null && tu2.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tu2 already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTu2ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTu2FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tu2 == null )
    		throw new ProcessingException( "Tu2 already has nothing assigned." );  
    ...
    public void handle(AssignTu3ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tu3 != null && tu3.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tu3 already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTu3ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTu3FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tu3 == null )
    		throw new ProcessingException( "Tu3 already has nothing assigned." );  
    ...
    public void handle(AssignTu4ToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tu4 != null && tu4.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tu4 already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTu4ToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTu4FromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tu4 == null )
    		throw new ProcessingException( "Tu4 already has nothing assigned." );  
    ...
    public void handle(AssignTulToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tul != null && tul.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tul already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTulToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTulFromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tul == null )
    		throw new ProcessingException( "Tul already has nothing assigned." );  
    ...
    public void handle(AssignTupToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tup != null && tup.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tup already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTupToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTupFromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tup == null )
    		throw new ProcessingException( "Tup already has nothing assigned." );  
    ...
    public void handle(AssignTuqToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tuq != null && tuq.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tuq already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTuqToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTuqFromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tuq == null )
    		throw new ProcessingException( "Tuq already has nothing assigned." );  
    ...
    public void handle(AssignTuvToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tuv != null && tuv.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tuv already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTuvToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTuvFromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  tuv == null )
    		throw new ProcessingException( "Tuv already has nothing assigned." );  
    ...
    public void handle(AssignVuimaxToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  vuimax != null && vuimax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vuimax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVuimaxToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVuimaxFromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  vuimax == null )
    		throw new ProcessingException( "Vuimax already has nothing assigned." );  
    ...
    public void handle(AssignVuiminToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  vuimin != null && vuimin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vuimin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVuiminToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVuiminFromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  vuimin == null )
    		throw new ProcessingException( "Vuimin already has nothing assigned." );  
    ...
    public void handle(AssignVulmaxToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  vulmax != null && vulmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vulmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVulmaxToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVulmaxFromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  vulmax == null )
    		throw new ProcessingException( "Vulmax already has nothing assigned." );  
    ...
    public void handle(AssignVulminToUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  vulmin != null && vulmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vulmin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVulminToUnderexcLimIEEE2Event(command.getUnderexcLimIEEE2Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVulminFromUnderexcLimIEEE2Command command) throws Exception {
    	...
    	if (  vulmin == null )
    		throw new ProcessingException( "Vulmin already has nothing assigned." );  
