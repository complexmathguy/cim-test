...
public class AngleRadiansAggregate {  
    ...
    public AngleRadiansAggregate(CreateAngleRadiansCommand command) throws Exception {
    	...
    	CreateAngleRadiansEvent event = new CreateAngleRadiansEvent(command.getAngleRadiansId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateAngleRadiansCommand command) throws Exception {
    	...
    	UpdateAngleRadiansEvent event = new UpdateAngleRadiansEvent(command.getAngleRadiansId(), command.Multiplier(), command.Unit(), command.Value());        
