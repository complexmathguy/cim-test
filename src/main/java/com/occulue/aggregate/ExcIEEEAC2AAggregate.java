...
public class ExcIEEEAC2AAggregate {  
    ...
    public void handle(UpdateExcIEEEAC2ACommand command) throws Exception {
    	...
    	UpdateExcIEEEAC2AEvent event = new UpdateExcIEEEAC2AEvent(command.getExcIEEEAC2AId(), command.Ka(), command.Kb(), command.Kc(), command.Kd(), command.Ke(), command.Kf(), command.Kh(), command.Seve1(), command.Seve2(), command.Ta(), command.Tb(), command.Tc(), command.Te(), command.Tf(), command.Vamax(), command.Vamin(), command.Ve1(), command.Ve2(), command.Vfemax(), command.Vrmax(), command.Vrmin());        
