...
public class PerLengthDCLineParameterAggregate {  
    ...
    public PerLengthDCLineParameterAggregate(CreatePerLengthDCLineParameterCommand command) throws Exception {
    	...
    	CreatePerLengthDCLineParameterEvent event = new CreatePerLengthDCLineParameterEvent(command.getPerLengthDCLineParameterId());
    ...
    public void handle(UpdatePerLengthDCLineParameterCommand command) throws Exception {
    	...
    	UpdatePerLengthDCLineParameterEvent event = new UpdatePerLengthDCLineParameterEvent(command.getPerLengthDCLineParameterId(), command.Capacitance(), command.Inductance(), command.Resistance());        
    ...
    public void handle(AssignCapacitanceToPerLengthDCLineParameterCommand command) throws Exception {
    	...
    	if (  capacitance != null && capacitance.getCapacitancePerLengthId() == command.getAssignment().getCapacitancePerLengthId() )
    		throw new ProcessingException( "Capacitance already assigned with id " + command.getAssignment().getCapacitancePerLengthId() );  
    		
        apply(new AssignCapacitanceToPerLengthDCLineParameterEvent(command.getPerLengthDCLineParameterId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignCapacitanceFromPerLengthDCLineParameterCommand command) throws Exception {
    	...
    	apply(new UnAssignCapacitanceFromPerLengthDCLineParameterEvent(command.getPerLengthDCLineParameterId()));
    }
    @CommandHandler
    public void handle(AssignInductanceToPerLengthDCLineParameterCommand command) throws Exception {
    	...
    	if (  inductance != null && inductance.getInductancePerLengthId() == command.getAssignment().getInductancePerLengthId() )
    		throw new ProcessingException( "Inductance already assigned with id " + command.getAssignment().getInductancePerLengthId() );  
    		
        apply(new AssignInductanceToPerLengthDCLineParameterEvent(command.getPerLengthDCLineParameterId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignInductanceFromPerLengthDCLineParameterCommand command) throws Exception {
    	...
    	apply(new UnAssignInductanceFromPerLengthDCLineParameterEvent(command.getPerLengthDCLineParameterId()));
    }
    @CommandHandler
    public void handle(AssignResistanceToPerLengthDCLineParameterCommand command) throws Exception {
    	...
    	if (  resistance != null && resistance.getResistancePerLengthId() == command.getAssignment().getResistancePerLengthId() )
    		throw new ProcessingException( "Resistance already assigned with id " + command.getAssignment().getResistancePerLengthId() );  
    		
        apply(new AssignResistanceToPerLengthDCLineParameterEvent(command.getPerLengthDCLineParameterId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignResistanceFromPerLengthDCLineParameterCommand command) throws Exception {
    	...
    	apply(new UnAssignResistanceFromPerLengthDCLineParameterEvent(command.getPerLengthDCLineParameterId()));
    }
