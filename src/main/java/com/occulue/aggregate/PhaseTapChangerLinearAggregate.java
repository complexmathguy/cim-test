...
public class PhaseTapChangerLinearAggregate {  
    ...
    public PhaseTapChangerLinearAggregate(CreatePhaseTapChangerLinearCommand command) throws Exception {
    	...
    	CreatePhaseTapChangerLinearEvent event = new CreatePhaseTapChangerLinearEvent(command.getPhaseTapChangerLinearId());
    ...
    public void handle(UpdatePhaseTapChangerLinearCommand command) throws Exception {
    	...
    	UpdatePhaseTapChangerLinearEvent event = new UpdatePhaseTapChangerLinearEvent(command.getPhaseTapChangerLinearId(), command.StepPhaseShiftIncrement(), command.XMax(), command.XMin());        
    ...
    @CommandHandler
    public void handle(AssignStepPhaseShiftIncrementToPhaseTapChangerLinearCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignStepPhaseShiftIncrementToPhaseTapChangerLinearCommand" );
    	
    	if (  stepPhaseShiftIncrement != null && stepPhaseShiftIncrement.getAngleDegreesId() == command.getAssignment().getAngleDegreesId() )
    		throw new ProcessingException( "StepPhaseShiftIncrement already assigned with id " + command.getAssignment().getAngleDegreesId() );  
    		
        apply(new AssignStepPhaseShiftIncrementToPhaseTapChangerLinearEvent(command.getPhaseTapChangerLinearId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignStepPhaseShiftIncrementFromPhaseTapChangerLinearCommand command) throws Exception {
    	...
    	apply(new UnAssignStepPhaseShiftIncrementFromPhaseTapChangerLinearEvent(command.getPhaseTapChangerLinearId()));
    }
    @CommandHandler
    public void handle(AssignXMaxToPhaseTapChangerLinearCommand command) throws Exception {
        ...
        apply(new AssignXMaxToPhaseTapChangerLinearEvent(command.getPhaseTapChangerLinearId(), command.getAssignment()));
    }
    ...
    public void handle(AssignXMinToPhaseTapChangerLinearCommand command) throws Exception {
        ...
        apply(new AssignXMinToPhaseTapChangerLinearEvent(command.getPhaseTapChangerLinearId(), command.getAssignment()));
    }
