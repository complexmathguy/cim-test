...
public class GeneratingUnitAggregate {  
    ...
    public GeneratingUnitAggregate(CreateGeneratingUnitCommand command) throws Exception {
    	...
    	CreateGeneratingUnitEvent event = new CreateGeneratingUnitEvent(command.getGeneratingUnitId(), command.GenControlSource());
    ...
    public void handle(UpdateGeneratingUnitCommand command) throws Exception {
    	...
    	UpdateGeneratingUnitEvent event = new UpdateGeneratingUnitEvent(command.getGeneratingUnitId(), command.GenControlSource(), command.GovernorSCD(), command.InitialP(), command.LongPF(), command.MaximumAllowableSpinningReserve(), command.MaxOperatingP(), command.MinOperatingP(), command.NominalP(), command.RatedGrossMaxP(), command.RatedGrossMinP(), command.RatedNetMaxP(), command.ShortPF(), command.StartupCost(), command.TotalEfficiency(), command.VariableCost());        
    ...
    public void handle(AssignGovernorSCDToGeneratingUnitCommand command) throws Exception {
    	...
    	if (  governorSCD != null && governorSCD.getPerCentId() == command.getAssignment().getPerCentId() )
    		throw new ProcessingException( "GovernorSCD already assigned with id " + command.getAssignment().getPerCentId() );  
    		
        apply(new AssignGovernorSCDToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }
    ...
    public void handle(AssignInitialPToGeneratingUnitCommand command) throws Exception {
    	...
    	if (  initialP != null && initialP.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "InitialP already assigned with id " + command.getAssignment().getActivePowerId() );  
    		
        apply(new AssignInitialPToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignInitialPFromGeneratingUnitCommand command) throws Exception {
    	...
    	if (  initialP == null )
    		throw new ProcessingException( "InitialP already has nothing assigned." );  
    ...
    public void handle(AssignLongPFToGeneratingUnitCommand command) throws Exception {
    	...
    	if (  longPF != null && longPF.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "LongPF already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignLongPFToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignLongPFFromGeneratingUnitCommand command) throws Exception {
    	...
    	if (  longPF == null )
    		throw new ProcessingException( "LongPF already has nothing assigned." );  

    	apply(new UnAssignLongPFFromGeneratingUnitEvent(command.getGeneratingUnitId()));
    }
    @CommandHandler
    public void handle(AssignMaximumAllowableSpinningReserveToGeneratingUnitCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignMaximumAllowableSpinningReserveToGeneratingUnitCommand" );
    	
    	if (  maximumAllowableSpinningReserve != null && maximumAllowableSpinningReserve.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "MaximumAllowableSpinningReserve already assigned with id " + command.getAssignment().getActivePowerId() );  
    		
        apply(new AssignMaximumAllowableSpinningReserveToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignMaximumAllowableSpinningReserveFromGeneratingUnitCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignMaximumAllowableSpinningReserveFromGeneratingUnitCommand" );

    	if (  maximumAllowableSpinningReserve == null )
    		throw new ProcessingException( "MaximumAllowableSpinningReserve already has nothing assigned." );  

    	apply(new UnAssignMaximumAllowableSpinningReserveFromGeneratingUnitEvent(command.getGeneratingUnitId()));
    }
    @CommandHandler
    public void handle(AssignMaxOperatingPToGeneratingUnitCommand command) throws Exception {
    	...
    	if (  maxOperatingP != null && maxOperatingP.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "MaxOperatingP already assigned with id " + command.getAssignment().getActivePowerId() );  
    		
        apply(new AssignMaxOperatingPToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }
    ...
    public void handle(AssignMinOperatingPToGeneratingUnitCommand command) throws Exception {
    	...
    	if (  minOperatingP != null && minOperatingP.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "MinOperatingP already assigned with id " + command.getAssignment().getActivePowerId() );  
    		
        apply(new AssignMinOperatingPToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }
    ...
    public void handle(AssignNominalPToGeneratingUnitCommand command) throws Exception {
    	...
    	if (  nominalP != null && nominalP.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "NominalP already assigned with id " + command.getAssignment().getActivePowerId() );  
    		
        apply(new AssignNominalPToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignNominalPFromGeneratingUnitCommand command) throws Exception {
    	...
    	if (  nominalP == null )
    		throw new ProcessingException( "NominalP already has nothing assigned." );  
    ...
    public void handle(AssignRatedGrossMaxPToGeneratingUnitCommand command) throws Exception {
    	...
    	if (  ratedGrossMaxP != null && ratedGrossMaxP.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "RatedGrossMaxP already assigned with id " + command.getAssignment().getActivePowerId() );  
    		
        apply(new AssignRatedGrossMaxPToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRatedGrossMinPToGeneratingUnitCommand command) throws Exception {
    	...
    	if (  ratedGrossMinP != null && ratedGrossMinP.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "RatedGrossMinP already assigned with id " + command.getAssignment().getActivePowerId() );  
    		
        apply(new AssignRatedGrossMinPToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRatedNetMaxPToGeneratingUnitCommand command) throws Exception {
    	...
    	if (  ratedNetMaxP != null && ratedNetMaxP.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "RatedNetMaxP already assigned with id " + command.getAssignment().getActivePowerId() );  
    		
        apply(new AssignRatedNetMaxPToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }
    ...
    public void handle(AssignShortPFToGeneratingUnitCommand command) throws Exception {
    	...
    	if (  shortPF != null && shortPF.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "ShortPF already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignShortPFToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignShortPFFromGeneratingUnitCommand command) throws Exception {
    	...
    	if (  shortPF == null )
    		throw new ProcessingException( "ShortPF already has nothing assigned." );  
    ...
    public void handle(AssignStartupCostToGeneratingUnitCommand command) throws Exception {
    	...
    	if (  startupCost != null && startupCost.getMoneyId() == command.getAssignment().getMoneyId() )
    		throw new ProcessingException( "StartupCost already assigned with id " + command.getAssignment().getMoneyId() );  
    		
        apply(new AssignStartupCostToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTotalEfficiencyToGeneratingUnitCommand command) throws Exception {
    	...
    	if (  totalEfficiency != null && totalEfficiency.getPerCentId() == command.getAssignment().getPerCentId() )
    		throw new ProcessingException( "TotalEfficiency already assigned with id " + command.getAssignment().getPerCentId() );  
    		
        apply(new AssignTotalEfficiencyToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }
    ...
    public void handle(AssignVariableCostToGeneratingUnitCommand command) throws Exception {
    	...
    	if (  variableCost != null && variableCost.getMoneyId() == command.getAssignment().getMoneyId() )
    		throw new ProcessingException( "VariableCost already assigned with id " + command.getAssignment().getMoneyId() );  
    		
        apply(new AssignVariableCostToGeneratingUnitEvent(command.getGeneratingUnitId(), command.getAssignment()));
    }
