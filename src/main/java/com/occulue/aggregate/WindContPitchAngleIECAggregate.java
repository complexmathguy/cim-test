...
public class WindContPitchAngleIECAggregate {  
    ...
    public WindContPitchAngleIECAggregate(CreateWindContPitchAngleIECCommand command) throws Exception {
    	...
    	CreateWindContPitchAngleIECEvent event = new CreateWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId());
    ...
    public void handle(UpdateWindContPitchAngleIECCommand command) throws Exception {
    	...
    	UpdateWindContPitchAngleIECEvent event = new UpdateWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId(), command.Dthetamax(), command.Dthetamin(), command.Kic(), command.Kiomega(), command.Kpc(), command.Kpomega(), command.Kpx(), command.Thetamax(), command.Thetamin(), command.Ttheta());        
    ...
    public void handle(AssignDthetamaxToWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  dthetamax != null && dthetamax.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Dthetamax already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignDthetamaxToWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDthetamaxFromWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  dthetamax == null )
    		throw new ProcessingException( "Dthetamax already has nothing assigned." );  

    	apply(new UnAssignDthetamaxFromWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId()));
    }
    @CommandHandler
    public void handle(AssignDthetaminToWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  dthetamin != null && dthetamin.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Dthetamin already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignDthetaminToWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDthetaminFromWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  dthetamin == null )
    		throw new ProcessingException( "Dthetamin already has nothing assigned." );  

    	apply(new UnAssignDthetaminFromWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId()));
    }
    @CommandHandler
    public void handle(AssignKicToWindContPitchAngleIECCommand command) throws Exception {
        ...
        apply(new AssignKicToWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignKiomegaToWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  kiomega != null && kiomega.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kiomega already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKiomegaToWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKiomegaFromWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  kiomega == null )
    		throw new ProcessingException( "Kiomega already has nothing assigned." );  
    ...
    public void handle(AssignKpcToWindContPitchAngleIECCommand command) throws Exception {
        ...
        apply(new AssignKpcToWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignKpomegaToWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  kpomega != null && kpomega.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kpomega already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKpomegaToWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKpomegaFromWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  kpomega == null )
    		throw new ProcessingException( "Kpomega already has nothing assigned." );  
    ...
    public void handle(AssignKpxToWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  kpx != null && kpx.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kpx already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKpxToWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKpxFromWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  kpx == null )
    		throw new ProcessingException( "Kpx already has nothing assigned." );  
    ...
    public void handle(AssignThetamaxToWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  thetamax != null && thetamax.getAngleDegreesId() == command.getAssignment().getAngleDegreesId() )
    		throw new ProcessingException( "Thetamax already assigned with id " + command.getAssignment().getAngleDegreesId() );  
    		
        apply(new AssignThetamaxToWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignThetamaxFromWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  thetamax == null )
    		throw new ProcessingException( "Thetamax already has nothing assigned." );  
    ...
    public void handle(AssignThetaminToWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  thetamin != null && thetamin.getAngleDegreesId() == command.getAssignment().getAngleDegreesId() )
    		throw new ProcessingException( "Thetamin already assigned with id " + command.getAssignment().getAngleDegreesId() );  
    		
        apply(new AssignThetaminToWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignThetaminFromWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  thetamin == null )
    		throw new ProcessingException( "Thetamin already has nothing assigned." );  
    ...
    public void handle(AssignTthetaToWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  ttheta != null && ttheta.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Ttheta already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTthetaToWindContPitchAngleIECEvent(command.getWindContPitchAngleIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTthetaFromWindContPitchAngleIECCommand command) throws Exception {
    	...
    	if (  ttheta == null )
    		throw new ProcessingException( "Ttheta already has nothing assigned." );  
