...
public class ExcIEEEAC8BAggregate {  
    ...
    public void handle(UpdateExcIEEEAC8BCommand command) throws Exception {
    	...
    	UpdateExcIEEEAC8BEvent event = new UpdateExcIEEEAC8BEvent(command.getExcIEEEAC8BId(), command.Ka(), command.Kc(), command.Kd(), command.Kdr(), command.Ke(), command.Kir(), command.Kpr(), command.Seve1(), command.Seve2(), command.Ta(), command.Tdr(), command.Te(), command.Ve1(), command.Ve2(), command.Vemin(), command.Vfemax(), command.Vrmax(), command.Vrmin());        
