...
public class EquipmentBoundaryVersionAggregate {  
    ...
    public EquipmentBoundaryVersionAggregate(CreateEquipmentBoundaryVersionCommand command) throws Exception {
    	...
    	CreateEquipmentBoundaryVersionEvent event = new CreateEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId());
    ...
    public void handle(UpdateEquipmentBoundaryVersionCommand command) throws Exception {
    	...
    	UpdateEquipmentBoundaryVersionEvent event = new UpdateEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId(), command.BaseUML(), command.BaseURI(), command.Date(), command.DifferenceModelURI(), command.EntsoeUML(), command.EntsoeURIcore(), command.EntsoeURIoperation(), command.ModelDescriptionURI(), command.NamespaceRDF(), command.NamespaceUML(), command.ShortName());        
    ...
    public void handle(AssignBaseUMLToEquipmentBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseUMLToEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignBaseUMLFromEquipmentBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignBaseUMLFromEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignBaseURIToEquipmentBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseURIToEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignBaseURIFromEquipmentBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignBaseURIFromEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignDateToEquipmentBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignDateToEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDateFromEquipmentBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignDateFromEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignDifferenceModelURIToEquipmentBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignDifferenceModelURIToEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignDifferenceModelURIFromEquipmentBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignDifferenceModelURIFromEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignEntsoeUMLToEquipmentBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeUMLToEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEntsoeUMLFromEquipmentBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignEntsoeUMLFromEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignEntsoeURIcoreToEquipmentBoundaryVersionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignEntsoeURIcoreToEquipmentBoundaryVersionCommand" );
    	
    	if (  entsoeURIcore != null && entsoeURIcore.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "EntsoeURIcore already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignEntsoeURIcoreToEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEntsoeURIcoreFromEquipmentBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignEntsoeURIcoreFromEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignEntsoeURIoperationToEquipmentBoundaryVersionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignEntsoeURIoperationToEquipmentBoundaryVersionCommand" );
    	
    	if (  entsoeURIoperation != null && entsoeURIoperation.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "EntsoeURIoperation already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignEntsoeURIoperationToEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignEntsoeURIoperationFromEquipmentBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignEntsoeURIoperationFromEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignModelDescriptionURIToEquipmentBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignModelDescriptionURIToEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignModelDescriptionURIFromEquipmentBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignModelDescriptionURIFromEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignNamespaceRDFToEquipmentBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceRDFToEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignNamespaceRDFFromEquipmentBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignNamespaceRDFFromEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignNamespaceUMLToEquipmentBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceUMLToEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignNamespaceUMLFromEquipmentBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignNamespaceUMLFromEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId()));
    }
    @CommandHandler
    public void handle(AssignShortNameToEquipmentBoundaryVersionCommand command) throws Exception {
        ...
        apply(new AssignShortNameToEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignShortNameFromEquipmentBoundaryVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignShortNameFromEquipmentBoundaryVersionEvent(command.getEquipmentBoundaryVersionId()));
    }
