...
public class DiscontinuousExcitationControlUserDefinedAggregate {  
    ...
    public void handle(UpdateDiscontinuousExcitationControlUserDefinedCommand command) throws Exception {
    	...
    	UpdateDiscontinuousExcitationControlUserDefinedEvent event = new UpdateDiscontinuousExcitationControlUserDefinedEvent(command.getDiscontinuousExcitationControlUserDefinedId(), command.Proprietary());        
