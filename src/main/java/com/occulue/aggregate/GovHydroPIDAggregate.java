...
public class GovHydroPIDAggregate {  
    ...
    public void handle(UpdateGovHydroPIDCommand command) throws Exception {
    	...
    	UpdateGovHydroPIDEvent event = new UpdateGovHydroPIDEvent(command.getGovHydroPIDId(), command.Aturb(), command.Bturb(), command.Db1(), command.Db2(), command.Eps(), command.Gv1(), command.Gv2(), command.Gv3(), command.Gv4(), command.Gv5(), command.Gv6(), command.InputSignal(), command.Kd(), command.Kg(), command.Ki(), command.Kp(), command.Mwbase(), command.Pgv1(), command.Pgv2(), command.Pgv3(), command.Pgv4(), command.Pgv5(), command.Pgv6(), command.Pmax(), command.Pmin(), command.R(), command.Td(), command.Tf(), command.Tp(), command.Tt(), command.Tturb(), command.Velcl(), command.Velop());        
    ...
    public void handle(AssignInputSignalToGovHydroPIDCommand command) throws Exception {
        ...
        apply(new AssignInputSignalToGovHydroPIDEvent(command.getGovHydroPIDId(), command.getAssignment()));
    }
