...
public class WindContPType4bIECAggregate {  
    ...
    public WindContPType4bIECAggregate(CreateWindContPType4bIECCommand command) throws Exception {
    	...
    	CreateWindContPType4bIECEvent event = new CreateWindContPType4bIECEvent(command.getWindContPType4bIECId());
    ...
    public void handle(UpdateWindContPType4bIECCommand command) throws Exception {
    	...
    	UpdateWindContPType4bIECEvent event = new UpdateWindContPType4bIECEvent(command.getWindContPType4bIECId(), command.Dpmax(), command.Tpaero(), command.Tpord(), command.Tufilt());        
    ...
    public void handle(AssignDpmaxToWindContPType4bIECCommand command) throws Exception {
        ...
        apply(new AssignDpmaxToWindContPType4bIECEvent(command.getWindContPType4bIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTpaeroToWindContPType4bIECCommand command) throws Exception {
    	...
    	if (  tpaero != null && tpaero.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tpaero already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTpaeroToWindContPType4bIECEvent(command.getWindContPType4bIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTpaeroFromWindContPType4bIECCommand command) throws Exception {
    	...
    	if (  tpaero == null )
    		throw new ProcessingException( "Tpaero already has nothing assigned." );  
    ...
    public void handle(AssignTpordToWindContPType4bIECCommand command) throws Exception {
    	...
    	if (  tpord != null && tpord.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tpord already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTpordToWindContPType4bIECEvent(command.getWindContPType4bIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTufiltToWindContPType4bIECCommand command) throws Exception {
        ...
        apply(new AssignTufiltToWindContPType4bIECEvent(command.getWindContPType4bIECId(), command.getAssignment()));
    }
