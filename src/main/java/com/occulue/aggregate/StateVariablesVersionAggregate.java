...
public class StateVariablesVersionAggregate {  
    ...
    public StateVariablesVersionAggregate(CreateStateVariablesVersionCommand command) throws Exception {
    	...
    	CreateStateVariablesVersionEvent event = new CreateStateVariablesVersionEvent(command.getStateVariablesVersionId());
    ...
    public void handle(AssignBaseUMLToStateVariablesVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseUMLToStateVariablesVersionEvent(command.getStateVariablesVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignBaseURIToStateVariablesVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseURIToStateVariablesVersionEvent(command.getStateVariablesVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignDateToStateVariablesVersionCommand command) throws Exception {
        ...
        apply(new AssignDateToStateVariablesVersionEvent(command.getStateVariablesVersionId(), command.getAssignment()));
    }
    ...
    @CommandHandler
    public void handle(AssignDifferenceModelURIToStateVariablesVersionCommand command) throws Exception {
        ...
        apply(new AssignDifferenceModelURIToStateVariablesVersionEvent(command.getStateVariablesVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignDifferenceModelURIFromStateVariablesVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignDifferenceModelURIFromStateVariablesVersionEvent(command.getStateVariablesVersionId()));
    }
    @CommandHandler
    public void handle(AssignEntsoeUMLToStateVariablesVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeUMLToStateVariablesVersionEvent(command.getStateVariablesVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEntsoeUMLFromStateVariablesVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignEntsoeUMLFromStateVariablesVersionEvent(command.getStateVariablesVersionId()));
    }
    @CommandHandler
    public void handle(AssignEntsoeURIToStateVariablesVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeURIToStateVariablesVersionEvent(command.getStateVariablesVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEntsoeURIFromStateVariablesVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignEntsoeURIFromStateVariablesVersionEvent(command.getStateVariablesVersionId()));
    }
    @CommandHandler
    public void handle(AssignModelDescriptionURIToStateVariablesVersionCommand command) throws Exception {
        ...
        apply(new AssignModelDescriptionURIToStateVariablesVersionEvent(command.getStateVariablesVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignModelDescriptionURIFromStateVariablesVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignModelDescriptionURIFromStateVariablesVersionEvent(command.getStateVariablesVersionId()));
    }
    @CommandHandler
    public void handle(AssignNamespaceRDFToStateVariablesVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceRDFToStateVariablesVersionEvent(command.getStateVariablesVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignNamespaceRDFFromStateVariablesVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignNamespaceRDFFromStateVariablesVersionEvent(command.getStateVariablesVersionId()));
    }
    @CommandHandler
    public void handle(AssignNamespaceUMLToStateVariablesVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceUMLToStateVariablesVersionEvent(command.getStateVariablesVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignNamespaceUMLFromStateVariablesVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignNamespaceUMLFromStateVariablesVersionEvent(command.getStateVariablesVersionId()));
    }
    @CommandHandler
    public void handle(AssignShortNameToStateVariablesVersionCommand command) throws Exception {
        ...
        apply(new AssignShortNameToStateVariablesVersionEvent(command.getStateVariablesVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignShortNameFromStateVariablesVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignShortNameFromStateVariablesVersionEvent(command.getStateVariablesVersionId()));
    }
