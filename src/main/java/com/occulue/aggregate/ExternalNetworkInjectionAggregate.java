...
public class ExternalNetworkInjectionAggregate {  
    ...
    public ExternalNetworkInjectionAggregate(CreateExternalNetworkInjectionCommand command) throws Exception {
    	...
    	CreateExternalNetworkInjectionEvent event = new CreateExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId());
    ...
    public void handle(UpdateExternalNetworkInjectionCommand command) throws Exception {
    	...
    	UpdateExternalNetworkInjectionEvent event = new UpdateExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.GovernorSCD(), command.IkSecond(), command.MaxInitialSymShCCurrent(), command.MaxP(), command.MaxQ(), command.MaxR0ToX0Ratio(), command.MaxR1ToX1Ratio(), command.MaxZ0ToZ1Ratio(), command.MinInitialSymShCCurrent(), command.MinP(), command.MinQ(), command.MinR0ToX0Ratio(), command.MinR1ToX1Ratio(), command.MinZ0ToZ1Ratio(), command.VoltageFactor());        
    ...
    public void handle(AssignGovernorSCDToExternalNetworkInjectionCommand command) throws Exception {
    	...
    	if (  governorSCD != null && governorSCD.getActivePowerPerFrequencyId() == command.getAssignment().getActivePowerPerFrequencyId() )
    		throw new ProcessingException( "GovernorSCD already assigned with id " + command.getAssignment().getActivePowerPerFrequencyId() );  
    		
        apply(new AssignGovernorSCDToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignGovernorSCDFromExternalNetworkInjectionCommand command) throws Exception {
    	...
    	apply(new UnAssignGovernorSCDFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignIkSecondToExternalNetworkInjectionCommand command) throws Exception {
    	...
    	if (  ikSecond != null && ikSecond.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "IkSecond already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignIkSecondToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignIkSecondFromExternalNetworkInjectionCommand command) throws Exception {
    	...
    	if (  ikSecond == null )
    		throw new ProcessingException( "IkSecond already has nothing assigned." );  

    	apply(new UnAssignIkSecondFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignMaxInitialSymShCCurrentToExternalNetworkInjectionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignMaxInitialSymShCCurrentToExternalNetworkInjectionCommand" );
    	
    	if (  maxInitialSymShCCurrent != null && maxInitialSymShCCurrent.getCurrentFlowId() == command.getAssignment().getCurrentFlowId() )
    		throw new ProcessingException( "MaxInitialSymShCCurrent already assigned with id " + command.getAssignment().getCurrentFlowId() );  
    		
        apply(new AssignMaxInitialSymShCCurrentToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignMaxInitialSymShCCurrentFromExternalNetworkInjectionCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignMaxInitialSymShCCurrentFromExternalNetworkInjectionCommand" );

    	if (  maxInitialSymShCCurrent == null )
    		throw new ProcessingException( "MaxInitialSymShCCurrent already has nothing assigned." );  

    	apply(new UnAssignMaxInitialSymShCCurrentFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignMaxPToExternalNetworkInjectionCommand command) throws Exception {
    	...
    	if (  maxP != null && maxP.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "MaxP already assigned with id " + command.getAssignment().getActivePowerId() );  
    		
        apply(new AssignMaxPToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMaxPFromExternalNetworkInjectionCommand command) throws Exception {
    	...
    	if (  maxP == null )
    		throw new ProcessingException( "MaxP already has nothing assigned." );  

    	apply(new UnAssignMaxPFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignMaxQToExternalNetworkInjectionCommand command) throws Exception {
    	...
    	if (  maxQ != null && maxQ.getReactivePowerId() == command.getAssignment().getReactivePowerId() )
    		throw new ProcessingException( "MaxQ already assigned with id " + command.getAssignment().getReactivePowerId() );  
    		
        apply(new AssignMaxQToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMaxQFromExternalNetworkInjectionCommand command) throws Exception {
    	...
    	if (  maxQ == null )
    		throw new ProcessingException( "MaxQ already has nothing assigned." );  

    	apply(new UnAssignMaxQFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignMaxR0ToX0RatioToExternalNetworkInjectionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignMaxR0ToX0RatioToExternalNetworkInjectionCommand" );
    	
    	if (  maxR0ToX0Ratio != null && maxR0ToX0Ratio.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "MaxR0ToX0Ratio already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignMaxR0ToX0RatioToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignMaxR0ToX0RatioFromExternalNetworkInjectionCommand command) throws Exception {
    	...
    	apply(new UnAssignMaxR0ToX0RatioFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignMaxR1ToX1RatioToExternalNetworkInjectionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignMaxR1ToX1RatioToExternalNetworkInjectionCommand" );
    	
    	if (  maxR1ToX1Ratio != null && maxR1ToX1Ratio.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "MaxR1ToX1Ratio already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignMaxR1ToX1RatioToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignMaxR1ToX1RatioFromExternalNetworkInjectionCommand command) throws Exception {
    	...
    	apply(new UnAssignMaxR1ToX1RatioFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignMaxZ0ToZ1RatioToExternalNetworkInjectionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignMaxZ0ToZ1RatioToExternalNetworkInjectionCommand" );
    	
    	if (  maxZ0ToZ1Ratio != null && maxZ0ToZ1Ratio.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "MaxZ0ToZ1Ratio already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignMaxZ0ToZ1RatioToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignMaxZ0ToZ1RatioFromExternalNetworkInjectionCommand command) throws Exception {
    	...
    	apply(new UnAssignMaxZ0ToZ1RatioFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignMinInitialSymShCCurrentToExternalNetworkInjectionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignMinInitialSymShCCurrentToExternalNetworkInjectionCommand" );
    	
    	if (  minInitialSymShCCurrent != null && minInitialSymShCCurrent.getCurrentFlowId() == command.getAssignment().getCurrentFlowId() )
    		throw new ProcessingException( "MinInitialSymShCCurrent already assigned with id " + command.getAssignment().getCurrentFlowId() );  
    		
        apply(new AssignMinInitialSymShCCurrentToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignMinInitialSymShCCurrentFromExternalNetworkInjectionCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignMinInitialSymShCCurrentFromExternalNetworkInjectionCommand" );

    	if (  minInitialSymShCCurrent == null )
    		throw new ProcessingException( "MinInitialSymShCCurrent already has nothing assigned." );  

    	apply(new UnAssignMinInitialSymShCCurrentFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignMinPToExternalNetworkInjectionCommand command) throws Exception {
    	...
    	if (  minP != null && minP.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "MinP already assigned with id " + command.getAssignment().getActivePowerId() );  
    		
        apply(new AssignMinPToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMinPFromExternalNetworkInjectionCommand command) throws Exception {
    	...
    	if (  minP == null )
    		throw new ProcessingException( "MinP already has nothing assigned." );  

    	apply(new UnAssignMinPFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignMinQToExternalNetworkInjectionCommand command) throws Exception {
    	...
    	if (  minQ != null && minQ.getReactivePowerId() == command.getAssignment().getReactivePowerId() )
    		throw new ProcessingException( "MinQ already assigned with id " + command.getAssignment().getReactivePowerId() );  
    		
        apply(new AssignMinQToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMinQFromExternalNetworkInjectionCommand command) throws Exception {
    	...
    	if (  minQ == null )
    		throw new ProcessingException( "MinQ already has nothing assigned." );  

    	apply(new UnAssignMinQFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignMinR0ToX0RatioToExternalNetworkInjectionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignMinR0ToX0RatioToExternalNetworkInjectionCommand" );
    	
    	if (  minR0ToX0Ratio != null && minR0ToX0Ratio.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "MinR0ToX0Ratio already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignMinR0ToX0RatioToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignMinR0ToX0RatioFromExternalNetworkInjectionCommand command) throws Exception {
    	...
    	apply(new UnAssignMinR0ToX0RatioFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignMinR1ToX1RatioToExternalNetworkInjectionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignMinR1ToX1RatioToExternalNetworkInjectionCommand" );
    	
    	if (  minR1ToX1Ratio != null && minR1ToX1Ratio.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "MinR1ToX1Ratio already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignMinR1ToX1RatioToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignMinR1ToX1RatioFromExternalNetworkInjectionCommand command) throws Exception {
    	...
    	apply(new UnAssignMinR1ToX1RatioFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignMinZ0ToZ1RatioToExternalNetworkInjectionCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignMinZ0ToZ1RatioToExternalNetworkInjectionCommand" );
    	
    	if (  minZ0ToZ1Ratio != null && minZ0ToZ1Ratio.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "MinZ0ToZ1Ratio already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignMinZ0ToZ1RatioToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignMinZ0ToZ1RatioFromExternalNetworkInjectionCommand command) throws Exception {
    	...
    	apply(new UnAssignMinZ0ToZ1RatioFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
    @CommandHandler
    public void handle(AssignVoltageFactorToExternalNetworkInjectionCommand command) throws Exception {
    	...
    	if (  voltageFactor != null && voltageFactor.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "VoltageFactor already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVoltageFactorToExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignVoltageFactorFromExternalNetworkInjectionCommand command) throws Exception {
    	...
    	apply(new UnAssignVoltageFactorFromExternalNetworkInjectionEvent(command.getExternalNetworkInjectionId()));
    }
