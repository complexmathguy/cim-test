...
public class DCConverterUnitAggregate {  
    ...
    public DCConverterUnitAggregate(CreateDCConverterUnitCommand command) throws Exception {
    	...
    	CreateDCConverterUnitEvent event = new CreateDCConverterUnitEvent(command.getDCConverterUnitId(), command.OperationMode());
    ...
    public void handle(UpdateDCConverterUnitCommand command) throws Exception {
    	...
    	UpdateDCConverterUnitEvent event = new UpdateDCConverterUnitEvent(command.getDCConverterUnitId(), command.OperationMode());        
