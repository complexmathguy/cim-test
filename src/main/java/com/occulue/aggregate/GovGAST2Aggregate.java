...
public class GovGAST2Aggregate {  
    ...
    public void handle(UpdateGovGAST2Command command) throws Exception {
    	...
    	UpdateGovGAST2Event event = new UpdateGovGAST2Event(command.getGovGAST2Id(), command.A(), command.Af1(), command.Af2(), command.B(), command.Bf1(), command.Bf2(), command.C(), command.Cf2(), command.Ecr(), command.Etd(), command.K3(), command.K4(), command.K5(), command.K6(), command.Kf(), command.Mwbase(), command.T(), command.T3(), command.T4(), command.T5(), command.Tc(), command.Tcd(), command.Tf(), command.Tmax(), command.Tmin(), command.Tr(), command.Trate(), command.Tt(), command.W(), command.X(), command.Y(), command.Z());        
    ...
    public void handle(AssignWToGovGAST2Command command) throws Exception {
    	...
    	if (  w != null && w.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "W already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignWFromGovGAST2Command command) throws Exception {
    	...
    	if (  w == null )
    		throw new ProcessingException( "W already has nothing assigned." );  
    ...
    public void handle(AssignXToGovGAST2Command command) throws Exception {
    	...
    	if (  x != null && x.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "X already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(AssignYToGovGAST2Command command) throws Exception {
    	...
    	if (  y != null && y.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Y already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(AssignZToGovGAST2Command command) throws Exception {
    	...
    	if (  z != null && z.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Z already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(UnAssignZFromGovGAST2Command command) throws Exception {
    	...
    	if (  z == null )
    		throw new ProcessingException( "Z already has nothing assigned." );  
