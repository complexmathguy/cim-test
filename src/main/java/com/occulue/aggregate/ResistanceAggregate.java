...
public class ResistanceAggregate {  
    ...
    public ResistanceAggregate(CreateResistanceCommand command) throws Exception {
    	...
    	CreateResistanceEvent event = new CreateResistanceEvent(command.getResistanceId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateResistanceCommand command) throws Exception {
    	...
    	UpdateResistanceEvent event = new UpdateResistanceEvent(command.getResistanceId(), command.Multiplier(), command.Unit(), command.Value());        
