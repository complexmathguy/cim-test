...
public class ExcIEEEAC7BAggregate {  
    ...
    public void handle(UpdateExcIEEEAC7BCommand command) throws Exception {
    	...
    	UpdateExcIEEEAC7BEvent event = new UpdateExcIEEEAC7BEvent(command.getExcIEEEAC7BId(), command.Kc(), command.Kd(), command.Kdr(), command.Ke(), command.Kf1(), command.Kf2(), command.Kf3(), command.Kia(), command.Kir(), command.Kl(), command.Kp(), command.Kpa(), command.Kpr(), command.Seve1(), command.Seve2(), command.Tdr(), command.Te(), command.Tf(), command.Vamax(), command.Vamin(), command.Ve1(), command.Ve2(), command.Vemin(), command.Vfemax(), command.Vrmax(), command.Vrmin());        
    ...
    public void handle(AssignKf2ToExcIEEEAC7BCommand command) throws Exception {
    	...
    	if (  kf2 != null && kf2.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kf2 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignKf2FromExcIEEEAC7BCommand command) throws Exception {
    	...
    	if (  kf2 == null )
    		throw new ProcessingException( "Kf2 already has nothing assigned." );  
    ...
    public void handle(AssignKiaToExcIEEEAC7BCommand command) throws Exception {
    	...
    	if (  kia != null && kia.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kia already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignKiaFromExcIEEEAC7BCommand command) throws Exception {
    	...
    	if (  kia == null )
    		throw new ProcessingException( "Kia already has nothing assigned." );  
    ...
    public void handle(AssignKpaToExcIEEEAC7BCommand command) throws Exception {
    	...
    	if (  kpa != null && kpa.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kpa already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignKpaFromExcIEEEAC7BCommand command) throws Exception {
    	...
    	if (  kpa == null )
    		throw new ProcessingException( "Kpa already has nothing assigned." );  
