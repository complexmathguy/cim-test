...
public class RegularIntervalScheduleAggregate {  
    ...
    public RegularIntervalScheduleAggregate(CreateRegularIntervalScheduleCommand command) throws Exception {
    	...
    	CreateRegularIntervalScheduleEvent event = new CreateRegularIntervalScheduleEvent(command.getRegularIntervalScheduleId());
    ...
    public void handle(UpdateRegularIntervalScheduleCommand command) throws Exception {
    	...
    	UpdateRegularIntervalScheduleEvent event = new UpdateRegularIntervalScheduleEvent(command.getRegularIntervalScheduleId(), command.EndTime(), command.TimeStep());        
    ...
    public void handle(AssignEndTimeToRegularIntervalScheduleCommand command) throws Exception {
    	...
    	if (  endTime != null && endTime.getDateTimeId() == command.getAssignment().getDateTimeId() )
    		throw new ProcessingException( "EndTime already assigned with id " + command.getAssignment().getDateTimeId() );  
    		
        apply(new AssignEndTimeToRegularIntervalScheduleEvent(command.getRegularIntervalScheduleId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignEndTimeFromRegularIntervalScheduleCommand command) throws Exception {
    	...
    	if (  endTime == null )
    		throw new ProcessingException( "EndTime already has nothing assigned." );  

    	apply(new UnAssignEndTimeFromRegularIntervalScheduleEvent(command.getRegularIntervalScheduleId()));
    }
    @CommandHandler
    public void handle(AssignTimeStepToRegularIntervalScheduleCommand command) throws Exception {
    	...
    	if (  timeStep != null && timeStep.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "TimeStep already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTimeStepToRegularIntervalScheduleEvent(command.getRegularIntervalScheduleId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTimeStepFromRegularIntervalScheduleCommand command) throws Exception {
    	...
    	if (  timeStep == null )
    		throw new ProcessingException( "TimeStep already has nothing assigned." );  

    	apply(new UnAssignTimeStepFromRegularIntervalScheduleEvent(command.getRegularIntervalScheduleId()));
    }
