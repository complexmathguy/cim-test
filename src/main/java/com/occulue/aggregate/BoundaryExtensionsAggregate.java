...
public class BoundaryExtensionsAggregate {  
    ...
    public BoundaryExtensionsAggregate(CreateBoundaryExtensionsCommand command) throws Exception {
    	...
    	CreateBoundaryExtensionsEvent event = new CreateBoundaryExtensionsEvent(command.getBoundaryExtensionsId());
    ...
    public void handle(UpdateBoundaryExtensionsCommand command) throws Exception {
    	...
    	UpdateBoundaryExtensionsEvent event = new UpdateBoundaryExtensionsEvent(command.getBoundaryExtensionsId(), command.BoundaryPoint(), command.FromEndIsoCode(), command.FromEndName(), command.FromEndNameTso(), command.ToEndIsoCode(), command.ToEndName(), command.ToEndNameTso());        
    ...
    public void handle(AssignBoundaryPointToBoundaryExtensionsCommand command) throws Exception {
        ...
        apply(new AssignBoundaryPointToBoundaryExtensionsEvent(command.getBoundaryExtensionsId(), command.getAssignment()));
    }
    ...
    public void handle(AssignFromEndIsoCodeToBoundaryExtensionsCommand command) throws Exception {
        ...
        apply(new AssignFromEndIsoCodeToBoundaryExtensionsEvent(command.getBoundaryExtensionsId(), command.getAssignment()));
    }
    ...
    public void handle(AssignFromEndNameToBoundaryExtensionsCommand command) throws Exception {
        ...
        apply(new AssignFromEndNameToBoundaryExtensionsEvent(command.getBoundaryExtensionsId(), command.getAssignment()));
    }
    ...
    public void handle(AssignFromEndNameTsoToBoundaryExtensionsCommand command) throws Exception {
        ...
        apply(new AssignFromEndNameTsoToBoundaryExtensionsEvent(command.getBoundaryExtensionsId(), command.getAssignment()));
    }
    ...
    public void handle(AssignToEndIsoCodeToBoundaryExtensionsCommand command) throws Exception {
        ...
        apply(new AssignToEndIsoCodeToBoundaryExtensionsEvent(command.getBoundaryExtensionsId(), command.getAssignment()));
    }
    ...
    public void handle(AssignToEndNameToBoundaryExtensionsCommand command) throws Exception {
        ...
        apply(new AssignToEndNameToBoundaryExtensionsEvent(command.getBoundaryExtensionsId(), command.getAssignment()));
    }
    ...
    public void handle(AssignToEndNameTsoToBoundaryExtensionsCommand command) throws Exception {
        ...
        apply(new AssignToEndNameTsoToBoundaryExtensionsEvent(command.getBoundaryExtensionsId(), command.getAssignment()));
    }
