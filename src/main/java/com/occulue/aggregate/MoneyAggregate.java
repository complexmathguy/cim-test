...
public class MoneyAggregate {  
    ...
    public MoneyAggregate(CreateMoneyCommand command) throws Exception {
    	...
    	CreateMoneyEvent event = new CreateMoneyEvent(command.getMoneyId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateMoneyCommand command) throws Exception {
    	...
    	UpdateMoneyEvent event = new UpdateMoneyEvent(command.getMoneyId(), command.Multiplier(), command.Unit(), command.Value());        
    ...
    public void handle(AssignValueToMoneyCommand command) throws Exception {
    	...
    	if (  value != null && value.getDecimalProxyId() == command.getAssignment().getDecimalProxyId() )
    		throw new ProcessingException( "Value already assigned with id " + command.getAssignment().getDecimalProxyId() );  
