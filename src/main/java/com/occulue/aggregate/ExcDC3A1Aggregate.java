...
public class ExcDC3A1Aggregate {  
    ...
    public void handle(UpdateExcDC3A1Command command) throws Exception {
    	...
    	UpdateExcDC3A1Event event = new UpdateExcDC3A1Event(command.getExcDC3A1Id(), command.Exclim(), command.Ka(), command.Ke(), command.Kf(), command.Ki(), command.Kp(), command.Ta(), command.Te(), command.Tf(), command.Vb1max(), command.Vblim(), command.Vbmax(), command.Vrmax(), command.Vrmin());        
    ...
    public void handle(AssignVb1maxToExcDC3A1Command command) throws Exception {
    	...
    	if (  vb1max != null && vb1max.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vb1max already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignVb1maxFromExcDC3A1Command command) throws Exception {
    	...
    	if (  vb1max == null )
    		throw new ProcessingException( "Vb1max already has nothing assigned." );  
    ...
    public void handle(AssignVblimToExcDC3A1Command command) throws Exception {
    	...
    	if (  vblim != null && vblim.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Vblim already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(UnAssignVblimFromExcDC3A1Command command) throws Exception {
    	...
    	if (  vblim == null )
    		throw new ProcessingException( "Vblim already has nothing assigned." );  
