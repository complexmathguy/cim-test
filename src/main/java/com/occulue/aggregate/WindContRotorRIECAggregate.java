...
public class WindContRotorRIECAggregate {  
    ...
    public WindContRotorRIECAggregate(CreateWindContRotorRIECCommand command) throws Exception {
    	...
    	CreateWindContRotorRIECEvent event = new CreateWindContRotorRIECEvent(command.getWindContRotorRIECId());
    ...
    public void handle(UpdateWindContRotorRIECCommand command) throws Exception {
    	...
    	UpdateWindContRotorRIECEvent event = new UpdateWindContRotorRIECEvent(command.getWindContRotorRIECId(), command.Kirr(), command.Komegafilt(), command.Kpfilt(), command.Kprr(), command.Rmax(), command.Rmin(), command.Tomegafilt(), command.Tpfilt());        
    ...
    public void handle(AssignKirrToWindContRotorRIECCommand command) throws Exception {
    	...
    	if (  kirr != null && kirr.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kirr already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKirrToWindContRotorRIECEvent(command.getWindContRotorRIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKirrFromWindContRotorRIECCommand command) throws Exception {
    	...
    	if (  kirr == null )
    		throw new ProcessingException( "Kirr already has nothing assigned." );  
    ...
    public void handle(AssignKomegafiltToWindContRotorRIECCommand command) throws Exception {
    	...
    	if (  komegafilt != null && komegafilt.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Komegafilt already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignKomegafiltToWindContRotorRIECEvent(command.getWindContRotorRIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignKpfiltToWindContRotorRIECCommand command) throws Exception {
    	...
    	if (  kpfilt != null && kpfilt.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Kpfilt already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignKpfiltToWindContRotorRIECEvent(command.getWindContRotorRIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKpfiltFromWindContRotorRIECCommand command) throws Exception {
    	...
    	if (  kpfilt == null )
    		throw new ProcessingException( "Kpfilt already has nothing assigned." );  
    ...
    public void handle(AssignKprrToWindContRotorRIECCommand command) throws Exception {
    	...
    	if (  kprr != null && kprr.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kprr already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKprrToWindContRotorRIECEvent(command.getWindContRotorRIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKprrFromWindContRotorRIECCommand command) throws Exception {
    	...
    	if (  kprr == null )
    		throw new ProcessingException( "Kprr already has nothing assigned." );  
    ...
    public void handle(AssignRmaxToWindContRotorRIECCommand command) throws Exception {
    	...
    	if (  rmax != null && rmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Rmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignRmaxToWindContRotorRIECEvent(command.getWindContRotorRIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRminToWindContRotorRIECCommand command) throws Exception {
    	...
    	if (  rmin != null && rmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Rmin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignRminToWindContRotorRIECEvent(command.getWindContRotorRIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignRminFromWindContRotorRIECCommand command) throws Exception {
    	...
    	if (  rmin == null )
    		throw new ProcessingException( "Rmin already has nothing assigned." );  
    ...
    public void handle(AssignTomegafiltToWindContRotorRIECCommand command) throws Exception {
        ...
        apply(new AssignTomegafiltToWindContRotorRIECEvent(command.getWindContRotorRIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTpfiltToWindContRotorRIECCommand command) throws Exception {
        ...
        apply(new AssignTpfiltToWindContRotorRIECEvent(command.getWindContRotorRIECId(), command.getAssignment()));
    }
