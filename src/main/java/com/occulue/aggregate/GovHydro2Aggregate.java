...
public class GovHydro2Aggregate {  
    ...
    public void handle(UpdateGovHydro2Command command) throws Exception {
    	...
    	UpdateGovHydro2Event event = new UpdateGovHydro2Event(command.getGovHydro2Id(), command.Aturb(), command.Bturb(), command.Db1(), command.Db2(), command.Eps(), command.Gv1(), command.Gv2(), command.Gv3(), command.Gv4(), command.Gv5(), command.Gv6(), command.Kturb(), command.Mwbase(), command.Pgv1(), command.Pgv2(), command.Pgv3(), command.Pgv4(), command.Pgv5(), command.Pgv6(), command.Pmax(), command.Pmin(), command.Rperm(), command.Rtemp(), command.Tg(), command.Tp(), command.Tr(), command.Tw(), command.Uc(), command.Uo());        
