...
public class PUAggregate {  
    ...
    public PUAggregate(CreatePUCommand command) throws Exception {
    	...
    	CreatePUEvent event = new CreatePUEvent(command.getPUId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdatePUCommand command) throws Exception {
    	...
    	UpdatePUEvent event = new UpdatePUEvent(command.getPUId(), command.Multiplier(), command.Unit(), command.Value());        
