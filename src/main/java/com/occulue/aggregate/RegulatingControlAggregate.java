...
public class RegulatingControlAggregate {  
    ...
    public RegulatingControlAggregate(CreateRegulatingControlCommand command) throws Exception {
    	...
    	CreateRegulatingControlEvent event = new CreateRegulatingControlEvent(command.getRegulatingControlId(), command.Mode());
    ...
    public void handle(UpdateRegulatingControlCommand command) throws Exception {
    	...
    	UpdateRegulatingControlEvent event = new UpdateRegulatingControlEvent(command.getRegulatingControlId(), command.Mode());        
