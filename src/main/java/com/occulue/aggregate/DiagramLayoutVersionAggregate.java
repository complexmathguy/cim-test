...
public class DiagramLayoutVersionAggregate {  
    ...
    public DiagramLayoutVersionAggregate(CreateDiagramLayoutVersionCommand command) throws Exception {
    	...
    	CreateDiagramLayoutVersionEvent event = new CreateDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId());
    ...
    public void handle(UpdateDiagramLayoutVersionCommand command) throws Exception {
    	...
    	UpdateDiagramLayoutVersionEvent event = new UpdateDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId(), command.BaseUML(), command.BaseURI(), command.Date(), command.DifferenceModelURI(), command.EntsoeUML(), command.EntsoeURI(), command.ModelDescriptionURI(), command.NamespaceRDF(), command.NamespaceUML(), command.ShortName());        
    ...
    public void handle(AssignBaseUMLToDiagramLayoutVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseUMLToDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignBaseURIToDiagramLayoutVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseURIToDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignDateToDiagramLayoutVersionCommand command) throws Exception {
        ...
        apply(new AssignDateToDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId(), command.getAssignment()));
    }
    ...
    @CommandHandler
    public void handle(AssignDifferenceModelURIToDiagramLayoutVersionCommand command) throws Exception {
        ...
        apply(new AssignDifferenceModelURIToDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignDifferenceModelURIFromDiagramLayoutVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignDifferenceModelURIFromDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId()));
    }
    @CommandHandler
    public void handle(AssignEntsoeUMLToDiagramLayoutVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeUMLToDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignEntsoeURIToDiagramLayoutVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeURIToDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId(), command.getAssignment()));
    }
    ...
    @CommandHandler
    public void handle(AssignModelDescriptionURIToDiagramLayoutVersionCommand command) throws Exception {
        ...
        apply(new AssignModelDescriptionURIToDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignModelDescriptionURIFromDiagramLayoutVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignModelDescriptionURIFromDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId()));
    }
    @CommandHandler
    public void handle(AssignNamespaceRDFToDiagramLayoutVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceRDFToDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignNamespaceRDFFromDiagramLayoutVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignNamespaceRDFFromDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId()));
    }
    @CommandHandler
    public void handle(AssignNamespaceUMLToDiagramLayoutVersionCommand command) throws Exception {
        ...
        apply(new AssignNamespaceUMLToDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignNamespaceUMLFromDiagramLayoutVersionCommand command) throws Exception {
    	...
    	apply(new UnAssignNamespaceUMLFromDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId()));
    }
    @CommandHandler
    public void handle(AssignShortNameToDiagramLayoutVersionCommand command) throws Exception {
        ...
        apply(new AssignShortNameToDiagramLayoutVersionEvent(command.getDiagramLayoutVersionId(), command.getAssignment()));
    }
