...
public class ACLineSegmentAggregate {  
    ...
    public void handle(UpdateACLineSegmentCommand command) throws Exception {
    	...
    	UpdateACLineSegmentEvent event = new UpdateACLineSegmentEvent(command.getACLineSegmentId(), command.B0ch(), command.Bch(), command.G0ch(), command.Gch(), command.R(), command.R0(), command.ShortCircuitEndTemperature(), command.X(), command.X0());        
    ...
    public void handle(AssignB0chToACLineSegmentCommand command) throws Exception {
        ...
        apply(new AssignB0chToACLineSegmentEvent(command.getACLineSegmentId(), command.getAssignment()));
    }
    ...
    public void handle(AssignBchToACLineSegmentCommand command) throws Exception {
    	...
    	if (  bch != null && bch.getSusceptanceId() == command.getAssignment().getSusceptanceId() )
    		throw new ProcessingException( "Bch already assigned with id " + command.getAssignment().getSusceptanceId() );  
    ...
    public void handle(UnAssignBchFromACLineSegmentCommand command) throws Exception {
    	...
    	if (  bch == null )
    		throw new ProcessingException( "Bch already has nothing assigned." );  
    ...
    public void handle(AssignG0chToACLineSegmentCommand command) throws Exception {
        ...
        apply(new AssignG0chToACLineSegmentEvent(command.getACLineSegmentId(), command.getAssignment()));
    }
    ...
    public void handle(AssignGchToACLineSegmentCommand command) throws Exception {
    	...
    	if (  gch != null && gch.getConductanceId() == command.getAssignment().getConductanceId() )
    		throw new ProcessingException( "Gch already assigned with id " + command.getAssignment().getConductanceId() );  
    ...
    public void handle(UnAssignGchFromACLineSegmentCommand command) throws Exception {
    	...
    	if (  gch == null )
    		throw new ProcessingException( "Gch already has nothing assigned." );  
    ...
    @CommandHandler
    public void handle(AssignShortCircuitEndTemperatureToACLineSegmentCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignShortCircuitEndTemperatureToACLineSegmentCommand" );
    	
    	if (  shortCircuitEndTemperature != null && shortCircuitEndTemperature.getTemperatureId() == command.getAssignment().getTemperatureId() )
    		throw new ProcessingException( "ShortCircuitEndTemperature already assigned with id " + command.getAssignment().getTemperatureId() );  
    		
        apply(new AssignShortCircuitEndTemperatureToACLineSegmentEvent(command.getACLineSegmentId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignShortCircuitEndTemperatureFromACLineSegmentCommand command) throws Exception {
    	...
    	apply(new UnAssignShortCircuitEndTemperatureFromACLineSegmentEvent(command.getACLineSegmentId()));
    }
    @CommandHandler
