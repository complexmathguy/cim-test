...
public class GovSteamFV2Aggregate {  
    ...
    public void handle(UpdateGovSteamFV2Command command) throws Exception {
    	...
    	UpdateGovSteamFV2Event event = new UpdateGovSteamFV2Event(command.getGovSteamFV2Id(), command.Dt(), command.K(), command.Mwbase(), command.R(), command.T1(), command.T3(), command.Ta(), command.Tb(), command.Tc(), command.Ti(), command.Tt(), command.Vmax(), command.Vmin());        
    ...
    public void handle(AssignDtToGovSteamFV2Command command) throws Exception {
    	...
    	if (  dt != null && dt.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Dt already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignDtFromGovSteamFV2Command command) throws Exception {
    	...
    	if (  dt == null )
    		throw new ProcessingException( "Dt already has nothing assigned." );  
