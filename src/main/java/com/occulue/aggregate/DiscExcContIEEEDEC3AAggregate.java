...
public class DiscExcContIEEEDEC3AAggregate {  
    ...
    public DiscExcContIEEEDEC3AAggregate(CreateDiscExcContIEEEDEC3ACommand command) throws Exception {
    	...
    	CreateDiscExcContIEEEDEC3AEvent event = new CreateDiscExcContIEEEDEC3AEvent(command.getDiscExcContIEEEDEC3AId());
    ...
    public void handle(UpdateDiscExcContIEEEDEC3ACommand command) throws Exception {
    	...
    	UpdateDiscExcContIEEEDEC3AEvent event = new UpdateDiscExcContIEEEDEC3AEvent(command.getDiscExcContIEEEDEC3AId(), command.Tdr(), command.Vtmin());        
    ...
    public void handle(AssignTdrToDiscExcContIEEEDEC3ACommand command) throws Exception {
        ...
        apply(new AssignTdrToDiscExcContIEEEDEC3AEvent(command.getDiscExcContIEEEDEC3AId(), command.getAssignment()));
    }
    ...
    public void handle(AssignVtminToDiscExcContIEEEDEC3ACommand command) throws Exception {
        ...
        apply(new AssignVtminToDiscExcContIEEEDEC3AEvent(command.getDiscExcContIEEEDEC3AId(), command.getAssignment()));
    }
