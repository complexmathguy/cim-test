...
public class ExcDC1AAggregate {  
    ...
    public void handle(UpdateExcDC1ACommand command) throws Exception {
    	...
    	UpdateExcDC1AEvent event = new UpdateExcDC1AEvent(command.getExcDC1AId(), command.Edfmax(), command.Efd1(), command.Efd2(), command.Efdmin(), command.Exclim(), command.Ka(), command.Ke(), command.Kf(), command.Ks(), command.Seefd1(), command.Seefd2(), command.Ta(), command.Tb(), command.Tc(), command.Te(), command.Tf(), command.Vrmax(), command.Vrmin());        
    ...
    public void handle(AssignEdfmaxToExcDC1ACommand command) throws Exception {
    	...
    	if (  edfmax != null && edfmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Edfmax already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignEdfmaxFromExcDC1ACommand command) throws Exception {
    	...
    	if (  edfmax == null )
    		throw new ProcessingException( "Edfmax already has nothing assigned." );  
