...
public class ExcIEEEAC3AAggregate {  
    ...
    public void handle(UpdateExcIEEEAC3ACommand command) throws Exception {
    	...
    	UpdateExcIEEEAC3AEvent event = new UpdateExcIEEEAC3AEvent(command.getExcIEEEAC3AId(), command.Efdn(), command.Ka(), command.Kc(), command.Kd(), command.Ke(), command.Kf(), command.Kn(), command.Kr(), command.Seve1(), command.Seve2(), command.Ta(), command.Tb(), command.Tc(), command.Te(), command.Tf(), command.Vamax(), command.Vamin(), command.Ve1(), command.Ve2(), command.Vemin(), command.Vfemax());        
