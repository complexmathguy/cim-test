...
public class UnderexcitationLimiterUserDefinedAggregate {  
    ...
    public UnderexcitationLimiterUserDefinedAggregate(CreateUnderexcitationLimiterUserDefinedCommand command) throws Exception {
    	...
    	CreateUnderexcitationLimiterUserDefinedEvent event = new CreateUnderexcitationLimiterUserDefinedEvent(command.getUnderexcitationLimiterUserDefinedId());
    ...
    public void handle(UpdateUnderexcitationLimiterUserDefinedCommand command) throws Exception {
    	...
    	UpdateUnderexcitationLimiterUserDefinedEvent event = new UpdateUnderexcitationLimiterUserDefinedEvent(command.getUnderexcitationLimiterUserDefinedId(), command.Proprietary());        
    ...
    @CommandHandler
    public void handle(AssignProprietaryToUnderexcitationLimiterUserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToUnderexcitationLimiterUserDefinedEvent(command.getUnderexcitationLimiterUserDefinedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignProprietaryFromUnderexcitationLimiterUserDefinedCommand command) throws Exception {
    	...
    	apply(new UnAssignProprietaryFromUnderexcitationLimiterUserDefinedEvent(command.getUnderexcitationLimiterUserDefinedId()));
    }
