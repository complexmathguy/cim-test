...
public class ExcAVR2Aggregate {  
    ...
    public void handle(UpdateExcAVR2Command command) throws Exception {
    	...
    	UpdateExcAVR2Event event = new UpdateExcAVR2Event(command.getExcAVR2Id(), command.E1(), command.E2(), command.Ka(), command.Kf(), command.Se1(), command.Se2(), command.Ta(), command.Tb(), command.Te(), command.Tf1(), command.Tf2(), command.Vrmn(), command.Vrmx());        
    ...
    public void handle(AssignSe1ToExcAVR2Command command) throws Exception {
    	...
    	if (  se1 != null && se1.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Se1 already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    ...
    public void handle(AssignSe2ToExcAVR2Command command) throws Exception {
    	...
    	if (  se2 != null && se2.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Se2 already assigned with id " + command.getAssignment().getSimple_FloatId() );  
