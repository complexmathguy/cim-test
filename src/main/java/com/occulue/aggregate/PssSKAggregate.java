...
public class PssSKAggregate {  
    ...
    public void handle(UpdatePssSKCommand command) throws Exception {
    	...
    	UpdatePssSKEvent event = new UpdatePssSKEvent(command.getPssSKId(), command.K1(), command.K2(), command.K3(), command.T1(), command.T2(), command.T3(), command.T4(), command.T5(), command.T6(), command.Vsmax(), command.Vsmin());        
