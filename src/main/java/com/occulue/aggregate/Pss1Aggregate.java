...
public class Pss1Aggregate {  
    ...
    public void handle(UpdatePss1Command command) throws Exception {
    	...
    	UpdatePss1Event event = new UpdatePss1Event(command.getPss1Id(), command.Kf(), command.Kpe(), command.Ks(), command.Kw(), command.Pmin(), command.T10(), command.T5(), command.T6(), command.T7(), command.T8(), command.T9(), command.Tpe(), command.Vadat(), command.Vsmn(), command.Vsmx());        
    ...
    public void handle(AssignKwToPss1Command command) throws Exception {
    	...
    	if (  kw != null && kw.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Kw already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    ...
    public void handle(UnAssignKwFromPss1Command command) throws Exception {
    	...
    	if (  kw == null )
    		throw new ProcessingException( "Kw already has nothing assigned." );  
