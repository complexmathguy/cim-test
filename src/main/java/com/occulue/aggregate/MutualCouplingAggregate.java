...
public class MutualCouplingAggregate {  
    ...
    public void handle(UpdateMutualCouplingCommand command) throws Exception {
    	...
    	UpdateMutualCouplingEvent event = new UpdateMutualCouplingEvent(command.getMutualCouplingId(), command.B0ch(), command.Distance11(), command.Distance12(), command.Distance21(), command.Distance22(), command.G0ch(), command.R0(), command.X0());        
