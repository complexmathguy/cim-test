...
public class GovHydroWPIDAggregate {  
    ...
    public void handle(UpdateGovHydroWPIDCommand command) throws Exception {
    	...
    	UpdateGovHydroWPIDEvent event = new UpdateGovHydroWPIDEvent(command.getGovHydroWPIDId(), command.D(), command.Gatmax(), command.Gatmin(), command.Gv1(), command.Gv2(), command.Gv3(), command.Kd(), command.Ki(), command.Kp(), command.Mwbase(), command.Pgv1(), command.Pgv2(), command.Pgv3(), command.Pmax(), command.Pmin(), command.Reg(), command.Ta(), command.Tb(), command.Treg(), command.Tw(), command.Velmax(), command.Velmin());        
    ...
    public void handle(AssignDToGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  d != null && d.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "D already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignDFromGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  d == null )
    		throw new ProcessingException( "D already has nothing assigned." );  
    ...
    public void handle(AssignGatmaxToGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  gatmax != null && gatmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Gatmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignGatmaxToGovHydroWPIDEvent(command.getGovHydroWPIDId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignGatmaxFromGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  gatmax == null )
    		throw new ProcessingException( "Gatmax already has nothing assigned." );  
    ...
    public void handle(AssignGatminToGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  gatmin != null && gatmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Gatmin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignGatminToGovHydroWPIDEvent(command.getGovHydroWPIDId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignGatminFromGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  gatmin == null )
    		throw new ProcessingException( "Gatmin already has nothing assigned." );  
    ...
    public void handle(AssignMwbaseToGovHydroWPIDCommand command) throws Exception {
        ...
        apply(new AssignMwbaseToGovHydroWPIDEvent(command.getGovHydroWPIDId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRegToGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  reg != null && reg.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Reg already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignRegFromGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  reg == null )
    		throw new ProcessingException( "Reg already has nothing assigned." );  
    ...
    public void handle(AssignTregToGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  treg != null && treg.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Treg already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(UnAssignTregFromGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  treg == null )
    		throw new ProcessingException( "Treg already has nothing assigned." );  
    ...
    public void handle(AssignVelmaxToGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  velmax != null && velmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Velmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVelmaxToGovHydroWPIDEvent(command.getGovHydroWPIDId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVelmaxFromGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  velmax == null )
    		throw new ProcessingException( "Velmax already has nothing assigned." );  
    ...
    public void handle(AssignVelminToGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  velmin != null && velmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Velmin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVelminToGovHydroWPIDEvent(command.getGovHydroWPIDId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVelminFromGovHydroWPIDCommand command) throws Exception {
    	...
    	if (  velmin == null )
    		throw new ProcessingException( "Velmin already has nothing assigned." );  
