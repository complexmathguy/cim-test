...
public class DCSeriesDeviceAggregate {  
    ...
    public void handle(UpdateDCSeriesDeviceCommand command) throws Exception {
    	...
    	UpdateDCSeriesDeviceEvent event = new UpdateDCSeriesDeviceEvent(command.getDCSeriesDeviceId(), command.Inductance(), command.RatedUdc(), command.Resistance());        
    ...
    public void handle(AssignInductanceToDCSeriesDeviceCommand command) throws Exception {
        ...
        apply(new AssignInductanceToDCSeriesDeviceEvent(command.getDCSeriesDeviceId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRatedUdcToDCSeriesDeviceCommand command) throws Exception {
        ...
        apply(new AssignRatedUdcToDCSeriesDeviceEvent(command.getDCSeriesDeviceId(), command.getAssignment()));
    }
    ...
    public void handle(AssignResistanceToDCSeriesDeviceCommand command) throws Exception {
        ...
        apply(new AssignResistanceToDCSeriesDeviceEvent(command.getDCSeriesDeviceId(), command.getAssignment()));
    }
