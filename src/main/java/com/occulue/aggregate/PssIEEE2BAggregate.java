...
public class PssIEEE2BAggregate {  
    ...
    public PssIEEE2BAggregate(CreatePssIEEE2BCommand command) throws Exception {
    	...
    	CreatePssIEEE2BEvent event = new CreatePssIEEE2BEvent(command.getPssIEEE2BId(), command.InputSignal1Type(), command.InputSignal2Type());
    ...
    public void handle(UpdatePssIEEE2BCommand command) throws Exception {
    	...
    	UpdatePssIEEE2BEvent event = new UpdatePssIEEE2BEvent(command.getPssIEEE2BId(), command.InputSignal1Type(), command.InputSignal2Type(), command.Ks1(), command.Ks2(), command.Ks3(), command.M(), command.N(), command.T1(), command.T10(), command.T11(), command.T2(), command.T3(), command.T4(), command.T6(), command.T7(), command.T8(), command.T9(), command.Tw1(), command.Tw2(), command.Tw3(), command.Tw4(), command.Vsi1max(), command.Vsi1min(), command.Vsi2max(), command.Vsi2min(), command.Vstmax(), command.Vstmin());        
