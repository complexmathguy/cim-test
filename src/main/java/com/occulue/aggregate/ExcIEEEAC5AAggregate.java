...
public class ExcIEEEAC5AAggregate {  
    ...
    public void handle(UpdateExcIEEEAC5ACommand command) throws Exception {
    	...
    	UpdateExcIEEEAC5AEvent event = new UpdateExcIEEEAC5AEvent(command.getExcIEEEAC5AId(), command.Efd1(), command.Efd2(), command.Ka(), command.Ke(), command.Kf(), command.Seefd1(), command.Seefd2(), command.Ta(), command.Te(), command.Tf1(), command.Tf2(), command.Tf3(), command.Vrmax(), command.Vrmin());        
