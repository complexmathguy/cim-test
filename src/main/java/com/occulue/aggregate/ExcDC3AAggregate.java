...
public class ExcDC3AAggregate {  
    ...
    public void handle(UpdateExcDC3ACommand command) throws Exception {
    	...
    	UpdateExcDC3AEvent event = new UpdateExcDC3AEvent(command.getExcDC3AId(), command.Edfmax(), command.Efd1(), command.Efd2(), command.Efdlim(), command.Efdmin(), command.Exclim(), command.Ke(), command.Kr(), command.Ks(), command.Kv(), command.Seefd1(), command.Seefd2(), command.Te(), command.Trh(), command.Vrmax(), command.Vrmin());        
    ...
    public void handle(AssignEfdlimToExcDC3ACommand command) throws Exception {
    	...
    	if (  efdlim != null && efdlim.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Efdlim already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(UnAssignEfdlimFromExcDC3ACommand command) throws Exception {
    	...
    	if (  efdlim == null )
    		throw new ProcessingException( "Efdlim already has nothing assigned." );  
    ...
    public void handle(AssignKvToExcDC3ACommand command) throws Exception {
    	...
    	if (  kv != null && kv.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kv already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignKvFromExcDC3ACommand command) throws Exception {
    	...
    	if (  kv == null )
    		throw new ProcessingException( "Kv already has nothing assigned." );  
