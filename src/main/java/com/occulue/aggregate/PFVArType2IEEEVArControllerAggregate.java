...
public class PFVArType2IEEEVArControllerAggregate {  
    ...
    public PFVArType2IEEEVArControllerAggregate(CreatePFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	CreatePFVArType2IEEEVArControllerEvent event = new CreatePFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId());
    ...
    public void handle(UpdatePFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	UpdatePFVArType2IEEEVArControllerEvent event = new UpdatePFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId(), command.Exlon(), command.Ki(), command.Kp(), command.Qref(), command.Vclmt(), command.Vref(), command.Vs());        
    ...
    public void handle(AssignExlonToPFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  exlon != null && exlon.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Exlon already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignExlonToPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignExlonFromPFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  exlon == null )
    		throw new ProcessingException( "Exlon already has nothing assigned." );  

    	apply(new UnAssignExlonFromPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId()));
    }
    @CommandHandler
    public void handle(AssignKiToPFVArType2IEEEVArControllerCommand command) throws Exception {
        ...
        apply(new AssignKiToPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKiFromPFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	apply(new UnAssignKiFromPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId()));
    }
    @CommandHandler
    public void handle(AssignKpToPFVArType2IEEEVArControllerCommand command) throws Exception {
        ...
        apply(new AssignKpToPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKpFromPFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	apply(new UnAssignKpFromPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId()));
    }
    @CommandHandler
    public void handle(AssignQrefToPFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  qref != null && qref.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Qref already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignQrefToPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignQrefFromPFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  qref == null )
    		throw new ProcessingException( "Qref already has nothing assigned." );  

    	apply(new UnAssignQrefFromPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId()));
    }
    @CommandHandler
    public void handle(AssignVclmtToPFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  vclmt != null && vclmt.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vclmt already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVclmtToPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVclmtFromPFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  vclmt == null )
    		throw new ProcessingException( "Vclmt already has nothing assigned." );  

    	apply(new UnAssignVclmtFromPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId()));
    }
    @CommandHandler
    public void handle(AssignVrefToPFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  vref != null && vref.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vref already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVrefToPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVrefFromPFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  vref == null )
    		throw new ProcessingException( "Vref already has nothing assigned." );  

    	apply(new UnAssignVrefFromPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId()));
    }
    @CommandHandler
    public void handle(AssignVsToPFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  vs != null && vs.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Vs already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignVsToPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVsFromPFVArType2IEEEVArControllerCommand command) throws Exception {
    	...
    	if (  vs == null )
    		throw new ProcessingException( "Vs already has nothing assigned." );  

    	apply(new UnAssignVsFromPFVArType2IEEEVArControllerEvent(command.getPFVArType2IEEEVArControllerId()));
    }
