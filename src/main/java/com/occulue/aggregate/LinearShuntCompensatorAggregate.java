...
public class LinearShuntCompensatorAggregate {  
    ...
    public LinearShuntCompensatorAggregate(CreateLinearShuntCompensatorCommand command) throws Exception {
    	...
    	CreateLinearShuntCompensatorEvent event = new CreateLinearShuntCompensatorEvent(command.getLinearShuntCompensatorId());
    ...
    public void handle(UpdateLinearShuntCompensatorCommand command) throws Exception {
    	...
    	UpdateLinearShuntCompensatorEvent event = new UpdateLinearShuntCompensatorEvent(command.getLinearShuntCompensatorId(), command.B0PerSection(), command.BPerSection(), command.G0PerSection(), command.GPerSection());        
    ...
    public void handle(AssignB0PerSectionToLinearShuntCompensatorCommand command) throws Exception {
    	...
    	if (  b0PerSection != null && b0PerSection.getSusceptanceId() == command.getAssignment().getSusceptanceId() )
    		throw new ProcessingException( "B0PerSection already assigned with id " + command.getAssignment().getSusceptanceId() );  
    		
        apply(new AssignB0PerSectionToLinearShuntCompensatorEvent(command.getLinearShuntCompensatorId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignB0PerSectionFromLinearShuntCompensatorCommand command) throws Exception {
    	...
    	apply(new UnAssignB0PerSectionFromLinearShuntCompensatorEvent(command.getLinearShuntCompensatorId()));
    }
    @CommandHandler
    public void handle(AssignBPerSectionToLinearShuntCompensatorCommand command) throws Exception {
    	...
    	if (  bPerSection != null && bPerSection.getSusceptanceId() == command.getAssignment().getSusceptanceId() )
    		throw new ProcessingException( "BPerSection already assigned with id " + command.getAssignment().getSusceptanceId() );  
    		
        apply(new AssignBPerSectionToLinearShuntCompensatorEvent(command.getLinearShuntCompensatorId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignBPerSectionFromLinearShuntCompensatorCommand command) throws Exception {
    	...
    	apply(new UnAssignBPerSectionFromLinearShuntCompensatorEvent(command.getLinearShuntCompensatorId()));
    }
    @CommandHandler
    public void handle(AssignG0PerSectionToLinearShuntCompensatorCommand command) throws Exception {
    	...
    	if (  g0PerSection != null && g0PerSection.getConductanceId() == command.getAssignment().getConductanceId() )
    		throw new ProcessingException( "G0PerSection already assigned with id " + command.getAssignment().getConductanceId() );  
    		
        apply(new AssignG0PerSectionToLinearShuntCompensatorEvent(command.getLinearShuntCompensatorId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignG0PerSectionFromLinearShuntCompensatorCommand command) throws Exception {
    	...
    	apply(new UnAssignG0PerSectionFromLinearShuntCompensatorEvent(command.getLinearShuntCompensatorId()));
    }
    @CommandHandler
    public void handle(AssignGPerSectionToLinearShuntCompensatorCommand command) throws Exception {
    	...
    	if (  gPerSection != null && gPerSection.getConductanceId() == command.getAssignment().getConductanceId() )
    		throw new ProcessingException( "GPerSection already assigned with id " + command.getAssignment().getConductanceId() );  
    		
        apply(new AssignGPerSectionToLinearShuntCompensatorEvent(command.getLinearShuntCompensatorId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignGPerSectionFromLinearShuntCompensatorCommand command) throws Exception {
    	...
    	apply(new UnAssignGPerSectionFromLinearShuntCompensatorEvent(command.getLinearShuntCompensatorId()));
    }
