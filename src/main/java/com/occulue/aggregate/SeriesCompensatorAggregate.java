...
public class SeriesCompensatorAggregate {  
    ...
    public SeriesCompensatorAggregate(CreateSeriesCompensatorCommand command) throws Exception {
    	...
    	CreateSeriesCompensatorEvent event = new CreateSeriesCompensatorEvent(command.getSeriesCompensatorId());
    ...
    public void handle(UpdateSeriesCompensatorCommand command) throws Exception {
    	...
    	UpdateSeriesCompensatorEvent event = new UpdateSeriesCompensatorEvent(command.getSeriesCompensatorId(), command.R(), command.R0(), command.VaristorPresent(), command.VaristorRatedCurrent(), command.VaristorVoltageThreshold(), command.X(), command.X0());        
    ...
    public void handle(AssignRToSeriesCompensatorCommand command) throws Exception {
        ...
        apply(new AssignRToSeriesCompensatorEvent(command.getSeriesCompensatorId(), command.getAssignment()));
    }
    ...
    public void handle(AssignR0ToSeriesCompensatorCommand command) throws Exception {
        ...
        apply(new AssignR0ToSeriesCompensatorEvent(command.getSeriesCompensatorId(), command.getAssignment()));
    }
    ...
    public void handle(AssignVaristorPresentToSeriesCompensatorCommand command) throws Exception {
    	...
    	if (  varistorPresent != null && varistorPresent.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "VaristorPresent already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignVaristorPresentToSeriesCompensatorEvent(command.getSeriesCompensatorId(), command.getAssignment()));
    }
    ...
    @CommandHandler
    public void handle(AssignVaristorRatedCurrentToSeriesCompensatorCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignVaristorRatedCurrentToSeriesCompensatorCommand" );
    	
    	if (  varistorRatedCurrent != null && varistorRatedCurrent.getCurrentFlowId() == command.getAssignment().getCurrentFlowId() )
    		throw new ProcessingException( "VaristorRatedCurrent already assigned with id " + command.getAssignment().getCurrentFlowId() );  
    		
        apply(new AssignVaristorRatedCurrentToSeriesCompensatorEvent(command.getSeriesCompensatorId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignVaristorRatedCurrentFromSeriesCompensatorCommand command) throws Exception {
    	...
    	apply(new UnAssignVaristorRatedCurrentFromSeriesCompensatorEvent(command.getSeriesCompensatorId()));
    }
    @CommandHandler
    public void handle(AssignVaristorVoltageThresholdToSeriesCompensatorCommand command) throws Exception {
    	LOGGER.info( "Handling command AssignVaristorVoltageThresholdToSeriesCompensatorCommand" );
    	
    	if (  varistorVoltageThreshold != null && varistorVoltageThreshold.getVoltageId() == command.getAssignment().getVoltageId() )
    		throw new ProcessingException( "VaristorVoltageThreshold already assigned with id " + command.getAssignment().getVoltageId() );  
    		
        apply(new AssignVaristorVoltageThresholdToSeriesCompensatorEvent(command.getSeriesCompensatorId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignVaristorVoltageThresholdFromSeriesCompensatorCommand command) throws Exception {
    	...
    	apply(new UnAssignVaristorVoltageThresholdFromSeriesCompensatorEvent(command.getSeriesCompensatorId()));
    }
    @CommandHandler
    public void handle(AssignXToSeriesCompensatorCommand command) throws Exception {
        ...
        apply(new AssignXToSeriesCompensatorEvent(command.getSeriesCompensatorId(), command.getAssignment()));
    }
    ...
    public void handle(AssignX0ToSeriesCompensatorCommand command) throws Exception {
        ...
        apply(new AssignX0ToSeriesCompensatorEvent(command.getSeriesCompensatorId(), command.getAssignment()));
    }
