...
public class PFVArType1IEEEPFControllerAggregate {  
    ...
    public PFVArType1IEEEPFControllerAggregate(CreatePFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	CreatePFVArType1IEEEPFControllerEvent event = new CreatePFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId());
    ...
    public void handle(UpdatePFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	UpdatePFVArType1IEEEPFControllerEvent event = new UpdatePFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId(), command.Ovex(), command.Tpfc(), command.Vitmin(), command.Vpf(), command.Vpfcbw(), command.Vpfref(), command.Vvtmax(), command.Vvtmin());        
    ...
    public void handle(AssignOvexToPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  ovex != null && ovex.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Ovex already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignOvexToPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignOvexFromPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  ovex == null )
    		throw new ProcessingException( "Ovex already has nothing assigned." );  

    	apply(new UnAssignOvexFromPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId()));
    }
    @CommandHandler
    public void handle(AssignTpfcToPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  tpfc != null && tpfc.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tpfc already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTpfcToPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTpfcFromPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  tpfc == null )
    		throw new ProcessingException( "Tpfc already has nothing assigned." );  

    	apply(new UnAssignTpfcFromPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId()));
    }
    @CommandHandler
    public void handle(AssignVitminToPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  vitmin != null && vitmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vitmin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVitminToPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVitminFromPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  vitmin == null )
    		throw new ProcessingException( "Vitmin already has nothing assigned." );  

    	apply(new UnAssignVitminFromPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId()));
    }
    @CommandHandler
    public void handle(AssignVpfToPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  vpf != null && vpf.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vpf already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVpfToPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVpfFromPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  vpf == null )
    		throw new ProcessingException( "Vpf already has nothing assigned." );  

    	apply(new UnAssignVpfFromPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId()));
    }
    @CommandHandler
    public void handle(AssignVpfcbwToPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  vpfcbw != null && vpfcbw.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Vpfcbw already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignVpfcbwToPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVpfcbwFromPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  vpfcbw == null )
    		throw new ProcessingException( "Vpfcbw already has nothing assigned." );  

    	apply(new UnAssignVpfcbwFromPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId()));
    }
    @CommandHandler
    public void handle(AssignVpfrefToPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  vpfref != null && vpfref.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vpfref already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVpfrefToPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVpfrefFromPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  vpfref == null )
    		throw new ProcessingException( "Vpfref already has nothing assigned." );  

    	apply(new UnAssignVpfrefFromPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId()));
    }
    @CommandHandler
    public void handle(AssignVvtmaxToPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  vvtmax != null && vvtmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vvtmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVvtmaxToPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVvtmaxFromPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  vvtmax == null )
    		throw new ProcessingException( "Vvtmax already has nothing assigned." );  

    	apply(new UnAssignVvtmaxFromPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId()));
    }
    @CommandHandler
    public void handle(AssignVvtminToPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  vvtmin != null && vvtmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vvtmin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignVvtminToPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVvtminFromPFVArType1IEEEPFControllerCommand command) throws Exception {
    	...
    	if (  vvtmin == null )
    		throw new ProcessingException( "Vvtmin already has nothing assigned." );  

    	apply(new UnAssignVvtminFromPFVArType1IEEEPFControllerEvent(command.getPFVArType1IEEEPFControllerId()));
    }
