...
public class ConductanceAggregate {  
    ...
    public ConductanceAggregate(CreateConductanceCommand command) throws Exception {
    	...
    	CreateConductanceEvent event = new CreateConductanceEvent(command.getConductanceId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateConductanceCommand command) throws Exception {
    	...
    	UpdateConductanceEvent event = new UpdateConductanceEvent(command.getConductanceId(), command.Multiplier(), command.Unit(), command.Value());        
