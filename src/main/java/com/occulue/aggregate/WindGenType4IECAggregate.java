...
public class WindGenType4IECAggregate {  
    ...
    public WindGenType4IECAggregate(CreateWindGenType4IECCommand command) throws Exception {
    	...
    	CreateWindGenType4IECEvent event = new CreateWindGenType4IECEvent(command.getWindGenType4IECId());
    ...
    public void handle(UpdateWindGenType4IECCommand command) throws Exception {
    	...
    	UpdateWindGenType4IECEvent event = new UpdateWindGenType4IECEvent(command.getWindGenType4IECId(), command.Dipmax(), command.Diqmax(), command.Diqmin(), command.Tg());        
    ...
    public void handle(AssignDipmaxToWindGenType4IECCommand command) throws Exception {
        ...
        apply(new AssignDipmaxToWindGenType4IECEvent(command.getWindGenType4IECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignDiqmaxToWindGenType4IECCommand command) throws Exception {
        ...
        apply(new AssignDiqmaxToWindGenType4IECEvent(command.getWindGenType4IECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignDiqminToWindGenType4IECCommand command) throws Exception {
    	...
    	if (  diqmin != null && diqmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Diqmin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignDiqminToWindGenType4IECEvent(command.getWindGenType4IECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignDiqminFromWindGenType4IECCommand command) throws Exception {
    	...
    	if (  diqmin == null )
    		throw new ProcessingException( "Diqmin already has nothing assigned." );  
    ...
    public void handle(AssignTgToWindGenType4IECCommand command) throws Exception {
        ...
        apply(new AssignTgToWindGenType4IECEvent(command.getWindGenType4IECId(), command.getAssignment()));
    }
