...
public class ACDCConverterDCTerminalAggregate {  
    ...
    public ACDCConverterDCTerminalAggregate(CreateACDCConverterDCTerminalCommand command) throws Exception {
    	...
    	CreateACDCConverterDCTerminalEvent event = new CreateACDCConverterDCTerminalEvent(command.getACDCConverterDCTerminalId(), command.Polarity());
    ...
    public void handle(UpdateACDCConverterDCTerminalCommand command) throws Exception {
    	...
    	UpdateACDCConverterDCTerminalEvent event = new UpdateACDCConverterDCTerminalEvent(command.getACDCConverterDCTerminalId(), command.Polarity());        
