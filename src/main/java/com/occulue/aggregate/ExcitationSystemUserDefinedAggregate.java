...
public class ExcitationSystemUserDefinedAggregate {  
    ...
    public ExcitationSystemUserDefinedAggregate(CreateExcitationSystemUserDefinedCommand command) throws Exception {
    	...
    	CreateExcitationSystemUserDefinedEvent event = new CreateExcitationSystemUserDefinedEvent(command.getExcitationSystemUserDefinedId());
    ...
    public void handle(UpdateExcitationSystemUserDefinedCommand command) throws Exception {
    	...
    	UpdateExcitationSystemUserDefinedEvent event = new UpdateExcitationSystemUserDefinedEvent(command.getExcitationSystemUserDefinedId(), command.Proprietary());        
    ...
    @CommandHandler
    public void handle(AssignProprietaryToExcitationSystemUserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToExcitationSystemUserDefinedEvent(command.getExcitationSystemUserDefinedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignProprietaryFromExcitationSystemUserDefinedCommand command) throws Exception {
    	...
    	apply(new UnAssignProprietaryFromExcitationSystemUserDefinedEvent(command.getExcitationSystemUserDefinedId()));
    }
