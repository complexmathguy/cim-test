...
public class EquivalentBranchAggregate {  
    ...
    public EquivalentBranchAggregate(CreateEquivalentBranchCommand command) throws Exception {
    	...
    	CreateEquivalentBranchEvent event = new CreateEquivalentBranchEvent(command.getEquivalentBranchId());
    ...
    public void handle(UpdateEquivalentBranchCommand command) throws Exception {
    	...
    	UpdateEquivalentBranchEvent event = new UpdateEquivalentBranchEvent(command.getEquivalentBranchId(), command.NegativeR12(), command.NegativeR21(), command.NegativeX12(), command.NegativeX21(), command.PositiveR12(), command.PositiveR21(), command.PositiveX12(), command.PositiveX21(), command.R(), command.R21(), command.X(), command.X21(), command.ZeroR12(), command.ZeroR21(), command.ZeroX12(), command.ZeroX21());        
    ...
    public void handle(AssignNegativeR12ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  negativeR12 != null && negativeR12.getResistanceId() == command.getAssignment().getResistanceId() )
    		throw new ProcessingException( "NegativeR12 already assigned with id " + command.getAssignment().getResistanceId() );  
    		
        apply(new AssignNegativeR12ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(AssignNegativeR21ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  negativeR21 != null && negativeR21.getResistanceId() == command.getAssignment().getResistanceId() )
    		throw new ProcessingException( "NegativeR21 already assigned with id " + command.getAssignment().getResistanceId() );  
    		
        apply(new AssignNegativeR21ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(AssignNegativeX12ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  negativeX12 != null && negativeX12.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "NegativeX12 already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignNegativeX12ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(AssignNegativeX21ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  negativeX21 != null && negativeX21.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "NegativeX21 already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignNegativeX21ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(AssignPositiveR12ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  positiveR12 != null && positiveR12.getResistanceId() == command.getAssignment().getResistanceId() )
    		throw new ProcessingException( "PositiveR12 already assigned with id " + command.getAssignment().getResistanceId() );  
    		
        apply(new AssignPositiveR12ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(AssignPositiveR21ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  positiveR21 != null && positiveR21.getResistanceId() == command.getAssignment().getResistanceId() )
    		throw new ProcessingException( "PositiveR21 already assigned with id " + command.getAssignment().getResistanceId() );  
    		
        apply(new AssignPositiveR21ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(AssignPositiveX12ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  positiveX12 != null && positiveX12.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "PositiveX12 already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignPositiveX12ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(AssignPositiveX21ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  positiveX21 != null && positiveX21.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "PositiveX21 already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignPositiveX21ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRToEquivalentBranchCommand command) throws Exception {
        ...
        apply(new AssignRToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(AssignR21ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  r21 != null && r21.getResistanceId() == command.getAssignment().getResistanceId() )
    		throw new ProcessingException( "R21 already assigned with id " + command.getAssignment().getResistanceId() );  
    		
        apply(new AssignR21ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignR21FromEquivalentBranchCommand command) throws Exception {
    	...
    	if (  r21 == null )
    		throw new ProcessingException( "R21 already has nothing assigned." );  
    ...
    public void handle(AssignXToEquivalentBranchCommand command) throws Exception {
        ...
        apply(new AssignXToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(AssignX21ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  x21 != null && x21.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "X21 already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignX21ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignX21FromEquivalentBranchCommand command) throws Exception {
    	...
    	if (  x21 == null )
    		throw new ProcessingException( "X21 already has nothing assigned." );  
    ...
    public void handle(AssignZeroR12ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  zeroR12 != null && zeroR12.getResistanceId() == command.getAssignment().getResistanceId() )
    		throw new ProcessingException( "ZeroR12 already assigned with id " + command.getAssignment().getResistanceId() );  
    		
        apply(new AssignZeroR12ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignZeroR12FromEquivalentBranchCommand command) throws Exception {
    	...
    	if (  zeroR12 == null )
    		throw new ProcessingException( "ZeroR12 already has nothing assigned." );  
    ...
    public void handle(AssignZeroR21ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  zeroR21 != null && zeroR21.getResistanceId() == command.getAssignment().getResistanceId() )
    		throw new ProcessingException( "ZeroR21 already assigned with id " + command.getAssignment().getResistanceId() );  
    		
        apply(new AssignZeroR21ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignZeroR21FromEquivalentBranchCommand command) throws Exception {
    	...
    	if (  zeroR21 == null )
    		throw new ProcessingException( "ZeroR21 already has nothing assigned." );  
    ...
    public void handle(AssignZeroX12ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  zeroX12 != null && zeroX12.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "ZeroX12 already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignZeroX12ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignZeroX12FromEquivalentBranchCommand command) throws Exception {
    	...
    	if (  zeroX12 == null )
    		throw new ProcessingException( "ZeroX12 already has nothing assigned." );  
    ...
    public void handle(AssignZeroX21ToEquivalentBranchCommand command) throws Exception {
    	...
    	if (  zeroX21 != null && zeroX21.getReactanceId() == command.getAssignment().getReactanceId() )
    		throw new ProcessingException( "ZeroX21 already assigned with id " + command.getAssignment().getReactanceId() );  
    		
        apply(new AssignZeroX21ToEquivalentBranchEvent(command.getEquivalentBranchId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignZeroX21FromEquivalentBranchCommand command) throws Exception {
    	...
    	if (  zeroX21 == null )
    		throw new ProcessingException( "ZeroX21 already has nothing assigned." );  
