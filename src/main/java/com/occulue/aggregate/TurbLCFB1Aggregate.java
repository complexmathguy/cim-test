...
public class TurbLCFB1Aggregate {  
    ...
    public void handle(UpdateTurbLCFB1Command command) throws Exception {
    	...
    	UpdateTurbLCFB1Event event = new UpdateTurbLCFB1Event(command.getTurbLCFB1Id(), command.Db(), command.Emax(), command.Fb(), command.Fbf(), command.Irmax(), command.Ki(), command.Kp(), command.Mwbase(), command.Pbf(), command.Pmwset(), command.SpeedReferenceGovernor(), command.Tpelec());        
    ...
    public void handle(AssignFbToTurbLCFB1Command command) throws Exception {
    	...
    	if (  fb != null && fb.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Fb already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignFbFromTurbLCFB1Command command) throws Exception {
    	...
    	if (  fb == null )
    		throw new ProcessingException( "Fb already has nothing assigned." );  
    ...
    public void handle(AssignFbfToTurbLCFB1Command command) throws Exception {
    	...
    	if (  fbf != null && fbf.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Fbf already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(UnAssignFbfFromTurbLCFB1Command command) throws Exception {
    	...
    	if (  fbf == null )
    		throw new ProcessingException( "Fbf already has nothing assigned." );  
    ...
    public void handle(AssignIrmaxToTurbLCFB1Command command) throws Exception {
    	...
    	if (  irmax != null && irmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Irmax already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignIrmaxFromTurbLCFB1Command command) throws Exception {
    	...
    	if (  irmax == null )
    		throw new ProcessingException( "Irmax already has nothing assigned." );  
    ...
    public void handle(AssignPbfToTurbLCFB1Command command) throws Exception {
    	...
    	if (  pbf != null && pbf.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Pbf already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    ...
    public void handle(UnAssignPbfFromTurbLCFB1Command command) throws Exception {
    	...
    	if (  pbf == null )
    		throw new ProcessingException( "Pbf already has nothing assigned." );  
    ...
    public void handle(AssignPmwsetToTurbLCFB1Command command) throws Exception {
    	...
    	if (  pmwset != null && pmwset.getActivePowerId() == command.getAssignment().getActivePowerId() )
    		throw new ProcessingException( "Pmwset already assigned with id " + command.getAssignment().getActivePowerId() );  
    ...
    public void handle(UnAssignPmwsetFromTurbLCFB1Command command) throws Exception {
    	...
    	if (  pmwset == null )
    		throw new ProcessingException( "Pmwset already has nothing assigned." );  
    ...
    public void handle(AssignSpeedReferenceGovernorToTurbLCFB1Command command) throws Exception {
    	...
    	if (  speedReferenceGovernor != null && speedReferenceGovernor.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "SpeedReferenceGovernor already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignSpeedReferenceGovernorToTurbLCFB1Event(command.getTurbLCFB1Id(), command.getAssignment()));
    }
