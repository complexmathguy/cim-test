...
public class AsynchronousMachineTimeConstantReactanceAggregate {  
    ...
    public AsynchronousMachineTimeConstantReactanceAggregate(CreateAsynchronousMachineTimeConstantReactanceCommand command) throws Exception {
    	...
    	CreateAsynchronousMachineTimeConstantReactanceEvent event = new CreateAsynchronousMachineTimeConstantReactanceEvent(command.getAsynchronousMachineTimeConstantReactanceId());
    ...
    public void handle(UpdateAsynchronousMachineTimeConstantReactanceCommand command) throws Exception {
    	...
    	UpdateAsynchronousMachineTimeConstantReactanceEvent event = new UpdateAsynchronousMachineTimeConstantReactanceEvent(command.getAsynchronousMachineTimeConstantReactanceId(), command.Tpo(), command.Tppo(), command.Xp(), command.Xpp(), command.Xs());        
    ...
    @CommandHandler
    public void handle(AssignTpoToAsynchronousMachineTimeConstantReactanceCommand command) throws Exception {
    	...
    	if (  tpo != null && tpo.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tpo already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTpoToAsynchronousMachineTimeConstantReactanceEvent(command.getAsynchronousMachineTimeConstantReactanceId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignTpoFromAsynchronousMachineTimeConstantReactanceCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignTpoFromAsynchronousMachineTimeConstantReactanceCommand" );

    	if (  tpo == null )
    		throw new ProcessingException( "Tpo already has nothing assigned." );  

    	apply(new UnAssignTpoFromAsynchronousMachineTimeConstantReactanceEvent(command.getAsynchronousMachineTimeConstantReactanceId()));
    }
    @CommandHandler
    public void handle(AssignTppoToAsynchronousMachineTimeConstantReactanceCommand command) throws Exception {
    	...
    	if (  tppo != null && tppo.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tppo already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTppoToAsynchronousMachineTimeConstantReactanceEvent(command.getAsynchronousMachineTimeConstantReactanceId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignTppoFromAsynchronousMachineTimeConstantReactanceCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignTppoFromAsynchronousMachineTimeConstantReactanceCommand" );

    	if (  tppo == null )
    		throw new ProcessingException( "Tppo already has nothing assigned." );  

    	apply(new UnAssignTppoFromAsynchronousMachineTimeConstantReactanceEvent(command.getAsynchronousMachineTimeConstantReactanceId()));
    }
    @CommandHandler
    public void handle(AssignXpToAsynchronousMachineTimeConstantReactanceCommand command) throws Exception {
        ...
        apply(new AssignXpToAsynchronousMachineTimeConstantReactanceEvent(command.getAsynchronousMachineTimeConstantReactanceId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignXpFromAsynchronousMachineTimeConstantReactanceCommand command) throws Exception {
    	...
    	apply(new UnAssignXpFromAsynchronousMachineTimeConstantReactanceEvent(command.getAsynchronousMachineTimeConstantReactanceId()));
    }
    @CommandHandler
    public void handle(AssignXppToAsynchronousMachineTimeConstantReactanceCommand command) throws Exception {
    	...
    	if (  xpp != null && xpp.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Xpp already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignXppToAsynchronousMachineTimeConstantReactanceEvent(command.getAsynchronousMachineTimeConstantReactanceId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignXppFromAsynchronousMachineTimeConstantReactanceCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignXppFromAsynchronousMachineTimeConstantReactanceCommand" );

    	if (  xpp == null )
    		throw new ProcessingException( "Xpp already has nothing assigned." );  

    	apply(new UnAssignXppFromAsynchronousMachineTimeConstantReactanceEvent(command.getAsynchronousMachineTimeConstantReactanceId()));
    }
    @CommandHandler
    public void handle(AssignXsToAsynchronousMachineTimeConstantReactanceCommand command) throws Exception {
    	...
    	if (  xs != null && xs.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Xs already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignXsToAsynchronousMachineTimeConstantReactanceEvent(command.getAsynchronousMachineTimeConstantReactanceId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignXsFromAsynchronousMachineTimeConstantReactanceCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignXsFromAsynchronousMachineTimeConstantReactanceCommand" );

    	if (  xs == null )
    		throw new ProcessingException( "Xs already has nothing assigned." );  

    	apply(new UnAssignXsFromAsynchronousMachineTimeConstantReactanceEvent(command.getAsynchronousMachineTimeConstantReactanceId()));
    }
