...
public class ExcBBCAggregate {  
    ...
    public void handle(UpdateExcBBCCommand command) throws Exception {
    	...
    	UpdateExcBBCEvent event = new UpdateExcBBCEvent(command.getExcBBCId(), command.Efdmax(), command.Efdmin(), command.K(), command.SwitchIt(), command.T1(), command.T2(), command.T3(), command.T4(), command.Vrmax(), command.Vrmin(), command.Xe());        
    ...
    public void handle(AssignSwitchItToExcBBCCommand command) throws Exception {
    	...
    	if (  switchIt != null && switchIt.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "SwitchIt already assigned with id " + command.getAssignment().getBooleanProxyId() );  
