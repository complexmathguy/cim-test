...
public class MechanicalLoadUserDefinedAggregate {  
    ...
    public MechanicalLoadUserDefinedAggregate(CreateMechanicalLoadUserDefinedCommand command) throws Exception {
    	...
    	CreateMechanicalLoadUserDefinedEvent event = new CreateMechanicalLoadUserDefinedEvent(command.getMechanicalLoadUserDefinedId());
    ...
    public void handle(UpdateMechanicalLoadUserDefinedCommand command) throws Exception {
    	...
    	UpdateMechanicalLoadUserDefinedEvent event = new UpdateMechanicalLoadUserDefinedEvent(command.getMechanicalLoadUserDefinedId(), command.Proprietary());        
    ...
    public void handle(AssignProprietaryToMechanicalLoadUserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToMechanicalLoadUserDefinedEvent(command.getMechanicalLoadUserDefinedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignProprietaryFromMechanicalLoadUserDefinedCommand command) throws Exception {
    	...
    	apply(new UnAssignProprietaryFromMechanicalLoadUserDefinedEvent(command.getMechanicalLoadUserDefinedId()));
    }
