...
public class GovSteamIEEE1Aggregate {  
    ...
    public void handle(UpdateGovSteamIEEE1Command command) throws Exception {
    	...
    	UpdateGovSteamIEEE1Event event = new UpdateGovSteamIEEE1Event(command.getGovSteamIEEE1Id(), command.K(), command.K1(), command.K2(), command.K3(), command.K4(), command.K5(), command.K6(), command.K7(), command.K8(), command.Mwbase(), command.Pmax(), command.Pmin(), command.T1(), command.T2(), command.T3(), command.T4(), command.T5(), command.T6(), command.T7(), command.Uc(), command.Uo());        
    ...
    public void handle(AssignMwbaseToGovSteamIEEE1Command command) throws Exception {
        ...
        apply(new AssignMwbaseToGovSteamIEEE1Event(command.getGovSteamIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignPmaxToGovSteamIEEE1Command command) throws Exception {
        ...
        apply(new AssignPmaxToGovSteamIEEE1Event(command.getGovSteamIEEE1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignPminToGovSteamIEEE1Command command) throws Exception {
        ...
        apply(new AssignPminToGovSteamIEEE1Event(command.getGovSteamIEEE1Id(), command.getAssignment()));
    }
