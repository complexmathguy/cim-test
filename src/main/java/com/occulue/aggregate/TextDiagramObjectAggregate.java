...
public class TextDiagramObjectAggregate {  
    ...
    public TextDiagramObjectAggregate(CreateTextDiagramObjectCommand command) throws Exception {
    	...
    	CreateTextDiagramObjectEvent event = new CreateTextDiagramObjectEvent(command.getTextDiagramObjectId());
    ...
    public void handle(UpdateTextDiagramObjectCommand command) throws Exception {
    	...
    	UpdateTextDiagramObjectEvent event = new UpdateTextDiagramObjectEvent(command.getTextDiagramObjectId(), command.Text());        
    ...
    public void handle(AssignTextToTextDiagramObjectCommand command) throws Exception {
    	...
    	if (  text != null && text.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "Text already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignTextToTextDiagramObjectEvent(command.getTextDiagramObjectId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTextFromTextDiagramObjectCommand command) throws Exception {
    	...
    	if (  text == null )
    		throw new ProcessingException( "Text already has nothing assigned." );  
