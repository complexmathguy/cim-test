...
public class ExcAC5AAggregate {  
    ...
    public void handle(UpdateExcAC5ACommand command) throws Exception {
    	...
    	UpdateExcAC5AEvent event = new UpdateExcAC5AEvent(command.getExcAC5AId(), command.A(), command.Efd1(), command.Efd2(), command.Ka(), command.Ke(), command.Kf(), command.Ks(), command.Seefd1(), command.Seefd2(), command.Ta(), command.Tb(), command.Tc(), command.Te(), command.Tf1(), command.Tf2(), command.Tf3(), command.Vrmax(), command.Vrmin());        
    ...
    public void handle(AssignTf3ToExcAC5ACommand command) throws Exception {
    	...
    	if (  tf3 != null && tf3.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tf3 already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(UnAssignTf3FromExcAC5ACommand command) throws Exception {
    	...
    	if (  tf3 == null )
    		throw new ProcessingException( "Tf3 already has nothing assigned." );  
