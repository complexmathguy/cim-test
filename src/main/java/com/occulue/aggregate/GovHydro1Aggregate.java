...
public class GovHydro1Aggregate {  
    ...
    public void handle(UpdateGovHydro1Command command) throws Exception {
    	...
    	UpdateGovHydro1Event event = new UpdateGovHydro1Event(command.getGovHydro1Id(), command.At(), command.Dturb(), command.Gmax(), command.Gmin(), command.Hdam(), command.Mwbase(), command.Qnl(), command.Rperm(), command.Rtemp(), command.Tf(), command.Tg(), command.Tr(), command.Tw(), command.Velm());        
    ...
    public void handle(AssignVelmToGovHydro1Command command) throws Exception {
    	...
    	if (  velm != null && velm.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Velm already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    ...
    public void handle(UnAssignVelmFromGovHydro1Command command) throws Exception {
    	...
    	if (  velm == null )
    		throw new ProcessingException( "Velm already has nothing assigned." );  
