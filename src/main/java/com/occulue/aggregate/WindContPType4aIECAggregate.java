...
public class WindContPType4aIECAggregate {  
    ...
    public WindContPType4aIECAggregate(CreateWindContPType4aIECCommand command) throws Exception {
    	...
    	CreateWindContPType4aIECEvent event = new CreateWindContPType4aIECEvent(command.getWindContPType4aIECId());
    ...
    public void handle(UpdateWindContPType4aIECCommand command) throws Exception {
    	...
    	UpdateWindContPType4aIECEvent event = new UpdateWindContPType4aIECEvent(command.getWindContPType4aIECId(), command.Dpmax(), command.Tpord(), command.Tufilt());        
    ...
    public void handle(AssignDpmaxToWindContPType4aIECCommand command) throws Exception {
        ...
        apply(new AssignDpmaxToWindContPType4aIECEvent(command.getWindContPType4aIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTpordToWindContPType4aIECCommand command) throws Exception {
        ...
        apply(new AssignTpordToWindContPType4aIECEvent(command.getWindContPType4aIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTufiltToWindContPType4aIECCommand command) throws Exception {
        ...
        apply(new AssignTufiltToWindContPType4aIECEvent(command.getWindContPType4aIECId(), command.getAssignment()));
    }
