...
public class PFVArType2Common1Aggregate {  
    ...
    public PFVArType2Common1Aggregate(CreatePFVArType2Common1Command command) throws Exception {
    	...
    	CreatePFVArType2Common1Event event = new CreatePFVArType2Common1Event(command.getPFVArType2Common1Id());
    ...
    public void handle(UpdatePFVArType2Common1Command command) throws Exception {
    	...
    	UpdatePFVArType2Common1Event event = new UpdatePFVArType2Common1Event(command.getPFVArType2Common1Id(), command.J(), command.Ki(), command.Kp(), command.Max(), command.Ref());        
    ...
    public void handle(AssignJToPFVArType2Common1Command command) throws Exception {
    	...
    	if (  j != null && j.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "J already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignJToPFVArType2Common1Event(command.getPFVArType2Common1Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignJFromPFVArType2Common1Command command) throws Exception {
    	...
    	if (  j == null )
    		throw new ProcessingException( "J already has nothing assigned." );  
    ...
    public void handle(AssignKiToPFVArType2Common1Command command) throws Exception {
        ...
        apply(new AssignKiToPFVArType2Common1Event(command.getPFVArType2Common1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignKpToPFVArType2Common1Command command) throws Exception {
        ...
        apply(new AssignKpToPFVArType2Common1Event(command.getPFVArType2Common1Id(), command.getAssignment()));
    }
    ...
    public void handle(AssignMaxToPFVArType2Common1Command command) throws Exception {
    	...
    	if (  max != null && max.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Max already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignMaxToPFVArType2Common1Event(command.getPFVArType2Common1Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMaxFromPFVArType2Common1Command command) throws Exception {
    	...
    	if (  max == null )
    		throw new ProcessingException( "Max already has nothing assigned." );  
    ...
    public void handle(AssignRefToPFVArType2Common1Command command) throws Exception {
    	...
    	if (  ref != null && ref.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Ref already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignRefToPFVArType2Common1Event(command.getPFVArType2Common1Id(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignRefFromPFVArType2Common1Command command) throws Exception {
    	...
    	if (  ref == null )
    		throw new ProcessingException( "Ref already has nothing assigned." );  
