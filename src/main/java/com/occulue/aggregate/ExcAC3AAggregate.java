...
public class ExcAC3AAggregate {  
    ...
    public void handle(UpdateExcAC3ACommand command) throws Exception {
    	...
    	UpdateExcAC3AEvent event = new UpdateExcAC3AEvent(command.getExcAC3AId(), command.Efdn(), command.Ka(), command.Kc(), command.Kd(), command.Ke(), command.Kf(), command.Kf1(), command.Kf2(), command.Klv(), command.Kn(), command.Kr(), command.Ks(), command.Seve1(), command.Seve2(), command.Ta(), command.Tb(), command.Tc(), command.Te(), command.Tf(), command.Vamax(), command.Vamin(), command.Ve1(), command.Ve2(), command.Vemin(), command.Vfemax(), command.Vlv());        
    ...
    public void handle(AssignEfdnToExcAC3ACommand command) throws Exception {
    	...
    	if (  efdn != null && efdn.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Efdn already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignEfdnFromExcAC3ACommand command) throws Exception {
    	...
    	if (  efdn == null )
    		throw new ProcessingException( "Efdn already has nothing assigned." );  
    ...
    public void handle(AssignKaToExcAC3ACommand command) throws Exception {
    	...
    	if (  ka != null && ka.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Ka already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(AssignKlvToExcAC3ACommand command) throws Exception {
    	...
    	if (  klv != null && klv.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Klv already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignKlvFromExcAC3ACommand command) throws Exception {
    	...
    	if (  klv == null )
    		throw new ProcessingException( "Klv already has nothing assigned." );  
    ...
    public void handle(AssignKnToExcAC3ACommand command) throws Exception {
    	...
    	if (  kn != null && kn.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kn already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignKnFromExcAC3ACommand command) throws Exception {
    	...
    	if (  kn == null )
    		throw new ProcessingException( "Kn already has nothing assigned." );  
    ...
    public void handle(AssignKrToExcAC3ACommand command) throws Exception {
    	...
    	if (  kr != null && kr.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kr already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignKrFromExcAC3ACommand command) throws Exception {
    	...
    	if (  kr == null )
    		throw new ProcessingException( "Kr already has nothing assigned." );  
    ...
    public void handle(AssignTaToExcAC3ACommand command) throws Exception {
    	...
    	if (  ta != null && ta.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Ta already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(AssignVlvToExcAC3ACommand command) throws Exception {
    	...
    	if (  vlv != null && vlv.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Vlv already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignVlvFromExcAC3ACommand command) throws Exception {
    	...
    	if (  vlv == null )
    		throw new ProcessingException( "Vlv already has nothing assigned." );  
