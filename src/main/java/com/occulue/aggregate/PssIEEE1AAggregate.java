...
public class PssIEEE1AAggregate {  
    ...
    public PssIEEE1AAggregate(CreatePssIEEE1ACommand command) throws Exception {
    	...
    	CreatePssIEEE1AEvent event = new CreatePssIEEE1AEvent(command.getPssIEEE1AId(), command.InputSignalType());
    ...
    public void handle(UpdatePssIEEE1ACommand command) throws Exception {
    	...
    	UpdatePssIEEE1AEvent event = new UpdatePssIEEE1AEvent(command.getPssIEEE1AId(), command.A1(), command.A2(), command.InputSignalType(), command.Ks(), command.T1(), command.T2(), command.T3(), command.T4(), command.T5(), command.T6(), command.Vrmax(), command.Vrmin());        
