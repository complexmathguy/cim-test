...
public class DiagramObjectPointAggregate {  
    ...
    public void handle(UpdateDiagramObjectPointCommand command) throws Exception {
    	...
    	UpdateDiagramObjectPointEvent event = new UpdateDiagramObjectPointEvent(command.getDiagramObjectPointId(), command.SequenceNumber(), command.XPosition(), command.YPosition(), command.ZPosition());        
