...
public class ApparentPowerAggregate {  
    ...
    public ApparentPowerAggregate(CreateApparentPowerCommand command) throws Exception {
    	...
    	CreateApparentPowerEvent event = new CreateApparentPowerEvent(command.getApparentPowerId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateApparentPowerCommand command) throws Exception {
    	...
    	UpdateApparentPowerEvent event = new UpdateApparentPowerEvent(command.getApparentPowerId(), command.Multiplier(), command.Unit(), command.Value());        
    ...
    public void handle(AssignValueToApparentPowerCommand command) throws Exception {
        ...
        apply(new AssignValueToApparentPowerEvent(command.getApparentPowerId(), command.getAssignment()));
    }
