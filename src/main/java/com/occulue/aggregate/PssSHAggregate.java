...
public class PssSHAggregate {  
    ...
    public void handle(UpdatePssSHCommand command) throws Exception {
    	...
    	UpdatePssSHEvent event = new UpdatePssSHEvent(command.getPssSHId(), command.K(), command.K0(), command.K1(), command.K2(), command.K3(), command.K4(), command.T1(), command.T2(), command.T3(), command.T4(), command.Td(), command.Vsmax(), command.Vsmin());        
    ...
    public void handle(AssignK0ToPssSHCommand command) throws Exception {
    	...
    	if (  k0 != null && k0.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "K0 already assigned with id " + command.getAssignment().getPUId() );  
    ...
    public void handle(UnAssignK0FromPssSHCommand command) throws Exception {
    	...
    	if (  k0 == null )
    		throw new ProcessingException( "K0 already has nothing assigned." );  
