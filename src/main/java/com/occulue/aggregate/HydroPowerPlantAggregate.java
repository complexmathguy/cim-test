...
public class HydroPowerPlantAggregate {  
    ...
    public HydroPowerPlantAggregate(CreateHydroPowerPlantCommand command) throws Exception {
    	...
    	CreateHydroPowerPlantEvent event = new CreateHydroPowerPlantEvent(command.getHydroPowerPlantId(), command.HydroPlantStorageType());
    ...
    public void handle(UpdateHydroPowerPlantCommand command) throws Exception {
    	...
    	UpdateHydroPowerPlantEvent event = new UpdateHydroPowerPlantEvent(command.getHydroPowerPlantId(), command.HydroPlantStorageType());        
