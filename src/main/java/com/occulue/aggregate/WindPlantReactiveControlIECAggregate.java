...
public class WindPlantReactiveControlIECAggregate {  
    ...
    public WindPlantReactiveControlIECAggregate(CreateWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	CreateWindPlantReactiveControlIECEvent event = new CreateWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId());
    ...
    public void handle(UpdateWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	UpdateWindPlantReactiveControlIECEvent event = new UpdateWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.Kiwpx(), command.Kpwpx(), command.Kwpqu(), command.Mwppf(), command.Mwpu(), command.Twppfilt(), command.Twpqfilt(), command.Twpufilt(), command.Txft(), command.Txfv(), command.Uwpqdip(), command.Xrefmax(), command.Xrefmin());        
    ...
    public void handle(AssignKiwpxToWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  kiwpx != null && kiwpx.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Kiwpx already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignKiwpxToWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKiwpxFromWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  kiwpx == null )
    		throw new ProcessingException( "Kiwpx already has nothing assigned." );  

    	apply(new UnAssignKiwpxFromWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId()));
    }
    @CommandHandler
    public void handle(AssignKpwpxToWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  kpwpx != null && kpwpx.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Kpwpx already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignKpwpxToWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKpwpxFromWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  kpwpx == null )
    		throw new ProcessingException( "Kpwpx already has nothing assigned." );  

    	apply(new UnAssignKpwpxFromWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId()));
    }
    @CommandHandler
    public void handle(AssignKwpquToWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  kwpqu != null && kwpqu.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Kwpqu already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignKwpquToWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignKwpquFromWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  kwpqu == null )
    		throw new ProcessingException( "Kwpqu already has nothing assigned." );  

    	apply(new UnAssignKwpquFromWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId()));
    }
    @CommandHandler
    public void handle(AssignMwppfToWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  mwppf != null && mwppf.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Mwppf already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignMwppfToWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMwppfFromWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  mwppf == null )
    		throw new ProcessingException( "Mwppf already has nothing assigned." );  

    	apply(new UnAssignMwppfFromWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId()));
    }
    @CommandHandler
    public void handle(AssignMwpuToWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  mwpu != null && mwpu.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Mwpu already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignMwpuToWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMwpuFromWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  mwpu == null )
    		throw new ProcessingException( "Mwpu already has nothing assigned." );  

    	apply(new UnAssignMwpuFromWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId()));
    }
    @CommandHandler
    public void handle(AssignTwppfiltToWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  twppfilt != null && twppfilt.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Twppfilt already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTwppfiltToWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignTwppfiltFromWindPlantReactiveControlIECCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignTwppfiltFromWindPlantReactiveControlIECCommand" );

    	if (  twppfilt == null )
    		throw new ProcessingException( "Twppfilt already has nothing assigned." );  

    	apply(new UnAssignTwppfiltFromWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId()));
    }
    @CommandHandler
    public void handle(AssignTwpqfiltToWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  twpqfilt != null && twpqfilt.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Twpqfilt already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTwpqfiltToWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignTwpqfiltFromWindPlantReactiveControlIECCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignTwpqfiltFromWindPlantReactiveControlIECCommand" );

    	if (  twpqfilt == null )
    		throw new ProcessingException( "Twpqfilt already has nothing assigned." );  

    	apply(new UnAssignTwpqfiltFromWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId()));
    }
    @CommandHandler
    public void handle(AssignTwpufiltToWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  twpufilt != null && twpufilt.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Twpufilt already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTwpufiltToWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignTwpufiltFromWindPlantReactiveControlIECCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignTwpufiltFromWindPlantReactiveControlIECCommand" );

    	if (  twpufilt == null )
    		throw new ProcessingException( "Twpufilt already has nothing assigned." );  

    	apply(new UnAssignTwpufiltFromWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId()));
    }
    @CommandHandler
    public void handle(AssignTxftToWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  txft != null && txft.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Txft already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTxftToWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTxftFromWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  txft == null )
    		throw new ProcessingException( "Txft already has nothing assigned." );  

    	apply(new UnAssignTxftFromWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId()));
    }
    @CommandHandler
    public void handle(AssignTxfvToWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  txfv != null && txfv.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Txfv already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTxfvToWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTxfvFromWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  txfv == null )
    		throw new ProcessingException( "Txfv already has nothing assigned." );  

    	apply(new UnAssignTxfvFromWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId()));
    }
    @CommandHandler
    public void handle(AssignUwpqdipToWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  uwpqdip != null && uwpqdip.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Uwpqdip already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignUwpqdipToWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignUwpqdipFromWindPlantReactiveControlIECCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignUwpqdipFromWindPlantReactiveControlIECCommand" );

    	if (  uwpqdip == null )
    		throw new ProcessingException( "Uwpqdip already has nothing assigned." );  

    	apply(new UnAssignUwpqdipFromWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId()));
    }
    @CommandHandler
    public void handle(AssignXrefmaxToWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  xrefmax != null && xrefmax.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Xrefmax already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignXrefmaxToWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignXrefmaxFromWindPlantReactiveControlIECCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignXrefmaxFromWindPlantReactiveControlIECCommand" );

    	if (  xrefmax == null )
    		throw new ProcessingException( "Xrefmax already has nothing assigned." );  

    	apply(new UnAssignXrefmaxFromWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId()));
    }
    @CommandHandler
    public void handle(AssignXrefminToWindPlantReactiveControlIECCommand command) throws Exception {
    	...
    	if (  xrefmin != null && xrefmin.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Xrefmin already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignXrefminToWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignXrefminFromWindPlantReactiveControlIECCommand command) throws Exception {
    	LOGGER.info( "Handlign command UnAssignXrefminFromWindPlantReactiveControlIECCommand" );

    	if (  xrefmin == null )
    		throw new ProcessingException( "Xrefmin already has nothing assigned." );  

    	apply(new UnAssignXrefminFromWindPlantReactiveControlIECEvent(command.getWindPlantReactiveControlIECId()));
    }
