...
public class WindType3or4UserDefinedAggregate {  
    ...
    public WindType3or4UserDefinedAggregate(CreateWindType3or4UserDefinedCommand command) throws Exception {
    	...
    	CreateWindType3or4UserDefinedEvent event = new CreateWindType3or4UserDefinedEvent(command.getWindType3or4UserDefinedId());
    ...
    public void handle(UpdateWindType3or4UserDefinedCommand command) throws Exception {
    	...
    	UpdateWindType3or4UserDefinedEvent event = new UpdateWindType3or4UserDefinedEvent(command.getWindType3or4UserDefinedId(), command.Proprietary());        
    ...
    public void handle(AssignProprietaryToWindType3or4UserDefinedCommand command) throws Exception {
        ...
        apply(new AssignProprietaryToWindType3or4UserDefinedEvent(command.getWindType3or4UserDefinedId(), command.getAssignment()));
    }

    @CommandHandler
    public void handle(UnAssignProprietaryFromWindType3or4UserDefinedCommand command) throws Exception {
    	...
    	apply(new UnAssignProprietaryFromWindType3or4UserDefinedEvent(command.getWindType3or4UserDefinedId()));
    }
