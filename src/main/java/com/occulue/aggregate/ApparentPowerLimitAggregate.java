...
public class ApparentPowerLimitAggregate {  
    ...
    public ApparentPowerLimitAggregate(CreateApparentPowerLimitCommand command) throws Exception {
    	...
    	CreateApparentPowerLimitEvent event = new CreateApparentPowerLimitEvent(command.getApparentPowerLimitId());
    ...
    public void handle(UpdateApparentPowerLimitCommand command) throws Exception {
    	...
    	UpdateApparentPowerLimitEvent event = new UpdateApparentPowerLimitEvent(command.getApparentPowerLimitId(), command.Value());        
    ...
    public void handle(AssignValueToApparentPowerLimitCommand command) throws Exception {
    	...
    	if (  value != null && value.getApparentPowerId() == command.getAssignment().getApparentPowerId() )
    		throw new ProcessingException( "Value already assigned with id " + command.getAssignment().getApparentPowerId() );  
    		
        apply(new AssignValueToApparentPowerLimitEvent(command.getApparentPowerLimitId(), command.getAssignment()));
    }
