...
public class WindContCurrLimIECAggregate {  
    ...
    public WindContCurrLimIECAggregate(CreateWindContCurrLimIECCommand command) throws Exception {
    	...
    	CreateWindContCurrLimIECEvent event = new CreateWindContCurrLimIECEvent(command.getWindContCurrLimIECId());
    ...
    public void handle(UpdateWindContCurrLimIECCommand command) throws Exception {
    	...
    	UpdateWindContCurrLimIECEvent event = new UpdateWindContCurrLimIECEvent(command.getWindContCurrLimIECId(), command.Imax(), command.Imaxdip(), command.Mdfslim(), command.Mqpri(), command.Tufilt());        
    ...
    public void handle(AssignImaxToWindContCurrLimIECCommand command) throws Exception {
        ...
        apply(new AssignImaxToWindContCurrLimIECEvent(command.getWindContCurrLimIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignImaxdipToWindContCurrLimIECCommand command) throws Exception {
    	...
    	if (  imaxdip != null && imaxdip.getPUId() == command.getAssignment().getPUId() )
    		throw new ProcessingException( "Imaxdip already assigned with id " + command.getAssignment().getPUId() );  
    		
        apply(new AssignImaxdipToWindContCurrLimIECEvent(command.getWindContCurrLimIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignImaxdipFromWindContCurrLimIECCommand command) throws Exception {
    	...
    	if (  imaxdip == null )
    		throw new ProcessingException( "Imaxdip already has nothing assigned." );  
    ...
    public void handle(AssignMdfslimToWindContCurrLimIECCommand command) throws Exception {
    	...
    	if (  mdfslim != null && mdfslim.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Mdfslim already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignMdfslimToWindContCurrLimIECEvent(command.getWindContCurrLimIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMdfslimFromWindContCurrLimIECCommand command) throws Exception {
    	...
    	if (  mdfslim == null )
    		throw new ProcessingException( "Mdfslim already has nothing assigned." );  
    ...
    public void handle(AssignMqpriToWindContCurrLimIECCommand command) throws Exception {
    	...
    	if (  mqpri != null && mqpri.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Mqpri already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignMqpriToWindContCurrLimIECEvent(command.getWindContCurrLimIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignMqpriFromWindContCurrLimIECCommand command) throws Exception {
    	...
    	if (  mqpri == null )
    		throw new ProcessingException( "Mqpri already has nothing assigned." );  
    ...
    public void handle(AssignTufiltToWindContCurrLimIECCommand command) throws Exception {
        ...
        apply(new AssignTufiltToWindContCurrLimIECEvent(command.getWindContCurrLimIECId(), command.getAssignment()));
    }
