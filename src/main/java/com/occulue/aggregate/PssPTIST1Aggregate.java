...
public class PssPTIST1Aggregate {  
    ...
    public void handle(UpdatePssPTIST1Command command) throws Exception {
    	...
    	UpdatePssPTIST1Event event = new UpdatePssPTIST1Event(command.getPssPTIST1Id(), command.Dtc(), command.Dtf(), command.Dtp(), command.K(), command.M(), command.T1(), command.T2(), command.T3(), command.T4(), command.Tf(), command.Tp());        
