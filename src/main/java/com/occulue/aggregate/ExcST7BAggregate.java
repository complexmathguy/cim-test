...
public class ExcST7BAggregate {  
    ...
    public ExcST7BAggregate(CreateExcST7BCommand command) throws Exception {
    	...
    	CreateExcST7BEvent event = new CreateExcST7BEvent(command.getExcST7BId(), command.Oelin(), command.Uelin());
    ...
    public void handle(UpdateExcST7BCommand command) throws Exception {
    	...
    	UpdateExcST7BEvent event = new UpdateExcST7BEvent(command.getExcST7BId(), command.Kh(), command.Kia(), command.Kl(), command.Kpa(), command.Oelin(), command.Tb(), command.Tc(), command.Tf(), command.Tg(), command.Tia(), command.Ts(), command.Uelin(), command.Vmax(), command.Vmin(), command.Vrmax(), command.Vrmin());        
    ...
    public void handle(AssignTiaToExcST7BCommand command) throws Exception {
    	...
    	if (  tia != null && tia.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tia already assigned with id " + command.getAssignment().getSecondsId() );  
    ...
    public void handle(UnAssignTiaFromExcST7BCommand command) throws Exception {
    	...
    	if (  tia == null )
    		throw new ProcessingException( "Tia already has nothing assigned." );  
