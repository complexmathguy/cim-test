...
public class WindGenTurbineType3aIECAggregate {  
    ...
    public WindGenTurbineType3aIECAggregate(CreateWindGenTurbineType3aIECCommand command) throws Exception {
    	...
    	CreateWindGenTurbineType3aIECEvent event = new CreateWindGenTurbineType3aIECEvent(command.getWindGenTurbineType3aIECId());
    ...
    public void handle(UpdateWindGenTurbineType3aIECCommand command) throws Exception {
    	...
    	UpdateWindGenTurbineType3aIECEvent event = new UpdateWindGenTurbineType3aIECEvent(command.getWindGenTurbineType3aIECId(), command.Kpc(), command.Tic(), command.Xs());        
    ...
    public void handle(AssignKpcToWindGenTurbineType3aIECCommand command) throws Exception {
    	...
    	if (  kpc != null && kpc.getSimple_FloatId() == command.getAssignment().getSimple_FloatId() )
    		throw new ProcessingException( "Kpc already assigned with id " + command.getAssignment().getSimple_FloatId() );  
    		
        apply(new AssignKpcToWindGenTurbineType3aIECEvent(command.getWindGenTurbineType3aIECId(), command.getAssignment()));
    }
    ...
    public void handle(AssignTicToWindGenTurbineType3aIECCommand command) throws Exception {
    	...
    	if (  tic != null && tic.getSecondsId() == command.getAssignment().getSecondsId() )
    		throw new ProcessingException( "Tic already assigned with id " + command.getAssignment().getSecondsId() );  
    		
        apply(new AssignTicToWindGenTurbineType3aIECEvent(command.getWindGenTurbineType3aIECId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignTicFromWindGenTurbineType3aIECCommand command) throws Exception {
    	...
    	if (  tic == null )
    		throw new ProcessingException( "Tic already has nothing assigned." );  
    ...
    public void handle(AssignXsToWindGenTurbineType3aIECCommand command) throws Exception {
        ...
        apply(new AssignXsToWindGenTurbineType3aIECEvent(command.getWindGenTurbineType3aIECId(), command.getAssignment()));
    }
