...
public class CoordinateSystemAggregate {  
    ...
    public CoordinateSystemAggregate(CreateCoordinateSystemCommand command) throws Exception {
    	...
    	CreateCoordinateSystemEvent event = new CreateCoordinateSystemEvent(command.getCoordinateSystemId());
    ...
    public void handle(UpdateCoordinateSystemCommand command) throws Exception {
    	...
    	UpdateCoordinateSystemEvent event = new UpdateCoordinateSystemEvent(command.getCoordinateSystemId(), command.CrsUrn());        
    ...
    public void handle(AssignCrsUrnToCoordinateSystemCommand command) throws Exception {
    	...
    	if (  crsUrn != null && crsUrn.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "CrsUrn already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignCrsUrnToCoordinateSystemEvent(command.getCoordinateSystemId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignCrsUrnFromCoordinateSystemCommand command) throws Exception {
    	...
    	if (  crsUrn == null )
    		throw new ProcessingException( "CrsUrn already has nothing assigned." );  
