...
public class SwitchProxyAggregate {  
    ...
    public void handle(UpdateSwitchProxyCommand command) throws Exception {
    	...
    	UpdateSwitchProxyEvent event = new UpdateSwitchProxyEvent(command.getSwitchProxyId(), command.NormalOpen(), command.RatedCurrent(), command.Retained());        
    ...
    public void handle(AssignNormalOpenToSwitchProxyCommand command) throws Exception {
    	...
    	if (  normalOpen != null && normalOpen.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "NormalOpen already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignNormalOpenToSwitchProxyEvent(command.getSwitchProxyId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRatedCurrentToSwitchProxyCommand command) throws Exception {
    	...
    	if (  ratedCurrent != null && ratedCurrent.getCurrentFlowId() == command.getAssignment().getCurrentFlowId() )
    		throw new ProcessingException( "RatedCurrent already assigned with id " + command.getAssignment().getCurrentFlowId() );  
    		
        apply(new AssignRatedCurrentToSwitchProxyEvent(command.getSwitchProxyId(), command.getAssignment()));
    }
    ...
    public void handle(AssignRetainedToSwitchProxyCommand command) throws Exception {
    	...
    	if (  retained != null && retained.getBooleanProxyId() == command.getAssignment().getBooleanProxyId() )
    		throw new ProcessingException( "Retained already assigned with id " + command.getAssignment().getBooleanProxyId() );  
    		
        apply(new AssignRetainedToSwitchProxyEvent(command.getSwitchProxyId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignRetainedFromSwitchProxyCommand command) throws Exception {
    	...
    	if (  retained == null )
    		throw new ProcessingException( "Retained already has nothing assigned." );  
