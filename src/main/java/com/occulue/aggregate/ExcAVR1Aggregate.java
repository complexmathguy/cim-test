...
public class ExcAVR1Aggregate {  
    ...
    public void handle(UpdateExcAVR1Command command) throws Exception {
    	...
    	UpdateExcAVR1Event event = new UpdateExcAVR1Event(command.getExcAVR1Id(), command.E1(), command.E2(), command.Ka(), command.Kf(), command.Se1(), command.Se2(), command.Ta(), command.Tb(), command.Te(), command.Tf(), command.Vrmn(), command.Vrmx());        
