...
public class DomainVersionAggregate {  
    ...
    public void handle(UpdateDomainVersionCommand command) throws Exception {
    	...
    	UpdateDomainVersionEvent event = new UpdateDomainVersionEvent(command.getDomainVersionId(), command.BaseUML(), command.Date(), command.EntsoeUML(), command.Version());        
    ...
    public void handle(AssignBaseUMLToDomainVersionCommand command) throws Exception {
        ...
        apply(new AssignBaseUMLToDomainVersionEvent(command.getDomainVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignDateToDomainVersionCommand command) throws Exception {
        ...
        apply(new AssignDateToDomainVersionEvent(command.getDomainVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignEntsoeUMLToDomainVersionCommand command) throws Exception {
        ...
        apply(new AssignEntsoeUMLToDomainVersionEvent(command.getDomainVersionId(), command.getAssignment()));
    }
    ...
    public void handle(AssignVersionToDomainVersionCommand command) throws Exception {
    	...
    	if (  version != null && version.getStringProxyId() == command.getAssignment().getStringProxyId() )
    		throw new ProcessingException( "Version already assigned with id " + command.getAssignment().getStringProxyId() );  
    		
        apply(new AssignVersionToDomainVersionEvent(command.getDomainVersionId(), command.getAssignment()));
    }
    ...
    public void handle(UnAssignVersionFromDomainVersionCommand command) throws Exception {
    	...
    	if (  version == null )
    		throw new ProcessingException( "Version already has nothing assigned." );  
