...
public class CapacitanceAggregate {  
    ...
    public CapacitanceAggregate(CreateCapacitanceCommand command) throws Exception {
    	...
    	CreateCapacitanceEvent event = new CreateCapacitanceEvent(command.getCapacitanceId(), command.Multiplier(), command.Unit());
    ...
    public void handle(UpdateCapacitanceCommand command) throws Exception {
    	...
    	UpdateCapacitanceEvent event = new UpdateCapacitanceEvent(command.getCapacitanceId(), command.Multiplier(), command.Unit(), command.Value());        
