...
public class ExcIEEEST4BAggregate {  
    ...
    public void handle(UpdateExcIEEEST4BCommand command) throws Exception {
    	...
    	UpdateExcIEEEST4BEvent event = new UpdateExcIEEEST4BEvent(command.getExcIEEEST4BId(), command.Kc(), command.Kg(), command.Ki(), command.Kim(), command.Kir(), command.Kp(), command.Kpm(), command.Kpr(), command.Ta(), command.Thetap(), command.Vbmax(), command.Vmmax(), command.Vmmin(), command.Vrmax(), command.Vrmin(), command.Xl());        
