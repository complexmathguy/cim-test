...
public class PFVArType2IEEEVArControllerProjector extends PFVArType2IEEEVArControllerEntityProjector {
    ...
    public void handle( AssignExlonToPFVArType2IEEEVArControllerEvent event) {
	    ...
	    // ------------------------------------------
	    PFVArType2IEEEVArController entity = assignExlon( event.getPFVArType2IEEEVArControllerId(), event.getAssignment() );
    ...
    public void handle( AssignKiToPFVArType2IEEEVArControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType2IEEEVArController entity = assignKi( event.getPFVArType2IEEEVArControllerId(), event.getAssignment() );
    ...
    public void handle( AssignKpToPFVArType2IEEEVArControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType2IEEEVArController entity = assignKp( event.getPFVArType2IEEEVArControllerId(), event.getAssignment() );
    ...
    public void handle( AssignQrefToPFVArType2IEEEVArControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType2IEEEVArController entity = assignQref( event.getPFVArType2IEEEVArControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVclmtToPFVArType2IEEEVArControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType2IEEEVArController entity = assignVclmt( event.getPFVArType2IEEEVArControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVrefToPFVArType2IEEEVArControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType2IEEEVArController entity = assignVref( event.getPFVArType2IEEEVArControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVsToPFVArType2IEEEVArControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType2IEEEVArController entity = assignVs( event.getPFVArType2IEEEVArControllerId(), event.getAssignment() );
