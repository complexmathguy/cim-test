...
public class PFVArType2IEEEPFControllerProjector extends PFVArType2IEEEPFControllerEntityProjector {
    ...
    public void handle( AssignExlonToPFVArType2IEEEPFControllerEvent event) {
	    ...
	    // ------------------------------------------
	    PFVArType2IEEEPFController entity = assignExlon( event.getPFVArType2IEEEPFControllerId(), event.getAssignment() );
    ...
    public void handle( AssignKiToPFVArType2IEEEPFControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType2IEEEPFController entity = assignKi( event.getPFVArType2IEEEPFControllerId(), event.getAssignment() );
    ...
    public void handle( AssignKpToPFVArType2IEEEPFControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType2IEEEPFController entity = assignKp( event.getPFVArType2IEEEPFControllerId(), event.getAssignment() );
    ...
    public void handle( AssignPfrefToPFVArType2IEEEPFControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType2IEEEPFController entity = assignPfref( event.getPFVArType2IEEEPFControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVclmtToPFVArType2IEEEPFControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType2IEEEPFController entity = assignVclmt( event.getPFVArType2IEEEPFControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVrefToPFVArType2IEEEPFControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType2IEEEPFController entity = assignVref( event.getPFVArType2IEEEPFControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVsToPFVArType2IEEEPFControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType2IEEEPFController entity = assignVs( event.getPFVArType2IEEEPFControllerId(), event.getAssignment() );
