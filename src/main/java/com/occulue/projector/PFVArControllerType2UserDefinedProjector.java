...
public class PFVArControllerType2UserDefinedProjector extends PFVArControllerType2UserDefinedEntityProjector {
    ...
    public void handle( AssignProprietaryToPFVArControllerType2UserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    PFVArControllerType2UserDefined entity = assignProprietary( event.getPFVArControllerType2UserDefinedId(), event.getAssignment() );
	...
	public void handle( UnAssignProprietaryFromPFVArControllerType2UserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    PFVArControllerType2UserDefined entity = unAssignProprietary( event.getPFVArControllerType2UserDefinedId() );
