...
public class LoadGenericNonLinearProjector extends LoadGenericNonLinearEntityProjector {
    ...
    public void handle( AssignBsToLoadGenericNonLinearEvent event) {
	    ...
	    // ------------------------------------------
	    LoadGenericNonLinear entity = assignBs( event.getLoadGenericNonLinearId(), event.getAssignment() );
    ...
    public void handle( AssignBtToLoadGenericNonLinearEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadGenericNonLinear entity = assignBt( event.getLoadGenericNonLinearId(), event.getAssignment() );
    ...
    public void handle( AssignLsToLoadGenericNonLinearEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadGenericNonLinear entity = assignLs( event.getLoadGenericNonLinearId(), event.getAssignment() );
    ...
    public void handle( AssignLtToLoadGenericNonLinearEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadGenericNonLinear entity = assignLt( event.getLoadGenericNonLinearId(), event.getAssignment() );
    ...
    public void handle( AssignPtToLoadGenericNonLinearEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadGenericNonLinear entity = assignPt( event.getLoadGenericNonLinearId(), event.getAssignment() );
    ...
    public void handle( AssignQtToLoadGenericNonLinearEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadGenericNonLinear entity = assignQt( event.getLoadGenericNonLinearId(), event.getAssignment() );
    ...
    public void handle( AssignTpToLoadGenericNonLinearEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadGenericNonLinear entity = assignTp( event.getLoadGenericNonLinearId(), event.getAssignment() );
    ...
    public void handle( AssignTqToLoadGenericNonLinearEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadGenericNonLinear entity = assignTq( event.getLoadGenericNonLinearId(), event.getAssignment() );
