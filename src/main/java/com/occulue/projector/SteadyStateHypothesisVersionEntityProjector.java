...
public class SteadyStateHypothesisVersionEntityProjector {
     ...
     * @return	SteadyStateHypothesisVersion
     */
    public SteadyStateHypothesisVersion assignDifferenceModelURI( UUID parentId, StringProxy assignment ) {
     ...
     * @return	SteadyStateHypothesisVersion
     */
    public SteadyStateHypothesisVersion assignModelDescriptionURI( UUID parentId, StringProxy assignment ) {
