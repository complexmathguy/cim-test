...
public class WindContPitchAngleIECProjector extends WindContPitchAngleIECEntityProjector {
    ...
    public void handle( AssignDthetamaxToWindContPitchAngleIECEvent event) {
	    ...
	    // ------------------------------------------
	    WindContPitchAngleIEC entity = assignDthetamax( event.getWindContPitchAngleIECId(), event.getAssignment() );
    ...
    public void handle( AssignDthetaminToWindContPitchAngleIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindContPitchAngleIEC entity = assignDthetamin( event.getWindContPitchAngleIECId(), event.getAssignment() );
    ...
    public void handle( AssignKicToWindContPitchAngleIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindContPitchAngleIEC entity = assignKic( event.getWindContPitchAngleIECId(), event.getAssignment() );
    ...
    public void handle( AssignKiomegaToWindContPitchAngleIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindContPitchAngleIEC entity = assignKiomega( event.getWindContPitchAngleIECId(), event.getAssignment() );
    ...
    public void handle( AssignKpcToWindContPitchAngleIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindContPitchAngleIEC entity = assignKpc( event.getWindContPitchAngleIECId(), event.getAssignment() );
    ...
    public void handle( AssignKpomegaToWindContPitchAngleIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindContPitchAngleIEC entity = assignKpomega( event.getWindContPitchAngleIECId(), event.getAssignment() );
    ...
    public void handle( AssignKpxToWindContPitchAngleIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindContPitchAngleIEC entity = assignKpx( event.getWindContPitchAngleIECId(), event.getAssignment() );
    ...
    public void handle( AssignThetamaxToWindContPitchAngleIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindContPitchAngleIEC entity = assignThetamax( event.getWindContPitchAngleIECId(), event.getAssignment() );
    ...
    public void handle( AssignThetaminToWindContPitchAngleIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindContPitchAngleIEC entity = assignThetamin( event.getWindContPitchAngleIECId(), event.getAssignment() );
    ...
    public void handle( AssignTthetaToWindContPitchAngleIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindContPitchAngleIEC entity = assignTtheta( event.getWindContPitchAngleIECId(), event.getAssignment() );
