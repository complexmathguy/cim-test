...
public class TurbineLoadControllerUserDefinedProjector extends TurbineLoadControllerUserDefinedEntityProjector {
    ...
    public void handle( AssignProprietaryToTurbineLoadControllerUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    TurbineLoadControllerUserDefined entity = assignProprietary( event.getTurbineLoadControllerUserDefinedId(), event.getAssignment() );
	...
	public void handle( UnAssignProprietaryFromTurbineLoadControllerUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    TurbineLoadControllerUserDefined entity = unAssignProprietary( event.getTurbineLoadControllerUserDefinedId() );
