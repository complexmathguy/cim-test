...
public class WindPlantReactiveControlIECProjector extends WindPlantReactiveControlIECEntityProjector {
    ...
    public void handle( AssignKiwpxToWindPlantReactiveControlIECEvent event) {
	    ...
	    // ------------------------------------------
	    WindPlantReactiveControlIEC entity = assignKiwpx( event.getWindPlantReactiveControlIECId(), event.getAssignment() );
    ...
    public void handle( AssignKpwpxToWindPlantReactiveControlIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantReactiveControlIEC entity = assignKpwpx( event.getWindPlantReactiveControlIECId(), event.getAssignment() );
    ...
    public void handle( AssignKwpquToWindPlantReactiveControlIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantReactiveControlIEC entity = assignKwpqu( event.getWindPlantReactiveControlIECId(), event.getAssignment() );
    ...
    public void handle( AssignMwppfToWindPlantReactiveControlIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantReactiveControlIEC entity = assignMwppf( event.getWindPlantReactiveControlIECId(), event.getAssignment() );
    ...
    public void handle( AssignMwpuToWindPlantReactiveControlIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantReactiveControlIEC entity = assignMwpu( event.getWindPlantReactiveControlIECId(), event.getAssignment() );
    ...
    public void handle( AssignTwppfiltToWindPlantReactiveControlIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantReactiveControlIEC entity = assignTwppfilt( event.getWindPlantReactiveControlIECId(), event.getAssignment() );
    ...
    public void handle( AssignTwpqfiltToWindPlantReactiveControlIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantReactiveControlIEC entity = assignTwpqfilt( event.getWindPlantReactiveControlIECId(), event.getAssignment() );
    ...
    public void handle( AssignTwpufiltToWindPlantReactiveControlIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantReactiveControlIEC entity = assignTwpufilt( event.getWindPlantReactiveControlIECId(), event.getAssignment() );
    ...
    public void handle( AssignTxftToWindPlantReactiveControlIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantReactiveControlIEC entity = assignTxft( event.getWindPlantReactiveControlIECId(), event.getAssignment() );
    ...
    public void handle( AssignTxfvToWindPlantReactiveControlIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantReactiveControlIEC entity = assignTxfv( event.getWindPlantReactiveControlIECId(), event.getAssignment() );
    ...
    public void handle( AssignUwpqdipToWindPlantReactiveControlIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantReactiveControlIEC entity = assignUwpqdip( event.getWindPlantReactiveControlIECId(), event.getAssignment() );
    ...
    public void handle( AssignXrefmaxToWindPlantReactiveControlIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantReactiveControlIEC entity = assignXrefmax( event.getWindPlantReactiveControlIECId(), event.getAssignment() );
    ...
    public void handle( AssignXrefminToWindPlantReactiveControlIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantReactiveControlIEC entity = assignXrefmin( event.getWindPlantReactiveControlIECId(), event.getAssignment() );
