...
public class GeographicalLocationVersionProjector extends GeographicalLocationVersionEntityProjector {
    ...
    public void handle( AssignBaseUMLToGeographicalLocationVersionEvent event) {
	    ...
	    // ------------------------------------------
	    GeographicalLocationVersion entity = assignBaseUML( event.getGeographicalLocationVersionId(), event.getAssignment() );
    ...
    public void handle( AssignBaseURIToGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GeographicalLocationVersion entity = assignBaseURI( event.getGeographicalLocationVersionId(), event.getAssignment() );
    ...
    public void handle( AssignDateToGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GeographicalLocationVersion entity = assignDate( event.getGeographicalLocationVersionId(), event.getAssignment() );
    ...
    public void handle( AssignDifferenceModelURIToGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GeographicalLocationVersion entity = assignDifferenceModelURI( event.getGeographicalLocationVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignDifferenceModelURIFromGeographicalLocationVersionEvent event) {
	    LOGGER.info("handling UnAssignDifferenceModelURIFromGeographicalLocationVersionEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    GeographicalLocationVersion entity = unAssignDifferenceModelURI( event.getGeographicalLocationVersionId() );
    ...
    public void handle( AssignEntsoeUMLToGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GeographicalLocationVersion entity = assignEntsoeUML( event.getGeographicalLocationVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignEntsoeUMLFromGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    GeographicalLocationVersion entity = unAssignEntsoeUML( event.getGeographicalLocationVersionId() );
    ...
    public void handle( AssignEntsoeURIToGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GeographicalLocationVersion entity = assignEntsoeURI( event.getGeographicalLocationVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignEntsoeURIFromGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    GeographicalLocationVersion entity = unAssignEntsoeURI( event.getGeographicalLocationVersionId() );
    ...
    public void handle( AssignModelDescriptionURIToGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GeographicalLocationVersion entity = assignModelDescriptionURI( event.getGeographicalLocationVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignModelDescriptionURIFromGeographicalLocationVersionEvent event) {
	    LOGGER.info("handling UnAssignModelDescriptionURIFromGeographicalLocationVersionEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    GeographicalLocationVersion entity = unAssignModelDescriptionURI( event.getGeographicalLocationVersionId() );
    ...
    public void handle( AssignNamespaceRDFToGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GeographicalLocationVersion entity = assignNamespaceRDF( event.getGeographicalLocationVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignNamespaceRDFFromGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    GeographicalLocationVersion entity = unAssignNamespaceRDF( event.getGeographicalLocationVersionId() );
    ...
    public void handle( AssignNamespaceUMLToGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GeographicalLocationVersion entity = assignNamespaceUML( event.getGeographicalLocationVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignNamespaceUMLFromGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    GeographicalLocationVersion entity = unAssignNamespaceUML( event.getGeographicalLocationVersionId() );
    ...
    public void handle( AssignShortNameToGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GeographicalLocationVersion entity = assignShortName( event.getGeographicalLocationVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignShortNameFromGeographicalLocationVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    GeographicalLocationVersion entity = unAssignShortName( event.getGeographicalLocationVersionId() );
