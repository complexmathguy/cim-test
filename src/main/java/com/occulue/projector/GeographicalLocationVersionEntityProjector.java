...
public class GeographicalLocationVersionEntityProjector {
     ...
     * @return	GeographicalLocationVersion
     */
    public GeographicalLocationVersion assignDifferenceModelURI( UUID parentId, StringProxy assignment ) {
     ...
     * @return	GeographicalLocationVersion
     */
    public GeographicalLocationVersion assignModelDescriptionURI( UUID parentId, StringProxy assignment ) {
