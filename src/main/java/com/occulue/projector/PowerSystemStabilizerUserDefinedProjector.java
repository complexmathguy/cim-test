...
public class PowerSystemStabilizerUserDefinedProjector extends PowerSystemStabilizerUserDefinedEntityProjector {
    ...
    public void handle( AssignProprietaryToPowerSystemStabilizerUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    PowerSystemStabilizerUserDefined entity = assignProprietary( event.getPowerSystemStabilizerUserDefinedId(), event.getAssignment() );
	...
	public void handle( UnAssignProprietaryFromPowerSystemStabilizerUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    PowerSystemStabilizerUserDefined entity = unAssignProprietary( event.getPowerSystemStabilizerUserDefinedId() );
