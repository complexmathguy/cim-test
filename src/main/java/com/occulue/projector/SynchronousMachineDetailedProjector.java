...
public class SynchronousMachineDetailedProjector extends SynchronousMachineDetailedEntityProjector {
    ...
    public void handle( AssignEfdBaseRatioToSynchronousMachineDetailedEvent event) {
	    ...
	    // ------------------------------------------
	    SynchronousMachineDetailed entity = assignEfdBaseRatio( event.getSynchronousMachineDetailedId(), event.getAssignment() );
	...
	public void handle( UnAssignEfdBaseRatioFromSynchronousMachineDetailedEvent event) {
	    ...
	    // ------------------------------------------
	    SynchronousMachineDetailed entity = unAssignEfdBaseRatio( event.getSynchronousMachineDetailedId() );
    ...
    public void handle( AssignIfdBaseValueToSynchronousMachineDetailedEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineDetailed entity = assignIfdBaseValue( event.getSynchronousMachineDetailedId(), event.getAssignment() );
	...
	public void handle( UnAssignIfdBaseValueFromSynchronousMachineDetailedEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineDetailed entity = unAssignIfdBaseValue( event.getSynchronousMachineDetailedId() );
    ...
    public void handle( AssignSaturationFactor120QAxisToSynchronousMachineDetailedEvent event) {
	    LOGGER.info("handling AssignSaturationFactor120QAxisToSynchronousMachineDetailedEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineDetailed entity = assignSaturationFactor120QAxis( event.getSynchronousMachineDetailedId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignSaturationFactor120QAxisFromSynchronousMachineDetailedEvent.class)
	public void handle( UnAssignSaturationFactor120QAxisFromSynchronousMachineDetailedEvent event) {
	    LOGGER.info("handling UnAssignSaturationFactor120QAxisFromSynchronousMachineDetailedEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineDetailed entity = unAssignSaturationFactor120QAxis( event.getSynchronousMachineDetailedId() );
    ...
    public void handle( AssignSaturationFactorQAxisToSynchronousMachineDetailedEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineDetailed entity = assignSaturationFactorQAxis( event.getSynchronousMachineDetailedId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignSaturationFactorQAxisFromSynchronousMachineDetailedEvent.class)
	public void handle( UnAssignSaturationFactorQAxisFromSynchronousMachineDetailedEvent event) {
	    LOGGER.info("handling UnAssignSaturationFactorQAxisFromSynchronousMachineDetailedEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineDetailed entity = unAssignSaturationFactorQAxis( event.getSynchronousMachineDetailedId() );
