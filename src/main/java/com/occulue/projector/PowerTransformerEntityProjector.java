...
public class PowerTransformerEntityProjector {
     ...
     */
    public PowerTransformer assignBeforeShCircuitHighestOperatingCurrent( UUID parentId, CurrentFlow assignment ) {
     ...
     * @return	PowerTransformer
     */
    public PowerTransformer assignBeforeShCircuitHighestOperatingVoltage( UUID parentId, Voltage assignment ) {
     ...
     * @return	PowerTransformer
     */
    public PowerTransformer assignOperationalValuesConsidered( UUID parentId, BooleanProxy assignment ) {
