...
public class UnderexcLim2SimplifiedProjector extends UnderexcLim2SimplifiedEntityProjector {
    ...
    public void handle( AssignKuiToUnderexcLim2SimplifiedEvent event) {
	    ...
	    // ------------------------------------------
	    UnderexcLim2Simplified entity = assignKui( event.getUnderexcLim2SimplifiedId(), event.getAssignment() );
    ...
    public void handle( AssignP0ToUnderexcLim2SimplifiedEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    UnderexcLim2Simplified entity = assignP0( event.getUnderexcLim2SimplifiedId(), event.getAssignment() );
    ...
    public void handle( AssignP1ToUnderexcLim2SimplifiedEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    UnderexcLim2Simplified entity = assignP1( event.getUnderexcLim2SimplifiedId(), event.getAssignment() );
    ...
    public void handle( AssignQ0ToUnderexcLim2SimplifiedEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    UnderexcLim2Simplified entity = assignQ0( event.getUnderexcLim2SimplifiedId(), event.getAssignment() );
    ...
    public void handle( AssignQ1ToUnderexcLim2SimplifiedEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    UnderexcLim2Simplified entity = assignQ1( event.getUnderexcLim2SimplifiedId(), event.getAssignment() );
    ...
    public void handle( AssignVuimaxToUnderexcLim2SimplifiedEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    UnderexcLim2Simplified entity = assignVuimax( event.getUnderexcLim2SimplifiedId(), event.getAssignment() );
    ...
    public void handle( AssignVuiminToUnderexcLim2SimplifiedEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    UnderexcLim2Simplified entity = assignVuimin( event.getUnderexcLim2SimplifiedId(), event.getAssignment() );
