...
public class DiscontinuousExcitationControlUserDefinedProjector extends DiscontinuousExcitationControlUserDefinedEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignProprietaryToDiscontinuousExcitationControlUserDefinedEvent.class)
    public void handle( AssignProprietaryToDiscontinuousExcitationControlUserDefinedEvent event) {
	    LOGGER.info("handling AssignProprietaryToDiscontinuousExcitationControlUserDefinedEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscontinuousExcitationControlUserDefined entity = assignProprietary( event.getDiscontinuousExcitationControlUserDefinedId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignProprietaryFromDiscontinuousExcitationControlUserDefinedEvent.class)
	public void handle( UnAssignProprietaryFromDiscontinuousExcitationControlUserDefinedEvent event) {
	    LOGGER.info("handling UnAssignProprietaryFromDiscontinuousExcitationControlUserDefinedEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    DiscontinuousExcitationControlUserDefined entity = unAssignProprietary( event.getDiscontinuousExcitationControlUserDefinedId() );
