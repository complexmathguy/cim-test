...
public class PFVArType1IEEEPFControllerProjector extends PFVArType1IEEEPFControllerEntityProjector {
    ...
    public void handle( AssignOvexToPFVArType1IEEEPFControllerEvent event) {
	    ...
	    // ------------------------------------------
	    PFVArType1IEEEPFController entity = assignOvex( event.getPFVArType1IEEEPFControllerId(), event.getAssignment() );
    ...
    public void handle( AssignTpfcToPFVArType1IEEEPFControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType1IEEEPFController entity = assignTpfc( event.getPFVArType1IEEEPFControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVitminToPFVArType1IEEEPFControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType1IEEEPFController entity = assignVitmin( event.getPFVArType1IEEEPFControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVpfToPFVArType1IEEEPFControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType1IEEEPFController entity = assignVpf( event.getPFVArType1IEEEPFControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVpfcbwToPFVArType1IEEEPFControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType1IEEEPFController entity = assignVpfcbw( event.getPFVArType1IEEEPFControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVpfrefToPFVArType1IEEEPFControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType1IEEEPFController entity = assignVpfref( event.getPFVArType1IEEEPFControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVvtmaxToPFVArType1IEEEPFControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType1IEEEPFController entity = assignVvtmax( event.getPFVArType1IEEEPFControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVvtminToPFVArType1IEEEPFControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType1IEEEPFController entity = assignVvtmin( event.getPFVArType1IEEEPFControllerId(), event.getAssignment() );
