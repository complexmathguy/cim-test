...
public class TopologicalNodeProjector extends TopologicalNodeEntityProjector {
    ...
    public void handle( AssignBoundaryPointToTopologicalNodeEvent event) {
	    ...
	    // ------------------------------------------
	    TopologicalNode entity = assignBoundaryPoint( event.getTopologicalNodeId(), event.getAssignment() );
    ...
    public void handle( AssignFromEndIsoCodeToTopologicalNodeEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologicalNode entity = assignFromEndIsoCode( event.getTopologicalNodeId(), event.getAssignment() );
    ...
    public void handle( AssignFromEndNameTsoToTopologicalNodeEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologicalNode entity = assignFromEndNameTso( event.getTopologicalNodeId(), event.getAssignment() );
    ...
    public void handle( AssignToEndIsoCodeToTopologicalNodeEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologicalNode entity = assignToEndIsoCode( event.getTopologicalNodeId(), event.getAssignment() );
    ...
    public void handle( AssignToEndNameTsoToTopologicalNodeEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologicalNode entity = assignToEndNameTso( event.getTopologicalNodeId(), event.getAssignment() );
