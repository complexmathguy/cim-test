...
public class ExternalNetworkInjectionProjector extends ExternalNetworkInjectionEntityProjector {
    ...
    public void handle( AssignGovernorSCDToExternalNetworkInjectionEvent event) {
	    ...
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignGovernorSCD( event.getExternalNetworkInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignIkSecondToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignIkSecond( event.getExternalNetworkInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignMaxInitialSymShCCurrentToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignMaxInitialSymShCCurrent( event.getExternalNetworkInjectionId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignMaxInitialSymShCCurrentFromExternalNetworkInjectionEvent.class)
	public void handle( UnAssignMaxInitialSymShCCurrentFromExternalNetworkInjectionEvent event) {
	    LOGGER.info("handling UnAssignMaxInitialSymShCCurrentFromExternalNetworkInjectionEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    ExternalNetworkInjection entity = unAssignMaxInitialSymShCCurrent( event.getExternalNetworkInjectionId() );
    ...
    public void handle( AssignMaxPToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignMaxP( event.getExternalNetworkInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignMaxQToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignMaxQ( event.getExternalNetworkInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignMaxR0ToX0RatioToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignMaxR0ToX0Ratio( event.getExternalNetworkInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignMaxR1ToX1RatioToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignMaxR1ToX1Ratio( event.getExternalNetworkInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignMaxZ0ToZ1RatioToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignMaxZ0ToZ1Ratio( event.getExternalNetworkInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignMinInitialSymShCCurrentToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignMinInitialSymShCCurrent( event.getExternalNetworkInjectionId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignMinInitialSymShCCurrentFromExternalNetworkInjectionEvent.class)
	public void handle( UnAssignMinInitialSymShCCurrentFromExternalNetworkInjectionEvent event) {
	    LOGGER.info("handling UnAssignMinInitialSymShCCurrentFromExternalNetworkInjectionEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    ExternalNetworkInjection entity = unAssignMinInitialSymShCCurrent( event.getExternalNetworkInjectionId() );
    ...
    public void handle( AssignMinPToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignMinP( event.getExternalNetworkInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignMinQToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignMinQ( event.getExternalNetworkInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignMinR0ToX0RatioToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignMinR0ToX0Ratio( event.getExternalNetworkInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignMinR1ToX1RatioToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignMinR1ToX1Ratio( event.getExternalNetworkInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignMinZ0ToZ1RatioToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignMinZ0ToZ1Ratio( event.getExternalNetworkInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignVoltageFactorToExternalNetworkInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ExternalNetworkInjection entity = assignVoltageFactor( event.getExternalNetworkInjectionId(), event.getAssignment() );
