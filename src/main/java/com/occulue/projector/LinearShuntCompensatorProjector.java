...
public class LinearShuntCompensatorProjector extends LinearShuntCompensatorEntityProjector {
    ...
    public void handle( AssignB0PerSectionToLinearShuntCompensatorEvent event) {
	    ...
	    // ------------------------------------------
	    LinearShuntCompensator entity = assignB0PerSection( event.getLinearShuntCompensatorId(), event.getAssignment() );
    ...
    public void handle( AssignBPerSectionToLinearShuntCompensatorEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LinearShuntCompensator entity = assignBPerSection( event.getLinearShuntCompensatorId(), event.getAssignment() );
    ...
    public void handle( AssignG0PerSectionToLinearShuntCompensatorEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LinearShuntCompensator entity = assignG0PerSection( event.getLinearShuntCompensatorId(), event.getAssignment() );
    ...
    public void handle( AssignGPerSectionToLinearShuntCompensatorEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LinearShuntCompensator entity = assignGPerSection( event.getLinearShuntCompensatorId(), event.getAssignment() );
