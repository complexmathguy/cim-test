...
public class StaticVarCompensatorProjector extends StaticVarCompensatorEntityProjector {
    ...
    public void handle( AssignCapacitiveRatingToStaticVarCompensatorEvent event) {
	    ...
	    // ------------------------------------------
	    StaticVarCompensator entity = assignCapacitiveRating( event.getStaticVarCompensatorId(), event.getAssignment() );
    ...
    public void handle( AssignInductiveRatingToStaticVarCompensatorEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    StaticVarCompensator entity = assignInductiveRating( event.getStaticVarCompensatorId(), event.getAssignment() );
    ...
    public void handle( AssignSlopeToStaticVarCompensatorEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    StaticVarCompensator entity = assignSlope( event.getStaticVarCompensatorId(), event.getAssignment() );
    ...
    public void handle( AssignVoltageSetPointToStaticVarCompensatorEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    StaticVarCompensator entity = assignVoltageSetPoint( event.getStaticVarCompensatorId(), event.getAssignment() );
