...
public class DiscExcContIEEEDEC2AProjector extends DiscExcContIEEEDEC2AEntityProjector {
    ...
    public void handle( AssignTd1ToDiscExcContIEEEDEC2AEvent event) {
	    ...
	    // ------------------------------------------
	    DiscExcContIEEEDEC2A entity = assignTd1( event.getDiscExcContIEEEDEC2AId(), event.getAssignment() );
    ...
    public void handle( AssignTd2ToDiscExcContIEEEDEC2AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC2A entity = assignTd2( event.getDiscExcContIEEEDEC2AId(), event.getAssignment() );
    ...
    public void handle( AssignVdmaxToDiscExcContIEEEDEC2AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC2A entity = assignVdmax( event.getDiscExcContIEEEDEC2AId(), event.getAssignment() );
    ...
    public void handle( AssignVdminToDiscExcContIEEEDEC2AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC2A entity = assignVdmin( event.getDiscExcContIEEEDEC2AId(), event.getAssignment() );
    ...
    public void handle( AssignVkToDiscExcContIEEEDEC2AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC2A entity = assignVk( event.getDiscExcContIEEEDEC2AId(), event.getAssignment() );
