...
public class ShuntCompensatorProjector extends ShuntCompensatorEntityProjector {
    ...
    public void handle( AssignMaximumSectionsToShuntCompensatorEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ShuntCompensator entity = assignMaximumSections( event.getShuntCompensatorId(), event.getAssignment() );
    ...
    public void handle( AssignNormalSectionsToShuntCompensatorEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ShuntCompensator entity = assignNormalSections( event.getShuntCompensatorId(), event.getAssignment() );
    ...
    public void handle( AssignSwitchOnCountToShuntCompensatorEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ShuntCompensator entity = assignSwitchOnCount( event.getShuntCompensatorId(), event.getAssignment() );
    ...
    public void handle( AssignSwitchOnDateToShuntCompensatorEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ShuntCompensator entity = assignSwitchOnDate( event.getShuntCompensatorId(), event.getAssignment() );
    ...
    public void handle( AssignVoltageSensitivityToShuntCompensatorEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    ShuntCompensator entity = assignVoltageSensitivity( event.getShuntCompensatorId(), event.getAssignment() );
