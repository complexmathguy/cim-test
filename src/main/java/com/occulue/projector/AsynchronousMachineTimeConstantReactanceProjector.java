...
public class AsynchronousMachineTimeConstantReactanceProjector extends AsynchronousMachineTimeConstantReactanceEntityProjector {
    ...
    public void handle( AssignTpoToAsynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // ------------------------------------------
	    AsynchronousMachineTimeConstantReactance entity = assignTpo( event.getAsynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	...
	public void handle( UnAssignTpoFromAsynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // ------------------------------------------
	    AsynchronousMachineTimeConstantReactance entity = unAssignTpo( event.getAsynchronousMachineTimeConstantReactanceId() );
    ...
    public void handle( AssignTppoToAsynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachineTimeConstantReactance entity = assignTppo( event.getAsynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	...
	public void handle( UnAssignTppoFromAsynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling UnAssignTppoFromAsynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    AsynchronousMachineTimeConstantReactance entity = unAssignTppo( event.getAsynchronousMachineTimeConstantReactanceId() );
    ...
    public void handle( AssignXpToAsynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachineTimeConstantReactance entity = assignXp( event.getAsynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	...
	public void handle( UnAssignXpFromAsynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    AsynchronousMachineTimeConstantReactance entity = unAssignXp( event.getAsynchronousMachineTimeConstantReactanceId() );
    ...
    public void handle( AssignXppToAsynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachineTimeConstantReactance entity = assignXpp( event.getAsynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	...
	public void handle( UnAssignXppFromAsynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    AsynchronousMachineTimeConstantReactance entity = unAssignXpp( event.getAsynchronousMachineTimeConstantReactanceId() );
    ...
    public void handle( AssignXsToAsynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachineTimeConstantReactance entity = assignXs( event.getAsynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	...
	public void handle( UnAssignXsFromAsynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    AsynchronousMachineTimeConstantReactance entity = unAssignXs( event.getAsynchronousMachineTimeConstantReactanceId() );
