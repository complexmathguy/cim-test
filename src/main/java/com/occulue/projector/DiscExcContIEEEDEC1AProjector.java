...
public class DiscExcContIEEEDEC1AProjector extends DiscExcContIEEEDEC1AEntityProjector {
    ...
    public void handle( AssignEscToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignEsc( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignKanToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignKan( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignKetlToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignKetl( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignTanToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignTan( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignTdToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignTd( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignTl1ToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignTl1( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignTl2ToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignTl2( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignTw5ToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignTw5( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignValueToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignValue( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignVanmaxToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignVanmax( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignVomaxToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignVomax( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignVominToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignVomin( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignVsmaxToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignVsmax( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignVsminToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignVsmin( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignVtcToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignVtc( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignVtlmtToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignVtlmt( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignVtmToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignVtm( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
    ...
    public void handle( AssignVtnToDiscExcContIEEEDEC1AEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiscExcContIEEEDEC1A entity = assignVtn( event.getDiscExcContIEEEDEC1AId(), event.getAssignment() );
