...
public class DiagramLayoutVersionProjector extends DiagramLayoutVersionEntityProjector {
    ...
    public void handle( AssignBaseUMLToDiagramLayoutVersionEvent event) {
	    ...
	    // ------------------------------------------
	    DiagramLayoutVersion entity = assignBaseUML( event.getDiagramLayoutVersionId(), event.getAssignment() );
    ...
    public void handle( AssignBaseURIToDiagramLayoutVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramLayoutVersion entity = assignBaseURI( event.getDiagramLayoutVersionId(), event.getAssignment() );
    ...
    public void handle( AssignDateToDiagramLayoutVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramLayoutVersion entity = assignDate( event.getDiagramLayoutVersionId(), event.getAssignment() );
    ...
    public void handle( AssignDifferenceModelURIToDiagramLayoutVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramLayoutVersion entity = assignDifferenceModelURI( event.getDiagramLayoutVersionId(), event.getAssignment() );
    ...
    public void handle( AssignEntsoeUMLToDiagramLayoutVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramLayoutVersion entity = assignEntsoeUML( event.getDiagramLayoutVersionId(), event.getAssignment() );
    ...
    public void handle( AssignEntsoeURIToDiagramLayoutVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramLayoutVersion entity = assignEntsoeURI( event.getDiagramLayoutVersionId(), event.getAssignment() );
    ...
    public void handle( AssignModelDescriptionURIToDiagramLayoutVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramLayoutVersion entity = assignModelDescriptionURI( event.getDiagramLayoutVersionId(), event.getAssignment() );
    ...
    public void handle( AssignNamespaceRDFToDiagramLayoutVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramLayoutVersion entity = assignNamespaceRDF( event.getDiagramLayoutVersionId(), event.getAssignment() );
    ...
    public void handle( AssignNamespaceUMLToDiagramLayoutVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramLayoutVersion entity = assignNamespaceUML( event.getDiagramLayoutVersionId(), event.getAssignment() );
    ...
    public void handle( AssignShortNameToDiagramLayoutVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramLayoutVersion entity = assignShortName( event.getDiagramLayoutVersionId(), event.getAssignment() );
