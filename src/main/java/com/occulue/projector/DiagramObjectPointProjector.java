...
public class DiagramObjectPointProjector extends DiagramObjectPointEntityProjector {
    ...
    public void handle( AssignSequenceNumberToDiagramObjectPointEvent event) {
	    ...
	    // ------------------------------------------
	    DiagramObjectPoint entity = assignSequenceNumber( event.getDiagramObjectPointId(), event.getAssignment() );
    ...
    public void handle( AssignXPositionToDiagramObjectPointEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramObjectPoint entity = assignXPosition( event.getDiagramObjectPointId(), event.getAssignment() );
    ...
    public void handle( AssignYPositionToDiagramObjectPointEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramObjectPoint entity = assignYPosition( event.getDiagramObjectPointId(), event.getAssignment() );
    ...
    public void handle( AssignZPositionToDiagramObjectPointEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DiagramObjectPoint entity = assignZPosition( event.getDiagramObjectPointId(), event.getAssignment() );
