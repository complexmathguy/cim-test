...
public class ExternalNetworkInjectionEntityProjector {
     ...
     */
    public ExternalNetworkInjection assignGovernorSCD( UUID parentId, ActivePowerPerFrequency assignment ) {
     ...
     * @return	ExternalNetworkInjection
     */
    public ExternalNetworkInjection assignMaxInitialSymShCCurrent( UUID parentId, CurrentFlow assignment ) {
     ...
     * @return	ExternalNetworkInjection
     */
    public ExternalNetworkInjection assignMinInitialSymShCCurrent( UUID parentId, CurrentFlow assignment ) {
