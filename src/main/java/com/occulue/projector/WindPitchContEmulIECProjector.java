...
public class WindPitchContEmulIECProjector extends WindPitchContEmulIECEntityProjector {
    ...
    public void handle( AssignKdroopToWindPitchContEmulIECEvent event) {
	    ...
	    // ------------------------------------------
	    WindPitchContEmulIEC entity = assignKdroop( event.getWindPitchContEmulIECId(), event.getAssignment() );
    ...
    public void handle( AssignKipceToWindPitchContEmulIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPitchContEmulIEC entity = assignKipce( event.getWindPitchContEmulIECId(), event.getAssignment() );
    ...
    public void handle( AssignKomegaaeroToWindPitchContEmulIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPitchContEmulIEC entity = assignKomegaaero( event.getWindPitchContEmulIECId(), event.getAssignment() );
    ...
    public void handle( AssignKppceToWindPitchContEmulIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPitchContEmulIEC entity = assignKppce( event.getWindPitchContEmulIECId(), event.getAssignment() );
    ...
    public void handle( AssignOmegarefToWindPitchContEmulIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPitchContEmulIEC entity = assignOmegaref( event.getWindPitchContEmulIECId(), event.getAssignment() );
    ...
    public void handle( AssignPimaxToWindPitchContEmulIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPitchContEmulIEC entity = assignPimax( event.getWindPitchContEmulIECId(), event.getAssignment() );
    ...
    public void handle( AssignPiminToWindPitchContEmulIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPitchContEmulIEC entity = assignPimin( event.getWindPitchContEmulIECId(), event.getAssignment() );
    ...
    public void handle( AssignT1ToWindPitchContEmulIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPitchContEmulIEC entity = assignT1( event.getWindPitchContEmulIECId(), event.getAssignment() );
    ...
    public void handle( AssignT2ToWindPitchContEmulIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPitchContEmulIEC entity = assignT2( event.getWindPitchContEmulIECId(), event.getAssignment() );
    ...
    public void handle( AssignTpeToWindPitchContEmulIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPitchContEmulIEC entity = assignTpe( event.getWindPitchContEmulIECId(), event.getAssignment() );
