...
public class LoadResponseCharacteristicProjector extends LoadResponseCharacteristicEntityProjector {
    ...
    public void handle( AssignExponentModelToLoadResponseCharacteristicEvent event) {
	    ...
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = assignExponentModel( event.getLoadResponseCharacteristicId(), event.getAssignment() );
	...
	public void handle( UnAssignExponentModelFromLoadResponseCharacteristicEvent event) {
	    ...
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = unAssignExponentModel( event.getLoadResponseCharacteristicId() );
    ...
    public void handle( AssignPConstantCurrentToLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = assignPConstantCurrent( event.getLoadResponseCharacteristicId(), event.getAssignment() );
	...
	public void handle( UnAssignPConstantCurrentFromLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = unAssignPConstantCurrent( event.getLoadResponseCharacteristicId() );
    ...
    public void handle( AssignPConstantImpedanceToLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = assignPConstantImpedance( event.getLoadResponseCharacteristicId(), event.getAssignment() );
	...
	public void handle( UnAssignPConstantImpedanceFromLoadResponseCharacteristicEvent event) {
	    LOGGER.info("handling UnAssignPConstantImpedanceFromLoadResponseCharacteristicEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = unAssignPConstantImpedance( event.getLoadResponseCharacteristicId() );
    ...
    public void handle( AssignPConstantPowerToLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = assignPConstantPower( event.getLoadResponseCharacteristicId(), event.getAssignment() );
	...
	public void handle( UnAssignPConstantPowerFromLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = unAssignPConstantPower( event.getLoadResponseCharacteristicId() );
    ...
    public void handle( AssignPFrequencyExponentToLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = assignPFrequencyExponent( event.getLoadResponseCharacteristicId(), event.getAssignment() );
	...
	public void handle( UnAssignPFrequencyExponentFromLoadResponseCharacteristicEvent event) {
	    LOGGER.info("handling UnAssignPFrequencyExponentFromLoadResponseCharacteristicEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = unAssignPFrequencyExponent( event.getLoadResponseCharacteristicId() );
    ...
    public void handle( AssignPVoltageExponentToLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = assignPVoltageExponent( event.getLoadResponseCharacteristicId(), event.getAssignment() );
	...
	public void handle( UnAssignPVoltageExponentFromLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = unAssignPVoltageExponent( event.getLoadResponseCharacteristicId() );
    ...
    public void handle( AssignQConstantCurrentToLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = assignQConstantCurrent( event.getLoadResponseCharacteristicId(), event.getAssignment() );
	...
	public void handle( UnAssignQConstantCurrentFromLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = unAssignQConstantCurrent( event.getLoadResponseCharacteristicId() );
    ...
    public void handle( AssignQConstantImpedanceToLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = assignQConstantImpedance( event.getLoadResponseCharacteristicId(), event.getAssignment() );
	...
	public void handle( UnAssignQConstantImpedanceFromLoadResponseCharacteristicEvent event) {
	    LOGGER.info("handling UnAssignQConstantImpedanceFromLoadResponseCharacteristicEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = unAssignQConstantImpedance( event.getLoadResponseCharacteristicId() );
    ...
    public void handle( AssignQConstantPowerToLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = assignQConstantPower( event.getLoadResponseCharacteristicId(), event.getAssignment() );
	...
	public void handle( UnAssignQConstantPowerFromLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = unAssignQConstantPower( event.getLoadResponseCharacteristicId() );
    ...
    public void handle( AssignQFrequencyExponentToLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = assignQFrequencyExponent( event.getLoadResponseCharacteristicId(), event.getAssignment() );
	...
	public void handle( UnAssignQFrequencyExponentFromLoadResponseCharacteristicEvent event) {
	    LOGGER.info("handling UnAssignQFrequencyExponentFromLoadResponseCharacteristicEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = unAssignQFrequencyExponent( event.getLoadResponseCharacteristicId() );
    ...
    public void handle( AssignQVoltageExponentToLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = assignQVoltageExponent( event.getLoadResponseCharacteristicId(), event.getAssignment() );
	...
	public void handle( UnAssignQVoltageExponentFromLoadResponseCharacteristicEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    LoadResponseCharacteristic entity = unAssignQVoltageExponent( event.getLoadResponseCharacteristicId() );
