...
public class EquivalentBranchProjector extends EquivalentBranchEntityProjector {
    ...
    public void handle( AssignNegativeR12ToEquivalentBranchEvent event) {
	    ...
	    // ------------------------------------------
	    EquivalentBranch entity = assignNegativeR12( event.getEquivalentBranchId(), event.getAssignment() );
    ...
    public void handle( AssignNegativeR21ToEquivalentBranchEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquivalentBranch entity = assignNegativeR21( event.getEquivalentBranchId(), event.getAssignment() );
    ...
    public void handle( AssignNegativeX12ToEquivalentBranchEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquivalentBranch entity = assignNegativeX12( event.getEquivalentBranchId(), event.getAssignment() );
    ...
    public void handle( AssignNegativeX21ToEquivalentBranchEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquivalentBranch entity = assignNegativeX21( event.getEquivalentBranchId(), event.getAssignment() );
    ...
    public void handle( AssignPositiveR12ToEquivalentBranchEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquivalentBranch entity = assignPositiveR12( event.getEquivalentBranchId(), event.getAssignment() );
    ...
    public void handle( AssignPositiveR21ToEquivalentBranchEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquivalentBranch entity = assignPositiveR21( event.getEquivalentBranchId(), event.getAssignment() );
    ...
    public void handle( AssignPositiveX12ToEquivalentBranchEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquivalentBranch entity = assignPositiveX12( event.getEquivalentBranchId(), event.getAssignment() );
    ...
    public void handle( AssignPositiveX21ToEquivalentBranchEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquivalentBranch entity = assignPositiveX21( event.getEquivalentBranchId(), event.getAssignment() );
