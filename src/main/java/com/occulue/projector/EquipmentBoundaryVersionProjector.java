...
public class EquipmentBoundaryVersionProjector extends EquipmentBoundaryVersionEntityProjector {
    ...
    public void handle( AssignBaseUMLToEquipmentBoundaryVersionEvent event) {
	    ...
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = assignBaseUML( event.getEquipmentBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignBaseURIToEquipmentBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = assignBaseURI( event.getEquipmentBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignDateToEquipmentBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = assignDate( event.getEquipmentBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignDifferenceModelURIToEquipmentBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = assignDifferenceModelURI( event.getEquipmentBoundaryVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignDifferenceModelURIFromEquipmentBoundaryVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = unAssignDifferenceModelURI( event.getEquipmentBoundaryVersionId() );
    ...
    public void handle( AssignEntsoeUMLToEquipmentBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = assignEntsoeUML( event.getEquipmentBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignEntsoeURIcoreToEquipmentBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = assignEntsoeURIcore( event.getEquipmentBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignEntsoeURIoperationToEquipmentBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = assignEntsoeURIoperation( event.getEquipmentBoundaryVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignEntsoeURIoperationFromEquipmentBoundaryVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = unAssignEntsoeURIoperation( event.getEquipmentBoundaryVersionId() );
    ...
    public void handle( AssignModelDescriptionURIToEquipmentBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = assignModelDescriptionURI( event.getEquipmentBoundaryVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignModelDescriptionURIFromEquipmentBoundaryVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = unAssignModelDescriptionURI( event.getEquipmentBoundaryVersionId() );
    ...
    public void handle( AssignNamespaceRDFToEquipmentBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = assignNamespaceRDF( event.getEquipmentBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignNamespaceUMLToEquipmentBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = assignNamespaceUML( event.getEquipmentBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignShortNameToEquipmentBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentBoundaryVersion entity = assignShortName( event.getEquipmentBoundaryVersionId(), event.getAssignment() );
