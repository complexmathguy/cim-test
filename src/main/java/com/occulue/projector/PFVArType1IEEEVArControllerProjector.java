...
public class PFVArType1IEEEVArControllerProjector extends PFVArType1IEEEVArControllerEntityProjector {
    ...
    public void handle( AssignTvarcToPFVArType1IEEEVArControllerEvent event) {
	    ...
	    // ------------------------------------------
	    PFVArType1IEEEVArController entity = assignTvarc( event.getPFVArType1IEEEVArControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVvarToPFVArType1IEEEVArControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType1IEEEVArController entity = assignVvar( event.getPFVArType1IEEEVArControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVvarcbwToPFVArType1IEEEVArControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType1IEEEVArController entity = assignVvarcbw( event.getPFVArType1IEEEVArControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVvarrefToPFVArType1IEEEVArControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType1IEEEVArController entity = assignVvarref( event.getPFVArType1IEEEVArControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVvtmaxToPFVArType1IEEEVArControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType1IEEEVArController entity = assignVvtmax( event.getPFVArType1IEEEVArControllerId(), event.getAssignment() );
    ...
    public void handle( AssignVvtminToPFVArType1IEEEVArControllerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PFVArType1IEEEVArController entity = assignVvtmin( event.getPFVArType1IEEEVArControllerId(), event.getAssignment() );
