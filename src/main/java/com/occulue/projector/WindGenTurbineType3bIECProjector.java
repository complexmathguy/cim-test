...
public class WindGenTurbineType3bIECProjector extends WindGenTurbineType3bIECEntityProjector {
    ...
    public void handle( AssignFducwToWindGenTurbineType3bIECEvent event) {
	    ...
	    // ------------------------------------------
	    WindGenTurbineType3bIEC entity = assignFducw( event.getWindGenTurbineType3bIECId(), event.getAssignment() );
    ...
    public void handle( AssignMwtcwpToWindGenTurbineType3bIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindGenTurbineType3bIEC entity = assignMwtcwp( event.getWindGenTurbineType3bIECId(), event.getAssignment() );
    ...
    public void handle( AssignTgToWindGenTurbineType3bIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindGenTurbineType3bIEC entity = assignTg( event.getWindGenTurbineType3bIECId(), event.getAssignment() );
    ...
    public void handle( AssignTwoToWindGenTurbineType3bIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindGenTurbineType3bIEC entity = assignTwo( event.getWindGenTurbineType3bIECId(), event.getAssignment() );
    ...
    public void handle( AssignXsToWindGenTurbineType3bIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindGenTurbineType3bIEC entity = assignXs( event.getWindGenTurbineType3bIECId(), event.getAssignment() );
