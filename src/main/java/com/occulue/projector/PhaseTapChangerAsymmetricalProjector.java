...
public class PhaseTapChangerAsymmetricalProjector extends PhaseTapChangerAsymmetricalEntityProjector {
    ...
    public void handle( AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalEvent event) {
	    LOGGER.info("handling AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    PhaseTapChangerAsymmetrical entity = assignWindingConnectionAngle( event.getPhaseTapChangerAsymmetricalId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalEvent.class)
	public void handle( UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalEvent event) {
	    LOGGER.info("handling UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    PhaseTapChangerAsymmetrical entity = unAssignWindingConnectionAngle( event.getPhaseTapChangerAsymmetricalId() );
