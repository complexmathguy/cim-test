...
public class TopologyVersionProjector extends TopologyVersionEntityProjector {
    ...
    public void handle( AssignDifferenceModelURIToTopologyVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologyVersion entity = assignDifferenceModelURI( event.getTopologyVersionId(), event.getAssignment() );
    ...
    public void handle( AssignModelDescriptionURIToTopologyVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologyVersion entity = assignModelDescriptionURI( event.getTopologyVersionId(), event.getAssignment() );
    ...
    public void handle( AssignNamespaceRDFToTopologyVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologyVersion entity = assignNamespaceRDF( event.getTopologyVersionId(), event.getAssignment() );
    ...
    public void handle( AssignNamespaceUMLToTopologyVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologyVersion entity = assignNamespaceUML( event.getTopologyVersionId(), event.getAssignment() );
