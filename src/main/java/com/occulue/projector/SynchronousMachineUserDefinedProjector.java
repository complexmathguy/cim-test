...
public class SynchronousMachineUserDefinedProjector extends SynchronousMachineUserDefinedEntityProjector {
    ...
    public void handle( AssignProprietaryToSynchronousMachineUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    SynchronousMachineUserDefined entity = assignProprietary( event.getSynchronousMachineUserDefinedId(), event.getAssignment() );
	...
	public void handle( UnAssignProprietaryFromSynchronousMachineUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    SynchronousMachineUserDefined entity = unAssignProprietary( event.getSynchronousMachineUserDefinedId() );
