...
public class OverexcitationLimiterUserDefinedProjector extends OverexcitationLimiterUserDefinedEntityProjector {
    ...
    public void handle( AssignProprietaryToOverexcitationLimiterUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    OverexcitationLimiterUserDefined entity = assignProprietary( event.getOverexcitationLimiterUserDefinedId(), event.getAssignment() );
	...
	public void handle( UnAssignProprietaryFromOverexcitationLimiterUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    OverexcitationLimiterUserDefined entity = unAssignProprietary( event.getOverexcitationLimiterUserDefinedId() );
