...
public class SynchronousMachineDetailedEntityProjector {
     ...
     * @return	SynchronousMachineDetailed
     */
    public SynchronousMachineDetailed assignSaturationFactor120QAxis( UUID parentId, Simple_Float assignment ) {
     ...
     * @return	SynchronousMachineDetailed
     */
    public SynchronousMachineDetailed assignSaturationFactorQAxis( UUID parentId, Simple_Float assignment ) {
