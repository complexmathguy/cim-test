...
public class PhaseTapChangerLinearProjector extends PhaseTapChangerLinearEntityProjector {
    ...
    public void handle( AssignStepPhaseShiftIncrementToPhaseTapChangerLinearEvent event) {
	    ...
	    // ------------------------------------------
	    PhaseTapChangerLinear entity = assignStepPhaseShiftIncrement( event.getPhaseTapChangerLinearId(), event.getAssignment() );
	...
	public void handle( UnAssignStepPhaseShiftIncrementFromPhaseTapChangerLinearEvent event) {
	    LOGGER.info("handling UnAssignStepPhaseShiftIncrementFromPhaseTapChangerLinearEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    PhaseTapChangerLinear entity = unAssignStepPhaseShiftIncrement( event.getPhaseTapChangerLinearId() );
    ...
    public void handle( AssignXMaxToPhaseTapChangerLinearEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PhaseTapChangerLinear entity = assignXMax( event.getPhaseTapChangerLinearId(), event.getAssignment() );
    ...
    public void handle( AssignXMinToPhaseTapChangerLinearEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PhaseTapChangerLinear entity = assignXMin( event.getPhaseTapChangerLinearId(), event.getAssignment() );
