...
public class StateVariablesVersionProjector extends StateVariablesVersionEntityProjector {
    ...
    public void handle( AssignBaseUMLToStateVariablesVersionEvent event) {
	    ...
	    // ------------------------------------------
	    StateVariablesVersion entity = assignBaseUML( event.getStateVariablesVersionId(), event.getAssignment() );
    ...
    public void handle( AssignBaseURIToStateVariablesVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    StateVariablesVersion entity = assignBaseURI( event.getStateVariablesVersionId(), event.getAssignment() );
    ...
    public void handle( AssignDateToStateVariablesVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    StateVariablesVersion entity = assignDate( event.getStateVariablesVersionId(), event.getAssignment() );
    ...
    public void handle( AssignDifferenceModelURIToStateVariablesVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    StateVariablesVersion entity = assignDifferenceModelURI( event.getStateVariablesVersionId(), event.getAssignment() );
    ...
    public void handle( AssignEntsoeUMLToStateVariablesVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    StateVariablesVersion entity = assignEntsoeUML( event.getStateVariablesVersionId(), event.getAssignment() );
    ...
    public void handle( AssignEntsoeURIToStateVariablesVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    StateVariablesVersion entity = assignEntsoeURI( event.getStateVariablesVersionId(), event.getAssignment() );
    ...
    public void handle( AssignModelDescriptionURIToStateVariablesVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    StateVariablesVersion entity = assignModelDescriptionURI( event.getStateVariablesVersionId(), event.getAssignment() );
    ...
    public void handle( AssignNamespaceRDFToStateVariablesVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    StateVariablesVersion entity = assignNamespaceRDF( event.getStateVariablesVersionId(), event.getAssignment() );
    ...
    public void handle( AssignNamespaceUMLToStateVariablesVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    StateVariablesVersion entity = assignNamespaceUML( event.getStateVariablesVersionId(), event.getAssignment() );
    ...
    public void handle( AssignShortNameToStateVariablesVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    StateVariablesVersion entity = assignShortName( event.getStateVariablesVersionId(), event.getAssignment() );
