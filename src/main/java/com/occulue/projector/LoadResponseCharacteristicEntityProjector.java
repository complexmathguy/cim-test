...
public class LoadResponseCharacteristicEntityProjector {
     ...
     * @return	LoadResponseCharacteristic
     */
    public LoadResponseCharacteristic assignPConstantImpedance( UUID parentId, Simple_Float assignment ) {
     ...
     * @return	LoadResponseCharacteristic
     */
    public LoadResponseCharacteristic assignPFrequencyExponent( UUID parentId, Simple_Float assignment ) {
     ...
     * @return	LoadResponseCharacteristic
     */
    public LoadResponseCharacteristic assignQConstantImpedance( UUID parentId, Simple_Float assignment ) {
     ...
     * @return	LoadResponseCharacteristic
     */
    public LoadResponseCharacteristic assignQFrequencyExponent( UUID parentId, Simple_Float assignment ) {
