...
public class WindGenTurbineType3aIECProjector extends WindGenTurbineType3aIECEntityProjector {
    ...
    public void handle( AssignKpcToWindGenTurbineType3aIECEvent event) {
	    ...
	    // ------------------------------------------
	    WindGenTurbineType3aIEC entity = assignKpc( event.getWindGenTurbineType3aIECId(), event.getAssignment() );
    ...
    public void handle( AssignTicToWindGenTurbineType3aIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindGenTurbineType3aIEC entity = assignTic( event.getWindGenTurbineType3aIECId(), event.getAssignment() );
    ...
    public void handle( AssignXsToWindGenTurbineType3aIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindGenTurbineType3aIEC entity = assignXs( event.getWindGenTurbineType3aIECId(), event.getAssignment() );
