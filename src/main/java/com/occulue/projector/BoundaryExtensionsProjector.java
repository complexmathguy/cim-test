...
public class BoundaryExtensionsProjector extends BoundaryExtensionsEntityProjector {
    ...
    public void handle( AssignBoundaryPointToBoundaryExtensionsEvent event) {
	    ...
	    // ------------------------------------------
	    BoundaryExtensions entity = assignBoundaryPoint( event.getBoundaryExtensionsId(), event.getAssignment() );
    ...
    public void handle( AssignFromEndIsoCodeToBoundaryExtensionsEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    BoundaryExtensions entity = assignFromEndIsoCode( event.getBoundaryExtensionsId(), event.getAssignment() );
    ...
    public void handle( AssignFromEndNameToBoundaryExtensionsEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    BoundaryExtensions entity = assignFromEndName( event.getBoundaryExtensionsId(), event.getAssignment() );
    ...
    public void handle( AssignFromEndNameTsoToBoundaryExtensionsEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    BoundaryExtensions entity = assignFromEndNameTso( event.getBoundaryExtensionsId(), event.getAssignment() );
    ...
    public void handle( AssignToEndIsoCodeToBoundaryExtensionsEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    BoundaryExtensions entity = assignToEndIsoCode( event.getBoundaryExtensionsId(), event.getAssignment() );
    ...
    public void handle( AssignToEndNameToBoundaryExtensionsEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    BoundaryExtensions entity = assignToEndName( event.getBoundaryExtensionsId(), event.getAssignment() );
    ...
    public void handle( AssignToEndNameTsoToBoundaryExtensionsEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    BoundaryExtensions entity = assignToEndNameTso( event.getBoundaryExtensionsId(), event.getAssignment() );
