...
public class PhaseTapChangerNonLinearProjector extends PhaseTapChangerNonLinearEntityProjector {
    ...
    public void handle( AssignVoltageStepIncrementToPhaseTapChangerNonLinearEvent event) {
	    ...
	    // ------------------------------------------
	    PhaseTapChangerNonLinear entity = assignVoltageStepIncrement( event.getPhaseTapChangerNonLinearId(), event.getAssignment() );
	...
	public void handle( UnAssignVoltageStepIncrementFromPhaseTapChangerNonLinearEvent event) {
	    LOGGER.info("handling UnAssignVoltageStepIncrementFromPhaseTapChangerNonLinearEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    PhaseTapChangerNonLinear entity = unAssignVoltageStepIncrement( event.getPhaseTapChangerNonLinearId() );
    ...
    public void handle( AssignXMaxToPhaseTapChangerNonLinearEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PhaseTapChangerNonLinear entity = assignXMax( event.getPhaseTapChangerNonLinearId(), event.getAssignment() );
    ...
    public void handle( AssignXMinToPhaseTapChangerNonLinearEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PhaseTapChangerNonLinear entity = assignXMin( event.getPhaseTapChangerNonLinearId(), event.getAssignment() );
