...
public class NonlinearShuntCompensatorPointProjector extends NonlinearShuntCompensatorPointEntityProjector {
    ...
    public void handle( AssignBToNonlinearShuntCompensatorPointEvent event) {
	    ...
	    // ------------------------------------------
	    NonlinearShuntCompensatorPoint entity = assignB( event.getNonlinearShuntCompensatorPointId(), event.getAssignment() );
    ...
    public void handle( AssignB0ToNonlinearShuntCompensatorPointEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    NonlinearShuntCompensatorPoint entity = assignB0( event.getNonlinearShuntCompensatorPointId(), event.getAssignment() );
    ...
    public void handle( AssignGToNonlinearShuntCompensatorPointEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    NonlinearShuntCompensatorPoint entity = assignG( event.getNonlinearShuntCompensatorPointId(), event.getAssignment() );
    ...
    public void handle( AssignG0ToNonlinearShuntCompensatorPointEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    NonlinearShuntCompensatorPoint entity = assignG0( event.getNonlinearShuntCompensatorPointId(), event.getAssignment() );
    ...
    public void handle( AssignSectionNumberToNonlinearShuntCompensatorPointEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    NonlinearShuntCompensatorPoint entity = assignSectionNumber( event.getNonlinearShuntCompensatorPointId(), event.getAssignment() );
	...
	public void handle( UnAssignSectionNumberFromNonlinearShuntCompensatorPointEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    NonlinearShuntCompensatorPoint entity = unAssignSectionNumber( event.getNonlinearShuntCompensatorPointId() );
