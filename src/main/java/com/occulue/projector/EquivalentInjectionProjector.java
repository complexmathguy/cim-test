...
public class EquivalentInjectionProjector extends EquivalentInjectionEntityProjector {
    ...
    public void handle( AssignMaxPToEquivalentInjectionEvent event) {
	    ...
	    // ------------------------------------------
	    EquivalentInjection entity = assignMaxP( event.getEquivalentInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignMaxQToEquivalentInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquivalentInjection entity = assignMaxQ( event.getEquivalentInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignMinPToEquivalentInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquivalentInjection entity = assignMinP( event.getEquivalentInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignMinQToEquivalentInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquivalentInjection entity = assignMinQ( event.getEquivalentInjectionId(), event.getAssignment() );
    ...
    public void handle( AssignRegulationCapabilityToEquivalentInjectionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquivalentInjection entity = assignRegulationCapability( event.getEquivalentInjectionId(), event.getAssignment() );
