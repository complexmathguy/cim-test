...
public class SynchronousMachineEquivalentCircuitProjector extends SynchronousMachineEquivalentCircuitEntityProjector {
    ...
    public void handle( AssignR1dToSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = assignR1d( event.getSynchronousMachineEquivalentCircuitId(), event.getAssignment() );
	...
	public void handle( UnAssignR1dFromSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = unAssignR1d( event.getSynchronousMachineEquivalentCircuitId() );
    ...
    public void handle( AssignR1qToSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = assignR1q( event.getSynchronousMachineEquivalentCircuitId(), event.getAssignment() );
	...
	public void handle( UnAssignR1qFromSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = unAssignR1q( event.getSynchronousMachineEquivalentCircuitId() );
    ...
    public void handle( AssignR2qToSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = assignR2q( event.getSynchronousMachineEquivalentCircuitId(), event.getAssignment() );
	...
	public void handle( UnAssignR2qFromSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = unAssignR2q( event.getSynchronousMachineEquivalentCircuitId() );
    ...
    public void handle( AssignRfdToSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = assignRfd( event.getSynchronousMachineEquivalentCircuitId(), event.getAssignment() );
	...
	public void handle( UnAssignRfdFromSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = unAssignRfd( event.getSynchronousMachineEquivalentCircuitId() );
    ...
    public void handle( AssignX1dToSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = assignX1d( event.getSynchronousMachineEquivalentCircuitId(), event.getAssignment() );
	...
	public void handle( UnAssignX1dFromSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = unAssignX1d( event.getSynchronousMachineEquivalentCircuitId() );
    ...
    public void handle( AssignX1qToSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = assignX1q( event.getSynchronousMachineEquivalentCircuitId(), event.getAssignment() );
	...
	public void handle( UnAssignX1qFromSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = unAssignX1q( event.getSynchronousMachineEquivalentCircuitId() );
    ...
    public void handle( AssignX2qToSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = assignX2q( event.getSynchronousMachineEquivalentCircuitId(), event.getAssignment() );
	...
	public void handle( UnAssignX2qFromSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = unAssignX2q( event.getSynchronousMachineEquivalentCircuitId() );
    ...
    public void handle( AssignXadToSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = assignXad( event.getSynchronousMachineEquivalentCircuitId(), event.getAssignment() );
	...
	public void handle( UnAssignXadFromSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = unAssignXad( event.getSynchronousMachineEquivalentCircuitId() );
    ...
    public void handle( AssignXaqToSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = assignXaq( event.getSynchronousMachineEquivalentCircuitId(), event.getAssignment() );
	...
	public void handle( UnAssignXaqFromSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = unAssignXaq( event.getSynchronousMachineEquivalentCircuitId() );
    ...
    public void handle( AssignXf1dToSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = assignXf1d( event.getSynchronousMachineEquivalentCircuitId(), event.getAssignment() );
	...
	public void handle( UnAssignXf1dFromSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = unAssignXf1d( event.getSynchronousMachineEquivalentCircuitId() );
    ...
    public void handle( AssignXfdToSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = assignXfd( event.getSynchronousMachineEquivalentCircuitId(), event.getAssignment() );
	...
	public void handle( UnAssignXfdFromSynchronousMachineEquivalentCircuitEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineEquivalentCircuit entity = unAssignXfd( event.getSynchronousMachineEquivalentCircuitId() );
