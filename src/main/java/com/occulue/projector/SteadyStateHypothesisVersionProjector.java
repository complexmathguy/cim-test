...
public class SteadyStateHypothesisVersionProjector extends SteadyStateHypothesisVersionEntityProjector {
    ...
    public void handle( AssignBaseUMLToSteadyStateHypothesisVersionEvent event) {
	    ...
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = assignBaseUML( event.getSteadyStateHypothesisVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignBaseUMLFromSteadyStateHypothesisVersionEvent event) {
	    ...
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = unAssignBaseUML( event.getSteadyStateHypothesisVersionId() );
    ...
    public void handle( AssignBaseURIToSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = assignBaseURI( event.getSteadyStateHypothesisVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignBaseURIFromSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = unAssignBaseURI( event.getSteadyStateHypothesisVersionId() );
    ...
    public void handle( AssignDateToSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = assignDate( event.getSteadyStateHypothesisVersionId(), event.getAssignment() );
    ...
    public void handle( AssignDifferenceModelURIToSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = assignDifferenceModelURI( event.getSteadyStateHypothesisVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignDifferenceModelURIFromSteadyStateHypothesisVersionEvent event) {
	    LOGGER.info("handling UnAssignDifferenceModelURIFromSteadyStateHypothesisVersionEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = unAssignDifferenceModelURI( event.getSteadyStateHypothesisVersionId() );
    ...
    public void handle( AssignEntsoeUMLToSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = assignEntsoeUML( event.getSteadyStateHypothesisVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignEntsoeUMLFromSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = unAssignEntsoeUML( event.getSteadyStateHypothesisVersionId() );
    ...
    public void handle( AssignEntsoeURIToSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = assignEntsoeURI( event.getSteadyStateHypothesisVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignEntsoeURIFromSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = unAssignEntsoeURI( event.getSteadyStateHypothesisVersionId() );
    ...
    public void handle( AssignModelDescriptionURIToSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = assignModelDescriptionURI( event.getSteadyStateHypothesisVersionId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignModelDescriptionURIFromSteadyStateHypothesisVersionEvent.class)
	public void handle( UnAssignModelDescriptionURIFromSteadyStateHypothesisVersionEvent event) {
	    LOGGER.info("handling UnAssignModelDescriptionURIFromSteadyStateHypothesisVersionEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = unAssignModelDescriptionURI( event.getSteadyStateHypothesisVersionId() );
    ...
    public void handle( AssignNamespaceRDFToSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = assignNamespaceRDF( event.getSteadyStateHypothesisVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignNamespaceRDFFromSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = unAssignNamespaceRDF( event.getSteadyStateHypothesisVersionId() );
    ...
    public void handle( AssignNamespaceUMLToSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = assignNamespaceUML( event.getSteadyStateHypothesisVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignNamespaceUMLFromSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = unAssignNamespaceUML( event.getSteadyStateHypothesisVersionId() );
    ...
    public void handle( AssignShortNameToSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = assignShortName( event.getSteadyStateHypothesisVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignShortNameFromSteadyStateHypothesisVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SteadyStateHypothesisVersion entity = unAssignShortName( event.getSteadyStateHypothesisVersionId() );
