...
public class GovHydroFrancisProjector extends GovHydroFrancisEntityProjector {
    ...
    public void handle( AssignWaterTunnelSurgeChamberSimulationToGovHydroFrancisEvent event) {
	    LOGGER.info("handling AssignWaterTunnelSurgeChamberSimulationToGovHydroFrancisEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    GovHydroFrancis entity = assignWaterTunnelSurgeChamberSimulation( event.getGovHydroFrancisId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroFrancisEvent.class)
	public void handle( UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroFrancisEvent event) {
	    LOGGER.info("handling UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroFrancisEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    GovHydroFrancis entity = unAssignWaterTunnelSurgeChamberSimulation( event.getGovHydroFrancisId() );
