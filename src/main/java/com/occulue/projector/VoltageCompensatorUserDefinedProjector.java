...
public class VoltageCompensatorUserDefinedProjector extends VoltageCompensatorUserDefinedEntityProjector {
    ...
    public void handle( AssignProprietaryToVoltageCompensatorUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    VoltageCompensatorUserDefined entity = assignProprietary( event.getVoltageCompensatorUserDefinedId(), event.getAssignment() );
	...
	public void handle( UnAssignProprietaryFromVoltageCompensatorUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    VoltageCompensatorUserDefined entity = unAssignProprietary( event.getVoltageCompensatorUserDefinedId() );
