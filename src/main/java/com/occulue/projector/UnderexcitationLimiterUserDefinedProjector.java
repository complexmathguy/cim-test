...
public class UnderexcitationLimiterUserDefinedProjector extends UnderexcitationLimiterUserDefinedEntityProjector {
    ...
    public void handle( AssignProprietaryToUnderexcitationLimiterUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    UnderexcitationLimiterUserDefined entity = assignProprietary( event.getUnderexcitationLimiterUserDefinedId(), event.getAssignment() );
	...
	public void handle( UnAssignProprietaryFromUnderexcitationLimiterUserDefinedEvent event) {
	    LOGGER.info("handling UnAssignProprietaryFromUnderexcitationLimiterUserDefinedEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    UnderexcitationLimiterUserDefined entity = unAssignProprietary( event.getUnderexcitationLimiterUserDefinedId() );
