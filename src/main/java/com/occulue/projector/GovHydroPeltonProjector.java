...
public class GovHydroPeltonProjector extends GovHydroPeltonEntityProjector {
    ...
    public void handle( AssignSimplifiedPeltonToGovHydroPeltonEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GovHydroPelton entity = assignSimplifiedPelton( event.getGovHydroPeltonId(), event.getAssignment() );
    ...
    public void handle( AssignStaticCompensatingToGovHydroPeltonEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GovHydroPelton entity = assignStaticCompensating( event.getGovHydroPeltonId(), event.getAssignment() );
    ...
    public void handle( AssignWaterTunnelSurgeChamberSimulationToGovHydroPeltonEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GovHydroPelton entity = assignWaterTunnelSurgeChamberSimulation( event.getGovHydroPeltonId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroPeltonEvent.class)
	public void handle( UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroPeltonEvent event) {
	    LOGGER.info("handling UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroPeltonEvent - " + event );
