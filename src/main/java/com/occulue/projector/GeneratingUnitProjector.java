...
public class GeneratingUnitProjector extends GeneratingUnitEntityProjector {
    ...
    public void handle( AssignMaximumAllowableSpinningReserveToGeneratingUnitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GeneratingUnit entity = assignMaximumAllowableSpinningReserve( event.getGeneratingUnitId(), event.getAssignment() );
	...
	public void handle( UnAssignMaximumAllowableSpinningReserveFromGeneratingUnitEvent event) {
	    LOGGER.info("handling UnAssignMaximumAllowableSpinningReserveFromGeneratingUnitEvent - " + event );
    ...
    public void handle( AssignRatedGrossMaxPToGeneratingUnitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GeneratingUnit entity = assignRatedGrossMaxP( event.getGeneratingUnitId(), event.getAssignment() );
    ...
    public void handle( AssignRatedGrossMinPToGeneratingUnitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GeneratingUnit entity = assignRatedGrossMinP( event.getGeneratingUnitId(), event.getAssignment() );
    ...
    public void handle( AssignTotalEfficiencyToGeneratingUnitEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    GeneratingUnit entity = assignTotalEfficiency( event.getGeneratingUnitId(), event.getAssignment() );
