...
public class RotatingMachineDynamicsProjector extends RotatingMachineDynamicsEntityProjector {
    ...
    public void handle( AssignDampingToRotatingMachineDynamicsEvent event) {
	    ...
	    // ------------------------------------------
	    RotatingMachineDynamics entity = assignDamping( event.getRotatingMachineDynamicsId(), event.getAssignment() );
    ...
    public void handle( AssignInertiaToRotatingMachineDynamicsEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    RotatingMachineDynamics entity = assignInertia( event.getRotatingMachineDynamicsId(), event.getAssignment() );
    ...
    public void handle( AssignSaturationFactorToRotatingMachineDynamicsEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    RotatingMachineDynamics entity = assignSaturationFactor( event.getRotatingMachineDynamicsId(), event.getAssignment() );
    ...
    public void handle( AssignSaturationFactor120ToRotatingMachineDynamicsEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    RotatingMachineDynamics entity = assignSaturationFactor120( event.getRotatingMachineDynamicsId(), event.getAssignment() );
	...
	public void handle( UnAssignSaturationFactor120FromRotatingMachineDynamicsEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    RotatingMachineDynamics entity = unAssignSaturationFactor120( event.getRotatingMachineDynamicsId() );
    ...
    public void handle( AssignStatorLeakageReactanceToRotatingMachineDynamicsEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    RotatingMachineDynamics entity = assignStatorLeakageReactance( event.getRotatingMachineDynamicsId(), event.getAssignment() );
	...
	public void handle( UnAssignStatorLeakageReactanceFromRotatingMachineDynamicsEvent event) {
	    LOGGER.info("handling UnAssignStatorLeakageReactanceFromRotatingMachineDynamicsEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    RotatingMachineDynamics entity = unAssignStatorLeakageReactance( event.getRotatingMachineDynamicsId() );
    ...
    public void handle( AssignStatorResistanceToRotatingMachineDynamicsEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    RotatingMachineDynamics entity = assignStatorResistance( event.getRotatingMachineDynamicsId(), event.getAssignment() );
