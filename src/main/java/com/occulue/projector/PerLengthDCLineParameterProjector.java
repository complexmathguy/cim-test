...
public class PerLengthDCLineParameterProjector extends PerLengthDCLineParameterEntityProjector {
    ...
    public void handle( AssignCapacitanceToPerLengthDCLineParameterEvent event) {
	    ...
	    // ------------------------------------------
	    PerLengthDCLineParameter entity = assignCapacitance( event.getPerLengthDCLineParameterId(), event.getAssignment() );
    ...
    public void handle( AssignInductanceToPerLengthDCLineParameterEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PerLengthDCLineParameter entity = assignInductance( event.getPerLengthDCLineParameterId(), event.getAssignment() );
    ...
    public void handle( AssignResistanceToPerLengthDCLineParameterEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PerLengthDCLineParameter entity = assignResistance( event.getPerLengthDCLineParameterId(), event.getAssignment() );
