...
public class TopologyBoundaryVersionProjector extends TopologyBoundaryVersionEntityProjector {
    ...
    public void handle( AssignBaseUMLToTopologyBoundaryVersionEvent event) {
	    ...
	    // ------------------------------------------
	    TopologyBoundaryVersion entity = assignBaseUML( event.getTopologyBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignBaseURIToTopologyBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologyBoundaryVersion entity = assignBaseURI( event.getTopologyBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignDateToTopologyBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologyBoundaryVersion entity = assignDate( event.getTopologyBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignDifferenceModelURIToTopologyBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologyBoundaryVersion entity = assignDifferenceModelURI( event.getTopologyBoundaryVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignDifferenceModelURIFromTopologyBoundaryVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    TopologyBoundaryVersion entity = unAssignDifferenceModelURI( event.getTopologyBoundaryVersionId() );
    ...
    public void handle( AssignEntsoeUMLToTopologyBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologyBoundaryVersion entity = assignEntsoeUML( event.getTopologyBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignEntsoeURIToTopologyBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologyBoundaryVersion entity = assignEntsoeURI( event.getTopologyBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignModelDescriptionURIToTopologyBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologyBoundaryVersion entity = assignModelDescriptionURI( event.getTopologyBoundaryVersionId(), event.getAssignment() );
	...
	public void handle( UnAssignModelDescriptionURIFromTopologyBoundaryVersionEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    TopologyBoundaryVersion entity = unAssignModelDescriptionURI( event.getTopologyBoundaryVersionId() );
    ...
    public void handle( AssignNamespaceRDFToTopologyBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologyBoundaryVersion entity = assignNamespaceRDF( event.getTopologyBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignNamespaceUMLToTopologyBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologyBoundaryVersion entity = assignNamespaceUML( event.getTopologyBoundaryVersionId(), event.getAssignment() );
    ...
    public void handle( AssignShortNameToTopologyBoundaryVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    TopologyBoundaryVersion entity = assignShortName( event.getTopologyBoundaryVersionId(), event.getAssignment() );
