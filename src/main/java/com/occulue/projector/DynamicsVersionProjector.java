...
public class DynamicsVersionProjector extends DynamicsVersionEntityProjector {
    ...
    public void handle( AssignDifferenceModelURIToDynamicsVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DynamicsVersion entity = assignDifferenceModelURI( event.getDynamicsVersionId(), event.getAssignment() );
    ...
    public void handle( AssignModelDescriptionURIToDynamicsVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DynamicsVersion entity = assignModelDescriptionURI( event.getDynamicsVersionId(), event.getAssignment() );
    ...
    public void handle( AssignNamespaceRDFToDynamicsVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DynamicsVersion entity = assignNamespaceRDF( event.getDynamicsVersionId(), event.getAssignment() );
    ...
    public void handle( AssignNamespaceUMLToDynamicsVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    DynamicsVersion entity = assignNamespaceUML( event.getDynamicsVersionId(), event.getAssignment() );
