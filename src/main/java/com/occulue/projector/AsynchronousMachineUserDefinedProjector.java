...
public class AsynchronousMachineUserDefinedProjector extends AsynchronousMachineUserDefinedEntityProjector {
    ...
    public void handle( AssignProprietaryToAsynchronousMachineUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    AsynchronousMachineUserDefined entity = assignProprietary( event.getAsynchronousMachineUserDefinedId(), event.getAssignment() );
	...
	public void handle( UnAssignProprietaryFromAsynchronousMachineUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    AsynchronousMachineUserDefined entity = unAssignProprietary( event.getAsynchronousMachineUserDefinedId() );
