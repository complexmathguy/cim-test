...
public class PowerTransformerProjector extends PowerTransformerEntityProjector {
     ...
     */
    @EventHandler( payloadType=AssignBeforeShCircuitHighestOperatingCurrentToPowerTransformerEvent.class)
    public void handle( AssignBeforeShCircuitHighestOperatingCurrentToPowerTransformerEvent event) {
	    LOGGER.info("handling AssignBeforeShCircuitHighestOperatingCurrentToPowerTransformerEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    PowerTransformer entity = assignBeforeShCircuitHighestOperatingCurrent( event.getPowerTransformerId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignBeforeShCircuitHighestOperatingCurrentFromPowerTransformerEvent.class)
	public void handle( UnAssignBeforeShCircuitHighestOperatingCurrentFromPowerTransformerEvent event) {
	    LOGGER.info("handling UnAssignBeforeShCircuitHighestOperatingCurrentFromPowerTransformerEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    PowerTransformer entity = unAssignBeforeShCircuitHighestOperatingCurrent( event.getPowerTransformerId() );
     ...
     */
    @EventHandler( payloadType=AssignBeforeShCircuitHighestOperatingVoltageToPowerTransformerEvent.class)
    public void handle( AssignBeforeShCircuitHighestOperatingVoltageToPowerTransformerEvent event) {
	    LOGGER.info("handling AssignBeforeShCircuitHighestOperatingVoltageToPowerTransformerEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    PowerTransformer entity = assignBeforeShCircuitHighestOperatingVoltage( event.getPowerTransformerId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignBeforeShCircuitHighestOperatingVoltageFromPowerTransformerEvent.class)
	public void handle( UnAssignBeforeShCircuitHighestOperatingVoltageFromPowerTransformerEvent event) {
	    LOGGER.info("handling UnAssignBeforeShCircuitHighestOperatingVoltageFromPowerTransformerEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    PowerTransformer entity = unAssignBeforeShCircuitHighestOperatingVoltage( event.getPowerTransformerId() );
    ...
    public void handle( AssignBeforeShortCircuitAnglePfToPowerTransformerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PowerTransformer entity = assignBeforeShortCircuitAnglePf( event.getPowerTransformerId(), event.getAssignment() );
    ...
    public void handle( AssignHighSideMinOperatingUToPowerTransformerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PowerTransformer entity = assignHighSideMinOperatingU( event.getPowerTransformerId(), event.getAssignment() );
    ...
    public void handle( AssignPartOfGeneratorUnitFlagToPowerTransformerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PowerTransformer entity = assignPartOfGeneratorUnitFlag( event.getPowerTransformerId(), event.getAssignment() );
    ...
    public void handle( AssignOperationalValuesConsideredToPowerTransformerEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    PowerTransformer entity = assignOperationalValuesConsidered( event.getPowerTransformerId(), event.getAssignment() );
