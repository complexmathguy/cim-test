...
public class EquipmentVersionProjector extends EquipmentVersionEntityProjector {
    ...
    public void handle( AssignBaseURIcoreToEquipmentVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentVersion entity = assignBaseURIcore( event.getEquipmentVersionId(), event.getAssignment() );
    ...
    public void handle( AssignBaseURIoperationToEquipmentVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentVersion entity = assignBaseURIoperation( event.getEquipmentVersionId(), event.getAssignment() );
    ...
    public void handle( AssignBaseURIshortCircuitToEquipmentVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentVersion entity = assignBaseURIshortCircuit( event.getEquipmentVersionId(), event.getAssignment() );
    ...
    public void handle( AssignDifferenceModelURIToEquipmentVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentVersion entity = assignDifferenceModelURI( event.getEquipmentVersionId(), event.getAssignment() );
    ...
    public void handle( AssignEntsoeURIcoreToEquipmentVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentVersion entity = assignEntsoeURIcore( event.getEquipmentVersionId(), event.getAssignment() );
    ...
    public void handle( AssignEntsoeURIoperationToEquipmentVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentVersion entity = assignEntsoeURIoperation( event.getEquipmentVersionId(), event.getAssignment() );
    ...
    public void handle( AssignEntsoeURIshortCircuitToEquipmentVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentVersion entity = assignEntsoeURIshortCircuit( event.getEquipmentVersionId(), event.getAssignment() );
    ...
    public void handle( AssignModelDescriptionURIToEquipmentVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentVersion entity = assignModelDescriptionURI( event.getEquipmentVersionId(), event.getAssignment() );
    ...
    public void handle( AssignNamespaceRDFToEquipmentVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentVersion entity = assignNamespaceRDF( event.getEquipmentVersionId(), event.getAssignment() );
    ...
    public void handle( AssignNamespaceUMLToEquipmentVersionEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    EquipmentVersion entity = assignNamespaceUML( event.getEquipmentVersionId(), event.getAssignment() );
