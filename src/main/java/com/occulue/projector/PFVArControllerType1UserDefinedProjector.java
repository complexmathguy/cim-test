...
public class PFVArControllerType1UserDefinedProjector extends PFVArControllerType1UserDefinedEntityProjector {
    ...
    public void handle( AssignProprietaryToPFVArControllerType1UserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    PFVArControllerType1UserDefined entity = assignProprietary( event.getPFVArControllerType1UserDefinedId(), event.getAssignment() );
	...
	public void handle( UnAssignProprietaryFromPFVArControllerType1UserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    PFVArControllerType1UserDefined entity = unAssignProprietary( event.getPFVArControllerType1UserDefinedId() );
