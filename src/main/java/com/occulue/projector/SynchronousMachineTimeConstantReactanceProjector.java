...
public class SynchronousMachineTimeConstantReactanceProjector extends SynchronousMachineTimeConstantReactanceEntityProjector {
    ...
    public void handle( AssignKsToSynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = assignKs( event.getSynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	...
	public void handle( UnAssignKsFromSynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = unAssignKs( event.getSynchronousMachineTimeConstantReactanceId() );
    ...
    public void handle( AssignTcToSynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = assignTc( event.getSynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	...
	public void handle( UnAssignTcFromSynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = unAssignTc( event.getSynchronousMachineTimeConstantReactanceId() );
    ...
    public void handle( AssignTpdoToSynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = assignTpdo( event.getSynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	...
	public void handle( UnAssignTpdoFromSynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = unAssignTpdo( event.getSynchronousMachineTimeConstantReactanceId() );
    ...
    public void handle( AssignTppdoToSynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = assignTppdo( event.getSynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	...
	public void handle( UnAssignTppdoFromSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling UnAssignTppdoFromSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = unAssignTppdo( event.getSynchronousMachineTimeConstantReactanceId() );
    ...
    public void handle( AssignTppqoToSynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = assignTppqo( event.getSynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	...
	public void handle( UnAssignTppqoFromSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling UnAssignTppqoFromSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = unAssignTppqo( event.getSynchronousMachineTimeConstantReactanceId() );
    ...
    public void handle( AssignTpqoToSynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = assignTpqo( event.getSynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	...
	public void handle( UnAssignTpqoFromSynchronousMachineTimeConstantReactanceEvent event) {
	    ...
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = unAssignTpqo( event.getSynchronousMachineTimeConstantReactanceId() );
     ...
     */
    @EventHandler( payloadType=AssignXDirectSubtransToSynchronousMachineTimeConstantReactanceEvent.class)
    public void handle( AssignXDirectSubtransToSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling AssignXDirectSubtransToSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = assignXDirectSubtrans( event.getSynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignXDirectSubtransFromSynchronousMachineTimeConstantReactanceEvent.class)
	public void handle( UnAssignXDirectSubtransFromSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling UnAssignXDirectSubtransFromSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = unAssignXDirectSubtrans( event.getSynchronousMachineTimeConstantReactanceId() );
    ...
    public void handle( AssignXDirectSyncToSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling AssignXDirectSyncToSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = assignXDirectSync( event.getSynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignXDirectSyncFromSynchronousMachineTimeConstantReactanceEvent.class)
	public void handle( UnAssignXDirectSyncFromSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling UnAssignXDirectSyncFromSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = unAssignXDirectSync( event.getSynchronousMachineTimeConstantReactanceId() );
     ...
     */
    @EventHandler( payloadType=AssignXDirectTransToSynchronousMachineTimeConstantReactanceEvent.class)
    public void handle( AssignXDirectTransToSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling AssignXDirectTransToSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = assignXDirectTrans( event.getSynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignXDirectTransFromSynchronousMachineTimeConstantReactanceEvent.class)
	public void handle( UnAssignXDirectTransFromSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling UnAssignXDirectTransFromSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = unAssignXDirectTrans( event.getSynchronousMachineTimeConstantReactanceId() );
     ...
     */
    @EventHandler( payloadType=AssignXQuadSubtransToSynchronousMachineTimeConstantReactanceEvent.class)
    public void handle( AssignXQuadSubtransToSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling AssignXQuadSubtransToSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = assignXQuadSubtrans( event.getSynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignXQuadSubtransFromSynchronousMachineTimeConstantReactanceEvent.class)
	public void handle( UnAssignXQuadSubtransFromSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling UnAssignXQuadSubtransFromSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = unAssignXQuadSubtrans( event.getSynchronousMachineTimeConstantReactanceId() );
    ...
    public void handle( AssignXQuadSyncToSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling AssignXQuadSyncToSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = assignXQuadSync( event.getSynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignXQuadSyncFromSynchronousMachineTimeConstantReactanceEvent.class)
	public void handle( UnAssignXQuadSyncFromSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling UnAssignXQuadSyncFromSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = unAssignXQuadSync( event.getSynchronousMachineTimeConstantReactanceId() );
    ...
    public void handle( AssignXQuadTransToSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling AssignXQuadTransToSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to assignTo
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = assignXQuadTrans( event.getSynchronousMachineTimeConstantReactanceId(), event.getAssignment() );
	 ...
	 */
	@EventHandler( payloadType=UnAssignXQuadTransFromSynchronousMachineTimeConstantReactanceEvent.class)
	public void handle( UnAssignXQuadTransFromSynchronousMachineTimeConstantReactanceEvent event) {
	    LOGGER.info("handling UnAssignXQuadTransFromSynchronousMachineTimeConstantReactanceEvent - " + event );

	    // ------------------------------------------
	    // delegate to unAssignFrom
	    // ------------------------------------------
	    SynchronousMachineTimeConstantReactance entity = unAssignXQuadTrans( event.getSynchronousMachineTimeConstantReactanceId() );
