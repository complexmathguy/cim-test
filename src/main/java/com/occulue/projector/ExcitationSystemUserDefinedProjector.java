...
public class ExcitationSystemUserDefinedProjector extends ExcitationSystemUserDefinedEntityProjector {
    ...
    public void handle( AssignProprietaryToExcitationSystemUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    ExcitationSystemUserDefined entity = assignProprietary( event.getExcitationSystemUserDefinedId(), event.getAssignment() );
	...
	public void handle( UnAssignProprietaryFromExcitationSystemUserDefinedEvent event) {
	    ...
	    // ------------------------------------------
	    ExcitationSystemUserDefined entity = unAssignProprietary( event.getExcitationSystemUserDefinedId() );
