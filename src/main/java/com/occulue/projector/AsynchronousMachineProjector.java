...
public class AsynchronousMachineProjector extends AsynchronousMachineEntityProjector {
    ...
    public void handle( AssignConverterFedDriveToAsynchronousMachineEvent event) {
	    ...
	    // ------------------------------------------
	    AsynchronousMachine entity = assignConverterFedDrive( event.getAsynchronousMachineId(), event.getAssignment() );
    ...
    public void handle( AssignEfficiencyToAsynchronousMachineEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachine entity = assignEfficiency( event.getAsynchronousMachineId(), event.getAssignment() );
    ...
    public void handle( AssignIaIrRatioToAsynchronousMachineEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachine entity = assignIaIrRatio( event.getAsynchronousMachineId(), event.getAssignment() );
    ...
    public void handle( AssignNominalFrequencyToAsynchronousMachineEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachine entity = assignNominalFrequency( event.getAsynchronousMachineId(), event.getAssignment() );
    ...
    public void handle( AssignNominalSpeedToAsynchronousMachineEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachine entity = assignNominalSpeed( event.getAsynchronousMachineId(), event.getAssignment() );
    ...
    public void handle( AssignPolePairNumberToAsynchronousMachineEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachine entity = assignPolePairNumber( event.getAsynchronousMachineId(), event.getAssignment() );
    ...
    public void handle( AssignRatedMechanicalPowerToAsynchronousMachineEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachine entity = assignRatedMechanicalPower( event.getAsynchronousMachineId(), event.getAssignment() );
    ...
    public void handle( AssignReversibleToAsynchronousMachineEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachine entity = assignReversible( event.getAsynchronousMachineId(), event.getAssignment() );
    ...
    public void handle( AssignRxLockedRotorRatioToAsynchronousMachineEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    AsynchronousMachine entity = assignRxLockedRotorRatio( event.getAsynchronousMachineId(), event.getAssignment() );
