...
public class WindPlantFreqPcontrolIECProjector extends WindPlantFreqPcontrolIECEntityProjector {
    ...
    public void handle( AssignDprefmaxToWindPlantFreqPcontrolIECEvent event) {
	    ...
	    // ------------------------------------------
	    WindPlantFreqPcontrolIEC entity = assignDprefmax( event.getWindPlantFreqPcontrolIECId(), event.getAssignment() );
    ...
    public void handle( AssignDprefminToWindPlantFreqPcontrolIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantFreqPcontrolIEC entity = assignDprefmin( event.getWindPlantFreqPcontrolIECId(), event.getAssignment() );
    ...
    public void handle( AssignKiwppToWindPlantFreqPcontrolIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantFreqPcontrolIEC entity = assignKiwpp( event.getWindPlantFreqPcontrolIECId(), event.getAssignment() );
    ...
    public void handle( AssignKpwppToWindPlantFreqPcontrolIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantFreqPcontrolIEC entity = assignKpwpp( event.getWindPlantFreqPcontrolIECId(), event.getAssignment() );
    ...
    public void handle( AssignPrefmaxToWindPlantFreqPcontrolIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantFreqPcontrolIEC entity = assignPrefmax( event.getWindPlantFreqPcontrolIECId(), event.getAssignment() );
    ...
    public void handle( AssignPrefminToWindPlantFreqPcontrolIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantFreqPcontrolIEC entity = assignPrefmin( event.getWindPlantFreqPcontrolIECId(), event.getAssignment() );
    ...
    public void handle( AssignTpftToWindPlantFreqPcontrolIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantFreqPcontrolIEC entity = assignTpft( event.getWindPlantFreqPcontrolIECId(), event.getAssignment() );
    ...
    public void handle( AssignTpfvToWindPlantFreqPcontrolIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantFreqPcontrolIEC entity = assignTpfv( event.getWindPlantFreqPcontrolIECId(), event.getAssignment() );
    ...
    public void handle( AssignTwpffiltToWindPlantFreqPcontrolIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantFreqPcontrolIEC entity = assignTwpffilt( event.getWindPlantFreqPcontrolIECId(), event.getAssignment() );
    ...
    public void handle( AssignTwppfiltToWindPlantFreqPcontrolIECEvent event) {
	    ...
	    // delegate to assignTo
	    // ------------------------------------------
	    WindPlantFreqPcontrolIEC entity = assignTwppfilt( event.getWindPlantFreqPcontrolIECId(), event.getAssignment() );
