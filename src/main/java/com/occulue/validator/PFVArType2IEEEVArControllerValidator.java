...
//		Assert.isNull( pFVArType2IEEEVArController.getPFVArType2IEEEVArControllerId(), "CreatePFVArType2IEEEVArControllerCommand identifier should be null" );
	...
	public void validate( AssignExlonToPFVArType2IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "AssignExlonToPFVArType2IEEEVArControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExlonToPFVArType2IEEEVArControllerCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignExlonFromPFVArType2IEEEVArControllerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignExlonFromPFVArType2IEEEVArControllerCommand should not be null" );
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "UnAssignExlonFromPFVArType2IEEEVArControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToPFVArType2IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "AssignKiToPFVArType2IEEEVArControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToPFVArType2IEEEVArControllerCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromPFVArType2IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "UnAssignKiFromPFVArType2IEEEVArControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToPFVArType2IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "AssignKpToPFVArType2IEEEVArControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToPFVArType2IEEEVArControllerCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromPFVArType2IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "UnAssignKpFromPFVArType2IEEEVArControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQrefToPFVArType2IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "AssignQrefToPFVArType2IEEEVArControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQrefToPFVArType2IEEEVArControllerCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignQrefFromPFVArType2IEEEVArControllerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignQrefFromPFVArType2IEEEVArControllerCommand should not be null" );
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "UnAssignQrefFromPFVArType2IEEEVArControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVclmtToPFVArType2IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "AssignVclmtToPFVArType2IEEEVArControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVclmtToPFVArType2IEEEVArControllerCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVclmtFromPFVArType2IEEEVArControllerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVclmtFromPFVArType2IEEEVArControllerCommand should not be null" );
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "UnAssignVclmtFromPFVArType2IEEEVArControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrefToPFVArType2IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "AssignVrefToPFVArType2IEEEVArControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrefToPFVArType2IEEEVArControllerCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVrefFromPFVArType2IEEEVArControllerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVrefFromPFVArType2IEEEVArControllerCommand should not be null" );
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "UnAssignVrefFromPFVArType2IEEEVArControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsToPFVArType2IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "AssignVsToPFVArType2IEEEVArControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsToPFVArType2IEEEVArControllerCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsFromPFVArType2IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEVArControllerId(), "UnAssignVsFromPFVArType2IEEEVArControllerCommand identifier should not be null" );
	}
