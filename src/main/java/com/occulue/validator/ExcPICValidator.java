...
//		Assert.isNull( excPIC.getExcPICId(), "CreateExcPICCommand identifier should be null" );
	...
	public void validate( AssignE1ToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignE1ToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignE1FromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignE1FromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignE2ToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignE2ToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignE2FromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignE2FromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfdmaxToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "AssignEfdmaxToExcPICCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdmaxToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdmaxFromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignEfdmaxFromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfdminToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "AssignEfdminToExcPICCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdminToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdminFromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignEfdminFromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKaToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignKaFromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKcToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignKcFromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKeToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignKeFromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKfToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignKfFromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKiToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignKiFromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKpToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignKpFromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSe1ToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignSe1ToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSe1FromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignSe1FromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSe2ToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignSe2ToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSe2FromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignSe2FromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTa1ToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTa1ToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTa1FromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignTa1FromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTa2ToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTa2ToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTa2FromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignTa2FromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTa3ToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTa3ToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTa3FromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignTa3FromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTa4ToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTa4ToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTa4FromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignTa4FromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTeToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignTeFromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTf1ToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTf1ToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTf1FromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignTf1FromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTf2ToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTf2ToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTf2FromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignTf2FromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVr1ToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVr1ToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVr1FromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignVr1FromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVr2ToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVr2ToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVr2FromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignVr2FromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "AssignVrmaxToExcPICCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignVrmaxFromExcPICCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "AssignVrminToExcPICCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcPICCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcPICCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcPICId(), "UnAssignVrminFromExcPICCommand identifier should not be null" );
	}
