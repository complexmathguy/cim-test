...
//		Assert.isNull( govGAST.getGovGASTId(), "CreateGovGASTCommand identifier should be null" );
	...
	public void validate( AssignAtToGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "AssignAtToGovGASTCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAtToGovGASTCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAtFromGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "UnAssignAtFromGovGASTCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDturbToGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "AssignDturbToGovGASTCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDturbToGovGASTCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDturbFromGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "UnAssignDturbFromGovGASTCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKtToGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "AssignKtToGovGASTCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKtToGovGASTCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKtFromGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "UnAssignKtFromGovGASTCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "AssignMwbaseToGovGASTCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovGASTCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "UnAssignMwbaseFromGovGASTCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRToGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignRToGovGASTCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRFromGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "UnAssignRFromGovGASTCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "AssignT1ToGovGASTCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToGovGASTCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "UnAssignT1FromGovGASTCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "AssignT2ToGovGASTCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToGovGASTCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "UnAssignT2FromGovGASTCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "AssignT3ToGovGASTCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToGovGASTCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "UnAssignT3FromGovGASTCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmaxToGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "AssignVmaxToGovGASTCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmaxToGovGASTCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVmaxFromGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "UnAssignVmaxFromGovGASTCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVminToGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "AssignVminToGovGASTCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVminToGovGASTCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVminFromGovGASTCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTId(), "UnAssignVminFromGovGASTCommand identifier should not be null" );
	}
