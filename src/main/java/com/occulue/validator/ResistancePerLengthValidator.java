...
//		Assert.isNull( resistancePerLength.getResistancePerLengthId(), "CreateResistancePerLengthCommand identifier should be null" );
	...
	public void validate( AssignValueToResistancePerLengthCommand command ) throws Exception {
		...
		Assert.notNull( command.getResistancePerLengthId(), "AssignValueToResistancePerLengthCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToResistancePerLengthCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromResistancePerLengthCommand command ) throws Exception {
		...
		Assert.notNull( command.getResistancePerLengthId(), "UnAssignValueFromResistancePerLengthCommand identifier should not be null" );
	}
