...
//		Assert.isNull( excIEEEST7B.getExcIEEEST7BId(), "CreateExcIEEEST7BCommand identifier should be null" );
	...
	public void validate( AssignKhToExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "AssignKhToExcIEEEST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKhToExcIEEEST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKhFromExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "UnAssignKhFromExcIEEEST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiaToExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "AssignKiaToExcIEEEST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiaToExcIEEEST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiaFromExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "UnAssignKiaFromExcIEEEST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKlToExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "AssignKlToExcIEEEST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKlToExcIEEEST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKlFromExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "UnAssignKlFromExcIEEEST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpaToExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "AssignKpaToExcIEEEST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpaToExcIEEEST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpaFromExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "UnAssignKpaFromExcIEEEST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "AssignTbToExcIEEEST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcIEEEST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "UnAssignTbFromExcIEEEST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "AssignTcToExcIEEEST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcIEEEST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "UnAssignTcFromExcIEEEST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "AssignTfToExcIEEEST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcIEEEST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "UnAssignTfFromExcIEEEST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTgToExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "AssignTgToExcIEEEST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTgToExcIEEEST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTgFromExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "UnAssignTgFromExcIEEEST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTiaToExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "AssignTiaToExcIEEEST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTiaToExcIEEEST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTiaFromExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "UnAssignTiaFromExcIEEEST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmaxToExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "AssignVmaxToExcIEEEST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmaxToExcIEEEST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVmaxFromExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "UnAssignVmaxFromExcIEEEST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVminToExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "AssignVminToExcIEEEST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVminToExcIEEEST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVminFromExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "UnAssignVminFromExcIEEEST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "AssignVrmaxToExcIEEEST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "UnAssignVrmaxFromExcIEEEST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "AssignVrminToExcIEEEST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST7BId(), "UnAssignVrminFromExcIEEEST7BCommand identifier should not be null" );
	}
