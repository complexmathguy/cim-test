...
//		Assert.isNull( govHydroIEEE0.getGovHydroIEEE0Id(), "CreateGovHydroIEEE0Command identifier should be null" );
	...
	public void validate( AssignKToGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "AssignKToGovHydroIEEE0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKToGovHydroIEEE0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKFromGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "UnAssignKFromGovHydroIEEE0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "AssignMwbaseToGovHydroIEEE0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovHydroIEEE0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "UnAssignMwbaseFromGovHydroIEEE0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPmaxToGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "AssignPmaxToGovHydroIEEE0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPmaxToGovHydroIEEE0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPmaxFromGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "UnAssignPmaxFromGovHydroIEEE0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPminToGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "AssignPminToGovHydroIEEE0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPminToGovHydroIEEE0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPminFromGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "UnAssignPminFromGovHydroIEEE0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "AssignT1ToGovHydroIEEE0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToGovHydroIEEE0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "UnAssignT1FromGovHydroIEEE0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "AssignT2ToGovHydroIEEE0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToGovHydroIEEE0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "UnAssignT2FromGovHydroIEEE0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "AssignT3ToGovHydroIEEE0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToGovHydroIEEE0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "UnAssignT3FromGovHydroIEEE0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "AssignT4ToGovHydroIEEE0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4ToGovHydroIEEE0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromGovHydroIEEE0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroIEEE0Id(), "UnAssignT4FromGovHydroIEEE0Command identifier should not be null" );
	}
