...
//		Assert.isNull( loadMotor.getLoadMotorId(), "CreateLoadMotorCommand identifier should be null" );
	...
	public void validate( AssignDToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignDToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignDFromLoadMotorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignHToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignHToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignHToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignHFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignHFromLoadMotorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignLfacToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignLfacToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLfacToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLfacFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignLfacFromLoadMotorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignLpToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignLpToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLpToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLpFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignLpFromLoadMotorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignLppToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignLppToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLppToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLppFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignLppFromLoadMotorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignLsToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignLsToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLsToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLsFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignLsFromLoadMotorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPfracToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignPfracToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPfracToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPfracFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignPfracFromLoadMotorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRaToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignRaToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRaToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRaFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignRaFromLoadMotorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbkrToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignTbkrToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbkrToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbkrFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignTbkrFromLoadMotorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpoToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignTpoToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpoToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTpoFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignTpoFromLoadMotorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTppoToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignTppoToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTppoToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTppoFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignTppoFromLoadMotorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTvToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignTvToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTvToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTvFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignTvFromLoadMotorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVtToLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "AssignVtToLoadMotorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVtToLoadMotorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVtFromLoadMotorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadMotorId(), "UnAssignVtFromLoadMotorCommand identifier should not be null" );
	}
