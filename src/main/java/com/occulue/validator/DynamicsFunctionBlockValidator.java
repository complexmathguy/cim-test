...
//		Assert.isNull( dynamicsFunctionBlock.getDynamicsFunctionBlockId(), "CreateDynamicsFunctionBlockCommand identifier should be null" );
	...
	public void validate( AssignEnabledToDynamicsFunctionBlockCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsFunctionBlockId(), "AssignEnabledToDynamicsFunctionBlockCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEnabledToDynamicsFunctionBlockCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEnabledFromDynamicsFunctionBlockCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsFunctionBlockId(), "UnAssignEnabledFromDynamicsFunctionBlockCommand identifier should not be null" );
	}
