...
//		Assert.isNull( basicIntervalSchedule.getBasicIntervalScheduleId(), "CreateBasicIntervalScheduleCommand identifier should be null" );
	...
	public void validate( AssignStartTimeToBasicIntervalScheduleCommand command ) throws Exception {
		...
		Assert.notNull( command.getBasicIntervalScheduleId(), "AssignStartTimeToBasicIntervalScheduleCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignStartTimeToBasicIntervalScheduleCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignStartTimeFromBasicIntervalScheduleCommand command ) throws Exception {
		...
		Assert.notNull( command.getBasicIntervalScheduleId(), "UnAssignStartTimeFromBasicIntervalScheduleCommand identifier should not be null" );
	}
