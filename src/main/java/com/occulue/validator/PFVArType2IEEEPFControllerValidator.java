...
//		Assert.isNull( pFVArType2IEEEPFController.getPFVArType2IEEEPFControllerId(), "CreatePFVArType2IEEEPFControllerCommand identifier should be null" );
	...
	public void validate( AssignExlonToPFVArType2IEEEPFControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "AssignExlonToPFVArType2IEEEPFControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExlonToPFVArType2IEEEPFControllerCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignExlonFromPFVArType2IEEEPFControllerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignExlonFromPFVArType2IEEEPFControllerCommand should not be null" );
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "UnAssignExlonFromPFVArType2IEEEPFControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToPFVArType2IEEEPFControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "AssignKiToPFVArType2IEEEPFControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToPFVArType2IEEEPFControllerCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromPFVArType2IEEEPFControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "UnAssignKiFromPFVArType2IEEEPFControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToPFVArType2IEEEPFControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "AssignKpToPFVArType2IEEEPFControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToPFVArType2IEEEPFControllerCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromPFVArType2IEEEPFControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "UnAssignKpFromPFVArType2IEEEPFControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPfrefToPFVArType2IEEEPFControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "AssignPfrefToPFVArType2IEEEPFControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPfrefToPFVArType2IEEEPFControllerCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignPfrefFromPFVArType2IEEEPFControllerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignPfrefFromPFVArType2IEEEPFControllerCommand should not be null" );
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "UnAssignPfrefFromPFVArType2IEEEPFControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVclmtToPFVArType2IEEEPFControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "AssignVclmtToPFVArType2IEEEPFControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVclmtToPFVArType2IEEEPFControllerCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVclmtFromPFVArType2IEEEPFControllerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVclmtFromPFVArType2IEEEPFControllerCommand should not be null" );
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "UnAssignVclmtFromPFVArType2IEEEPFControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrefToPFVArType2IEEEPFControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "AssignVrefToPFVArType2IEEEPFControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrefToPFVArType2IEEEPFControllerCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrefFromPFVArType2IEEEPFControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "UnAssignVrefFromPFVArType2IEEEPFControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsToPFVArType2IEEEPFControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "AssignVsToPFVArType2IEEEPFControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsToPFVArType2IEEEPFControllerCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsFromPFVArType2IEEEPFControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2IEEEPFControllerId(), "UnAssignVsFromPFVArType2IEEEPFControllerCommand identifier should not be null" );
	}
