...
//		Assert.isNull( switchProxy.getSwitchProxyId(), "CreateSwitchProxyCommand identifier should be null" );
	...
	public void validate( AssignNormalOpenToSwitchProxyCommand command ) throws Exception {
		...
		Assert.notNull( command.getSwitchProxyId(), "AssignNormalOpenToSwitchProxyCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNormalOpenToSwitchProxyCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNormalOpenFromSwitchProxyCommand command ) throws Exception {
		...
		Assert.notNull( command.getSwitchProxyId(), "UnAssignNormalOpenFromSwitchProxyCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRatedCurrentToSwitchProxyCommand command ) throws Exception {
		...
		Assert.notNull( command.getSwitchProxyId(), "AssignRatedCurrentToSwitchProxyCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRatedCurrentToSwitchProxyCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRatedCurrentFromSwitchProxyCommand command ) throws Exception {
		...
		Assert.notNull( command.getSwitchProxyId(), "UnAssignRatedCurrentFromSwitchProxyCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRetainedToSwitchProxyCommand command ) throws Exception {
		...
		Assert.notNull( command.getSwitchProxyId(), "AssignRetainedToSwitchProxyCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRetainedToSwitchProxyCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRetainedFromSwitchProxyCommand command ) throws Exception {
		...
		Assert.notNull( command.getSwitchProxyId(), "UnAssignRetainedFromSwitchProxyCommand identifier should not be null" );
	}
