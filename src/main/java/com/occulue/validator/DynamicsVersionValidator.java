...
//		Assert.isNull( dynamicsVersion.getDynamicsVersionId(), "CreateDynamicsVersionCommand identifier should be null" );
	...
	public void validate( AssignBaseUMLToDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "AssignBaseUMLToDynamicsVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBaseUMLToDynamicsVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBaseUMLFromDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "UnAssignBaseUMLFromDynamicsVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBaseURIToDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "AssignBaseURIToDynamicsVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBaseURIToDynamicsVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBaseURIFromDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "UnAssignBaseURIFromDynamicsVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDateToDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "AssignDateToDynamicsVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDateToDynamicsVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDateFromDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "UnAssignDateFromDynamicsVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDifferenceModelURIToDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "AssignDifferenceModelURIToDynamicsVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDifferenceModelURIToDynamicsVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignDifferenceModelURIFromDynamicsVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignDifferenceModelURIFromDynamicsVersionCommand should not be null" );
		Assert.notNull( command.getDynamicsVersionId(), "UnAssignDifferenceModelURIFromDynamicsVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEntsoeUMLToDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "AssignEntsoeUMLToDynamicsVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEntsoeUMLToDynamicsVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEntsoeUMLFromDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "UnAssignEntsoeUMLFromDynamicsVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEntsoeURIToDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "AssignEntsoeURIToDynamicsVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEntsoeURIToDynamicsVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEntsoeURIFromDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "UnAssignEntsoeURIFromDynamicsVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignModelDescriptionURIToDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "AssignModelDescriptionURIToDynamicsVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignModelDescriptionURIToDynamicsVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignModelDescriptionURIFromDynamicsVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignModelDescriptionURIFromDynamicsVersionCommand should not be null" );
		Assert.notNull( command.getDynamicsVersionId(), "UnAssignModelDescriptionURIFromDynamicsVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNamespaceRDFToDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "AssignNamespaceRDFToDynamicsVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNamespaceRDFToDynamicsVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNamespaceRDFFromDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "UnAssignNamespaceRDFFromDynamicsVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNamespaceUMLToDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "AssignNamespaceUMLToDynamicsVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNamespaceUMLToDynamicsVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNamespaceUMLFromDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "UnAssignNamespaceUMLFromDynamicsVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignShortNameToDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "AssignShortNameToDynamicsVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignShortNameToDynamicsVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignShortNameFromDynamicsVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDynamicsVersionId(), "UnAssignShortNameFromDynamicsVersionCommand identifier should not be null" );
	}
