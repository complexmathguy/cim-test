...
//		Assert.isNull( quality61850.getQuality61850Id(), "CreateQuality61850Command identifier should be null" );
	...
	public void validate( AssignBadReferenceToQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "AssignBadReferenceToQuality61850Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBadReferenceToQuality61850Command assignment should not be null" );
	}
	...
	public void validate( UnAssignBadReferenceFromQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "UnAssignBadReferenceFromQuality61850Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEstimatorReplacedToQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "AssignEstimatorReplacedToQuality61850Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEstimatorReplacedToQuality61850Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEstimatorReplacedFromQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "UnAssignEstimatorReplacedFromQuality61850Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignFailureToQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "AssignFailureToQuality61850Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFailureToQuality61850Command assignment should not be null" );
	}
	...
	public void validate( UnAssignFailureFromQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "UnAssignFailureFromQuality61850Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignOldDataToQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "AssignOldDataToQuality61850Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignOldDataToQuality61850Command assignment should not be null" );
	}
	...
	public void validate( UnAssignOldDataFromQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "UnAssignOldDataFromQuality61850Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignOperatorBlockedToQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "AssignOperatorBlockedToQuality61850Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignOperatorBlockedToQuality61850Command assignment should not be null" );
	}
	...
	public void validate( UnAssignOperatorBlockedFromQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "UnAssignOperatorBlockedFromQuality61850Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignOscillatoryToQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "AssignOscillatoryToQuality61850Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignOscillatoryToQuality61850Command assignment should not be null" );
	}
	...
	public void validate( UnAssignOscillatoryFromQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "UnAssignOscillatoryFromQuality61850Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignOutOfRangeToQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "AssignOutOfRangeToQuality61850Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignOutOfRangeToQuality61850Command assignment should not be null" );
	}
	...
	public void validate( UnAssignOutOfRangeFromQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "UnAssignOutOfRangeFromQuality61850Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignOverFlowToQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "AssignOverFlowToQuality61850Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignOverFlowToQuality61850Command assignment should not be null" );
	}
	...
	public void validate( UnAssignOverFlowFromQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "UnAssignOverFlowFromQuality61850Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSuspectToQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "AssignSuspectToQuality61850Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSuspectToQuality61850Command assignment should not be null" );
	}
	...
	public void validate( UnAssignSuspectFromQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "UnAssignSuspectFromQuality61850Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTestToQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "AssignTestToQuality61850Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTestToQuality61850Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTestFromQuality61850Command command ) throws Exception {
		...
		Assert.notNull( command.getQuality61850Id(), "UnAssignTestFromQuality61850Command identifier should not be null" );
	}
