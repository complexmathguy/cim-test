...
//		Assert.isNull( windGenTurbineType3bIEC.getWindGenTurbineType3bIECId(), "CreateWindGenTurbineType3bIECCommand identifier should be null" );
	...
	public void validate( AssignFducwToWindGenTurbineType3bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3bIECId(), "AssignFducwToWindGenTurbineType3bIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFducwToWindGenTurbineType3bIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignFducwFromWindGenTurbineType3bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3bIECId(), "UnAssignFducwFromWindGenTurbineType3bIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwtcwpToWindGenTurbineType3bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3bIECId(), "AssignMwtcwpToWindGenTurbineType3bIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwtcwpToWindGenTurbineType3bIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMwtcwpFromWindGenTurbineType3bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3bIECId(), "UnAssignMwtcwpFromWindGenTurbineType3bIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTgToWindGenTurbineType3bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3bIECId(), "AssignTgToWindGenTurbineType3bIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTgToWindGenTurbineType3bIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTgFromWindGenTurbineType3bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3bIECId(), "UnAssignTgFromWindGenTurbineType3bIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTwoToWindGenTurbineType3bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3bIECId(), "AssignTwoToWindGenTurbineType3bIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTwoToWindGenTurbineType3bIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTwoFromWindGenTurbineType3bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3bIECId(), "UnAssignTwoFromWindGenTurbineType3bIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXsToWindGenTurbineType3bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3bIECId(), "AssignXsToWindGenTurbineType3bIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXsToWindGenTurbineType3bIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXsFromWindGenTurbineType3bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3bIECId(), "UnAssignXsFromWindGenTurbineType3bIECCommand identifier should not be null" );
	}
