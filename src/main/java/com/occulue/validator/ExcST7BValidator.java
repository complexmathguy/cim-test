...
//		Assert.isNull( excST7B.getExcST7BId(), "CreateExcST7BCommand identifier should be null" );
	...
	public void validate( AssignKhToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignKhToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKhToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKhFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignKhFromExcST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiaToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignKiaToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiaToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiaFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignKiaFromExcST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKlToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignKlToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKlToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKlFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignKlFromExcST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpaToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignKpaToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpaToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpaFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignKpaFromExcST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignTbToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignTbFromExcST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignTcToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignTcFromExcST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignTfToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignTfFromExcST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTgToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignTgToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTgToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTgFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignTgFromExcST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTiaToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignTiaToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTiaToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTiaFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignTiaFromExcST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTsToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignTsToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTsToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTsFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignTsFromExcST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmaxToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignVmaxToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmaxToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVmaxFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignVmaxFromExcST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVminToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignVminToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVminToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVminFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignVminFromExcST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignVrmaxToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignVrmaxFromExcST7BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "AssignVrminToExcST7BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcST7BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcST7BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST7BId(), "UnAssignVrminFromExcST7BCommand identifier should not be null" );
	}
