...
//		Assert.isNull( aCLineSegment.getACLineSegmentId(), "CreateACLineSegmentCommand identifier should be null" );
	...
	public void validate( AssignB0chToACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "AssignB0chToACLineSegmentCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignB0chToACLineSegmentCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignB0chFromACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "UnAssignB0chFromACLineSegmentCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBchToACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "AssignBchToACLineSegmentCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBchToACLineSegmentCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBchFromACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "UnAssignBchFromACLineSegmentCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignG0chToACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "AssignG0chToACLineSegmentCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignG0chToACLineSegmentCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignG0chFromACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "UnAssignG0chFromACLineSegmentCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGchToACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "AssignGchToACLineSegmentCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGchToACLineSegmentCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGchFromACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "UnAssignGchFromACLineSegmentCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRToACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "AssignRToACLineSegmentCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRToACLineSegmentCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRFromACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "UnAssignRFromACLineSegmentCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignR0ToACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "AssignR0ToACLineSegmentCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignR0ToACLineSegmentCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignR0FromACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "UnAssignR0FromACLineSegmentCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignShortCircuitEndTemperatureToACLineSegmentCommand command ) throws Exception {
		Assert.notNull( command, "AssignShortCircuitEndTemperatureToACLineSegmentCommand should not be null" );
		Assert.notNull( command.getACLineSegmentId(), "AssignShortCircuitEndTemperatureToACLineSegmentCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignShortCircuitEndTemperatureToACLineSegmentCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignShortCircuitEndTemperatureFromACLineSegmentCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignShortCircuitEndTemperatureFromACLineSegmentCommand should not be null" );
		Assert.notNull( command.getACLineSegmentId(), "UnAssignShortCircuitEndTemperatureFromACLineSegmentCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXToACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "AssignXToACLineSegmentCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXToACLineSegmentCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXFromACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "UnAssignXFromACLineSegmentCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignX0ToACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "AssignX0ToACLineSegmentCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignX0ToACLineSegmentCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignX0FromACLineSegmentCommand command ) throws Exception {
		...
		Assert.notNull( command.getACLineSegmentId(), "UnAssignX0FromACLineSegmentCommand identifier should not be null" );
	}
