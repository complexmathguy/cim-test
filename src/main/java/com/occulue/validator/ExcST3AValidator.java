...
//		Assert.isNull( excST3A.getExcST3AId(), "CreateExcST3ACommand identifier should be null" );
	...
	public void validate( AssignEfdmaxToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignEfdmaxToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdmaxToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdmaxFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignEfdmaxFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignKcToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignKcFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKgToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignKgToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKgToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKgFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignKgFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignKiToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignKiFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKjToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignKjToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKjToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKjFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignKjFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKmToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignKmToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKmToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKmFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignKmFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignKpToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignKpFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKsToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignKsToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKsToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKsFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignKsFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKs1ToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignKs1ToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKs1ToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKs1FromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignKs1FromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignTbToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignTbFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignTcToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignTcFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignThetapToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignThetapToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignThetapToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignThetapFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignThetapFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTmToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignTmToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTmToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTmFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignTmFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVbmaxToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignVbmaxToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVbmaxToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVbmaxFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignVbmaxFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVgmaxToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignVgmaxToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVgmaxToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVgmaxFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignVgmaxFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVimaxToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignVimaxToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVimaxToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVimaxFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignVimaxFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignViminToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignViminToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignViminToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignViminFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignViminFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignVrmaxToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignVrmaxFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignVrminToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignVrminFromExcST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXlToExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "AssignXlToExcST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXlToExcST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXlFromExcST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST3AId(), "UnAssignXlFromExcST3ACommand identifier should not be null" );
	}
