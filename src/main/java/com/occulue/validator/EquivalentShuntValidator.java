...
//		Assert.isNull( equivalentShunt.getEquivalentShuntId(), "CreateEquivalentShuntCommand identifier should be null" );
	...
	public void validate( AssignBToEquivalentShuntCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentShuntId(), "AssignBToEquivalentShuntCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBToEquivalentShuntCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBFromEquivalentShuntCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentShuntId(), "UnAssignBFromEquivalentShuntCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGToEquivalentShuntCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentShuntId(), "AssignGToEquivalentShuntCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGToEquivalentShuntCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGFromEquivalentShuntCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentShuntId(), "UnAssignGFromEquivalentShuntCommand identifier should not be null" );
	}
