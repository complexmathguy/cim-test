...
//		Assert.isNull( overexcitationLimiterUserDefined.getOverexcitationLimiterUserDefinedId(), "CreateOverexcitationLimiterUserDefinedCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignProprietaryToOverexcitationLimiterUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "AssignProprietaryToOverexcitationLimiterUserDefinedCommand should not be null" );
		Assert.notNull( command.getOverexcitationLimiterUserDefinedId(), "AssignProprietaryToOverexcitationLimiterUserDefinedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProprietaryToOverexcitationLimiterUserDefinedCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignProprietaryFromOverexcitationLimiterUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignProprietaryFromOverexcitationLimiterUserDefinedCommand should not be null" );
		Assert.notNull( command.getOverexcitationLimiterUserDefinedId(), "UnAssignProprietaryFromOverexcitationLimiterUserDefinedCommand identifier should not be null" );
	}
