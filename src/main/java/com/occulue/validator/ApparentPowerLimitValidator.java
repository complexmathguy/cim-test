...
//		Assert.isNull( apparentPowerLimit.getApparentPowerLimitId(), "CreateApparentPowerLimitCommand identifier should be null" );
	...
	public void validate( AssignValueToApparentPowerLimitCommand command ) throws Exception {
		...
		Assert.notNull( command.getApparentPowerLimitId(), "AssignValueToApparentPowerLimitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToApparentPowerLimitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromApparentPowerLimitCommand command ) throws Exception {
		...
		Assert.notNull( command.getApparentPowerLimitId(), "UnAssignValueFromApparentPowerLimitCommand identifier should not be null" );
	}
