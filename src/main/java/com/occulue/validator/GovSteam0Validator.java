...
//		Assert.isNull( govSteam0.getGovSteam0Id(), "CreateGovSteam0Command identifier should be null" );
	...
	public void validate( AssignDtToGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "AssignDtToGovSteam0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDtToGovSteam0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignDtFromGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "UnAssignDtFromGovSteam0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "AssignMwbaseToGovSteam0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovSteam0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "UnAssignMwbaseFromGovSteam0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRToGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "AssignRToGovSteam0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRToGovSteam0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignRFromGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "UnAssignRFromGovSteam0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "AssignT1ToGovSteam0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToGovSteam0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "UnAssignT1FromGovSteam0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "AssignT2ToGovSteam0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToGovSteam0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "UnAssignT2FromGovSteam0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "AssignT3ToGovSteam0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToGovSteam0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "UnAssignT3FromGovSteam0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmaxToGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "AssignVmaxToGovSteam0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmaxToGovSteam0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVmaxFromGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "UnAssignVmaxFromGovSteam0Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVminToGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "AssignVminToGovSteam0Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVminToGovSteam0Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVminFromGovSteam0Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam0Id(), "UnAssignVminFromGovSteam0Command identifier should not be null" );
	}
