...
//		Assert.isNull( shuntCompensator.getShuntCompensatorId(), "CreateShuntCompensatorCommand identifier should be null" );
	...
	public void validate( AssignAVRDelayToShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "AssignAVRDelayToShuntCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAVRDelayToShuntCompensatorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAVRDelayFromShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "UnAssignAVRDelayFromShuntCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGroundedToShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "AssignGroundedToShuntCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGroundedToShuntCompensatorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGroundedFromShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "UnAssignGroundedFromShuntCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMaximumSectionsToShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "AssignMaximumSectionsToShuntCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMaximumSectionsToShuntCompensatorCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignMaximumSectionsFromShuntCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignMaximumSectionsFromShuntCompensatorCommand should not be null" );
		Assert.notNull( command.getShuntCompensatorId(), "UnAssignMaximumSectionsFromShuntCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNomUToShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "AssignNomUToShuntCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNomUToShuntCompensatorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNomUFromShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "UnAssignNomUFromShuntCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNormalSectionsToShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "AssignNormalSectionsToShuntCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNormalSectionsToShuntCompensatorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNormalSectionsFromShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "UnAssignNormalSectionsFromShuntCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSwitchOnCountToShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "AssignSwitchOnCountToShuntCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSwitchOnCountToShuntCompensatorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSwitchOnCountFromShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "UnAssignSwitchOnCountFromShuntCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSwitchOnDateToShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "AssignSwitchOnDateToShuntCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSwitchOnDateToShuntCompensatorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSwitchOnDateFromShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "UnAssignSwitchOnDateFromShuntCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVoltageSensitivityToShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getShuntCompensatorId(), "AssignVoltageSensitivityToShuntCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVoltageSensitivityToShuntCompensatorCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVoltageSensitivityFromShuntCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVoltageSensitivityFromShuntCompensatorCommand should not be null" );
		Assert.notNull( command.getShuntCompensatorId(), "UnAssignVoltageSensitivityFromShuntCompensatorCommand identifier should not be null" );
	}
