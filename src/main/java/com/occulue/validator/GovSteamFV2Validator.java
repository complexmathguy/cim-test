...
//		Assert.isNull( govSteamFV2.getGovSteamFV2Id(), "CreateGovSteamFV2Command identifier should be null" );
	...
	public void validate( AssignDtToGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "AssignDtToGovSteamFV2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDtToGovSteamFV2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignDtFromGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "UnAssignDtFromGovSteamFV2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKToGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "AssignKToGovSteamFV2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKToGovSteamFV2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKFromGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "UnAssignKFromGovSteamFV2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "AssignMwbaseToGovSteamFV2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovSteamFV2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "UnAssignMwbaseFromGovSteamFV2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRToGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "AssignRToGovSteamFV2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRToGovSteamFV2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignRFromGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "UnAssignRFromGovSteamFV2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "AssignT1ToGovSteamFV2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToGovSteamFV2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "UnAssignT1FromGovSteamFV2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "AssignT3ToGovSteamFV2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToGovSteamFV2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "UnAssignT3FromGovSteamFV2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "AssignTaToGovSteamFV2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToGovSteamFV2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "UnAssignTaFromGovSteamFV2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "AssignTbToGovSteamFV2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToGovSteamFV2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "UnAssignTbFromGovSteamFV2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "AssignTcToGovSteamFV2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToGovSteamFV2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "UnAssignTcFromGovSteamFV2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTiToGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "AssignTiToGovSteamFV2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTiToGovSteamFV2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTiFromGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "UnAssignTiFromGovSteamFV2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTtToGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "AssignTtToGovSteamFV2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTtToGovSteamFV2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTtFromGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "UnAssignTtFromGovSteamFV2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmaxToGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "AssignVmaxToGovSteamFV2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmaxToGovSteamFV2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVmaxFromGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "UnAssignVmaxFromGovSteamFV2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVminToGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "AssignVminToGovSteamFV2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVminToGovSteamFV2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVminFromGovSteamFV2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV2Id(), "UnAssignVminFromGovSteamFV2Command identifier should not be null" );
	}
