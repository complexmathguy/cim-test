...
//		Assert.isNull( csConverter.getCsConverterId(), "CreateCsConverterCommand identifier should be null" );
	...
	public void validate( AssignMaxAlphaToCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "AssignMaxAlphaToCsConverterCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMaxAlphaToCsConverterCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMaxAlphaFromCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "UnAssignMaxAlphaFromCsConverterCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMaxGammaToCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "AssignMaxGammaToCsConverterCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMaxGammaToCsConverterCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMaxGammaFromCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "UnAssignMaxGammaFromCsConverterCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMaxIdcToCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "AssignMaxIdcToCsConverterCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMaxIdcToCsConverterCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMaxIdcFromCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "UnAssignMaxIdcFromCsConverterCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMinAlphaToCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "AssignMinAlphaToCsConverterCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMinAlphaToCsConverterCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMinAlphaFromCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "UnAssignMinAlphaFromCsConverterCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMinGammaToCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "AssignMinGammaToCsConverterCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMinGammaToCsConverterCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMinGammaFromCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "UnAssignMinGammaFromCsConverterCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMinIdcToCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "AssignMinIdcToCsConverterCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMinIdcToCsConverterCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMinIdcFromCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "UnAssignMinIdcFromCsConverterCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRatedIdcToCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "AssignRatedIdcToCsConverterCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRatedIdcToCsConverterCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRatedIdcFromCsConverterCommand command ) throws Exception {
		...
		Assert.notNull( command.getCsConverterId(), "UnAssignRatedIdcFromCsConverterCommand identifier should not be null" );
	}
