...
//		Assert.isNull( excIEEEAC5A.getExcIEEEAC5AId(), "CreateExcIEEEAC5ACommand identifier should be null" );
	...
	public void validate( AssignEfd1ToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignEfd1ToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd1ToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd1FromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignEfd1FromExcIEEEAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd2ToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignEfd2ToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd2ToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd2FromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignEfd2FromExcIEEEAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignKaToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignKaFromExcIEEEAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignKeToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignKeFromExcIEEEAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignKfToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignKfFromExcIEEEAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd1ToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignSeefd1ToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd1ToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd1FromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignSeefd1FromExcIEEEAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd2ToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignSeefd2ToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd2ToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd2FromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignSeefd2FromExcIEEEAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignTaToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignTaFromExcIEEEAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignTeToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignTeFromExcIEEEAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTf1ToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignTf1ToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTf1ToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTf1FromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignTf1FromExcIEEEAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTf2ToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignTf2ToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTf2ToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTf2FromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignTf2FromExcIEEEAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTf3ToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignTf3ToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTf3ToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTf3FromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignTf3FromExcIEEEAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignVrmaxToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignVrmaxFromExcIEEEAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "AssignVrminToExcIEEEAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC5AId(), "UnAssignVrminFromExcIEEEAC5ACommand identifier should not be null" );
	}
