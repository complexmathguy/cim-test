...
//		Assert.isNull( angleDegrees.getAngleDegreesId(), "CreateAngleDegreesCommand identifier should be null" );
	...
	public void validate( AssignValueToAngleDegreesCommand command ) throws Exception {
		...
		Assert.notNull( command.getAngleDegreesId(), "AssignValueToAngleDegreesCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToAngleDegreesCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromAngleDegreesCommand command ) throws Exception {
		...
		Assert.notNull( command.getAngleDegreesId(), "UnAssignValueFromAngleDegreesCommand identifier should not be null" );
	}
