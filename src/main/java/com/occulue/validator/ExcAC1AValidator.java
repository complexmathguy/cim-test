...
//		Assert.isNull( excAC1A.getExcAC1AId(), "CreateExcAC1ACommand identifier should be null" );
	...
	public void validate( AssignHvlvgatesToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignHvlvgatesToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignHvlvgatesToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignHvlvgatesFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignHvlvgatesFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignKaToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignKaFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignKcToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignKcFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignKdToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignKdFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignKeToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignKeFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignKfToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignKfFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKf1ToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignKf1ToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKf1ToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKf1FromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignKf1FromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKf2ToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignKf2ToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKf2ToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKf2FromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignKf2FromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKsToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignKsToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKsToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKsFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignKsFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve1ToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignSeve1ToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve1ToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve1FromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignSeve1FromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve2ToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignSeve2ToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve2ToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve2FromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignSeve2FromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignTaToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignTaFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignTbToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignTbFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignTcToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignTcFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignTeToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignTeFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignTfToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignTfFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVamaxToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignVamaxToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVamaxToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVamaxFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignVamaxFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaminToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignVaminToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaminToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVaminFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignVaminFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe1ToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignVe1ToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe1ToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe1FromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignVe1FromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe2ToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignVe2ToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe2ToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe2FromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignVe2FromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignVrmaxToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignVrmaxFromExcAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "AssignVrminToExcAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC1AId(), "UnAssignVrminFromExcAC1ACommand identifier should not be null" );
	}
