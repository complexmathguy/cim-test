...
//		Assert.isNull( discExcContIEEEDEC2A.getDiscExcContIEEEDEC2AId(), "CreateDiscExcContIEEEDEC2ACommand identifier should be null" );
	...
	public void validate( AssignTd1ToDiscExcContIEEEDEC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC2AId(), "AssignTd1ToDiscExcContIEEEDEC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTd1ToDiscExcContIEEEDEC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTd1FromDiscExcContIEEEDEC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC2AId(), "UnAssignTd1FromDiscExcContIEEEDEC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTd2ToDiscExcContIEEEDEC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC2AId(), "AssignTd2ToDiscExcContIEEEDEC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTd2ToDiscExcContIEEEDEC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTd2FromDiscExcContIEEEDEC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC2AId(), "UnAssignTd2FromDiscExcContIEEEDEC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVdmaxToDiscExcContIEEEDEC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC2AId(), "AssignVdmaxToDiscExcContIEEEDEC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVdmaxToDiscExcContIEEEDEC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVdmaxFromDiscExcContIEEEDEC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC2AId(), "UnAssignVdmaxFromDiscExcContIEEEDEC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVdminToDiscExcContIEEEDEC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC2AId(), "AssignVdminToDiscExcContIEEEDEC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVdminToDiscExcContIEEEDEC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVdminFromDiscExcContIEEEDEC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC2AId(), "UnAssignVdminFromDiscExcContIEEEDEC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVkToDiscExcContIEEEDEC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC2AId(), "AssignVkToDiscExcContIEEEDEC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVkToDiscExcContIEEEDEC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVkFromDiscExcContIEEEDEC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC2AId(), "UnAssignVkFromDiscExcContIEEEDEC2ACommand identifier should not be null" );
	}
