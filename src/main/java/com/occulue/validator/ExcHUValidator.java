...
//		Assert.isNull( excHU.getExcHUId(), "CreateExcHUCommand identifier should be null" );
	...
	public void validate( UnAssignAeFromExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcHUId(), "UnAssignAeFromExcHUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignAiFromExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcHUId(), "UnAssignAiFromExcHUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignAtrToExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignAtrToExcHUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAtrFromExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcHUId(), "UnAssignAtrFromExcHUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEmaxToExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignEmaxToExcHUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEmaxFromExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcHUId(), "UnAssignEmaxFromExcHUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEminToExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignEminToExcHUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEminFromExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcHUId(), "UnAssignEminFromExcHUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignImaxToExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignImaxToExcHUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignImaxFromExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcHUId(), "UnAssignImaxFromExcHUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIminToExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignIminToExcHUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIminFromExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcHUId(), "UnAssignIminFromExcHUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignKeFromExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcHUId(), "UnAssignKeFromExcHUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignKiFromExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcHUId(), "UnAssignKiFromExcHUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTeFromExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcHUId(), "UnAssignTeFromExcHUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTiFromExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcHUId(), "UnAssignTiFromExcHUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTrFromExcHUCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcHUId(), "UnAssignTrFromExcHUCommand identifier should not be null" );
	}
