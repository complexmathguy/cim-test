...
//		Assert.isNull( regularIntervalSchedule.getRegularIntervalScheduleId(), "CreateRegularIntervalScheduleCommand identifier should be null" );
	...
	public void validate( AssignEndTimeToRegularIntervalScheduleCommand command ) throws Exception {
		...
		Assert.notNull( command.getRegularIntervalScheduleId(), "AssignEndTimeToRegularIntervalScheduleCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEndTimeToRegularIntervalScheduleCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEndTimeFromRegularIntervalScheduleCommand command ) throws Exception {
		...
		Assert.notNull( command.getRegularIntervalScheduleId(), "UnAssignEndTimeFromRegularIntervalScheduleCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTimeStepToRegularIntervalScheduleCommand command ) throws Exception {
		...
		Assert.notNull( command.getRegularIntervalScheduleId(), "AssignTimeStepToRegularIntervalScheduleCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTimeStepToRegularIntervalScheduleCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignTimeStepFromRegularIntervalScheduleCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignTimeStepFromRegularIntervalScheduleCommand should not be null" );
		Assert.notNull( command.getRegularIntervalScheduleId(), "UnAssignTimeStepFromRegularIntervalScheduleCommand identifier should not be null" );
	}
