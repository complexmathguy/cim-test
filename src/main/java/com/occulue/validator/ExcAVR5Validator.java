...
//		Assert.isNull( excAVR5.getExcAVR5Id(), "CreateExcAVR5Command identifier should be null" );
	...
	public void validate( AssignKaToExcAVR5Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR5Id(), "AssignKaToExcAVR5Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcAVR5Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcAVR5Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR5Id(), "UnAssignKaFromExcAVR5Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRexToExcAVR5Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR5Id(), "AssignRexToExcAVR5Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRexToExcAVR5Command assignment should not be null" );
	}
	...
	public void validate( UnAssignRexFromExcAVR5Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR5Id(), "UnAssignRexFromExcAVR5Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcAVR5Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR5Id(), "AssignTaToExcAVR5Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcAVR5Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcAVR5Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR5Id(), "UnAssignTaFromExcAVR5Command identifier should not be null" );
	}
