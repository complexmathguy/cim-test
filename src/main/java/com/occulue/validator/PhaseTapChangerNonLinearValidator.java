...
//		Assert.isNull( phaseTapChangerNonLinear.getPhaseTapChangerNonLinearId(), "CreatePhaseTapChangerNonLinearCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignVoltageStepIncrementToPhaseTapChangerNonLinearCommand command ) throws Exception {
		Assert.notNull( command, "AssignVoltageStepIncrementToPhaseTapChangerNonLinearCommand should not be null" );
		Assert.notNull( command.getPhaseTapChangerNonLinearId(), "AssignVoltageStepIncrementToPhaseTapChangerNonLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVoltageStepIncrementToPhaseTapChangerNonLinearCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVoltageStepIncrementFromPhaseTapChangerNonLinearCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVoltageStepIncrementFromPhaseTapChangerNonLinearCommand should not be null" );
		Assert.notNull( command.getPhaseTapChangerNonLinearId(), "UnAssignVoltageStepIncrementFromPhaseTapChangerNonLinearCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXMaxToPhaseTapChangerNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getPhaseTapChangerNonLinearId(), "AssignXMaxToPhaseTapChangerNonLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXMaxToPhaseTapChangerNonLinearCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXMaxFromPhaseTapChangerNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getPhaseTapChangerNonLinearId(), "UnAssignXMaxFromPhaseTapChangerNonLinearCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXMinToPhaseTapChangerNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getPhaseTapChangerNonLinearId(), "AssignXMinToPhaseTapChangerNonLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXMinToPhaseTapChangerNonLinearCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXMinFromPhaseTapChangerNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getPhaseTapChangerNonLinearId(), "UnAssignXMinFromPhaseTapChangerNonLinearCommand identifier should not be null" );
	}
