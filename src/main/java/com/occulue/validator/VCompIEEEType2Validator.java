...
//		Assert.isNull( vCompIEEEType2.getVCompIEEEType2Id(), "CreateVCompIEEEType2Command identifier should be null" );
	...
	public void validate( AssignTrToVCompIEEEType2Command command ) throws Exception {
		...
		Assert.notNull( command.getVCompIEEEType2Id(), "AssignTrToVCompIEEEType2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTrToVCompIEEEType2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTrFromVCompIEEEType2Command command ) throws Exception {
		...
		Assert.notNull( command.getVCompIEEEType2Id(), "UnAssignTrFromVCompIEEEType2Command identifier should not be null" );
	}
