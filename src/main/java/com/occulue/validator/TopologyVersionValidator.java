...
//		Assert.isNull( topologyVersion.getTopologyVersionId(), "CreateTopologyVersionCommand identifier should be null" );
	...
	public void validate( AssignBaseUMLToTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "AssignBaseUMLToTopologyVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBaseUMLToTopologyVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBaseUMLFromTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "UnAssignBaseUMLFromTopologyVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBaseURIToTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "AssignBaseURIToTopologyVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBaseURIToTopologyVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBaseURIFromTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "UnAssignBaseURIFromTopologyVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDateToTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "AssignDateToTopologyVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDateToTopologyVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDateFromTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "UnAssignDateFromTopologyVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDifferenceModelURIToTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "AssignDifferenceModelURIToTopologyVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDifferenceModelURIToTopologyVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignDifferenceModelURIFromTopologyVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignDifferenceModelURIFromTopologyVersionCommand should not be null" );
		Assert.notNull( command.getTopologyVersionId(), "UnAssignDifferenceModelURIFromTopologyVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEntsoeUMLToTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "AssignEntsoeUMLToTopologyVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEntsoeUMLToTopologyVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEntsoeUMLFromTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "UnAssignEntsoeUMLFromTopologyVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEntsoeURIToTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "AssignEntsoeURIToTopologyVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEntsoeURIToTopologyVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEntsoeURIFromTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "UnAssignEntsoeURIFromTopologyVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignModelDescriptionURIToTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "AssignModelDescriptionURIToTopologyVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignModelDescriptionURIToTopologyVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignModelDescriptionURIFromTopologyVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignModelDescriptionURIFromTopologyVersionCommand should not be null" );
		Assert.notNull( command.getTopologyVersionId(), "UnAssignModelDescriptionURIFromTopologyVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNamespaceRDFToTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "AssignNamespaceRDFToTopologyVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNamespaceRDFToTopologyVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNamespaceRDFFromTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "UnAssignNamespaceRDFFromTopologyVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNamespaceUMLToTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "AssignNamespaceUMLToTopologyVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNamespaceUMLToTopologyVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNamespaceUMLFromTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "UnAssignNamespaceUMLFromTopologyVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignShortNameToTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "AssignShortNameToTopologyVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignShortNameToTopologyVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignShortNameFromTopologyVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getTopologyVersionId(), "UnAssignShortNameFromTopologyVersionCommand identifier should not be null" );
	}
