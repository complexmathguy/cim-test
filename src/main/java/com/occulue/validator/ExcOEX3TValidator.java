...
//		Assert.isNull( excOEX3T.getExcOEX3TId(), "CreateExcOEX3TCommand identifier should be null" );
	...
	public void validate( AssignE1ToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignE1ToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignE1ToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignE1FromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignE1FromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignE2ToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignE2ToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignE2ToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignE2FromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignE2FromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignKaToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignKaFromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignKcToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignKcFromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignKdToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignKdFromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignKeToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignKeFromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignKfToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignKfFromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSee1ToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignSee1ToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSee1ToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSee1FromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignSee1FromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSee2ToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignSee2ToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSee2ToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSee2FromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignSee2FromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignT1ToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignT1FromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignT2ToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignT2FromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignT3ToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignT3FromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignT4ToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4ToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignT4FromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT5ToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignT5ToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT5ToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT5FromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignT5FromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT6ToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignT6ToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT6ToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT6FromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignT6FromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignTeToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignTeFromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignTfToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignTfFromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignVrmaxToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignVrmaxFromExcOEX3TCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "AssignVrminToExcOEX3TCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcOEX3TCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcOEX3TCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcOEX3TId(), "UnAssignVrminFromExcOEX3TCommand identifier should not be null" );
	}
