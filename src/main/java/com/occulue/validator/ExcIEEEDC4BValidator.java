...
//		Assert.isNull( excIEEEDC4B.getExcIEEEDC4BId(), "CreateExcIEEEDC4BCommand identifier should be null" );
	...
	public void validate( AssignEfd1ToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignEfd1ToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd1ToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd1FromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignEfd1FromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd2ToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignEfd2ToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd2ToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd2FromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignEfd2FromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignKaToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignKaFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignKdToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignKdFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignKeToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignKeFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignKfToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignKfFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignKiToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignKiFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignKpToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignKpFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignOelinToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignOelinToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignOelinToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignOelinFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignOelinFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd1ToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignSeefd1ToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd1ToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd1FromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignSeefd1FromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd2ToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignSeefd2ToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd2ToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd2FromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignSeefd2FromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignTaToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignTaFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTdToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignTdToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTdToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTdFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignTdFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignTeToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignTeFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignTfToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignTfFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUelinToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignUelinToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUelinToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUelinFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignUelinFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVeminToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignVeminToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVeminToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVeminFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignVeminFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignVrmaxToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignVrmaxFromExcIEEEDC4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "AssignVrminToExcIEEEDC4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEDC4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEDC4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC4BId(), "UnAssignVrminFromExcIEEEDC4BCommand identifier should not be null" );
	}
