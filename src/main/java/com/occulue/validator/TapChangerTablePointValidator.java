...
//		Assert.isNull( tapChangerTablePoint.getTapChangerTablePointId(), "CreateTapChangerTablePointCommand identifier should be null" );
	...
	public void validate( AssignBToTapChangerTablePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerTablePointId(), "AssignBToTapChangerTablePointCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBToTapChangerTablePointCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBFromTapChangerTablePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerTablePointId(), "UnAssignBFromTapChangerTablePointCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGToTapChangerTablePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerTablePointId(), "AssignGToTapChangerTablePointCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGToTapChangerTablePointCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGFromTapChangerTablePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerTablePointId(), "UnAssignGFromTapChangerTablePointCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRToTapChangerTablePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerTablePointId(), "AssignRToTapChangerTablePointCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRToTapChangerTablePointCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRFromTapChangerTablePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerTablePointId(), "UnAssignRFromTapChangerTablePointCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRatioToTapChangerTablePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerTablePointId(), "AssignRatioToTapChangerTablePointCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRatioToTapChangerTablePointCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRatioFromTapChangerTablePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerTablePointId(), "UnAssignRatioFromTapChangerTablePointCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignStepToTapChangerTablePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerTablePointId(), "AssignStepToTapChangerTablePointCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignStepToTapChangerTablePointCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignStepFromTapChangerTablePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerTablePointId(), "UnAssignStepFromTapChangerTablePointCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXToTapChangerTablePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerTablePointId(), "AssignXToTapChangerTablePointCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXToTapChangerTablePointCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXFromTapChangerTablePointCommand command ) throws Exception {
		...
		Assert.notNull( command.getTapChangerTablePointId(), "UnAssignXFromTapChangerTablePointCommand identifier should not be null" );
	}
