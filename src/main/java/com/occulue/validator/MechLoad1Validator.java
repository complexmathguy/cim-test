...
//		Assert.isNull( mechLoad1.getMechLoad1Id(), "CreateMechLoad1Command identifier should be null" );
	...
	public void validate( AssignAToMechLoad1Command command ) throws Exception {
		...
		Assert.notNull( command.getMechLoad1Id(), "AssignAToMechLoad1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAToMechLoad1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignAFromMechLoad1Command command ) throws Exception {
		...
		Assert.notNull( command.getMechLoad1Id(), "UnAssignAFromMechLoad1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBToMechLoad1Command command ) throws Exception {
		...
		Assert.notNull( command.getMechLoad1Id(), "AssignBToMechLoad1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBToMechLoad1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignBFromMechLoad1Command command ) throws Exception {
		...
		Assert.notNull( command.getMechLoad1Id(), "UnAssignBFromMechLoad1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDToMechLoad1Command command ) throws Exception {
		...
		Assert.notNull( command.getMechLoad1Id(), "AssignDToMechLoad1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDToMechLoad1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignDFromMechLoad1Command command ) throws Exception {
		...
		Assert.notNull( command.getMechLoad1Id(), "UnAssignDFromMechLoad1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEToMechLoad1Command command ) throws Exception {
		...
		Assert.notNull( command.getMechLoad1Id(), "AssignEToMechLoad1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEToMechLoad1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEFromMechLoad1Command command ) throws Exception {
		...
		Assert.notNull( command.getMechLoad1Id(), "UnAssignEFromMechLoad1Command identifier should not be null" );
	}
