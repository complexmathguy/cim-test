...
//		Assert.isNull( diagramLayoutVersion.getDiagramLayoutVersionId(), "CreateDiagramLayoutVersionCommand identifier should be null" );
	...
	public void validate( AssignBaseUMLToDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "AssignBaseUMLToDiagramLayoutVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBaseUMLToDiagramLayoutVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBaseUMLFromDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "UnAssignBaseUMLFromDiagramLayoutVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBaseURIToDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "AssignBaseURIToDiagramLayoutVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBaseURIToDiagramLayoutVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBaseURIFromDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "UnAssignBaseURIFromDiagramLayoutVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDateToDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "AssignDateToDiagramLayoutVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDateToDiagramLayoutVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDateFromDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "UnAssignDateFromDiagramLayoutVersionCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignDifferenceModelURIToDiagramLayoutVersionCommand command ) throws Exception {
		Assert.notNull( command, "AssignDifferenceModelURIToDiagramLayoutVersionCommand should not be null" );
		Assert.notNull( command.getDiagramLayoutVersionId(), "AssignDifferenceModelURIToDiagramLayoutVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDifferenceModelURIToDiagramLayoutVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignDifferenceModelURIFromDiagramLayoutVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignDifferenceModelURIFromDiagramLayoutVersionCommand should not be null" );
		Assert.notNull( command.getDiagramLayoutVersionId(), "UnAssignDifferenceModelURIFromDiagramLayoutVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEntsoeUMLToDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "AssignEntsoeUMLToDiagramLayoutVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEntsoeUMLToDiagramLayoutVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEntsoeUMLFromDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "UnAssignEntsoeUMLFromDiagramLayoutVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEntsoeURIToDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "AssignEntsoeURIToDiagramLayoutVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEntsoeURIToDiagramLayoutVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEntsoeURIFromDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "UnAssignEntsoeURIFromDiagramLayoutVersionCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignModelDescriptionURIToDiagramLayoutVersionCommand command ) throws Exception {
		Assert.notNull( command, "AssignModelDescriptionURIToDiagramLayoutVersionCommand should not be null" );
		Assert.notNull( command.getDiagramLayoutVersionId(), "AssignModelDescriptionURIToDiagramLayoutVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignModelDescriptionURIToDiagramLayoutVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignModelDescriptionURIFromDiagramLayoutVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignModelDescriptionURIFromDiagramLayoutVersionCommand should not be null" );
		Assert.notNull( command.getDiagramLayoutVersionId(), "UnAssignModelDescriptionURIFromDiagramLayoutVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNamespaceRDFToDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "AssignNamespaceRDFToDiagramLayoutVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNamespaceRDFToDiagramLayoutVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignNamespaceRDFFromDiagramLayoutVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignNamespaceRDFFromDiagramLayoutVersionCommand should not be null" );
		Assert.notNull( command.getDiagramLayoutVersionId(), "UnAssignNamespaceRDFFromDiagramLayoutVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNamespaceUMLToDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "AssignNamespaceUMLToDiagramLayoutVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNamespaceUMLToDiagramLayoutVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignNamespaceUMLFromDiagramLayoutVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignNamespaceUMLFromDiagramLayoutVersionCommand should not be null" );
		Assert.notNull( command.getDiagramLayoutVersionId(), "UnAssignNamespaceUMLFromDiagramLayoutVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignShortNameToDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "AssignShortNameToDiagramLayoutVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignShortNameToDiagramLayoutVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignShortNameFromDiagramLayoutVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDiagramLayoutVersionId(), "UnAssignShortNameFromDiagramLayoutVersionCommand identifier should not be null" );
	}
