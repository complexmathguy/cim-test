...
//		Assert.isNull( excIEEEST5B.getExcIEEEST5BId(), "CreateExcIEEEST5BCommand identifier should be null" );
	...
	public void validate( AssignKcToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignKcToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignKcFromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKrToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignKrToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKrToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKrFromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignKrFromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignT1ToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignT1FromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTb1ToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignTb1ToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTb1ToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTb1FromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignTb1FromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTb2ToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignTb2ToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTb2ToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTb2FromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignTb2FromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTc1ToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignTc1ToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTc1ToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTc1FromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignTc1FromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTc2ToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignTc2ToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTc2ToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTc2FromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignTc2FromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTob1ToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignTob1ToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTob1ToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTob1FromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignTob1FromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTob2ToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignTob2ToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTob2ToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTob2FromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignTob2FromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignToc1ToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignToc1ToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignToc1ToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignToc1FromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignToc1FromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignToc2ToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignToc2ToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignToc2ToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignToc2FromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignToc2FromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTub1ToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignTub1ToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTub1ToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTub1FromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignTub1FromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTub2ToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignTub2ToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTub2ToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTub2FromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignTub2FromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTuc1ToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignTuc1ToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTuc1ToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTuc1FromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignTuc1FromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTuc2ToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignTuc2ToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTuc2ToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTuc2FromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignTuc2FromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignVrmaxToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignVrmaxFromExcIEEEST5BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "AssignVrminToExcIEEEST5BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEST5BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEST5BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST5BId(), "UnAssignVrminFromExcIEEEST5BCommand identifier should not be null" );
	}
