...
//		Assert.isNull( underexcitationLimiterUserDefined.getUnderexcitationLimiterUserDefinedId(), "CreateUnderexcitationLimiterUserDefinedCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignProprietaryToUnderexcitationLimiterUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "AssignProprietaryToUnderexcitationLimiterUserDefinedCommand should not be null" );
		Assert.notNull( command.getUnderexcitationLimiterUserDefinedId(), "AssignProprietaryToUnderexcitationLimiterUserDefinedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProprietaryToUnderexcitationLimiterUserDefinedCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignProprietaryFromUnderexcitationLimiterUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignProprietaryFromUnderexcitationLimiterUserDefinedCommand should not be null" );
		Assert.notNull( command.getUnderexcitationLimiterUserDefinedId(), "UnAssignProprietaryFromUnderexcitationLimiterUserDefinedCommand identifier should not be null" );
	}
