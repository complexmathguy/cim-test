...
//		Assert.isNull( reactivePower.getReactivePowerId(), "CreateReactivePowerCommand identifier should be null" );
	...
	public void validate( AssignValueToReactivePowerCommand command ) throws Exception {
		...
		Assert.notNull( command.getReactivePowerId(), "AssignValueToReactivePowerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToReactivePowerCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromReactivePowerCommand command ) throws Exception {
		...
		Assert.notNull( command.getReactivePowerId(), "UnAssignValueFromReactivePowerCommand identifier should not be null" );
	}
