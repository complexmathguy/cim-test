...
//		Assert.isNull( overexcLimIEEE.getOverexcLimIEEEId(), "CreateOverexcLimIEEECommand identifier should be null" );
	...
	public void validate( AssignHystToOverexcLimIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimIEEEId(), "AssignHystToOverexcLimIEEECommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignHystToOverexcLimIEEECommand assignment should not be null" );
	}
	...
	public void validate( UnAssignHystFromOverexcLimIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimIEEEId(), "UnAssignHystFromOverexcLimIEEECommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIfdlimToOverexcLimIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimIEEEId(), "AssignIfdlimToOverexcLimIEEECommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIfdlimToOverexcLimIEEECommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIfdlimFromOverexcLimIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimIEEEId(), "UnAssignIfdlimFromOverexcLimIEEECommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIfdmaxToOverexcLimIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimIEEEId(), "AssignIfdmaxToOverexcLimIEEECommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIfdmaxToOverexcLimIEEECommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIfdmaxFromOverexcLimIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimIEEEId(), "UnAssignIfdmaxFromOverexcLimIEEECommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignItfpuToOverexcLimIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimIEEEId(), "AssignItfpuToOverexcLimIEEECommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignItfpuToOverexcLimIEEECommand assignment should not be null" );
	}
	...
	public void validate( UnAssignItfpuFromOverexcLimIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimIEEEId(), "UnAssignItfpuFromOverexcLimIEEECommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcdToOverexcLimIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimIEEEId(), "AssignKcdToOverexcLimIEEECommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcdToOverexcLimIEEECommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcdFromOverexcLimIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimIEEEId(), "UnAssignKcdFromOverexcLimIEEECommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKrampToOverexcLimIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimIEEEId(), "AssignKrampToOverexcLimIEEECommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKrampToOverexcLimIEEECommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKrampFromOverexcLimIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimIEEEId(), "UnAssignKrampFromOverexcLimIEEECommand identifier should not be null" );
	}
