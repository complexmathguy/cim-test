...
//		Assert.isNull( loadComposite.getLoadCompositeId(), "CreateLoadCompositeCommand identifier should be null" );
	...
	public void validate( AssignEpfdToLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "AssignEpfdToLoadCompositeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEpfdToLoadCompositeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEpfdFromLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "UnAssignEpfdFromLoadCompositeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEpfsToLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "AssignEpfsToLoadCompositeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEpfsToLoadCompositeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEpfsFromLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "UnAssignEpfsFromLoadCompositeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEpvdToLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "AssignEpvdToLoadCompositeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEpvdToLoadCompositeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEpvdFromLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "UnAssignEpvdFromLoadCompositeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEpvsToLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "AssignEpvsToLoadCompositeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEpvsToLoadCompositeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEpvsFromLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "UnAssignEpvsFromLoadCompositeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEqfdToLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "AssignEqfdToLoadCompositeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEqfdToLoadCompositeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEqfdFromLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "UnAssignEqfdFromLoadCompositeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEqfsToLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "AssignEqfsToLoadCompositeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEqfsToLoadCompositeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEqfsFromLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "UnAssignEqfsFromLoadCompositeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEqvdToLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "AssignEqvdToLoadCompositeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEqvdToLoadCompositeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEqvdFromLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "UnAssignEqvdFromLoadCompositeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEqvsToLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "AssignEqvsToLoadCompositeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEqvsToLoadCompositeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEqvsFromLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "UnAssignEqvsFromLoadCompositeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignHToLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "AssignHToLoadCompositeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignHToLoadCompositeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignHFromLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "UnAssignHFromLoadCompositeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignLfracToLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "AssignLfracToLoadCompositeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLfracToLoadCompositeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLfracFromLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "UnAssignLfracFromLoadCompositeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPfracToLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "AssignPfracToLoadCompositeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPfracToLoadCompositeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPfracFromLoadCompositeCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadCompositeId(), "UnAssignPfracFromLoadCompositeCommand identifier should not be null" );
	}
