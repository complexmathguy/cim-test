...
//		Assert.isNull( switchIt.getSwitchItId(), "CreateSwitchItCommand identifier should be null" );
	...
	public void validate( AssignOpenToSwitchItCommand command ) throws Exception {
		...
		Assert.notNull( command.getSwitchItId(), "AssignOpenToSwitchItCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignOpenToSwitchItCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignOpenFromSwitchItCommand command ) throws Exception {
		...
		Assert.notNull( command.getSwitchItId(), "UnAssignOpenFromSwitchItCommand identifier should not be null" );
	}
