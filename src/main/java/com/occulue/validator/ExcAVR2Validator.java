...
//		Assert.isNull( excAVR2.getExcAVR2Id(), "CreateExcAVR2Command identifier should be null" );
	...
	public void validate( AssignE1ToExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "AssignE1ToExcAVR2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignE1ToExcAVR2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignE1FromExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "UnAssignE1FromExcAVR2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignE2ToExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "AssignE2ToExcAVR2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignE2ToExcAVR2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignE2FromExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "UnAssignE2FromExcAVR2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "AssignKaToExcAVR2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcAVR2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "UnAssignKaFromExcAVR2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "AssignKfToExcAVR2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcAVR2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "UnAssignKfFromExcAVR2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSe1ToExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "AssignSe1ToExcAVR2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSe1ToExcAVR2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignSe1FromExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "UnAssignSe1FromExcAVR2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSe2ToExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "AssignSe2ToExcAVR2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSe2ToExcAVR2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignSe2FromExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "UnAssignSe2FromExcAVR2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "AssignTaToExcAVR2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcAVR2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "UnAssignTaFromExcAVR2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "AssignTbToExcAVR2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcAVR2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "UnAssignTbFromExcAVR2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "AssignTeToExcAVR2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcAVR2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "UnAssignTeFromExcAVR2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTf1ToExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "AssignTf1ToExcAVR2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTf1ToExcAVR2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTf1FromExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "UnAssignTf1FromExcAVR2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTf2ToExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "AssignTf2ToExcAVR2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTf2ToExcAVR2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTf2FromExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "UnAssignTf2FromExcAVR2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmnToExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "AssignVrmnToExcAVR2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmnToExcAVR2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmnFromExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "UnAssignVrmnFromExcAVR2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmxToExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "AssignVrmxToExcAVR2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmxToExcAVR2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmxFromExcAVR2Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR2Id(), "UnAssignVrmxFromExcAVR2Command identifier should not be null" );
	}
