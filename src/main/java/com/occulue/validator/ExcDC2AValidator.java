...
//		Assert.isNull( excDC2A.getExcDC2AId(), "CreateExcDC2ACommand identifier should be null" );
	...
	public void validate( AssignEfd1ToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignEfd1ToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd1ToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd1FromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignEfd1FromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd2ToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignEfd2ToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd2ToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd2FromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignEfd2FromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignExclimToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignExclimToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExclimToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignExclimFromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignExclimFromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignKaToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignKaFromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignKeToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignKeFromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignKfToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignKfFromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKsToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignKsToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKsToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKsFromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignKsFromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd1ToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignSeefd1ToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd1ToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd1FromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignSeefd1FromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd2ToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignSeefd2ToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd2ToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd2FromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignSeefd2FromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignTaToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignTaFromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignTbToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignTbFromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignTcToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignTcFromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignTeToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignTeFromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignTfToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignTfFromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTf1ToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignTf1ToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTf1ToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTf1FromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignTf1FromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignVrmaxToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignVrmaxFromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignVrminToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignVrminFromExcDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVtlimToExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "AssignVtlimToExcDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVtlimToExcDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVtlimFromExcDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC2AId(), "UnAssignVtlimFromExcDC2ACommand identifier should not be null" );
	}
