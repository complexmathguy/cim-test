...
//		Assert.isNull( connectivityNode.getConnectivityNodeId(), "CreateConnectivityNodeCommand identifier should be null" );
	...
	public void validate( AssignBoundaryPointToConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "AssignBoundaryPointToConnectivityNodeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBoundaryPointToConnectivityNodeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBoundaryPointFromConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "UnAssignBoundaryPointFromConnectivityNodeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignFromEndIsoCodeToConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "AssignFromEndIsoCodeToConnectivityNodeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFromEndIsoCodeToConnectivityNodeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignFromEndIsoCodeFromConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "UnAssignFromEndIsoCodeFromConnectivityNodeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignFromEndNameToConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "AssignFromEndNameToConnectivityNodeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFromEndNameToConnectivityNodeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignFromEndNameFromConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "UnAssignFromEndNameFromConnectivityNodeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignFromEndNameTsoToConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "AssignFromEndNameTsoToConnectivityNodeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFromEndNameTsoToConnectivityNodeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignFromEndNameTsoFromConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "UnAssignFromEndNameTsoFromConnectivityNodeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignToEndIsoCodeToConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "AssignToEndIsoCodeToConnectivityNodeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignToEndIsoCodeToConnectivityNodeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignToEndIsoCodeFromConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "UnAssignToEndIsoCodeFromConnectivityNodeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignToEndNameToConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "AssignToEndNameToConnectivityNodeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignToEndNameToConnectivityNodeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignToEndNameFromConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "UnAssignToEndNameFromConnectivityNodeCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignToEndNameTsoToConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "AssignToEndNameTsoToConnectivityNodeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignToEndNameTsoToConnectivityNodeCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignToEndNameTsoFromConnectivityNodeCommand command ) throws Exception {
		...
		Assert.notNull( command.getConnectivityNodeId(), "UnAssignToEndNameTsoFromConnectivityNodeCommand identifier should not be null" );
	}
