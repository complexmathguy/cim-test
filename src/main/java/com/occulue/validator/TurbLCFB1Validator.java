...
//		Assert.isNull( turbLCFB1.getTurbLCFB1Id(), "CreateTurbLCFB1Command identifier should be null" );
	...
	public void validate( AssignDbToTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "AssignDbToTurbLCFB1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDbToTurbLCFB1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignDbFromTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "UnAssignDbFromTurbLCFB1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEmaxToTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "AssignEmaxToTurbLCFB1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEmaxToTurbLCFB1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEmaxFromTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "UnAssignEmaxFromTurbLCFB1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignFbToTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "AssignFbToTurbLCFB1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFbToTurbLCFB1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignFbFromTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "UnAssignFbFromTurbLCFB1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignFbfToTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "AssignFbfToTurbLCFB1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFbfToTurbLCFB1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignFbfFromTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "UnAssignFbfFromTurbLCFB1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIrmaxToTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "AssignIrmaxToTurbLCFB1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIrmaxToTurbLCFB1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignIrmaxFromTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "UnAssignIrmaxFromTurbLCFB1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "AssignKiToTurbLCFB1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToTurbLCFB1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "UnAssignKiFromTurbLCFB1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "AssignKpToTurbLCFB1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToTurbLCFB1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "UnAssignKpFromTurbLCFB1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "AssignMwbaseToTurbLCFB1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToTurbLCFB1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "UnAssignMwbaseFromTurbLCFB1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPbfToTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "AssignPbfToTurbLCFB1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPbfToTurbLCFB1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPbfFromTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "UnAssignPbfFromTurbLCFB1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPmwsetToTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "AssignPmwsetToTurbLCFB1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPmwsetToTurbLCFB1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPmwsetFromTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "UnAssignPmwsetFromTurbLCFB1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSpeedReferenceGovernorToTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "AssignSpeedReferenceGovernorToTurbLCFB1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSpeedReferenceGovernorToTurbLCFB1Command assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignSpeedReferenceGovernorFromTurbLCFB1Command command ) throws Exception {
		Assert.notNull( command, "UnAssignSpeedReferenceGovernorFromTurbLCFB1Command should not be null" );
		Assert.notNull( command.getTurbLCFB1Id(), "UnAssignSpeedReferenceGovernorFromTurbLCFB1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpelecToTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "AssignTpelecToTurbLCFB1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpelecToTurbLCFB1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTpelecFromTurbLCFB1Command command ) throws Exception {
		...
		Assert.notNull( command.getTurbLCFB1Id(), "UnAssignTpelecFromTurbLCFB1Command identifier should not be null" );
	}
