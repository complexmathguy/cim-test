...
//		Assert.isNull( voltageLimit.getVoltageLimitId(), "CreateVoltageLimitCommand identifier should be null" );
	...
	public void validate( AssignValueToVoltageLimitCommand command ) throws Exception {
		...
		Assert.notNull( command.getVoltageLimitId(), "AssignValueToVoltageLimitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToVoltageLimitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromVoltageLimitCommand command ) throws Exception {
		...
		Assert.notNull( command.getVoltageLimitId(), "UnAssignValueFromVoltageLimitCommand identifier should not be null" );
	}
