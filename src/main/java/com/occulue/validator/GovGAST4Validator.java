...
//		Assert.isNull( govGAST4.getGovGAST4Id(), "CreateGovGAST4Command identifier should be null" );
	...
	public void validate( AssignBpToGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "AssignBpToGovGAST4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBpToGovGAST4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignBpFromGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "UnAssignBpFromGovGAST4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKtmToGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "AssignKtmToGovGAST4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKtmToGovGAST4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKtmFromGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "UnAssignKtmFromGovGAST4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMnefToGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "AssignMnefToGovGAST4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMnefToGovGAST4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMnefFromGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "UnAssignMnefFromGovGAST4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMxefToGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "AssignMxefToGovGAST4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMxefToGovGAST4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMxefFromGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "UnAssignMxefFromGovGAST4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRymnToGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "AssignRymnToGovGAST4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRymnToGovGAST4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignRymnFromGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "UnAssignRymnFromGovGAST4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRymxToGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "AssignRymxToGovGAST4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRymxToGovGAST4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignRymxFromGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "UnAssignRymxFromGovGAST4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "AssignTaToGovGAST4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToGovGAST4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "UnAssignTaFromGovGAST4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "AssignTcToGovGAST4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToGovGAST4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "UnAssignTcFromGovGAST4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcmToGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "AssignTcmToGovGAST4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcmToGovGAST4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTcmFromGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "UnAssignTcmFromGovGAST4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTmToGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "AssignTmToGovGAST4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTmToGovGAST4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTmFromGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "UnAssignTmFromGovGAST4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTvToGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "AssignTvToGovGAST4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTvToGovGAST4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTvFromGovGAST4Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST4Id(), "UnAssignTvFromGovGAST4Command identifier should not be null" );
	}
