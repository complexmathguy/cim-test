...
//		Assert.isNull( govSteamSGO.getGovSteamSGOId(), "CreateGovSteamSGOCommand identifier should be null" );
	...
	public void validate( AssignK1ToGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "AssignK1ToGovSteamSGOCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK1ToGovSteamSGOCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK1FromGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "UnAssignK1FromGovSteamSGOCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK2ToGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "AssignK2ToGovSteamSGOCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK2ToGovSteamSGOCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK2FromGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "UnAssignK2FromGovSteamSGOCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK3ToGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "AssignK3ToGovSteamSGOCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK3ToGovSteamSGOCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK3FromGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "UnAssignK3FromGovSteamSGOCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "AssignMwbaseToGovSteamSGOCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovSteamSGOCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "UnAssignMwbaseFromGovSteamSGOCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPmaxToGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "AssignPmaxToGovSteamSGOCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPmaxToGovSteamSGOCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPmaxFromGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "UnAssignPmaxFromGovSteamSGOCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPminToGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "AssignPminToGovSteamSGOCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPminToGovSteamSGOCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPminFromGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "UnAssignPminFromGovSteamSGOCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "AssignT1ToGovSteamSGOCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToGovSteamSGOCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "UnAssignT1FromGovSteamSGOCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "AssignT2ToGovSteamSGOCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToGovSteamSGOCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "UnAssignT2FromGovSteamSGOCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "AssignT3ToGovSteamSGOCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToGovSteamSGOCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "UnAssignT3FromGovSteamSGOCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "AssignT4ToGovSteamSGOCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4ToGovSteamSGOCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "UnAssignT4FromGovSteamSGOCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT5ToGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "AssignT5ToGovSteamSGOCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT5ToGovSteamSGOCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT5FromGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "UnAssignT5FromGovSteamSGOCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT6ToGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "AssignT6ToGovSteamSGOCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT6ToGovSteamSGOCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT6FromGovSteamSGOCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamSGOId(), "UnAssignT6FromGovSteamSGOCommand identifier should not be null" );
	}
