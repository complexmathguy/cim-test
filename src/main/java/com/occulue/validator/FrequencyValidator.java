...
//		Assert.isNull( frequency.getFrequencyId(), "CreateFrequencyCommand identifier should be null" );
	...
	public void validate( AssignValueToFrequencyCommand command ) throws Exception {
		...
		Assert.notNull( command.getFrequencyId(), "AssignValueToFrequencyCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToFrequencyCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromFrequencyCommand command ) throws Exception {
		...
		Assert.notNull( command.getFrequencyId(), "UnAssignValueFromFrequencyCommand identifier should not be null" );
	}
