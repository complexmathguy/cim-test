...
//		Assert.isNull( excST6B.getExcST6BId(), "CreateExcST6BCommand identifier should be null" );
	...
	public void validate( AssignIlrToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignIlrToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIlrToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIlrFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignIlrFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK1ToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignK1ToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK1ToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK1FromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignK1FromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKclToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignKclToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKclToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKclFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignKclFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKffToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignKffToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKffToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKffFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignKffFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKgToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignKgToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKgToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKgFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignKgFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiaToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignKiaToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiaToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiaFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignKiaFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKlrToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignKlrToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKlrToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKlrFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignKlrFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKmToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignKmToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKmToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKmFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignKmFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpaToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignKpaToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpaToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpaFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignKpaFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKvdToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignKvdToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKvdToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKvdFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignKvdFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTgToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignTgToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTgToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTgFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignTgFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTsToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignTsToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTsToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTsFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignTsFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTvdToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignTvdToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTvdToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTvdFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignTvdFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVamaxToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignVamaxToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVamaxToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVamaxFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignVamaxFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaminToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignVaminToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaminToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVaminFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignVaminFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVilimToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignVilimToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVilimToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVilimFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignVilimFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVimaxToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignVimaxToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVimaxToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVimaxFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignVimaxFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignViminToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignViminToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignViminToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignViminFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignViminFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmultToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignVmultToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmultToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVmultFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignVmultFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignVrmaxToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignVrmaxFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignVrminToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignVrminFromExcST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXcToExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "AssignXcToExcST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXcToExcST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXcFromExcST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST6BId(), "UnAssignXcFromExcST6BCommand identifier should not be null" );
	}
