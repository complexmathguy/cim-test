...
//		Assert.isNull( windContRotorRIEC.getWindContRotorRIECId(), "CreateWindContRotorRIECCommand identifier should be null" );
	...
	public void validate( AssignKirrToWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "AssignKirrToWindContRotorRIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKirrToWindContRotorRIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKirrFromWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "UnAssignKirrFromWindContRotorRIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKomegafiltToWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "AssignKomegafiltToWindContRotorRIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKomegafiltToWindContRotorRIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKomegafiltFromWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "UnAssignKomegafiltFromWindContRotorRIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpfiltToWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "AssignKpfiltToWindContRotorRIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpfiltToWindContRotorRIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpfiltFromWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "UnAssignKpfiltFromWindContRotorRIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKprrToWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "AssignKprrToWindContRotorRIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKprrToWindContRotorRIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKprrFromWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "UnAssignKprrFromWindContRotorRIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRmaxToWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "AssignRmaxToWindContRotorRIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRmaxToWindContRotorRIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRmaxFromWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "UnAssignRmaxFromWindContRotorRIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRminToWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "AssignRminToWindContRotorRIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRminToWindContRotorRIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRminFromWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "UnAssignRminFromWindContRotorRIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTomegafiltToWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "AssignTomegafiltToWindContRotorRIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTomegafiltToWindContRotorRIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTomegafiltFromWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "UnAssignTomegafiltFromWindContRotorRIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpfiltToWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "AssignTpfiltToWindContRotorRIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpfiltToWindContRotorRIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTpfiltFromWindContRotorRIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContRotorRIECId(), "UnAssignTpfiltFromWindContRotorRIECCommand identifier should not be null" );
	}
