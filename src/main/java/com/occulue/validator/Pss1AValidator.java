...
//		Assert.isNull( pss1A.getPss1AId(), "CreatePss1ACommand identifier should be null" );
	...
	public void validate( UnAssignA1FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignA1FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignA2FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignA2FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignA3FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignA3FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignA4FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignA4FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignA5FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignA5FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignA6FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignA6FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignA7FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignA7FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignA8FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignA8FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignKdFromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignKdFromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignKsFromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignKsFromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT1FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignT1FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT2FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignT2FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT3FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignT3FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT4FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignT4FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT5FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignT5FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT6FromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignT6FromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTdelayToPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "AssignTdelayToPss1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTdelayToPss1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTdelayFromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignTdelayFromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVclToPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVclToPss1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVclFromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignVclFromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVcuToPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVcuToPss1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVcuFromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignVcuFromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVrmaxToPss1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignVrmaxFromPss1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVrminToPss1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromPss1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPss1AId(), "UnAssignVrminFromPss1ACommand identifier should not be null" );
	}
