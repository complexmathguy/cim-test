...
//		Assert.isNull( excSK.getExcSKId(), "CreateExcSKCommand identifier should be null" );
	...
	public void validate( AssignEfdmaxToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "AssignEfdmaxToExcSKCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdmaxToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdmaxFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignEfdmaxFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfdminToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "AssignEfdminToExcSKCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdminToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdminFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignEfdminFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEmaxToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignEmaxToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEmaxFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignEmaxFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEminToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignEminToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEminFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignEminFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignK1FromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignK1FromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignK2FromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignK2FromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignKcFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignKcFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKceToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKceToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKceFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignKceFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignKdFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignKdFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKgobToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKgobToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKgobFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignKgobFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignKpFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignKpFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKqiToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKqiToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKqiFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignKqiFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKqobToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKqobToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKqobFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignKqobFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKqpToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKqpToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKqpFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignKqpFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignNqFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignNqFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQconoffToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "AssignQconoffToExcSKCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQconoffToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignQconoffFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignQconoffFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignQzFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignQzFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRemoteToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "AssignRemoteToExcSKCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRemoteToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRemoteFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignRemoteFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSbaseToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignSbaseToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSbaseFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignSbaseFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTcFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignTcFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTeFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignTeFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTiFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignTiFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTpFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignTpFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTrFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignTrFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUimaxToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignUimaxToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUimaxFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignUimaxFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUiminToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignUiminToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUiminFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignUiminFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUrmaxToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignUrmaxToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUrmaxFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignUrmaxFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUrminToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignUrminToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUrminFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignUrminFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVtmaxToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVtmaxToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVtmaxFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignVtmaxFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVtminToExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVtminToExcSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVtminFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignVtminFromExcSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignYpFromExcSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSKId(), "UnAssignYpFromExcSKCommand identifier should not be null" );
	}
