...
//		Assert.isNull( phaseTapChangerAsymmetrical.getPhaseTapChangerAsymmetricalId(), "CreatePhaseTapChangerAsymmetricalCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalCommand command ) throws Exception {
		Assert.notNull( command, "AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalCommand should not be null" );
		Assert.notNull( command.getPhaseTapChangerAsymmetricalId(), "AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalCommand should not be null" );
		Assert.notNull( command.getPhaseTapChangerAsymmetricalId(), "UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalCommand identifier should not be null" );
	}
