...
//		Assert.isNull( loadUserDefined.getLoadUserDefinedId(), "CreateLoadUserDefinedCommand identifier should be null" );
	...
	public void validate( AssignProprietaryToLoadUserDefinedCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadUserDefinedId(), "AssignProprietaryToLoadUserDefinedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProprietaryToLoadUserDefinedCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignProprietaryFromLoadUserDefinedCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadUserDefinedId(), "UnAssignProprietaryFromLoadUserDefinedCommand identifier should not be null" );
	}
