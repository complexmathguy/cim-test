...
//		Assert.isNull( windContPType4aIEC.getWindContPType4aIECId(), "CreateWindContPType4aIECCommand identifier should be null" );
	...
	public void validate( AssignDpmaxToWindContPType4aIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4aIECId(), "AssignDpmaxToWindContPType4aIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDpmaxToWindContPType4aIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDpmaxFromWindContPType4aIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4aIECId(), "UnAssignDpmaxFromWindContPType4aIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpordToWindContPType4aIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4aIECId(), "AssignTpordToWindContPType4aIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpordToWindContPType4aIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTpordFromWindContPType4aIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4aIECId(), "UnAssignTpordFromWindContPType4aIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTufiltToWindContPType4aIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4aIECId(), "AssignTufiltToWindContPType4aIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTufiltToWindContPType4aIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTufiltFromWindContPType4aIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4aIECId(), "UnAssignTufiltFromWindContPType4aIECCommand identifier should not be null" );
	}
