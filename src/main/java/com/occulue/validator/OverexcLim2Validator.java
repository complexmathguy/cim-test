...
//		Assert.isNull( overexcLim2.getOverexcLim2Id(), "CreateOverexcLim2Command identifier should be null" );
	...
	public void validate( AssignIfdlimToOverexcLim2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLim2Id(), "AssignIfdlimToOverexcLim2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIfdlimToOverexcLim2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignIfdlimFromOverexcLim2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLim2Id(), "UnAssignIfdlimFromOverexcLim2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKoiToOverexcLim2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLim2Id(), "AssignKoiToOverexcLim2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKoiToOverexcLim2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKoiFromOverexcLim2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLim2Id(), "UnAssignKoiFromOverexcLim2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVoimaxToOverexcLim2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLim2Id(), "AssignVoimaxToOverexcLim2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVoimaxToOverexcLim2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVoimaxFromOverexcLim2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLim2Id(), "UnAssignVoimaxFromOverexcLim2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVoiminToOverexcLim2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLim2Id(), "AssignVoiminToOverexcLim2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVoiminToOverexcLim2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVoiminFromOverexcLim2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLim2Id(), "UnAssignVoiminFromOverexcLim2Command identifier should not be null" );
	}
