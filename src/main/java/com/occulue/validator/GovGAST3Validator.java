...
//		Assert.isNull( govGAST3.getGovGAST3Id(), "CreateGovGAST3Command identifier should be null" );
	...
	public void validate( AssignBcaToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignBcaToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBcaToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignBcaFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignBcaFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBpToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignBpToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBpToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignBpFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignBpFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDtcToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignDtcToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDtcToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignDtcFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignDtcFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignKaToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignKaFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKacToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignKacToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKacToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKacFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignKacFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcaToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignKcaToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcaToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKcaFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignKcaFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKsiToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignKsiToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKsiToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKsiFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignKsiFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKyToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignKyToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKyToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKyFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignKyFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMnefToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignMnefToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMnefToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMnefFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignMnefFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMxefToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignMxefToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMxefToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMxefFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignMxefFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRcmnToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignRcmnToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRcmnToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignRcmnFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignRcmnFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRcmxToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignRcmxToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRcmxToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignRcmxFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignRcmxFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTacToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignTacToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTacToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTacFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignTacFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignTcToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignTcFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTdToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignTdToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTdToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTdFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignTdFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfenToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignTfenToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfenToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTfenFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignTfenFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTgToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignTgToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTgToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTgFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignTgFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTsiToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignTsiToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTsiToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTsiFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignTsiFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTtToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignTtToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTtToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTtFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignTtFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTtcToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignTtcToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTtcToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTtcFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignTtcFromGovGAST3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTyToGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "AssignTyToGovGAST3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTyToGovGAST3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTyFromGovGAST3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovGAST3Id(), "UnAssignTyFromGovGAST3Command identifier should not be null" );
	}
