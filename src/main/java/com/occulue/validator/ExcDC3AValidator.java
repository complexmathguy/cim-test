...
//		Assert.isNull( excDC3A.getExcDC3AId(), "CreateExcDC3ACommand identifier should be null" );
	...
	public void validate( AssignEdfmaxToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignEdfmaxToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEdfmaxToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEdfmaxFromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignEdfmaxFromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd1ToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignEfd1ToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd1ToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd1FromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignEfd1FromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd2ToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignEfd2ToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd2ToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd2FromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignEfd2FromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfdlimToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignEfdlimToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdlimToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdlimFromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignEfdlimFromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfdminToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignEfdminToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdminToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdminFromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignEfdminFromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignExclimToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignExclimToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExclimToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignExclimFromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignExclimFromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignKeToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignKeFromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKrToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignKrToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKrToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKrFromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignKrFromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKsToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignKsToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKsToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKsFromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignKsFromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKvToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignKvToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKvToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKvFromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignKvFromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd1ToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignSeefd1ToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd1ToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd1FromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignSeefd1FromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd2ToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignSeefd2ToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd2ToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd2FromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignSeefd2FromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignTeToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignTeFromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTrhToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignTrhToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTrhToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTrhFromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignTrhFromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignVrmaxToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignVrmaxFromExcDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "AssignVrminToExcDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3AId(), "UnAssignVrminFromExcDC3ACommand identifier should not be null" );
	}
