...
//		Assert.isNull( petersenCoil.getPetersenCoilId(), "CreatePetersenCoilCommand identifier should be null" );
	...
	public void validate( AssignNominalUToPetersenCoilCommand command ) throws Exception {
		...
		Assert.notNull( command.getPetersenCoilId(), "AssignNominalUToPetersenCoilCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNominalUToPetersenCoilCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNominalUFromPetersenCoilCommand command ) throws Exception {
		...
		Assert.notNull( command.getPetersenCoilId(), "UnAssignNominalUFromPetersenCoilCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignOffsetCurrentToPetersenCoilCommand command ) throws Exception {
		...
		Assert.notNull( command.getPetersenCoilId(), "AssignOffsetCurrentToPetersenCoilCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignOffsetCurrentToPetersenCoilCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignOffsetCurrentFromPetersenCoilCommand command ) throws Exception {
		...
		Assert.notNull( command.getPetersenCoilId(), "UnAssignOffsetCurrentFromPetersenCoilCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPositionCurrentToPetersenCoilCommand command ) throws Exception {
		...
		Assert.notNull( command.getPetersenCoilId(), "AssignPositionCurrentToPetersenCoilCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPositionCurrentToPetersenCoilCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPositionCurrentFromPetersenCoilCommand command ) throws Exception {
		...
		Assert.notNull( command.getPetersenCoilId(), "UnAssignPositionCurrentFromPetersenCoilCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXGroundMaxToPetersenCoilCommand command ) throws Exception {
		...
		Assert.notNull( command.getPetersenCoilId(), "AssignXGroundMaxToPetersenCoilCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXGroundMaxToPetersenCoilCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXGroundMaxFromPetersenCoilCommand command ) throws Exception {
		...
		Assert.notNull( command.getPetersenCoilId(), "UnAssignXGroundMaxFromPetersenCoilCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXGroundMinToPetersenCoilCommand command ) throws Exception {
		...
		Assert.notNull( command.getPetersenCoilId(), "AssignXGroundMinToPetersenCoilCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXGroundMinToPetersenCoilCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXGroundMinFromPetersenCoilCommand command ) throws Exception {
		...
		Assert.notNull( command.getPetersenCoilId(), "UnAssignXGroundMinFromPetersenCoilCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXGroundNominalToPetersenCoilCommand command ) throws Exception {
		...
		Assert.notNull( command.getPetersenCoilId(), "AssignXGroundNominalToPetersenCoilCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXGroundNominalToPetersenCoilCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXGroundNominalFromPetersenCoilCommand command ) throws Exception {
		...
		Assert.notNull( command.getPetersenCoilId(), "UnAssignXGroundNominalFromPetersenCoilCommand identifier should not be null" );
	}
