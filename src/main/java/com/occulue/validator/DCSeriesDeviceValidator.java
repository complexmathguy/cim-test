...
//		Assert.isNull( dCSeriesDevice.getDCSeriesDeviceId(), "CreateDCSeriesDeviceCommand identifier should be null" );
	...
	public void validate( AssignInductanceToDCSeriesDeviceCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCSeriesDeviceId(), "AssignInductanceToDCSeriesDeviceCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignInductanceToDCSeriesDeviceCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignInductanceFromDCSeriesDeviceCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCSeriesDeviceId(), "UnAssignInductanceFromDCSeriesDeviceCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRatedUdcToDCSeriesDeviceCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCSeriesDeviceId(), "AssignRatedUdcToDCSeriesDeviceCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRatedUdcToDCSeriesDeviceCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRatedUdcFromDCSeriesDeviceCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCSeriesDeviceId(), "UnAssignRatedUdcFromDCSeriesDeviceCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignResistanceToDCSeriesDeviceCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCSeriesDeviceId(), "AssignResistanceToDCSeriesDeviceCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignResistanceToDCSeriesDeviceCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignResistanceFromDCSeriesDeviceCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCSeriesDeviceId(), "UnAssignResistanceFromDCSeriesDeviceCommand identifier should not be null" );
	}
