...
//		Assert.isNull( turbineGovernorUserDefined.getTurbineGovernorUserDefinedId(), "CreateTurbineGovernorUserDefinedCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignProprietaryToTurbineGovernorUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "AssignProprietaryToTurbineGovernorUserDefinedCommand should not be null" );
		Assert.notNull( command.getTurbineGovernorUserDefinedId(), "AssignProprietaryToTurbineGovernorUserDefinedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProprietaryToTurbineGovernorUserDefinedCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignProprietaryFromTurbineGovernorUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignProprietaryFromTurbineGovernorUserDefinedCommand should not be null" );
		Assert.notNull( command.getTurbineGovernorUserDefinedId(), "UnAssignProprietaryFromTurbineGovernorUserDefinedCommand identifier should not be null" );
	}
