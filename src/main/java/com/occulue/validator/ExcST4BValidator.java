...
//		Assert.isNull( excST4B.getExcST4BId(), "CreateExcST4BCommand identifier should be null" );
	...
	public void validate( AssignKcToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignKcToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignKcFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKgToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignKgToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKgToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKgFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignKgFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignKiToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignKiFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKimToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignKimToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKimToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKimFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignKimFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKirToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignKirToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKirToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKirFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignKirFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignKpToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignKpFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpmToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignKpmToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpmToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpmFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignKpmFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKprToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignKprToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKprToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKprFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignKprFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignLvgateToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignLvgateToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLvgateToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLvgateFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignLvgateFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignTaToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignTaFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignThetapToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignThetapToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignThetapToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignThetapFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignThetapFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUelToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignUelToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUelToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUelFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignUelFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVbmaxToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignVbmaxToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVbmaxToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVbmaxFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignVbmaxFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVgmaxToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignVgmaxToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVgmaxToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVgmaxFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignVgmaxFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmmaxToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignVmmaxToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmmaxToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVmmaxFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignVmmaxFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmminToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignVmminToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmminToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVmminFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignVmminFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignVrmaxToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignVrmaxFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignVrminToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignVrminFromExcST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXlToExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "AssignXlToExcST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXlToExcST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXlFromExcST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST4BId(), "UnAssignXlFromExcST4BCommand identifier should not be null" );
	}
