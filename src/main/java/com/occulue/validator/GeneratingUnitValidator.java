...
//		Assert.isNull( generatingUnit.getGeneratingUnitId(), "CreateGeneratingUnitCommand identifier should be null" );
	...
	public void validate( AssignGovernorSCDToGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "AssignGovernorSCDToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGovernorSCDToGeneratingUnitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGovernorSCDFromGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignGovernorSCDFromGeneratingUnitCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignInitialPToGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "AssignInitialPToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignInitialPToGeneratingUnitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignInitialPFromGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignInitialPFromGeneratingUnitCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignLongPFToGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "AssignLongPFToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLongPFToGeneratingUnitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLongPFFromGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignLongPFFromGeneratingUnitCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignMaximumAllowableSpinningReserveToGeneratingUnitCommand command ) throws Exception {
		Assert.notNull( command, "AssignMaximumAllowableSpinningReserveToGeneratingUnitCommand should not be null" );
		Assert.notNull( command.getGeneratingUnitId(), "AssignMaximumAllowableSpinningReserveToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMaximumAllowableSpinningReserveToGeneratingUnitCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignMaximumAllowableSpinningReserveFromGeneratingUnitCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignMaximumAllowableSpinningReserveFromGeneratingUnitCommand should not be null" );
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignMaximumAllowableSpinningReserveFromGeneratingUnitCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMaxOperatingPToGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "AssignMaxOperatingPToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMaxOperatingPToGeneratingUnitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMaxOperatingPFromGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignMaxOperatingPFromGeneratingUnitCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMinOperatingPToGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "AssignMinOperatingPToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMinOperatingPToGeneratingUnitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMinOperatingPFromGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignMinOperatingPFromGeneratingUnitCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNominalPToGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "AssignNominalPToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNominalPToGeneratingUnitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNominalPFromGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignNominalPFromGeneratingUnitCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRatedGrossMaxPToGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "AssignRatedGrossMaxPToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRatedGrossMaxPToGeneratingUnitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRatedGrossMaxPFromGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignRatedGrossMaxPFromGeneratingUnitCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRatedGrossMinPToGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "AssignRatedGrossMinPToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRatedGrossMinPToGeneratingUnitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRatedGrossMinPFromGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignRatedGrossMinPFromGeneratingUnitCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRatedNetMaxPToGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "AssignRatedNetMaxPToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRatedNetMaxPToGeneratingUnitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRatedNetMaxPFromGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignRatedNetMaxPFromGeneratingUnitCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignShortPFToGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "AssignShortPFToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignShortPFToGeneratingUnitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignShortPFFromGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignShortPFFromGeneratingUnitCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignStartupCostToGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "AssignStartupCostToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignStartupCostToGeneratingUnitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignStartupCostFromGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignStartupCostFromGeneratingUnitCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTotalEfficiencyToGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "AssignTotalEfficiencyToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTotalEfficiencyToGeneratingUnitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTotalEfficiencyFromGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignTotalEfficiencyFromGeneratingUnitCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVariableCostToGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "AssignVariableCostToGeneratingUnitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVariableCostToGeneratingUnitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVariableCostFromGeneratingUnitCommand command ) throws Exception {
		...
		Assert.notNull( command.getGeneratingUnitId(), "UnAssignVariableCostFromGeneratingUnitCommand identifier should not be null" );
	}
