...
//		Assert.isNull( voltagePerReactivePower.getVoltagePerReactivePowerId(), "CreateVoltagePerReactivePowerCommand identifier should be null" );
	...
	public void validate( AssignValueToVoltagePerReactivePowerCommand command ) throws Exception {
		...
		Assert.notNull( command.getVoltagePerReactivePowerId(), "AssignValueToVoltagePerReactivePowerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToVoltagePerReactivePowerCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromVoltagePerReactivePowerCommand command ) throws Exception {
		...
		Assert.notNull( command.getVoltagePerReactivePowerId(), "UnAssignValueFromVoltagePerReactivePowerCommand identifier should not be null" );
	}
