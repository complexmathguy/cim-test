...
//		Assert.isNull( length.getLengthId(), "CreateLengthCommand identifier should be null" );
	...
	public void validate( AssignValueToLengthCommand command ) throws Exception {
		...
		Assert.notNull( command.getLengthId(), "AssignValueToLengthCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToLengthCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromLengthCommand command ) throws Exception {
		...
		Assert.notNull( command.getLengthId(), "UnAssignValueFromLengthCommand identifier should not be null" );
	}
