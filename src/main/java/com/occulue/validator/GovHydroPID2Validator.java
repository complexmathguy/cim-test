...
//		Assert.isNull( govHydroPID2.getGovHydroPID2Id(), "CreateGovHydroPID2Command identifier should be null" );
	...
	public void validate( AssignAtwToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignAtwToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAtwToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignAtwFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignAtwFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignDToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignDFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignDFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignFeedbackSignalToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignFeedbackSignalToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFeedbackSignalToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignFeedbackSignalFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignFeedbackSignalFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignG0ToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignG0ToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignG0ToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignG0FromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignG0FromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignG1ToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignG1ToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignG1ToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignG1FromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignG1FromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignG2ToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignG2ToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignG2ToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignG2FromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignG2FromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGmaxToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignGmaxToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGmaxToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignGmaxFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignGmaxFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGminToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignGminToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGminToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignGminFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignGminFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignKdToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignKdFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignKiToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignKiFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignKpToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignKpFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignMwbaseToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignMwbaseFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignP1ToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignP1ToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignP1ToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignP1FromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignP1FromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignP2ToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignP2ToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignP2ToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignP2FromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignP2FromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignP3ToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignP3ToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignP3ToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignP3FromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignP3FromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRpermToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignRpermToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRpermToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignRpermFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignRpermFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignTaToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignTaFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignTbToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignTbFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTregToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignTregToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTregToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTregFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignTregFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTwToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignTwToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTwToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTwFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignTwFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVelmaxToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignVelmaxToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVelmaxToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVelmaxFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignVelmaxFromGovHydroPID2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVelminToGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "AssignVelminToGovHydroPID2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVelminToGovHydroPID2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVelminFromGovHydroPID2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPID2Id(), "UnAssignVelminFromGovHydroPID2Command identifier should not be null" );
	}
