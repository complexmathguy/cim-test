...
//		Assert.isNull( excSEXS.getExcSEXSId(), "CreateExcSEXSCommand identifier should be null" );
	...
	public void validate( AssignEfdmaxToExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "AssignEfdmaxToExcSEXSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdmaxToExcSEXSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdmaxFromExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "UnAssignEfdmaxFromExcSEXSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfdminToExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "AssignEfdminToExcSEXSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdminToExcSEXSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdminFromExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "UnAssignEfdminFromExcSEXSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEmaxToExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "AssignEmaxToExcSEXSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEmaxToExcSEXSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEmaxFromExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "UnAssignEmaxFromExcSEXSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEminToExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "AssignEminToExcSEXSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEminToExcSEXSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEminFromExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "UnAssignEminFromExcSEXSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKToExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKToExcSEXSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKFromExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "UnAssignKFromExcSEXSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "AssignKcToExcSEXSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcSEXSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "UnAssignKcFromExcSEXSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTatbToExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "AssignTatbToExcSEXSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTatbToExcSEXSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTatbFromExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "UnAssignTatbFromExcSEXSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "AssignTbToExcSEXSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcSEXSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "UnAssignTbFromExcSEXSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "AssignTcToExcSEXSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcSEXSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "UnAssignTcFromExcSEXSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "AssignTeToExcSEXSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcSEXSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcSEXSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSEXSId(), "UnAssignTeFromExcSEXSCommand identifier should not be null" );
	}
