...
//		Assert.isNull( excAVR3.getExcAVR3Id(), "CreateExcAVR3Command identifier should be null" );
	...
	public void validate( AssignE1ToExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "AssignE1ToExcAVR3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignE1ToExcAVR3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignE1FromExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "UnAssignE1FromExcAVR3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignE2ToExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "AssignE2ToExcAVR3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignE2ToExcAVR3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignE2FromExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "UnAssignE2FromExcAVR3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "AssignKaToExcAVR3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcAVR3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "UnAssignKaFromExcAVR3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSe1ToExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "AssignSe1ToExcAVR3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSe1ToExcAVR3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignSe1FromExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "UnAssignSe1FromExcAVR3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSe2ToExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "AssignSe2ToExcAVR3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSe2ToExcAVR3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignSe2FromExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "UnAssignSe2FromExcAVR3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "AssignT1ToExcAVR3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToExcAVR3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "UnAssignT1FromExcAVR3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "AssignT2ToExcAVR3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToExcAVR3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "UnAssignT2FromExcAVR3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "AssignT3ToExcAVR3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToExcAVR3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "UnAssignT3FromExcAVR3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "AssignT4ToExcAVR3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4ToExcAVR3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "UnAssignT4FromExcAVR3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "AssignTeToExcAVR3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcAVR3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "UnAssignTeFromExcAVR3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmnToExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "AssignVrmnToExcAVR3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmnToExcAVR3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmnFromExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "UnAssignVrmnFromExcAVR3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmxToExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "AssignVrmxToExcAVR3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmxToExcAVR3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmxFromExcAVR3Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR3Id(), "UnAssignVrmxFromExcAVR3Command identifier should not be null" );
	}
