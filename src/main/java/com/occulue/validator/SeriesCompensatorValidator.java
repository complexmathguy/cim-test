...
//		Assert.isNull( seriesCompensator.getSeriesCompensatorId(), "CreateSeriesCompensatorCommand identifier should be null" );
	...
	public void validate( AssignRToSeriesCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getSeriesCompensatorId(), "AssignRToSeriesCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRToSeriesCompensatorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRFromSeriesCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getSeriesCompensatorId(), "UnAssignRFromSeriesCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignR0ToSeriesCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getSeriesCompensatorId(), "AssignR0ToSeriesCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignR0ToSeriesCompensatorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignR0FromSeriesCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getSeriesCompensatorId(), "UnAssignR0FromSeriesCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaristorPresentToSeriesCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getSeriesCompensatorId(), "AssignVaristorPresentToSeriesCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaristorPresentToSeriesCompensatorCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVaristorPresentFromSeriesCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVaristorPresentFromSeriesCompensatorCommand should not be null" );
		Assert.notNull( command.getSeriesCompensatorId(), "UnAssignVaristorPresentFromSeriesCompensatorCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignVaristorRatedCurrentToSeriesCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "AssignVaristorRatedCurrentToSeriesCompensatorCommand should not be null" );
		Assert.notNull( command.getSeriesCompensatorId(), "AssignVaristorRatedCurrentToSeriesCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaristorRatedCurrentToSeriesCompensatorCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVaristorRatedCurrentFromSeriesCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVaristorRatedCurrentFromSeriesCompensatorCommand should not be null" );
		Assert.notNull( command.getSeriesCompensatorId(), "UnAssignVaristorRatedCurrentFromSeriesCompensatorCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignVaristorVoltageThresholdToSeriesCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "AssignVaristorVoltageThresholdToSeriesCompensatorCommand should not be null" );
		Assert.notNull( command.getSeriesCompensatorId(), "AssignVaristorVoltageThresholdToSeriesCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaristorVoltageThresholdToSeriesCompensatorCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVaristorVoltageThresholdFromSeriesCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVaristorVoltageThresholdFromSeriesCompensatorCommand should not be null" );
		Assert.notNull( command.getSeriesCompensatorId(), "UnAssignVaristorVoltageThresholdFromSeriesCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXToSeriesCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getSeriesCompensatorId(), "AssignXToSeriesCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXToSeriesCompensatorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXFromSeriesCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getSeriesCompensatorId(), "UnAssignXFromSeriesCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignX0ToSeriesCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getSeriesCompensatorId(), "AssignX0ToSeriesCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignX0ToSeriesCompensatorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignX0FromSeriesCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getSeriesCompensatorId(), "UnAssignX0FromSeriesCompensatorCommand identifier should not be null" );
	}
