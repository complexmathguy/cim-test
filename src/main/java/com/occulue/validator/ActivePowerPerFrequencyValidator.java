...
//		Assert.isNull( activePowerPerFrequency.getActivePowerPerFrequencyId(), "CreateActivePowerPerFrequencyCommand identifier should be null" );
	...
	public void validate( AssignValueToActivePowerPerFrequencyCommand command ) throws Exception {
		...
		Assert.notNull( command.getActivePowerPerFrequencyId(), "AssignValueToActivePowerPerFrequencyCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToActivePowerPerFrequencyCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromActivePowerPerFrequencyCommand command ) throws Exception {
		...
		Assert.notNull( command.getActivePowerPerFrequencyId(), "UnAssignValueFromActivePowerPerFrequencyCommand identifier should not be null" );
	}
