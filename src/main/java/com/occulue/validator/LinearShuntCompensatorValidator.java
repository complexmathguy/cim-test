...
//		Assert.isNull( linearShuntCompensator.getLinearShuntCompensatorId(), "CreateLinearShuntCompensatorCommand identifier should be null" );
	...
	public void validate( AssignB0PerSectionToLinearShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLinearShuntCompensatorId(), "AssignB0PerSectionToLinearShuntCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignB0PerSectionToLinearShuntCompensatorCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignB0PerSectionFromLinearShuntCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignB0PerSectionFromLinearShuntCompensatorCommand should not be null" );
		Assert.notNull( command.getLinearShuntCompensatorId(), "UnAssignB0PerSectionFromLinearShuntCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBPerSectionToLinearShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLinearShuntCompensatorId(), "AssignBPerSectionToLinearShuntCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBPerSectionToLinearShuntCompensatorCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignBPerSectionFromLinearShuntCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignBPerSectionFromLinearShuntCompensatorCommand should not be null" );
		Assert.notNull( command.getLinearShuntCompensatorId(), "UnAssignBPerSectionFromLinearShuntCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignG0PerSectionToLinearShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLinearShuntCompensatorId(), "AssignG0PerSectionToLinearShuntCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignG0PerSectionToLinearShuntCompensatorCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignG0PerSectionFromLinearShuntCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignG0PerSectionFromLinearShuntCompensatorCommand should not be null" );
		Assert.notNull( command.getLinearShuntCompensatorId(), "UnAssignG0PerSectionFromLinearShuntCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGPerSectionToLinearShuntCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getLinearShuntCompensatorId(), "AssignGPerSectionToLinearShuntCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGPerSectionToLinearShuntCompensatorCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignGPerSectionFromLinearShuntCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignGPerSectionFromLinearShuntCompensatorCommand should not be null" );
		Assert.notNull( command.getLinearShuntCompensatorId(), "UnAssignGPerSectionFromLinearShuntCompensatorCommand identifier should not be null" );
	}
