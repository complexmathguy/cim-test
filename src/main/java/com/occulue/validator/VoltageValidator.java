...
//		Assert.isNull( voltage.getVoltageId(), "CreateVoltageCommand identifier should be null" );
	...
	public void validate( AssignValueToVoltageCommand command ) throws Exception {
		...
		Assert.notNull( command.getVoltageId(), "AssignValueToVoltageCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToVoltageCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromVoltageCommand command ) throws Exception {
		...
		Assert.notNull( command.getVoltageId(), "UnAssignValueFromVoltageCommand identifier should not be null" );
	}
