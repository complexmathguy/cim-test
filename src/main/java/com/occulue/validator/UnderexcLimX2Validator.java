...
//		Assert.isNull( underexcLimX2.getUnderexcLimX2Id(), "CreateUnderexcLimX2Command identifier should be null" );
	...
	public void validate( AssignKf2ToUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "AssignKf2ToUnderexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKf2ToUnderexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKf2FromUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "UnAssignKf2FromUnderexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKmToUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "AssignKmToUnderexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKmToUnderexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKmFromUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "UnAssignKmFromUnderexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMelmaxToUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "AssignMelmaxToUnderexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMelmaxToUnderexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMelmaxFromUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "UnAssignMelmaxFromUnderexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQoToUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "AssignQoToUnderexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQoToUnderexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignQoFromUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "UnAssignQoFromUnderexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRToUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "AssignRToUnderexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRToUnderexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignRFromUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "UnAssignRFromUnderexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTf2ToUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "AssignTf2ToUnderexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTf2ToUnderexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTf2FromUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "UnAssignTf2FromUnderexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTmToUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "AssignTmToUnderexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTmToUnderexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTmFromUnderexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX2Id(), "UnAssignTmFromUnderexcLimX2Command identifier should not be null" );
	}
