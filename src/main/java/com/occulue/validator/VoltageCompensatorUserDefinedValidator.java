...
//		Assert.isNull( voltageCompensatorUserDefined.getVoltageCompensatorUserDefinedId(), "CreateVoltageCompensatorUserDefinedCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignProprietaryToVoltageCompensatorUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "AssignProprietaryToVoltageCompensatorUserDefinedCommand should not be null" );
		Assert.notNull( command.getVoltageCompensatorUserDefinedId(), "AssignProprietaryToVoltageCompensatorUserDefinedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProprietaryToVoltageCompensatorUserDefinedCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignProprietaryFromVoltageCompensatorUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignProprietaryFromVoltageCompensatorUserDefinedCommand should not be null" );
		Assert.notNull( command.getVoltageCompensatorUserDefinedId(), "UnAssignProprietaryFromVoltageCompensatorUserDefinedCommand identifier should not be null" );
	}
