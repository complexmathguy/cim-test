...
//		Assert.isNull( excAVR1.getExcAVR1Id(), "CreateExcAVR1Command identifier should be null" );
	...
	public void validate( AssignE1ToExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "AssignE1ToExcAVR1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignE1ToExcAVR1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignE1FromExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "UnAssignE1FromExcAVR1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignE2ToExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "AssignE2ToExcAVR1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignE2ToExcAVR1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignE2FromExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "UnAssignE2FromExcAVR1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "AssignKaToExcAVR1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcAVR1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "UnAssignKaFromExcAVR1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "AssignKfToExcAVR1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcAVR1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "UnAssignKfFromExcAVR1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSe1ToExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "AssignSe1ToExcAVR1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSe1ToExcAVR1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignSe1FromExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "UnAssignSe1FromExcAVR1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSe2ToExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "AssignSe2ToExcAVR1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSe2ToExcAVR1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignSe2FromExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "UnAssignSe2FromExcAVR1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "AssignTaToExcAVR1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcAVR1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "UnAssignTaFromExcAVR1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "AssignTbToExcAVR1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcAVR1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "UnAssignTbFromExcAVR1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "AssignTeToExcAVR1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcAVR1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "UnAssignTeFromExcAVR1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "AssignTfToExcAVR1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcAVR1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "UnAssignTfFromExcAVR1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmnToExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "AssignVrmnToExcAVR1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmnToExcAVR1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmnFromExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "UnAssignVrmnFromExcAVR1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmxToExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "AssignVrmxToExcAVR1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmxToExcAVR1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmxFromExcAVR1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR1Id(), "UnAssignVrmxFromExcAVR1Command identifier should not be null" );
	}
