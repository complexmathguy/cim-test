...
//		Assert.isNull( vCompIEEEType1.getVCompIEEEType1Id(), "CreateVCompIEEEType1Command identifier should be null" );
	...
	public void validate( AssignRcToVCompIEEEType1Command command ) throws Exception {
		...
		Assert.notNull( command.getVCompIEEEType1Id(), "AssignRcToVCompIEEEType1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRcToVCompIEEEType1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignRcFromVCompIEEEType1Command command ) throws Exception {
		...
		Assert.notNull( command.getVCompIEEEType1Id(), "UnAssignRcFromVCompIEEEType1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTrToVCompIEEEType1Command command ) throws Exception {
		...
		Assert.notNull( command.getVCompIEEEType1Id(), "AssignTrToVCompIEEEType1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTrToVCompIEEEType1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTrFromVCompIEEEType1Command command ) throws Exception {
		...
		Assert.notNull( command.getVCompIEEEType1Id(), "UnAssignTrFromVCompIEEEType1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXcToVCompIEEEType1Command command ) throws Exception {
		...
		Assert.notNull( command.getVCompIEEEType1Id(), "AssignXcToVCompIEEEType1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXcToVCompIEEEType1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignXcFromVCompIEEEType1Command command ) throws Exception {
		...
		Assert.notNull( command.getVCompIEEEType1Id(), "UnAssignXcFromVCompIEEEType1Command identifier should not be null" );
	}
