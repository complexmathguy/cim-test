...
//		Assert.isNull( pss2B.getPss2BId(), "CreatePss2BCommand identifier should be null" );
	...
	public void validate( AssignKs1ToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKs1ToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKs1FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignKs1FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKs2ToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKs2ToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKs2FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignKs2FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKs3ToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKs3ToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKs3FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignKs3FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKs4ToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKs4ToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKs4FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignKs4FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT1FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignT1FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT10ToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT10ToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT10FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignT10FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT11ToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT11ToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT11FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignT11FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT2FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignT2FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT3FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignT3FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT4FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignT4FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT6FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignT6FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT7FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignT7FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT8FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignT8FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT9FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignT9FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTaFromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignTaFromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTbFromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignTbFromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTw1ToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTw1ToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTw1FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignTw1FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTw2ToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTw2ToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTw2FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignTw2FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTw3ToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTw3ToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTw3FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignTw3FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTw4ToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTw4ToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTw4FromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignTw4FromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsi1maxToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "AssignVsi1maxToPss2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsi1maxToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsi1maxFromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignVsi1maxFromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsi1minToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "AssignVsi1minToPss2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsi1minToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsi1minFromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignVsi1minFromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsi2maxToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "AssignVsi2maxToPss2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsi2maxToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsi2maxFromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignVsi2maxFromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsi2minToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "AssignVsi2minToPss2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsi2minToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsi2minFromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignVsi2minFromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVstmaxToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "AssignVstmaxToPss2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVstmaxToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVstmaxFromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignVstmaxFromPss2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVstminToPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "AssignVstminToPss2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVstminToPss2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVstminFromPss2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2BId(), "UnAssignVstminFromPss2BCommand identifier should not be null" );
	}
