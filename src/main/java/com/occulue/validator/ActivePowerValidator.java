...
//		Assert.isNull( activePower.getActivePowerId(), "CreateActivePowerCommand identifier should be null" );
	...
	public void validate( AssignValueToActivePowerCommand command ) throws Exception {
		...
		Assert.notNull( command.getActivePowerId(), "AssignValueToActivePowerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToActivePowerCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromActivePowerCommand command ) throws Exception {
		...
		Assert.notNull( command.getActivePowerId(), "UnAssignValueFromActivePowerCommand identifier should not be null" );
	}
