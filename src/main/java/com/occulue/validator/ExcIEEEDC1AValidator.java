...
//		Assert.isNull( excIEEEDC1A.getExcIEEEDC1AId(), "CreateExcIEEEDC1ACommand identifier should be null" );
	...
	public void validate( AssignEfd1ToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignEfd1ToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd1ToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd1FromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignEfd1FromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd2ToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignEfd2ToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd2ToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd2FromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignEfd2FromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignExclimToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignExclimToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExclimToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignExclimFromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignExclimFromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignKaToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignKaFromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignKeToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignKeFromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignKfToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignKfFromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd1ToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignSeefd1ToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd1ToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd1FromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignSeefd1FromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd2ToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignSeefd2ToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd2ToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd2FromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignSeefd2FromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignTaToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignTaFromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignTbToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignTbFromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignTcToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignTcFromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignTeToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignTeFromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignTfToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignTfFromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUelinToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignUelinToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUelinToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUelinFromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignUelinFromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignVrmaxToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignVrmaxFromExcIEEEDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "AssignVrminToExcIEEEDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC1AId(), "UnAssignVrminFromExcIEEEDC1ACommand identifier should not be null" );
	}
