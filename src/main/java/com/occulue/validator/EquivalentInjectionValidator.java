...
//		Assert.isNull( equivalentInjection.getEquivalentInjectionId(), "CreateEquivalentInjectionCommand identifier should be null" );
	...
	public void validate( AssignMaxPToEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "AssignMaxPToEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMaxPToEquivalentInjectionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMaxPFromEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "UnAssignMaxPFromEquivalentInjectionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMaxQToEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "AssignMaxQToEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMaxQToEquivalentInjectionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMaxQFromEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "UnAssignMaxQFromEquivalentInjectionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMinPToEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "AssignMinPToEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMinPToEquivalentInjectionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMinPFromEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "UnAssignMinPFromEquivalentInjectionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMinQToEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "AssignMinQToEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMinQToEquivalentInjectionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMinQFromEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "UnAssignMinQFromEquivalentInjectionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRToEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "AssignRToEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRToEquivalentInjectionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRFromEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "UnAssignRFromEquivalentInjectionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignR0ToEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "AssignR0ToEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignR0ToEquivalentInjectionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignR0FromEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "UnAssignR0FromEquivalentInjectionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignR2ToEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "AssignR2ToEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignR2ToEquivalentInjectionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignR2FromEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "UnAssignR2FromEquivalentInjectionCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignRegulationCapabilityToEquivalentInjectionCommand command ) throws Exception {
		Assert.notNull( command, "AssignRegulationCapabilityToEquivalentInjectionCommand should not be null" );
		Assert.notNull( command.getEquivalentInjectionId(), "AssignRegulationCapabilityToEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRegulationCapabilityToEquivalentInjectionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignRegulationCapabilityFromEquivalentInjectionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignRegulationCapabilityFromEquivalentInjectionCommand should not be null" );
		Assert.notNull( command.getEquivalentInjectionId(), "UnAssignRegulationCapabilityFromEquivalentInjectionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXToEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "AssignXToEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXToEquivalentInjectionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXFromEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "UnAssignXFromEquivalentInjectionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignX0ToEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "AssignX0ToEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignX0ToEquivalentInjectionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignX0FromEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "UnAssignX0FromEquivalentInjectionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignX2ToEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "AssignX2ToEquivalentInjectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignX2ToEquivalentInjectionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignX2FromEquivalentInjectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentInjectionId(), "UnAssignX2FromEquivalentInjectionCommand identifier should not be null" );
	}
