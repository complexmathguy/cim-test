...
//		Assert.isNull( dCGround.getDCGroundId(), "CreateDCGroundCommand identifier should be null" );
	...
	public void validate( AssignInductanceToDCGroundCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCGroundId(), "AssignInductanceToDCGroundCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignInductanceToDCGroundCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignInductanceFromDCGroundCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCGroundId(), "UnAssignInductanceFromDCGroundCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRToDCGroundCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCGroundId(), "AssignRToDCGroundCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRToDCGroundCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRFromDCGroundCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCGroundId(), "UnAssignRFromDCGroundCommand identifier should not be null" );
	}
