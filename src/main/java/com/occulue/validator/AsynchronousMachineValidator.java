...
//		Assert.isNull( asynchronousMachine.getAsynchronousMachineId(), "CreateAsynchronousMachineCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignConverterFedDriveToAsynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "AssignConverterFedDriveToAsynchronousMachineCommand should not be null" );
		Assert.notNull( command.getAsynchronousMachineId(), "AssignConverterFedDriveToAsynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignConverterFedDriveToAsynchronousMachineCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignConverterFedDriveFromAsynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignConverterFedDriveFromAsynchronousMachineCommand should not be null" );
		Assert.notNull( command.getAsynchronousMachineId(), "UnAssignConverterFedDriveFromAsynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfficiencyToAsynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getAsynchronousMachineId(), "AssignEfficiencyToAsynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfficiencyToAsynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfficiencyFromAsynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getAsynchronousMachineId(), "UnAssignEfficiencyFromAsynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIaIrRatioToAsynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getAsynchronousMachineId(), "AssignIaIrRatioToAsynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIaIrRatioToAsynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIaIrRatioFromAsynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getAsynchronousMachineId(), "UnAssignIaIrRatioFromAsynchronousMachineCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignNominalFrequencyToAsynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "AssignNominalFrequencyToAsynchronousMachineCommand should not be null" );
		Assert.notNull( command.getAsynchronousMachineId(), "AssignNominalFrequencyToAsynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNominalFrequencyToAsynchronousMachineCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignNominalFrequencyFromAsynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignNominalFrequencyFromAsynchronousMachineCommand should not be null" );
		Assert.notNull( command.getAsynchronousMachineId(), "UnAssignNominalFrequencyFromAsynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNominalSpeedToAsynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getAsynchronousMachineId(), "AssignNominalSpeedToAsynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNominalSpeedToAsynchronousMachineCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignNominalSpeedFromAsynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignNominalSpeedFromAsynchronousMachineCommand should not be null" );
		Assert.notNull( command.getAsynchronousMachineId(), "UnAssignNominalSpeedFromAsynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPolePairNumberToAsynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getAsynchronousMachineId(), "AssignPolePairNumberToAsynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPolePairNumberToAsynchronousMachineCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignPolePairNumberFromAsynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignPolePairNumberFromAsynchronousMachineCommand should not be null" );
		Assert.notNull( command.getAsynchronousMachineId(), "UnAssignPolePairNumberFromAsynchronousMachineCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignRatedMechanicalPowerToAsynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "AssignRatedMechanicalPowerToAsynchronousMachineCommand should not be null" );
		Assert.notNull( command.getAsynchronousMachineId(), "AssignRatedMechanicalPowerToAsynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRatedMechanicalPowerToAsynchronousMachineCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignRatedMechanicalPowerFromAsynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignRatedMechanicalPowerFromAsynchronousMachineCommand should not be null" );
		Assert.notNull( command.getAsynchronousMachineId(), "UnAssignRatedMechanicalPowerFromAsynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignReversibleToAsynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getAsynchronousMachineId(), "AssignReversibleToAsynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignReversibleToAsynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignReversibleFromAsynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getAsynchronousMachineId(), "UnAssignReversibleFromAsynchronousMachineCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignRxLockedRotorRatioToAsynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "AssignRxLockedRotorRatioToAsynchronousMachineCommand should not be null" );
		Assert.notNull( command.getAsynchronousMachineId(), "AssignRxLockedRotorRatioToAsynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRxLockedRotorRatioToAsynchronousMachineCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignRxLockedRotorRatioFromAsynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignRxLockedRotorRatioFromAsynchronousMachineCommand should not be null" );
		Assert.notNull( command.getAsynchronousMachineId(), "UnAssignRxLockedRotorRatioFromAsynchronousMachineCommand identifier should not be null" );
	}
