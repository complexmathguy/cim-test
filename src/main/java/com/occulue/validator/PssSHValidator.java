...
//		Assert.isNull( pssSH.getPssSHId(), "CreatePssSHCommand identifier should be null" );
	...
	public void validate( UnAssignK0FromPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSHId(), "UnAssignK0FromPssSHCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignK1FromPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSHId(), "UnAssignK1FromPssSHCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignK2FromPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSHId(), "UnAssignK2FromPssSHCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignK3FromPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSHId(), "UnAssignK3FromPssSHCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignK4FromPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSHId(), "UnAssignK4FromPssSHCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT1FromPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSHId(), "UnAssignT1FromPssSHCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT2FromPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSHId(), "UnAssignT2FromPssSHCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT3FromPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSHId(), "UnAssignT3FromPssSHCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT4FromPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSHId(), "UnAssignT4FromPssSHCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTdFromPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSHId(), "UnAssignTdFromPssSHCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsmaxToPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVsmaxToPssSHCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsmaxFromPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSHId(), "UnAssignVsmaxFromPssSHCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsminToPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVsminToPssSHCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsminFromPssSHCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSHId(), "UnAssignVsminFromPssSHCommand identifier should not be null" );
	}
