...
//		Assert.isNull( excELIN1.getExcELIN1Id(), "CreateExcELIN1Command identifier should be null" );
	...
	public void validate( AssignDpnfToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignDpnfToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDpnfToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignDpnfFromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignDpnfFromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfmaxToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignEfmaxToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfmaxToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEfmaxFromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignEfmaxFromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfminToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignEfminToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfminToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEfminFromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignEfminFromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKs1ToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignKs1ToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKs1ToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKs1FromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignKs1FromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKs2ToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignKs2ToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKs2ToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKs2FromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignKs2FromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSmaxToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignSmaxToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSmaxToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignSmaxFromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignSmaxFromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfiToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignTfiToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfiToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTfiFromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignTfiFromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTnuToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignTnuToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTnuToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTnuFromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignTnuFromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTs1ToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignTs1ToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTs1ToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTs1FromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignTs1FromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTs2ToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignTs2ToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTs2ToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTs2FromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignTs2FromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTswToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignTswToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTswToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTswFromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignTswFromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVpiToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignVpiToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVpiToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVpiFromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignVpiFromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVpnfToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignVpnfToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVpnfToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVpnfFromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignVpnfFromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVpuToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignVpuToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVpuToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVpuFromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignVpuFromExcELIN1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXeToExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "AssignXeToExcELIN1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXeToExcELIN1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignXeFromExcELIN1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcELIN1Id(), "UnAssignXeFromExcELIN1Command identifier should not be null" );
	}
