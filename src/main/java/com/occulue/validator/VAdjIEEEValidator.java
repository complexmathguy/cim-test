...
//		Assert.isNull( vAdjIEEE.getVAdjIEEEId(), "CreateVAdjIEEECommand identifier should be null" );
	...
	public void validate( AssignAdjslewToVAdjIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getVAdjIEEEId(), "AssignAdjslewToVAdjIEEECommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAdjslewToVAdjIEEECommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAdjslewFromVAdjIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getVAdjIEEEId(), "UnAssignAdjslewFromVAdjIEEECommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaoffToVAdjIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getVAdjIEEEId(), "AssignTaoffToVAdjIEEECommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaoffToVAdjIEEECommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaoffFromVAdjIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getVAdjIEEEId(), "UnAssignTaoffFromVAdjIEEECommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaonToVAdjIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getVAdjIEEEId(), "AssignTaonToVAdjIEEECommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaonToVAdjIEEECommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaonFromVAdjIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getVAdjIEEEId(), "UnAssignTaonFromVAdjIEEECommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVadjfToVAdjIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getVAdjIEEEId(), "AssignVadjfToVAdjIEEECommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVadjfToVAdjIEEECommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVadjfFromVAdjIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getVAdjIEEEId(), "UnAssignVadjfFromVAdjIEEECommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVadjmaxToVAdjIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getVAdjIEEEId(), "AssignVadjmaxToVAdjIEEECommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVadjmaxToVAdjIEEECommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVadjmaxFromVAdjIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getVAdjIEEEId(), "UnAssignVadjmaxFromVAdjIEEECommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVadjminToVAdjIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getVAdjIEEEId(), "AssignVadjminToVAdjIEEECommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVadjminToVAdjIEEECommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVadjminFromVAdjIEEECommand command ) throws Exception {
		...
		Assert.notNull( command.getVAdjIEEEId(), "UnAssignVadjminFromVAdjIEEECommand identifier should not be null" );
	}
