...
//		Assert.isNull( windGenType4IEC.getWindGenType4IECId(), "CreateWindGenType4IECCommand identifier should be null" );
	...
	public void validate( AssignDipmaxToWindGenType4IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenType4IECId(), "AssignDipmaxToWindGenType4IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDipmaxToWindGenType4IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDipmaxFromWindGenType4IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenType4IECId(), "UnAssignDipmaxFromWindGenType4IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDiqmaxToWindGenType4IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenType4IECId(), "AssignDiqmaxToWindGenType4IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDiqmaxToWindGenType4IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDiqmaxFromWindGenType4IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenType4IECId(), "UnAssignDiqmaxFromWindGenType4IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDiqminToWindGenType4IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenType4IECId(), "AssignDiqminToWindGenType4IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDiqminToWindGenType4IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDiqminFromWindGenType4IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenType4IECId(), "UnAssignDiqminFromWindGenType4IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTgToWindGenType4IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenType4IECId(), "AssignTgToWindGenType4IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTgToWindGenType4IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTgFromWindGenType4IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenType4IECId(), "UnAssignTgFromWindGenType4IECCommand identifier should not be null" );
	}
