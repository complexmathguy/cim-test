...
//		Assert.isNull( rotationSpeed.getRotationSpeedId(), "CreateRotationSpeedCommand identifier should be null" );
	...
	public void validate( AssignValueToRotationSpeedCommand command ) throws Exception {
		...
		Assert.notNull( command.getRotationSpeedId(), "AssignValueToRotationSpeedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToRotationSpeedCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromRotationSpeedCommand command ) throws Exception {
		...
		Assert.notNull( command.getRotationSpeedId(), "UnAssignValueFromRotationSpeedCommand identifier should not be null" );
	}
