...
//		Assert.isNull( excST1A.getExcST1AId(), "CreateExcST1ACommand identifier should be null" );
	...
	public void validate( AssignIlrToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignIlrToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIlrToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIlrFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignIlrFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignKaToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignKaFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignKcToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignKcFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignKfToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignKfFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKlrToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignKlrToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKlrToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKlrFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignKlrFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignTaToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignTaFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignTbToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignTbFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTb1ToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignTb1ToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTb1ToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTb1FromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignTb1FromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignTcToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignTcFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTc1ToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignTc1ToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTc1ToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTc1FromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignTc1FromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignTfToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignTfFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVamaxToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignVamaxToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVamaxToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVamaxFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignVamaxFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaminToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignVaminToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaminToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVaminFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignVaminFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVimaxToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignVimaxToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVimaxToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVimaxFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignVimaxFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignViminToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignViminToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignViminToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignViminFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignViminFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignVrmaxToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignVrmaxFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignVrminToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignVrminFromExcST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXeToExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "AssignXeToExcST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXeToExcST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXeFromExcST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST1AId(), "UnAssignXeFromExcST1ACommand identifier should not be null" );
	}
