...
//		Assert.isNull( discExcContIEEEDEC3A.getDiscExcContIEEEDEC3AId(), "CreateDiscExcContIEEEDEC3ACommand identifier should be null" );
	...
	public void validate( AssignTdrToDiscExcContIEEEDEC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC3AId(), "AssignTdrToDiscExcContIEEEDEC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTdrToDiscExcContIEEEDEC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTdrFromDiscExcContIEEEDEC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC3AId(), "UnAssignTdrFromDiscExcContIEEEDEC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVtminToDiscExcContIEEEDEC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC3AId(), "AssignVtminToDiscExcContIEEEDEC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVtminToDiscExcContIEEEDEC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVtminFromDiscExcContIEEEDEC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC3AId(), "UnAssignVtminFromDiscExcContIEEEDEC3ACommand identifier should not be null" );
	}
