...
//		Assert.isNull( temperature.getTemperatureId(), "CreateTemperatureCommand identifier should be null" );
	...
	public void validate( AssignValueToTemperatureCommand command ) throws Exception {
		...
		Assert.notNull( command.getTemperatureId(), "AssignValueToTemperatureCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToTemperatureCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromTemperatureCommand command ) throws Exception {
		...
		Assert.notNull( command.getTemperatureId(), "UnAssignValueFromTemperatureCommand identifier should not be null" );
	}
