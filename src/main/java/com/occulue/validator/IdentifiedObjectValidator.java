...
//		Assert.isNull( identifiedObject.getIdentifiedObjectId(), "CreateIdentifiedObjectCommand identifier should be null" );
	...
	public void validate( AssignDescriptionToIdentifiedObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getIdentifiedObjectId(), "AssignDescriptionToIdentifiedObjectCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDescriptionToIdentifiedObjectCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDescriptionFromIdentifiedObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getIdentifiedObjectId(), "UnAssignDescriptionFromIdentifiedObjectCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEnergyIdentCodeEicToIdentifiedObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getIdentifiedObjectId(), "AssignEnergyIdentCodeEicToIdentifiedObjectCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEnergyIdentCodeEicToIdentifiedObjectCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignEnergyIdentCodeEicFromIdentifiedObjectCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignEnergyIdentCodeEicFromIdentifiedObjectCommand should not be null" );
		Assert.notNull( command.getIdentifiedObjectId(), "UnAssignEnergyIdentCodeEicFromIdentifiedObjectCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMRIDToIdentifiedObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getIdentifiedObjectId(), "AssignMRIDToIdentifiedObjectCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMRIDToIdentifiedObjectCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMRIDFromIdentifiedObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getIdentifiedObjectId(), "UnAssignMRIDFromIdentifiedObjectCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNameToIdentifiedObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getIdentifiedObjectId(), "AssignNameToIdentifiedObjectCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNameToIdentifiedObjectCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNameFromIdentifiedObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getIdentifiedObjectId(), "UnAssignNameFromIdentifiedObjectCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignShortNameToIdentifiedObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getIdentifiedObjectId(), "AssignShortNameToIdentifiedObjectCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignShortNameToIdentifiedObjectCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignShortNameFromIdentifiedObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getIdentifiedObjectId(), "UnAssignShortNameFromIdentifiedObjectCommand identifier should not be null" );
	}
