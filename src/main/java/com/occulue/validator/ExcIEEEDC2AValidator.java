...
//		Assert.isNull( excIEEEDC2A.getExcIEEEDC2AId(), "CreateExcIEEEDC2ACommand identifier should be null" );
	...
	public void validate( AssignEfd1ToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignEfd1ToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd1ToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd1FromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignEfd1FromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd2ToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignEfd2ToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd2ToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd2FromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignEfd2FromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignExclimToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignExclimToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExclimToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignExclimFromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignExclimFromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignKaToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignKaFromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignKeToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignKeFromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignKfToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignKfFromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd1ToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignSeefd1ToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd1ToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd1FromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignSeefd1FromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd2ToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignSeefd2ToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd2ToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd2FromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignSeefd2FromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignTaToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignTaFromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignTbToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignTbFromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignTcToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignTcFromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignTeToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignTeFromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignTfToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignTfFromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUelinToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignUelinToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUelinToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUelinFromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignUelinFromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignVrmaxToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignVrmaxFromExcIEEEDC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "AssignVrminToExcIEEEDC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEDC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEDC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC2AId(), "UnAssignVrminFromExcIEEEDC2ACommand identifier should not be null" );
	}
