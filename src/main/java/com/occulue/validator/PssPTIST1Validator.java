...
//		Assert.isNull( pssPTIST1.getPssPTIST1Id(), "CreatePssPTIST1Command identifier should be null" );
	...
	public void validate( AssignDtcToPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "AssignDtcToPssPTIST1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDtcToPssPTIST1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignDtcFromPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "UnAssignDtcFromPssPTIST1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDtfToPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "AssignDtfToPssPTIST1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDtfToPssPTIST1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignDtfFromPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "UnAssignDtfFromPssPTIST1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDtpToPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "AssignDtpToPssPTIST1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDtpToPssPTIST1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignDtpFromPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "UnAssignDtpFromPssPTIST1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKToPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "AssignKToPssPTIST1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKToPssPTIST1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKFromPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "UnAssignKFromPssPTIST1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMToPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "AssignMToPssPTIST1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMToPssPTIST1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMFromPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "UnAssignMFromPssPTIST1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "AssignT1ToPssPTIST1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToPssPTIST1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "UnAssignT1FromPssPTIST1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "AssignT2ToPssPTIST1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToPssPTIST1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "UnAssignT2FromPssPTIST1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "AssignT3ToPssPTIST1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToPssPTIST1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "UnAssignT3FromPssPTIST1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "AssignT4ToPssPTIST1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4ToPssPTIST1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "UnAssignT4FromPssPTIST1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "AssignTfToPssPTIST1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToPssPTIST1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "UnAssignTfFromPssPTIST1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpToPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "AssignTpToPssPTIST1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpToPssPTIST1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTpFromPssPTIST1Command command ) throws Exception {
		...
		Assert.notNull( command.getPssPTIST1Id(), "UnAssignTpFromPssPTIST1Command identifier should not be null" );
	}
