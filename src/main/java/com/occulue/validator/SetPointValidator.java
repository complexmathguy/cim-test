...
//		Assert.isNull( setPoint.getSetPointId(), "CreateSetPointCommand identifier should be null" );
	...
	public void validate( AssignNormalValueToSetPointCommand command ) throws Exception {
		...
		Assert.notNull( command.getSetPointId(), "AssignNormalValueToSetPointCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNormalValueToSetPointCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNormalValueFromSetPointCommand command ) throws Exception {
		...
		Assert.notNull( command.getSetPointId(), "UnAssignNormalValueFromSetPointCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignValueToSetPointCommand command ) throws Exception {
		...
		Assert.notNull( command.getSetPointId(), "AssignValueToSetPointCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToSetPointCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromSetPointCommand command ) throws Exception {
		...
		Assert.notNull( command.getSetPointId(), "UnAssignValueFromSetPointCommand identifier should not be null" );
	}
