...
//		Assert.isNull( resistance.getResistanceId(), "CreateResistanceCommand identifier should be null" );
	...
	public void validate( AssignValueToResistanceCommand command ) throws Exception {
		...
		Assert.notNull( command.getResistanceId(), "AssignValueToResistanceCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToResistanceCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromResistanceCommand command ) throws Exception {
		...
		Assert.notNull( command.getResistanceId(), "UnAssignValueFromResistanceCommand identifier should not be null" );
	}
