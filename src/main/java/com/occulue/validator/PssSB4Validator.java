...
//		Assert.isNull( pssSB4.getPssSB4Id(), "CreatePssSB4Command identifier should be null" );
	...
	public void validate( AssignKxToPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKxToPssSB4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKxFromPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getPssSB4Id(), "UnAssignKxFromPssSB4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTaToPssSB4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getPssSB4Id(), "UnAssignTaFromPssSB4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTbToPssSB4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getPssSB4Id(), "UnAssignTbFromPssSB4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTcToPssSB4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getPssSB4Id(), "UnAssignTcFromPssSB4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTdToPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTdToPssSB4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTdFromPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getPssSB4Id(), "UnAssignTdFromPssSB4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTeToPssSB4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getPssSB4Id(), "UnAssignTeFromPssSB4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTtToPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTtToPssSB4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTtFromPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getPssSB4Id(), "UnAssignTtFromPssSB4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTx1ToPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTx1ToPssSB4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTx1FromPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getPssSB4Id(), "UnAssignTx1FromPssSB4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTx2ToPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTx2ToPssSB4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTx2FromPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getPssSB4Id(), "UnAssignTx2FromPssSB4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsmaxToPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getPssSB4Id(), "AssignVsmaxToPssSB4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsmaxToPssSB4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVsmaxFromPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getPssSB4Id(), "UnAssignVsmaxFromPssSB4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsminToPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getPssSB4Id(), "AssignVsminToPssSB4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsminToPssSB4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVsminFromPssSB4Command command ) throws Exception {
		...
		Assert.notNull( command.getPssSB4Id(), "UnAssignVsminFromPssSB4Command identifier should not be null" );
	}
