...
//		Assert.isNull( eNTSOEIdentifiedObject.getENTSOEIdentifiedObjectId(), "CreateENTSOEIdentifiedObjectCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignEnergyIdentCodeEicToENTSOEIdentifiedObjectCommand command ) throws Exception {
		Assert.notNull( command, "AssignEnergyIdentCodeEicToENTSOEIdentifiedObjectCommand should not be null" );
		Assert.notNull( command.getENTSOEIdentifiedObjectId(), "AssignEnergyIdentCodeEicToENTSOEIdentifiedObjectCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEnergyIdentCodeEicToENTSOEIdentifiedObjectCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignEnergyIdentCodeEicFromENTSOEIdentifiedObjectCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignEnergyIdentCodeEicFromENTSOEIdentifiedObjectCommand should not be null" );
		Assert.notNull( command.getENTSOEIdentifiedObjectId(), "UnAssignEnergyIdentCodeEicFromENTSOEIdentifiedObjectCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignShortNameToENTSOEIdentifiedObjectCommand command ) throws Exception {
		...
		Assert.notNull( command.getENTSOEIdentifiedObjectId(), "AssignShortNameToENTSOEIdentifiedObjectCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignShortNameToENTSOEIdentifiedObjectCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignShortNameFromENTSOEIdentifiedObjectCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignShortNameFromENTSOEIdentifiedObjectCommand should not be null" );
		Assert.notNull( command.getENTSOEIdentifiedObjectId(), "UnAssignShortNameFromENTSOEIdentifiedObjectCommand identifier should not be null" );
	}
