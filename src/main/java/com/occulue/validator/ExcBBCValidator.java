...
//		Assert.isNull( excBBC.getExcBBCId(), "CreateExcBBCCommand identifier should be null" );
	...
	public void validate( AssignEfdmaxToExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "AssignEfdmaxToExcBBCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdmaxToExcBBCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdmaxFromExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "UnAssignEfdmaxFromExcBBCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfdminToExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "AssignEfdminToExcBBCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdminToExcBBCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdminFromExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "UnAssignEfdminFromExcBBCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignKFromExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "UnAssignKFromExcBBCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSwitchItToExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "AssignSwitchItToExcBBCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSwitchItToExcBBCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSwitchItFromExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "UnAssignSwitchItFromExcBBCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT1ToExcBBCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "UnAssignT1FromExcBBCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT2ToExcBBCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "UnAssignT2FromExcBBCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT3ToExcBBCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "UnAssignT3FromExcBBCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT4ToExcBBCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "UnAssignT4FromExcBBCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "AssignVrmaxToExcBBCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcBBCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "UnAssignVrmaxFromExcBBCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "AssignVrminToExcBBCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcBBCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "UnAssignVrminFromExcBBCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXeToExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignXeToExcBBCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXeFromExcBBCCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcBBCId(), "UnAssignXeFromExcBBCCommand identifier should not be null" );
	}
