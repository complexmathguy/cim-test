...
//		Assert.isNull( synchronousMachine.getSynchronousMachineId(), "CreateSynchronousMachineCommand identifier should be null" );
	...
	public void validate( AssignEarthingToSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "AssignEarthingToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEarthingToSynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEarthingFromSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignEarthingFromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignEarthingStarPointRToSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "AssignEarthingStarPointRToSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "AssignEarthingStarPointRToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEarthingStarPointRToSynchronousMachineCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignEarthingStarPointRFromSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignEarthingStarPointRFromSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignEarthingStarPointRFromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignEarthingStarPointXToSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "AssignEarthingStarPointXToSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "AssignEarthingStarPointXToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEarthingStarPointXToSynchronousMachineCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignEarthingStarPointXFromSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignEarthingStarPointXFromSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignEarthingStarPointXFromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIkkToSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "AssignIkkToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIkkToSynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIkkFromSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignIkkFromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMaxQToSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "AssignMaxQToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMaxQToSynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMaxQFromSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignMaxQFromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMinQToSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "AssignMinQToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMinQToSynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMinQFromSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignMinQFromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMuToSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "AssignMuToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMuToSynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMuFromSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignMuFromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQPercentToSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "AssignQPercentToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQPercentToSynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignQPercentFromSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignQPercentFromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRToSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "AssignRToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRToSynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRFromSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignRFromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignR0ToSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "AssignR0ToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignR0ToSynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignR0FromSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignR0FromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignR2ToSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "AssignR2ToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignR2ToSynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignR2FromSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignR2FromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignSatDirectSubtransXToSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "AssignSatDirectSubtransXToSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "AssignSatDirectSubtransXToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSatDirectSubtransXToSynchronousMachineCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignSatDirectSubtransXFromSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignSatDirectSubtransXFromSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignSatDirectSubtransXFromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSatDirectSyncXToSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "AssignSatDirectSyncXToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSatDirectSyncXToSynchronousMachineCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignSatDirectSyncXFromSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignSatDirectSyncXFromSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignSatDirectSyncXFromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSatDirectTransXToSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "AssignSatDirectTransXToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSatDirectTransXToSynchronousMachineCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignSatDirectTransXFromSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignSatDirectTransXFromSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignSatDirectTransXFromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignVoltageRegulationRangeToSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "AssignVoltageRegulationRangeToSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "AssignVoltageRegulationRangeToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVoltageRegulationRangeToSynchronousMachineCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVoltageRegulationRangeFromSynchronousMachineCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVoltageRegulationRangeFromSynchronousMachineCommand should not be null" );
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignVoltageRegulationRangeFromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignX0ToSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "AssignX0ToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignX0ToSynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignX0FromSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignX0FromSynchronousMachineCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignX2ToSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "AssignX2ToSynchronousMachineCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignX2ToSynchronousMachineCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignX2FromSynchronousMachineCommand command ) throws Exception {
		...
		Assert.notNull( command.getSynchronousMachineId(), "UnAssignX2FromSynchronousMachineCommand identifier should not be null" );
	}
