...
//		Assert.isNull( excAC2A.getExcAC2AId(), "CreateExcAC2ACommand identifier should be null" );
	...
	public void validate( AssignHvgateToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignHvgateToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignHvgateToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignHvgateFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignHvgateFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignKaToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignKaFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKbToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignKbToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKbToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKbFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignKbFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKb1ToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignKb1ToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKb1ToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKb1FromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignKb1FromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignKcToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignKcFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignKdToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignKdFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignKeToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignKeFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignKfToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignKfFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKhToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignKhToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKhToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKhFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignKhFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKlToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignKlToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKlToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKlFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignKlFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKl1ToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignKl1ToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKl1ToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKl1FromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignKl1FromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKsToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignKsToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKsToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKsFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignKsFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignLvgateToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignLvgateToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLvgateToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLvgateFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignLvgateFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve1ToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignSeve1ToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve1ToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve1FromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignSeve1FromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve2ToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignSeve2ToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve2ToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve2FromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignSeve2FromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignTaToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignTaFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignTbToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignTbFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignTcToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignTcFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignTeToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignTeFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignTfToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignTfFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVamaxToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignVamaxToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVamaxToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVamaxFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignVamaxFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaminToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignVaminToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaminToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVaminFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignVaminFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe1ToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignVe1ToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe1ToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe1FromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignVe1FromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe2ToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignVe2ToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe2ToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe2FromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignVe2FromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVfemaxToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignVfemaxToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVfemaxToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVfemaxFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignVfemaxFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVlrToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignVlrToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVlrToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVlrFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignVlrFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignVrmaxToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignVrmaxFromExcAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "AssignVrminToExcAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC2AId(), "UnAssignVrminFromExcAC2ACommand identifier should not be null" );
	}
