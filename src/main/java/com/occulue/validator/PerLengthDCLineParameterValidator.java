...
//		Assert.isNull( perLengthDCLineParameter.getPerLengthDCLineParameterId(), "CreatePerLengthDCLineParameterCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignCapacitanceToPerLengthDCLineParameterCommand command ) throws Exception {
		Assert.notNull( command, "AssignCapacitanceToPerLengthDCLineParameterCommand should not be null" );
		Assert.notNull( command.getPerLengthDCLineParameterId(), "AssignCapacitanceToPerLengthDCLineParameterCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignCapacitanceToPerLengthDCLineParameterCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignCapacitanceFromPerLengthDCLineParameterCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignCapacitanceFromPerLengthDCLineParameterCommand should not be null" );
		Assert.notNull( command.getPerLengthDCLineParameterId(), "UnAssignCapacitanceFromPerLengthDCLineParameterCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignInductanceToPerLengthDCLineParameterCommand command ) throws Exception {
		...
		Assert.notNull( command.getPerLengthDCLineParameterId(), "AssignInductanceToPerLengthDCLineParameterCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignInductanceToPerLengthDCLineParameterCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignInductanceFromPerLengthDCLineParameterCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignInductanceFromPerLengthDCLineParameterCommand should not be null" );
		Assert.notNull( command.getPerLengthDCLineParameterId(), "UnAssignInductanceFromPerLengthDCLineParameterCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignResistanceToPerLengthDCLineParameterCommand command ) throws Exception {
		...
		Assert.notNull( command.getPerLengthDCLineParameterId(), "AssignResistanceToPerLengthDCLineParameterCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignResistanceToPerLengthDCLineParameterCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignResistanceFromPerLengthDCLineParameterCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignResistanceFromPerLengthDCLineParameterCommand should not be null" );
		Assert.notNull( command.getPerLengthDCLineParameterId(), "UnAssignResistanceFromPerLengthDCLineParameterCommand identifier should not be null" );
	}
