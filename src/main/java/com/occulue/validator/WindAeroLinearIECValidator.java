...
//		Assert.isNull( windAeroLinearIEC.getWindAeroLinearIECId(), "CreateWindAeroLinearIECCommand identifier should be null" );
	...
	public void validate( AssignDpomegaToWindAeroLinearIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindAeroLinearIECId(), "AssignDpomegaToWindAeroLinearIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDpomegaToWindAeroLinearIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDpomegaFromWindAeroLinearIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindAeroLinearIECId(), "UnAssignDpomegaFromWindAeroLinearIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDpthetaToWindAeroLinearIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindAeroLinearIECId(), "AssignDpthetaToWindAeroLinearIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDpthetaToWindAeroLinearIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDpthetaFromWindAeroLinearIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindAeroLinearIECId(), "UnAssignDpthetaFromWindAeroLinearIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignOmegazeroToWindAeroLinearIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindAeroLinearIECId(), "AssignOmegazeroToWindAeroLinearIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignOmegazeroToWindAeroLinearIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignOmegazeroFromWindAeroLinearIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindAeroLinearIECId(), "UnAssignOmegazeroFromWindAeroLinearIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPavailToWindAeroLinearIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindAeroLinearIECId(), "AssignPavailToWindAeroLinearIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPavailToWindAeroLinearIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPavailFromWindAeroLinearIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindAeroLinearIECId(), "UnAssignPavailFromWindAeroLinearIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignThetazeroToWindAeroLinearIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindAeroLinearIECId(), "AssignThetazeroToWindAeroLinearIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignThetazeroToWindAeroLinearIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignThetazeroFromWindAeroLinearIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindAeroLinearIECId(), "UnAssignThetazeroFromWindAeroLinearIECCommand identifier should not be null" );
	}
