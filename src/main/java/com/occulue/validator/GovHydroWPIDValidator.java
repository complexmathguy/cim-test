...
//		Assert.isNull( govHydroWPID.getGovHydroWPIDId(), "CreateGovHydroWPIDCommand identifier should be null" );
	...
	public void validate( AssignDToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignDToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignDFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGatmaxToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignGatmaxToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGatmaxToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGatmaxFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignGatmaxFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGatminToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignGatminToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGatminToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGatminFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignGatminFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGv1ToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignGv1ToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGv1ToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGv1FromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignGv1FromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGv2ToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignGv2ToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGv2ToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGv2FromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignGv2FromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGv3ToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignGv3ToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGv3ToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGv3FromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignGv3FromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignKdToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignKdFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignKiToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignKiFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignKpToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignKpFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignMwbaseToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignMwbaseFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPgv1ToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignPgv1ToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPgv1ToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPgv1FromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignPgv1FromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPgv2ToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignPgv2ToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPgv2ToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPgv2FromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignPgv2FromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPgv3ToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignPgv3ToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPgv3ToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPgv3FromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignPgv3FromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPmaxToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignPmaxToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPmaxToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPmaxFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignPmaxFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPminToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignPminToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPminToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPminFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignPminFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRegToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignRegToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRegToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRegFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignRegFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignTaToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignTaFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignTbToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignTbFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTregToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignTregToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTregToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTregFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignTregFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTwToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignTwToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTwToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTwFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignTwFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVelmaxToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignVelmaxToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVelmaxToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVelmaxFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignVelmaxFromGovHydroWPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVelminToGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "AssignVelminToGovHydroWPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVelminToGovHydroWPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVelminFromGovHydroWPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroWPIDId(), "UnAssignVelminFromGovHydroWPIDCommand identifier should not be null" );
	}
