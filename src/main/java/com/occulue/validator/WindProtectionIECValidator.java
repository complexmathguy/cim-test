...
//		Assert.isNull( windProtectionIEC.getWindProtectionIECId(), "CreateWindProtectionIECCommand identifier should be null" );
	...
	public void validate( AssignFoverToWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "AssignFoverToWindProtectionIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFoverToWindProtectionIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignFoverFromWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "UnAssignFoverFromWindProtectionIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignFunderToWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "AssignFunderToWindProtectionIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFunderToWindProtectionIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignFunderFromWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "UnAssignFunderFromWindProtectionIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfoverToWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "AssignTfoverToWindProtectionIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfoverToWindProtectionIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfoverFromWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "UnAssignTfoverFromWindProtectionIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfunderToWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "AssignTfunderToWindProtectionIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfunderToWindProtectionIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfunderFromWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "UnAssignTfunderFromWindProtectionIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTuoverToWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "AssignTuoverToWindProtectionIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTuoverToWindProtectionIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTuoverFromWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "UnAssignTuoverFromWindProtectionIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTuunderToWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "AssignTuunderToWindProtectionIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTuunderToWindProtectionIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTuunderFromWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "UnAssignTuunderFromWindProtectionIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUoverToWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "AssignUoverToWindProtectionIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUoverToWindProtectionIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUoverFromWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "UnAssignUoverFromWindProtectionIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUunderToWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "AssignUunderToWindProtectionIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUunderToWindProtectionIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUunderFromWindProtectionIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindProtectionIECId(), "UnAssignUunderFromWindProtectionIECCommand identifier should not be null" );
	}
