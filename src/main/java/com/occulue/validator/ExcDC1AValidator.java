...
//		Assert.isNull( excDC1A.getExcDC1AId(), "CreateExcDC1ACommand identifier should be null" );
	...
	public void validate( AssignEdfmaxToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignEdfmaxToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEdfmaxToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEdfmaxFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignEdfmaxFromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd1ToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignEfd1ToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd1ToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd1FromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignEfd1FromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd2ToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignEfd2ToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd2ToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd2FromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignEfd2FromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfdminToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignEfdminToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdminToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdminFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignEfdminFromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignExclimToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignExclimToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExclimToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignExclimFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignExclimFromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignKaToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignKaFromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignKeToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignKeFromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignKfToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignKfFromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKsToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignKsToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKsToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKsFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignKsFromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd1ToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignSeefd1ToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd1ToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd1FromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignSeefd1FromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd2ToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignSeefd2ToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd2ToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd2FromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignSeefd2FromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignTaToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignTaFromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignTbToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignTbFromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignTcToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignTcFromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignTeToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignTeFromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignTfToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignTfFromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignVrmaxToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignVrmaxFromExcDC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "AssignVrminToExcDC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcDC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcDC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcDC1AId(), "UnAssignVrminFromExcDC1ACommand identifier should not be null" );
	}
