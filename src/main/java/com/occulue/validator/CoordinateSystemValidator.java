...
//		Assert.isNull( coordinateSystem.getCoordinateSystemId(), "CreateCoordinateSystemCommand identifier should be null" );
	...
	public void validate( AssignCrsUrnToCoordinateSystemCommand command ) throws Exception {
		...
		Assert.notNull( command.getCoordinateSystemId(), "AssignCrsUrnToCoordinateSystemCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignCrsUrnToCoordinateSystemCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignCrsUrnFromCoordinateSystemCommand command ) throws Exception {
		...
		Assert.notNull( command.getCoordinateSystemId(), "UnAssignCrsUrnFromCoordinateSystemCommand identifier should not be null" );
	}
