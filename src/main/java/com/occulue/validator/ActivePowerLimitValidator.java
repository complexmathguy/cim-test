...
//		Assert.isNull( activePowerLimit.getActivePowerLimitId(), "CreateActivePowerLimitCommand identifier should be null" );
	...
	public void validate( AssignValueToActivePowerLimitCommand command ) throws Exception {
		...
		Assert.notNull( command.getActivePowerLimitId(), "AssignValueToActivePowerLimitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToActivePowerLimitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromActivePowerLimitCommand command ) throws Exception {
		...
		Assert.notNull( command.getActivePowerLimitId(), "UnAssignValueFromActivePowerLimitCommand identifier should not be null" );
	}
