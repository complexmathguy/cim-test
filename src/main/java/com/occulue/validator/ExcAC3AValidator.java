...
//		Assert.isNull( excAC3A.getExcAC3AId(), "CreateExcAC3ACommand identifier should be null" );
	...
	public void validate( AssignEfdnToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignEfdnToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdnToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdnFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignEfdnFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignKaToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignKaFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignKcToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignKcFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignKdToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignKdFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignKeToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignKeFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignKfToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignKfFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKf1ToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignKf1ToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKf1ToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKf1FromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignKf1FromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKf2ToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignKf2ToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKf2ToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKf2FromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignKf2FromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKlvToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignKlvToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKlvToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKlvFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignKlvFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKnToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignKnToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKnToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKnFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignKnFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKrToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignKrToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKrToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKrFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignKrFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKsToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignKsToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKsToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKsFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignKsFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve1ToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignSeve1ToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve1ToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve1FromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignSeve1FromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve2ToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignSeve2ToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve2ToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve2FromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignSeve2FromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignTaToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignTaFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignTbToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignTbFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignTcToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignTcFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignTeToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignTeFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignTfToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignTfFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVamaxToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignVamaxToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVamaxToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVamaxFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignVamaxFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaminToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignVaminToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaminToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVaminFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignVaminFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe1ToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignVe1ToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe1ToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe1FromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignVe1FromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe2ToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignVe2ToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe2ToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe2FromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignVe2FromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVeminToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignVeminToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVeminToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVeminFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignVeminFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVfemaxToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignVfemaxToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVfemaxToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVfemaxFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignVfemaxFromExcAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVlvToExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "AssignVlvToExcAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVlvToExcAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVlvFromExcAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC3AId(), "UnAssignVlvFromExcAC3ACommand identifier should not be null" );
	}
