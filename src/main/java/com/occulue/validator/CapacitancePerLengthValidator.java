...
//		Assert.isNull( capacitancePerLength.getCapacitancePerLengthId(), "CreateCapacitancePerLengthCommand identifier should be null" );
	...
	public void validate( AssignValueToCapacitancePerLengthCommand command ) throws Exception {
		...
		Assert.notNull( command.getCapacitancePerLengthId(), "AssignValueToCapacitancePerLengthCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToCapacitancePerLengthCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromCapacitancePerLengthCommand command ) throws Exception {
		...
		Assert.notNull( command.getCapacitancePerLengthId(), "UnAssignValueFromCapacitancePerLengthCommand identifier should not be null" );
	}
