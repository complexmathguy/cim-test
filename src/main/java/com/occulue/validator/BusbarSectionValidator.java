...
//		Assert.isNull( busbarSection.getBusbarSectionId(), "CreateBusbarSectionCommand identifier should be null" );
	...
	public void validate( AssignIpMaxToBusbarSectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getBusbarSectionId(), "AssignIpMaxToBusbarSectionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIpMaxToBusbarSectionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIpMaxFromBusbarSectionCommand command ) throws Exception {
		...
		Assert.notNull( command.getBusbarSectionId(), "UnAssignIpMaxFromBusbarSectionCommand identifier should not be null" );
	}
