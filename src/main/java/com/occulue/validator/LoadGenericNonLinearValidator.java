...
//		Assert.isNull( loadGenericNonLinear.getLoadGenericNonLinearId(), "CreateLoadGenericNonLinearCommand identifier should be null" );
	...
	public void validate( AssignBsToLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "AssignBsToLoadGenericNonLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBsToLoadGenericNonLinearCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBsFromLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "UnAssignBsFromLoadGenericNonLinearCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBtToLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "AssignBtToLoadGenericNonLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBtToLoadGenericNonLinearCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBtFromLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "UnAssignBtFromLoadGenericNonLinearCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignLsToLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "AssignLsToLoadGenericNonLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLsToLoadGenericNonLinearCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLsFromLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "UnAssignLsFromLoadGenericNonLinearCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignLtToLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "AssignLtToLoadGenericNonLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLtToLoadGenericNonLinearCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLtFromLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "UnAssignLtFromLoadGenericNonLinearCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPtToLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "AssignPtToLoadGenericNonLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPtToLoadGenericNonLinearCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPtFromLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "UnAssignPtFromLoadGenericNonLinearCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQtToLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "AssignQtToLoadGenericNonLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQtToLoadGenericNonLinearCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignQtFromLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "UnAssignQtFromLoadGenericNonLinearCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpToLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "AssignTpToLoadGenericNonLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpToLoadGenericNonLinearCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTpFromLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "UnAssignTpFromLoadGenericNonLinearCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTqToLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "AssignTqToLoadGenericNonLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTqToLoadGenericNonLinearCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTqFromLoadGenericNonLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadGenericNonLinearId(), "UnAssignTqFromLoadGenericNonLinearCommand identifier should not be null" );
	}
