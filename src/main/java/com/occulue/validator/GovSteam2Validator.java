...
//		Assert.isNull( govSteam2.getGovSteam2Id(), "CreateGovSteam2Command identifier should be null" );
	...
	public void validate( AssignDbfToGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "AssignDbfToGovSteam2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDbfToGovSteam2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignDbfFromGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "UnAssignDbfFromGovSteam2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKToGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "AssignKToGovSteam2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKToGovSteam2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKFromGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "UnAssignKFromGovSteam2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMnefToGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "AssignMnefToGovSteam2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMnefToGovSteam2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMnefFromGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "UnAssignMnefFromGovSteam2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMxefToGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "AssignMxefToGovSteam2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMxefToGovSteam2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMxefFromGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "UnAssignMxefFromGovSteam2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPmaxToGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "AssignPmaxToGovSteam2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPmaxToGovSteam2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPmaxFromGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "UnAssignPmaxFromGovSteam2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPminToGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "AssignPminToGovSteam2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPminToGovSteam2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPminFromGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "UnAssignPminFromGovSteam2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "AssignT1ToGovSteam2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToGovSteam2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "UnAssignT1FromGovSteam2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "AssignT2ToGovSteam2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToGovSteam2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromGovSteam2Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteam2Id(), "UnAssignT2FromGovSteam2Command identifier should not be null" );
	}
