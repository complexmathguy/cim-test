...
//		Assert.isNull( powerTransformerEnd.getPowerTransformerEndId(), "CreatePowerTransformerEndCommand identifier should be null" );
	...
	public void validate( AssignBToPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "AssignBToPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBToPowerTransformerEndCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBFromPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "UnAssignBFromPowerTransformerEndCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignB0ToPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "AssignB0ToPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignB0ToPowerTransformerEndCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignB0FromPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "UnAssignB0FromPowerTransformerEndCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGToPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "AssignGToPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGToPowerTransformerEndCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGFromPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "UnAssignGFromPowerTransformerEndCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignG0ToPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "AssignG0ToPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignG0ToPowerTransformerEndCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignG0FromPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "UnAssignG0FromPowerTransformerEndCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPhaseAngleClockToPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "AssignPhaseAngleClockToPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPhaseAngleClockToPowerTransformerEndCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignPhaseAngleClockFromPowerTransformerEndCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignPhaseAngleClockFromPowerTransformerEndCommand should not be null" );
		Assert.notNull( command.getPowerTransformerEndId(), "UnAssignPhaseAngleClockFromPowerTransformerEndCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRToPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "AssignRToPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRToPowerTransformerEndCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRFromPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "UnAssignRFromPowerTransformerEndCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignR0ToPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "AssignR0ToPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignR0ToPowerTransformerEndCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignR0FromPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "UnAssignR0FromPowerTransformerEndCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRatedSToPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "AssignRatedSToPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRatedSToPowerTransformerEndCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRatedSFromPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "UnAssignRatedSFromPowerTransformerEndCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRatedUToPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "AssignRatedUToPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRatedUToPowerTransformerEndCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRatedUFromPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "UnAssignRatedUFromPowerTransformerEndCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXToPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "AssignXToPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXToPowerTransformerEndCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXFromPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "UnAssignXFromPowerTransformerEndCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignX0ToPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "AssignX0ToPowerTransformerEndCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignX0ToPowerTransformerEndCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignX0FromPowerTransformerEndCommand command ) throws Exception {
		...
		Assert.notNull( command.getPowerTransformerEndId(), "UnAssignX0FromPowerTransformerEndCommand identifier should not be null" );
	}
