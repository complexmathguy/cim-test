...
//		Assert.isNull( excIEEEST1A.getExcIEEEST1AId(), "CreateExcIEEEST1ACommand identifier should be null" );
	...
	public void validate( AssignIlrToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignIlrToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIlrToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIlrFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignIlrFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignKaToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignKaFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignKcToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignKcFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignKfToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignKfFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKlrToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignKlrToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKlrToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKlrFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignKlrFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPssinToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignPssinToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPssinToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPssinFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignPssinFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignTaToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignTaFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignTbToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignTbFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTb1ToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignTb1ToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTb1ToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTb1FromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignTb1FromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignTcToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignTcFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTc1ToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignTc1ToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTc1ToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTc1FromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignTc1FromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignTfToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignTfFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVamaxToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignVamaxToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVamaxToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVamaxFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignVamaxFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaminToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignVaminToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaminToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVaminFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignVaminFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVimaxToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignVimaxToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVimaxToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVimaxFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignVimaxFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignViminToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignViminToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignViminToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignViminFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignViminFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignVrmaxToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignVrmaxFromExcIEEEST1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "AssignVrminToExcIEEEST1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEST1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEST1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST1AId(), "UnAssignVrminFromExcIEEEST1ACommand identifier should not be null" );
	}
