...
//		Assert.isNull( govSteamIEEE1.getGovSteamIEEE1Id(), "CreateGovSteamIEEE1Command identifier should be null" );
	...
	public void validate( AssignKToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignKToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKFromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignKFromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK1ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignK1ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK1ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK1FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignK1FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK2ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignK2ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK2ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK2FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignK2FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK3ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignK3ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK3ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK3FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignK3FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK4ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignK4ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK4ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK4FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignK4FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK5ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignK5ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK5ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK5FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignK5FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK6ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignK6ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK6ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK6FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignK6FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK7ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignK7ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK7ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK7FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignK7FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK8ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignK8ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK8ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK8FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignK8FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignMwbaseToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignMwbaseFromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPmaxToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignPmaxToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPmaxToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPmaxFromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignPmaxFromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPminToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignPminToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPminToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPminFromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignPminFromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignT1ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignT1FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignT2ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignT2FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignT3ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignT3FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignT4ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignT4FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT5ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignT5ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT5ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT5FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignT5FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT6ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignT6ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT6ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT6FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignT6FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT7ToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignT7ToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT7ToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT7FromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignT7FromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUcToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignUcToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUcToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignUcFromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignUcFromGovSteamIEEE1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUoToGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "AssignUoToGovSteamIEEE1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUoToGovSteamIEEE1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignUoFromGovSteamIEEE1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamIEEE1Id(), "UnAssignUoFromGovSteamIEEE1Command identifier should not be null" );
	}
