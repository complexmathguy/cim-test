...
//		Assert.isNull( govSteamFV3.getGovSteamFV3Id(), "CreateGovSteamFV3Command identifier should be null" );
	...
	public void validate( AssignKToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignKToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKFromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignKFromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK1ToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignK1ToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK1ToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK1FromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignK1FromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK2ToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignK2ToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK2ToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK2FromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignK2FromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK3ToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignK3ToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK3ToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK3FromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignK3FromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignMwbaseToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignMwbaseFromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPmaxToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignPmaxToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPmaxToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPmaxFromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignPmaxFromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPminToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignPminToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPminToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPminFromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignPminFromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPrmaxToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignPrmaxToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPrmaxToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPrmaxFromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignPrmaxFromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignT1ToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignT1FromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignT2ToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignT2FromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignT3ToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignT3FromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignT4ToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4ToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignT4FromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT5ToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignT5ToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT5ToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT5FromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignT5FromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT6ToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignT6ToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT6ToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT6FromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignT6FromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignTaToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignTaFromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignTbToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignTbFromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignTcToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignTcFromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUcToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignUcToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUcToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignUcFromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignUcFromGovSteamFV3Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUoToGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "AssignUoToGovSteamFV3Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUoToGovSteamFV3Command assignment should not be null" );
	}
	...
	public void validate( UnAssignUoFromGovSteamFV3Command command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamFV3Id(), "UnAssignUoFromGovSteamFV3Command identifier should not be null" );
	}
