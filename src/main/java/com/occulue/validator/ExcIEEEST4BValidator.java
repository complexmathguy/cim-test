...
//		Assert.isNull( excIEEEST4B.getExcIEEEST4BId(), "CreateExcIEEEST4BCommand identifier should be null" );
	...
	public void validate( AssignKcToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignKcToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignKcFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKgToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignKgToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKgToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKgFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignKgFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignKiToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignKiFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKimToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignKimToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKimToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKimFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignKimFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKirToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignKirToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKirToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKirFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignKirFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignKpToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignKpFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpmToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignKpmToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpmToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpmFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignKpmFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKprToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignKprToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKprToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKprFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignKprFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignTaToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignTaFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignThetapToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignThetapToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignThetapToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignThetapFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignThetapFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVbmaxToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignVbmaxToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVbmaxToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVbmaxFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignVbmaxFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmmaxToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignVmmaxToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmmaxToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVmmaxFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignVmmaxFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmminToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignVmminToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmminToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVmminFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignVmminFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignVrmaxToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignVrmaxFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignVrminToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignVrminFromExcIEEEST4BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXlToExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "AssignXlToExcIEEEST4BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXlToExcIEEEST4BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXlFromExcIEEEST4BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST4BId(), "UnAssignXlFromExcIEEEST4BCommand identifier should not be null" );
	}
