...
//		Assert.isNull( excIEEEST6B.getExcIEEEST6BId(), "CreateExcIEEEST6BCommand identifier should be null" );
	...
	public void validate( AssignIlrToExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "AssignIlrToExcIEEEST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIlrToExcIEEEST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIlrFromExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "UnAssignIlrFromExcIEEEST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKciToExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "AssignKciToExcIEEEST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKciToExcIEEEST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKciFromExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "UnAssignKciFromExcIEEEST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKffToExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "AssignKffToExcIEEEST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKffToExcIEEEST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKffFromExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "UnAssignKffFromExcIEEEST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKgToExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "AssignKgToExcIEEEST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKgToExcIEEEST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKgFromExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "UnAssignKgFromExcIEEEST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiaToExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "AssignKiaToExcIEEEST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiaToExcIEEEST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiaFromExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "UnAssignKiaFromExcIEEEST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKlrToExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "AssignKlrToExcIEEEST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKlrToExcIEEEST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKlrFromExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "UnAssignKlrFromExcIEEEST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKmToExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "AssignKmToExcIEEEST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKmToExcIEEEST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKmFromExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "UnAssignKmFromExcIEEEST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpaToExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "AssignKpaToExcIEEEST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpaToExcIEEEST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpaFromExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "UnAssignKpaFromExcIEEEST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTgToExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "AssignTgToExcIEEEST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTgToExcIEEEST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTgFromExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "UnAssignTgFromExcIEEEST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVamaxToExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "AssignVamaxToExcIEEEST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVamaxToExcIEEEST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVamaxFromExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "UnAssignVamaxFromExcIEEEST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaminToExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "AssignVaminToExcIEEEST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaminToExcIEEEST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVaminFromExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "UnAssignVaminFromExcIEEEST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "AssignVrmaxToExcIEEEST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "UnAssignVrmaxFromExcIEEEST6BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "AssignVrminToExcIEEEST6BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEST6BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEST6BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST6BId(), "UnAssignVrminFromExcIEEEST6BCommand identifier should not be null" );
	}
