...
//		Assert.isNull( windContQIEC.getWindContQIECId(), "CreateWindContQIECCommand identifier should be null" );
	...
	public void validate( AssignIqh1ToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignIqh1ToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIqh1ToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIqh1FromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignIqh1FromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIqmaxToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignIqmaxToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIqmaxToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIqmaxFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignIqmaxFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIqminToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignIqminToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIqminToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIqminFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignIqminFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIqpostToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignIqpostToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIqpostToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIqpostFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignIqpostFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiqToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignKiqToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiqToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiqFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignKiqFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiuToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignKiuToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiuToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiuFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignKiuFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpqToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignKpqToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpqToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpqFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignKpqFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpuToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignKpuToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpuToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpuFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignKpuFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKqvToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignKqvToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKqvToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKqvFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignKqvFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQmaxToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignQmaxToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQmaxToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignQmaxFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignQmaxFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQminToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignQminToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQminToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignQminFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignQminFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRdroopToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignRdroopToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRdroopToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRdroopFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignRdroopFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTiqToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignTiqToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTiqToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTiqFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignTiqFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpfiltToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignTpfiltToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpfiltToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTpfiltFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignTpfiltFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpostToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignTpostToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpostToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTpostFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignTpostFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTqordToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignTqordToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTqordToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTqordFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignTqordFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTufiltToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignTufiltToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTufiltToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTufiltFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignTufiltFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUdb1ToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignUdb1ToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUdb1ToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUdb1FromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignUdb1FromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUdb2ToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignUdb2ToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUdb2ToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUdb2FromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignUdb2FromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUmaxToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignUmaxToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUmaxToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUmaxFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignUmaxFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUminToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignUminToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUminToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUminFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignUminFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUqdipToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignUqdipToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUqdipToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUqdipFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignUqdipFromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUref0ToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignUref0ToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUref0ToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUref0FromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignUref0FromWindContQIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXdroopToWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "AssignXdroopToWindContQIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXdroopToWindContQIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXdroopFromWindContQIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContQIECId(), "UnAssignXdroopFromWindContQIECCommand identifier should not be null" );
	}
