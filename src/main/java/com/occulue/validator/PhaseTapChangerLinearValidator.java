...
//		Assert.isNull( phaseTapChangerLinear.getPhaseTapChangerLinearId(), "CreatePhaseTapChangerLinearCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignStepPhaseShiftIncrementToPhaseTapChangerLinearCommand command ) throws Exception {
		Assert.notNull( command, "AssignStepPhaseShiftIncrementToPhaseTapChangerLinearCommand should not be null" );
		Assert.notNull( command.getPhaseTapChangerLinearId(), "AssignStepPhaseShiftIncrementToPhaseTapChangerLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignStepPhaseShiftIncrementToPhaseTapChangerLinearCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignStepPhaseShiftIncrementFromPhaseTapChangerLinearCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignStepPhaseShiftIncrementFromPhaseTapChangerLinearCommand should not be null" );
		Assert.notNull( command.getPhaseTapChangerLinearId(), "UnAssignStepPhaseShiftIncrementFromPhaseTapChangerLinearCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXMaxToPhaseTapChangerLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getPhaseTapChangerLinearId(), "AssignXMaxToPhaseTapChangerLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXMaxToPhaseTapChangerLinearCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXMaxFromPhaseTapChangerLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getPhaseTapChangerLinearId(), "UnAssignXMaxFromPhaseTapChangerLinearCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXMinToPhaseTapChangerLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getPhaseTapChangerLinearId(), "AssignXMinToPhaseTapChangerLinearCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXMinToPhaseTapChangerLinearCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXMinFromPhaseTapChangerLinearCommand command ) throws Exception {
		...
		Assert.notNull( command.getPhaseTapChangerLinearId(), "UnAssignXMinFromPhaseTapChangerLinearCommand identifier should not be null" );
	}
