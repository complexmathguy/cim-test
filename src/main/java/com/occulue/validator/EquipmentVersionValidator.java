...
//		Assert.isNull( equipmentVersion.getEquipmentVersionId(), "CreateEquipmentVersionCommand identifier should be null" );
	...
	public void validate( AssignBaseUMLToEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "AssignBaseUMLToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBaseUMLToEquipmentVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBaseUMLFromEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignBaseUMLFromEquipmentVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBaseURIcoreToEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "AssignBaseURIcoreToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBaseURIcoreToEquipmentVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBaseURIcoreFromEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignBaseURIcoreFromEquipmentVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBaseURIoperationToEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "AssignBaseURIoperationToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBaseURIoperationToEquipmentVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignBaseURIoperationFromEquipmentVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignBaseURIoperationFromEquipmentVersionCommand should not be null" );
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignBaseURIoperationFromEquipmentVersionCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignBaseURIshortCircuitToEquipmentVersionCommand command ) throws Exception {
		Assert.notNull( command, "AssignBaseURIshortCircuitToEquipmentVersionCommand should not be null" );
		Assert.notNull( command.getEquipmentVersionId(), "AssignBaseURIshortCircuitToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBaseURIshortCircuitToEquipmentVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignBaseURIshortCircuitFromEquipmentVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignBaseURIshortCircuitFromEquipmentVersionCommand should not be null" );
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignBaseURIshortCircuitFromEquipmentVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDateToEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "AssignDateToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDateToEquipmentVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDateFromEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignDateFromEquipmentVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDifferenceModelURIToEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "AssignDifferenceModelURIToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDifferenceModelURIToEquipmentVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignDifferenceModelURIFromEquipmentVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignDifferenceModelURIFromEquipmentVersionCommand should not be null" );
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignDifferenceModelURIFromEquipmentVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEntsoeUMLToEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "AssignEntsoeUMLToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEntsoeUMLToEquipmentVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEntsoeUMLFromEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignEntsoeUMLFromEquipmentVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEntsoeURIcoreToEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "AssignEntsoeURIcoreToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEntsoeURIcoreToEquipmentVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEntsoeURIcoreFromEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignEntsoeURIcoreFromEquipmentVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEntsoeURIoperationToEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "AssignEntsoeURIoperationToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEntsoeURIoperationToEquipmentVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignEntsoeURIoperationFromEquipmentVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignEntsoeURIoperationFromEquipmentVersionCommand should not be null" );
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignEntsoeURIoperationFromEquipmentVersionCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignEntsoeURIshortCircuitToEquipmentVersionCommand command ) throws Exception {
		Assert.notNull( command, "AssignEntsoeURIshortCircuitToEquipmentVersionCommand should not be null" );
		Assert.notNull( command.getEquipmentVersionId(), "AssignEntsoeURIshortCircuitToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEntsoeURIshortCircuitToEquipmentVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignEntsoeURIshortCircuitFromEquipmentVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignEntsoeURIshortCircuitFromEquipmentVersionCommand should not be null" );
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignEntsoeURIshortCircuitFromEquipmentVersionCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignModelDescriptionURIToEquipmentVersionCommand command ) throws Exception {
		Assert.notNull( command, "AssignModelDescriptionURIToEquipmentVersionCommand should not be null" );
		Assert.notNull( command.getEquipmentVersionId(), "AssignModelDescriptionURIToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignModelDescriptionURIToEquipmentVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignModelDescriptionURIFromEquipmentVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignModelDescriptionURIFromEquipmentVersionCommand should not be null" );
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignModelDescriptionURIFromEquipmentVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNamespaceRDFToEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "AssignNamespaceRDFToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNamespaceRDFToEquipmentVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNamespaceRDFFromEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignNamespaceRDFFromEquipmentVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNamespaceUMLToEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "AssignNamespaceUMLToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNamespaceUMLToEquipmentVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNamespaceUMLFromEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignNamespaceUMLFromEquipmentVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignShortNameToEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "AssignShortNameToEquipmentVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignShortNameToEquipmentVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignShortNameFromEquipmentVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquipmentVersionId(), "UnAssignShortNameFromEquipmentVersionCommand identifier should not be null" );
	}
