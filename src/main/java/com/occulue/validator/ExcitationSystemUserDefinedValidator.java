...
//		Assert.isNull( excitationSystemUserDefined.getExcitationSystemUserDefinedId(), "CreateExcitationSystemUserDefinedCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignProprietaryToExcitationSystemUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "AssignProprietaryToExcitationSystemUserDefinedCommand should not be null" );
		Assert.notNull( command.getExcitationSystemUserDefinedId(), "AssignProprietaryToExcitationSystemUserDefinedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProprietaryToExcitationSystemUserDefinedCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignProprietaryFromExcitationSystemUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignProprietaryFromExcitationSystemUserDefinedCommand should not be null" );
		Assert.notNull( command.getExcitationSystemUserDefinedId(), "UnAssignProprietaryFromExcitationSystemUserDefinedCommand identifier should not be null" );
	}
