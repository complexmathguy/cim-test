...
//		Assert.isNull( currentLimit.getCurrentLimitId(), "CreateCurrentLimitCommand identifier should be null" );
	...
	public void validate( AssignValueToCurrentLimitCommand command ) throws Exception {
		...
		Assert.notNull( command.getCurrentLimitId(), "AssignValueToCurrentLimitCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToCurrentLimitCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromCurrentLimitCommand command ) throws Exception {
		...
		Assert.notNull( command.getCurrentLimitId(), "UnAssignValueFromCurrentLimitCommand identifier should not be null" );
	}
