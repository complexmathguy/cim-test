...
//		Assert.isNull( excSCRX.getExcSCRXId(), "CreateExcSCRXCommand identifier should be null" );
	...
	public void validate( AssignCswitchToExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "AssignCswitchToExcSCRXCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignCswitchToExcSCRXCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignCswitchFromExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "UnAssignCswitchFromExcSCRXCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEmaxToExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "AssignEmaxToExcSCRXCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEmaxToExcSCRXCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEmaxFromExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "UnAssignEmaxFromExcSCRXCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEminToExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "AssignEminToExcSCRXCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEminToExcSCRXCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEminFromExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "UnAssignEminFromExcSCRXCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKToExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKToExcSCRXCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKFromExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "UnAssignKFromExcSCRXCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRcrfdToExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "AssignRcrfdToExcSCRXCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRcrfdToExcSCRXCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRcrfdFromExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "UnAssignRcrfdFromExcSCRXCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTatbToExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "AssignTatbToExcSCRXCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTatbToExcSCRXCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTatbFromExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "UnAssignTatbFromExcSCRXCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "AssignTbToExcSCRXCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcSCRXCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "UnAssignTbFromExcSCRXCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "AssignTeToExcSCRXCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcSCRXCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcSCRXCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcSCRXId(), "UnAssignTeFromExcSCRXCommand identifier should not be null" );
	}
