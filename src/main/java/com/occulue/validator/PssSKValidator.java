...
//		Assert.isNull( pssSK.getPssSKId(), "CreatePssSKCommand identifier should be null" );
	...
	public void validate( UnAssignK1FromPssSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSKId(), "UnAssignK1FromPssSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignK2FromPssSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSKId(), "UnAssignK2FromPssSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignK3FromPssSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSKId(), "UnAssignK3FromPssSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT1FromPssSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSKId(), "UnAssignT1FromPssSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT2FromPssSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSKId(), "UnAssignT2FromPssSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT3FromPssSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSKId(), "UnAssignT3FromPssSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT4FromPssSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSKId(), "UnAssignT4FromPssSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT5FromPssSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSKId(), "UnAssignT5FromPssSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignT6FromPssSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSKId(), "UnAssignT6FromPssSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsmaxToPssSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVsmaxToPssSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsmaxFromPssSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSKId(), "UnAssignVsmaxFromPssSKCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsminToPssSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVsminToPssSKCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsminFromPssSKCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssSKId(), "UnAssignVsminFromPssSKCommand identifier should not be null" );
	}
