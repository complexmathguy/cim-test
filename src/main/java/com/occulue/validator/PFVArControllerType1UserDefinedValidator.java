...
//		Assert.isNull( pFVArControllerType1UserDefined.getPFVArControllerType1UserDefinedId(), "CreatePFVArControllerType1UserDefinedCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignProprietaryToPFVArControllerType1UserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "AssignProprietaryToPFVArControllerType1UserDefinedCommand should not be null" );
		Assert.notNull( command.getPFVArControllerType1UserDefinedId(), "AssignProprietaryToPFVArControllerType1UserDefinedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProprietaryToPFVArControllerType1UserDefinedCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignProprietaryFromPFVArControllerType1UserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignProprietaryFromPFVArControllerType1UserDefinedCommand should not be null" );
		Assert.notNull( command.getPFVArControllerType1UserDefinedId(), "UnAssignProprietaryFromPFVArControllerType1UserDefinedCommand identifier should not be null" );
	}
