...
//		Assert.isNull( excIEEEAC2A.getExcIEEEAC2AId(), "CreateExcIEEEAC2ACommand identifier should be null" );
	...
	public void validate( AssignKaToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignKaToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignKaFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKbToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignKbToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKbToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKbFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignKbFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignKcToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignKcFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignKdToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignKdFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignKeToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignKeFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignKfToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignKfFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKhToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignKhToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKhToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKhFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignKhFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve1ToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignSeve1ToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve1ToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve1FromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignSeve1FromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve2ToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignSeve2ToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve2ToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve2FromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignSeve2FromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignTaToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignTaFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignTbToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignTbFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignTcToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignTcFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignTeToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignTeFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignTfToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignTfFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVamaxToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignVamaxToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVamaxToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVamaxFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignVamaxFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaminToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignVaminToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaminToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVaminFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignVaminFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe1ToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignVe1ToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe1ToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe1FromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignVe1FromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe2ToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignVe2ToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe2ToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe2FromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignVe2FromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVfemaxToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignVfemaxToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVfemaxToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVfemaxFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignVfemaxFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignVrmaxToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignVrmaxFromExcIEEEAC2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "AssignVrminToExcIEEEAC2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEAC2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEAC2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC2AId(), "UnAssignVrminFromExcIEEEAC2ACommand identifier should not be null" );
	}
