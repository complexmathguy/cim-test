...
//		Assert.isNull( excANS.getExcANSId(), "CreateExcANSCommand identifier should be null" );
	...
	public void validate( AssignBlintToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "AssignBlintToExcANSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBlintToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBlintFromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignBlintFromExcANSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIfmnToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "AssignIfmnToExcANSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIfmnToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIfmnFromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignIfmnFromExcANSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIfmxToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "AssignIfmxToExcANSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIfmxToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIfmxFromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignIfmxFromExcANSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK2ToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignK2ToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK2FromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignK2FromExcANSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK3ToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignK3ToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK3FromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignK3FromExcANSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKceToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKceToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKceFromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignKceFromExcANSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKrveccToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "AssignKrveccToExcANSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKrveccToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKrveccFromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignKrveccFromExcANSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKvfifToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "AssignKvfifToExcANSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKvfifToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKvfifFromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignKvfifFromExcANSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT1ToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignT1FromExcANSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT2ToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignT2FromExcANSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT3ToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignT3FromExcANSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignTbToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignTbFromExcANSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmnToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "AssignVrmnToExcANSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmnToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmnFromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignVrmnFromExcANSCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmxToExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "AssignVrmxToExcANSCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmxToExcANSCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmxFromExcANSCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcANSId(), "UnAssignVrmxFromExcANSCommand identifier should not be null" );
	}
