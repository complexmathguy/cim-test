...
//		Assert.isNull( pss2ST.getPss2STId(), "CreatePss2STCommand identifier should be null" );
	...
	public void validate( AssignK1ToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignK1ToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK1FromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignK1FromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK2ToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignK2ToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK2FromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignK2FromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignLsmaxToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "AssignLsmaxToPss2STCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLsmaxToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLsmaxFromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignLsmaxFromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignLsminToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "AssignLsminToPss2STCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignLsminToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignLsminFromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignLsminFromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT1ToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignT1FromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT10ToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT10ToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT10FromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignT10FromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT2ToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignT2FromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT3ToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignT3FromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT4ToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignT4FromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT5ToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT5ToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT5FromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignT5FromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT6ToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT6ToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT6FromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignT6FromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT7ToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT7ToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT7FromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignT7FromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT8ToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT8ToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT8FromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignT8FromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT9ToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignT9ToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT9FromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignT9FromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVclToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVclToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVclFromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignVclFromPss2STCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVcuToPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVcuToPss2STCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVcuFromPss2STCommand command ) throws Exception {
		...
		Assert.notNull( command.getPss2STId(), "UnAssignVcuFromPss2STCommand identifier should not be null" );
	}
