...
//		Assert.isNull( excIEEEAC1A.getExcIEEEAC1AId(), "CreateExcIEEEAC1ACommand identifier should be null" );
	...
	public void validate( AssignKaToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignKaToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignKaFromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignKcToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignKcFromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignKdToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignKdFromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignKeToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignKeFromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignKfToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignKfFromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve1ToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignSeve1ToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve1ToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve1FromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignSeve1FromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve2ToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignSeve2ToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve2ToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve2FromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignSeve2FromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignTaToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignTaFromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignTbToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignTbFromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignTcToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignTcFromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignTeToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignTeFromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignTfToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignTfFromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVamaxToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignVamaxToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVamaxToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVamaxFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignVamaxFromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaminToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignVaminToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaminToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVaminFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignVaminFromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe1ToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignVe1ToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe1ToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe1FromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignVe1FromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe2ToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignVe2ToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe2ToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe2FromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignVe2FromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignVrmaxToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignVrmaxFromExcIEEEAC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "AssignVrminToExcIEEEAC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEAC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEAC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC1AId(), "UnAssignVrminFromExcIEEEAC1ACommand identifier should not be null" );
	}
