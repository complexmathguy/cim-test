...
//		Assert.isNull( excIEEEAC3A.getExcIEEEAC3AId(), "CreateExcIEEEAC3ACommand identifier should be null" );
	...
	public void validate( AssignEfdnToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignEfdnToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdnToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdnFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignEfdnFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignKaToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignKaFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignKcToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignKcFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignKdToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignKdFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignKeToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignKeFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignKfToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignKfFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKnToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignKnToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKnToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKnFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignKnFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKrToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignKrToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKrToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKrFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignKrFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve1ToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignSeve1ToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve1ToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve1FromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignSeve1FromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve2ToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignSeve2ToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve2ToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve2FromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignSeve2FromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignTaToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignTaFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignTbToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignTbFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignTcToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignTcFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignTeToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignTeFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignTfToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignTfFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVamaxToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignVamaxToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVamaxToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVamaxFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignVamaxFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaminToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignVaminToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaminToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVaminFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignVaminFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe1ToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignVe1ToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe1ToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe1FromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignVe1FromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe2ToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignVe2ToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe2ToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe2FromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignVe2FromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVeminToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignVeminToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVeminToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVeminFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignVeminFromExcIEEEAC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVfemaxToExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "AssignVfemaxToExcIEEEAC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVfemaxToExcIEEEAC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVfemaxFromExcIEEEAC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC3AId(), "UnAssignVfemaxFromExcIEEEAC3ACommand identifier should not be null" );
	}
