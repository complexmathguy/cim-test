...
//		Assert.isNull( dCShunt.getDCShuntId(), "CreateDCShuntCommand identifier should be null" );
	...
	public void validate( AssignCapacitanceToDCShuntCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCShuntId(), "AssignCapacitanceToDCShuntCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignCapacitanceToDCShuntCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignCapacitanceFromDCShuntCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCShuntId(), "UnAssignCapacitanceFromDCShuntCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRatedUdcToDCShuntCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCShuntId(), "AssignRatedUdcToDCShuntCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRatedUdcToDCShuntCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRatedUdcFromDCShuntCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCShuntId(), "UnAssignRatedUdcFromDCShuntCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignResistanceToDCShuntCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCShuntId(), "AssignResistanceToDCShuntCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignResistanceToDCShuntCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignResistanceFromDCShuntCommand command ) throws Exception {
		...
		Assert.notNull( command.getDCShuntId(), "UnAssignResistanceFromDCShuntCommand identifier should not be null" );
	}
