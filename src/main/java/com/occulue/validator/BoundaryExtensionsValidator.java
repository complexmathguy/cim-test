...
//		Assert.isNull( boundaryExtensions.getBoundaryExtensionsId(), "CreateBoundaryExtensionsCommand identifier should be null" );
	...
	public void validate( AssignBoundaryPointToBoundaryExtensionsCommand command ) throws Exception {
		...
		Assert.notNull( command.getBoundaryExtensionsId(), "AssignBoundaryPointToBoundaryExtensionsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBoundaryPointToBoundaryExtensionsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignBoundaryPointFromBoundaryExtensionsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignBoundaryPointFromBoundaryExtensionsCommand should not be null" );
		Assert.notNull( command.getBoundaryExtensionsId(), "UnAssignBoundaryPointFromBoundaryExtensionsCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignFromEndIsoCodeToBoundaryExtensionsCommand command ) throws Exception {
		...
		Assert.notNull( command.getBoundaryExtensionsId(), "AssignFromEndIsoCodeToBoundaryExtensionsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFromEndIsoCodeToBoundaryExtensionsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignFromEndIsoCodeFromBoundaryExtensionsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignFromEndIsoCodeFromBoundaryExtensionsCommand should not be null" );
		Assert.notNull( command.getBoundaryExtensionsId(), "UnAssignFromEndIsoCodeFromBoundaryExtensionsCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignFromEndNameToBoundaryExtensionsCommand command ) throws Exception {
		...
		Assert.notNull( command.getBoundaryExtensionsId(), "AssignFromEndNameToBoundaryExtensionsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFromEndNameToBoundaryExtensionsCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignFromEndNameFromBoundaryExtensionsCommand command ) throws Exception {
		...
		Assert.notNull( command.getBoundaryExtensionsId(), "UnAssignFromEndNameFromBoundaryExtensionsCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignFromEndNameTsoToBoundaryExtensionsCommand command ) throws Exception {
		...
		Assert.notNull( command.getBoundaryExtensionsId(), "AssignFromEndNameTsoToBoundaryExtensionsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFromEndNameTsoToBoundaryExtensionsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignFromEndNameTsoFromBoundaryExtensionsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignFromEndNameTsoFromBoundaryExtensionsCommand should not be null" );
		Assert.notNull( command.getBoundaryExtensionsId(), "UnAssignFromEndNameTsoFromBoundaryExtensionsCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignToEndIsoCodeToBoundaryExtensionsCommand command ) throws Exception {
		...
		Assert.notNull( command.getBoundaryExtensionsId(), "AssignToEndIsoCodeToBoundaryExtensionsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignToEndIsoCodeToBoundaryExtensionsCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignToEndIsoCodeFromBoundaryExtensionsCommand command ) throws Exception {
		...
		Assert.notNull( command.getBoundaryExtensionsId(), "UnAssignToEndIsoCodeFromBoundaryExtensionsCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignToEndNameToBoundaryExtensionsCommand command ) throws Exception {
		...
		Assert.notNull( command.getBoundaryExtensionsId(), "AssignToEndNameToBoundaryExtensionsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignToEndNameToBoundaryExtensionsCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignToEndNameFromBoundaryExtensionsCommand command ) throws Exception {
		...
		Assert.notNull( command.getBoundaryExtensionsId(), "UnAssignToEndNameFromBoundaryExtensionsCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignToEndNameTsoToBoundaryExtensionsCommand command ) throws Exception {
		...
		Assert.notNull( command.getBoundaryExtensionsId(), "AssignToEndNameTsoToBoundaryExtensionsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignToEndNameTsoToBoundaryExtensionsCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignToEndNameTsoFromBoundaryExtensionsCommand command ) throws Exception {
		...
		Assert.notNull( command.getBoundaryExtensionsId(), "UnAssignToEndNameTsoFromBoundaryExtensionsCommand identifier should not be null" );
	}
