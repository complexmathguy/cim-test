...
//		Assert.isNull( powerSystemStabilizerUserDefined.getPowerSystemStabilizerUserDefinedId(), "CreatePowerSystemStabilizerUserDefinedCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignProprietaryToPowerSystemStabilizerUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "AssignProprietaryToPowerSystemStabilizerUserDefinedCommand should not be null" );
		Assert.notNull( command.getPowerSystemStabilizerUserDefinedId(), "AssignProprietaryToPowerSystemStabilizerUserDefinedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProprietaryToPowerSystemStabilizerUserDefinedCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignProprietaryFromPowerSystemStabilizerUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignProprietaryFromPowerSystemStabilizerUserDefinedCommand should not be null" );
		Assert.notNull( command.getPowerSystemStabilizerUserDefinedId(), "UnAssignProprietaryFromPowerSystemStabilizerUserDefinedCommand identifier should not be null" );
	}
