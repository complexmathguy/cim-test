...
//		Assert.isNull( windContPType4bIEC.getWindContPType4bIECId(), "CreateWindContPType4bIECCommand identifier should be null" );
	...
	public void validate( AssignDpmaxToWindContPType4bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4bIECId(), "AssignDpmaxToWindContPType4bIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDpmaxToWindContPType4bIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDpmaxFromWindContPType4bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4bIECId(), "UnAssignDpmaxFromWindContPType4bIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpaeroToWindContPType4bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4bIECId(), "AssignTpaeroToWindContPType4bIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpaeroToWindContPType4bIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTpaeroFromWindContPType4bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4bIECId(), "UnAssignTpaeroFromWindContPType4bIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpordToWindContPType4bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4bIECId(), "AssignTpordToWindContPType4bIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpordToWindContPType4bIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTpordFromWindContPType4bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4bIECId(), "UnAssignTpordFromWindContPType4bIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTufiltToWindContPType4bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4bIECId(), "AssignTufiltToWindContPType4bIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTufiltToWindContPType4bIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTufiltFromWindContPType4bIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType4bIECId(), "UnAssignTufiltFromWindContPType4bIECCommand identifier should not be null" );
	}
