...
//		Assert.isNull( windPitchContEmulIEC.getWindPitchContEmulIECId(), "CreateWindPitchContEmulIECCommand identifier should be null" );
	...
	public void validate( AssignKdroopToWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "AssignKdroopToWindPitchContEmulIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdroopToWindPitchContEmulIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdroopFromWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "UnAssignKdroopFromWindPitchContEmulIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKipceToWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "AssignKipceToWindPitchContEmulIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKipceToWindPitchContEmulIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKipceFromWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "UnAssignKipceFromWindPitchContEmulIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKomegaaeroToWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "AssignKomegaaeroToWindPitchContEmulIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKomegaaeroToWindPitchContEmulIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKomegaaeroFromWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "UnAssignKomegaaeroFromWindPitchContEmulIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKppceToWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "AssignKppceToWindPitchContEmulIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKppceToWindPitchContEmulIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKppceFromWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "UnAssignKppceFromWindPitchContEmulIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignOmegarefToWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "AssignOmegarefToWindPitchContEmulIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignOmegarefToWindPitchContEmulIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignOmegarefFromWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "UnAssignOmegarefFromWindPitchContEmulIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPimaxToWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "AssignPimaxToWindPitchContEmulIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPimaxToWindPitchContEmulIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPimaxFromWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "UnAssignPimaxFromWindPitchContEmulIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPiminToWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "AssignPiminToWindPitchContEmulIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPiminToWindPitchContEmulIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPiminFromWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "UnAssignPiminFromWindPitchContEmulIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "AssignT1ToWindPitchContEmulIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToWindPitchContEmulIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "UnAssignT1FromWindPitchContEmulIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "AssignT2ToWindPitchContEmulIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToWindPitchContEmulIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "UnAssignT2FromWindPitchContEmulIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpeToWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "AssignTpeToWindPitchContEmulIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpeToWindPitchContEmulIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTpeFromWindPitchContEmulIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPitchContEmulIECId(), "UnAssignTpeFromWindPitchContEmulIECCommand identifier should not be null" );
	}
