...
//		Assert.isNull( seconds.getSecondsId(), "CreateSecondsCommand identifier should be null" );
	...
	public void validate( AssignValueToSecondsCommand command ) throws Exception {
		...
		Assert.notNull( command.getSecondsId(), "AssignValueToSecondsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToSecondsCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromSecondsCommand command ) throws Exception {
		...
		Assert.notNull( command.getSecondsId(), "UnAssignValueFromSecondsCommand identifier should not be null" );
	}
