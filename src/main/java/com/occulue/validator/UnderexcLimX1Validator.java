...
//		Assert.isNull( underexcLimX1.getUnderexcLimX1Id(), "CreateUnderexcLimX1Command identifier should be null" );
	...
	public void validate( AssignKToUnderexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX1Id(), "AssignKToUnderexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKToUnderexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKFromUnderexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX1Id(), "UnAssignKFromUnderexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKf2ToUnderexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX1Id(), "AssignKf2ToUnderexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKf2ToUnderexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKf2FromUnderexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX1Id(), "UnAssignKf2FromUnderexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKmToUnderexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX1Id(), "AssignKmToUnderexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKmToUnderexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKmFromUnderexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX1Id(), "UnAssignKmFromUnderexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMelmaxToUnderexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX1Id(), "AssignMelmaxToUnderexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMelmaxToUnderexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMelmaxFromUnderexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX1Id(), "UnAssignMelmaxFromUnderexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTf2ToUnderexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX1Id(), "AssignTf2ToUnderexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTf2ToUnderexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTf2FromUnderexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX1Id(), "UnAssignTf2FromUnderexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTmToUnderexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX1Id(), "AssignTmToUnderexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTmToUnderexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTmFromUnderexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLimX1Id(), "UnAssignTmFromUnderexcLimX1Command identifier should not be null" );
	}
