...
//		Assert.isNull( analog.getAnalogId(), "CreateAnalogCommand identifier should be null" );
	...
	public void validate( AssignPositiveFlowInToAnalogCommand command ) throws Exception {
		...
		Assert.notNull( command.getAnalogId(), "AssignPositiveFlowInToAnalogCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPositiveFlowInToAnalogCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPositiveFlowInFromAnalogCommand command ) throws Exception {
		...
		Assert.notNull( command.getAnalogId(), "UnAssignPositiveFlowInFromAnalogCommand identifier should not be null" );
	}
