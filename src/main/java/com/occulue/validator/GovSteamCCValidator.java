...
//		Assert.isNull( govSteamCC.getGovSteamCCId(), "CreateGovSteamCCCommand identifier should be null" );
	...
	public void validate( AssignDhpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignDhpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDhpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDhpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignDhpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDlpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignDlpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDlpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDlpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignDlpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignFhpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignFhpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFhpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignFhpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignFhpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignFlpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignFlpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignFlpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignFlpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignFlpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignMwbaseToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignMwbaseFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPmaxhpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignPmaxhpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPmaxhpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPmaxhpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignPmaxhpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPmaxlpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignPmaxlpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPmaxlpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPmaxlpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignPmaxlpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRhpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignRhpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRhpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRhpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignRhpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRlpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignRlpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRlpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRlpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignRlpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1hpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignT1hpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1hpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1hpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignT1hpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1lpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignT1lpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1lpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1lpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignT1lpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3hpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignT3hpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3hpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT3hpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignT3hpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3lpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignT3lpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3lpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT3lpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignT3lpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4hpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignT4hpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4hpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT4hpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignT4hpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4lpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignT4lpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4lpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT4lpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignT4lpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT5hpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignT5hpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT5hpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT5hpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignT5hpFromGovSteamCCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT5lpToGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "AssignT5lpToGovSteamCCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT5lpToGovSteamCCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT5lpFromGovSteamCCCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamCCId(), "UnAssignT5lpFromGovSteamCCCommand identifier should not be null" );
	}
