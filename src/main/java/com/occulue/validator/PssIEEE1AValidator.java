...
//		Assert.isNull( pssIEEE1A.getPssIEEE1AId(), "CreatePssIEEE1ACommand identifier should be null" );
	...
	public void validate( AssignA1ToPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "AssignA1ToPssIEEE1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA1ToPssIEEE1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignA1FromPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "UnAssignA1FromPssIEEE1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignA2ToPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "AssignA2ToPssIEEE1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA2ToPssIEEE1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignA2FromPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "UnAssignA2FromPssIEEE1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKsToPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "AssignKsToPssIEEE1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKsToPssIEEE1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKsFromPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "UnAssignKsFromPssIEEE1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "AssignT1ToPssIEEE1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToPssIEEE1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "UnAssignT1FromPssIEEE1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "AssignT2ToPssIEEE1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToPssIEEE1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "UnAssignT2FromPssIEEE1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "AssignT3ToPssIEEE1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToPssIEEE1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "UnAssignT3FromPssIEEE1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "AssignT4ToPssIEEE1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4ToPssIEEE1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "UnAssignT4FromPssIEEE1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT5ToPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "AssignT5ToPssIEEE1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT5ToPssIEEE1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT5FromPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "UnAssignT5FromPssIEEE1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT6ToPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "AssignT6ToPssIEEE1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT6ToPssIEEE1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT6FromPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "UnAssignT6FromPssIEEE1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "AssignVrmaxToPssIEEE1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToPssIEEE1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "UnAssignVrmaxFromPssIEEE1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "AssignVrminToPssIEEE1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToPssIEEE1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromPssIEEE1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE1AId(), "UnAssignVrminFromPssIEEE1ACommand identifier should not be null" );
	}
