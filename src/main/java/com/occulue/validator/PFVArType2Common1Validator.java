...
//		Assert.isNull( pFVArType2Common1.getPFVArType2Common1Id(), "CreatePFVArType2Common1Command identifier should be null" );
	...
	public void validate( AssignJToPFVArType2Common1Command command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2Common1Id(), "AssignJToPFVArType2Common1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignJToPFVArType2Common1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignJFromPFVArType2Common1Command command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2Common1Id(), "UnAssignJFromPFVArType2Common1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToPFVArType2Common1Command command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2Common1Id(), "AssignKiToPFVArType2Common1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToPFVArType2Common1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromPFVArType2Common1Command command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2Common1Id(), "UnAssignKiFromPFVArType2Common1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToPFVArType2Common1Command command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2Common1Id(), "AssignKpToPFVArType2Common1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToPFVArType2Common1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromPFVArType2Common1Command command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2Common1Id(), "UnAssignKpFromPFVArType2Common1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMaxToPFVArType2Common1Command command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2Common1Id(), "AssignMaxToPFVArType2Common1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMaxToPFVArType2Common1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMaxFromPFVArType2Common1Command command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2Common1Id(), "UnAssignMaxFromPFVArType2Common1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRefToPFVArType2Common1Command command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2Common1Id(), "AssignRefToPFVArType2Common1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRefToPFVArType2Common1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignRefFromPFVArType2Common1Command command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType2Common1Id(), "UnAssignRefFromPFVArType2Common1Command identifier should not be null" );
	}
