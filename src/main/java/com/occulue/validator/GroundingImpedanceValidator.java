...
//		Assert.isNull( groundingImpedance.getGroundingImpedanceId(), "CreateGroundingImpedanceCommand identifier should be null" );
	...
	public void validate( AssignXToGroundingImpedanceCommand command ) throws Exception {
		...
		Assert.notNull( command.getGroundingImpedanceId(), "AssignXToGroundingImpedanceCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXToGroundingImpedanceCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXFromGroundingImpedanceCommand command ) throws Exception {
		...
		Assert.notNull( command.getGroundingImpedanceId(), "UnAssignXFromGroundingImpedanceCommand identifier should not be null" );
	}
