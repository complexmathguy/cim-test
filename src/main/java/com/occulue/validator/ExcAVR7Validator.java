...
//		Assert.isNull( excAVR7.getExcAVR7Id(), "CreateExcAVR7Command identifier should be null" );
	...
	public void validate( AssignA1ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignA1ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA1ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignA1FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignA1FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignA2ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignA2ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA2ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignA2FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignA2FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignA3ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignA3ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA3ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignA3FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignA3FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignA4ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignA4ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA4ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignA4FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignA4FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignA5ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignA5ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA5ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignA5FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignA5FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignA6ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignA6ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA6ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignA6FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignA6FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK1ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignK1ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK1ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK1FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignK1FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK3ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignK3ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK3ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK3FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignK3FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK5ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignK5ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK5ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignK5FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignK5FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignT1ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignT1FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignT2ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignT2FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignT3ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignT3FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignT4ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignT4FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT5ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignT5ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT5ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT5FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignT5FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT6ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignT6ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT6ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT6FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignT6FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmax1ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignVmax1ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmax1ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVmax1FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignVmax1FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmax3ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignVmax3ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmax3ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVmax3FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignVmax3FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmax5ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignVmax5ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmax5ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVmax5FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignVmax5FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmin1ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignVmin1ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmin1ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVmin1FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignVmin1FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmin3ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignVmin3ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmin3ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVmin3FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignVmin3FromExcAVR7Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmin5ToExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "AssignVmin5ToExcAVR7Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmin5ToExcAVR7Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVmin5FromExcAVR7Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR7Id(), "UnAssignVmin5FromExcAVR7Command identifier should not be null" );
	}
