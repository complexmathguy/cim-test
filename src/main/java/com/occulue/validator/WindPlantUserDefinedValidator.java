...
//		Assert.isNull( windPlantUserDefined.getWindPlantUserDefinedId(), "CreateWindPlantUserDefinedCommand identifier should be null" );
	...
	public void validate( AssignProprietaryToWindPlantUserDefinedCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindPlantUserDefinedId(), "AssignProprietaryToWindPlantUserDefinedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProprietaryToWindPlantUserDefinedCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignProprietaryFromWindPlantUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignProprietaryFromWindPlantUserDefinedCommand should not be null" );
		Assert.notNull( command.getWindPlantUserDefinedId(), "UnAssignProprietaryFromWindPlantUserDefinedCommand identifier should not be null" );
	}
