...
//		Assert.isNull( monthDayInterval.getMonthDayIntervalId(), "CreateMonthDayIntervalCommand identifier should be null" );
	...
	public void validate( AssignEndToMonthDayIntervalCommand command ) throws Exception {
		...
		Assert.notNull( command.getMonthDayIntervalId(), "AssignEndToMonthDayIntervalCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEndToMonthDayIntervalCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEndFromMonthDayIntervalCommand command ) throws Exception {
		...
		Assert.notNull( command.getMonthDayIntervalId(), "UnAssignEndFromMonthDayIntervalCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignStartToMonthDayIntervalCommand command ) throws Exception {
		...
		Assert.notNull( command.getMonthDayIntervalId(), "AssignStartToMonthDayIntervalCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignStartToMonthDayIntervalCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignStartFromMonthDayIntervalCommand command ) throws Exception {
		...
		Assert.notNull( command.getMonthDayIntervalId(), "UnAssignStartFromMonthDayIntervalCommand identifier should not be null" );
	}
