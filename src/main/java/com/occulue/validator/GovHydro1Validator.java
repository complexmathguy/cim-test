...
//		Assert.isNull( govHydro1.getGovHydro1Id(), "CreateGovHydro1Command identifier should be null" );
	...
	public void validate( AssignAtToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignAtToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAtToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignAtFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignAtFromGovHydro1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDturbToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignDturbToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDturbToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignDturbFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignDturbFromGovHydro1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGmaxToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignGmaxToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGmaxToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignGmaxFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignGmaxFromGovHydro1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGminToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignGminToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGminToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignGminFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignGminFromGovHydro1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignHdamToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignHdamToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignHdamToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignHdamFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignHdamFromGovHydro1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignMwbaseToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignMwbaseFromGovHydro1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQnlToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignQnlToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQnlToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignQnlFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignQnlFromGovHydro1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRpermToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignRpermToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRpermToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignRpermFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignRpermFromGovHydro1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRtempToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignRtempToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRtempToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignRtempFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignRtempFromGovHydro1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignTfToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignTfFromGovHydro1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTgToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignTgToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTgToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTgFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignTgFromGovHydro1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTrToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignTrToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTrToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTrFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignTrFromGovHydro1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTwToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignTwToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTwToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTwFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignTwFromGovHydro1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVelmToGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "AssignVelmToGovHydro1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVelmToGovHydro1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVelmFromGovHydro1Command command ) throws Exception {
		...
		Assert.notNull( command.getGovHydro1Id(), "UnAssignVelmFromGovHydro1Command identifier should not be null" );
	}
