...
//		Assert.isNull( govHydroPID.getGovHydroPIDId(), "CreateGovHydroPIDCommand identifier should be null" );
	...
	public void validate( AssignAturbToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignAturbToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAturbToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAturbFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignAturbFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBturbToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignBturbToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBturbToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBturbFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignBturbFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDb1ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignDb1ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDb1ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDb1FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignDb1FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDb2ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignDb2ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDb2ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDb2FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignDb2FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEpsToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignEpsToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEpsToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEpsFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignEpsFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGv1ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignGv1ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGv1ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGv1FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignGv1FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGv2ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignGv2ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGv2ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGv2FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignGv2FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGv3ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignGv3ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGv3ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGv3FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignGv3FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGv4ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignGv4ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGv4ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGv4FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignGv4FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGv5ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignGv5ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGv5ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGv5FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignGv5FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignGv6ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignGv6ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignGv6ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignGv6FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignGv6FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignInputSignalToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignInputSignalToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignInputSignalToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignInputSignalFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignInputSignalFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignKdToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignKdFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKgToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignKgToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKgToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKgFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignKgFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignKiToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignKiFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignKpToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignKpFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignMwbaseToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignMwbaseFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPgv1ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignPgv1ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPgv1ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPgv1FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignPgv1FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPgv2ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignPgv2ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPgv2ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPgv2FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignPgv2FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPgv3ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignPgv3ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPgv3ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPgv3FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignPgv3FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPgv4ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignPgv4ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPgv4ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPgv4FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignPgv4FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPgv5ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignPgv5ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPgv5ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPgv5FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignPgv5FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPgv6ToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignPgv6ToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPgv6ToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPgv6FromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignPgv6FromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPmaxToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignPmaxToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPmaxToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPmaxFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignPmaxFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPminToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignPminToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPminToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPminFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignPminFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignRToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignRFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTdToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignTdToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTdToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTdFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignTdFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignTfToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignTfFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignTpToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTpFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignTpFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTtToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignTtToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTtToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTtFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignTtFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTturbToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignTturbToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTturbToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTturbFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignTturbFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVelclToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignVelclToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVelclToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVelclFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignVelclFromGovHydroPIDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVelopToGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "AssignVelopToGovHydroPIDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVelopToGovHydroPIDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVelopFromGovHydroPIDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPIDId(), "UnAssignVelopFromGovHydroPIDCommand identifier should not be null" );
	}
