...
//		Assert.isNull( pssIEEE3B.getPssIEEE3BId(), "CreatePssIEEE3BCommand identifier should be null" );
	...
	public void validate( AssignA1ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignA1ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA1ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignA1FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignA1FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignA2ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignA2ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA2ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignA2FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignA2FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignA3ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignA3ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA3ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignA3FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignA3FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignA4ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignA4ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA4ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignA4FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignA4FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignA5ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignA5ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA5ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignA5FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignA5FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignA6ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignA6ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA6ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignA6FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignA6FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignA7ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignA7ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA7ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignA7FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignA7FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignA8ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignA8ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignA8ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignA8FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignA8FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKs1ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignKs1ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKs1ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKs1FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignKs1FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKs2ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignKs2ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKs2ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKs2FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignKs2FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignT1ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignT1FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignT2ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignT2FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTw1ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignTw1ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTw1ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTw1FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignTw1FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTw2ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignTw2ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTw2ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTw2FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignTw2FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTw3ToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignTw3ToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTw3ToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTw3FromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignTw3FromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVstmaxToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignVstmaxToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVstmaxToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVstmaxFromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignVstmaxFromPssIEEE3BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVstminToPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "AssignVstminToPssIEEE3BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVstminToPssIEEE3BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVstminFromPssIEEE3BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE3BId(), "UnAssignVstminFromPssIEEE3BCommand identifier should not be null" );
	}
