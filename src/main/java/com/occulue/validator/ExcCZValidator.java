...
//		Assert.isNull( excCZ.getExcCZId(), "CreateExcCZCommand identifier should be null" );
	...
	public void validate( AssignEfdmaxToExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcCZId(), "AssignEfdmaxToExcCZCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdmaxToExcCZCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdmaxFromExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcCZId(), "UnAssignEfdmaxFromExcCZCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfdminToExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcCZId(), "AssignEfdminToExcCZCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdminToExcCZCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdminFromExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcCZId(), "UnAssignEfdminFromExcCZCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignKaFromExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcCZId(), "UnAssignKaFromExcCZCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignKeFromExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcCZId(), "UnAssignKeFromExcCZCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignKpFromExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcCZId(), "UnAssignKpFromExcCZCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTaFromExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcCZId(), "UnAssignTaFromExcCZCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTcFromExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcCZId(), "UnAssignTcFromExcCZCommand identifier should not be null" );
	}
	/**
	...
	public void validate( UnAssignTeFromExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcCZId(), "UnAssignTeFromExcCZCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcCZCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcCZId(), "UnAssignVrmaxFromExcCZCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVrminToExcCZCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcCZCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcCZId(), "UnAssignVrminFromExcCZCommand identifier should not be null" );
	}
