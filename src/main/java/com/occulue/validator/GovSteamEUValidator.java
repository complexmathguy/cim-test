...
//		Assert.isNull( govSteamEU.getGovSteamEUId(), "CreateGovSteamEUCommand identifier should be null" );
	...
	public void validate( AssignChcToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignChcToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignChcToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignChcFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignChcFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignChoToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignChoToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignChoToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignChoFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignChoFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignCicToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignCicToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignCicToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignCicFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignCicFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignCioToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignCioToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignCioToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignCioFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignCioFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDb1ToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignDb1ToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDb1ToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDb1FromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignDb1FromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDb2ToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignDb2ToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDb2ToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDb2FromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignDb2FromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignHhpmaxToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignHhpmaxToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignHhpmaxToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignHhpmaxFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignHhpmaxFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignKeToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignKeFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfcorToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignKfcorToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfcorToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfcorFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignKfcorFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKhpToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignKhpToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKhpToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKhpFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignKhpFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKlpToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignKlpToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKlpToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKlpFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignKlpFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKwcorToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignKwcorToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKwcorToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKwcorFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignKwcorFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignMwbaseToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignMwbaseFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPmaxToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignPmaxToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPmaxToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPmaxFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignPmaxFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPrhmaxToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignPrhmaxToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPrhmaxToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPrhmaxFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignPrhmaxFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSimxToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignSimxToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSimxToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSimxFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignSimxFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignTbToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignTbFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTdpToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignTdpToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTdpToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTdpFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignTdpFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTenToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignTenToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTenToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTenFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignTenFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignTfToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignTfFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfpToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignTfpToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfpToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfpFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignTfpFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignThpToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignThpToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignThpToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignThpFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignThpFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTipToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignTipToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTipToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTipFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignTipFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTlpToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignTlpToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTlpToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTlpFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignTlpFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignTpToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTpFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignTpFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTrhToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignTrhToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTrhToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTrhFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignTrhFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTvhpToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignTvhpToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTvhpToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTvhpFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignTvhpFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTvipToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignTvipToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTvipToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTvipFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignTvipFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTwToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignTwToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTwToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTwFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignTwFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignWfmaxToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignWfmaxToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWfmaxToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignWfmaxFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignWfmaxFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignWfminToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignWfminToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWfminToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignWfminFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignWfminFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignWmax1ToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignWmax1ToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWmax1ToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignWmax1FromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignWmax1FromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignWmax2ToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignWmax2ToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWmax2ToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignWmax2FromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignWmax2FromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignWwmaxToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignWwmaxToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWwmaxToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignWwmaxFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignWwmaxFromGovSteamEUCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignWwminToGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "AssignWwminToGovSteamEUCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWwminToGovSteamEUCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignWwminFromGovSteamEUCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovSteamEUId(), "UnAssignWwminFromGovSteamEUCommand identifier should not be null" );
	}
