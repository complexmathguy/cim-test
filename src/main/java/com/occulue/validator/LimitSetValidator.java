...
//		Assert.isNull( limitSet.getLimitSetId(), "CreateLimitSetCommand identifier should be null" );
	...
	public void validate( AssignPercentageLimitsFlagToLimitSetCommand command ) throws Exception {
		...
		Assert.notNull( command.getLimitSetId(), "AssignPercentageLimitsFlagToLimitSetCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPercentageLimitsFlagToLimitSetCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPercentageLimitsFlagFromLimitSetCommand command ) throws Exception {
		...
		Assert.notNull( command.getLimitSetId(), "UnAssignPercentageLimitsFlagFromLimitSetCommand identifier should not be null" );
	}
