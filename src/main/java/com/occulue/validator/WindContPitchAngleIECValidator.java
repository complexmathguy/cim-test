...
//		Assert.isNull( windContPitchAngleIEC.getWindContPitchAngleIECId(), "CreateWindContPitchAngleIECCommand identifier should be null" );
	...
	public void validate( AssignDthetamaxToWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "AssignDthetamaxToWindContPitchAngleIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDthetamaxToWindContPitchAngleIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDthetamaxFromWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "UnAssignDthetamaxFromWindContPitchAngleIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDthetaminToWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "AssignDthetaminToWindContPitchAngleIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDthetaminToWindContPitchAngleIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDthetaminFromWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "UnAssignDthetaminFromWindContPitchAngleIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKicToWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "AssignKicToWindContPitchAngleIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKicToWindContPitchAngleIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKicFromWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "UnAssignKicFromWindContPitchAngleIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiomegaToWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "AssignKiomegaToWindContPitchAngleIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiomegaToWindContPitchAngleIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiomegaFromWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "UnAssignKiomegaFromWindContPitchAngleIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpcToWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "AssignKpcToWindContPitchAngleIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpcToWindContPitchAngleIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpcFromWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "UnAssignKpcFromWindContPitchAngleIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpomegaToWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "AssignKpomegaToWindContPitchAngleIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpomegaToWindContPitchAngleIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpomegaFromWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "UnAssignKpomegaFromWindContPitchAngleIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpxToWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "AssignKpxToWindContPitchAngleIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpxToWindContPitchAngleIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpxFromWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "UnAssignKpxFromWindContPitchAngleIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignThetamaxToWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "AssignThetamaxToWindContPitchAngleIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignThetamaxToWindContPitchAngleIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignThetamaxFromWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "UnAssignThetamaxFromWindContPitchAngleIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignThetaminToWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "AssignThetaminToWindContPitchAngleIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignThetaminToWindContPitchAngleIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignThetaminFromWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "UnAssignThetaminFromWindContPitchAngleIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTthetaToWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "AssignTthetaToWindContPitchAngleIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTthetaToWindContPitchAngleIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTthetaFromWindContPitchAngleIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPitchAngleIECId(), "UnAssignTthetaFromWindContPitchAngleIECCommand identifier should not be null" );
	}
