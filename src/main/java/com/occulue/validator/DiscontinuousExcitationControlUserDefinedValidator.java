...
//		Assert.isNull( discontinuousExcitationControlUserDefined.getDiscontinuousExcitationControlUserDefinedId(), "CreateDiscontinuousExcitationControlUserDefinedCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignProprietaryToDiscontinuousExcitationControlUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "AssignProprietaryToDiscontinuousExcitationControlUserDefinedCommand should not be null" );
		Assert.notNull( command.getDiscontinuousExcitationControlUserDefinedId(), "AssignProprietaryToDiscontinuousExcitationControlUserDefinedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProprietaryToDiscontinuousExcitationControlUserDefinedCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignProprietaryFromDiscontinuousExcitationControlUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignProprietaryFromDiscontinuousExcitationControlUserDefinedCommand should not be null" );
		Assert.notNull( command.getDiscontinuousExcitationControlUserDefinedId(), "UnAssignProprietaryFromDiscontinuousExcitationControlUserDefinedCommand identifier should not be null" );
	}
