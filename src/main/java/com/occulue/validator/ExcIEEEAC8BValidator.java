...
//		Assert.isNull( excIEEEAC8B.getExcIEEEAC8BId(), "CreateExcIEEEAC8BCommand identifier should be null" );
	...
	public void validate( AssignKaToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignKaToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignKaFromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignKcToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignKcFromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignKdToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignKdFromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdrToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignKdrToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdrToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdrFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignKdrFromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignKeToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignKeFromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKirToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignKirToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKirToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKirFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignKirFromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKprToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignKprToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKprToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKprFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignKprFromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve1ToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignSeve1ToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve1ToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve1FromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignSeve1FromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve2ToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignSeve2ToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve2ToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve2FromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignSeve2FromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignTaToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignTaFromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTdrToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignTdrToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTdrToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTdrFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignTdrFromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignTeToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignTeFromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe1ToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignVe1ToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe1ToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe1FromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignVe1FromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe2ToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignVe2ToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe2ToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe2FromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignVe2FromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVeminToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignVeminToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVeminToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVeminFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignVeminFromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVfemaxToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignVfemaxToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVfemaxToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVfemaxFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignVfemaxFromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignVrmaxToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignVrmaxFromExcIEEEAC8BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "AssignVrminToExcIEEEAC8BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEAC8BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEAC8BCommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEAC8BId(), "UnAssignVrminFromExcIEEEAC8BCommand identifier should not be null" );
	}
