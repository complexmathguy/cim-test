...
//		Assert.isNull( windType1or2UserDefined.getWindType1or2UserDefinedId(), "CreateWindType1or2UserDefinedCommand identifier should be null" );
	...
	public void validate( AssignProprietaryToWindType1or2UserDefinedCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindType1or2UserDefinedId(), "AssignProprietaryToWindType1or2UserDefinedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProprietaryToWindType1or2UserDefinedCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignProprietaryFromWindType1or2UserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignProprietaryFromWindType1or2UserDefinedCommand should not be null" );
		Assert.notNull( command.getWindType1or2UserDefinedId(), "UnAssignProprietaryFromWindType1or2UserDefinedCommand identifier should not be null" );
	}
