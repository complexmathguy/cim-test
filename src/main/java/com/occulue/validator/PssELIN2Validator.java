...
//		Assert.isNull( pssELIN2.getPssELIN2Id(), "CreatePssELIN2Command identifier should be null" );
	...
	public void validate( AssignApssToPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "AssignApssToPssELIN2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignApssToPssELIN2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignApssFromPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "UnAssignApssFromPssELIN2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKs1ToPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "AssignKs1ToPssELIN2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKs1ToPssELIN2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKs1FromPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "UnAssignKs1FromPssELIN2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKs2ToPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "AssignKs2ToPssELIN2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKs2ToPssELIN2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKs2FromPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "UnAssignKs2FromPssELIN2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPpssToPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "AssignPpssToPssELIN2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPpssToPssELIN2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPpssFromPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "UnAssignPpssFromPssELIN2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPsslimToPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "AssignPsslimToPssELIN2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPsslimToPssELIN2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPsslimFromPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "UnAssignPsslimFromPssELIN2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTs1ToPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "AssignTs1ToPssELIN2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTs1ToPssELIN2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTs1FromPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "UnAssignTs1FromPssELIN2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTs2ToPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "AssignTs2ToPssELIN2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTs2ToPssELIN2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTs2FromPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "UnAssignTs2FromPssELIN2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTs3ToPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "AssignTs3ToPssELIN2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTs3ToPssELIN2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTs3FromPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "UnAssignTs3FromPssELIN2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTs4ToPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "AssignTs4ToPssELIN2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTs4ToPssELIN2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTs4FromPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "UnAssignTs4FromPssELIN2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTs5ToPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "AssignTs5ToPssELIN2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTs5ToPssELIN2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTs5FromPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "UnAssignTs5FromPssELIN2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTs6ToPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "AssignTs6ToPssELIN2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTs6ToPssELIN2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTs6FromPssELIN2Command command ) throws Exception {
		...
		Assert.notNull( command.getPssELIN2Id(), "UnAssignTs6FromPssELIN2Command identifier should not be null" );
	}
