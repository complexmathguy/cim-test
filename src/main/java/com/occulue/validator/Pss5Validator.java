...
//		Assert.isNull( pss5.getPss5Id(), "CreatePss5Command identifier should be null" );
	...
	public void validate( AssignCtw2ToPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignCtw2ToPss5Command assignment should not be null" );
	}
	...
	public void validate( UnAssignCtw2FromPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getPss5Id(), "UnAssignCtw2FromPss5Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDeadbandToPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getPss5Id(), "AssignDeadbandToPss5Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDeadbandToPss5Command assignment should not be null" );
	}
	...
	public void validate( UnAssignDeadbandFromPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getPss5Id(), "UnAssignDeadbandFromPss5Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIsfreqToPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignIsfreqToPss5Command assignment should not be null" );
	}
	...
	public void validate( UnAssignIsfreqFromPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getPss5Id(), "UnAssignIsfreqFromPss5Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpssToPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignKpssToPss5Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKpssFromPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getPss5Id(), "UnAssignKpssFromPss5Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVadatToPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVadatToPss5Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVadatFromPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getPss5Id(), "UnAssignVadatFromPss5Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsmnToPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVsmnToPss5Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVsmnFromPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getPss5Id(), "UnAssignVsmnFromPss5Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsmxToPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVsmxToPss5Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVsmxFromPss5Command command ) throws Exception {
		...
		Assert.notNull( command.getPss5Id(), "UnAssignVsmxFromPss5Command identifier should not be null" );
	}
