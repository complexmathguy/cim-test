...
//		Assert.isNull( windGenTurbineType3aIEC.getWindGenTurbineType3aIECId(), "CreateWindGenTurbineType3aIECCommand identifier should be null" );
	...
	public void validate( AssignKpcToWindGenTurbineType3aIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3aIECId(), "AssignKpcToWindGenTurbineType3aIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpcToWindGenTurbineType3aIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpcFromWindGenTurbineType3aIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3aIECId(), "UnAssignKpcFromWindGenTurbineType3aIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTicToWindGenTurbineType3aIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3aIECId(), "AssignTicToWindGenTurbineType3aIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTicToWindGenTurbineType3aIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTicFromWindGenTurbineType3aIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3aIECId(), "UnAssignTicFromWindGenTurbineType3aIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXsToWindGenTurbineType3aIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3aIECId(), "AssignXsToWindGenTurbineType3aIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXsToWindGenTurbineType3aIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXsFromWindGenTurbineType3aIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindGenTurbineType3aIECId(), "UnAssignXsFromWindGenTurbineType3aIECCommand identifier should not be null" );
	}
