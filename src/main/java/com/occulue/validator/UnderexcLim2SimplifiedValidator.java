...
//		Assert.isNull( underexcLim2Simplified.getUnderexcLim2SimplifiedId(), "CreateUnderexcLim2SimplifiedCommand identifier should be null" );
	...
	public void validate( AssignKuiToUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "AssignKuiToUnderexcLim2SimplifiedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKuiToUnderexcLim2SimplifiedCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKuiFromUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "UnAssignKuiFromUnderexcLim2SimplifiedCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignP0ToUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "AssignP0ToUnderexcLim2SimplifiedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignP0ToUnderexcLim2SimplifiedCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignP0FromUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "UnAssignP0FromUnderexcLim2SimplifiedCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignP1ToUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "AssignP1ToUnderexcLim2SimplifiedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignP1ToUnderexcLim2SimplifiedCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignP1FromUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "UnAssignP1FromUnderexcLim2SimplifiedCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQ0ToUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "AssignQ0ToUnderexcLim2SimplifiedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQ0ToUnderexcLim2SimplifiedCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignQ0FromUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "UnAssignQ0FromUnderexcLim2SimplifiedCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQ1ToUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "AssignQ1ToUnderexcLim2SimplifiedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQ1ToUnderexcLim2SimplifiedCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignQ1FromUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "UnAssignQ1FromUnderexcLim2SimplifiedCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVuimaxToUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "AssignVuimaxToUnderexcLim2SimplifiedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVuimaxToUnderexcLim2SimplifiedCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVuimaxFromUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "UnAssignVuimaxFromUnderexcLim2SimplifiedCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVuiminToUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "AssignVuiminToUnderexcLim2SimplifiedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVuiminToUnderexcLim2SimplifiedCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVuiminFromUnderexcLim2SimplifiedCommand command ) throws Exception {
		...
		Assert.notNull( command.getUnderexcLim2SimplifiedId(), "UnAssignVuiminFromUnderexcLim2SimplifiedCommand identifier should not be null" );
	}
