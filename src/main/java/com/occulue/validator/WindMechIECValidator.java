...
//		Assert.isNull( windMechIEC.getWindMechIECId(), "CreateWindMechIECCommand identifier should be null" );
	...
	public void validate( AssignCdrtToWindMechIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindMechIECId(), "AssignCdrtToWindMechIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignCdrtToWindMechIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignCdrtFromWindMechIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindMechIECId(), "UnAssignCdrtFromWindMechIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignHgenToWindMechIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindMechIECId(), "AssignHgenToWindMechIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignHgenToWindMechIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignHgenFromWindMechIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindMechIECId(), "UnAssignHgenFromWindMechIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignHwtrToWindMechIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindMechIECId(), "AssignHwtrToWindMechIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignHwtrToWindMechIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignHwtrFromWindMechIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindMechIECId(), "UnAssignHwtrFromWindMechIECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdrtToWindMechIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindMechIECId(), "AssignKdrtToWindMechIECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdrtToWindMechIECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdrtFromWindMechIECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindMechIECId(), "UnAssignKdrtFromWindMechIECCommand identifier should not be null" );
	}
