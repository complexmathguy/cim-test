...
//		Assert.isNull( govHydroPelton.getGovHydroPeltonId(), "CreateGovHydroPeltonCommand identifier should be null" );
	...
	public void validate( AssignAv0ToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignAv0ToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAv0ToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAv0FromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignAv0FromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignAv1ToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignAv1ToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAv1ToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAv1FromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignAv1FromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBpToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignBpToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBpToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBpFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignBpFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDb1ToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignDb1ToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDb1ToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDb1FromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignDb1FromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDb2ToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignDb2ToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDb2ToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDb2FromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignDb2FromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignH1ToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignH1ToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignH1ToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignH1FromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignH1FromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignH2ToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignH2ToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignH2ToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignH2FromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignH2FromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignHnToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignHnToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignHnToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignHnFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignHnFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignKcToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignKcFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKgToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignKgToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKgToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKgFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignKgFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQc0ToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignQc0ToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQc0ToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignQc0FromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignQc0FromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQnToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignQnToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQnToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignQnFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignQnFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSimplifiedPeltonToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignSimplifiedPeltonToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSimplifiedPeltonToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSimplifiedPeltonFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignSimplifiedPeltonFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignStaticCompensatingToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignStaticCompensatingToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignStaticCompensatingToGovHydroPeltonCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignStaticCompensatingFromGovHydroPeltonCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignStaticCompensatingFromGovHydroPeltonCommand should not be null" );
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignStaticCompensatingFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignTaToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignTaFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTsToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignTsToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTsToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTsFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignTsFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTvToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignTvToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTvToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTvFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignTvFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTwncToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignTwncToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTwncToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTwncFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignTwncFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTwngToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignTwngToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTwngToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTwngFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignTwngFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTxToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignTxToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTxToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTxFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignTxFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignVaToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVaFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignVaFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignValvmaxToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignValvmaxToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValvmaxToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValvmaxFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignValvmaxFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignValvminToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignValvminToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValvminToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValvminFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignValvminFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVavToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignVavToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVavToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVavFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignVavFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVcToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignVcToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVcToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVcFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignVcFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVcvToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignVcvToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVcvToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVcvFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignVcvFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignWaterTunnelSurgeChamberSimulationToGovHydroPeltonCommand command ) throws Exception {
		Assert.notNull( command, "AssignWaterTunnelSurgeChamberSimulationToGovHydroPeltonCommand should not be null" );
		Assert.notNull( command.getGovHydroPeltonId(), "AssignWaterTunnelSurgeChamberSimulationToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWaterTunnelSurgeChamberSimulationToGovHydroPeltonCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroPeltonCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroPeltonCommand should not be null" );
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroPeltonCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignZsfcToGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "AssignZsfcToGovHydroPeltonCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignZsfcToGovHydroPeltonCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignZsfcFromGovHydroPeltonCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroPeltonId(), "UnAssignZsfcFromGovHydroPeltonCommand identifier should not be null" );
	}
