...
//		Assert.isNull( windContPType3IEC.getWindContPType3IECId(), "CreateWindContPType3IECCommand identifier should be null" );
	...
	public void validate( AssignDpmaxToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignDpmaxToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDpmaxToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDpmaxFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignDpmaxFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDtrisemaxlvrtToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignDtrisemaxlvrtToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDtrisemaxlvrtToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDtrisemaxlvrtFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignDtrisemaxlvrtFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdtdToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignKdtdToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdtdToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdtdFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignKdtdFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKipToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignKipToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKipToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKipFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignKipFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKppToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignKppToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKppToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKppFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignKppFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMplvrtToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignMplvrtToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMplvrtToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMplvrtFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignMplvrtFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignOmegaoffsetToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignOmegaoffsetToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignOmegaoffsetToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignOmegaoffsetFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignOmegaoffsetFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPdtdmaxToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignPdtdmaxToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPdtdmaxToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPdtdmaxFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignPdtdmaxFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRrampToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignRrampToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRrampToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRrampFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignRrampFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTdvsToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignTdvsToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTdvsToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTdvsFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignTdvsFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeminToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignTeminToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeminToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeminFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignTeminFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTomegafiltToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignTomegafiltToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTomegafiltToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTomegafiltFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignTomegafiltFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpfiltToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignTpfiltToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpfiltToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTpfiltFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignTpfiltFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTpordToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignTpordToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTpordToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTpordFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignTpordFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTufiltToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignTufiltToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTufiltToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTufiltFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignTufiltFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTuscaleToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignTuscaleToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTuscaleToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTuscaleFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignTuscaleFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTwrefToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignTwrefToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTwrefToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTwrefFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignTwrefFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUdvsToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignUdvsToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUdvsToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUdvsFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignUdvsFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUpdipToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignUpdipToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUpdipToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUpdipFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignUpdipFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignWdtdToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignWdtdToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWdtdToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignWdtdFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignWdtdFromWindContPType3IECCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignZetaToWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "AssignZetaToWindContPType3IECCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignZetaToWindContPType3IECCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignZetaFromWindContPType3IECCommand command ) throws Exception {
		...
		Assert.notNull( command.getWindContPType3IECId(), "UnAssignZetaFromWindContPType3IECCommand identifier should not be null" );
	}
