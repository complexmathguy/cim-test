...
//		Assert.isNull( excIEEEST3A.getExcIEEEST3AId(), "CreateExcIEEEST3ACommand identifier should be null" );
	...
	public void validate( AssignKaToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignKaToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignKaFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignKcToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignKcFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKgToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignKgToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKgToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKgFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignKgFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignKiToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignKiFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKmToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignKmToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKmToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKmFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignKmFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignKpToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignKpFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignTaToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignTaFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignTbToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignTbFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignTcToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignTcFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignThetapToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignThetapToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignThetapToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignThetapFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignThetapFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTmToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignTmToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTmToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTmFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignTmFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVbmaxToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignVbmaxToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVbmaxToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVbmaxFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignVbmaxFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVgmaxToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignVgmaxToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVgmaxToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVgmaxFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignVgmaxFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVimaxToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignVimaxToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVimaxToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVimaxFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignVimaxFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignViminToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignViminToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignViminToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignViminFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignViminFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmmaxToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignVmmaxToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmmaxToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVmmaxFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignVmmaxFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVmminToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignVmminToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVmminToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVmminFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignVmminFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignVrmaxToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignVrmaxFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignVrminToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignVrminFromExcIEEEST3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXlToExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "AssignXlToExcIEEEST3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXlToExcIEEEST3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXlFromExcIEEEST3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST3AId(), "UnAssignXlFromExcIEEEST3ACommand identifier should not be null" );
	}
