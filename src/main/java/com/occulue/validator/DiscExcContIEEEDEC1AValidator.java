...
//		Assert.isNull( discExcContIEEEDEC1A.getDiscExcContIEEEDEC1AId(), "CreateDiscExcContIEEEDEC1ACommand identifier should be null" );
	...
	public void validate( AssignEscToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignEscToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEscToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEscFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignEscFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKanToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignKanToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKanToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKanFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignKanFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKetlToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignKetlToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKetlToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKetlFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignKetlFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTanToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignTanToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTanToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTanFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignTanFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTdToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignTdToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTdToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTdFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignTdFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTl1ToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignTl1ToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTl1ToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTl1FromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignTl1FromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTl2ToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignTl2ToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTl2ToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTl2FromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignTl2FromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTw5ToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignTw5ToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTw5ToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTw5FromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignTw5FromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignValueToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignValueToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignValueFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVanmaxToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignVanmaxToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVanmaxToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVanmaxFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignVanmaxFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVomaxToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignVomaxToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVomaxToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVomaxFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignVomaxFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVominToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignVominToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVominToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVominFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignVominFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsmaxToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignVsmaxToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsmaxToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsmaxFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignVsmaxFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsminToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignVsminToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsminToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsminFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignVsminFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVtcToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignVtcToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVtcToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVtcFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignVtcFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVtlmtToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignVtlmtToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVtlmtToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVtlmtFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignVtlmtFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVtmToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignVtmToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVtmToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVtmFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignVtmFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVtnToDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "AssignVtnToDiscExcContIEEEDEC1ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVtnToDiscExcContIEEEDEC1ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVtnFromDiscExcContIEEEDEC1ACommand command ) throws Exception {
		...
		Assert.notNull( command.getDiscExcContIEEEDEC1AId(), "UnAssignVtnFromDiscExcContIEEEDEC1ACommand identifier should not be null" );
	}
