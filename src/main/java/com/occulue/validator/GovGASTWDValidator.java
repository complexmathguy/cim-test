...
//		Assert.isNull( govGASTWD.getGovGASTWDId(), "CreateGovGASTWDCommand identifier should be null" );
	...
	public void validate( AssignAToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignAToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignAFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignAf1ToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignAf1ToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAf1ToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAf1FromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignAf1FromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignAf2ToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignAf2ToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAf2ToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAf2FromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignAf2FromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignBToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignBFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBf1ToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignBf1ToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBf1ToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBf1FromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignBf1FromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBf2ToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignBf2ToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBf2ToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBf2FromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignBf2FromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignCToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignCToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignCToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignCFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignCFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignCf2ToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignCf2ToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignCf2ToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignCf2FromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignCf2FromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEcrToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignEcrToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEcrToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEcrFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignEcrFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEtdToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignEtdToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEtdToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEtdFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignEtdFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK3ToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignK3ToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK3ToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK3FromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignK3FromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK4ToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignK4ToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK4ToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK4FromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignK4FromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK5ToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignK5ToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK5ToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK5FromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignK5FromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK6ToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignK6ToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK6ToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK6FromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignK6FromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignKdToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignKdFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdroopToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignKdroopToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdroopToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdroopFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignKdroopFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignKfToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignKfFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignKiToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignKiFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignKpToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignKpFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMwbaseToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignMwbaseToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMwbaseToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMwbaseFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignMwbaseFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignTToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignTFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignT3ToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignT3FromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignT4ToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4ToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignT4FromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT5ToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignT5ToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT5ToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT5FromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignT5FromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignTcToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignTcFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcdToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignTcdToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcdToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcdFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignTcdFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTdToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignTdToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTdToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTdFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignTdFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignTfToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignTfFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTmaxToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignTmaxToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTmaxToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTmaxFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignTmaxFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTminToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignTminToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTminToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTminFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignTminFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTrToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignTrToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTrToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTrFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignTrFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTrateToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignTrateToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTrateToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTrateFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignTrateFromGovGASTWDCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTtToGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "AssignTtToGovGASTWDCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTtToGovGASTWDCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTtFromGovGASTWDCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovGASTWDId(), "UnAssignTtFromGovGASTWDCommand identifier should not be null" );
	}
