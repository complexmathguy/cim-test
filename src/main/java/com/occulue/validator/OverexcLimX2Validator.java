...
//		Assert.isNull( overexcLimX2.getOverexcLimX2Id(), "CreateOverexcLimX2Command identifier should be null" );
	...
	public void validate( AssignEfd1ToOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "AssignEfd1ToOverexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd1ToOverexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd1FromOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "UnAssignEfd1FromOverexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd2ToOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "AssignEfd2ToOverexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd2ToOverexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd2FromOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "UnAssignEfd2FromOverexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd3ToOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "AssignEfd3ToOverexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd3ToOverexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd3FromOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "UnAssignEfd3FromOverexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfddesToOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "AssignEfddesToOverexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfddesToOverexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEfddesFromOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "UnAssignEfddesFromOverexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfdratedToOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "AssignEfdratedToOverexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdratedToOverexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdratedFromOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "UnAssignEfdratedFromOverexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKmxToOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "AssignKmxToOverexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKmxToOverexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKmxFromOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "UnAssignKmxFromOverexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMToOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "AssignMToOverexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMToOverexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignMFromOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "UnAssignMFromOverexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "AssignT1ToOverexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToOverexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "UnAssignT1FromOverexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "AssignT2ToOverexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToOverexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "UnAssignT2FromOverexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "AssignT3ToOverexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToOverexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "UnAssignT3FromOverexcLimX2Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVlowToOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "AssignVlowToOverexcLimX2Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVlowToOverexcLimX2Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVlowFromOverexcLimX2Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX2Id(), "UnAssignVlowFromOverexcLimX2Command identifier should not be null" );
	}
