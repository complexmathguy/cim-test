...
//		Assert.isNull( stateVariablesVersion.getStateVariablesVersionId(), "CreateStateVariablesVersionCommand identifier should be null" );
	...
	public void validate( AssignBaseUMLToStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "AssignBaseUMLToStateVariablesVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBaseUMLToStateVariablesVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBaseUMLFromStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "UnAssignBaseUMLFromStateVariablesVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBaseURIToStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "AssignBaseURIToStateVariablesVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBaseURIToStateVariablesVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBaseURIFromStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "UnAssignBaseURIFromStateVariablesVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDateToStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "AssignDateToStateVariablesVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDateToStateVariablesVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDateFromStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "UnAssignDateFromStateVariablesVersionCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignDifferenceModelURIToStateVariablesVersionCommand command ) throws Exception {
		Assert.notNull( command, "AssignDifferenceModelURIToStateVariablesVersionCommand should not be null" );
		Assert.notNull( command.getStateVariablesVersionId(), "AssignDifferenceModelURIToStateVariablesVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDifferenceModelURIToStateVariablesVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignDifferenceModelURIFromStateVariablesVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignDifferenceModelURIFromStateVariablesVersionCommand should not be null" );
		Assert.notNull( command.getStateVariablesVersionId(), "UnAssignDifferenceModelURIFromStateVariablesVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEntsoeUMLToStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "AssignEntsoeUMLToStateVariablesVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEntsoeUMLToStateVariablesVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEntsoeUMLFromStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "UnAssignEntsoeUMLFromStateVariablesVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEntsoeURIToStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "AssignEntsoeURIToStateVariablesVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEntsoeURIToStateVariablesVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEntsoeURIFromStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "UnAssignEntsoeURIFromStateVariablesVersionCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignModelDescriptionURIToStateVariablesVersionCommand command ) throws Exception {
		Assert.notNull( command, "AssignModelDescriptionURIToStateVariablesVersionCommand should not be null" );
		Assert.notNull( command.getStateVariablesVersionId(), "AssignModelDescriptionURIToStateVariablesVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignModelDescriptionURIToStateVariablesVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignModelDescriptionURIFromStateVariablesVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignModelDescriptionURIFromStateVariablesVersionCommand should not be null" );
		Assert.notNull( command.getStateVariablesVersionId(), "UnAssignModelDescriptionURIFromStateVariablesVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNamespaceRDFToStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "AssignNamespaceRDFToStateVariablesVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNamespaceRDFToStateVariablesVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignNamespaceRDFFromStateVariablesVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignNamespaceRDFFromStateVariablesVersionCommand should not be null" );
		Assert.notNull( command.getStateVariablesVersionId(), "UnAssignNamespaceRDFFromStateVariablesVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNamespaceUMLToStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "AssignNamespaceUMLToStateVariablesVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNamespaceUMLToStateVariablesVersionCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignNamespaceUMLFromStateVariablesVersionCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignNamespaceUMLFromStateVariablesVersionCommand should not be null" );
		Assert.notNull( command.getStateVariablesVersionId(), "UnAssignNamespaceUMLFromStateVariablesVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignShortNameToStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "AssignShortNameToStateVariablesVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignShortNameToStateVariablesVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignShortNameFromStateVariablesVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getStateVariablesVersionId(), "UnAssignShortNameFromStateVariablesVersionCommand identifier should not be null" );
	}
