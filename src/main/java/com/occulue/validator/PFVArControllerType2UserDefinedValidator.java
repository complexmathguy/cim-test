...
//		Assert.isNull( pFVArControllerType2UserDefined.getPFVArControllerType2UserDefinedId(), "CreatePFVArControllerType2UserDefinedCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignProprietaryToPFVArControllerType2UserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "AssignProprietaryToPFVArControllerType2UserDefinedCommand should not be null" );
		Assert.notNull( command.getPFVArControllerType2UserDefinedId(), "AssignProprietaryToPFVArControllerType2UserDefinedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProprietaryToPFVArControllerType2UserDefinedCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignProprietaryFromPFVArControllerType2UserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignProprietaryFromPFVArControllerType2UserDefinedCommand should not be null" );
		Assert.notNull( command.getPFVArControllerType2UserDefinedId(), "UnAssignProprietaryFromPFVArControllerType2UserDefinedCommand identifier should not be null" );
	}
