...
//		Assert.isNull( excAVR4.getExcAVR4Id(), "CreateExcAVR4Command identifier should be null" );
	...
	public void validate( AssignImulToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignImulToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignImulToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignImulFromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignImulFromExcAVR4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignKaToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignKaFromExcAVR4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignKeToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignKeFromExcAVR4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKifToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignKifToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKifToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKifFromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignKifFromExcAVR4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignT1ToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignT1FromExcAVR4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ifToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignT1ifToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ifToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT1ifFromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignT1ifFromExcAVR4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignT2ToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignT2FromExcAVR4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignT3ToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignT3FromExcAVR4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignT4ToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4ToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignT4FromExcAVR4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTifToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignTifToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTifToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTifFromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignTifFromExcAVR4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVfmnToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignVfmnToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVfmnToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVfmnFromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignVfmnFromExcAVR4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVfmxToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignVfmxToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVfmxToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVfmxFromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignVfmxFromExcAVR4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmnToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignVrmnToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmnToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmnFromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignVrmnFromExcAVR4Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmxToExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "AssignVrmxToExcAVR4Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmxToExcAVR4Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmxFromExcAVR4Command command ) throws Exception {
		...
		Assert.notNull( command.getExcAVR4Id(), "UnAssignVrmxFromExcAVR4Command identifier should not be null" );
	}
