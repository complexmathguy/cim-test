...
//		Assert.isNull( inductance.getInductanceId(), "CreateInductanceCommand identifier should be null" );
	...
	public void validate( AssignValueToInductanceCommand command ) throws Exception {
		...
		Assert.notNull( command.getInductanceId(), "AssignValueToInductanceCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToInductanceCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromInductanceCommand command ) throws Exception {
		...
		Assert.notNull( command.getInductanceId(), "UnAssignValueFromInductanceCommand identifier should not be null" );
	}
