...
//		Assert.isNull( staticVarCompensator.getStaticVarCompensatorId(), "CreateStaticVarCompensatorCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignCapacitiveRatingToStaticVarCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "AssignCapacitiveRatingToStaticVarCompensatorCommand should not be null" );
		Assert.notNull( command.getStaticVarCompensatorId(), "AssignCapacitiveRatingToStaticVarCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignCapacitiveRatingToStaticVarCompensatorCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignCapacitiveRatingFromStaticVarCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignCapacitiveRatingFromStaticVarCompensatorCommand should not be null" );
		Assert.notNull( command.getStaticVarCompensatorId(), "UnAssignCapacitiveRatingFromStaticVarCompensatorCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignInductiveRatingToStaticVarCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "AssignInductiveRatingToStaticVarCompensatorCommand should not be null" );
		Assert.notNull( command.getStaticVarCompensatorId(), "AssignInductiveRatingToStaticVarCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignInductiveRatingToStaticVarCompensatorCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignInductiveRatingFromStaticVarCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignInductiveRatingFromStaticVarCompensatorCommand should not be null" );
		Assert.notNull( command.getStaticVarCompensatorId(), "UnAssignInductiveRatingFromStaticVarCompensatorCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSlopeToStaticVarCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getStaticVarCompensatorId(), "AssignSlopeToStaticVarCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSlopeToStaticVarCompensatorCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSlopeFromStaticVarCompensatorCommand command ) throws Exception {
		...
		Assert.notNull( command.getStaticVarCompensatorId(), "UnAssignSlopeFromStaticVarCompensatorCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignVoltageSetPointToStaticVarCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "AssignVoltageSetPointToStaticVarCompensatorCommand should not be null" );
		Assert.notNull( command.getStaticVarCompensatorId(), "AssignVoltageSetPointToStaticVarCompensatorCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVoltageSetPointToStaticVarCompensatorCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVoltageSetPointFromStaticVarCompensatorCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVoltageSetPointFromStaticVarCompensatorCommand should not be null" );
		Assert.notNull( command.getStaticVarCompensatorId(), "UnAssignVoltageSetPointFromStaticVarCompensatorCommand identifier should not be null" );
	}
