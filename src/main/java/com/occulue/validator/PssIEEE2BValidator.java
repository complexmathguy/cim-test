...
//		Assert.isNull( pssIEEE2B.getPssIEEE2BId(), "CreatePssIEEE2BCommand identifier should be null" );
	...
	public void validate( AssignKs1ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignKs1ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKs1ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKs1FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignKs1FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKs2ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignKs2ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKs2ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKs2FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignKs2FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKs3ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignKs3ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKs3ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKs3FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignKs3FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignMToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignMToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignMToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignMFromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignMFromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignNToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNFromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignNFromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignT1ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignT1FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT10ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignT10ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT10ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT10FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignT10FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT11ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignT11ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT11ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT11FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignT11FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignT2ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignT2FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignT3ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignT3FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignT4ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignT4FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT6ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignT6ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT6ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT6FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignT6FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT7ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignT7ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT7ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT7FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignT7FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT8ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignT8ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT8ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT8FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignT8FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT9ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignT9ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT9ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT9FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignT9FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTw1ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignTw1ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTw1ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTw1FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignTw1FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTw2ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignTw2ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTw2ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTw2FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignTw2FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTw3ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignTw3ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTw3ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTw3FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignTw3FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTw4ToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignTw4ToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTw4ToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTw4FromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignTw4FromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsi1maxToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignVsi1maxToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsi1maxToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsi1maxFromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignVsi1maxFromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsi1minToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignVsi1minToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsi1minToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsi1minFromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignVsi1minFromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsi2maxToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignVsi2maxToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsi2maxToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsi2maxFromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignVsi2maxFromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsi2minToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignVsi2minToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsi2minToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsi2minFromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignVsi2minFromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVstmaxToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignVstmaxToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVstmaxToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVstmaxFromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignVstmaxFromPssIEEE2BCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVstminToPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "AssignVstminToPssIEEE2BCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVstminToPssIEEE2BCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVstminFromPssIEEE2BCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssIEEE2BId(), "UnAssignVstminFromPssIEEE2BCommand identifier should not be null" );
	}
