...
//		Assert.isNull( loadStatic.getLoadStaticId(), "CreateLoadStaticCommand identifier should be null" );
	...
	public void validate( AssignEp1ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignEp1ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEp1ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEp1FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignEp1FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEp2ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignEp2ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEp2ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEp2FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignEp2FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEp3ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignEp3ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEp3ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEp3FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignEp3FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEq1ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignEq1ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEq1ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEq1FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignEq1FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEq2ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignEq2ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEq2ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEq2FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignEq2FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEq3ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignEq3ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEq3ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEq3FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignEq3FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKp1ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignKp1ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKp1ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKp1FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignKp1FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKp2ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignKp2ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKp2ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKp2FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignKp2FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKp3ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignKp3ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKp3ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKp3FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignKp3FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKp4ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignKp4ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKp4ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKp4FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignKp4FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpfToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignKpfToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpfToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpfFromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignKpfFromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKq1ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignKq1ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKq1ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKq1FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignKq1FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKq2ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignKq2ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKq2ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKq2FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignKq2FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKq3ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignKq3ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKq3ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKq3FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignKq3FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKq4ToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignKq4ToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKq4ToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKq4FromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignKq4FromLoadStaticCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKqfToLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "AssignKqfToLoadStaticCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKqfToLoadStaticCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKqfFromLoadStaticCommand command ) throws Exception {
		...
		Assert.notNull( command.getLoadStaticId(), "UnAssignKqfFromLoadStaticCommand identifier should not be null" );
	}
