...
//		Assert.isNull( pss1.getPss1Id(), "CreatePss1Command identifier should be null" );
	...
	public void validate( AssignPminToPss1Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignPminToPss1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignPminFromPss1Command command ) throws Exception {
		...
		Assert.notNull( command.getPss1Id(), "UnAssignPminFromPss1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVadatToPss1Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVadatToPss1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVadatFromPss1Command command ) throws Exception {
		...
		Assert.notNull( command.getPss1Id(), "UnAssignVadatFromPss1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsmnToPss1Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVsmnToPss1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVsmnFromPss1Command command ) throws Exception {
		...
		Assert.notNull( command.getPss1Id(), "UnAssignVsmnFromPss1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsmxToPss1Command command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignVsmxToPss1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVsmxFromPss1Command command ) throws Exception {
		...
		Assert.notNull( command.getPss1Id(), "UnAssignVsmxFromPss1Command identifier should not be null" );
	}
