...
//		Assert.isNull( govHydroFrancis.getGovHydroFrancisId(), "CreateGovHydroFrancisCommand identifier should be null" );
	...
	public void validate( AssignAmToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignAmToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAmToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAmFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignAmFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignAv0ToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignAv0ToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAv0ToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAv0FromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignAv0FromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignAv1ToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignAv1ToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAv1ToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAv1FromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignAv1FromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignBpToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignBpToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBpToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBpFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignBpFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDb1ToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignDb1ToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDb1ToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDb1FromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignDb1FromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEtamaxToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignEtamaxToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEtamaxToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEtamaxFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignEtamaxFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignH1ToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignH1ToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignH1ToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignH1FromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignH1FromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignH2ToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignH2ToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignH2ToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignH2FromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignH2FromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignHnToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignHnToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignHnToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignHnFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignHnFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignKcToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignKcFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKgToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignKgToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKgToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKgFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignKgFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKtToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignKtToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKtToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKtFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignKtFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQc0ToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignQc0ToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQc0ToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignQc0FromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignQc0FromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignQnToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignQnToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignQnToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignQnFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignQnFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignTaToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignTaFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTdToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignTdToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTdToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTdFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignTdFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTsToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignTsToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTsToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTsFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignTsFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTwncToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignTwncToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTwncToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTwncFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignTwncFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTwngToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignTwngToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTwngToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTwngFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignTwngFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTxToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignTxToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTxToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTxFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignTxFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignVaToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVaFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignVaFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignValvmaxToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignValvmaxToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValvmaxToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValvmaxFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignValvmaxFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignValvminToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignValvminToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValvminToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValvminFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignValvminFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVcToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignVcToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVcToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVcFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignVcFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignWaterTunnelSurgeChamberSimulationToGovHydroFrancisCommand command ) throws Exception {
		Assert.notNull( command, "AssignWaterTunnelSurgeChamberSimulationToGovHydroFrancisCommand should not be null" );
		Assert.notNull( command.getGovHydroFrancisId(), "AssignWaterTunnelSurgeChamberSimulationToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignWaterTunnelSurgeChamberSimulationToGovHydroFrancisCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroFrancisCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroFrancisCommand should not be null" );
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroFrancisCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignZsfcToGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "AssignZsfcToGovHydroFrancisCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignZsfcToGovHydroFrancisCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignZsfcFromGovHydroFrancisCommand command ) throws Exception {
		...
		Assert.notNull( command.getGovHydroFrancisId(), "UnAssignZsfcFromGovHydroFrancisCommand identifier should not be null" );
	}
