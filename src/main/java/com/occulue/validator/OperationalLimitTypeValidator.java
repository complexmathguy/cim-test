...
//		Assert.isNull( operationalLimitType.getOperationalLimitTypeId(), "CreateOperationalLimitTypeCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignAcceptableDurationToOperationalLimitTypeCommand command ) throws Exception {
		Assert.notNull( command, "AssignAcceptableDurationToOperationalLimitTypeCommand should not be null" );
		Assert.notNull( command.getOperationalLimitTypeId(), "AssignAcceptableDurationToOperationalLimitTypeCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignAcceptableDurationToOperationalLimitTypeCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignAcceptableDurationFromOperationalLimitTypeCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignAcceptableDurationFromOperationalLimitTypeCommand should not be null" );
		Assert.notNull( command.getOperationalLimitTypeId(), "UnAssignAcceptableDurationFromOperationalLimitTypeCommand identifier should not be null" );
	}
