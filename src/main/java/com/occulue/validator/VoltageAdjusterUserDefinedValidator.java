...
//		Assert.isNull( voltageAdjusterUserDefined.getVoltageAdjusterUserDefinedId(), "CreateVoltageAdjusterUserDefinedCommand identifier should be null" );
	 ...
	 */	
	public void validate( AssignProprietaryToVoltageAdjusterUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "AssignProprietaryToVoltageAdjusterUserDefinedCommand should not be null" );
		Assert.notNull( command.getVoltageAdjusterUserDefinedId(), "AssignProprietaryToVoltageAdjusterUserDefinedCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProprietaryToVoltageAdjusterUserDefinedCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignProprietaryFromVoltageAdjusterUserDefinedCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignProprietaryFromVoltageAdjusterUserDefinedCommand should not be null" );
		Assert.notNull( command.getVoltageAdjusterUserDefinedId(), "UnAssignProprietaryFromVoltageAdjusterUserDefinedCommand identifier should not be null" );
	}
