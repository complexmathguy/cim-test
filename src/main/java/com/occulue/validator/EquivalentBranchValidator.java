...
//		Assert.isNull( equivalentBranch.getEquivalentBranchId(), "CreateEquivalentBranchCommand identifier should be null" );
	...
	public void validate( AssignNegativeR12ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignNegativeR12ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNegativeR12ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNegativeR12FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignNegativeR12FromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNegativeR21ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignNegativeR21ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNegativeR21ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNegativeR21FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignNegativeR21FromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNegativeX12ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignNegativeX12ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNegativeX12ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNegativeX12FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignNegativeX12FromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignNegativeX21ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignNegativeX21ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignNegativeX21ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignNegativeX21FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignNegativeX21FromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPositiveR12ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignPositiveR12ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPositiveR12ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPositiveR12FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignPositiveR12FromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPositiveR21ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignPositiveR21ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPositiveR21ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPositiveR21FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignPositiveR21FromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPositiveX12ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignPositiveX12ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPositiveX12ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPositiveX12FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignPositiveX12FromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignPositiveX21ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignPositiveX21ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignPositiveX21ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignPositiveX21FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignPositiveX21FromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignRToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignRToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignRToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignRFromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignRFromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignR21ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignR21ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignR21ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignR21FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignR21FromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignXToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignXToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignXToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignXFromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignXFromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignX21ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignX21ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignX21ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignX21FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignX21FromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignZeroR12ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignZeroR12ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignZeroR12ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignZeroR12FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignZeroR12FromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignZeroR21ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignZeroR21ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignZeroR21ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignZeroR21FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignZeroR21FromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignZeroX12ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignZeroX12ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignZeroX12ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignZeroX12FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignZeroX12FromEquivalentBranchCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignZeroX21ToEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "AssignZeroX21ToEquivalentBranchCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignZeroX21ToEquivalentBranchCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignZeroX21FromEquivalentBranchCommand command ) throws Exception {
		...
		Assert.notNull( command.getEquivalentBranchId(), "UnAssignZeroX21FromEquivalentBranchCommand identifier should not be null" );
	}
