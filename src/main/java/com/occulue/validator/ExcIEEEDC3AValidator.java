...
//		Assert.isNull( excIEEEDC3A.getExcIEEEDC3AId(), "CreateExcIEEEDC3ACommand identifier should be null" );
	...
	public void validate( AssignEfd1ToExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "AssignEfd1ToExcIEEEDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd1ToExcIEEEDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd1FromExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "UnAssignEfd1FromExcIEEEDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd2ToExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "AssignEfd2ToExcIEEEDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd2ToExcIEEEDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd2FromExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "UnAssignEfd2FromExcIEEEDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignExclimToExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "AssignExclimToExcIEEEDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExclimToExcIEEEDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignExclimFromExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "UnAssignExclimFromExcIEEEDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "AssignKeToExcIEEEDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcIEEEDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "UnAssignKeFromExcIEEEDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKvToExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "AssignKvToExcIEEEDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKvToExcIEEEDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKvFromExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "UnAssignKvFromExcIEEEDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd1ToExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "AssignSeefd1ToExcIEEEDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd1ToExcIEEEDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd1FromExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "UnAssignSeefd1FromExcIEEEDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd2ToExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "AssignSeefd2ToExcIEEEDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd2ToExcIEEEDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd2FromExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "UnAssignSeefd2FromExcIEEEDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "AssignTeToExcIEEEDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcIEEEDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "UnAssignTeFromExcIEEEDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTrhToExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "AssignTrhToExcIEEEDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTrhToExcIEEEDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTrhFromExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "UnAssignTrhFromExcIEEEDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "AssignVrmaxToExcIEEEDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "UnAssignVrmaxFromExcIEEEDC3ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "AssignVrminToExcIEEEDC3ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEDC3ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEDC3ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEDC3AId(), "UnAssignVrminFromExcIEEEDC3ACommand identifier should not be null" );
	}
