...
//		Assert.isNull( rotatingMachineDynamics.getRotatingMachineDynamicsId(), "CreateRotatingMachineDynamicsCommand identifier should be null" );
	...
	public void validate( AssignDampingToRotatingMachineDynamicsCommand command ) throws Exception {
		...
		Assert.notNull( command.getRotatingMachineDynamicsId(), "AssignDampingToRotatingMachineDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDampingToRotatingMachineDynamicsCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDampingFromRotatingMachineDynamicsCommand command ) throws Exception {
		...
		Assert.notNull( command.getRotatingMachineDynamicsId(), "UnAssignDampingFromRotatingMachineDynamicsCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignInertiaToRotatingMachineDynamicsCommand command ) throws Exception {
		...
		Assert.notNull( command.getRotatingMachineDynamicsId(), "AssignInertiaToRotatingMachineDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignInertiaToRotatingMachineDynamicsCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignInertiaFromRotatingMachineDynamicsCommand command ) throws Exception {
		...
		Assert.notNull( command.getRotatingMachineDynamicsId(), "UnAssignInertiaFromRotatingMachineDynamicsCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignSaturationFactorToRotatingMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignSaturationFactorToRotatingMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getRotatingMachineDynamicsId(), "AssignSaturationFactorToRotatingMachineDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSaturationFactorToRotatingMachineDynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignSaturationFactorFromRotatingMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignSaturationFactorFromRotatingMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getRotatingMachineDynamicsId(), "UnAssignSaturationFactorFromRotatingMachineDynamicsCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignSaturationFactor120ToRotatingMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignSaturationFactor120ToRotatingMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getRotatingMachineDynamicsId(), "AssignSaturationFactor120ToRotatingMachineDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSaturationFactor120ToRotatingMachineDynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignSaturationFactor120FromRotatingMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignSaturationFactor120FromRotatingMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getRotatingMachineDynamicsId(), "UnAssignSaturationFactor120FromRotatingMachineDynamicsCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignStatorLeakageReactanceToRotatingMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignStatorLeakageReactanceToRotatingMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getRotatingMachineDynamicsId(), "AssignStatorLeakageReactanceToRotatingMachineDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignStatorLeakageReactanceToRotatingMachineDynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignStatorLeakageReactanceFromRotatingMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignStatorLeakageReactanceFromRotatingMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getRotatingMachineDynamicsId(), "UnAssignStatorLeakageReactanceFromRotatingMachineDynamicsCommand identifier should not be null" );
	}
	/**
	 ...
	 */	
	public void validate( AssignStatorResistanceToRotatingMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "AssignStatorResistanceToRotatingMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getRotatingMachineDynamicsId(), "AssignStatorResistanceToRotatingMachineDynamicsCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignStatorResistanceToRotatingMachineDynamicsCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignStatorResistanceFromRotatingMachineDynamicsCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignStatorResistanceFromRotatingMachineDynamicsCommand should not be null" );
		Assert.notNull( command.getRotatingMachineDynamicsId(), "UnAssignStatorResistanceFromRotatingMachineDynamicsCommand identifier should not be null" );
	}
