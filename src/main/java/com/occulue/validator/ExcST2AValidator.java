...
//		Assert.isNull( excST2A.getExcST2AId(), "CreateExcST2ACommand identifier should be null" );
	...
	public void validate( AssignEfdmaxToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignEfdmaxToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdmaxToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdmaxFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignEfdmaxFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignKaToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignKaFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignKcToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignKcFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignKeToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignKeFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignKfToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignKfFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignKiToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignKiFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignKpToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignKpFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignTaToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignTaFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignTbToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignTbFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignTcToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignTcFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignTeToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignTeFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignTfToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignTfFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUelinToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignUelinToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUelinToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUelinFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignUelinFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignVrmaxToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignVrmaxFromExcST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "AssignVrminToExcST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcST2AId(), "UnAssignVrminFromExcST2ACommand identifier should not be null" );
	}
