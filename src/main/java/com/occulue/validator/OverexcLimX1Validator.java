...
//		Assert.isNull( overexcLimX1.getOverexcLimX1Id(), "CreateOverexcLimX1Command identifier should be null" );
	...
	public void validate( AssignEfd1ToOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "AssignEfd1ToOverexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd1ToOverexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd1FromOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "UnAssignEfd1FromOverexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd2ToOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "AssignEfd2ToOverexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd2ToOverexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd2FromOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "UnAssignEfd2FromOverexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd3ToOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "AssignEfd3ToOverexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd3ToOverexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd3FromOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "UnAssignEfd3FromOverexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfddesToOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "AssignEfddesToOverexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfddesToOverexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEfddesFromOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "UnAssignEfddesFromOverexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfdratedToOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "AssignEfdratedToOverexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdratedToOverexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdratedFromOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "UnAssignEfdratedFromOverexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKmxToOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "AssignKmxToOverexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKmxToOverexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKmxFromOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "UnAssignKmxFromOverexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "AssignT1ToOverexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToOverexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "UnAssignT1FromOverexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "AssignT2ToOverexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToOverexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "UnAssignT2FromOverexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "AssignT3ToOverexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToOverexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "UnAssignT3FromOverexcLimX1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVlowToOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "AssignVlowToOverexcLimX1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVlowToOverexcLimX1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVlowFromOverexcLimX1Command command ) throws Exception {
		...
		Assert.notNull( command.getOverexcLimX1Id(), "UnAssignVlowFromOverexcLimX1Command identifier should not be null" );
	}
