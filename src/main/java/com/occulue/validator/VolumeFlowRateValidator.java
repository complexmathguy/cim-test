...
//		Assert.isNull( volumeFlowRate.getVolumeFlowRateId(), "CreateVolumeFlowRateCommand identifier should be null" );
	...
	public void validate( AssignValueToVolumeFlowRateCommand command ) throws Exception {
		...
		Assert.notNull( command.getVolumeFlowRateId(), "AssignValueToVolumeFlowRateCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToVolumeFlowRateCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromVolumeFlowRateCommand command ) throws Exception {
		...
		Assert.notNull( command.getVolumeFlowRateId(), "UnAssignValueFromVolumeFlowRateCommand identifier should not be null" );
	}
