...
//		Assert.isNull( excAC6A.getExcAC6AId(), "CreateExcAC6ACommand identifier should be null" );
	...
	public void validate( AssignKaToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignKaToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignKaFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignKcToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignKcFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKdToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignKdToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKdToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKdFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignKdFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignKeToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignKeFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKhToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignKhToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKhToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKhFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignKhFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKsToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignKsToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKsToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKsFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignKsFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve1ToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignSeve1ToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve1ToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve1FromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignSeve1FromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeve2ToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignSeve2ToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeve2ToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeve2FromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignSeve2FromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignTaToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignTaFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignTbToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignTbFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignTcToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignTcFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignTeToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignTeFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignThToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignThToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignThToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignThFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignThFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTjToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignTjToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTjToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTjFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignTjFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTkToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignTkToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTkToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTkFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignTkFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVamaxToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignVamaxToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVamaxToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVamaxFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignVamaxFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVaminToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignVaminToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVaminToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVaminFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignVaminFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe1ToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignVe1ToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe1ToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe1FromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignVe1FromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVe2ToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignVe2ToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVe2ToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVe2FromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignVe2FromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVfelimToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignVfelimToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVfelimToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVfelimFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignVfelimFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVhmaxToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignVhmaxToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVhmaxToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVhmaxFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignVhmaxFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignVrmaxToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignVrmaxFromExcAC6ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "AssignVrminToExcAC6ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcAC6ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcAC6ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC6AId(), "UnAssignVrminFromExcAC6ACommand identifier should not be null" );
	}
