...
//		Assert.isNull( excIEEEST2A.getExcIEEEST2AId(), "CreateExcIEEEST2ACommand identifier should be null" );
	...
	public void validate( AssignEfdmaxToExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "AssignEfdmaxToExcIEEEST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfdmaxToExcIEEEST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfdmaxFromExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "UnAssignEfdmaxFromExcIEEEST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "AssignKaToExcIEEEST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcIEEEST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "UnAssignKaFromExcIEEEST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "AssignKcToExcIEEEST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcIEEEST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "UnAssignKcFromExcIEEEST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "AssignKeToExcIEEEST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcIEEEST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "UnAssignKeFromExcIEEEST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "AssignKfToExcIEEEST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcIEEEST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "UnAssignKfFromExcIEEEST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "AssignKiToExcIEEEST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToExcIEEEST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "UnAssignKiFromExcIEEEST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "AssignKpToExcIEEEST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToExcIEEEST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "UnAssignKpFromExcIEEEST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "AssignTaToExcIEEEST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcIEEEST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "UnAssignTaFromExcIEEEST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "AssignTeToExcIEEEST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcIEEEST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "UnAssignTeFromExcIEEEST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "AssignTfToExcIEEEST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcIEEEST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "UnAssignTfFromExcIEEEST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignUelinToExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "AssignUelinToExcIEEEST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignUelinToExcIEEEST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignUelinFromExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "UnAssignUelinFromExcIEEEST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "AssignVrmaxToExcIEEEST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcIEEEST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "UnAssignVrmaxFromExcIEEEST2ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "AssignVrminToExcIEEEST2ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcIEEEST2ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcIEEEST2ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcIEEEST2AId(), "UnAssignVrminFromExcIEEEST2ACommand identifier should not be null" );
	}
