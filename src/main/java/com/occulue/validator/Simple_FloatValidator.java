...
//		Assert.isNull( simple_Float.getSimple_FloatId(), "CreateSimple_FloatCommand identifier should be null" );
	...
	public void validate( AssignValueToSimple_FloatCommand command ) throws Exception {
		...
		Assert.notNull( command.getSimple_FloatId(), "AssignValueToSimple_FloatCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToSimple_FloatCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromSimple_FloatCommand command ) throws Exception {
		...
		Assert.notNull( command.getSimple_FloatId(), "UnAssignValueFromSimple_FloatCommand identifier should not be null" );
	}
