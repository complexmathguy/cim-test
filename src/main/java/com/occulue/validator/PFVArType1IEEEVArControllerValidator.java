...
//		Assert.isNull( pFVArType1IEEEVArController.getPFVArType1IEEEVArControllerId(), "CreatePFVArType1IEEEVArControllerCommand identifier should be null" );
	...
	public void validate( AssignTvarcToPFVArType1IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType1IEEEVArControllerId(), "AssignTvarcToPFVArType1IEEEVArControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTvarcToPFVArType1IEEEVArControllerCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignTvarcFromPFVArType1IEEEVArControllerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignTvarcFromPFVArType1IEEEVArControllerCommand should not be null" );
		Assert.notNull( command.getPFVArType1IEEEVArControllerId(), "UnAssignTvarcFromPFVArType1IEEEVArControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVvarToPFVArType1IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType1IEEEVArControllerId(), "AssignVvarToPFVArType1IEEEVArControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVvarToPFVArType1IEEEVArControllerCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVvarFromPFVArType1IEEEVArControllerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVvarFromPFVArType1IEEEVArControllerCommand should not be null" );
		Assert.notNull( command.getPFVArType1IEEEVArControllerId(), "UnAssignVvarFromPFVArType1IEEEVArControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVvarcbwToPFVArType1IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType1IEEEVArControllerId(), "AssignVvarcbwToPFVArType1IEEEVArControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVvarcbwToPFVArType1IEEEVArControllerCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVvarcbwFromPFVArType1IEEEVArControllerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVvarcbwFromPFVArType1IEEEVArControllerCommand should not be null" );
		Assert.notNull( command.getPFVArType1IEEEVArControllerId(), "UnAssignVvarcbwFromPFVArType1IEEEVArControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVvarrefToPFVArType1IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType1IEEEVArControllerId(), "AssignVvarrefToPFVArType1IEEEVArControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVvarrefToPFVArType1IEEEVArControllerCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVvarrefFromPFVArType1IEEEVArControllerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVvarrefFromPFVArType1IEEEVArControllerCommand should not be null" );
		Assert.notNull( command.getPFVArType1IEEEVArControllerId(), "UnAssignVvarrefFromPFVArType1IEEEVArControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVvtmaxToPFVArType1IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType1IEEEVArControllerId(), "AssignVvtmaxToPFVArType1IEEEVArControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVvtmaxToPFVArType1IEEEVArControllerCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVvtmaxFromPFVArType1IEEEVArControllerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVvtmaxFromPFVArType1IEEEVArControllerCommand should not be null" );
		Assert.notNull( command.getPFVArType1IEEEVArControllerId(), "UnAssignVvtmaxFromPFVArType1IEEEVArControllerCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVvtminToPFVArType1IEEEVArControllerCommand command ) throws Exception {
		...
		Assert.notNull( command.getPFVArType1IEEEVArControllerId(), "AssignVvtminToPFVArType1IEEEVArControllerCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVvtminToPFVArType1IEEEVArControllerCommand assignment should not be null" );
	}
	 ...
	 */	
	public void validate( UnAssignVvtminFromPFVArType1IEEEVArControllerCommand command ) throws Exception {
		Assert.notNull( command, "UnAssignVvtminFromPFVArType1IEEEVArControllerCommand should not be null" );
		Assert.notNull( command.getPFVArType1IEEEVArControllerId(), "UnAssignVvtminFromPFVArType1IEEEVArControllerCommand identifier should not be null" );
	}
