...
//		Assert.isNull( excAC4A.getExcAC4AId(), "CreateExcAC4ACommand identifier should be null" );
	...
	public void validate( AssignKaToExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "AssignKaToExcAC4ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcAC4ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "UnAssignKaFromExcAC4ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKcToExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "AssignKcToExcAC4ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKcToExcAC4ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKcFromExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "UnAssignKcFromExcAC4ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "AssignTaToExcAC4ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcAC4ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "UnAssignTaFromExcAC4ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "AssignTbToExcAC4ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcAC4ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "UnAssignTbFromExcAC4ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "AssignTcToExcAC4ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcAC4ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "UnAssignTcFromExcAC4ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVimaxToExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "AssignVimaxToExcAC4ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVimaxToExcAC4ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVimaxFromExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "UnAssignVimaxFromExcAC4ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignViminToExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "AssignViminToExcAC4ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignViminToExcAC4ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignViminFromExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "UnAssignViminFromExcAC4ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "AssignVrmaxToExcAC4ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcAC4ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "UnAssignVrmaxFromExcAC4ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "AssignVrminToExcAC4ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcAC4ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcAC4ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC4AId(), "UnAssignVrminFromExcAC4ACommand identifier should not be null" );
	}
