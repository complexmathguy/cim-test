...
//		Assert.isNull( excDC3A1.getExcDC3A1Id(), "CreateExcDC3A1Command identifier should be null" );
	...
	public void validate( AssignExclimToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignExclimToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignExclimToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignExclimFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignExclimFromExcDC3A1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignKaToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignKaFromExcDC3A1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignKeToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignKeFromExcDC3A1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignKfToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignKfFromExcDC3A1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKiToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignKiToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKiToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKiFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignKiFromExcDC3A1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKpToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignKpToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKpToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignKpFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignKpFromExcDC3A1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignTaToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignTaFromExcDC3A1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignTeToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignTeFromExcDC3A1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTfToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignTfToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTfToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignTfFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignTfFromExcDC3A1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVb1maxToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignVb1maxToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVb1maxToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVb1maxFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignVb1maxFromExcDC3A1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVblimToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignVblimToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVblimToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVblimFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignVblimFromExcDC3A1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVbmaxToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignVbmaxToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVbmaxToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVbmaxFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignVbmaxFromExcDC3A1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignVrmaxToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignVrmaxFromExcDC3A1Command identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "AssignVrminToExcDC3A1Command identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcDC3A1Command assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcDC3A1Command command ) throws Exception {
		...
		Assert.notNull( command.getExcDC3A1Id(), "UnAssignVrminFromExcDC3A1Command identifier should not be null" );
	}
