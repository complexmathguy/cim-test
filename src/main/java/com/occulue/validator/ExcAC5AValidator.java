...
//		Assert.isNull( excAC5A.getExcAC5AId(), "CreateExcAC5ACommand identifier should be null" );
	...
	public void validate( AssignAToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getAssignment(), "AssignAToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignAFromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignAFromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd1ToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignEfd1ToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd1ToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd1FromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignEfd1FromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEfd2ToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignEfd2ToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEfd2ToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEfd2FromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignEfd2FromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKaToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignKaToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKaToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKaFromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignKaFromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKeToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignKeToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKeToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKeFromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignKeFromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKfToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignKfToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKfToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKfFromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignKfFromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignKsToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignKsToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignKsToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignKsFromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignKsFromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd1ToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignSeefd1ToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd1ToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd1FromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignSeefd1FromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignSeefd2ToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignSeefd2ToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignSeefd2ToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignSeefd2FromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignSeefd2FromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTaToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignTaToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTaToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTaFromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignTaFromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTbToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignTbToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTbToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTbFromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignTbFromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTcToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignTcToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTcToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTcFromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignTcFromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTeToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignTeToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTeToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTeFromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignTeFromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTf1ToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignTf1ToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTf1ToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTf1FromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignTf1FromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTf2ToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignTf2ToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTf2ToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTf2FromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignTf2FromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignTf3ToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignTf3ToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTf3ToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTf3FromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignTf3FromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrmaxToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignVrmaxToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrmaxToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrmaxFromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignVrmaxFromExcAC5ACommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVrminToExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "AssignVrminToExcAC5ACommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVrminToExcAC5ACommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVrminFromExcAC5ACommand command ) throws Exception {
		...
		Assert.notNull( command.getExcAC5AId(), "UnAssignVrminFromExcAC5ACommand identifier should not be null" );
	}
