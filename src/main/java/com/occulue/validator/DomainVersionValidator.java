...
//		Assert.isNull( domainVersion.getDomainVersionId(), "CreateDomainVersionCommand identifier should be null" );
	...
	public void validate( AssignBaseUMLToDomainVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDomainVersionId(), "AssignBaseUMLToDomainVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignBaseUMLToDomainVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignBaseUMLFromDomainVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDomainVersionId(), "UnAssignBaseUMLFromDomainVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignDateToDomainVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDomainVersionId(), "AssignDateToDomainVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignDateToDomainVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignDateFromDomainVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDomainVersionId(), "UnAssignDateFromDomainVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEntsoeUMLToDomainVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDomainVersionId(), "AssignEntsoeUMLToDomainVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEntsoeUMLToDomainVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEntsoeUMLFromDomainVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDomainVersionId(), "UnAssignEntsoeUMLFromDomainVersionCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVersionToDomainVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDomainVersionId(), "AssignVersionToDomainVersionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVersionToDomainVersionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVersionFromDomainVersionCommand command ) throws Exception {
		...
		Assert.notNull( command.getDomainVersionId(), "UnAssignVersionFromDomainVersionCommand identifier should not be null" );
	}
