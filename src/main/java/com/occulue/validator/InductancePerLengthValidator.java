...
//		Assert.isNull( inductancePerLength.getInductancePerLengthId(), "CreateInductancePerLengthCommand identifier should be null" );
	...
	public void validate( AssignValueToInductancePerLengthCommand command ) throws Exception {
		...
		Assert.notNull( command.getInductancePerLengthId(), "AssignValueToInductancePerLengthCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignValueToInductancePerLengthCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignValueFromInductancePerLengthCommand command ) throws Exception {
		...
		Assert.notNull( command.getInductancePerLengthId(), "UnAssignValueFromInductancePerLengthCommand identifier should not be null" );
	}
