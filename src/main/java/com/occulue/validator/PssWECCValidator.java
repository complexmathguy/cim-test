...
//		Assert.isNull( pssWECC.getPssWECCId(), "CreatePssWECCCommand identifier should be null" );
	...
	public void validate( AssignK1ToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignK1ToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK1ToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK1FromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignK1FromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignK2ToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignK2ToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignK2ToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignK2FromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignK2FromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT1ToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignT1ToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT1ToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT1FromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignT1FromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT10ToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignT10ToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT10ToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT10FromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignT10FromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT2ToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignT2ToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT2ToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT2FromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignT2FromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT3ToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignT3ToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT3ToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT3FromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignT3FromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT4ToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignT4ToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT4ToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT4FromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignT4FromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT5ToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignT5ToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT5ToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT5FromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignT5FromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT6ToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignT6ToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT6ToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT6FromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignT6FromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT7ToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignT7ToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT7ToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT7FromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignT7FromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT8ToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignT8ToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT8ToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT8FromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignT8FromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignT9ToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignT9ToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignT9ToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignT9FromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignT9FromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVclToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignVclToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVclToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVclFromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignVclFromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVcuToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignVcuToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVcuToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVcuFromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignVcuFromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsmaxToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignVsmaxToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsmaxToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsmaxFromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignVsmaxFromPssWECCCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignVsminToPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "AssignVsminToPssWECCCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVsminToPssWECCCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVsminFromPssWECCCommand command ) throws Exception {
		...
		Assert.notNull( command.getPssWECCId(), "UnAssignVsminFromPssWECCCommand identifier should not be null" );
	}
