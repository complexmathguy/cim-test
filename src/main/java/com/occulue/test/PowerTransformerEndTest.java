...
public class PowerTransformerEndTest{
	...
	protected UpdatePowerTransformerEndCommand generateUpdateCommand() {
	        UpdatePowerTransformerEndCommand command = new UpdatePowerTransformerEndCommand( null,  null,  null,  WindingConnection.values()[0],  null,  null,  null,  null,  null,  null,  null,  null,  null );
