...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignPriority( AssignPriorityToBusNameMarkerCommand command ) throws ProcessingException {
		...
		BusNameMarkerBusinessDelegate parentDelegate = BusNameMarkerBusinessDelegate.getBusNameMarkerInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignPriority( UnAssignPriorityFromBusNameMarkerCommand command ) throws ProcessingException {
