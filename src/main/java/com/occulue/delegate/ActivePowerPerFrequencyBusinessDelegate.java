...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignValue( AssignValueToActivePowerPerFrequencyCommand command ) throws ProcessingException {
		...
		ActivePowerPerFrequencyBusinessDelegate parentDelegate = ActivePowerPerFrequencyBusinessDelegate.getActivePowerPerFrequencyInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromActivePowerPerFrequencyCommand command ) throws ProcessingException {
