...
//************************************************************************
    ...
    */
	...
	public void assignR( AssignRToEarthFaultCompensatorCommand command ) throws ProcessingException {
		...
		EarthFaultCompensatorBusinessDelegate parentDelegate = EarthFaultCompensatorBusinessDelegate.getEarthFaultCompensatorInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignR( UnAssignRFromEarthFaultCompensatorCommand command ) throws ProcessingException {
