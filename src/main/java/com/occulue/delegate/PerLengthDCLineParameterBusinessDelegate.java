...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignCapacitance( AssignCapacitanceToPerLengthDCLineParameterCommand command ) throws ProcessingException {
		...
		CapacitancePerLengthBusinessDelegate childDelegate 	= CapacitancePerLengthBusinessDelegate.getCapacitancePerLengthInstance();
		PerLengthDCLineParameterBusinessDelegate parentDelegate = PerLengthDCLineParameterBusinessDelegate.getPerLengthDCLineParameterInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignCapacitance( UnAssignCapacitanceFromPerLengthDCLineParameterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignInductance( AssignInductanceToPerLengthDCLineParameterCommand command ) throws ProcessingException {
		...
		InductancePerLengthBusinessDelegate childDelegate 	= InductancePerLengthBusinessDelegate.getInductancePerLengthInstance();
		PerLengthDCLineParameterBusinessDelegate parentDelegate = PerLengthDCLineParameterBusinessDelegate.getPerLengthDCLineParameterInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignInductance( UnAssignInductanceFromPerLengthDCLineParameterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignResistance( AssignResistanceToPerLengthDCLineParameterCommand command ) throws ProcessingException {
		...
		ResistancePerLengthBusinessDelegate childDelegate 	= ResistancePerLengthBusinessDelegate.getResistancePerLengthInstance();
		PerLengthDCLineParameterBusinessDelegate parentDelegate = PerLengthDCLineParameterBusinessDelegate.getPerLengthDCLineParameterInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignResistance( UnAssignResistanceFromPerLengthDCLineParameterCommand command ) throws ProcessingException {
