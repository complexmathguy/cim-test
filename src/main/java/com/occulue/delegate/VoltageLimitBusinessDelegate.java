...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToVoltageLimitCommand command ) throws ProcessingException {
		...
		VoltageLimitBusinessDelegate parentDelegate = VoltageLimitBusinessDelegate.getVoltageLimitInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromVoltageLimitCommand command ) throws ProcessingException {
