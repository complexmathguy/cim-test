...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToAccumulatorValueCommand command ) throws ProcessingException {
		...
		AccumulatorValueBusinessDelegate parentDelegate = AccumulatorValueBusinessDelegate.getAccumulatorValueInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromAccumulatorValueCommand command ) throws ProcessingException {
