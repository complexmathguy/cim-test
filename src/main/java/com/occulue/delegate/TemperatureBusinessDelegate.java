...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToTemperatureCommand command ) throws ProcessingException {
		...
		TemperatureBusinessDelegate parentDelegate = TemperatureBusinessDelegate.getTemperatureInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromTemperatureCommand command ) throws ProcessingException {
