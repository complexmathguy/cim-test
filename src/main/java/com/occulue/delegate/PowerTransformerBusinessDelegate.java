...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignBeforeShCircuitHighestOperatingCurrent( AssignBeforeShCircuitHighestOperatingCurrentToPowerTransformerCommand command ) throws ProcessingException {
		...
		PowerTransformerBusinessDelegate parentDelegate = PowerTransformerBusinessDelegate.getPowerTransformerInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignBeforeShCircuitHighestOperatingCurrent( UnAssignBeforeShCircuitHighestOperatingCurrentFromPowerTransformerCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign BeforeShCircuitHighestOperatingCurrent on PowerTransformer";
     ...
     * @exception	ProcessingException
     */     
	public void assignBeforeShCircuitHighestOperatingVoltage( AssignBeforeShCircuitHighestOperatingVoltageToPowerTransformerCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignBeforeShCircuitHighestOperatingVoltage( UnAssignBeforeShCircuitHighestOperatingVoltageFromPowerTransformerCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign BeforeShCircuitHighestOperatingVoltage on PowerTransformer";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
     ...
     * @exception	ProcessingException
     */     
	public void assignBeforeShortCircuitAnglePf( AssignBeforeShortCircuitAnglePfToPowerTransformerCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignBeforeShortCircuitAnglePf( UnAssignBeforeShortCircuitAnglePfFromPowerTransformerCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignHighSideMinOperatingU( AssignHighSideMinOperatingUToPowerTransformerCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignHighSideMinOperatingU( UnAssignHighSideMinOperatingUFromPowerTransformerCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignPartOfGeneratorUnitFlag( AssignPartOfGeneratorUnitFlagToPowerTransformerCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignPartOfGeneratorUnitFlag( UnAssignPartOfGeneratorUnitFlagFromPowerTransformerCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignOperationalValuesConsidered( AssignOperationalValuesConsideredToPowerTransformerCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignOperationalValuesConsidered( UnAssignOperationalValuesConsideredFromPowerTransformerCommand command ) throws ProcessingException {
