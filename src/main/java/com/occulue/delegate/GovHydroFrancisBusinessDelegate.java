...
//************************************************************************
    ...
    */
	...
	public void assignAm( AssignAmToGovHydroFrancisCommand command ) throws ProcessingException {
		...
		GovHydroFrancisBusinessDelegate parentDelegate = GovHydroFrancisBusinessDelegate.getGovHydroFrancisInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignAv0( UnAssignAv0FromGovHydroFrancisCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignAv1( UnAssignAv1FromGovHydroFrancisCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignDb1( UnAssignDb1FromGovHydroFrancisCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignEtamax( AssignEtamaxToGovHydroFrancisCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignEtamax( UnAssignEtamaxFromGovHydroFrancisCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignQc0( UnAssignQc0FromGovHydroFrancisCommand command ) throws ProcessingException {
	...
	public void assignQn( AssignQnToGovHydroFrancisCommand command ) throws ProcessingException {
		...
		VolumeFlowRateBusinessDelegate childDelegate 	= VolumeFlowRateBusinessDelegate.getVolumeFlowRateInstance();
		GovHydroFrancisBusinessDelegate parentDelegate = GovHydroFrancisBusinessDelegate.getGovHydroFrancisInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTwnc( UnAssignTwncFromGovHydroFrancisCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignTwng( UnAssignTwngFromGovHydroFrancisCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignValvmax( AssignValvmaxToGovHydroFrancisCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValvmax( UnAssignValvmaxFromGovHydroFrancisCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignValvmin( AssignValvminToGovHydroFrancisCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValvmin( UnAssignValvminFromGovHydroFrancisCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignWaterTunnelSurgeChamberSimulation( AssignWaterTunnelSurgeChamberSimulationToGovHydroFrancisCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignWaterTunnelSurgeChamberSimulation( UnAssignWaterTunnelSurgeChamberSimulationFromGovHydroFrancisCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignZsfc( UnAssignZsfcFromGovHydroFrancisCommand command ) throws ProcessingException {
