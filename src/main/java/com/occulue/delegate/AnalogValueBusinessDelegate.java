...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToAnalogValueCommand command ) throws ProcessingException {
		...
		AnalogValueBusinessDelegate parentDelegate = AnalogValueBusinessDelegate.getAnalogValueInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromAnalogValueCommand command ) throws ProcessingException {
