...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToActivePowerLimitCommand command ) throws ProcessingException {
		...
		ActivePowerLimitBusinessDelegate parentDelegate = ActivePowerLimitBusinessDelegate.getActivePowerLimitInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromActivePowerLimitCommand command ) throws ProcessingException {
