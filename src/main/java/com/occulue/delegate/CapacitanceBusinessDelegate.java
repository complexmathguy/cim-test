...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToCapacitanceCommand command ) throws ProcessingException {
		...
		CapacitanceBusinessDelegate parentDelegate = CapacitanceBusinessDelegate.getCapacitanceInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromCapacitanceCommand command ) throws ProcessingException {
