...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToAnalogLimitCommand command ) throws ProcessingException {
		...
		AnalogLimitBusinessDelegate parentDelegate = AnalogLimitBusinessDelegate.getAnalogLimitInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromAnalogLimitCommand command ) throws ProcessingException {
