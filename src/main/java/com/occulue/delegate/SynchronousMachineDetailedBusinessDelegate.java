...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignEfdBaseRatio( AssignEfdBaseRatioToSynchronousMachineDetailedCommand command ) throws ProcessingException {
		...
		SynchronousMachineDetailedBusinessDelegate parentDelegate = SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignEfdBaseRatio( UnAssignEfdBaseRatioFromSynchronousMachineDetailedCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignIfdBaseValue( AssignIfdBaseValueToSynchronousMachineDetailedCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignIfdBaseValue( UnAssignIfdBaseValueFromSynchronousMachineDetailedCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignSaturationFactor120QAxis( AssignSaturationFactor120QAxisToSynchronousMachineDetailedCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSaturationFactor120QAxis( UnAssignSaturationFactor120QAxisFromSynchronousMachineDetailedCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign SaturationFactor120QAxis on SynchronousMachineDetailed";
			LOGGER.log( Level.WARNING, msg, exc );
			throw new ProcessingException( msg, exc );
		}
	}
     ...
     * @exception	ProcessingException
     */     
	public void assignSaturationFactorQAxis( AssignSaturationFactorQAxisToSynchronousMachineDetailedCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSaturationFactorQAxis( UnAssignSaturationFactorQAxisFromSynchronousMachineDetailedCommand command ) throws ProcessingException {
