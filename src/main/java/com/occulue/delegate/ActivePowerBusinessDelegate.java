...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToActivePowerCommand command ) throws ProcessingException {
		...
		ActivePowerBusinessDelegate parentDelegate = ActivePowerBusinessDelegate.getActivePowerInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromActivePowerCommand command ) throws ProcessingException {
