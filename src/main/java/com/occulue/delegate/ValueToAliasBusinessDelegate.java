...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToValueToAliasCommand command ) throws ProcessingException {
		...
		ValueToAliasBusinessDelegate parentDelegate = ValueToAliasBusinessDelegate.getValueToAliasInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromValueToAliasCommand command ) throws ProcessingException {
