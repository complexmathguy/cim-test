...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToAngleDegreesCommand command ) throws ProcessingException {
		...
		AngleDegreesBusinessDelegate parentDelegate = AngleDegreesBusinessDelegate.getAngleDegreesInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromAngleDegreesCommand command ) throws ProcessingException {
