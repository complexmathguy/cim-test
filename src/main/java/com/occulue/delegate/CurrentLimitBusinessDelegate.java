...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToCurrentLimitCommand command ) throws ProcessingException {
		...
		CurrentLimitBusinessDelegate parentDelegate = CurrentLimitBusinessDelegate.getCurrentLimitInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromCurrentLimitCommand command ) throws ProcessingException {
