...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignStepVoltageIncrement( AssignStepVoltageIncrementToRatioTapChangerCommand command ) throws ProcessingException {
		...
		RatioTapChangerBusinessDelegate parentDelegate = RatioTapChangerBusinessDelegate.getRatioTapChangerInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignStepVoltageIncrement( UnAssignStepVoltageIncrementFromRatioTapChangerCommand command ) throws ProcessingException {
