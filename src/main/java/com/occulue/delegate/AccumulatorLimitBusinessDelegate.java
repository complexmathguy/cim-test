...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToAccumulatorLimitCommand command ) throws ProcessingException {
		...
		AccumulatorLimitBusinessDelegate parentDelegate = AccumulatorLimitBusinessDelegate.getAccumulatorLimitInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromAccumulatorLimitCommand command ) throws ProcessingException {
