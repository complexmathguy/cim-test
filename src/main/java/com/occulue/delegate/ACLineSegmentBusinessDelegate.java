...
//************************************************************************
    ...
    */
	...
	public void assignB0ch( AssignB0chToACLineSegmentCommand command ) throws ProcessingException {
		...
		ACLineSegmentBusinessDelegate parentDelegate = ACLineSegmentBusinessDelegate.getACLineSegmentInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignB0ch( UnAssignB0chFromACLineSegmentCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignG0ch( UnAssignG0chFromACLineSegmentCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignShortCircuitEndTemperature( AssignShortCircuitEndTemperatureToACLineSegmentCommand command ) throws ProcessingException {
		...
		TemperatureBusinessDelegate childDelegate 	= TemperatureBusinessDelegate.getTemperatureInstance();
		ACLineSegmentBusinessDelegate parentDelegate = ACLineSegmentBusinessDelegate.getACLineSegmentInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignShortCircuitEndTemperature( UnAssignShortCircuitEndTemperatureFromACLineSegmentCommand command ) throws ProcessingException {
