...
//************************************************************************
    ...
    */
	...
	public void assignB( AssignBToPowerTransformerEndCommand command ) throws ProcessingException {
		...
		SusceptanceBusinessDelegate childDelegate 	= SusceptanceBusinessDelegate.getSusceptanceInstance();
		PowerTransformerEndBusinessDelegate parentDelegate = PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignB( UnAssignBFromPowerTransformerEndCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignB0( UnAssignB0FromPowerTransformerEndCommand command ) throws ProcessingException {
	...
	public void assignG( AssignGToPowerTransformerEndCommand command ) throws ProcessingException {
		...
		ConductanceBusinessDelegate childDelegate 	= ConductanceBusinessDelegate.getConductanceInstance();
		PowerTransformerEndBusinessDelegate parentDelegate = PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignG( UnAssignGFromPowerTransformerEndCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignG0( UnAssignG0FromPowerTransformerEndCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignPhaseAngleClock( AssignPhaseAngleClockToPowerTransformerEndCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignPhaseAngleClock( UnAssignPhaseAngleClockFromPowerTransformerEndCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignR( UnAssignRFromPowerTransformerEndCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignR0( UnAssignR0FromPowerTransformerEndCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignRatedS( AssignRatedSToPowerTransformerEndCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignRatedS( UnAssignRatedSFromPowerTransformerEndCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignRatedU( AssignRatedUToPowerTransformerEndCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignRatedU( UnAssignRatedUFromPowerTransformerEndCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignX( UnAssignXFromPowerTransformerEndCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignX0( UnAssignX0FromPowerTransformerEndCommand command ) throws ProcessingException {
