...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignDamping( AssignDampingToRotatingMachineDynamicsCommand command ) throws ProcessingException {
		...
		RotatingMachineDynamicsBusinessDelegate parentDelegate = RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignDamping( UnAssignDampingFromRotatingMachineDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignInertia( AssignInertiaToRotatingMachineDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignInertia( UnAssignInertiaFromRotatingMachineDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignSaturationFactor( AssignSaturationFactorToRotatingMachineDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSaturationFactor( UnAssignSaturationFactorFromRotatingMachineDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignSaturationFactor120( AssignSaturationFactor120ToRotatingMachineDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSaturationFactor120( UnAssignSaturationFactor120FromRotatingMachineDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignStatorLeakageReactance( AssignStatorLeakageReactanceToRotatingMachineDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignStatorLeakageReactance( UnAssignStatorLeakageReactanceFromRotatingMachineDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignStatorResistance( AssignStatorResistanceToRotatingMachineDynamicsCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignStatorResistance( UnAssignStatorResistanceFromRotatingMachineDynamicsCommand command ) throws ProcessingException {
