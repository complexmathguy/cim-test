...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToReactivePowerCommand command ) throws ProcessingException {
		...
		ReactivePowerBusinessDelegate parentDelegate = ReactivePowerBusinessDelegate.getReactivePowerInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromReactivePowerCommand command ) throws ProcessingException {
