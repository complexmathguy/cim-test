...
//************************************************************************
    ...
    */
	...
	public void assignIpMax( AssignIpMaxToBusbarSectionCommand command ) throws ProcessingException {
		...
		BusbarSectionBusinessDelegate parentDelegate = BusbarSectionBusinessDelegate.getBusbarSectionInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignIpMax( UnAssignIpMaxFromBusbarSectionCommand command ) throws ProcessingException {
