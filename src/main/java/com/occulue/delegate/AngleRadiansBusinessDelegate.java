...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToAngleRadiansCommand command ) throws ProcessingException {
		...
		AngleRadiansBusinessDelegate parentDelegate = AngleRadiansBusinessDelegate.getAngleRadiansInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromAngleRadiansCommand command ) throws ProcessingException {
