...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignVoltageStepIncrement( AssignVoltageStepIncrementToPhaseTapChangerNonLinearCommand command ) throws ProcessingException {
		...
		PhaseTapChangerNonLinearBusinessDelegate parentDelegate = PhaseTapChangerNonLinearBusinessDelegate.getPhaseTapChangerNonLinearInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignVoltageStepIncrement( UnAssignVoltageStepIncrementFromPhaseTapChangerNonLinearCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignXMax( AssignXMaxToPhaseTapChangerNonLinearCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignXMax( UnAssignXMaxFromPhaseTapChangerNonLinearCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignXMin( AssignXMinToPhaseTapChangerNonLinearCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignXMin( UnAssignXMinFromPhaseTapChangerNonLinearCommand command ) throws ProcessingException {
