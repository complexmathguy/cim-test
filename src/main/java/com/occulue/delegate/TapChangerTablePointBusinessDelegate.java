...
//************************************************************************
    ...
    */
	...
	public void assignB( AssignBToTapChangerTablePointCommand command ) throws ProcessingException {
		...
		TapChangerTablePointBusinessDelegate parentDelegate = TapChangerTablePointBusinessDelegate.getTapChangerTablePointInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignB( UnAssignBFromTapChangerTablePointCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignG( UnAssignGFromTapChangerTablePointCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignR( UnAssignRFromTapChangerTablePointCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignRatio( AssignRatioToTapChangerTablePointCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignRatio( UnAssignRatioFromTapChangerTablePointCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignStep( AssignStepToTapChangerTablePointCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignStep( UnAssignStepFromTapChangerTablePointCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignX( UnAssignXFromTapChangerTablePointCommand command ) throws ProcessingException {
