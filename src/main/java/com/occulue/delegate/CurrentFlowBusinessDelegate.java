...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToCurrentFlowCommand command ) throws ProcessingException {
		...
		CurrentFlowBusinessDelegate parentDelegate = CurrentFlowBusinessDelegate.getCurrentFlowInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromCurrentFlowCommand command ) throws ProcessingException {
