...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignAVRDelay( AssignAVRDelayToShuntCompensatorCommand command ) throws ProcessingException {
		...
		ShuntCompensatorBusinessDelegate parentDelegate = ShuntCompensatorBusinessDelegate.getShuntCompensatorInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignAVRDelay( UnAssignAVRDelayFromShuntCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignGrounded( AssignGroundedToShuntCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignGrounded( UnAssignGroundedFromShuntCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignMaximumSections( AssignMaximumSectionsToShuntCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignMaximumSections( UnAssignMaximumSectionsFromShuntCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignNomU( UnAssignNomUFromShuntCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignNormalSections( AssignNormalSectionsToShuntCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignNormalSections( UnAssignNormalSectionsFromShuntCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignSwitchOnCount( AssignSwitchOnCountToShuntCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSwitchOnCount( UnAssignSwitchOnCountFromShuntCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignSwitchOnDate( AssignSwitchOnDateToShuntCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSwitchOnDate( UnAssignSwitchOnDateFromShuntCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignVoltageSensitivity( AssignVoltageSensitivityToShuntCompensatorCommand command ) throws ProcessingException {
		...
		VoltagePerReactivePowerBusinessDelegate childDelegate 	= VoltagePerReactivePowerBusinessDelegate.getVoltagePerReactivePowerInstance();
		ShuntCompensatorBusinessDelegate parentDelegate = ShuntCompensatorBusinessDelegate.getShuntCompensatorInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignVoltageSensitivity( UnAssignVoltageSensitivityFromShuntCompensatorCommand command ) throws ProcessingException {
