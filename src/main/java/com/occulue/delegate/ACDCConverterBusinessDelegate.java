...
//************************************************************************
    ...
    */
	...
	public void assignBaseS( AssignBaseSToACDCConverterCommand command ) throws ProcessingException {
		...
		ApparentPowerBusinessDelegate childDelegate 	= ApparentPowerBusinessDelegate.getApparentPowerInstance();
		ACDCConverterBusinessDelegate parentDelegate = ACDCConverterBusinessDelegate.getACDCConverterInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignBaseS( UnAssignBaseSFromACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignIdleLoss( AssignIdleLossToACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignIdleLoss( UnAssignIdleLossFromACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignMaxUdc( UnAssignMaxUdcFromACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignMinUdc( UnAssignMinUdcFromACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignNumberOfValves( AssignNumberOfValvesToACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignNumberOfValves( UnAssignNumberOfValvesFromACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignRatedUdc( AssignRatedUdcToACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignRatedUdc( UnAssignRatedUdcFromACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignResistiveLoss( AssignResistiveLossToACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignResistiveLoss( UnAssignResistiveLossFromACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignSwitchingLoss( AssignSwitchingLossToACDCConverterCommand command ) throws ProcessingException {
		...
		ActivePowerPerCurrentFlowBusinessDelegate childDelegate 	= ActivePowerPerCurrentFlowBusinessDelegate.getActivePowerPerCurrentFlowInstance();
		ACDCConverterBusinessDelegate parentDelegate = ACDCConverterBusinessDelegate.getACDCConverterInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignSwitchingLoss( UnAssignSwitchingLossFromACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignValveU0( AssignValveU0ToACDCConverterCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValveU0( UnAssignValveU0FromACDCConverterCommand command ) throws ProcessingException {
