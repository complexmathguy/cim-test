...
//************************************************************************
    ...
    */
	...
	public void assignR( AssignRToSeriesCompensatorCommand command ) throws ProcessingException {
		...
		SeriesCompensatorBusinessDelegate parentDelegate = SeriesCompensatorBusinessDelegate.getSeriesCompensatorInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignR0( UnAssignR0FromSeriesCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignVaristorPresent( AssignVaristorPresentToSeriesCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignVaristorPresent( UnAssignVaristorPresentFromSeriesCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignVaristorRatedCurrent( AssignVaristorRatedCurrentToSeriesCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignVaristorRatedCurrent( UnAssignVaristorRatedCurrentFromSeriesCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void assignVaristorVoltageThreshold( AssignVaristorVoltageThresholdToSeriesCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignVaristorVoltageThreshold( UnAssignVaristorVoltageThresholdFromSeriesCompensatorCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignX0( UnAssignX0FromSeriesCompensatorCommand command ) throws ProcessingException {
