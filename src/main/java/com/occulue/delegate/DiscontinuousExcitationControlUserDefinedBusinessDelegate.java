...
//************************************************************************
    ...
    */
     ...
     * @exception	ProcessingException
     */     
	public void assignProprietary( AssignProprietaryToDiscontinuousExcitationControlUserDefinedCommand command ) throws ProcessingException {
		...
		DiscontinuousExcitationControlUserDefinedBusinessDelegate parentDelegate = DiscontinuousExcitationControlUserDefinedBusinessDelegate.getDiscontinuousExcitationControlUserDefinedInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignProprietary( UnAssignProprietaryFromDiscontinuousExcitationControlUserDefinedCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Proprietary on DiscontinuousExcitationControlUserDefined";
