...
//************************************************************************
    ...
    */
	...
	public void assignValue( AssignValueToConductanceCommand command ) throws ProcessingException {
		...
		ConductanceBusinessDelegate parentDelegate = ConductanceBusinessDelegate.getConductanceInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignValue( UnAssignValueFromConductanceCommand command ) throws ProcessingException {
